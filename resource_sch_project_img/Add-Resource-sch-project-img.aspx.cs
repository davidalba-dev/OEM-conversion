...
// This file implements the code-behind class for Add_Resource_sch_project_img.aspx.
// App_Code\Add_Resource_sch_project_img.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Resource_sch_project_img
        : BaseApplicationPage
// Code-behind class for the Add_Resource_sch_project_img page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Resource_sch_project_img()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetResource_sch_project_imgRecordControl()
        {
            SetResource_sch_project_imgRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Resource SCH Project Image");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Resource_sch_project_imgRecordControl":
                 SetResource_sch_project_imgRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Resource_sch_project_imgRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetResource_sch_project_imgRecordControl_Base()           
        
        {        
            if (Resource_sch_project_imgRecordControl.Visible)
            {
                Resource_sch_project_imgRecordControl.LoadData();
                Resource_sch_project_imgRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Resource_sch_project_imgRecordControl != null && this.Resource_sch_project_imgRecordControl.DataSource != null)
                  {
                        id = this.Resource_sch_project_imgRecordControl.DataSource.GetValue(this.Resource_sch_project_imgRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Resource_sch_project_imgRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Resource_sch_project_imgRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Resource_sch_project_imgRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Resource_sch_project_imgRecordControl.DataSource.GetValue(this.Resource_sch_project_imgRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
