...
// This file implements the code-behind class for Edit_Inventory.aspx.
// App_Code\Edit_Inventory.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Inventory
        : BaseApplicationPage
// Code-behind class for the Edit_Inventory page.
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetInventoryRecordControl()
        {
            SetInventoryRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Inventory");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "InventoryRecordControl":
                 SetInventoryRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.InventoryRecordControl.SaveData();
        ...
        SetInventoryRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "InventoryMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetInventoryRecordControl_Base()           
        
        {        
            if (InventoryRecordControl.Visible)
            {
                InventoryRecordControl.LoadData();
                InventoryRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.InventoryRecordControl != null && this.InventoryRecordControl.DataSource != null)
                  {
                        id = this.InventoryRecordControl.DataSource.GetValue(this.InventoryRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.InventoryRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.InventoryRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.InventoryRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.InventoryRecordControl.DataSource.GetValue(this.InventoryRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
