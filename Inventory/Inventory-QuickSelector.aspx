<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Inventory_QuickSelector" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Inventory-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="OEMConversion.UI.Inventory_QuickSelector" %>
