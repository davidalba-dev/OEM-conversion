...
// This file implements the code-behind class for Show_Vw_contactlist_export_Table.aspx.
// App_Code\Show_Vw_contactlist_export_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Vw_contactlist_export_Table
        : BaseApplicationPage
// Code-behind class for the Show_Vw_contactlist_export_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Vw_contactlist_export_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetVw_contactlist_exportTableControl()
        {
            SetVw_contactlist_exportTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Vw_contactlist_exportTableControl":
                 SetVw_contactlist_exportTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Vw_contactlist_exportTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Vw_contactlist_export_Table.Vw_contactlist_exportTableControl control = new OEMConversion.UI.Controls.Show_Vw_contactlist_export_Table.Vw_contactlist_exportTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetVw_contactlist_exportTableControl_Base()           
        
        {        
            if (Vw_contactlist_exportTableControl.Visible)
            {
                Vw_contactlist_exportTableControl.LoadData();
                Vw_contactlist_exportTableControl.DataBind();
            }
        }
