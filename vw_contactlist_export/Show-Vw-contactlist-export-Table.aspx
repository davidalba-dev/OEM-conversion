...
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_Vw_contactlist_export_Table" %>

<%@ Register Tagprefix="BaseClasses" Namespace="BaseClasses.Web.UI.WebControls" Assembly="BaseClasses" %>
<%@ Register Tagprefix="OEMConversion" TagName="PaginationModern" Src="../Shared/PaginationModern.ascx" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-Vw-contactlist-export-Table.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Show_Vw_contactlist_export_Table" %><asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
		...
		<asp:UpdatePanel runat="server" id="UpdatePanel1" UpdateMode="Conditional">
			<ContentTemplate>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="updatePanelContent"><tr><td>
                        <OEMConversion:Vw_contactlist_exportTableControl runat="server" id="Vw_contactlist_exportTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="panelTL"><img src="../Images/space.gif" class="panelTLSpace" alt="" /></td><td class="panelT"></td><td class="panelTR"><img src="../Images/space.gif" class="panelTRSpace" alt="" /></td></tr><tr><td class="panelHeaderL"></td><td class="dh">
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title0" Text="&lt;%#String.Concat(&quot;Contactlist Export&quot;) %>">	</asp:Literal>
                      </td></tr></table>
...
<asp:AutoCompleteExtender id="SearchTextAutoCompleteExtender" runat="server" TargetControlID="SearchText" ServiceMethod="GetAutoCompletionList_SearchText" MinimumPrefixLength="2" CompletionInterval="700" CompletionSetCount="10" CompletionListCssClass="autotypeahead_completionListElement" CompletionListItemCssClass="autotypeahead_listItem " CompletionListHighlightedItemCssClass="autotypeahead_highlightedListItem">
              ...
              <%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("SearchButton"))%>
                ...
                <asp:ImageButton runat="server" id="SearchButton" causesvalidation="False" commandname="Search" imageurl="../Images/panelSearchButton.png" tooltip="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;OEMConversion&quot;) %>">		
                          ...
                          <table cellpadding="0" cellspacing="0" border="0"><tr><td class="popupTableCellLabel"></td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td><td style="text-align: right;" class="popupTableCellValue"><input type="image" src="../Images/closeButton.gif" onmouseover="this.src='../Images/closeButtonOver.gif'" onmouseout="this.src='../Images/closeButton.gif'" alt="" onclick="ISD_HidePopupPanel();return false;" align="top" /><br /></td></tr><tr><td class="popupTableCellLabel"><asp:Literal runat="server" id="CustContact_activeLabel1" Text="Customer Contact Active">	</asp:Literal></td><td colspan="2" class="popupTableCellValue"><%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("FilterButton"))%>
<asp:DropDownList runat="server" id="CustContact_activeFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre">
                    <table id="Vw_contactlist_exportTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc"></th><th class="thc"><asp:LinkButton runat="server" id="CustContactNameLabel" tooltip="Sort by CustContactName" Text="Contact / Title" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="CustContactPhoneBusinessLabel" tooltip="Sort by CustContactPhoneBusiness" Text="Phone Bus/Mobile" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="CustContactEmailLabel" tooltip="Sort by CustContactEmail" Text="Email" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="CustNameLabel" tooltip="Sort by CustName" Text="Facility" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="CustAddress1Label" tooltip="Sort by CustAddress1" Text="Address" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="CustWebSiteLabel" tooltip="Sort by CustWebSite" Text="Website" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="CustContact_activeLabel" tooltip="Sort by CustContact_active" Text="Contact Active" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="customer_activeLabel1" tooltip="Sort by customer_active" Text="Facility Active" CausesValidation="False">	</asp:LinkButton></th></tr><asp:Repeater runat="server" id="Vw_contactlist_exportTableControlRepeater">		<ITEMTEMPLATE>		<OEMConversion:Vw_contactlist_exportTableControlRow runat="server" id="Vw_contactlist_exportTableControlRow">
<tr><td class="tableCellLabel"></td><td class="tableCellValue"><asp:Literal runat="server" id="CustContactName"></asp:Literal> <br><asp:Literal runat="server" id="CustContactTitle"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="CustContactPhoneBusiness"></asp:Literal> 
<asp:Literal runat="server" id="CustContactPhoneMobile"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="CustContactEmail"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="CustName"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="CustAddress1"></asp:Literal> <br>
<asp:Literal runat="server" id="CustAddress2"></asp:Literal> <br>
<asp:Literal runat="server" id="CustCity"></asp:Literal>&nbsp;<asp:Literal runat="server" id="CustProvince"></asp:Literal>&nbsp;<asp:Literal runat="server" id="CustPostalCode"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="CustWebSite"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="CustContact_active"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="customer_active"></asp:Literal></td></tr><tr><td class="tableRowDivider" colspan="6"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td></tr></OEMConversion:Vw_contactlist_exportTableControlRow>
</ITEMTEMPLATE>
	...
	<asp:hiddenfield id="Vw_contactlist_exportTableControl_PostbackTracker" runat="server" />
</OEMConversion:Vw_contactlist_exportTableControl>
