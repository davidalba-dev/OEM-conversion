...
// This file implements the code-behind class for Edit_Project_type.aspx.
// App_Code\Edit_Project_type.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Project_type
        : BaseApplicationPage
// Code-behind class for the Edit_Project_type page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Project_type()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetProject_typeRecordControl()
        {
            SetProject_typeRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Project Type");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Project_typeRecordControl":
                 SetProject_typeRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Project_typeRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetProject_typeRecordControl_Base()           
        
        {        
            if (Project_typeRecordControl.Visible)
            {
                Project_typeRecordControl.LoadData();
                Project_typeRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Project_typeRecordControl != null && this.Project_typeRecordControl.DataSource != null)
                  {
                        id = this.Project_typeRecordControl.DataSource.GetValue(this.Project_typeRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Project_typeRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Project_typeRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Project_typeRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Project_typeRecordControl.DataSource.GetValue(this.Project_typeRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
