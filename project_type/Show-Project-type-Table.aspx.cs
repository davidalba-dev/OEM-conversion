...
// This file implements the code-behind class for Show_Project_type_Table.aspx.
// App_Code\Show_Project_type_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Project_type_Table
        : BaseApplicationPage
// Code-behind class for the Show_Project_type_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Project_type_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetProject_typeTableControl()
        {
            SetProject_typeTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Project_typeTableControl":
                 SetProject_typeTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Project_typeTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetProject_typeTableControl_Base()           
        
        {        
            if (Project_typeTableControl.Visible)
            {
                Project_typeTableControl.LoadData();
                Project_typeTableControl.DataBind();
            }
        }
