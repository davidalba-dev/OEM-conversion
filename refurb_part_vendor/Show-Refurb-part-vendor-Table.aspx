...
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_Refurb_part_vendor_Table" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-Refurb-part-vendor-Table.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Show_Refurb_part_vendor_Table" %><asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
...
<asp:DropDownList runat="server" id="refurb_part_vendor_activeFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre">
                    <table id="Refurb_part_vendorTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" colspan="2"></th><th class="thc"><asp:Literal runat="server" id="refurb_part_vendor_nameLabel" Text="EvaluateFormula(&quot;= \&quot;Vendor Name\&quot;&quot;, true)">	</asp:Literal></th><th class="thc"><asp:Literal runat="server" id="refurb_part_vendor_address1Label" Text="EvaluateFormula(&quot;= \&quot;Address\&quot;&quot;, true)">	</asp:Literal></th><th class="thc"><asp:Literal runat="server" id="refurb_part_vendor_phoneLabel" Text="EvaluateFormula(&quot;= \&quot;Phone\&quot;&quot;, true)">	</asp:Literal></th><th class="thc"><asp:LinkButton runat="server" id="refurb_part_vendor_faxLabel" tooltip="Sort by refurb_part_vendor_fax" Text="EvaluateFormula(&quot;= \&quot;Fax\&quot;&quot;, true)" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="refurb_part_vendor_emailLabel" tooltip="Sort by refurb_part_vendor_email" Text="EvaluateFormula(&quot;= \&quot;Email\&quot;&quot;, true)" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:Literal runat="server" id="refurb_part_vendor_webLabel" Text="EvaluateFormula(&quot;= \&quot;Web\&quot;&quot;, true)">	</asp:Literal></th><th class="thc"><asp:Literal runat="server" id="refurb_part_vendor_activeLabel" Text="EvaluateFormula(&quot;= \&quot;Vendor Active\&quot;&quot;, true)">	</asp:Literal></th></tr><asp:Repeater runat="server" id="Refurb_part_vendorTableControlRepeater">		<ITEMTEMPLATE>		<OEMConversion:Refurb_part_vendorTableControlRow runat="server" id="Refurb_part_vendorTableControlRow">
<tr><td class="tableRowButtonsCellVertical" scope="row" style="font-size: 5px;" colspan="2">
                                ...
                                </td><td class="tableCellValue"><asp:Literal runat="server" id="refurb_part_vendor_name"></asp:Literal> </td><td class="tableCellValue"><asp:Literal runat="server" id="refurb_part_vendor_address1"></asp:Literal><br> 
<asp:Literal runat="server" id="refurb_part_vendor_address2"></asp:Literal><br> 
<asp:Literal runat="server" id="refurb_part_vendor_city"></asp:Literal> <asp:LinkButton runat="server" id="refurb_part_vendor_state_id" causesvalidation="False" commandname="Redirect"></asp:LinkButton> <asp:Literal runat="server" id="refurb_part_vendor_zip"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="refurb_part_vendor_phone"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="refurb_part_vendor_fax"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="refurb_part_vendor_email"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="refurb_part_vendor_web"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="refurb_part_vendor_active"></asp:Literal></td></tr><tr><td class="tableRowDivider" colspan="9"></td></tr></OEMConversion:Refurb_part_vendorTableControlRow>
</ITEMTEMPLATE>
