...
// This file implements the code-behind class for Edit_Refurb_part_vendor_Table.aspx.
// App_Code\Edit_Refurb_part_vendor_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Refurb_part_vendor_Table
        : BaseApplicationPage
// Code-behind class for the Edit_Refurb_part_vendor_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Refurb_part_vendor_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetRefurb_part_vendorTableControl()
        {
            SetRefurb_part_vendorTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Refurb Part Vendor");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Refurb_part_vendorTableControl":
                 SetRefurb_part_vendorTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Refurb_part_vendorTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Edit_Refurb_part_vendor_Table.Refurb_part_vendorTableControl control = new OEMConversion.UI.Controls.Edit_Refurb_part_vendor_Table.Refurb_part_vendorTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRefurb_part_vendorTableControl_Base()           
        
        {        
            if (Refurb_part_vendorTableControl.Visible)
            {
                Refurb_part_vendorTableControl.LoadData();
                Refurb_part_vendorTableControl.DataBind();
            }
        }
