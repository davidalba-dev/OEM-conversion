<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Edit_Refurb_part_vendor" %>

<%@ Register Namespace="OEMConversion.UI" TagPrefix="custom" %>
<%@ Register Tagprefix="Selectors" Namespace="OEMConversion" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Edit-Refurb-part-vendor.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Edit_Refurb_part_vendor" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title0" Text="&lt;%#String.Concat(GetResourceValue(&quot;Title:Edit&quot;),&quot;&quot;,&quot; Refurb Part Vendor&quot;) %>">	</asp:Literal>
                      </td></tr></table>
...
<asp:TextBox runat="server" id="refurb_part_vendor_address1" Columns="40" MaxLength="50" cssclass="field_input"></asp:TextBox>&nbsp;
...
<asp:TextBox runat="server" id="refurb_part_vendor_phone" Columns="12" MaxLength="12" cssclass="field_input"></asp:TextBox>&nbsp;
...
<asp:TextBox runat="server" id="refurb_part_vendor_address2" Columns="40" MaxLength="50" cssclass="field_input"></asp:TextBox>&nbsp;
...
<asp:TextBox runat="server" id="refurb_part_vendor_city" Columns="40" MaxLength="50" cssclass="field_input"></asp:TextBox>&nbsp;
...
<asp:TextBox runat="server" id="refurb_part_vendor_web" Columns="40" MaxLength="50" cssclass="field_input"></asp:TextBox>&nbsp;
...
<asp:DropDownList runat="server" id="refurb_part_vendor_state_id" cssclass="field_input" onkeypress="dropDownListTypeAhead(this,false)"></asp:DropDownList></span>
...
<asp:TextBox runat="server" id="refurb_part_vendor_zip" Columns="10" MaxLength="10" cssclass="field_input"></asp:TextBox>&nbsp;
