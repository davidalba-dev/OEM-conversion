...
// This file implements the code-behind class for Group_By_Technicians_Table.aspx.
// App_Code\Group_By_Technicians_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Group_By_Technicians_Table
        : BaseApplicationPage
// Code-behind class for the Group_By_Technicians_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Group_By_Technicians_Table()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Group_By_Technicians_Table.TechniciansTableControl control = new OEMConversion.UI.Controls.Group_By_Technicians_Table.TechniciansTableControl();
