<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_Technicians_Table" %>

<%@ Register Tagprefix="OEMConversion" TagName="ThemeButtonWithArrow" Src="../Shared/ThemeButtonWithArrow.ascx" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-Technicians-Table.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Show_Technicians_Table" %>
...
<BaseClasses:QuickSelector runat="server" id="TechInitialsFilter" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single">	</BaseClasses:QuickSelector><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="TechniciansTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" colspan="2"><img src="../Images/space.gif" height="1" width="1" alt="" /></th><th class="thc"><asp:LinkButton runat="server" id="TechNameLabel" tooltip="Sort by TechName" Text="EvaluateFormula(&quot;= \&quot;Technician Name\&quot;&quot;, true)" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="TechEmailLabel" tooltip="Sort by TechEmail" Text="EvaluateFormula(&quot;= \&quot;Email\&quot;&quot;, true)" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="TechInitialsLabel" tooltip="Sort by TechInitials" Text="EvaluateFormula(&quot;= \&quot;Initials\&quot;&quot;, true)" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="technician_activeLabel" tooltip="Sort by technician_active" Text="Technician Active" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="technician_login_statusLabel" tooltip="Sort by technician_login_status" Text="Login Status" CausesValidation="False">	</asp:LinkButton></th></tr><asp:Repeater runat="server" id="TechniciansTableControlRepeater">		<ITEMTEMPLATE>		<OEMConversion:TechniciansTableControlRow runat="server" id="TechniciansTableControlRow">
<tr><td class="tableRowButtonsCellVertical" scope="row" style="font-size: 5px;" colspan="2">
                                ...
                                </td><td class="tableCellValue"><asp:Literal runat="server" id="TechName"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="TechEmail"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="TechInitials"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="technician_active"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="technician_login_status"></asp:Literal></td></tr></OEMConversion:TechniciansTableControlRow>
</ITEMTEMPLATE>
