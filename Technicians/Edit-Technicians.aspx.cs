...
// This file implements the code-behind class for Edit_Technicians.aspx.
// App_Code\Edit_Technicians.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Technicians
        : BaseApplicationPage
// Code-behind class for the Edit_Technicians page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Technicians()
        {
            this.Initialize();
...
//        public void SetTechniciansTabContainer()
//        {
//            SetTechniciansTabContainer_Base(); 
//        }
...
public void SetTechnician_teamTableControl()
        {
            SetTechnician_teamTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Technicians");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Technician_teamTableControl":
        ...
        SetTechniciansRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "TechniciansMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetTechnician_teamTableControl_Base()           
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.TechniciansRecordControl != null && this.TechniciansRecordControl.DataSource != null)
                  {
                        id = this.TechniciansRecordControl.DataSource.GetValue(this.TechniciansRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.TechniciansRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.TechniciansRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.TechniciansRecordControl.DataSource, null,variables);
                        }
                        else if (displayFieldName == "") 
                        {
                            value = id;
                        ...
                        {
                            value = this.TechniciansRecordControl.DataSource.GetValue(this.TechniciansRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
