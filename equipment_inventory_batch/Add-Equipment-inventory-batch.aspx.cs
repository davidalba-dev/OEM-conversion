...
// This file implements the code-behind class for Add_Equipment_inventory_batch.aspx.
// App_Code\Add_Equipment_inventory_batch.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Equipment_inventory_batch
        : BaseApplicationPage
// Code-behind class for the Add_Equipment_inventory_batch page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Equipment_inventory_batch()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Equipment Inventory Batch");
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
      ...
      this.RedirectBack();
        ...
        public void SaveButton_Click_Base(object sender, EventArgs args)
        {
            ...
            string url = @"../equipment_inventory_batch/Import-Equipment-inventory-batch.aspx?equipment_inventory_batch={Equipment_inventory_batchRecordControl:PK}";
