...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Edit-Equipment-inventory-batch-barcode.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Edit_Equipment_inventory_batch_barcode" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Tagprefix="BaseClasses" Namespace="BaseClasses.Web.UI.WebControls" Assembly="BaseClasses" %>
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Edit_Equipment_inventory_batch_barcode" %>
...
<asp:TextBox runat="server" id="oem_ein" MaxLength="50" columns="10" cssclass="field_input"></asp:TextBox>&nbsp;
...
<asp:TextBox runat="server" id="purchase_price" Columns="20" MaxLength="31" cssclass="field_input" requiredroles="&lt;PRoles>3&lt;/PRoles>"></asp:TextBox></td>
<td>
&nbsp;
...
</td><td class="tableCellValue"><asp:CheckBox runat="server" id="accessories"></asp:CheckBox></td><td class="tableCellValue"><asp:CheckBox runat="server" id="phi"></asp:CheckBox></td><td class="tableCellValue" style="text-align:center;"><asp:CheckBox runat="server" id="oem_barcode_approve"></asp:CheckBox></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
</td></tr><tr><td class="tableCellValue" colspan="9"><asp:TextBox runat="server" id="comment" MaxLength="1000" columns="100" cssclass="field_input" rows="1" textmode="MultiLine"></asp:TextBox>&nbsp;
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="commentTextBoxMaxLengthValidator" ControlToValidate="comment" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;OEMConversion&quot;).Replace(&quot;{FieldName}&quot;, &quot;Comment&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableRowDivider" colspan="6"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td></tr></OEMConversion:Equipment_inventory_batch_detailTableControlRow>
</ITEMTEMPLATE>
...
<tr><td class="tableRowButtonsCellVertical" scope="row" style="font-size: 5px;" rowspan="2">
                                ...
                                </td><td class="tableCellValue"></td><td class="tableCellLabel"><span style="white-space:nowrap;">
<asp:TextBox runat="server" id="EIN1" Columns="25" MaxLength="25" cssclass="field_input"></asp:TextBox>&nbsp;
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="EIN1TextBoxMaxLengthValidator" ControlToValidate="EIN1" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;OEMConversion&quot;).Replace(&quot;{FieldName}&quot;, &quot;EIN&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></span>
</td><td class="tableCellLabel"><span style="white-space:nowrap;">
<asp:TextBox runat="server" id="serial_number1" Columns="25" MaxLength="25" cssclass="field_input"></asp:TextBox>&nbsp;
...
<asp:DropDownList runat="server" id="make1" cssclass="field_input" onkeypress="dropDownListTypeAhead(this,false)"></asp:DropDownList></span>
</td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:DropDownList runat="server" id="model1" cssclass="field_input" onkeypress="dropDownListTypeAhead(this,false)"></asp:DropDownList></span>
</td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:DropDownList runat="server" id="condition_id1" cssclass="field_input" onkeypress="dropDownListTypeAhead(this,false)"></asp:DropDownList></span>
</td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
<asp:TextBox runat="server" id="purchase_price1" Columns="20" MaxLength="31" cssclass="field_input"></asp:TextBox></td>
<td>
&nbsp;
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="purchase_price1TextBoxMaxLengthValidator" ControlToValidate="purchase_price1" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;OEMConversion&quot;).Replace(&quot;{FieldName}&quot;, EvaluateFormula(&quot;= \&quot;Bid Price\&quot;&quot;, true)) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
</tr>
</table>
</span>
 </td><td class="tableCellValue"><asp:CheckBox runat="server" id="accessories1"></asp:CheckBox></td><td class="tableCellValue"><asp:CheckBox runat="server" id="phi1"></asp:CheckBox></td><td class="tableCellValue"><asp:CheckBox runat="server" id="accepted1"></asp:CheckBox></td><td class="tableCellValue" style="text-align:center;"><asp:CheckBox runat="server" id="oem_barcode_approve1"></asp:CheckBox></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
</td></tr><tr><td class="tableCellValue" colspan="11"><asp:TextBox runat="server" id="comment1" MaxLength="1000" columns="100" cssclass="field_input" rows="1" textmode="MultiLine"></asp:TextBox>&nbsp;
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="comment1TextBoxMaxLengthValidator" ControlToValidate="comment1" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;OEMConversion&quot;).Replace(&quot;{FieldName}&quot;, &quot;Comment&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td><td class="tableCellValue"></td></tr><tr><td class="tableRowDivider" colspan="6"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td></tr></OEMConversion:Equipment_inventory_batch_detailTableControl1Row>
</ITEMTEMPLATE>
