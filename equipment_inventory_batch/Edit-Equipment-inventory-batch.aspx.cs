...
// This file implements the code-behind class for Edit_Equipment_inventory_batch.aspx.
// App_Code\Edit_Equipment_inventory_batch.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Equipment_inventory_batch
        : BaseApplicationPage
// Code-behind class for the Edit_Equipment_inventory_batch page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Equipment_inventory_batch()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetEquipment_inventory_batchRecordControl()
        {
            SetEquipment_inventory_batchRecordControl_Base(); 
        }
...
//[System.Web.Services.WebMethod]
//        public static string[] GetAutoCompletionList_Equipment_inventory_batch_detailSearchText(string prefixText, int count)
//        {
//            // GetEquipment_inventory_batch_detailSearchTextCompletionList gets the list of suggestions from the database.
//            // prefixText is the search text typed by the user .
//            // count specifies the number of suggestions to be returned.
//            // Customize by adding code before or after the call to  GetAutoCompletionList_Equipment_inventory_batch_detailSearchText_Base()
//            // or replace the call to GetAutoCompletionList_Equipment_inventory_batch_detailSearchText_Base().
//            return GetAutoCompletionList_Equipment_inventory_batch_detailSearchText_Base(prefixText, count);
//        }
//[System.Web.Services.WebMethod]
//        public static string[] GetAutoCompletionList_Equipment_inventory_batch_detailSearchText1(string prefixText, int count)
//        {
//            // GetEquipment_inventory_batch_detailSearchText1CompletionList gets the list of suggestions from the database.
//            // prefixText is the search text typed by the user .
//            // count specifies the number of suggestions to be returned.
//            // Customize by adding code before or after the call to  GetAutoCompletionList_Equipment_inventory_batch_detailSearchText1_Base()
//            // or replace the call to GetAutoCompletionList_Equipment_inventory_batch_detailSearchText1_Base().
//            return GetAutoCompletionList_Equipment_inventory_batch_detailSearchText1_Base(prefixText, count);
//        }
#endregion
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Equipment Inventory Batch");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Equipment_inventory_batchRecordControl":
                 SetEquipment_inventory_batchRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Equipment_inventory_batchRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetEquipment_inventory_batchRecordControl_Base()           
        
        {        
            if (Equipment_inventory_batchRecordControl.Visible)
            {
                Equipment_inventory_batchRecordControl.LoadData();
                Equipment_inventory_batchRecordControl.DataBind();
            }
        }
