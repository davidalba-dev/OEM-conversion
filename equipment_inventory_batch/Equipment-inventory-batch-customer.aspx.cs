...
// This file implements the code-behind class for Equipment_inventory_batch_customer.aspx.
// App_Code\Equipment_inventory_batch_customer.Controls.vb contains the Table, Row and Record control classes
...
public partial class Equipment_inventory_batch_customer
        : BaseApplicationPage
// Code-behind class for the Equipment_inventory_batch_customer page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Equipment_inventory_batch_customer()
        {
            this.Initialize();
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Equipment_inventory_batchRecordControl != null && this.Equipment_inventory_batchRecordControl.DataSource != null)
                  {
                        id = this.Equipment_inventory_batchRecordControl.DataSource.GetValue(this.Equipment_inventory_batchRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Equipment_inventory_batchRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Equipment_inventory_batchRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Equipment_inventory_batchRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Equipment_inventory_batchRecordControl.DataSource.GetValue(this.Equipment_inventory_batchRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
