...
// This file implements the code-behind class for Show_Help_Table.aspx.
// App_Code\Show_Help_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Help_Table
        : BaseApplicationPage
// Code-behind class for the Show_Help_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Help_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetHelpTableControl()
        {
            SetHelpTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SaveData_Base()
      {
        ...
        this.HelpTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Help_Table.HelpTableControl control = new OEMConversion.UI.Controls.Show_Help_Table.HelpTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetHelpTableControl_Base()           
        
        {        
            if (HelpTableControl.Visible)
            {
                HelpTableControl.LoadData();
                HelpTableControl.DataBind();
            }
        }
