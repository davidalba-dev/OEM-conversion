...
// This file implements the code-behind class for Edit_Help.aspx.
// App_Code\Edit_Help.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Help
        : BaseApplicationPage
// Code-behind class for the Edit_Help page.
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetHelpRecordControl()
        {
            SetHelpRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Help");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "HelpRecordControl":
                 SetHelpRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.HelpRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetHelpRecordControl_Base()           
        
        {        
            if (HelpRecordControl.Visible)
            {
                HelpRecordControl.LoadData();
                HelpRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.HelpRecordControl != null && this.HelpRecordControl.DataSource != null)
                  {
                        id = this.HelpRecordControl.DataSource.GetValue(this.HelpRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.HelpRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.HelpRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.HelpRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.HelpRecordControl.DataSource.GetValue(this.HelpRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
