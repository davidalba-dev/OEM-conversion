...
// This file implements the code-behind class for Show_Dotmed_process_Table.aspx.
// App_Code\Show_Dotmed_process_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Dotmed_process_Table
        : BaseApplicationPage
// Code-behind class for the Show_Dotmed_process_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Dotmed_process_Table()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Dotmed_processTableControl":
                 SetDotmed_processTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Dotmed_processTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetDotmed_processTableControl_Base()           
        
        {        
            if (Dotmed_processTableControl.Visible)
            {
                Dotmed_processTableControl.LoadData();
                Dotmed_processTableControl.DataBind();
            }
        }
