<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Procurement-request-status-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="OEMConversion.UI.Procurement_request_status_QuickSelector" %>
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Procurement_request_status_QuickSelector" %>
