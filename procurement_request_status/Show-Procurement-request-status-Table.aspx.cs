...
// This file implements the code-behind class for Show_Procurement_request_status_Table.aspx.
// App_Code\Show_Procurement_request_status_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Procurement_request_status_Table
        : BaseApplicationPage
// Code-behind class for the Show_Procurement_request_status_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Procurement_request_status_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetProcurement_request_statusTableControl()
        {
            SetProcurement_request_statusTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = "Procurement Request Status";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Procurement_request_statusTableControl":
                 SetProcurement_request_statusTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Procurement_request_statusTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetProcurement_request_statusTableControl_Base()           
        
        {        
            if (Procurement_request_statusTableControl.Visible)
            {
                Procurement_request_statusTableControl.LoadData();
                Procurement_request_statusTableControl.DataBind();
            }
        }
