...
// This file implements the code-behind class for Edit_Procurement_request_status.aspx.
// App_Code\Edit_Procurement_request_status.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Procurement_request_status
        : BaseApplicationPage
// Code-behind class for the Edit_Procurement_request_status page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Procurement_request_status()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetProcurement_request_statusRecordControl()
        {
            SetProcurement_request_statusRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Procurement Request Status");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Procurement_request_statusRecordControl":
                 SetProcurement_request_statusRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Procurement_request_statusRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetProcurement_request_statusRecordControl_Base()           
        
        {        
            if (Procurement_request_statusRecordControl.Visible)
            {
                Procurement_request_statusRecordControl.LoadData();
                Procurement_request_statusRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Procurement_request_statusRecordControl != null && this.Procurement_request_statusRecordControl.DataSource != null)
                  {
                        id = this.Procurement_request_statusRecordControl.DataSource.GetValue(this.Procurement_request_statusRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Procurement_request_statusRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Procurement_request_statusRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Procurement_request_statusRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Procurement_request_statusRecordControl.DataSource.GetValue(this.Procurement_request_statusRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
