...
// This file implements the code-behind class for Show_Repair_order_request_Table_Customer.aspx.
// App_Code\Show_Repair_order_request_Table_Customer.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Repair_order_request_Table_Customer
        : BaseApplicationPage
// Code-behind class for the Show_Repair_order_request_Table_Customer page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Repair_order_request_Table_Customer()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = "Repair Order Request";
      ...
      public void SaveData_Base()
      {
        ...
        this.Repair_order_requestTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Repair_order_request_Table_Customer.Repair_order_requestTableControl control = new OEMConversion.UI.Controls.Show_Repair_order_request_Table_Customer.Repair_order_requestTableControl();
