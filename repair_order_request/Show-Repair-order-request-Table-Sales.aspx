...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-Repair-order-request-Table-Sales.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Show_Repair_order_request_Table_Sales" %>
<%@ Register Tagprefix="BaseClasses" Namespace="BaseClasses.Web.UI.WebControls" Assembly="BaseClasses" %>
<%@ Register Tagprefix="OEMConversion" TagName="PaginationModern" Src="../Shared/PaginationModern.ascx" %>

<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_Repair_order_request_Table_Sales" %>
			...
			<ContentTemplate>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="updatePanelContent"><tr><td>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title" Text="&lt;%#String.Concat(&quot;Repair Order Request&quot;) %>">	</asp:Literal>
                      </td></tr></table>
...
<asp:LinkButton runat="server" id="custno" causesvalidation="False" commandname="Redirect"></asp:LinkButton></span>
 </td><td class="tableCellValue"><asp:Literal runat="server" id="serialno"></asp:Literal> </td><td class="tableCellValue"><asp:Literal runat="server" id="repair_request_po"></asp:Literal></td><td class="tableCellValue"><asp:LinkButton runat="server" id="requestor" causesvalidation="False" commandname="Redirect"></asp:LinkButton></td><td class="tableCellValue"><asp:Literal runat="server" id="request_method"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="cust_dept_id"></asp:Literal></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="repair_request_notesLabel" Text="Repair Request Notes">	</asp:Literal> 
</td><td class="tableCellValue" colspan="3"><asp:Literal runat="server" id="repair_request_notes"></asp:Literal> </td><td class="tableCellValue"></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableRowDivider" colspan="5"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td></tr></OEMConversion:Repair_order_requestTableControlRow>
</ITEMTEMPLATE>
