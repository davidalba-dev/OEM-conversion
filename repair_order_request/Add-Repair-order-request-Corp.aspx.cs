...
// This file implements the code-behind class for Add_Repair_order_request_Corp.aspx.
// App_Code\Add_Repair_order_request_Corp.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Repair_order_request_Corp
        : BaseApplicationPage
// Code-behind class for the Add_Repair_order_request_Corp page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Repair_order_request_Corp()
        {
            this.Initialize();
...
#region "Ajax Functions"
    ...
    public void SendEmailOnSaveButton_Click()
    {
      ...
      SendEmailOnSaveButton_Click_Base();
        ...
        public void SetRepair_order_requestRecordControl()
        {
            SetRepair_order_requestRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Repair Order Request");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Repair_order_requestRecordControl":
                 SetRepair_order_requestRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Repair_order_requestRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRepair_order_requestRecordControl_Base()           
        
        {        
            if (Repair_order_requestRecordControl.Visible)
            {
                Repair_order_requestRecordControl.LoadData();
                Repair_order_requestRecordControl.DataBind();
            }
        }
      ...
      this.RedirectBack();
        ...
        public void SaveButton_Click_Base(object sender, EventArgs args)
        {
            ...
            string url = @"../repair_order_request/Confirm-Repair-order-request.aspx?repair_order_request={Repair_order_requestRecordControl:PK}";
    ...
    public  void SendEmailOnSaveButton_Click_Base()
        ...
        SendEmail1To = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("oeminfo%40oemmed.com++++%3coeminfo%40oemmed.com%3e"), "" ,false);

          
        string SendEmail1CC;
        SendEmail1CC = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("kplante%40oemmed.com++++%3ckplante%40oemmed.com%3e"), "", false);
          
        string SendEmail1Subject;
        //In case Subject includes expressions substitute them with values
        SendEmail1Subject = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("OEM+Medical+Solutions+-+Repair+Request+Form"), "", false);
          
        string SendEmail1Content;
        //In case content has expressions substitude then with values
        SendEmail1Content = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("The+following+Repair+Request+form+has+been+submitted%3a%0d%0a%0d%0aCustomer%3a++%7bRepair_order_requestRecordControl%3aNoUrlEncode%3aFDV%3acustno%7d%0d%0aDept%3a%7bRepair_order_requestRecordControl%3aNoUrlEncode%3aFDV%3acust_dept_id%7d%0d%0aPurchase+Order%3a%7bRepair_order_requestRecordControl%3aNoUrlEncode%3aFDV%3arepair_request_po%7d%0d%0aRequest+Method%3a%7bRepair_order_requestRecordControl%3aNoUrlEncode%3aFDV%3arequest_method%7d%0d%0aSerial+Num%3a+%7bRepair_order_requestRecordControl%3aNoUrlEncode%3aFDV%3aserialno%7d%0d%0aRequestor%3a+%7bRepair_order_requestRecordControl%3aNoUrlEncode%3aFDV%3arequestor%7d%0d%0aMake%3a%7bRepair_order_requestRecordControl%3aNoUrlEncode%3aFDV%3amake%7d%0d%0aModel%3a%7bRepair_order_requestRecordControl%3aNoUrlEncode%3aFDV%3amodel%7d%0d%0aNotes%3a+%7bRepair_order_requestRecordControl%3aNoUrlEncode%3aFDV%3arepair_request_notes%7d%0d%0aStatus%3a+%7bRepair_order_requestRecordControl%3aNoUrlEncode%3aFDV%3aclean_status%7d"), "", false);
        ...
        // For page control
        string SendEmail2From;
        //If From Address has from of expression {SomeRecordControl:FK:Email}
        //substitute expression with actuall value
        //Email address can have format "Display Name <emailAddress@companyName.com>"
        SendEmail2From = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("OEMInfo%40oemmed.com"), "", false);

        string SendEmail2To;
        //Email Addresses should be separated by comma
        //Display Name <emailAddress@companyName.com>,Display Name <emailAddress@companyName.com> or
        //emalAddress1@companyname.com,emalAddress2@companyname.com
        SendEmail2To = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("%7bLoginRecordControl%3aNoUrlEncode%3aFV%3auser_email%7d+%3c%7bLoginRecordControl%3aNoUrlEncode%3aFV%3auser_email%7d%3e"), "" ,false);

          
        string SendEmail2Subject;
        //In case Subject includes expressions substitute them with values
        SendEmail2Subject = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("OEM+MED-+Repair+Order+Request"), "", false);
          
        string SendEmail2Content;
        //In case content has expressions substitude then with values
        SendEmail2Content = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("Thank+you+we+have+received+your+Repair+Order+Request+and+will+begin+processing+your+request.%0d%0a%0d%0aIf+you+have+any+questions+please+contact+us+oeminfo%40oemmed.com+or++410-574-1729%0d%0a%0d%0aYou+may+track+the+status+and+updates+to+your+Repair+Order+Request+online+at+http%3a%2f%2fexpertech.oemmed.com"), "", false);
            
        email = new BaseClasses.Utils.MailSenderInThread();
        email.AddFrom(SendEmail2From);
        email.AddTo(SendEmail2To);
          
        email.SetSubject(SendEmail2Subject);
          
        email.SetContent(SendEmail2Content);
