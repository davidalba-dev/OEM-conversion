...
// This file implements the code-behind class for Edit_Repair_order_request.aspx.
// App_Code\Edit_Repair_order_request.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Repair_order_request
        : BaseApplicationPage
// Code-behind class for the Edit_Repair_order_request page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Repair_order_request()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Repair Order Request");
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Repair_order_requestRecordControl != null && this.Repair_order_requestRecordControl.DataSource != null)
                  {
                        id = this.Repair_order_requestRecordControl.DataSource.GetValue(this.Repair_order_requestRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Repair_order_requestRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Repair_order_requestRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Repair_order_requestRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Repair_order_requestRecordControl.DataSource.GetValue(this.Repair_order_requestRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
