...
// This file implements the code-behind class for Edit_Custom_notification.aspx.
// App_Code\Edit_Custom_notification.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Custom_notification
        : BaseApplicationPage
// Code-behind class for the Edit_Custom_notification page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Custom_notification()
        {
            this.Initialize();
...
//        public void SetCustom_notificationTabContainer()
//        {
//            SetCustom_notificationTabContainer_Base(); 
//        }
        
        public void SetCustom_notificationRecordControl()
        {
            SetCustom_notificationRecordControl_Base(); 
        }
        
//        public void SetNotification_logTableControl()
//        {
//            SetNotification_logTableControl_Base(); 
//        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Custom Notification");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Custom_notificationRecordControl":
                 SetCustom_notificationRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Custom_notificationRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetCustom_notificationRecordControl_Base()           
        
        {        
            if (Custom_notificationRecordControl.Visible)
            {
                Custom_notificationRecordControl.LoadData();
                Custom_notificationRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Custom_notificationRecordControl != null && this.Custom_notificationRecordControl.DataSource != null)
                  {
                        id = this.Custom_notificationRecordControl.DataSource.GetValue(this.Custom_notificationRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Custom_notificationRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Custom_notificationRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Custom_notificationRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Custom_notificationRecordControl.DataSource.GetValue(this.Custom_notificationRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
