...
// This file implements the code-behind class for Show_Custom_notification.aspx.
// App_Code\Show_Custom_notification.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Custom_notification
        : BaseApplicationPage
// Code-behind class for the Show_Custom_notification page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Custom_notification()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = "Custom Notification";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Notification_logTableControl":
    ...
    DbUtils.StartTransaction();
            ...
            SetCustom_notificationTabContainer(); 
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetCustom_notificationTabContainer_Base()           
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "Custom_notificationTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "Custom_notificationTabContainer").Visible = false;
        ...
        public void SetNotification_logTableControl_Base()           
