<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_Custom_notification" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-Custom-notification.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Show_Custom_notification" %><asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                        ...
                        <OEMConversion:Custom_notificationRecordControl runat="server" id="Custom_notificationRecordControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="panelTL"><img src="../Images/space.gif" class="panelTLSpace" alt="" /></td><td class="panelT"></td><td class="panelTR"><img src="../Images/space.gif" class="panelTRSpace" alt="" /></td></tr><tr><td class="panelHeaderL"></td><td class="dh">
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title" Text="&lt;%#String.Concat(&quot;Custom Notification&quot;) %>">	</asp:Literal>
                      </td><td class="dhir">
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><asp:panel id="Custom_notificationRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tableCellLabel"><asp:Literal runat="server" id="custom_notification_activeLabel" Text="Custom Notification Active">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="custom_notification_active"></asp:Literal> </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="custom_notification_msgLabel" Text="Custom Notification Message">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="custom_notification_msg"></asp:Literal> </td></tr></table></asp:panel>
</td></tr></table>
</asp:panel>
                </td><td class="panelR"></td></tr><tr><td class="panelBL"><img src="../Images/space.gif" class="panelBLSpace" alt="" /></td><td class="panelB"></td><td class="panelBR"><img src="../Images/space.gif" class="panelBRSpace" alt="" /></td></tr></table>
	<asp:hiddenfield id="Custom_notificationRecordControl_PostbackTracker" runat="server" />
</OEMConversion:Custom_notificationRecordControl>
...
</td></tr><tr><td><BaseClasses:TabContainer runat="server" id="Custom_notificationTabContainer" panellayout="Tabbed">
 <BaseClasses:TabPanel runat="server" id="Notification_logTabPanel" HeaderText="Notification Log">	<ContentTemplate>
  <OEMConversion:Notification_logTableControl runat="server" id="Notification_logTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="panelTL"><img src="../Images/space.gif" class="panelTLSpace" alt="" /></td><td class="panelT"></td><td class="panelTR"><img src="../Images/space.gif" class="panelTRSpace" alt="" /></td></tr><tr><td class="panelHeaderL"></td><td class="dh">
            ...
            <OEMConversion:ThemeButtonWithArrow runat="server" id="Filters1Button" button-causesvalidation="False" button-commandname="Custom" button-onclientclick="return ISD_ShowPopupPanel(&#39;Filters1Div&#39;,&#39;Filters1Button&#39;,this);" button-text="&lt;%# GetResourceValue(&quot;Btn:Filters&quot;, &quot;OEMConversion&quot;) %>" button-tooltip="&lt;%# GetResourceValue(&quot;Btn:Filters&quot;, &quot;OEMConversion&quot;) %>"></OEMConversion:ThemeButtonWithArrow>
                  ...
                  <asp:panel id="CollapsibleRegion1" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="Notification_logTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" colspan="2" style="display:none"><img src="../Images/space.gif" height="1" width="1" alt="" /></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th></tr><asp:Repeater runat="server" id="Notification_logTableControlRepeater">		<ITEMTEMPLATE>		<OEMConversion:Notification_logTableControlRow runat="server" id="Notification_logTableControlRow">
<tr><td class="tableRowButtonsCellVertical" scope="row" style="font-size: 5px;" rowspan="5" colspan="2">
                                ...
                                </td><td class="tableCellLabel"><asp:Literal runat="server" id="ronoLabel" Text="Rono">	</asp:Literal> 
</td><td class="tableCellValue"><asp:LinkButton runat="server" id="rono" causesvalidation="False" commandname="Redirect"></asp:LinkButton> </td><td class="tableCellLabel"><asp:Literal runat="server" id="notify1Label" Text="Notify 1">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="notify1"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="notify_datetimeLabel" Text="Notify Date And Time">	</asp:Literal> 
...
</td><td class="tableCellValue"><asp:LinkButton runat="server" id="custno" causesvalidation="False" commandname="Redirect"></asp:LinkButton> </td><td class="tableCellLabel"><asp:Literal runat="server" id="notify2Label" Text="Notify 2">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="notify2"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="notify3Label" Text="Notify 3">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="notify3"></asp:Literal> </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="notified_byLabel" Text="Notified By">	</asp:Literal> 
</td><td class="tableCellValue"><asp:LinkButton runat="server" id="notified_by" causesvalidation="False" commandname="Redirect"></asp:LinkButton> </td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="notify_messageLabel" Text="Notify Message">	</asp:Literal> 
</td><td class="tableCellValue" colspan="5"><asp:Literal runat="server" id="notify_message"></asp:Literal> </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="notify_urlLabel" Text="Notify URL">	</asp:Literal> 
</td><td class="tableCellValue" colspan="5"><asp:Literal runat="server" id="notify_url"></asp:Literal> </td></tr><tr><td class="tableRowDivider" colspan="8"></td></tr></OEMConversion:Notification_logTableControlRow>
</ITEMTEMPLATE>
