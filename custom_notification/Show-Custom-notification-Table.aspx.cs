...
// This file implements the code-behind class for Show_Custom_notification_Table.aspx.
// App_Code\Show_Custom_notification_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Custom_notification_Table
        : BaseApplicationPage
// Code-behind class for the Show_Custom_notification_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Custom_notification_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetCustom_notificationTableControl()
        {
            SetCustom_notificationTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Custom_notificationTableControl":
                 SetCustom_notificationTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Custom_notificationTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetCustom_notificationTableControl_Base()           
        
        {        
            if (Custom_notificationTableControl.Visible)
            {
                Custom_notificationTableControl.LoadData();
                Custom_notificationTableControl.DataBind();
            }
        }
