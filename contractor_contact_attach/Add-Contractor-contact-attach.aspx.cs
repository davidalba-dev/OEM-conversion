...
// This file implements the code-behind class for Add_Contractor_contact_attach.aspx.
// App_Code\Add_Contractor_contact_attach.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Contractor_contact_attach
        : BaseApplicationPage
// Code-behind class for the Add_Contractor_contact_attach page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Contractor_contact_attach()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetContractor_contact_attachRecordControl()
        {
            SetContractor_contact_attachRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Contractor Contact Attach");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Contractor_contact_attachRecordControl":
                 SetContractor_contact_attachRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Contractor_contact_attachRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetContractor_contact_attachRecordControl_Base()           
        
        {        
            if (Contractor_contact_attachRecordControl.Visible)
            {
                Contractor_contact_attachRecordControl.LoadData();
                Contractor_contact_attachRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Contractor_contact_attachRecordControl != null && this.Contractor_contact_attachRecordControl.DataSource != null)
                  {
                        id = this.Contractor_contact_attachRecordControl.DataSource.GetValue(this.Contractor_contact_attachRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Contractor_contact_attachRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Contractor_contact_attachRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Contractor_contact_attachRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Contractor_contact_attachRecordControl.DataSource.GetValue(this.Contractor_contact_attachRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
