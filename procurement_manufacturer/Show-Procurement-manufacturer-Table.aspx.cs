...
// This file implements the code-behind class for Show_Procurement_manufacturer_Table.aspx.
// App_Code\Show_Procurement_manufacturer_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Procurement_manufacturer_Table
        : BaseApplicationPage
// Code-behind class for the Show_Procurement_manufacturer_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Procurement_manufacturer_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetProcurement_manufacturerTableControl()
        {
            SetProcurement_manufacturerTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = "Procurement Manufacturer";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Procurement_manufacturerTableControl":
                 SetProcurement_manufacturerTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Procurement_manufacturerTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Procurement_manufacturer_Table.Procurement_manufacturerTableControl control = new OEMConversion.UI.Controls.Show_Procurement_manufacturer_Table.Procurement_manufacturerTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetProcurement_manufacturerTableControl_Base()           
        
        {        
            if (Procurement_manufacturerTableControl.Visible)
            {
                Procurement_manufacturerTableControl.LoadData();
                Procurement_manufacturerTableControl.DataBind();
            }
        }
