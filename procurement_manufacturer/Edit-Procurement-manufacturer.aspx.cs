...
// This file implements the code-behind class for Edit_Procurement_manufacturer.aspx.
// App_Code\Edit_Procurement_manufacturer.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Procurement_manufacturer
        : BaseApplicationPage
// Code-behind class for the Edit_Procurement_manufacturer page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Procurement_manufacturer()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetProcurement_manufacturerRecordControl()
        {
            SetProcurement_manufacturerRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Procurement Manufacturer");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Procurement_manufacturerRecordControl":
                 SetProcurement_manufacturerRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Procurement_manufacturerRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetProcurement_manufacturerRecordControl_Base()           
        
        {        
            if (Procurement_manufacturerRecordControl.Visible)
            {
                Procurement_manufacturerRecordControl.LoadData();
                Procurement_manufacturerRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Procurement_manufacturerRecordControl != null && this.Procurement_manufacturerRecordControl.DataSource != null)
                  {
                        id = this.Procurement_manufacturerRecordControl.DataSource.GetValue(this.Procurement_manufacturerRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Procurement_manufacturerRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Procurement_manufacturerRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Procurement_manufacturerRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Procurement_manufacturerRecordControl.DataSource.GetValue(this.Procurement_manufacturerRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
