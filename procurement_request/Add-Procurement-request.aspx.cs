...
// This file implements the code-behind class for Add_Procurement_request.aspx.
// App_Code\Add_Procurement_request.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Procurement_request
        : BaseApplicationPage
// Code-behind class for the Add_Procurement_request page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Procurement_request()
        {
            this.Initialize();
...
//        }
        ...
        public void SetProcurement_requestRecordControl()
        {
            SetProcurement_requestRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Procurement Request");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Procurement_requestRecordControl":
                 SetProcurement_requestRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Procurement_requestRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetProcurement_requestRecordControl_Base()           
        
        {        
            if (Procurement_requestRecordControl.Visible)
            {
                Procurement_requestRecordControl.LoadData();
                Procurement_requestRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Procurement_requestRecordControl != null && this.Procurement_requestRecordControl.DataSource != null)
                  {
                        id = this.Procurement_requestRecordControl.DataSource.GetValue(this.Procurement_requestRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Procurement_requestRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Procurement_requestRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Procurement_requestRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Procurement_requestRecordControl.DataSource.GetValue(this.Procurement_requestRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
    ...
    public  void SendEmailOnSaveButton_Click_Base()
        ...
        SendEmail1From = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("noreply%40noreply.com"), "", false);
