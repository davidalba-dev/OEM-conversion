<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Internal-Edit-Procurement-request-replace.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Internal_Edit_Procurement_request_replace" %>
...
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Internal_Edit_Procurement_request_replace" %>
...
</td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="department_idLabel1" Text="Department">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
</td><td class="tableCellValue"></td><td class="tableCellValue" colspan="2"><asp:Literal runat="server" id="Literal" Text="MyLiteral">	</asp:Literal><br> 
