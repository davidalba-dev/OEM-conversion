...
// This file implements the code-behind class for Internal_Show_Procurement_request_Table.aspx.
// App_Code\Internal_Show_Procurement_request_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Internal_Show_Procurement_request_Table
        : BaseApplicationPage
// Code-behind class for the Internal_Show_Procurement_request_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Internal_Show_Procurement_request_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetProcurement_requestTableControl()
        {
            SetProcurement_requestTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = "Procurement Request";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Procurement_requestTableControl":
                 SetProcurement_requestTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Procurement_requestTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetProcurement_requestTableControl_Base()           
        
        {        
            if (Procurement_requestTableControl.Visible)
            {
                Procurement_requestTableControl.LoadData();
                Procurement_requestTableControl.DataBind();
            }
        }
