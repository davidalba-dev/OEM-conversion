<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.CustomerContacts_QuickSelector" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="CustomerContacts-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="OEMConversion.UI.CustomerContacts_QuickSelector" %>
