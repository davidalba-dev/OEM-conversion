...
// This file implements the code-behind class for Edit_CustomerContacts.aspx.
// App_Code\Edit_CustomerContacts.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_CustomerContacts
        : BaseApplicationPage
// Code-behind class for the Edit_CustomerContacts page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_CustomerContacts()
        {
            this.Initialize();
...
public void SetLoginRecordControl()
        {
            SetLoginRecordControl_Base(); 
        }
public void SetSecurityTableControl()
        {
            SetSecurityTableControl_Base(); 
        }
public void SetTabContainer()
        {
            SetTabContainer_Base(); 
        }
public void SetCustomercontact_vendorTableControl()
        {
            SetCustomercontact_vendorTableControl_Base(); 
        }
[System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_Customercontact_vendorSearchText(string prefixText, int count)
        {
            // GetCustomercontact_vendorSearchTextCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_Customercontact_vendorSearchText_Base()
            // or replace the call to GetAutoCompletionList_Customercontact_vendorSearchText_Base().
            return GetAutoCompletionList_Customercontact_vendorSearchText_Base(prefixText, count);
        }
#endregion
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Customer Contacts");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Customercontact_vendorTableControl":
                 SetCustomercontact_vendorTableControl();
                 break;
          
              case "CustomerContactsRecordControl":
                 SetCustomerContactsRecordControl();
                 break;
          
              case "LoginRecordControl":
                 SetLoginRecordControl();
                 break;
          
              case "SecurityTableControl":
                 SetSecurityTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.CustomerContactsRecordControl.SaveData();
        
        this.LoginRecordControl.SaveData();
        
        this.SecurityTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_Customercontact_vendorSearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Edit_CustomerContacts.Customercontact_vendorTableControl control = new OEMConversion.UI.Controls.Edit_CustomerContacts.Customercontact_vendorTableControl();
        
        return control.GetAutoCompletionList_Customercontact_vendorSearchText(prefixText, count);
        ...
        SetSecurityTableControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "CustomerContactsMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetCustomercontact_vendorTableControl_Base()           
        
        {        
            if (Customercontact_vendorTableControl.Visible)
            {
                Customercontact_vendorTableControl.LoadData();
                Customercontact_vendorTableControl.DataBind();
            }
        }
      
        public void SetCustomerContactsRecordControl_Base()           
        ...
        public void SetLoginRecordControl_Base()           
        ...
        public void SetSecurityTableControl_Base()           
        
        {        
            if (SecurityTableControl.Visible)
            {
                SecurityTableControl.LoadData();
                SecurityTableControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.CustomerContactsRecordControl != null && this.CustomerContactsRecordControl.DataSource != null)
                  {
                        id = this.CustomerContactsRecordControl.DataSource.GetValue(this.CustomerContactsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.CustomerContactsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.CustomerContactsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.CustomerContactsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.CustomerContactsRecordControl.DataSource.GetValue(this.CustomerContactsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
                  ...
                  if (this.LoginRecordControl != null && this.LoginRecordControl.DataSource != null)
                  {
                        id = this.LoginRecordControl.DataSource.GetValue(this.LoginRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.LoginRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.LoginRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.LoginRecordControl.DataSource, null,variables);
                        }
                        else if (displayFieldName == "") 
                        {
                            value = id;
                        ...
                        {
                            value = this.LoginRecordControl.DataSource.GetValue(this.LoginRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
