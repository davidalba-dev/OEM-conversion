...
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_CustomerContacts_Table" %>

<%@ Register Tagprefix="Selectors" Namespace="OEMConversion" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-CustomerContacts-Table.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Show_CustomerContacts_Table" %>
			...
			<ContentTemplate>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="updatePanelContent"><tr><td>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title" Text="Facility Contacts">	</asp:Literal>
                      </td></tr></table>
...
<i><span style="font-size:8pt">Search Contacts: Contact Name, Phone </span></i>
...
<asp:DropDownList runat="server" id="CustNoFromFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList>
                        <span class="rft"></span>
                        <%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
                                ...
                                </td></tr><tr><td class="popupTableCellLabel"><asp:Literal runat="server" id="CustContactTypeLabel" Text="Customer Contact Type">	</asp:Literal></td><td class="popupTableCellValue"><asp:DropDownList runat="server" id="CustContactTypeFromFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList> <span class="rft"></span> </td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td></tr><tr><td class="popupTableCellLabel"><asp:Literal runat="server" id="CustContact_activeLabel1" Text="EvaluateFormula(&quot;= \&quot;Active\&quot;&quot;, true)">	</asp:Literal></td><td class="popupTableCellValue"><asp:DropDownList runat="server" id="CustContact_activeFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList> </td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td></tr><tr><td class="popupTableCellLabel"><asp:Label runat="server" id="SortByLabel" Text="&lt;%# GetResourceValue(&quot;Txt:SortBy&quot;, &quot;OEMConversion&quot;) %>">	</asp:Label></td><td class="popupTableCellValue"><asp:DropDownList runat="server" id="OrderSort" autopostback="True" cssclass="Filter_Input" priorityno="1">	</asp:DropDownList></td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td></tr></table>

                          </div>
                        </td><td class="dher"><img src="../Images/space.gif" alt="" /></td></tr></table>

                </td><td class="panelHeaderR"></td></tr><tr><td class="panelL"></td><td>
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="CustomerContactsTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)" class="TFtable"><tr class="tch"><th class="thc" colspan="2"><img src="../Images/space.gif" height="1" width="1" alt="" /></th><th class="thc"><asp:LinkButton runat="server" id="CustNoLabel" tooltip="Sort by CustNo" Text="EvaluateFormula(&quot;= \&quot;Customer\&quot;&quot;, true)" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="CustContactNameLabel" tooltip="Sort by CustContactName" Text="EvaluateFormula(&quot;= \&quot;Contact Name\&quot;&quot;, true)" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="CustContactTitleLabel" tooltip="Sort by CustContactTitle" Text="EvaluateFormula(&quot;= \&quot;Title\&quot;&quot;, true)" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="CustContactPhoneBusinessLabel" tooltip="Sort by CustContactPhoneBusiness" Text="EvaluateFormula(&quot;= \&quot;Phone\&quot;&quot;, true)" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="CustContactEmailLabel" tooltip="Sort by CustContactEmail" Text="EvaluateFormula(&quot;= \&quot;Email\&quot;&quot;, true)" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="CustContact_activeLabel" tooltip="Sort by CustContact_active" Text="EvaluateFormula(&quot;= \&quot;Active\&quot;&quot;, true)" CausesValidation="False">	</asp:LinkButton></th><th class="thc"></th><th class="thc"></th></tr><asp:Repeater runat="server" id="CustomerContactsTableControlRepeater">		<ITEMTEMPLATE>		<OEMConversion:CustomerContactsTableControlRow runat="server" id="CustomerContactsTableControlRow">
...
</td><td class="tableCellValue"><asp:Literal runat="server" id="CustContactName"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="CustContactTitle"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="CustContactPhoneBusiness"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="CustContactEmail"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="CustContact_active"></asp:Literal></td><td class="tableCellLabel"></td><td class="tableCellValue"></td></tr><tr><td class="tableRowDivider" colspan="10"></td></tr></OEMConversion:CustomerContactsTableControlRow>
</ITEMTEMPLATE>
