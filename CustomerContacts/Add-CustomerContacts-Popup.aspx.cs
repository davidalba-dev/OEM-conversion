...
// This file implements the code-behind class for Add_CustomerContacts_Popup.aspx.
// App_Code\Add_CustomerContacts_Popup.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_CustomerContacts_Popup
        : BaseApplicationPage
// Code-behind class for the Add_CustomerContacts_Popup page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_CustomerContacts_Popup()
        {
            this.Initialize();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
      ...
      this.RedirectBack();
        ...
        public void SaveButton_Click_Base(object sender, EventArgs args)
        {
            ...
            string url = @"../login/Add-Login-Customer.aspx?CustomerNo={CustomerContactsRecordControl:FV:CustNo}&customercontact_email={CustomerContactsRecordControl:FV:CustContactEmail}";
