<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Add_CustomerContacts_Popup" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Add-CustomerContacts-Popup.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Add_CustomerContacts_Popup" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title" Text="&lt;%#String.Concat(GetResourceValue(&quot;Title:Add&quot;),&quot;&quot;,&quot; Customer Contacts&quot;) %>">	</asp:Literal>
                      </td></tr></table>
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="CustContactEmailTextBoxMaxLengthValidator" ControlToValidate="CustContactEmail" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;OEMConversion&quot;).Replace(&quot;{FieldName}&quot;, EvaluateFormula(&quot;= \&quot;Email\&quot;&quot;, true)) %>"></BaseClasses:TextBoxMaxLengthValidator></span>
 </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="CustContact_APLabel" Text="EvaluateFormula(&quot;= \&quot;Receives Invoices\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><asp:CheckBox runat="server" id="CustContact_AP"></asp:CheckBox></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="CustContact_QSLabel" Text="EvaluateFormula(&quot;= \&quot;Receives Estimates\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><asp:CheckBox runat="server" id="CustContact_QS"></asp:CheckBox></td></tr><tr><td class="tableCellValue"><span style="white-space:nowrap;">
