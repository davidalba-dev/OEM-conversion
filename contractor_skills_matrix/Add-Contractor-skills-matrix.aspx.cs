...
// This file implements the code-behind class for Add_Contractor_skills_matrix.aspx.
// App_Code\Add_Contractor_skills_matrix.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Contractor_skills_matrix
        : BaseApplicationPage
// Code-behind class for the Add_Contractor_skills_matrix page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Contractor_skills_matrix()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetContractor_skills_matrixRecordControl()
        {
            SetContractor_skills_matrixRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Contractor Skills Matrix");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Contractor_skills_matrixRecordControl":
                 SetContractor_skills_matrixRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Contractor_skills_matrixRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetContractor_skills_matrixRecordControl_Base()           
        
        {        
            if (Contractor_skills_matrixRecordControl.Visible)
            {
                Contractor_skills_matrixRecordControl.LoadData();
                Contractor_skills_matrixRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Contractor_skills_matrixRecordControl != null && this.Contractor_skills_matrixRecordControl.DataSource != null)
                  {
                        id = this.Contractor_skills_matrixRecordControl.DataSource.GetValue(this.Contractor_skills_matrixRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Contractor_skills_matrixRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Contractor_skills_matrixRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Contractor_skills_matrixRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Contractor_skills_matrixRecordControl.DataSource.GetValue(this.Contractor_skills_matrixRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
