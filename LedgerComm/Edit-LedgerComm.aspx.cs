...
// This file implements the code-behind class for Edit_LedgerComm.aspx.
// App_Code\Edit_LedgerComm.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_LedgerComm
        : BaseApplicationPage
// Code-behind class for the Edit_LedgerComm page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_LedgerComm()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetLedgerCommRecordControl()
        {
            SetLedgerCommRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Ledger Commission");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "LedgerCommRecordControl":
                 SetLedgerCommRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.LedgerCommRecordControl.SaveData();
        ...
        SetLedgerCommRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "LedgerCommMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetLedgerCommRecordControl_Base()           
        
        {        
            if (LedgerCommRecordControl.Visible)
            {
                LedgerCommRecordControl.LoadData();
                LedgerCommRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.LedgerCommRecordControl != null && this.LedgerCommRecordControl.DataSource != null)
                  {
                        id = this.LedgerCommRecordControl.DataSource.GetValue(this.LedgerCommRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.LedgerCommRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.LedgerCommRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.LedgerCommRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.LedgerCommRecordControl.DataSource.GetValue(this.LedgerCommRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
