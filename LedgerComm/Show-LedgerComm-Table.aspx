...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-LedgerComm-Table.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Show_LedgerComm_Table" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Tagprefix="BaseClasses" Namespace="BaseClasses.Web.UI.WebControls" Assembly="BaseClasses" %>
<%@ Register Tagprefix="OEMConversion" TagName="PaginationModern" Src="../Shared/PaginationModern.ascx" %>

<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_LedgerComm_Table" %>
...
<asp:TextBox runat="server" id="LdgRecDateFromFilter" columns="15" cssclass="Filter_Input" onkeyup="DateFormat(this, this.value, event.keyCode, &#39;m/d/yyyy&#39;)" timestring="&quot;00:00:00&quot;" AutoPostback="False" style="vertical-align:middle">	</asp:TextBox>
	...
	<Selectors:CalendarExtendarClass runat="server" ID="LdgRecDateToFilterCalenderExtender" TargetControlID="LdgRecDateToFilter" CssClass="MyCalendar" Format="d">
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="LedgerCommTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" colspan="2" style="display:none"><img src="../Images/space.gif" height="1" width="1" alt="" /></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th></tr><asp:Repeater runat="server" id="LedgerCommTableControlRepeater">		<ITEMTEMPLATE>		<OEMConversion:LedgerCommTableControlRow runat="server" id="LedgerCommTableControlRow">
...
</td><td class="tableCellValue"><asp:Literal runat="server" id="LdgFormType"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="LdgSubjectLabel" Text="LDG Subject">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="LdgSubject"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="LdgRecDateLabel" Text="LDG Received Date">	</asp:Literal> 
</td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="LdgRecDate"></asp:Literal></span>
 </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="LdgCommTypeLabel" Text="LDG Commission Type">	</asp:Literal> 
</td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="LdgCommType"></asp:Literal></span>
 </td><td class="tableCellLabel"><asp:Literal runat="server" id="LdgFormNoLabel" Text="LDG Form Number">	</asp:Literal> 
</td><td class="tableCellValue"><span style="white-space:nowrap;">
...
</td><td class="tableCellValue" colspan="5"><asp:Literal runat="server" id="LdgAddress"></asp:Literal> </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="LdgAttachmentsLabel" Text="LDG Attachments">	</asp:Literal> 
</td><td class="tableCellValue" colspan="5"><asp:Literal runat="server" id="LdgAttachments"></asp:Literal> </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="LdgMessageLabel" Text="LDG Message">	</asp:Literal> 
</td><td class="tableCellValue" colspan="5"><asp:Literal runat="server" id="LdgMessage"></asp:Literal> </td></tr><tr><td class="tableRowDivider" colspan="8"></td></tr></OEMConversion:LedgerCommTableControlRow>
</ITEMTEMPLATE>
