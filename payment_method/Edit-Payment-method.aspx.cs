...
// This file implements the code-behind class for Edit_Payment_method.aspx.
// App_Code\Edit_Payment_method.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Payment_method
        : BaseApplicationPage
// Code-behind class for the Edit_Payment_method page.
...
//        public void SetPayment_methodTabContainer()
//        {
//            SetPayment_methodTabContainer_Base(); 
//        }
...
//        }
        ...
        public void SetPayment_methodRecordControl()
        {
            SetPayment_methodRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Payment Method");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Payment_methodRecordControl":
                 SetPayment_methodRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Payment_methodRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetPayment_methodRecordControl_Base()           
        
        {        
            if (Payment_methodRecordControl.Visible)
            {
                Payment_methodRecordControl.LoadData();
                Payment_methodRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Payment_methodRecordControl != null && this.Payment_methodRecordControl.DataSource != null)
                  {
                        id = this.Payment_methodRecordControl.DataSource.GetValue(this.Payment_methodRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Payment_methodRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Payment_methodRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Payment_methodRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Payment_methodRecordControl.DataSource.GetValue(this.Payment_methodRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
