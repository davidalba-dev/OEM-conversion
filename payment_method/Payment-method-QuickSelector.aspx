<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Payment-method-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="OEMConversion.UI.Payment_method_QuickSelector" %>
...
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Payment_method_QuickSelector" %>
