...
// This file implements the code-behind class for Show_Payment_method_Table.aspx.
// App_Code\Show_Payment_method_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Payment_method_Table
        : BaseApplicationPage
// Code-behind class for the Show_Payment_method_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Payment_method_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetPayment_methodTableControl()
        {
            SetPayment_methodTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Payment_methodTableControl":
                 SetPayment_methodTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Payment_methodTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetPayment_methodTableControl_Base()           
        
        {        
            if (Payment_methodTableControl.Visible)
            {
                Payment_methodTableControl.LoadData();
                Payment_methodTableControl.DataBind();
            }
        }
