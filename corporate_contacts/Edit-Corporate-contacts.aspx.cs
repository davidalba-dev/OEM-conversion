...
// This file implements the code-behind class for Edit_Corporate_contacts.aspx.
// App_Code\Edit_Corporate_contacts.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Corporate_contacts
        : BaseApplicationPage
// Code-behind class for the Edit_Corporate_contacts page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Corporate_contacts()
        {
            this.Initialize();
...
//        public void SetCorporate_contactsTabContainer()
//        {
//            SetCorporate_contactsTabContainer_Base(); 
//        }
        
        public void SetCorporate_contactsRecordControl()
        {
            SetCorporate_contactsRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Corporate Contacts");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Corporate_contactsRecordControl":
                 SetCorporate_contactsRecordControl();
                 break;
          
              case "LoginTableControl":
                 SetLoginTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Corporate_contactsRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetCorporate_contactsRecordControl_Base()           
        
        {        
            if (Corporate_contactsRecordControl.Visible)
            {
                Corporate_contactsRecordControl.LoadData();
                Corporate_contactsRecordControl.DataBind();
            }
        }
      
        public void SetLoginTableControl_Base()           
        
        {        
            if (LoginTableControl.Visible)
            {
                LoginTableControl.LoadData();
                LoginTableControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Corporate_contactsRecordControl != null && this.Corporate_contactsRecordControl.DataSource != null)
                  {
                        id = this.Corporate_contactsRecordControl.DataSource.GetValue(this.Corporate_contactsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Corporate_contactsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Corporate_contactsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Corporate_contactsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Corporate_contactsRecordControl.DataSource.GetValue(this.Corporate_contactsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
