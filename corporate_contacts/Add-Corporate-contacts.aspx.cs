...
// This file implements the code-behind class for Add_Corporate_contacts.aspx.
// App_Code\Add_Corporate_contacts.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Corporate_contacts
        : BaseApplicationPage
// Code-behind class for the Add_Corporate_contacts page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Corporate_contacts()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Corporate Contacts");
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
      ...
      this.RedirectBack();
        ...
        public void SaveButton_Click_Base(object sender, EventArgs args)
        {
            ...
            string url = @"../login/Add-Login-CorporateContact.aspx?corporatecontact={Corporate_contactsRecordControl:PK}&corporateid={Corporate_contactsRecordControl:FV:corporate_id}&corporatecontact_email={Corporate_contactsRecordControl:FV:corporatecontact_email}";
