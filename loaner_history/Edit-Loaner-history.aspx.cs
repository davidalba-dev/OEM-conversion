...
// This file implements the code-behind class for Edit_Loaner_history.aspx.
// App_Code\Edit_Loaner_history.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Loaner_history
        : BaseApplicationPage
// Code-behind class for the Edit_Loaner_history page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Loaner_history()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetLoaner_historyRecordControl()
        {
            SetLoaner_historyRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Loaner History");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Loaner_historyRecordControl":
                 SetLoaner_historyRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Loaner_historyRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetLoaner_historyRecordControl_Base()           
        
        {        
            if (Loaner_historyRecordControl.Visible)
            {
                Loaner_historyRecordControl.LoadData();
                Loaner_historyRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Loaner_historyRecordControl != null && this.Loaner_historyRecordControl.DataSource != null)
                  {
                        id = this.Loaner_historyRecordControl.DataSource.GetValue(this.Loaner_historyRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Loaner_historyRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Loaner_historyRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Loaner_historyRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Loaner_historyRecordControl.DataSource.GetValue(this.Loaner_historyRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
