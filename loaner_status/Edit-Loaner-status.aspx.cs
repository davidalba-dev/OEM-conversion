...
// This file implements the code-behind class for Edit_Loaner_status.aspx.
// App_Code\Edit_Loaner_status.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Loaner_status
        : BaseApplicationPage
// Code-behind class for the Edit_Loaner_status page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Loaner_status()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetLoaner_statusRecordControl()
        {
            SetLoaner_statusRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Loaner Status");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Loaner_statusRecordControl":
                 SetLoaner_statusRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Loaner_statusRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetLoaner_statusRecordControl_Base()           
        
        {        
            if (Loaner_statusRecordControl.Visible)
            {
                Loaner_statusRecordControl.LoadData();
                Loaner_statusRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Loaner_statusRecordControl != null && this.Loaner_statusRecordControl.DataSource != null)
                  {
                        id = this.Loaner_statusRecordControl.DataSource.GetValue(this.Loaner_statusRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Loaner_statusRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Loaner_statusRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Loaner_statusRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Loaner_statusRecordControl.DataSource.GetValue(this.Loaner_statusRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
