...
// This file implements the code-behind class for Add_Statuses.aspx.
// App_Code\Add_Statuses.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Statuses
        : BaseApplicationPage
// Code-behind class for the Add_Statuses page.
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetStatusesTabContainer()
        {
            SetStatusesTabContainer_Base(); 
        }
        ...
        public void SetStatusesRecordControl()
        {
            SetStatusesRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Statuses");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "StatusesRecordControl":
                 SetStatusesRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.StatusesRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetStatusesTabContainer_Base()           
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "StatusesTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "StatusesTabContainer").Visible = false;
        ...
        public void SetStatusesRecordControl_Base()           
        
        {        
            if (StatusesRecordControl.Visible)
            {
                StatusesRecordControl.LoadData();
                StatusesRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.StatusesRecordControl != null && this.StatusesRecordControl.DataSource != null)
                  {
                        id = this.StatusesRecordControl.DataSource.GetValue(this.StatusesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.StatusesRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.StatusesRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.StatusesRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.StatusesRecordControl.DataSource.GetValue(this.StatusesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
