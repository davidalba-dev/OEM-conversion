...
// This file implements the code-behind class for Edit_Refurb_parts.aspx.
// App_Code\Edit_Refurb_parts.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Refurb_parts
        : BaseApplicationPage
// Code-behind class for the Edit_Refurb_parts page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Refurb_parts()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetRefurb_partsRecordControl()
        {
            SetRefurb_partsRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Refurb Parts");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Refurb_partsRecordControl":
                 SetRefurb_partsRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Refurb_partsRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRefurb_partsRecordControl_Base()           
        
        {        
            if (Refurb_partsRecordControl.Visible)
            {
                Refurb_partsRecordControl.LoadData();
                Refurb_partsRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Refurb_partsRecordControl != null && this.Refurb_partsRecordControl.DataSource != null)
                  {
                        id = this.Refurb_partsRecordControl.DataSource.GetValue(this.Refurb_partsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Refurb_partsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Refurb_partsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Refurb_partsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Refurb_partsRecordControl.DataSource.GetValue(this.Refurb_partsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
