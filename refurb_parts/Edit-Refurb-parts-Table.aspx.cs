...
// This file implements the code-behind class for Edit_Refurb_parts_Table.aspx.
// App_Code\Edit_Refurb_parts_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Refurb_parts_Table
        : BaseApplicationPage
// Code-behind class for the Edit_Refurb_parts_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Refurb_parts_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetRefurb_partsTableControl()
        {
            SetRefurb_partsTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Refurb_partsTableControl":
                 SetRefurb_partsTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Refurb_partsTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Edit_Refurb_parts_Table.Refurb_partsTableControl control = new OEMConversion.UI.Controls.Edit_Refurb_parts_Table.Refurb_partsTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRefurb_partsTableControl_Base()           
        
        {        
            if (Refurb_partsTableControl.Visible)
            {
                Refurb_partsTableControl.LoadData();
                Refurb_partsTableControl.DataBind();
            }
        }
