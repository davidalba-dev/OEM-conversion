...
// This file implements the code-behind class for Add_Warehouse_location.aspx.
// App_Code\Add_Warehouse_location.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Warehouse_location
        : BaseApplicationPage
// Code-behind class for the Add_Warehouse_location page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Warehouse_location()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetWarehouse_locationRecordControl()
        {
            SetWarehouse_locationRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Warehouse Location");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Warehouse_locationRecordControl":
                 SetWarehouse_locationRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Warehouse_locationRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetWarehouse_locationRecordControl_Base()           
        
        {        
            if (Warehouse_locationRecordControl.Visible)
            {
                Warehouse_locationRecordControl.LoadData();
                Warehouse_locationRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Warehouse_locationRecordControl != null && this.Warehouse_locationRecordControl.DataSource != null)
                  {
                        id = this.Warehouse_locationRecordControl.DataSource.GetValue(this.Warehouse_locationRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Warehouse_locationRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Warehouse_locationRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Warehouse_locationRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Warehouse_locationRecordControl.DataSource.GetValue(this.Warehouse_locationRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
