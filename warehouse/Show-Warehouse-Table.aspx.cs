...
// This file implements the code-behind class for Show_Warehouse_Table.aspx.
// App_Code\Show_Warehouse_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Warehouse_Table
        : BaseApplicationPage
// Code-behind class for the Show_Warehouse_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Warehouse_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetWarehouseTableControl()
        {
            SetWarehouseTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "WarehouseTableControl":
                 SetWarehouseTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.WarehouseTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Warehouse_Table.WarehouseTableControl control = new OEMConversion.UI.Controls.Show_Warehouse_Table.WarehouseTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetWarehouseTableControl_Base()           
        
        {        
            if (WarehouseTableControl.Visible)
            {
                WarehouseTableControl.LoadData();
                WarehouseTableControl.DataBind();
            }
        }
