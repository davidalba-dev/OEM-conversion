...
// This file implements the code-behind class for Edit_Warehouse.aspx.
// App_Code\Edit_Warehouse.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Warehouse : BaseApplicationPage
// Code-behind class for the Edit_Warehouse page.
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetWarehouseRecordControl()
        {
            SetWarehouseRecordControl_Base(); 
        }
...
public void SetEquipment_inventoryTableControl()
        {
            SetEquipment_inventoryTableControl_Base(); 
        }
#endregion
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Warehouse");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Equipment_inventoryTableControl":
                 SetEquipment_inventoryTableControl();
                 break;
          
              case "WarehouseRecordControl":
                 SetWarehouseRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.WarehouseRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetEquipment_inventoryTableControl_Base()           
        
        {        
            if (Equipment_inventoryTableControl.Visible)
            {
                Equipment_inventoryTableControl.LoadData();
                Equipment_inventoryTableControl.DataBind();
            }
        }
      
        public void SetWarehouseRecordControl_Base()           
        
        {        
            if (WarehouseRecordControl.Visible)
            {
                WarehouseRecordControl.LoadData();
                WarehouseRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.WarehouseRecordControl != null && this.WarehouseRecordControl.DataSource != null)
                  {
                        id = this.WarehouseRecordControl.DataSource.GetValue(this.WarehouseRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.WarehouseRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.WarehouseRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.WarehouseRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.WarehouseRecordControl.DataSource.GetValue(this.WarehouseRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
