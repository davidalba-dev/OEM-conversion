...
//public void SetRepair_order_requestTableControl()
//        {
//            SetRepair_order_requestTableControl_Base(); 
//        }
//public void SetRepair_request_countTableControl()
//        {
//            SetRepair_request_countTableControl_Base(); 
//        }
public void SetRepair_order_requestTableControl()
        {
            SetRepair_order_requestTableControl_Base(); 
...
#region "Section 2: Do not modify this section."
      ...
      public void Page_InitializeEventHandlers_Base(object sender, System.EventArgs e)
      {
        ...
        protected virtual void Page_Load(object sender, EventArgs e)
        {
            ...
            ((BaseApplicationPage)this.Page).Authorize((Control)this.Repair_order_requestTableControl, "3");
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Repair_order_requestTableControl":
                 SetRepair_order_requestTableControl();
                 break;
      ...
      protected virtual void UserStatusInit() {
        ...
        case null:
        case "":
          this.UserStatusLbl.Text = GetResourceValue("Txt:UserNotSignedIn", "OEMConversion");
        break;
        default:
          this.UserStatusLbl.Text = GetResourceValue("Txt:Hello", "OEMConversion");
      ...
      protected virtual void SignInButtonInit(){
        ...
        switch (((BaseApplicationPage)(this.Page)).CurrentSecurity.GetUserStatus()) {
          ...
          case "":
              ...
              this.SignIn.Text = GetResourceValue("Txt:SignIn", "OEMConversion");
              this.SignIn.ToolTip = GetResourceValue("Txt:SignIn", "OEMConversion");
              
            break;
          default:
          
            this.SignIn.Text = GetResourceValue("Txt:SignOut", "OEMConversion");
            this.SignIn.ToolTip = GetResourceValue("Txt:SignOut", "OEMConversion");
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRepair_order_requestTableControl_Base()           
        
        {        
            if (Repair_order_requestTableControl.Visible)
            {
                Repair_order_requestTableControl.LoadData();
                Repair_order_requestTableControl.DataBind();
            }
        }
...
#region Interface Properties
        ...
        public System.Web.UI.WebControls.Label Label {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_Label");
            }
        }
        ...
        NotifyParentProperty(true),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public OEMConversion.UI.Controls.Header.Repair_order_requestTableControl Repair_order_requestTableControl {
                  get {
                  return (OEMConversion.UI.Controls.Header.Repair_order_requestTableControl)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_Repair_order_requestTableControl");
            }
        }
