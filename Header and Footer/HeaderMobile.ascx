...
<%@ Control Language="C#" AutoEventWireup="false" CodeFile="HeaderMobile.ascx.cs" Inherits="OEMConversion.UI.HeaderMobile" %><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td>
    <table cellpadding="0" cellspacing="0" border="0" width="100%" class="mobileHeader"><tr><td><table style="width: 100%"><tr><td class="mobileHeaderLeft"></td><td class="mobileHeaderTitle" style="width: 64%"></td><td class="mobileHeaderOptions">
