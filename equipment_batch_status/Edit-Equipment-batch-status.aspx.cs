...
// This file implements the code-behind class for Edit_Equipment_batch_status.aspx.
// App_Code\Edit_Equipment_batch_status.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Equipment_batch_status
        : BaseApplicationPage
// Code-behind class for the Edit_Equipment_batch_status page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Equipment_batch_status()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetEquipment_batch_statusRecordControl()
        {
            SetEquipment_batch_statusRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Equipment Batch Status");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Equipment_batch_statusRecordControl":
                 SetEquipment_batch_statusRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Equipment_batch_statusRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetEquipment_batch_statusRecordControl_Base()           
        
        {        
            if (Equipment_batch_statusRecordControl.Visible)
            {
                Equipment_batch_statusRecordControl.LoadData();
                Equipment_batch_statusRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Equipment_batch_statusRecordControl != null && this.Equipment_batch_statusRecordControl.DataSource != null)
                  {
                        id = this.Equipment_batch_statusRecordControl.DataSource.GetValue(this.Equipment_batch_statusRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Equipment_batch_statusRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Equipment_batch_statusRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Equipment_batch_statusRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Equipment_batch_statusRecordControl.DataSource.GetValue(this.Equipment_batch_statusRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
