<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Equipment_batch_status_QuickSelector" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Equipment-batch-status-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="OEMConversion.UI.Equipment_batch_status_QuickSelector" %><asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
