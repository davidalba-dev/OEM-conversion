<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Categories_QuickSelector" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Categories-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="OEMConversion.UI.Categories_QuickSelector" %>
