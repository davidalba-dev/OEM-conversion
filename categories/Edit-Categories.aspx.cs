...
// This file implements the code-behind class for Edit_Categories.aspx.
// App_Code\Edit_Categories.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Categories
        : BaseApplicationPage
// Code-behind class for the Edit_Categories page.
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetCategoriesRecordControl()
        {
            SetCategoriesRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Categories");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "CategoriesRecordControl":
                 SetCategoriesRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.CategoriesRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetCategoriesRecordControl_Base()           
        
        {        
            if (CategoriesRecordControl.Visible)
            {
                CategoriesRecordControl.LoadData();
                CategoriesRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  {
                        id = this.CategoriesRecordControl.DataSource.GetValue(this.CategoriesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        ...
                        {
                            value = this.CategoriesRecordControl.DataSource.GetValue(this.CategoriesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
