...
// This file implements the code-behind class for Edit_Oem_team.aspx.
// App_Code\Edit_Oem_team.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Oem_team
        : BaseApplicationPage
// Code-behind class for the Edit_Oem_team page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Oem_team()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetOem_teamRecordControl()
        {
            SetOem_teamRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} OEM Team");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Oem_teamRecordControl":
                 SetOem_teamRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Oem_teamRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetOem_teamRecordControl_Base()           
        
        {        
            if (Oem_teamRecordControl.Visible)
            {
                Oem_teamRecordControl.LoadData();
                Oem_teamRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Oem_teamRecordControl != null && this.Oem_teamRecordControl.DataSource != null)
                  {
                        id = this.Oem_teamRecordControl.DataSource.GetValue(this.Oem_teamRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Oem_teamRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Oem_teamRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Oem_teamRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Oem_teamRecordControl.DataSource.GetValue(this.Oem_teamRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
