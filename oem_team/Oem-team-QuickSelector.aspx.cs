...
// This file implements the code-behind class for Oem_team_QuickSelector.aspx.
// App_Code\Oem_team_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
public partial class Oem_team_QuickSelector
        : BaseApplicationPage
// Code-behind class for the Oem_team_QuickSelector page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Oem_team_QuickSelector()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_Search_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Oem_team_QuickSelector.SelectorTableControl control = new OEMConversion.UI.Controls.Oem_team_QuickSelector.SelectorTableControl();
