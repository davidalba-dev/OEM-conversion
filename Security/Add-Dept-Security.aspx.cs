...
// This file implements the code-behind class for Add_Dept_Security.aspx.
// App_Code\Add_Dept_Security.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Dept_Security
        : BaseApplicationPage
// Code-behind class for the Add_Dept_Security page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Dept_Security()
        {
            this.Initialize();
...
//        }
        ...
        public void SetSecurityRecordControl()
        {
            SetSecurityRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Security");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "SecurityRecordControl":
                 SetSecurityRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.SecurityRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetSecurityRecordControl_Base()           
        
        {        
            if (SecurityRecordControl.Visible)
            {
                SecurityRecordControl.LoadData();
                SecurityRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.SecurityRecordControl != null && this.SecurityRecordControl.DataSource != null)
                  {
                        id = this.SecurityRecordControl.DataSource.GetValue(this.SecurityRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.SecurityRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.SecurityRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.SecurityRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.SecurityRecordControl.DataSource.GetValue(this.SecurityRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
