...
#region "Section 2: Do not modify this section."
   ...
   #region " Misc Methods "
        ...
        get { return ((BaseApplicationPage)this.Page).GetResourceValue("Err:InvalidLoginInfo", "OEMConversion"); }
        }


        public string ERR_INTERNAL_ERROR {
            get { return ((BaseApplicationPage)this.Page).GetResourceValue("Err:InternalErrorLogin", "OEMConversion"); }
        }


        public string LOGIN_MSG {
            get { return ((BaseApplicationPage)this.Page).GetResourceValue("Txt:LoginMsg", "OEMConversion"); }
        }


        public string LOGIN_MSG_SESSION_INVALID {
            get { return ((BaseApplicationPage)this.Page).GetResourceValue("Txt:LoginMsgSessionInvalid", "OEMConversion"); }
        }
   #endregion
