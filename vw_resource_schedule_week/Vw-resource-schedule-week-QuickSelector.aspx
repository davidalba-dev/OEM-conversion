<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Vw_resource_schedule_week_QuickSelector" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Vw-resource-schedule-week-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="OEMConversion.UI.Vw_resource_schedule_week_QuickSelector" %>
