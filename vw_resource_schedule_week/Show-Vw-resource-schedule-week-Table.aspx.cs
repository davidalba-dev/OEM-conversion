...
// This file implements the code-behind class for Show_Vw_resource_schedule_week_Table.aspx.
// App_Code\Show_Vw_resource_schedule_week_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Vw_resource_schedule_week_Table
        : BaseApplicationPage
// Code-behind class for the Show_Vw_resource_schedule_week_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Vw_resource_schedule_week_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetVw_resource_schedule_weekTableControl()
        {
            SetVw_resource_schedule_weekTableControl_Base(); 
        }
...
//[System.Web.Services.WebMethod]
//        public static string[] GetAutoCompletionList_Vw_resource_schedule_weekSearchText(string prefixText, int count)
//        {
//            // GetVw_resource_schedule_weekSearchTextCompletionList gets the list of suggestions from the database.
//            // prefixText is the search text typed by the user .
//            // count specifies the number of suggestions to be returned.
//            // Customize by adding code before or after the call to  GetAutoCompletionList_Vw_resource_schedule_weekSearchText_Base()
//            // or replace the call to GetAutoCompletionList_Vw_resource_schedule_weekSearchText_Base().
//            return GetAutoCompletionList_Vw_resource_schedule_weekSearchText_Base(prefixText, count);
//        }
#endregion
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = "Resource Schedule Week";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Vw_resource_schedule_weekTableControl":
                 SetVw_resource_schedule_weekTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Vw_resource_schedule_weekTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Vw_resource_schedule_week_Table.Vw_resource_schedule_weekTableControl control = new OEMConversion.UI.Controls.Show_Vw_resource_schedule_week_Table.Vw_resource_schedule_weekTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetVw_resource_schedule_weekTableControl_Base()           
        
        {        
            if (Vw_resource_schedule_weekTableControl.Visible)
            {
                Vw_resource_schedule_weekTableControl.LoadData();
                Vw_resource_schedule_weekTableControl.DataBind();
            }
        }
