...
// This file implements the code-behind class for Show_Corporate_Table.aspx.
// App_Code\Show_Corporate_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Corporate_Table
        : BaseApplicationPage
// Code-behind class for the Show_Corporate_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Corporate_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetCorporateTableControl()
        {
            SetCorporateTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "CorporateTableControl":
                 SetCorporateTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.CorporateTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Corporate_Table.CorporateTableControl control = new OEMConversion.UI.Controls.Show_Corporate_Table.CorporateTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetCorporateTableControl_Base()           
        
        {        
            if (CorporateTableControl.Visible)
            {
                CorporateTableControl.LoadData();
                CorporateTableControl.DataBind();
            }
        }
