...
// This file implements the code-behind class for Edit_Corporate.aspx.
// App_Code\Edit_Corporate.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Corporate
        : BaseApplicationPage
// Code-behind class for the Edit_Corporate page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Corporate()
        {
            this.Initialize();
...
//        public void SetCorporateTabContainer()
//        {
//            SetCorporateTabContainer_Base(); 
//        }
        
        public void SetCorporateRecordControl()
        {
            SetCorporateRecordControl_Base(); 
        }
        
//        public void SetLoginTableControl()
//        {
//            SetLoginTableControl_Base(); 
//        }
...
public void SetCustomersTableControl()
        {
            SetCustomersTableControl_Base(); 
        }
public void SetCorporate_contactsTableControl()
        {
            SetCorporate_contactsTableControl_Base(); 
        }
...
//[System.Web.Services.WebMethod]
//        public static string[] GetAutoCompletionList_CustomersSearchText(string prefixText, int count)
//        {
//            // GetCustomersSearchTextCompletionList gets the list of suggestions from the database.
//            // prefixText is the search text typed by the user .
//            // count specifies the number of suggestions to be returned.
//            // Customize by adding code before or after the call to  GetAutoCompletionList_CustomersSearchText_Base()
//            // or replace the call to GetAutoCompletionList_CustomersSearchText_Base().
//            return GetAutoCompletionList_CustomersSearchText_Base(prefixText, count);
//        }
[System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_Corporate_contactsSearchText(string prefixText, int count)
        {
            // GetCorporate_contactsSearchTextCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_Corporate_contactsSearchText_Base()
            // or replace the call to GetAutoCompletionList_Corporate_contactsSearchText_Base().
            return GetAutoCompletionList_Corporate_contactsSearchText_Base(prefixText, count);
        }
#endregion
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Corporate");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Corporate_contactsTableControl":
                 SetCorporate_contactsTableControl();
                 break;
          
              case "CorporateRecordControl":
                 SetCorporateRecordControl();
                 break;
          
              case "CustomersTableControl":
                 SetCustomersTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.CorporateRecordControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_Corporate_contactsSearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Edit_Corporate.Corporate_contactsTableControl control = new OEMConversion.UI.Controls.Edit_Corporate.Corporate_contactsTableControl();
        
        return control.GetAutoCompletionList_Corporate_contactsSearchText(prefixText, count);
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetCorporate_contactsTableControl_Base()           
        
        {        
            if (Corporate_contactsTableControl.Visible)
            {
                Corporate_contactsTableControl.LoadData();
                Corporate_contactsTableControl.DataBind();
            }
        }
      
        public void SetCorporateRecordControl_Base()           
        
        {        
            if (CorporateRecordControl.Visible)
            {
                CorporateRecordControl.LoadData();
                CorporateRecordControl.DataBind();
            }
        }
      
        public void SetCustomersTableControl_Base()           
        
        {        
            if (CustomersTableControl.Visible)
            {
                CustomersTableControl.LoadData();
                CustomersTableControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.CorporateRecordControl != null && this.CorporateRecordControl.DataSource != null)
                  {
                        id = this.CorporateRecordControl.DataSource.GetValue(this.CorporateRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.CorporateRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.CorporateRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.CorporateRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.CorporateRecordControl.DataSource.GetValue(this.CorporateRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
