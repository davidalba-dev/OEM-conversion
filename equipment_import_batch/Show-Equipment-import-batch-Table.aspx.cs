...
// This file implements the code-behind class for Show_Equipment_import_batch_Table.aspx.
// App_Code\Show_Equipment_import_batch_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Equipment_import_batch_Table
        : BaseApplicationPage
// Code-behind class for the Show_Equipment_import_batch_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Equipment_import_batch_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetEquipment_import_batchTableControl()
        {
            SetEquipment_import_batchTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = "Equipment Import Batch";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Equipment_import_batchTableControl":
                 SetEquipment_import_batchTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Equipment_import_batchTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetEquipment_import_batchTableControl_Base()           
        
        {        
            if (Equipment_import_batchTableControl.Visible)
            {
                Equipment_import_batchTableControl.LoadData();
                Equipment_import_batchTableControl.DataBind();
            }
        }
