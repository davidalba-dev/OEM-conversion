...
// This file implements the code-behind class for Show_Equipment_inventory.aspx.
// App_Code\Show_Equipment_inventory.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Equipment_inventory
        : BaseApplicationPage
// Code-behind class for the Show_Equipment_inventory page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Equipment_inventory()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetEquipment_inventoryTabContainer()
        {
            SetEquipment_inventoryTabContainer_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    DbUtils.StartTransaction();
            ...
            SetEquipment_inventoryTabContainer(); 
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetEquipment_inventoryTabContainer_Base()           
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "Equipment_inventoryTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "Equipment_inventoryTabContainer").Visible = false;
