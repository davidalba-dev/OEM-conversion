...
// This file implements the code-behind class for Search_Equipment_inventory.aspx.
// App_Code\Show_Equipment_inventory_Table2.Controls.vb contains the Table, Row and Record control classes
...
public partial class Search_Equipment_inventory
        : BaseApplicationPage
// Code-behind class for the Search_Equipment_inventory page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Search_Equipment_inventory()
        {
            this.Initialize();
...
//[System.Web.Services.WebMethod]
//        public static string[] GetAutoCompletionList_Equipment_inventory_historySearchText(string prefixText, int count)
//        {
//            // GetEquipment_inventory_historySearchTextCompletionList gets the list of suggestions from the database.
//            // prefixText is the search text typed by the user .
//            // count specifies the number of suggestions to be returned.
//            // Customize by adding code before or after the call to  GetAutoCompletionList_Equipment_inventory_historySearchText_Base()
//            // or replace the call to GetAutoCompletionList_Equipment_inventory_historySearchText_Base().
//            return GetAutoCompletionList_Equipment_inventory_historySearchText_Base(prefixText, count);
//        }
public void SetVw_equipment_inventoryTableControl()
        {
            SetVw_equipment_inventoryTableControl_Base(); 
        }
[System.Web.Services.WebMethod]
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = "Equipment Inventory";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Vw_equipment_inventoryTableControl":
                 SetVw_equipment_inventoryTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Vw_equipment_inventoryTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText1_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Search_Equipment_inventory.Vw_equipment_inventoryTableControl control = new OEMConversion.UI.Controls.Search_Equipment_inventory.Vw_equipment_inventoryTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetVw_equipment_inventoryTableControl_Base()           
        
        {        
            if (Vw_equipment_inventoryTableControl.Visible)
            {
                Vw_equipment_inventoryTableControl.LoadData();
                Vw_equipment_inventoryTableControl.DataBind();
            }
        }
