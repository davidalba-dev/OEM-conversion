...
// This file implements the code-behind class for Show_Equipment_inventory_Gallery.aspx.
// App_Code\Show_Equipment_inventory_Gallery.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Equipment_inventory_Gallery
        : BaseApplicationPage
// Code-behind class for the Show_Equipment_inventory_Gallery page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Equipment_inventory_Gallery()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Equipment_inventory_Gallery.Equipment_inventoryTableControl control = new OEMConversion.UI.Controls.Show_Equipment_inventory_Gallery.Equipment_inventoryTableControl();
