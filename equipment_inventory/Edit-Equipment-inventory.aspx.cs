...
// This file implements the code-behind class for Edit_Equipment_inventory.aspx.
// App_Code\Edit_Equipment_inventory.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Equipment_inventory
        : BaseApplicationPage
// Code-behind class for the Edit_Equipment_inventory page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Equipment_inventory()
        {
            this.Initialize();
...
[System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_Equipment_inventory_partsSearchText(string prefixText, int count)
        {
            // GetEquipment_inventory_partsSearchTextCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_Equipment_inventory_partsSearchText_Base()
            // or replace the call to GetAutoCompletionList_Equipment_inventory_partsSearchText_Base().
            return GetAutoCompletionList_Equipment_inventory_partsSearchText_Base(prefixText, count);
        }
[System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_Loaner_historySearchText(string prefixText, int count)
        {
            // GetLoaner_historySearchTextCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_Loaner_historySearchText_Base()
            // or replace the call to GetAutoCompletionList_Loaner_historySearchText_Base().
            return GetAutoCompletionList_Loaner_historySearchText_Base(prefixText, count);
        }
//public void SetMax_customerRecordControl()
//        {
//            SetMax_customerRecordControl_Base(); 
//        }
#endregion
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Equipment Finance Details");
    ...
    public static string[] GetAutoCompletionList_Equipment_inventory_partsSearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Edit_Equipment_inventory.Equipment_inventory_partsTableControl control = new OEMConversion.UI.Controls.Edit_Equipment_inventory.Equipment_inventory_partsTableControl();
        
        return control.GetAutoCompletionList_Equipment_inventory_partsSearchText(prefixText, count);
            
    }
      
    public static string[] GetAutoCompletionList_Loaner_historySearchText_Base(string prefixText, int count)
    {
        // Since this method is a shared/static method it does not maintain information about page or controls within the page.
        // Hence we can not invoke any method associated with any controls.
        // So, if we need to use any control in the page we need to instantiate it.
        OEMConversion.UI.Controls.Edit_Equipment_inventory.Loaner_historyTableControl control = new OEMConversion.UI.Controls.Edit_Equipment_inventory.Loaner_historyTableControl();
        
        return control.GetAutoCompletionList_Loaner_historySearchText(prefixText, count);
      ...
      this.RedirectBack();
        ...
        public void SaveButton_Click_Base(object sender, EventArgs args)
        {
          ...
          this.CommitTransaction(sender);
                string inventoryID = Session["inventoryID"].ToString();
                new fulcrum().updateIntofulscrum(inventoryID);
