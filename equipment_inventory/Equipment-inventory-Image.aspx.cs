...
// This file implements the code-behind class for Equipment_inventory_Image.aspx.
// App_Code\Equipment_inventory_Image.Controls.vb contains the Table, Row and Record control classes
...
public partial class Equipment_inventory_Image
        : BaseApplicationPage
// Code-behind class for the Equipment_inventory_Image page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Equipment_inventory_Image()
        {
            this.Initialize();
		...
		//Todd Add Decrypt Param
		public static string GetURLParam(string KeyName, string Element)
        {
 
            string Param = HttpContext.Current.Request.QueryString[KeyName];
            if (string.IsNullOrEmpty(Param))
            {
                Param = HttpContext.Current.Request.QueryString[Element];
            }
            if (!string.IsNullOrEmpty(Param))
            {
                Param = HttpContext.Current.Server.UrlDecode(Param);
                // if decryption needed, decrypt here
                //Param = Decrypt(Param);
                if (BaseClasses.Data.KeyValue.IsXmlKey(Param))
                {
                    BaseClasses.Data.KeyValue kv = new BaseClasses.Data.KeyValue();
                    Param = kv.ColumnValueByName(Element);
                }
                else
                {
                }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = "OEM Equipment Image";
