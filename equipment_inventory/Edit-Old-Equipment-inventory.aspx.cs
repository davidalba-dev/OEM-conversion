...
// This file implements the code-behind class for Edit_Old_Equipment_inventory.aspx.
// App_Code\Edit_Old_Equipment_inventory.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Old_Equipment_inventory
        : BaseApplicationPage
// Code-behind class for the Edit_Old_Equipment_inventory page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Old_Equipment_inventory()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_Equipment_inventory_partsSearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Edit_Old_Equipment_inventory.Equipment_inventory_partsTableControl control = new OEMConversion.UI.Controls.Edit_Old_Equipment_inventory.Equipment_inventory_partsTableControl();
    ...
    public static string[] GetAutoCompletionList_Loaner_historySearchText_Base(string prefixText, int count)
    {
        ...
        // Hence we can not invoke any method associated with any controls.
        // So, if we need to use any control in the page we need to instantiate it.
        OEMConversion.UI.Controls.Edit_Old_Equipment_inventory.Loaner_historyTableControl control = new OEMConversion.UI.Controls.Edit_Old_Equipment_inventory.Loaner_historyTableControl();
