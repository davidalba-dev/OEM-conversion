...
// This file implements the code-behind class for Edit_Loaner_Equipment_inventory.aspx.
// App_Code\Edit_Loaner_Equipment_inventory.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Loaner_Equipment_inventory
        : BaseApplicationPage
// Code-behind class for the Edit_Loaner_Equipment_inventory page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Loaner_Equipment_inventory()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_Loaner_historySearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Edit_Loaner_Equipment_inventory.Loaner_historyTableControl control = new OEMConversion.UI.Controls.Edit_Loaner_Equipment_inventory.Loaner_historyTableControl();
