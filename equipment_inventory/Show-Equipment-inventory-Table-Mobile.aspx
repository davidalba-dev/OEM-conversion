...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-Equipment-inventory-Table-Mobile.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Mobile.master" Inherits="OEMConversion.UI.Show_Equipment_inventory_Table_Mobile" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Tagprefix="BaseClasses" Namespace="BaseClasses.Web.UI.WebControls" Assembly="BaseClasses" %>
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_Equipment_inventory_Table_Mobile" %>
...
<asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
    ...
    <div id="scrollRegion" class="scrollRegion">              
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%"><tr><td>
                        <OEMConversion:Equipment_inventoryTableControl runat="server" id="Equipment_inventoryTableControl">	<table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="mobileFieldLabelOnTop"><%# GetResourceValue("Txt:SearchFor", "OEMConversion") %></td></tr><tr><td class="mobileFieldValueOnBottom"><%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SearchButton"))%>
...
</td></tr><tr><td class="mobileFieldValueOnBottom"><OEMConversion:ThemeButtonMobile runat="server" id="SearchButton" button-causesvalidation="False" button-commandname="Search" button-text="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;OEMConversion&quot;) %>" button-tooltip="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;OEMConversion&quot;) %>" postback="False"></OEMConversion:ThemeButtonMobile></td></tr><tr><td class="mobileFieldLabelOnTop"></td></tr><tr><td class="mobileFieldValueOnBottom"></td></tr><tr><td class="mobileFieldLabelOnTop"></td></tr><tr><td class="mobileFieldValueOnBottom"></td></tr></table>
</asp:panel>
                  </td></tr><tr><td class="mobileBody"><table id="Equipment_inventoryTableControlGrid" cellpadding="0" cellspacing="0" border="0" onkeydown="captureUpDownKey(this, event)" width="100%"><tr><th class="mobileTableCell" colspan="1" style="display:none"><!-- Note: Cell Is Hidden --></th><th class="mobileTableCell" scope="col" style="display:none"><!-- Note: Cell Is Hidden --></th><th class="mobileTableCell" scope="col" style="display:none"><!-- Note: Cell Is Hidden --></th><th class="mobileTableCell" scope="col" style="display:none"></th><th class="mobileTableCell" scope="col" style="display:none"></th></tr><asp:Repeater runat="server" id="Equipment_inventoryTableControlRepeater">		<ITEMTEMPLATE>
		<asp:Repeater runat="server" id="Equipment_inventoryTableControlRepeater1">				<ITEMTEMPLATE>		<OEMConversion:Equipment_inventoryTableControlRow runat="server" id="Equipment_inventoryTableControlRow">
<tr onclick="RedirectByViewButton(event)"><td class="mobileTableCell" style="display:none;"><!-- Note: Cell Is Hidden --><asp:ImageButton runat="server" id="ViewRowButton" causesvalidation="False" commandname="Redirect" cssclass="button_link" imageurl="../Images/icon_view.gif" tooltip="&lt;%# GetResourceValue(&quot;Txt:ViewRecord&quot;, &quot;OEMConversion&quot;) %>">		
                  ...
                  &nbsp;
                <asp:Image runat="server" id="equipment_inventory_pic1" class="imageDropshadow" style="max-width:120px;margin:5px;"></asp:Image></td><td class="mobileTableCell"><asp:Literal runat="server" id="category_id"></asp:Literal><bt></bt> 
<asp:Literal runat="server" id="make_id"></asp:Literal> <br>
<asp:Literal runat="server" id="model_id"></asp:Literal></td><td class="mobileTableCell"><asp:Literal runat="server" id="serial_number"></asp:Literal></td><td class="mobileTableCell"><asp:Literal runat="server" id="warehouse_id"></asp:Literal> <br>
<asp:Literal runat="server" id="warehouse_location_id"></asp:Literal></td></tr></OEMConversion:Equipment_inventoryTableControlRow>
</ITEMTEMPLATE>
