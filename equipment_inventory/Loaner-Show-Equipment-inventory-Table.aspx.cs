...
// This file implements the code-behind class for Loaner_Show_Equipment_inventory_Table.aspx.
// App_Code\Loaner_Show_Equipment_inventory_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Loaner_Show_Equipment_inventory_Table
        : BaseApplicationPage
// Code-behind class for the Loaner_Show_Equipment_inventory_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Loaner_Show_Equipment_inventory_Table()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Loaner_Show_Equipment_inventory_Table.Equipment_inventoryTableControl control = new OEMConversion.UI.Controls.Loaner_Show_Equipment_inventory_Table.Equipment_inventoryTableControl();
