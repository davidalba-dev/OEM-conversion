...
// This file implements the code-behind class for Edit_Equipment_inventory_Mobile.aspx.
// App_Code\Edit_Equipment_inventory_Mobile.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Equipment_inventory_Mobile
        : BaseApplicationPage
// Code-behind class for the Edit_Equipment_inventory_Mobile page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Equipment_inventory_Mobile()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Equipment Inventory");
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Equipment_inventoryRecordControl != null && this.Equipment_inventoryRecordControl.DataSource != null)
                  {
                        id = this.Equipment_inventoryRecordControl.DataSource.GetValue(this.Equipment_inventoryRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Equipment_inventoryRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Equipment_inventoryRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Equipment_inventoryRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Equipment_inventoryRecordControl.DataSource.GetValue(this.Equipment_inventoryRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
