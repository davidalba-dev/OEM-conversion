...
// This file implements the code-behind class for Facility_Show_Equipment_inventory_Table.aspx.
// App_Code\Facility_Show_Equipment_inventory_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Facility_Show_Equipment_inventory_Table
        : BaseApplicationPage
// Code-behind class for the Facility_Show_Equipment_inventory_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Facility_Show_Equipment_inventory_Table()
        {
            this.Initialize();
...
public void SetVw_customer_equip_inventoryTableControl()
        {
            SetVw_customer_equip_inventoryTableControl_Base(); 
        }
public void SetVw_customer_equip_inventoryTableControl1()
        {
            SetVw_customer_equip_inventoryTableControl1_Base(); 
        }
#endregion
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Vw_customer_equip_inventoryTableControl":
                 SetVw_customer_equip_inventoryTableControl();
                 break;
          
              case "Vw_customer_equip_inventoryTableControl1":
                 SetVw_customer_equip_inventoryTableControl1();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Vw_customer_equip_inventoryTableControl.SaveData();
        
        this.Vw_customer_equip_inventoryTableControl1.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetVw_customer_equip_inventoryTableControl_Base()           
        
        {        
            if (Vw_customer_equip_inventoryTableControl.Visible)
            {
                Vw_customer_equip_inventoryTableControl.LoadData();
                Vw_customer_equip_inventoryTableControl.DataBind();
            }
        }
      
        public void SetVw_customer_equip_inventoryTableControl1_Base()           
        
        {        
            if (Vw_customer_equip_inventoryTableControl1.Visible)
            {
                Vw_customer_equip_inventoryTableControl1.LoadData();
                Vw_customer_equip_inventoryTableControl1.DataBind();
            }
        }
