...
// This file implements the code-behind class for Active_Loaner_Equipment.aspx.
// App_Code\Active_Loaner_Equipment.Controls.vb contains the Table, Row and Record control classes
...
public partial class Active_Loaner_Equipment
        : BaseApplicationPage
// Code-behind class for the Active_Loaner_Equipment page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Active_Loaner_Equipment()
        {
            this.Initialize();
...
[System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_Loaner_historySearchText1(string prefixText, int count)
        {
            // GetLoaner_historySearchText1CompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_Loaner_historySearchText1_Base()
            // or replace the call to GetAutoCompletionList_Loaner_historySearchText1_Base().
            return GetAutoCompletionList_Loaner_historySearchText1_Base(prefixText, count);
        }
#endregion
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_Loaner_historySearchText1_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Active_Loaner_Equipment.Loaner_historyTableControl1 control = new OEMConversion.UI.Controls.Active_Loaner_Equipment.Loaner_historyTableControl1();
        
        return control.GetAutoCompletionList_Loaner_historySearchText1(prefixText, count);
