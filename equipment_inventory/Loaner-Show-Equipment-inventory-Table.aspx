<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Loaner-Show-Equipment-inventory-Table.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Loaner_Show_Equipment_inventory_Table" %>
<%@ Register Tagprefix="OEMConversion" TagName="ThemeButtonWithArrow" Src="../Shared/ThemeButtonWithArrow.ascx" %>

<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Loaner_Show_Equipment_inventory_Table" %>
			...
			<ContentTemplate>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="updatePanelContent"><tr><td>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title0" Text="&lt;%#String.Concat(&quot;Equipment Loaner Inventory&quot;) %>">	</asp:Literal>
                      </td></tr></table>
...
<asp:DropDownList runat="server" id="received_from_customer_idFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)" selectionmode="Single">	</asp:DropDownList> </td><td class="popupTableCellValue"><OEMConversion:ThemeButton runat="server" id="FilterButton" button-causesvalidation="False" button-commandname="Search" button-text="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;OEMConversion&quot;) %>" button-tooltip="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;OEMConversion&quot;) %>" postback="False"></OEMConversion:ThemeButton></td><td class="popupTableCellValue">
	...
	<Selectors:CalendarExtendarClass runat="server" ID="date_receivedToFilterCalenderExtender" TargetControlID="date_receivedToFilter" CssClass="MyCalendar" Format="d">
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre">
                    <table id="Equipment_inventoryTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" colspan="2"></th><th class="thc"><asp:LinkButton runat="server" id="vendnoLabel" tooltip="Sort by vendno" Text="EvaluateFormula(&quot;= \&quot;Vendor\&quot;&quot;, true)" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:Literal runat="server" id="make_idLabel" Text="Make/Model/Cat">	</asp:Literal></th><th class="thc"><asp:Literal runat="server" id="serial_numberLabel" Text="Serial Number">	</asp:Literal></th><th class="thc"><asp:LinkButton runat="server" id="oem_einLabel" tooltip="Sort by oem_ein" Text="EvaluateFormula(&quot;= \&quot;OEM Barcode\&quot;&quot;, true)" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="warehouse_idLabel" tooltip="Sort by warehouse_id" Text="Warehouse" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="condition_idLabel" tooltip="Sort by condition_id" Text="Condition" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="disposition_idLabel" tooltip="Sort by disposition_id" Text="Disposition" CausesValidation="False">	</asp:LinkButton></th></tr><asp:Repeater runat="server" id="Equipment_inventoryTableControlRepeater">		<ITEMTEMPLATE>		<OEMConversion:Equipment_inventoryTableControlRow runat="server" id="Equipment_inventoryTableControlRow">
...
<asp:LinkButton runat="server" id="vendno" causesvalidation="False" commandname="Redirect"></asp:LinkButton></span>
</td><td class="tableCellValue"><b><asp:Literal runat="server" id="make_idLabel1" Text="Make">	</asp:Literal></b>
<b><asp:Literal runat="server" id="model_idLabel" Text="Model">	</asp:Literal></b>
<b><asp:Literal runat="server" id="category_idLabel" Text="Category">	</asp:Literal></b> <asp:Literal runat="server" id="new_category_id"></asp:Literal> <br></td><td class="tableCellValue"><asp:Literal runat="server" id="serial_number"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="oem_ein"></asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
</td></tr></OEMConversion:Equipment_inventoryTableControlRow>
</ITEMTEMPLATE>
