...
// This file implements the code-behind class for Show_Equipment_inventory_Table.aspx.
// App_Code\Show_Equipment_inventory_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Equipment_inventory_Table
        : BaseApplicationPage
// Code-behind class for the Show_Equipment_inventory_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Equipment_inventory_Table()
        {
            this.Initialize();
...
//        }
//[System.Web.Services.WebMethod]
//        public static string[] GetAutoCompletionList_Vw_equipment_inventorySearchText(string prefixText, int count)
//        {
//            // GetVw_equipment_inventorySearchTextCompletionList gets the list of suggestions from the database.
//            // prefixText is the search text typed by the user .
//            // count specifies the number of suggestions to be returned.
//            // Customize by adding code before or after the call to  GetAutoCompletionList_Vw_equipment_inventorySearchText_Base()
//            // or replace the call to GetAutoCompletionList_Vw_equipment_inventorySearchText_Base().
//            return GetAutoCompletionList_Vw_equipment_inventorySearchText_Base(prefixText, count);
//        }
#endregion
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SaveData_Base()
      {
        ...
        this.Equipment_inventoryTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Equipment_inventory_Table.Equipment_inventoryTableControl control = new OEMConversion.UI.Controls.Show_Equipment_inventory_Table.Equipment_inventoryTableControl();
