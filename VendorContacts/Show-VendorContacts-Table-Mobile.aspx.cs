...
// This file implements the code-behind class for Show_VendorContacts_Table_Mobile.aspx.
// App_Code\Show_VendorContacts_Table_Mobile.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_VendorContacts_Table_Mobile
        : BaseApplicationPage
// Code-behind class for the Show_VendorContacts_Table_Mobile page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_VendorContacts_Table_Mobile()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetVendorContactsTableControl()
        {
            SetVendorContactsTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "VendorContactsTableControl":
                 SetVendorContactsTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.VendorContactsTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_VendorContacts_Table_Mobile.VendorContactsTableControl control = new OEMConversion.UI.Controls.Show_VendorContacts_Table_Mobile.VendorContactsTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetVendorContactsTableControl_Base()           
        
        {        
            if (VendorContactsTableControl.Visible)
            {
                VendorContactsTableControl.LoadData();
                VendorContactsTableControl.DataBind();
            }
        }
