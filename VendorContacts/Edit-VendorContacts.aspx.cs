...
// This file implements the code-behind class for Edit_VendorContacts.aspx.
// App_Code\Edit_VendorContacts.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_VendorContacts
        : BaseApplicationPage
// Code-behind class for the Edit_VendorContacts page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_VendorContacts()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetVendorContactsRecordControl()
        {
            SetVendorContactsRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Vendor Contacts");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "VendorContactsRecordControl":
                 SetVendorContactsRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.VendorContactsRecordControl.SaveData();
        ...
        SetVendorContactsRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "VendorContactsMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetVendorContactsRecordControl_Base()           
        
        {        
            if (VendorContactsRecordControl.Visible)
            {
                VendorContactsRecordControl.LoadData();
                VendorContactsRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.VendorContactsRecordControl != null && this.VendorContactsRecordControl.DataSource != null)
                  {
                        id = this.VendorContactsRecordControl.DataSource.GetValue(this.VendorContactsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.VendorContactsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.VendorContactsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.VendorContactsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.VendorContactsRecordControl.DataSource.GetValue(this.VendorContactsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
