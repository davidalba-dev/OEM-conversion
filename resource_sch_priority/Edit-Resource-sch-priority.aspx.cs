...
// This file implements the code-behind class for Edit_Resource_sch_priority.aspx.
// App_Code\Edit_Resource_sch_priority.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Resource_sch_priority
        : BaseApplicationPage
// Code-behind class for the Edit_Resource_sch_priority page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Resource_sch_priority()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetResource_sch_priorityRecordControl()
        {
            SetResource_sch_priorityRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Resource SCH Priority");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Resource_sch_priorityRecordControl":
                 SetResource_sch_priorityRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Resource_sch_priorityRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetResource_sch_priorityRecordControl_Base()           
        
        {        
            if (Resource_sch_priorityRecordControl.Visible)
            {
                Resource_sch_priorityRecordControl.LoadData();
                Resource_sch_priorityRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Resource_sch_priorityRecordControl != null && this.Resource_sch_priorityRecordControl.DataSource != null)
                  {
                        id = this.Resource_sch_priorityRecordControl.DataSource.GetValue(this.Resource_sch_priorityRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Resource_sch_priorityRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Resource_sch_priorityRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Resource_sch_priorityRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Resource_sch_priorityRecordControl.DataSource.GetValue(this.Resource_sch_priorityRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
