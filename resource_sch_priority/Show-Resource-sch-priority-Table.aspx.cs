...
// This file implements the code-behind class for Show_Resource_sch_priority_Table.aspx.
// App_Code\Show_Resource_sch_priority_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Resource_sch_priority_Table
        : BaseApplicationPage
// Code-behind class for the Show_Resource_sch_priority_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Resource_sch_priority_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetResource_sch_priorityTableControl()
        {
            SetResource_sch_priorityTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = "Resource SCH Priority";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Resource_sch_priorityTableControl":
                 SetResource_sch_priorityTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Resource_sch_priorityTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetResource_sch_priorityTableControl_Base()           
        
        {        
            if (Resource_sch_priorityTableControl.Visible)
            {
                Resource_sch_priorityTableControl.LoadData();
                Resource_sch_priorityTableControl.DataBind();
            }
        }
