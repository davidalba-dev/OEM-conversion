...
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Edit_SC2" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Edit-SC2.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Edit_SC2" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title" Text="Edit Service Code">	</asp:Literal>
                      </td></tr></table>
</td><td class="dher"><img src="../Images/space.gif" alt="" /></td></tr></table>

                </td><td class="panelHeaderR"></td></tr><tr><td class="panelL"></td><td>
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><asp:panel id="SC2RecordControlPanel" runat="server"><table><tr><td class="fls"><asp:Literal runat="server" id="ServCodeLabel" Text="Serv Code">	</asp:Literal></td><td class="dfv" style="white-space:nowrap;"><span style="white-space:nowrap;">
...
</td></tr><tr><td class="fls"><asp:Literal runat="server" id="ServCategoryLabel" Text="Serv Category">	</asp:Literal></td><td class="dfv" style="white-space:nowrap;"><span style="white-space:nowrap;">
...
</td></tr><tr><td class="fls"><asp:Literal runat="server" id="Service_activeLabel" Text="Service Active">	</asp:Literal></td><td class="dfv" style="white-space:nowrap;"><asp:CheckBox runat="server" id="Service_active"></asp:CheckBox></td></tr><tr><td class="fls"></td><td class="dfv" style="white-space:nowrap;"><span style="white-space:nowrap;">
