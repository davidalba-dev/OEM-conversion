...
// This file implements the code-behind class for Edit_SC2.aspx.
// App_Code\Edit_SC2.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_SC2
        : BaseApplicationPage
// Code-behind class for the Edit_SC2 page.
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetSC2RecordControl()
        {
            SetSC2RecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} SC2");
      ...
      public void SaveData_Base()
      {
        ...
        this.SC2RecordControl.SaveData();
        ...
        SetSC2RecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "SC2MenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetSC2RecordControl_Base()           
        
        {        
            if (SC2RecordControl.Visible)
            {
                SC2RecordControl.LoadData();
                SC2RecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.SC2RecordControl != null && this.SC2RecordControl.DataSource != null)
                  {
                        id = this.SC2RecordControl.DataSource.GetValue(this.SC2RecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.SC2RecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.SC2RecordControl.DataSource);
                            value = EvaluateFormula(formula, this.SC2RecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.SC2RecordControl.DataSource.GetValue(this.SC2RecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
