...
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_SC2_Table" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-SC2-Table.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Show_SC2_Table" %><asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
...
<BaseClasses:QuickSelector runat="server" id="ServCodeGroupFilter" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single">	</BaseClasses:QuickSelector><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="SC2TableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" colspan="2" style="display:none"><img src="../Images/space.gif" height="1" width="1" alt="" /></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th></tr><asp:Repeater runat="server" id="SC2TableControlRepeater">		<ITEMTEMPLATE>		<OEMConversion:SC2TableControlRow runat="server" id="SC2TableControlRow">
...
</td><td class="tableCellValue"><asp:Literal runat="server" id="ServCategory"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ServCodeLabel" Text="Serv Code">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="ServCode"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ServDateRecordAddedLabel" Text="Serv Date Record Added">	</asp:Literal> 
...
</td><td class="tableCellValue"><asp:Literal runat="server" id="ServDefault"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ServCodeGroupLabel" Text="Serv Code Group">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="ServCodeGroup"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ServTypeLabel" Text="Serv Type">	</asp:Literal> 
</td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="ServType"></asp:Literal></span>
 </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ServDescLabel" Text="Serv Description">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="ServDesc"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ServQBItemCodeLabel" Text="Serv QB Item Code">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="ServQBItemCode"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ServChargeLabel" Text="Serv Charge">	</asp:Literal> 
</td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="ServCharge"></asp:Literal></span>
 </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ServReference1Label" Text="Serv Reference 1">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="ServReference1"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ServReference2Label" Text="Serv Reference 2">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="ServReference2"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ServReference3Label" Text="Serv Reference 3">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="ServReference3"></asp:Literal> </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ServReference4Label" Text="Serv Reference 4">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="ServReference4"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ServRepairStepLabel" Text="Serv Repair Step">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="ServRepairStep"></asp:Literal> </td><td class="tableCellLabel"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ServDropdownLabel" Text="Serv Dropdown">	</asp:Literal> 
</td><td class="tableCellValue" colspan="5"><asp:Literal runat="server" id="ServDropdown"></asp:Literal> </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ServNotesLabel" Text="Serv Notes">	</asp:Literal> 
</td><td class="tableCellValue" colspan="5"><asp:Literal runat="server" id="ServNotes"></asp:Literal> </td></tr><tr><td class="tableRowDivider" colspan="8"></td></tr></OEMConversion:SC2TableControlRow>
</ITEMTEMPLATE>
