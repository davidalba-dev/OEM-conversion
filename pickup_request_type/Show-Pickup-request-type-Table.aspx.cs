...
// This file implements the code-behind class for Show_Pickup_request_type_Table.aspx.
// App_Code\Show_Pickup_request_type_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Pickup_request_type_Table
        : BaseApplicationPage
// Code-behind class for the Show_Pickup_request_type_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Pickup_request_type_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetPickup_request_typeTableControl()
        {
            SetPickup_request_typeTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = "Pickup Request Type";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Pickup_request_typeTableControl":
                 SetPickup_request_typeTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Pickup_request_typeTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetPickup_request_typeTableControl_Base()           
        
        {        
            if (Pickup_request_typeTableControl.Visible)
            {
                Pickup_request_typeTableControl.LoadData();
                Pickup_request_typeTableControl.DataBind();
            }
        }
