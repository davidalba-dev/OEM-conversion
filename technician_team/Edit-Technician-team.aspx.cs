...
// This file implements the code-behind class for Edit_Technician_team.aspx.
// App_Code\Edit_Technician_team.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Technician_team
        : BaseApplicationPage
// Code-behind class for the Edit_Technician_team page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Technician_team()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetTechnician_teamRecordControl()
        {
            SetTechnician_teamRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Technician Team");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Technician_teamRecordControl":
                 SetTechnician_teamRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Technician_teamRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetTechnician_teamRecordControl_Base()           
        
        {        
            if (Technician_teamRecordControl.Visible)
            {
                Technician_teamRecordControl.LoadData();
                Technician_teamRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Technician_teamRecordControl != null && this.Technician_teamRecordControl.DataSource != null)
                  {
                        id = this.Technician_teamRecordControl.DataSource.GetValue(this.Technician_teamRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Technician_teamRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Technician_teamRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Technician_teamRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Technician_teamRecordControl.DataSource.GetValue(this.Technician_teamRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
