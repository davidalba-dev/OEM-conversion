...
// This file implements the code-behind class for Show_Technician_team_Table.aspx.
// App_Code\Show_Technician_team_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Technician_team_Table
        : BaseApplicationPage
// Code-behind class for the Show_Technician_team_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Technician_team_Table()
        {
            this.Initialize();
...
public void SetOem_teamTableControl()
        {
            SetOem_teamTableControl_Base(); 
        }
#endregion
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Oem_teamTableControl":
                 SetOem_teamTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Oem_teamTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetOem_teamTableControl_Base()           
        
        {        
            if (Oem_teamTableControl.Visible)
            {
                Oem_teamTableControl.LoadData();
                Oem_teamTableControl.DataBind();
            }
        }
