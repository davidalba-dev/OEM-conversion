...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codefile="ImportData.aspx.cs" Inherits="OEMConversion.UI.ImportData" %>
				...
				<table class="importWizarddv" cellpadding="0" cellspacing="0" border="0">
					<tr>
						<td class="importWizarddBody" style="width:100%; height:100%">			
							...
							<table>
								<tr>
									<td><OEMConversion:ThemeButton runat="server" id="PreviousButton" Button-Text="&lt;%# GetResourceValue(&quot;Import:Previous&quot;) %>" Button-ToolTip="&lt;%# GetResourceValue(&quot;Import:Previous&quot;, &quot;OEMConversion&quot;) %>">
		</OEMConversion:ThemeButton></td>
									<td><OEMConversion:ThemeButton runat="server" id="ImportButton" Button-Text="&lt;%# GetResourceValue(&quot;Import:Import&quot;) %>" Button-ToolTip="&lt;%# GetResourceValue(&quot;Import:Import&quot;, &quot;OEMConversion&quot;) %>">
		</OEMConversion:ThemeButton></td>
								</tr>
							</table>
						</td>
