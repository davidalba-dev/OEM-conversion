...
<%@ Control Language="C#" AutoEventWireup="false" CodeFile="InfinitePaginationMobile.ascx.cs" Inherits="OEMConversion.UI.InfinitePaginationMobile" %>
<%@ Register Tagprefix="BaseClasses" Namespace="BaseClasses.Web.UI.WebControls" Assembly="BaseClasses" %><table class="mobileHeaderPagination"><tr><td class="mobilePaginationAreaFirst"><asp:ImageButton runat="server" id="_FirstPage" alt="&lt;%# GetResourceValue(&quot;Btn:FirstPage&quot;, &quot;OEMConversion&quot;) %>" causesvalidation="False" commandname="FirstPage" imageurl="../Images/MobileButtonFirst.png" onclientclick="return SubmitHRefOnce(this, &quot;&quot;);" tooltip="&lt;%# GetResourceValue(&quot;Btn:FirstPage&quot;, &quot;OEMConversion&quot;) %>" visible="False" style="visibility:hidden;display:none">		
	</asp:ImageButton></td><td class="mobilePaginationAreaPrevious"><asp:ImageButton runat="server" id="_PreviousPage" alt="&lt;%# GetResourceValue(&quot;Btn:PreviousPage&quot;, &quot;OEMConversion&quot;) %>" causesvalidation="False" commandname="PreviousPage" imageurl="../Images/MobileButtonPrevious.png" onclientclick="return SubmitHRefOnce(this, &quot;&quot;);" tooltip="&lt;%# GetResourceValue(&quot;Btn:PreviousPage&quot;, &quot;OEMConversion&quot;) %>" style="visibility:hidden;display:none">		
	</asp:ImageButton></td><td class="mobilePaginationAreaCurrentPage" nowrap="nowrap">
<asp:Label runat="server" id="_CurrentPage" onchange="ISD_InfiScrollHandler(this)" visible="True" style="visibility:hidden;display:none">	</asp:Label>
</td><td class="mobilePaginationAreaNext"><asp:ImageButton runat="server" id="_NextPage" alt="&lt;%# GetResourceValue(&quot;Btn:NextPage&quot;, &quot;OEMConversion&quot;) %>" causesvalidation="False" commandname="NextPage" imageurl="../Images/MobileButtonNext.png" onclientclick="return SubmitHRefOnce(this, &quot;&quot;);" tooltip="&lt;%# GetResourceValue(&quot;Btn:NextPage&quot;, &quot;OEMConversion&quot;) %>" style="visibility:hidden;display:none">		
	</asp:ImageButton></td><td class="mobilePaginationAreaLast"><asp:ImageButton runat="server" id="_LastPage" alt="&lt;%# GetResourceValue(&quot;Btn:LastPage&quot;, &quot;OEMConversion&quot;) %>" causesvalidation="False" commandname="LastPage" imageurl="../Images/MobileButtonLast.png" onclientclick="return SubmitHRefOnce(this, &quot;&quot;);" tooltip="&lt;%# GetResourceValue(&quot;Btn:LastPage&quot;, &quot;OEMConversion&quot;) %>" visible="False" style="visibility:hidden;display:none">		
	</asp:ImageButton></td><td class="prbggo"><asp:LinkButton runat="server" id="_PageSizeButton" causesvalidation="False" commandname="PageSize" cssclass="button_link" text="&lt;%# GetResourceValue(&quot;Txt:PageSize&quot;, &quot;OEMConversion&quot;) %>" style="visibility:hidden;display:none">		
	</asp:LinkButton></td><td class="prbg"><%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("_PageSizeButton")) %><asp:TextBox runat="server" id="_PageSize" cssclass="Pagination_Input" maxlength="5" text="20" style="visibility:hidden;display:none">	</asp:TextBox><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControl("_PageSizeButton")) %></td><td class="prbg"><asp:TextBox runat="server" id="_Summary" text="Infinite Pagination Mobile" style="visibility:hidden;display:none">	</asp:TextBox></td></tr></table><div><iframe id="Infiniteframe" runat="server" style="width:0px;height:0px;visibility:hidden"></iframe></div>
<script type="text/javascript">
    var bool = "False";
    if (window != top && window.parent.document.forms[0].action.indexOf("MobileFrame") == -1) {
    ...
    $(window).scroll(function() {
        if ((($(window).scrollTop() + 10) >= $(document).height() - $(window).height()) || (($(window).scrollTop() + 10) >= $(document).height() - window.innerHeight)) {
            if (document.forms[0].action.indexOf("MobileFrame") == -1) {
    ...
    window.onload = function () {
        if (document.forms[0].action.indexOf("MobileFrame") == -1) {
            try {
                ...
                if (sessionStorage.getItem("is_scroll") == "true" && window != top && IfraNam.name == "PostbackIframe" && window.parent.document.forms[0].action.indexOf("MobileFrame") == -1) {
                    ...
                    if (window == top || window.parent.document.forms[0].action.indexOf("MobileFrame") != -1) {
                        ...
                        if (infinitecheck != null) {
                            ...
                            var CurrPagBut = initialframe.contentWindow.document.getElementById('<%= SystemUtils.InfinitePagination(FindControl("_CurrentPage")) %>');
                            if (CurrPagBut != null && CurrPagBut.innerHTML != '') {
                                CurrPagBut.onchange();
                            }
                        }
                    }
        ...
        if (document.forms[0].action.indexOf("MobileFrame") == -1) {
            if (window != top && window.parent.document.forms[0].action.indexOf("MobileFrame") == -1) {
                ...
                if (parenttframe.name == "PostbackIframe" && infinitecheck == null) {
                    var CurrPagBut = document.getElementById('<%= SystemUtils.InfinitePagination(FindControl("_CurrentPage")) %>');
                    if (CurrPagBut != null && CurrPagBut.innerHTML != '') {
                        CurrPagBut.onchange();
                    }
                }
    ...
    function onScroll() {
        if (document.forms[0].action.indexOf("MobileFrame") == -1) {
            ...
            if (t != null) {
                ...
                var IframePageSize = t.contentWindow.document.getElementById('<%= SystemUtils.InfinitePagination(FindControl("_NextPage")) %>');
                var CurrPagBut = t.contentWindow.document.getElementById('<%= SystemUtils.InfinitePagination(FindControl("_CurrentPage")) %>');
                if (NewRecords == "True") {
                    if (CurrPagBut != null && CurrPagBut.innerHTML == '0') {
                        CurrPagBut.onchange();
                    } else {
                        IframePageSize.click();
                    }
