...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codefile="SelectFileToImport.aspx.cs"
    Inherits="OEMConversion.UI.SelectFileToImport" %>
                               ...
                               <asp:UpdatePanel ID="FileSelectionPanel" runat="server" UpdateMode="Conditional">
                                ...
                                <table>
                                    <tr>
                                        <td>
                                            <br />
                                            <OEMConversion:Themebutton runat="server" id="NextButton" button-text="&lt;%# GetResourceValue(&quot;Import:Next&quot;) %>"
                                                button-tooltip="&lt;%# GetResourceValue(&quot;Import:Next&quot;) %>">
		</OEMConversion:Themebutton>
                                        </td>
                                    </tr>
                                </table>
                            </td>
