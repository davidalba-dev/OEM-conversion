...
// This file implements the code-behind class for Customer_Loaner_request.aspx.
// App_Code\Customer_Loaner_request.Controls.vb contains the Table, Row and Record control classes
...
public partial class Customer_Loaner_request
        : BaseApplicationPage
// Code-behind class for the Customer_Loaner_request page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Customer_Loaner_request()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetLoaner_requestRecordControl()
        {
            SetLoaner_requestRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Loaner Request");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Loaner_requestRecordControl":
                 SetLoaner_requestRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Loaner_requestRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetLoaner_requestRecordControl_Base()           
        
        {        
            if (Loaner_requestRecordControl.Visible)
            {
                Loaner_requestRecordControl.LoadData();
                Loaner_requestRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Loaner_requestRecordControl != null && this.Loaner_requestRecordControl.DataSource != null)
                  {
                        id = this.Loaner_requestRecordControl.DataSource.GetValue(this.Loaner_requestRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Loaner_requestRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Loaner_requestRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Loaner_requestRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Loaner_requestRecordControl.DataSource.GetValue(this.Loaner_requestRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
