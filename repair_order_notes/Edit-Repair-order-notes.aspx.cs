...
// This file implements the code-behind class for Edit_Repair_order_notes.aspx.
// App_Code\Edit_Repair_order_notes.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Repair_order_notes
        : BaseApplicationPage
// Code-behind class for the Edit_Repair_order_notes page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Repair_order_notes()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetRepair_order_notesRecordControl()
        {
            SetRepair_order_notesRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Repair Order Notes");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Repair_order_notesRecordControl":
                 SetRepair_order_notesRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Repair_order_notesRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRepair_order_notesRecordControl_Base()           
        
        {        
            if (Repair_order_notesRecordControl.Visible)
            {
                Repair_order_notesRecordControl.LoadData();
                Repair_order_notesRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Repair_order_notesRecordControl != null && this.Repair_order_notesRecordControl.DataSource != null)
                  {
                        id = this.Repair_order_notesRecordControl.DataSource.GetValue(this.Repair_order_notesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Repair_order_notesRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Repair_order_notesRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Repair_order_notesRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Repair_order_notesRecordControl.DataSource.GetValue(this.Repair_order_notesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
