...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetRoleTabContainer()
        {
            SetRoleTabContainer_Base(); 
        }
        ...
        public void SetRoleRecordControl()
        {
            SetRoleRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Role");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "RoleRecordControl":
                 SetRoleRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.RoleRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRoleTabContainer_Base()           
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "RoleTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "RoleTabContainer").Visible = false;
        ...
        public void SetRoleRecordControl_Base()           
        
        {        
            if (RoleRecordControl.Visible)
            {
                RoleRecordControl.LoadData();
                RoleRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.RoleRecordControl != null && this.RoleRecordControl.DataSource != null)
                  {
                        id = this.RoleRecordControl.DataSource.GetValue(this.RoleRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.RoleRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.RoleRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.RoleRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.RoleRecordControl.DataSource.GetValue(this.RoleRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
