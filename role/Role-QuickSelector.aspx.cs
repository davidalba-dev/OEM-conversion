...
public partial class Role_QuickSelector
        : BaseApplicationPage
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_Search_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Role_QuickSelector.SelectorTableControl control = new OEMConversion.UI.Controls.Role_QuickSelector.SelectorTableControl();
