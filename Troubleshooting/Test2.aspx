...
<table cellpadding="3" cellspacing="0" border="0" width="100%">
 ...
 <tr>
  <td>
   Run this test if your application uses Microsoft Access.  <br />
   If you are using Iron Speed Designer, 64 bit, you will not <br />
   be able to create an application using Microsoft Access, <br />
   so you should <a href="Test3.aspx">Go to Next Test</a>.
   <br /><br />
  </td>
 </tr>
 <tr>
   ...
   <ul>
    ...
    <li>
     <b>Errors?  Is it one of these?</b>
      ...
      <a href="#" onclick="ShowHelp('Part_VIII/Microsoft_Jet_OLEDB_4_0_provider_is_not_registered.htm');return false;">'Microsoft.Jet.OLEDB.4.0' provider is not registered...</a><br />
    </li>
    <li>
