   ...
   <ul>
    ...
    <li>
     <b>Errors?  Is it one of these?</b>
      <br />
      <a href="#" onclick="ShowHelp('Part_VIII/ASPX_HTML_is_Displayed_Instead_of_Your_Application.htm');return false;">ASPX (HTML) is Displayed Instead of Your Application</a><br />
      <a href="#" onclick="ShowHelp('Part_VIII/Parser_Error_Unrecognized_attribute_validateRequest.htm');return false;">Configuration Error: Unrecognized attribute 'validateRequest'...</a><br />
      <a href="#" onclick="ShowHelp('Part_VIII/HTTP_Error_403_-_Forbidden_You_are_not_authorized_to_view_this_page.htm');return false;">HTTP Error 403 - Forbidden.  You are not authorized to view this page...</a><br />
      <a href="#" onclick="ShowHelp('Part_VIII/HTTP_Error_404_-_Page_Not_Found.htm');return false;">HTTP Error 404 - Page Not Found</a><br />
      <a href="#" onclick="ShowHelp('Part_VIII/HTTP_Error_500_-_Page_Cannot_be_Displayed.htm');return false;">HTTP Error 500 - Page cannot be displayed...</a><br />
      <a href="#" onclick="ShowHelp('Part_VIII/Server_Application_Unavailable.htm');return false;">Server Application Unavailable</a><br />
      <a href="#" onclick="ShowHelp('Part_VIII/System_IO_FileNotFoundException.htm');return false;">System.IO.FileNotFoundException</a><br />
    </li>
    <li>
