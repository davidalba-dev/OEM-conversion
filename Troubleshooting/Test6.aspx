  ...
  <td>
   <ul>
    <li>
     ...
     and if you continue to have problems, <a href="http://support.ironspeed.com/Case/GroupByCaseTable.aspx" target="_blank">submit a support case</a>.  Please include a screen shot of the error message.
    </li>
    <li>
    ...
    <li>
     <b>Can't find your error message?</b><br />
      <a href="#" onclick="ShowHelp('Part_VIII/Application_Runs_But_No_Data_is_Displayed.htm#Application_Runs_But_No');return false;">Lookup additional error messages...</a>
      <br /><br />
