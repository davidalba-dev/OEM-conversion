...
// This file implements the code-behind class for Show_Project_role_Table.aspx.
// App_Code\Show_Project_role_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Project_role_Table
        : BaseApplicationPage
// Code-behind class for the Show_Project_role_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Project_role_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetProject_roleTableControl()
        {
            SetProject_roleTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Project_roleTableControl":
                 SetProject_roleTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Project_roleTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetProject_roleTableControl_Base()           
        
        {        
            if (Project_roleTableControl.Visible)
            {
                Project_roleTableControl.LoadData();
                Project_roleTableControl.DataBind();
            }
        }
