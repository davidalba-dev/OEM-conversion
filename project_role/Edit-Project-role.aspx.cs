...
// This file implements the code-behind class for Edit_Project_role.aspx.
// App_Code\Edit_Project_role.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Project_role
        : BaseApplicationPage
// Code-behind class for the Edit_Project_role page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Project_role()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetProject_roleRecordControl()
        {
            SetProject_roleRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Project Role");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Project_roleRecordControl":
                 SetProject_roleRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Project_roleRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetProject_roleRecordControl_Base()           
        
        {        
            if (Project_roleRecordControl.Visible)
            {
                Project_roleRecordControl.LoadData();
                Project_roleRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Project_roleRecordControl != null && this.Project_roleRecordControl.DataSource != null)
                  {
                        id = this.Project_roleRecordControl.DataSource.GetValue(this.Project_roleRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Project_roleRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Project_roleRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Project_roleRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Project_roleRecordControl.DataSource.GetValue(this.Project_roleRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
