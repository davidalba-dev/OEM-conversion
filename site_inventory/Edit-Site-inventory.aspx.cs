...
// This file implements the code-behind class for Edit_Site_inventory.aspx.
// App_Code\Edit_Site_inventory.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Site_inventory
        : BaseApplicationPage
// Code-behind class for the Edit_Site_inventory page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Site_inventory()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetSite_inventoryRecordControl()
        {
            SetSite_inventoryRecordControl_Base(); 
        }
...
public void SetSerial_numberTableControl()
        {
            SetSerial_numberTableControl_Base(); 
        }
//public void SetSite_inventory_pm_pmiRecordControl()
//        {
//            SetSite_inventory_pm_pmiRecordControl_Base(); 
//        }
public void SetSite_inventory_contract_historyTableControl1()
        {
            SetSite_inventory_contract_historyTableControl1_Base(); 
        }
public void SetSite_inventory_contract_historyTableControl()
        {
            SetSite_inventory_contract_historyTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Site Inventory");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Serial_numberTableControl":
                 SetSerial_numberTableControl();
                 break;
          
              case "Site_inventory_contract_historyTableControl":
                 SetSite_inventory_contract_historyTableControl();
                 break;
          
              case "Site_inventory_contract_historyTableControl1":
                 SetSite_inventory_contract_historyTableControl1();
                 break;
          
              case "Site_inventoryRecordControl":
                 SetSite_inventoryRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Site_inventory_contract_historyTableControl.SaveData();
        
        this.Site_inventory_contract_historyTableControl1.SaveData();
        
        this.Site_inventoryRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetSerial_numberTableControl_Base()           
        ...
        public void SetSite_inventory_contract_historyTableControl_Base()           
        
        {        
            if (Site_inventory_contract_historyTableControl.Visible)
            {
                Site_inventory_contract_historyTableControl.LoadData();
                Site_inventory_contract_historyTableControl.DataBind();
            }
        }
      
        public void SetSite_inventory_contract_historyTableControl1_Base()           
        
        {        
            if (Site_inventory_contract_historyTableControl1.Visible)
            {
                Site_inventory_contract_historyTableControl1.LoadData();
                Site_inventory_contract_historyTableControl1.DataBind();
            }
        }
      
        public void SetSite_inventoryRecordControl_Base()           
        
        {        
            if (Site_inventoryRecordControl.Visible)
            {
                Site_inventoryRecordControl.LoadData();
                Site_inventoryRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Site_inventoryRecordControl != null && this.Site_inventoryRecordControl.DataSource != null)
                  {
                        id = this.Site_inventoryRecordControl.DataSource.GetValue(this.Site_inventoryRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Site_inventoryRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Site_inventoryRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Site_inventoryRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Site_inventoryRecordControl.DataSource.GetValue(this.Site_inventoryRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
