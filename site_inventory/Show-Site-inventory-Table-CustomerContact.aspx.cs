...
// This file implements the code-behind class for Show_Site_inventory_Table_CustomerContact.aspx.
// App_Code\Show_Site_inventory_Table_Cust.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Site_inventory_Table_CustomerContact
        : BaseApplicationPage
// Code-behind class for the Show_Site_inventory_Table_CustomerContact page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Site_inventory_Table_CustomerContact()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SaveData_Base()
      {
        ...
        this.Site_inventory_custcontactTableControl.SaveData();
        
        this.Site_inventory_custcontactTableControl1.SaveData();
    ...
    public static string[] GetAutoCompletionList_Site_inventory_custcontactSearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Site_inventory_Table_CustomerContact.Site_inventory_custcontactTableControl control = new OEMConversion.UI.Controls.Show_Site_inventory_Table_CustomerContact.Site_inventory_custcontactTableControl();
    ...
    public static string[] GetAutoCompletionList_Site_inventory_custcontactSearchText1_Base(string prefixText, int count)
    {
        ...
        // Hence we can not invoke any method associated with any controls.
        // So, if we need to use any control in the page we need to instantiate it.
        OEMConversion.UI.Controls.Show_Site_inventory_Table_CustomerContact.Site_inventory_custcontactTableControl1 control = new OEMConversion.UI.Controls.Show_Site_inventory_Table_CustomerContact.Site_inventory_custcontactTableControl1();
