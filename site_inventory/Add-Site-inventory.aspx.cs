...
// This file implements the code-behind class for Add_Site_inventory.aspx.
// App_Code\Add_Site_inventory.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Site_inventory
        : BaseApplicationPage
// Code-behind class for the Add_Site_inventory page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Site_inventory()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Site Inventory");
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
      ...
      this.RedirectBack();
        ...
        public void SaveButton_Click_Base(object sender, EventArgs args)
        {
            ...
            string url = @"../serial_number/Add-Serial-number.aspx?siteinventory={Site_inventoryRecordControl:PK}&custno={Site_inventoryRecordControl:FV:custno}";
