...
// This file implements the code-behind class for Edit_Site_inventory_Table.aspx.
// App_Code\Edit_Site_inventory_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Site_inventory_Table
        : BaseApplicationPage
// Code-behind class for the Edit_Site_inventory_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Site_inventory_Table()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Site_inventoryTableControl":
                 SetSite_inventoryTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Site_inventoryTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetSite_inventoryTableControl_Base()           
        
        {        
            if (Site_inventoryTableControl.Visible)
            {
                Site_inventoryTableControl.LoadData();
                Site_inventoryTableControl.DataBind();
            }
        }
