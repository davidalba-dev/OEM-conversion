...
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Site_inventory_QuickSelector" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Site-inventory-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="OEMConversion.UI.Site_inventory_QuickSelector" %>
