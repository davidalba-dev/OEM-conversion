...
// This file implements the code-behind class for Edit_Resource_CurrentWeek_Table.aspx.
// App_Code\Edit_Resource_CurrentWeek_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Resource_CurrentWeek_Table
        : BaseApplicationPage
// Code-behind class for the Edit_Resource_CurrentWeek_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Resource_CurrentWeek_Table()
        {
            this.Initialize();
...
//        public void SetVw_resource_time_currentweekTableControl()
//        {
//            SetVw_resource_time_currentweekTableControl_Base(); 
//        }
...
//public void SetCalendarTableControl()
//        {
//            SetCalendarTableControl_Base(); 
//        }
//public void SetCalendarTableControl1()
//        {
//            SetCalendarTableControl1_Base(); 
//        }
public void SetCalendarTableControl()
        {
            SetCalendarTableControl_Base(); 
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Resource Time Entry");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "CalendarTableControl":
                 SetCalendarTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.CalendarTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetCalendarTableControl_Base()           
        
        {        
            if (CalendarTableControl.Visible)
            {
                CalendarTableControl.LoadData();
                CalendarTableControl.DataBind();
            }
        }
