<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Edit_Resource_LastWeek_Table" %>

<%@ Register Tagprefix="OEMConversion" TagName="ThemeButton" Src="../Shared/ThemeButton.ascx" %>

<%@ Register Tagprefix="Selectors" Namespace="OEMConversion" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Edit-Resource-LastWeek-Table.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Edit_Resource_LastWeek_Table" %>
...
</td><td><OEMConversion:ThemeButton runat="server" id="Button" button-causesvalidation="False" button-commandname="Redirect" button-text="Next Week >>" button-tooltip="Next Week"></OEMConversion:ThemeButton> 
...
<asp:Literal runat="server" id="calendar_date"></asp:Literal></span>
                  ...
                  <asp:panel id="CollapsibleRegion3" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre">
                    <table id="Resource_sch_timeTableControl2Grid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc"></th><th class="thc"><asp:LinkButton runat="server" id="resource_sch_ticket_idLabel1" tooltip="Sort by resource_sch_ticket_id" Text="EvaluateFormula(&quot;= \&quot;Ticket #\&quot;&quot;, true)" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="resource_sch_time_hoursLabel1" tooltip="Sort by resource_sch_time_hours" Text="Time" CausesValidation="False">	</asp:LinkButton></th><th class="thc"></th></tr><asp:Repeater runat="server" id="Resource_sch_timeTableControl2Repeater">		<ITEMTEMPLATE>		<OEMConversion:Resource_sch_timeTableControl2Row runat="server" id="Resource_sch_timeTableControl2Row">
