<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Add_Resource_sch_time" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Add-Resource-sch-time.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Add_Resource_sch_time" %><asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td>
                    <asp:panel id="Resource_sch_timeRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tableCellLabel"><asp:Literal runat="server" id="resource_sch_time_dateLabel" Text="EvaluateFormula(&quot;= \&quot;Date\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
</td></tr><tr><td class="tableCellLabel"><asp:Label runat="server" id="resource_sch_time_minLabel" Text="Minutes">	</asp:Label></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
</td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="resource_sch_technician_idLabel" Text="Technician">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:DropDownList runat="server" id="resource_sch_technician_id1" cssclass="field_input" onkeypress="dropDownListTypeAhead(this,false)" visible="True"></asp:DropDownList></span>
...
<tr>
<td style="padding-right: 5px; vertical-align:top">
<asp:TextBox runat="server" id="resource_sch_ticket_id" Columns="14" MaxLength="14" cssclass="field_input" visible="False"></asp:TextBox></td>
<td>
&nbsp;
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="resource_sch_ticket_idTextBoxMaxLengthValidator" ControlToValidate="resource_sch_ticket_id" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;OEMConversion&quot;).Replace(&quot;{FieldName}&quot;, EvaluateFormula(&quot;= \&quot;Ticket #\&quot;&quot;, true)) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
</tr>
</table>
</span>
