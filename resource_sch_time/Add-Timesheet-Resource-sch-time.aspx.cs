...
// This file implements the code-behind class for Add_Timesheet_Resource_sch_time.aspx.
// App_Code\Add_Timesheet_Resource_sch_time.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Timesheet_Resource_sch_time
        : BaseApplicationPage
// Code-behind class for the Add_Timesheet_Resource_sch_time page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Timesheet_Resource_sch_time()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetResource_sch_timeRecordControl()
        {
            SetResource_sch_timeRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Resource SCH Time");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Resource_sch_timeRecordControl":
                 SetResource_sch_timeRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Resource_sch_timeRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetResource_sch_timeRecordControl_Base()           
        
        {        
            if (Resource_sch_timeRecordControl.Visible)
            {
                Resource_sch_timeRecordControl.LoadData();
                Resource_sch_timeRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Resource_sch_timeRecordControl != null && this.Resource_sch_timeRecordControl.DataSource != null)
                  {
                        id = this.Resource_sch_timeRecordControl.DataSource.GetValue(this.Resource_sch_timeRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Resource_sch_timeRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Resource_sch_timeRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Resource_sch_timeRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Resource_sch_timeRecordControl.DataSource.GetValue(this.Resource_sch_timeRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
