...
// This file implements the code-behind class for Show_Repairorder_history_Table.aspx.
// App_Code\Show_Repairorder_history_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Repairorder_history_Table
        : BaseApplicationPage
// Code-behind class for the Show_Repairorder_history_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Repairorder_history_Table()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = "Repair Order History";
      ...
      public void SaveData_Base()
      {
        ...
        this.Repairorder_historyTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Repairorder_history_Table.Repairorder_historyTableControl control = new OEMConversion.UI.Controls.Show_Repairorder_history_Table.Repairorder_historyTableControl();
