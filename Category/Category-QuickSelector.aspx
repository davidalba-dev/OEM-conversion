<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Category_QuickSelector" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Category-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="OEMConversion.UI.Category_QuickSelector" %><asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
