...
// This file implements the code-behind class for Edit_Site_inventory_contract_history.aspx.
// App_Code\Edit_Site_inventory_contract_history.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Site_inventory_contract_history
        : BaseApplicationPage
// Code-behind class for the Edit_Site_inventory_contract_history page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Site_inventory_contract_history()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetSite_inventory_contract_historyRecordControl()
        {
            SetSite_inventory_contract_historyRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Site Inventory Contract History");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Site_inventory_contract_historyRecordControl":
                 SetSite_inventory_contract_historyRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Site_inventory_contract_historyRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetSite_inventory_contract_historyRecordControl_Base()           
        
        {        
            if (Site_inventory_contract_historyRecordControl.Visible)
            {
                Site_inventory_contract_historyRecordControl.LoadData();
                Site_inventory_contract_historyRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Site_inventory_contract_historyRecordControl != null && this.Site_inventory_contract_historyRecordControl.DataSource != null)
                  {
                        id = this.Site_inventory_contract_historyRecordControl.DataSource.GetValue(this.Site_inventory_contract_historyRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Site_inventory_contract_historyRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Site_inventory_contract_historyRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Site_inventory_contract_historyRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Site_inventory_contract_historyRecordControl.DataSource.GetValue(this.Site_inventory_contract_historyRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
