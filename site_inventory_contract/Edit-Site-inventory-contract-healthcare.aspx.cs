...
// This file implements the code-behind class for Edit_Site_inventory_contract_healthcare.aspx.
// App_Code\Edit_Site_inventory_contract_healthcare.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Site_inventory_contract_healthcare
        : BaseApplicationPage
// Code-behind class for the Edit_Site_inventory_contract_healthcare page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Site_inventory_contract_healthcare()
        {
            this.Initialize();
...
//        [System.Web.Services.WebMethod]
//        public static string[] GetAutoCompletionList_Vw_site_inventory_contract_detailsSearchText(string prefixText, int count)
//        {
//            // GetVw_site_inventory_contract_detailsSearchTextCompletionList gets the list of suggestions from the database.
//            // prefixText is the search text typed by the user .
//            // count specifies the number of suggestions to be returned.
//            // Customize by adding code before or after the call to  GetAutoCompletionList_Vw_site_inventory_contract_detailsSearchText_Base()
//            // or replace the call to GetAutoCompletionList_Vw_site_inventory_contract_detailsSearchText_Base().
//            return GetAutoCompletionList_Vw_site_inventory_contract_detailsSearchText_Base(prefixText, count);
//        }
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetSite_inventory_contractRecordControl()
        {
            SetSite_inventory_contractRecordControl_Base(); 
        }
        
//        public void SetVw_site_inventory_contract_detailsTableControl()
//        {
//            SetVw_site_inventory_contract_detailsTableControl_Base(); 
//        }
...
public void SetVw_site_inventory_contract_healthcareTableControl()
        {
            SetVw_site_inventory_contract_healthcareTableControl_Base(); 
        }
#endregion
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Site Inventory Contract");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Site_inventory_contractRecordControl":
                 SetSite_inventory_contractRecordControl();
                 break;
          
              case "Vw_site_inventory_contract_healthcareTableControl":
                 SetVw_site_inventory_contract_healthcareTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Site_inventory_contractRecordControl.SaveData();
        
        this.Vw_site_inventory_contract_healthcareTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetSite_inventory_contractRecordControl_Base()           
        
        {        
            if (Site_inventory_contractRecordControl.Visible)
            {
                Site_inventory_contractRecordControl.LoadData();
                Site_inventory_contractRecordControl.DataBind();
            }
        }
      
        public void SetVw_site_inventory_contract_healthcareTableControl_Base()           
        
        {        
            if (Vw_site_inventory_contract_healthcareTableControl.Visible)
            {
                Vw_site_inventory_contract_healthcareTableControl.LoadData();
                Vw_site_inventory_contract_healthcareTableControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Site_inventory_contractRecordControl != null && this.Site_inventory_contractRecordControl.DataSource != null)
                  {
                        id = this.Site_inventory_contractRecordControl.DataSource.GetValue(this.Site_inventory_contractRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Site_inventory_contractRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Site_inventory_contractRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Site_inventory_contractRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Site_inventory_contractRecordControl.DataSource.GetValue(this.Site_inventory_contractRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
