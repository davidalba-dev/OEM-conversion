...
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Pop_Edit_Site_inventory_contract_healthcare" %>

<%@ Register Tagprefix="BaseClasses" Namespace="BaseClasses.Web.UI.WebControls" Assembly="BaseClasses" %>
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Pop-Edit-Site-inventory-contract-healthcare.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Pop_Edit_Site_inventory_contract_healthcare" %><asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
