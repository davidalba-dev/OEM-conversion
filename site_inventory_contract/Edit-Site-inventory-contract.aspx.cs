...
// This file implements the code-behind class for Edit_Site_inventory_contract.aspx.
// App_Code\Edit_Site_inventory_contract.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Site_inventory_contract
        : BaseApplicationPage
// Code-behind class for the Edit_Site_inventory_contract page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Site_inventory_contract()
        {
            this.Initialize();
...
//        public void SetSite_inventory_contractTabContainer()
//        {
//            SetSite_inventory_contractTabContainer_Base(); 
//        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Vw_site_inventory_contract_detailsTableControl":
                 SetVw_site_inventory_contract_detailsTableControl();
                 break;
    ...
    public static string[] GetAutoCompletionList_Vw_site_inventory_contract_detailsSearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Edit_Site_inventory_contract.Vw_site_inventory_contract_detailsTableControl control = new OEMConversion.UI.Controls.Edit_Site_inventory_contract.Vw_site_inventory_contract_detailsTableControl();
        
        return control.GetAutoCompletionList_Vw_site_inventory_contract_detailsSearchText(prefixText, count);
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetVw_site_inventory_contract_detailsTableControl_Base()           
        
        {        
            if (Vw_site_inventory_contract_detailsTableControl.Visible)
            {
                Vw_site_inventory_contract_detailsTableControl.LoadData();
                Vw_site_inventory_contract_detailsTableControl.DataBind();
            }
        }
