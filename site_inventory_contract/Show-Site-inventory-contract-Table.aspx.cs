...
// This file implements the code-behind class for Show_Site_inventory_contract_Table.aspx.
// App_Code\Show_Site_inventory_contract_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Site_inventory_contract_Table
        : BaseApplicationPage
// Code-behind class for the Show_Site_inventory_contract_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Site_inventory_contract_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetSite_inventory_contractTableControl()
        {
            SetSite_inventory_contractTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = "Site Inventory Contract";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Site_inventory_contractTableControl":
                 SetSite_inventory_contractTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Site_inventory_contractTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Site_inventory_contract_Table.Site_inventory_contractTableControl control = new OEMConversion.UI.Controls.Show_Site_inventory_contract_Table.Site_inventory_contractTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetSite_inventory_contractTableControl_Base()           
        
        {        
            if (Site_inventory_contractTableControl.Visible)
            {
                Site_inventory_contractTableControl.LoadData();
                Site_inventory_contractTableControl.DataBind();
            }
        }
