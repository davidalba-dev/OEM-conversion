<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Pop-Edit-Site-inventory-contract.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Pop_Edit_Site_inventory_contract" %>
<%@ Register Tagprefix="OEMConversion" TagName="ThemeButton" Src="../Shared/ThemeButton.ascx" %>

<%@ Register Tagprefix="Selectors" Namespace="OEMConversion" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Pop_Edit_Site_inventory_contract" %>
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="contract_detailsTextBoxMaxLengthValidator" ControlToValidate="contract_details" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;OEMConversion&quot;).Replace(&quot;{FieldName}&quot;, &quot;Contract Details&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator> </td></tr></table></asp:panel>
