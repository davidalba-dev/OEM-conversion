<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Site_inventory_contract_QuickSelector" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Site-inventory-contract-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="OEMConversion.UI.Site_inventory_contract_QuickSelector" %>
