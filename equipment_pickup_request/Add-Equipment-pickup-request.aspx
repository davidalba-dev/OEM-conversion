<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Add-Equipment-pickup-request.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Add_Equipment_pickup_request" %>
...
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Add_Equipment_pickup_request" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title0" Text="&lt;%#String.Concat(GetResourceValue(&quot;Title:Add&quot;),&quot;&quot;,&quot; Equipment Pickup Request&quot;) %>">	</asp:Literal>
                      </td></tr></table>
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="poc_phone_extTextBoxMaxLengthValidator" ControlToValidate="poc_phone_ext" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;OEMConversion&quot;).Replace(&quot;{FieldName}&quot;, &quot;POC Phone Extension&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></span>
 </td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="pickup_instructionsLabel" Text="Pickup Instructions">	</asp:Literal></td><td class="tableCellValue" colspan="3"><asp:TextBox runat="server" id="pickup_instructions" MaxLength="500" columns="120" cssclass="field_input" rows="6" textmode="MultiLine"></asp:TextBox>&nbsp;
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="pickup_instructionsTextBoxMaxLengthValidator" ControlToValidate="pickup_instructions" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;OEMConversion&quot;).Replace(&quot;{FieldName}&quot;, &quot;Pickup Instructions&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator> </td></tr></table></asp:panel>
...
</td></tr><tr><td class="recordPanelButtonsAlignment"><table cellpadding="0" cellspacing="0" border="0" class="pageButtonsContainer"><tr><td><table cellpadding="0" cellspacing="0" border="0"><tr><td><OEMConversion:ThemeButton runat="server" id="SaveButton" button-causesvalidation="True" button-commandname="UpdateData" button-text="&lt;%# GetResourceValue(&quot;Btn:Save&quot;, &quot;OEMConversion&quot;) %>" button-tooltip="&lt;%# GetResourceValue(&quot;Btn:Save&quot;, &quot;OEMConversion&quot;) %>" postback="True" sendemail1content="The+following+equipment+pickup+request+has+been+submitted%3a%0d%0aContact%3a%7bEquipment_pickup_requestRecordControl%3aNoUrlEncode%3aFDV%3acustcontactkey%7d%0d%0aAddress%3a%7bEquipment_pickup_requestRecordControl%3aNoUrlEncode%3aFDV%3apickup_address1%7d%0d%0aAddress2%3a%7bEquipment_pickup_requestRecordControl%3aNoUrlEncode%3aFDV%3apickup_address2%7d%0d%0aCity%3a%7bEquipment_pickup_requestRecordControl%3aNoUrlEncode%3aFDV%3apickup_city%7d%0d%0aState%3b%7bEquipment_pickup_requestRecordControl%3aNoUrlEncode%3aFDV%3apickup_state%7d%0d%0aZip%3a%7bEquipment_pickup_requestRecordControl%3aNoUrlEncode%3aFDV%3apickup_zip%7d%0d%0aPOC+Phone%3a+%7bEquipment_pickup_requestRecordControl%3aNoUrlEncode%3aFDV%3apoc_phone%7d%0d%0aPickup+Date%3a%7bEquipment_pickup_requestRecordControl%3aNoUrlEncode%3aFDV%3apickkup_date%7d%0d%0aPickup+Time%3a%7bEquipment_pickup_requestRecordControl%3aNoUrlEncode%3aFDV%3apickup_time%7d" sendemail1forrecord="Current" sendemail1from="info%40oemmed.com+%3cinfo%40oemmed.com%3e" sendemail1subject="Equipment+Pickup+Request" sendemail1to="info%40oemmed.com"></OEMConversion:ThemeButton></td><td></td><td><OEMConversion:ThemeButton runat="server" id="CancelButton" button-causesvalidation="False" button-commandname="Redirect" button-text="&lt;%# GetResourceValue(&quot;Btn:Cancel&quot;, &quot;OEMConversion&quot;) %>" button-tooltip="&lt;%# GetResourceValue(&quot;Btn:Cancel&quot;, &quot;OEMConversion&quot;) %>" postback="False"></OEMConversion:ThemeButton></td></tr></table>
</td></tr></table>
</td></tr></table>
      </ContentTemplate>
</asp:UpdatePanel>
