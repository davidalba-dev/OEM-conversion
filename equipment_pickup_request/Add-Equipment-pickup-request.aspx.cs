...
// This file implements the code-behind class for Add_Equipment_pickup_request.aspx.
// App_Code\Add_Equipment_pickup_request.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Equipment_pickup_request
        : BaseApplicationPage
// Code-behind class for the Add_Equipment_pickup_request page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Equipment_pickup_request()
        {
            this.Initialize();
...
//        }
        ...
        public void SetEquipment_pickup_requestRecordControl()
        {
            SetEquipment_pickup_requestRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Equipment Pickup Request");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Equipment_pickup_requestRecordControl":
                 SetEquipment_pickup_requestRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Equipment_pickup_requestRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetEquipment_pickup_requestRecordControl_Base()           
        
        {        
            if (Equipment_pickup_requestRecordControl.Visible)
            {
                Equipment_pickup_requestRecordControl.LoadData();
                Equipment_pickup_requestRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Equipment_pickup_requestRecordControl != null && this.Equipment_pickup_requestRecordControl.DataSource != null)
                  {
                        id = this.Equipment_pickup_requestRecordControl.DataSource.GetValue(this.Equipment_pickup_requestRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Equipment_pickup_requestRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Equipment_pickup_requestRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Equipment_pickup_requestRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Equipment_pickup_requestRecordControl.DataSource.GetValue(this.Equipment_pickup_requestRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
    ...
    public  void SendEmailOnSaveButton_Click_Base()
        ...
        SendEmail1From = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("info%40oemmed.com+%3cinfo%40oemmed.com%3e"), "", false);
        ...
        SendEmail1To = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("info%40oemmed.com"), "" ,false);

          
        string SendEmail1Subject;
        //In case Subject includes expressions substitute them with values
        SendEmail1Subject = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("Equipment+Pickup+Request"), "", false);
          
        string SendEmail1Content;
        //In case content has expressions substitude then with values
        SendEmail1Content = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("The+following+equipment+pickup+request+has+been+submitted%3a%0d%0aContact%3a%7bEquipment_pickup_requestRecordControl%3aNoUrlEncode%3aFDV%3acustcontactkey%7d%0d%0aAddress%3a%7bEquipment_pickup_requestRecordControl%3aNoUrlEncode%3aFDV%3apickup_address1%7d%0d%0aAddress2%3a%7bEquipment_pickup_requestRecordControl%3aNoUrlEncode%3aFDV%3apickup_address2%7d%0d%0aCity%3a%7bEquipment_pickup_requestRecordControl%3aNoUrlEncode%3aFDV%3apickup_city%7d%0d%0aState%3b%7bEquipment_pickup_requestRecordControl%3aNoUrlEncode%3aFDV%3apickup_state%7d%0d%0aZip%3a%7bEquipment_pickup_requestRecordControl%3aNoUrlEncode%3aFDV%3apickup_zip%7d%0d%0aPOC+Phone%3a+%7bEquipment_pickup_requestRecordControl%3aNoUrlEncode%3aFDV%3apoc_phone%7d%0d%0aPickup+Date%3a%7bEquipment_pickup_requestRecordControl%3aNoUrlEncode%3aFDV%3apickkup_date%7d%0d%0aPickup+Time%3a%7bEquipment_pickup_requestRecordControl%3aNoUrlEncode%3aFDV%3apickup_time%7d"), "", false);
