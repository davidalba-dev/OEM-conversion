...
// This file implements the code-behind class for Edit_Contractor.aspx.
// App_Code\Edit_Contractor.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Contractor
        : BaseApplicationPage
// Code-behind class for the Edit_Contractor page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Contractor()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetContractorRecordControl()
        {
            SetContractorRecordControl_Base(); 
        }
...
public void SetContractor_contactTableControl()
        {
            SetContractor_contactTableControl_Base(); 
        }
[System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_Contractor_contactSearchText(string prefixText, int count)
        {
            // GetContractor_contactSearchTextCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_Contractor_contactSearchText_Base()
            // or replace the call to GetAutoCompletionList_Contractor_contactSearchText_Base().
            return GetAutoCompletionList_Contractor_contactSearchText_Base(prefixText, count);
        }
public void SetContractor_skills_matrixTableControl()
        {
            SetContractor_skills_matrixTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
      ...
      public void Page_InitializeEventHandlers_Base(object sender, System.EventArgs e)
      {
        ...
        protected virtual void Page_Load(object sender, EventArgs e)
        {
			...
			this.Authorize(((Control)(this.FindControlRecursively("TabPanel"))), "NOT_ANONYMOUS");
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Contractor");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Contractor_contactTableControl":
                 SetContractor_contactTableControl();
                 break;
          
              case "Contractor_skills_matrixTableControl":
                 SetContractor_skills_matrixTableControl();
                 break;
          
              case "ContractorRecordControl":
                 SetContractorRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.ContractorRecordControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_Contractor_contactSearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Edit_Contractor.Contractor_contactTableControl control = new OEMConversion.UI.Controls.Edit_Contractor.Contractor_contactTableControl();
        
        return control.GetAutoCompletionList_Contractor_contactSearchText(prefixText, count);
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetContractor_contactTableControl_Base()           
        
        {        
            if (Contractor_contactTableControl.Visible)
            {
                Contractor_contactTableControl.LoadData();
                Contractor_contactTableControl.DataBind();
            }
        }
      
        public void SetContractor_skills_matrixTableControl_Base()           
        
        {        
            if (Contractor_skills_matrixTableControl.Visible)
            {
                Contractor_skills_matrixTableControl.LoadData();
                Contractor_skills_matrixTableControl.DataBind();
            }
        }
      
        public void SetContractorRecordControl_Base()           
        
        {        
            if (ContractorRecordControl.Visible)
            {
                ContractorRecordControl.LoadData();
                ContractorRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.ContractorRecordControl != null && this.ContractorRecordControl.DataSource != null)
                  {
                        id = this.ContractorRecordControl.DataSource.GetValue(this.ContractorRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.ContractorRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.ContractorRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.ContractorRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.ContractorRecordControl.DataSource.GetValue(this.ContractorRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
