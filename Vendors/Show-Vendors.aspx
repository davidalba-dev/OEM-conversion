...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-Vendors.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Show_Vendors" %>
...
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_Vendors" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><asp:panel id="VendorsRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tableCellLabel"><asp:Literal runat="server" id="VendNameLabel" Text="EvaluateFormula(&quot;= \&quot;Vendor Name\&quot;&quot;, true)">	</asp:Literal></td></tr></table></asp:panel>
</td></tr></table>
</asp:panel>
...
</td></tr><tr><td><BaseClasses:TabContainer runat="server" id="VendorsTabContainer" panellayout="Tabbed">
...
</td><td class="tableCellValue"><asp:LinkButton runat="server" id="ROEstimatedBy" causesvalidation="False" commandname="Redirect"></asp:LinkButton> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ROQBInvNoLabel" Text="ROQB Invoice Number">	</asp:Literal> 
...
</td><td class="tableCellValue"><asp:LinkButton runat="server" id="ROReceivedBy" causesvalidation="False" commandname="Redirect"></asp:LinkButton> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ROQBTxnIDLabel" Text="ROQB Transaction">	</asp:Literal> 
...
</td><td class="tableCellValue"><asp:LinkButton runat="server" id="ROTechnician" causesvalidation="False" commandname="Redirect"></asp:LinkButton> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ROQBTxnIDPayLabel" Text="ROQB Transaction Pay">	</asp:Literal> 
