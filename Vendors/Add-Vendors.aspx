<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Add_Vendors" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Add-Vendors.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Add_Vendors" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title" Text="&lt;%#String.Concat(GetResourceValue(&quot;Title:Add&quot;),&quot;&quot;,&quot; Vendors&quot;) %>">	</asp:Literal>
                      </td></tr></table>
...
</td><td class="tableCellLabel"><asp:Literal runat="server" id="Vend_activeLabel" Text="EvaluateFormula(&quot;= \&quot;Active\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><asp:CheckBox runat="server" id="Vend_active"></asp:CheckBox></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"><asp:Literal runat="server" id="vendor_inventoryLabel" Text="Inventory">	</asp:Literal></td><td class="tableCellValue"><asp:CheckBox runat="server" id="vendor_inventory"></asp:CheckBox></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"><asp:Literal runat="server" id="vendor_repairLabel" Text="Service">	</asp:Literal></td><td class="tableCellValue"><asp:CheckBox runat="server" id="vendor_repair"></asp:CheckBox></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="VendPrintNotesLabel" Text="Vend Print Notes">	</asp:Literal></td><td class="tableCellValue" colspan="3"><custom:HTMLEditor ID="VendPrivateNotes" runat="server" VendPrivateNotesRequiredFieldValidator:Enabled="False" VendPrivateNotesRequiredFieldValidator:Text="*" Height="350" Width="640" AutoFocus="False" /></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
<asp:TextBox runat="server" id="VendNo" Columns="14" MaxLength="14" cssclass="field_input" visible="False"></asp:TextBox></td>
<td>
&nbsp;
<asp:RequiredFieldValidator runat="server" id="VendNoRequiredFieldValidator" ControlToValidate="VendNo" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueIsRequired&quot;, &quot;OEMConversion&quot;).Replace(&quot;{FieldName}&quot;, &quot;Vend Number&quot;) %>" enabled="True" text="*"></asp:RequiredFieldValidator>&nbsp;
