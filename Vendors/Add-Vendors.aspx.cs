...
// This file implements the code-behind class for Add_Vendors.aspx.
// App_Code\Add_Vendors.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Vendors
        : BaseApplicationPage
// Code-behind class for the Add_Vendors page.
...
//        public void SetVendorsTabContainer()
//        {
//            SetVendorsTabContainer_Base(); 
//        }
...
//        }
        ...
        public void SetVendorsRecordControl()
        {
            SetVendorsRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Vendors");
      ...
      public void SaveData_Base()
      {
        ...
        this.VendorsRecordControl.SaveData();
        ...
        SetVendorsRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "VendorsMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetVendorsRecordControl_Base()           
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.VendorsRecordControl != null && this.VendorsRecordControl.DataSource != null)
                  {
                        id = this.VendorsRecordControl.DataSource.GetValue(this.VendorsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.VendorsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.VendorsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.VendorsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.VendorsRecordControl.DataSource.GetValue(this.VendorsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
    ...
    public  void SendEmailOnSaveButton_Click_Base()
        ...
        SendEmail1From = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("oeminfo%40oemmed.com+%3coeminfo%40oemmed.com%3e"), "", false);
        ...
        SendEmail1Subject = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("New+OEM+Expertech+-+Vendor+Added"), "", false);
          
        string SendEmail1Content;
        //In case content has expressions substitude then with values
        SendEmail1Content = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("The+following+vendor+has+been+added+to+the+OEM+Expertech+Application%0d%0a%0d%0aVendor%3a+%7bVendorsRecordControl%3aNoUrlEncode%3aFDV%3aVendName%7d"), "", false);
