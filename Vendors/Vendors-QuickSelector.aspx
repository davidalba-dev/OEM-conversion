<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Vendors_QuickSelector" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Vendors-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="OEMConversion.UI.Vendors_QuickSelector" %>
