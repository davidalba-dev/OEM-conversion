...
// This file implements the code-behind class for Show_Vendors_Table.aspx.
// App_Code\Show_Vendors_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Vendors_Table
        : BaseApplicationPage
// Code-behind class for the Show_Vendors_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Vendors_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetVendorsTableControl()
        {
            SetVendorsTableControl_Base(); 
        }
...
public void SetVw_max_vendornoRecordControl()
        {
            SetVw_max_vendornoRecordControl_Base(); 
        }
#endregion
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "VendorsTableControl":
                 SetVendorsTableControl();
                 break;
          
              case "Vw_max_vendornoRecordControl":
                 SetVw_max_vendornoRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.VendorsTableControl.SaveData();
        
        this.Vw_max_vendornoRecordControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Vendors_Table.VendorsTableControl control = new OEMConversion.UI.Controls.Show_Vendors_Table.VendorsTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetVendorsTableControl_Base()           
        
        {        
            if (VendorsTableControl.Visible)
            {
                VendorsTableControl.LoadData();
                VendorsTableControl.DataBind();
            }
        }
      
        public void SetVw_max_vendornoRecordControl_Base()           
        
        {        
            if (Vw_max_vendornoRecordControl.Visible)
            {
                Vw_max_vendornoRecordControl.LoadData();
                Vw_max_vendornoRecordControl.DataBind();
            }
        }
