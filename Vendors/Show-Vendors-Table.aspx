...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-Vendors-Table.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Show_Vendors_Table" %>
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_Vendors_Table" %>
      ...
      <asp:UpdateProgress runat="server" id="UpdatePanel1_UpdateProgress1" AssociatedUpdatePanelID="UpdatePanel1">
		...
		<asp:UpdatePanel runat="server" id="UpdatePanel1" UpdateMode="Conditional">
			<ContentTemplate>
                ...
                Search Vendors: Name, City, Phone 
...
<OEMConversion:Vw_max_vendornoRecordControl runat="server" id="Vw_max_vendornoRecordControl">	<table cellpadding="0" cellspacing="0" border="0"><tr><td class="panelTL"><img src="../Images/space.gif" class="panelTLSpace" alt="" /></td><td class="panelT"></td><td class="panelTR"><img src="../Images/space.gif" class="panelTRSpace" alt="" /></td></tr><tr><td></td><td></td><td></td></tr><tr><td></td><td><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td>
                    <asp:panel id="Vw_max_vendornoRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td></td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="Expr1" visible="False"></asp:Literal></span>
 </td></tr></table></asp:panel>

                  </td></tr></table>
</td><td></td></tr></table>
	<asp:hiddenfield id="Vw_max_vendornoRecordControl_PostbackTracker" runat="server" />
</OEMConversion:Vw_max_vendornoRecordControl>
