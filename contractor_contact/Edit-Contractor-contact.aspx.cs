...
// This file implements the code-behind class for Edit_Contractor_contact.aspx.
// App_Code\Edit_Contractor_contact.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Contractor_contact
        : BaseApplicationPage
// Code-behind class for the Edit_Contractor_contact page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Contractor_contact()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetContractor_contactRecordControl()
        {
            SetContractor_contactRecordControl_Base(); 
        }
...
public void SetContractor_contact_rateTableControl()
        {
            SetContractor_contact_rateTableControl_Base(); 
        }
public void SetContractor_contact_attachTableControl()
        {
            SetContractor_contact_attachTableControl_Base(); 
        }
[System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_Contractor_contact_attachSearchText(string prefixText, int count)
        {
            // GetContractor_contact_attachSearchTextCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_Contractor_contact_attachSearchText_Base()
            // or replace the call to GetAutoCompletionList_Contractor_contact_attachSearchText_Base().
            return GetAutoCompletionList_Contractor_contact_attachSearchText_Base(prefixText, count);
        }
...
#region "Section 2: Do not modify this section."
      ...
      public void Page_InitializeEventHandlers_Base(object sender, System.EventArgs e)
      {
        ...
        protected virtual void Page_Load(object sender, EventArgs e)
        {
			...
			this.Authorize(((Control)(this.FindControlRecursively("TabPanel"))), "NO_ACCESS");
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Contractor Contact");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Contractor_contact_attachTableControl":
                 SetContractor_contact_attachTableControl();
                 break;
          
              case "Contractor_contact_rateTableControl":
                 SetContractor_contact_rateTableControl();
                 break;
          
              case "Contractor_contactRecordControl":
                 SetContractor_contactRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Contractor_contact_attachTableControl.SaveData();
        
        this.Contractor_contactRecordControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_Contractor_contact_attachSearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Edit_Contractor_contact.Contractor_contact_attachTableControl control = new OEMConversion.UI.Controls.Edit_Contractor_contact.Contractor_contact_attachTableControl();
        
        return control.GetAutoCompletionList_Contractor_contact_attachSearchText(prefixText, count);
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetContractor_contact_attachTableControl_Base()           
        
        {        
            if (Contractor_contact_attachTableControl.Visible)
            {
                Contractor_contact_attachTableControl.LoadData();
                Contractor_contact_attachTableControl.DataBind();
            }
        }
      
        public void SetContractor_contact_rateTableControl_Base()           
        
        {        
            if (Contractor_contact_rateTableControl.Visible)
            {
                Contractor_contact_rateTableControl.LoadData();
                Contractor_contact_rateTableControl.DataBind();
            }
        }
      
        public void SetContractor_contactRecordControl_Base()           
        
        {        
            if (Contractor_contactRecordControl.Visible)
            {
                Contractor_contactRecordControl.LoadData();
                Contractor_contactRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Contractor_contactRecordControl != null && this.Contractor_contactRecordControl.DataSource != null)
                  {
                        id = this.Contractor_contactRecordControl.DataSource.GetValue(this.Contractor_contactRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Contractor_contactRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Contractor_contactRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Contractor_contactRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Contractor_contactRecordControl.DataSource.GetValue(this.Contractor_contactRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
