<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Contractor-contact-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="OEMConversion.UI.Contractor_contact_QuickSelector" %>
...
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Contractor_contact_QuickSelector" %>
