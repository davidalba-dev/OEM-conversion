...
// This file implements the code-behind class for Add_Contractor_contact.aspx.
// App_Code\Add_Contractor_contact.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Contractor_contact
        : BaseApplicationPage
// Code-behind class for the Add_Contractor_contact page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Contractor_contact()
        {
            this.Initialize();
...
public void SetContractor_contact_rateRecordControl()
        {
            SetContractor_contact_rateRecordControl_Base(); 
        }
#endregion
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Contractor Contact");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Contractor_contact_rateRecordControl":
                 SetContractor_contact_rateRecordControl();
                 break;
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetContractor_contact_rateRecordControl_Base()           
        
        {        
            if (Contractor_contact_rateRecordControl.Visible)
            {
                Contractor_contact_rateRecordControl.LoadData();
                Contractor_contact_rateRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Contractor_contact_rateRecordControl != null && this.Contractor_contact_rateRecordControl.DataSource != null)
                  {
                        id = this.Contractor_contact_rateRecordControl.DataSource.GetValue(this.Contractor_contact_rateRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Contractor_contact_rateRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Contractor_contact_rateRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Contractor_contact_rateRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Contractor_contact_rateRecordControl.DataSource.GetValue(this.Contractor_contact_rateRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
