...
// This file implements the code-behind class for Copy_of_Show_Vw_equipment_inventory_Table.aspx.
// App_Code\Copy_of_Show_Vw_equipment_inventory_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Copy_of_Show_Vw_equipment_inventory_Table
        : BaseApplicationPage
// Code-behind class for the Copy_of_Show_Vw_equipment_inventory_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Copy_of_Show_Vw_equipment_inventory_Table()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Copy_of_Show_Vw_equipment_inventory_Table.Vw_equipment_inventoryTableControl control = new OEMConversion.UI.Controls.Copy_of_Show_Vw_equipment_inventory_Table.Vw_equipment_inventoryTableControl();
