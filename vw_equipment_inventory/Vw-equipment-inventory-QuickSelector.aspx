...
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Vw_equipment_inventory_QuickSelector" %>

<%@ Register Tagprefix="Selectors" Namespace="OEMConversion" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Vw-equipment-inventory-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="OEMConversion.UI.Vw_equipment_inventory_QuickSelector" %>
