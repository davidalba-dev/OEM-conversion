...
// This file implements the code-behind class for CustomerContactNotify_QuickSelector.aspx.
// App_Code\CustomerContactNotify_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
public partial class CustomerContactNotify_QuickSelector
        : BaseApplicationPage
// Code-behind class for the CustomerContactNotify_QuickSelector page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public CustomerContactNotify_QuickSelector()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_Search_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.CustomerContactNotify_QuickSelector.SelectorTableControl control = new OEMConversion.UI.Controls.CustomerContactNotify_QuickSelector.SelectorTableControl();
