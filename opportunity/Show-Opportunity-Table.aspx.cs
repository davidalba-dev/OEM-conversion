...
// This file implements the code-behind class for Show_Opportunity_Table.aspx.
// App_Code\Show_Opportunity_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Opportunity_Table
        : BaseApplicationPage
// Code-behind class for the Show_Opportunity_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Opportunity_Table()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SaveData_Base()
      {
        ...
        this.OpportunityTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Opportunity_Table.OpportunityTableControl control = new OEMConversion.UI.Controls.Show_Opportunity_Table.OpportunityTableControl();
