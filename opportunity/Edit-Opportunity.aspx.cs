...
// This file implements the code-behind class for Edit_Opportunity.aspx.
// App_Code\Edit_Opportunity.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Opportunity
        : BaseApplicationPage
// Code-behind class for the Edit_Opportunity page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Opportunity()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetOpportunityRecordControl()
        {
            SetOpportunityRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Opportunity");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "OpportunityRecordControl":
                 SetOpportunityRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.OpportunityRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetOpportunityRecordControl_Base()           
        
        {        
            if (OpportunityRecordControl.Visible)
            {
                OpportunityRecordControl.LoadData();
                OpportunityRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.OpportunityRecordControl != null && this.OpportunityRecordControl.DataSource != null)
                  {
                        id = this.OpportunityRecordControl.DataSource.GetValue(this.OpportunityRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.OpportunityRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.OpportunityRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.OpportunityRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.OpportunityRecordControl.DataSource.GetValue(this.OpportunityRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
