<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Add_Opportunity" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Add-Opportunity.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Add_Opportunity" %><asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title" Text="Add New Opportunity">	</asp:Literal>
                      </td></tr></table>
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="opportunity_dateTextBoxMaxLengthValidator" ControlToValidate="opportunity_date" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;OEMConversion&quot;).Replace(&quot;{FieldName}&quot;, &quot;Opportunity Date&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
 ...
 </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="custnoLabel" Text="Facility">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
<asp:DropDownList runat="server" id="lead_source_id" cssclass="field_input" onkeypress="dropDownListTypeAhead(this,false)"></asp:DropDownList></span>
 </td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="attachment_1Label" Text="Attachment 1">	</asp:Literal></td><td class="tableCellValue"><asp:FileUpload runat="server" id="attachment_1" cssclass="field_input" size="60"></asp:FileUpload></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="attachment_2Label" Text="Attachment 2">	</asp:Literal></td><td class="tableCellValue"><asp:FileUpload runat="server" id="attachment_2" cssclass="field_input" size="60"></asp:FileUpload></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="attachment_3Label" Text="Attachment 3">	</asp:Literal></td><td class="tableCellValue"><asp:FileUpload runat="server" id="attachment_3" cssclass="field_input" size="60"></asp:FileUpload> 
</td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="attachment_4Label" Text="Attachment 4">	</asp:Literal></td><td class="tableCellValue"><asp:FileUpload runat="server" id="attachment_4" cssclass="field_input" size="60"></asp:FileUpload></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="opportunity_notesLabel" Text="Opportunity Notes">	</asp:Literal></td><td class="tableCellValue" colspan="3"><custom:HTMLEditor ID="opportunity_notes" runat="server" opportunity_notesRequiredFieldValidator:Enabled="False" opportunity_notesRequiredFieldValidator:Text="*" Height="150px" Width="640" AutoFocus="False" /> </td></tr></table></asp:panel>
</td></tr></table>
</asp:panel>
