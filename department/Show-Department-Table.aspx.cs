...
// This file implements the code-behind class for Show_Department_Table.aspx.
// App_Code\Show_Department_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Department_Table
        : BaseApplicationPage
// Code-behind class for the Show_Department_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Department_Table()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SaveData_Base()
      {
        ...
        this.DepartmentTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Department_Table.DepartmentTableControl control = new OEMConversion.UI.Controls.Show_Department_Table.DepartmentTableControl();
