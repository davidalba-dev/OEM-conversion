...
// This file implements the code-behind class for Edit_Department.aspx.
// App_Code\Edit_Department.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Department
        : BaseApplicationPage
// Code-behind class for the Edit_Department page.
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetDepartmentTabContainer()
        {
            SetDepartmentTabContainer_Base(); 
        }
        
        public void SetDepartmentRecordControl()
        {
            SetDepartmentRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
      ...
      public void Page_InitializeEventHandlers_Base(object sender, System.EventArgs e)
      {
        ...
        protected virtual void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Authorize((Control)SaveButton, "3;5");
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Department");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "DepartmentRecordControl":
                 SetDepartmentRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.DepartmentRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetDepartmentTabContainer_Base()           
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "DepartmentTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "DepartmentTabContainer").Visible = false;
         
  
        }      
      
        public void SetDepartmentRecordControl_Base()           
        
        {        
            if (DepartmentRecordControl.Visible)
            {
                DepartmentRecordControl.LoadData();
                DepartmentRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.DepartmentRecordControl != null && this.DepartmentRecordControl.DataSource != null)
                  {
                        id = this.DepartmentRecordControl.DataSource.GetValue(this.DepartmentRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.DepartmentRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.DepartmentRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.DepartmentRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.DepartmentRecordControl.DataSource.GetValue(this.DepartmentRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
