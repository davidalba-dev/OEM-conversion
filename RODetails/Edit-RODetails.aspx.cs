...
// This file implements the code-behind class for Edit_RODetails.aspx.
// App_Code\Edit_RODetails.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_RODetails
        : BaseApplicationPage
// Code-behind class for the Edit_RODetails page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_RODetails()
        {
            this.Initialize();
...
//        public void SetRODetailsTabContainer()
//        {
//            SetRODetailsTabContainer_Base(); 
//        }
...
//        }
        ...
        public void SetRODetailsRecordControl()
        {
            SetRODetailsRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} RO Details");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "RODetailsRecordControl":
                 SetRODetailsRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.RODetailsRecordControl.SaveData();
        ...
        SetRODetailsRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "RODetailsMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRODetailsRecordControl_Base()           
        
        {        
            if (RODetailsRecordControl.Visible)
            {
                RODetailsRecordControl.LoadData();
                RODetailsRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.RODetailsRecordControl != null && this.RODetailsRecordControl.DataSource != null)
                  {
                        id = this.RODetailsRecordControl.DataSource.GetValue(this.RODetailsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.RODetailsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.RODetailsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.RODetailsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.RODetailsRecordControl.DataSource.GetValue(this.RODetailsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
