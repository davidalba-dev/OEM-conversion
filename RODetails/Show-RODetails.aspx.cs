...
// This file implements the code-behind class for Show_RODetails.aspx.
// App_Code\Show_RODetails.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_RODetails
        : BaseApplicationPage
// Code-behind class for the Show_RODetails page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_RODetails()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRODetailsTabContainer_Base()           
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "RODetailsTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "RODetailsTabContainer").Visible = false;
