...
// This file implements the code-behind class for Edit_PackDetails.aspx.
// App_Code\Edit_PackDetails.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_PackDetails
        : BaseApplicationPage
// Code-behind class for the Edit_PackDetails page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_PackDetails()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetPackDetailsRecordControl()
        {
            SetPackDetailsRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Pack Details");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "PackDetailsRecordControl":
                 SetPackDetailsRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.PackDetailsRecordControl.SaveData();
        ...
        SetPackDetailsRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "PackDetailsMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetPackDetailsRecordControl_Base()           
        
        {        
            if (PackDetailsRecordControl.Visible)
            {
                PackDetailsRecordControl.LoadData();
                PackDetailsRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.PackDetailsRecordControl != null && this.PackDetailsRecordControl.DataSource != null)
                  {
                        id = this.PackDetailsRecordControl.DataSource.GetValue(this.PackDetailsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.PackDetailsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.PackDetailsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.PackDetailsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.PackDetailsRecordControl.DataSource.GetValue(this.PackDetailsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
