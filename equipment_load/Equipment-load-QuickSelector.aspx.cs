...
// This file implements the code-behind class for Equipment_load_QuickSelector.aspx.
// App_Code\Equipment_load_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
public partial class Equipment_load_QuickSelector
        : BaseApplicationPage
// Code-behind class for the Equipment_load_QuickSelector page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Equipment_load_QuickSelector()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_Search_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Equipment_load_QuickSelector.SelectorTableControl control = new OEMConversion.UI.Controls.Equipment_load_QuickSelector.SelectorTableControl();
