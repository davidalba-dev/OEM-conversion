...
// This file implements the code-behind class for Edit_Contract.aspx.
// App_Code\Edit_Contract.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Contract
        : BaseApplicationPage
// Code-behind class for the Edit_Contract page.
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetContractTabContainer()
        {
            SetContractTabContainer_Base(); 
        }
        
        public void SetBudgetTableControl()
        {
            SetBudgetTableControl_Base(); 
        }
        
        public void SetContractRecordControl()
        {
            SetContractRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Contract");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "BudgetTableControl":
                 SetBudgetTableControl();
                 break;
          
              case "ContractRecordControl":
                 SetContractRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.ContractRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetContractTabContainer_Base()           
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "ContractTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "ContractTabContainer").Visible = false;
         
  
        }      
      
        public void SetBudgetTableControl_Base()           
        
        {        
            if (BudgetTableControl.Visible)
            {
                BudgetTableControl.LoadData();
                BudgetTableControl.DataBind();
            }
        }
      
        public void SetContractRecordControl_Base()           
        
        {        
            if (ContractRecordControl.Visible)
            {
                ContractRecordControl.LoadData();
                ContractRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.ContractRecordControl != null && this.ContractRecordControl.DataSource != null)
                  {
                        id = this.ContractRecordControl.DataSource.GetValue(this.ContractRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.ContractRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.ContractRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.ContractRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.ContractRecordControl.DataSource.GetValue(this.ContractRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
