<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Edit-Contract.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Edit_Contract" %>
...
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Edit_Contract" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title" Text="&lt;%#String.Concat(GetResourceValue(&quot;Title:Edit&quot;),&quot;&quot;,&quot; Contract&quot;) %>">	</asp:Literal>
                      </td></tr></table>
...
<%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("CancelButton"))%>
 ...
 <BaseClasses:TabPanel runat="server" id="BudgetTabPanel" HeaderText="Budget Allocation">	<ContentTemplate>
  <OEMConversion:BudgetTableControl runat="server" id="BudgetTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="panelTL"><img src="../Images/space.gif" class="panelTLSpace" alt="" /></td><td class="panelT"></td><td class="panelTR"><img src="../Images/space.gif" class="panelTRSpace" alt="" /></td></tr><tr><td class="panelHeaderL"></td><td class="dh">
            ...
            <OEMConversion:ThemeButtonWithArrow runat="server" id="Filters1Button" button-causesvalidation="False" button-commandname="Custom" button-onclientclick="return ISD_ShowPopupPanel(&#39;Filters1Div&#39;,&#39;Filters1Button&#39;,this);" button-text="&lt;%# GetResourceValue(&quot;Btn:Filters&quot;, &quot;OEMConversion&quot;) %>" button-tooltip="&lt;%# GetResourceValue(&quot;Btn:Filters&quot;, &quot;OEMConversion&quot;) %>"></OEMConversion:ThemeButtonWithArrow>
                  ...
                  <asp:panel id="CollapsibleRegion1" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="BudgetTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thcnb">&nbsp;</th><th class="thc">&nbsp;</th><th class="thc">&nbsp; 
<asp:Literal runat="server" id="custnoLabel" Text="Customer/Location">	</asp:Literal></th><th class="thc">&nbsp; 
<asp:Literal runat="server" id="budget_amountLabel" Text="Budget Amount">	</asp:Literal></th><th class="thc"></th></tr><asp:Repeater runat="server" id="BudgetTableControlRepeater">		<ITEMTEMPLATE>		<OEMConversion:BudgetTableControlRow runat="server" id="BudgetTableControlRow">
<tr><td class="tableRowButtonsCellVertical" style="text-align:left;"><asp:ImageButton runat="server" id="EditRowButton" causesvalidation="False" commandname="Redirect" cssclass="button_link" imageurl="../Images/icon_edit.gif" onmouseout="this.src=&#39;../Images/icon_edit.gif&#39;" onmouseover="this.src=&#39;../Images/icon_edit_over.gif&#39;" tooltip="&lt;%# GetResourceValue(&quot;Txt:EditRecord&quot;, &quot;OEMConversion&quot;) %>">		
	</asp:ImageButton>
...
<asp:DropDownList runat="server" id="budget_created_by" cssclass="field_input" onkeypress="dropDownListTypeAhead(this,false)" visible="False"></asp:DropDownList></span>
</td></tr><tr><td class="tableRowDivider" colspan="4"></td><td class="tableRowDivider"></td></tr></OEMConversion:BudgetTableControlRow>
</ITEMTEMPLATE>

</asp:Repeater>
<tr summary="Footer"><td class="tableCellValue"></td><td class="tableCellValue"></td><td class="tableCellValue"><%# GetResourceValue("Txt:GrandTotal", "OEMConversion") %></td><td class="tableCellValue"><asp:Label runat="server" id="budget_amountGrandTotal">	</asp:Label></td><td class="tableCellValue"></td></tr></table>
</td></tr></table>
</asp:panel>
