...
// This file implements the code-behind class for Add_Stage.aspx.
// App_Code\Add_Stage.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Stage
        : BaseApplicationPage
// Code-behind class for the Add_Stage page.
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetStageTabContainer()
        {
            SetStageTabContainer_Base(); 
        }
        
        public void SetOpportunityTableControl()
        {
            SetOpportunityTableControl_Base(); 
        }
        
        public void SetStageRecordControl()
        {
            SetStageRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Stage");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "OpportunityTableControl":
                 SetOpportunityTableControl();
                 break;
          
              case "StageRecordControl":
                 SetStageRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.StageRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetStageTabContainer_Base()           
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "StageTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "StageTabContainer").Visible = false;
         
  
        }      
      
        public void SetOpportunityTableControl_Base()           
        
        {        
            if (OpportunityTableControl.Visible)
            {
                OpportunityTableControl.LoadData();
                OpportunityTableControl.DataBind();
            }
        }
      
        public void SetStageRecordControl_Base()           
        
        {        
            if (StageRecordControl.Visible)
            {
                StageRecordControl.LoadData();
                StageRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.StageRecordControl != null && this.StageRecordControl.DataSource != null)
                  {
                        id = this.StageRecordControl.DataSource.GetValue(this.StageRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.StageRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.StageRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.StageRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.StageRecordControl.DataSource.GetValue(this.StageRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
