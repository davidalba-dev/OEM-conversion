...
// This file implements the code-behind class for Show_Stage_Table.aspx.
// App_Code\Show_Stage_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Stage_Table
        : BaseApplicationPage
// Code-behind class for the Show_Stage_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Stage_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetStageTableControl()
        {
            SetStageTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "StageTableControl":
                 SetStageTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.StageTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Stage_Table.StageTableControl control = new OEMConversion.UI.Controls.Show_Stage_Table.StageTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetStageTableControl_Base()           
        
        {        
            if (StageTableControl.Visible)
            {
                StageTableControl.LoadData();
                StageTableControl.DataBind();
            }
        }
