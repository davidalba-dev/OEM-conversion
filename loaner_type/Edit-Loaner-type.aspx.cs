...
// This file implements the code-behind class for Edit_Loaner_type.aspx.
// App_Code\Edit_Loaner_type.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Loaner_type
        : BaseApplicationPage
// Code-behind class for the Edit_Loaner_type page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Loaner_type()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetLoaner_typeRecordControl()
        {
            SetLoaner_typeRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Loaner Type");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Loaner_typeRecordControl":
                 SetLoaner_typeRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Loaner_typeRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetLoaner_typeRecordControl_Base()           
        
        {        
            if (Loaner_typeRecordControl.Visible)
            {
                Loaner_typeRecordControl.LoadData();
                Loaner_typeRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Loaner_typeRecordControl != null && this.Loaner_typeRecordControl.DataSource != null)
                  {
                        id = this.Loaner_typeRecordControl.DataSource.GetValue(this.Loaner_typeRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Loaner_typeRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Loaner_typeRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Loaner_typeRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Loaner_typeRecordControl.DataSource.GetValue(this.Loaner_typeRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
