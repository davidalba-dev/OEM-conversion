<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Customer_type_QuickSelector" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Customer-type-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="OEMConversion.UI.Customer_type_QuickSelector" %>
