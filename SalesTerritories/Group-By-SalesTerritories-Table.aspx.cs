...
// This file implements the code-behind class for Group_By_SalesTerritories_Table.aspx.
// App_Code\Group_By_SalesTerritories_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Group_By_SalesTerritories_Table
        : BaseApplicationPage
// Code-behind class for the Group_By_SalesTerritories_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Group_By_SalesTerritories_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetSalesTerritoriesTableControl()
        {
            SetSalesTerritoriesTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "SalesTerritoriesTableControl":
                 SetSalesTerritoriesTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.SalesTerritoriesTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetSalesTerritoriesTableControl_Base()           
        
        {        
            if (SalesTerritoriesTableControl.Visible)
            {
                SalesTerritoriesTableControl.LoadData();
                SalesTerritoriesTableControl.DataBind();
            }
        }
