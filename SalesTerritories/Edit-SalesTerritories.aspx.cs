...
// This file implements the code-behind class for Edit_SalesTerritories.aspx.
// App_Code\Edit_SalesTerritories.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_SalesTerritories
        : BaseApplicationPage
// Code-behind class for the Edit_SalesTerritories page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_SalesTerritories()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetSalesTerritoriesRecordControl()
        {
            SetSalesTerritoriesRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Sales Territories");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "SalesTerritoriesRecordControl":
                 SetSalesTerritoriesRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.SalesTerritoriesRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetSalesTerritoriesRecordControl_Base()           
        
        {        
            if (SalesTerritoriesRecordControl.Visible)
            {
                SalesTerritoriesRecordControl.LoadData();
                SalesTerritoriesRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.SalesTerritoriesRecordControl != null && this.SalesTerritoriesRecordControl.DataSource != null)
                  {
                        id = this.SalesTerritoriesRecordControl.DataSource.GetValue(this.SalesTerritoriesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.SalesTerritoriesRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.SalesTerritoriesRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.SalesTerritoriesRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.SalesTerritoriesRecordControl.DataSource.GetValue(this.SalesTerritoriesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
