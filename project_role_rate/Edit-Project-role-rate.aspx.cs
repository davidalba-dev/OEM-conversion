...
// This file implements the code-behind class for Edit_Project_role_rate.aspx.
// App_Code\Edit_Project_role_rate.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Project_role_rate
        : BaseApplicationPage
// Code-behind class for the Edit_Project_role_rate page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Project_role_rate()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetProject_role_rateRecordControl()
        {
            SetProject_role_rateRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Project Role Rate");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Project_role_rateRecordControl":
                 SetProject_role_rateRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Project_role_rateRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetProject_role_rateRecordControl_Base()           
        
        {        
            if (Project_role_rateRecordControl.Visible)
            {
                Project_role_rateRecordControl.LoadData();
                Project_role_rateRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Project_role_rateRecordControl != null && this.Project_role_rateRecordControl.DataSource != null)
                  {
                        id = this.Project_role_rateRecordControl.DataSource.GetValue(this.Project_role_rateRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Project_role_rateRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Project_role_rateRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Project_role_rateRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Project_role_rateRecordControl.DataSource.GetValue(this.Project_role_rateRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
