...
// This file implements the code-behind class for Add_Notification_log.aspx.
// App_Code\Add_Notification_log.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Notification_log
        : BaseApplicationPage
// Code-behind class for the Add_Notification_log page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Notification_log()
        {
            this.Initialize();
...
//        }
        ...
        public void SetNotification_logRecordControl()
        {
            SetNotification_logRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Notification Log");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Notification_logRecordControl":
                 SetNotification_logRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Notification_logRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetNotification_logRecordControl_Base()           
        
        {        
            if (Notification_logRecordControl.Visible)
            {
                Notification_logRecordControl.LoadData();
                Notification_logRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Notification_logRecordControl != null && this.Notification_logRecordControl.DataSource != null)
                  {
                        id = this.Notification_logRecordControl.DataSource.GetValue(this.Notification_logRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Notification_logRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Notification_logRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Notification_logRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Notification_logRecordControl.DataSource.GetValue(this.Notification_logRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
