<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Pickup_request_status_QuickSelector" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Pickup-request-status-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="OEMConversion.UI.Pickup_request_status_QuickSelector" %>
