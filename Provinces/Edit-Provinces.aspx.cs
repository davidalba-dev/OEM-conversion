...
// This file implements the code-behind class for Edit_Provinces.aspx.
// App_Code\Edit_Provinces.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Provinces
        : BaseApplicationPage
// Code-behind class for the Edit_Provinces page.
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetProvincesTabContainer()
        {
            SetProvincesTabContainer_Base(); 
        }
        
        public void SetProvincesRecordControl()
        {
            SetProvincesRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Provinces");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "ProvincesRecordControl":
                 SetProvincesRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.ProvincesRecordControl.SaveData();
        ...
        SetProvincesRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "ProvincesMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetProvincesTabContainer_Base()           
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "ProvincesTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "ProvincesTabContainer").Visible = false;
         
  
        }      
      
        public void SetProvincesRecordControl_Base()           
        
        {        
            if (ProvincesRecordControl.Visible)
            {
                ProvincesRecordControl.LoadData();
                ProvincesRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.ProvincesRecordControl != null && this.ProvincesRecordControl.DataSource != null)
                  {
                        id = this.ProvincesRecordControl.DataSource.GetValue(this.ProvincesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.ProvincesRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.ProvincesRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.ProvincesRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.ProvincesRecordControl.DataSource.GetValue(this.ProvincesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
