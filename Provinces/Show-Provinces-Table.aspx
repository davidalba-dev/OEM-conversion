...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-Provinces-Table.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Show_Provinces_Table" %>
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_Provinces_Table" %>
...
<BaseClasses:QuickSelector runat="server" id="ProvCodeFilter" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single">	</BaseClasses:QuickSelector><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="ProvincesTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" colspan="2" style="display:none"><img src="../Images/space.gif" height="1" width="1" alt="" /></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th></tr><asp:Repeater runat="server" id="ProvincesTableControlRepeater">		<ITEMTEMPLATE>		<OEMConversion:ProvincesTableControlRow runat="server" id="ProvincesTableControlRow">
...
</td><td class="tableCellValue"><asp:Literal runat="server" id="ProvName"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="CountryLabel" Text="Country">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="Country"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="GeoGroupLabel" Text="Geographical Group">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="GeoGroup"></asp:Literal> </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ProvCodeLabel" Text="Province Code">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="ProvCode"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ProvCodeDisplayLabel" Text="Province Code Display">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="ProvCodeDisplay"></asp:Literal> </td><td class="tableCellLabel"></td><td class="tableCellValue"></td></tr><tr><td class="tableRowDivider" colspan="8"></td></tr></OEMConversion:ProvincesTableControlRow>
</ITEMTEMPLATE>
