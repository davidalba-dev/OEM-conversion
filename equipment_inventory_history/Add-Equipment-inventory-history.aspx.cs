...
// This file implements the code-behind class for Add_Equipment_inventory_history.aspx.
// App_Code\Add_Equipment_inventory_history.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Equipment_inventory_history
        : BaseApplicationPage
// Code-behind class for the Add_Equipment_inventory_history page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Equipment_inventory_history()
        {
            this.Initialize();
...
//        }
        ...
        public void SetEquipment_inventory_historyRecordControl()
        {
            SetEquipment_inventory_historyRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = "Equipment Inventory Move";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Equipment_inventory_historyRecordControl":
                 SetEquipment_inventory_historyRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Equipment_inventory_historyRecordControl.SaveData();

            new fulcrum().updateWarehouseDataIntoFulcrum(Session["fulcrumID"].ToString(), this.Equipment_inventory_historyRecordControl.inventory_id.Text, this.Equipment_inventory_historyRecordControl.warehouse_id.SelectedItem.Text, this.Equipment_inventory_historyRecordControl.warehouse_location_id.SelectedItem.Text);

            //    this.Equipment_inventory_historyRecordControl.inventory_id.Text
            //this.Equipment_inventory_historyRecordControl.warehouse_id.SelectedItem.Text
            //this.Equipment_inventory_historyRecordControl.warehouse_location_id.SelectedItem.Text
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetEquipment_inventory_historyRecordControl_Base()           
        
        {        
            if (Equipment_inventory_historyRecordControl.Visible)
            {
                Equipment_inventory_historyRecordControl.LoadData();
                Equipment_inventory_historyRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Equipment_inventory_historyRecordControl != null && this.Equipment_inventory_historyRecordControl.DataSource != null)
                  {
                        id = this.Equipment_inventory_historyRecordControl.DataSource.GetValue(this.Equipment_inventory_historyRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Equipment_inventory_historyRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Equipment_inventory_historyRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Equipment_inventory_historyRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Equipment_inventory_historyRecordControl.DataSource.GetValue(this.Equipment_inventory_historyRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
