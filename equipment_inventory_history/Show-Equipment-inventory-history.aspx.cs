...
// This file implements the code-behind class for Show_Equipment_inventory_history.aspx.
// App_Code\Show_Equipment_inventory_history.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Equipment_inventory_history
        : BaseApplicationPage
// Code-behind class for the Show_Equipment_inventory_history page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Equipment_inventory_history()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = "Equipment Inventory History";
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void EditButton_Click_Base(object sender, EventArgs args)
        {
            ...
            string url = @"../equipment_inventory_history/Edit-Equipment-inventory-history.aspx?Equipment_inventory_history={PK}";
