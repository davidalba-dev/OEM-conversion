<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Add_Customer_note" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Add-Customer-note.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Add_Customer_note" %>
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="custnoTextBoxMaxLengthValidator" ControlToValidate="custno" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;OEMConversion&quot;).Replace(&quot;{FieldName}&quot;, &quot;Custno&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
 ...
 </td></tr><tr><td class="tableCellValue"><BaseClasses:QuickSelector runat="server" id="customer_note_createdby" redirecturl="" visible="False"></BaseClasses:QuickSelector> </td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
<asp:TextBox runat="server" id="customer_note_date" Columns="20" MaxLength="30" cssclass="field_input" visible="False"></asp:TextBox></td>
<td>
