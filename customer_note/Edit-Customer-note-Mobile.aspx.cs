...
// This file implements the code-behind class for Edit_Customer_note_Mobile.aspx.
// App_Code\Edit_Customer_note_Mobile.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Customer_note_Mobile
        : BaseApplicationPage
// Code-behind class for the Edit_Customer_note_Mobile page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Customer_note_Mobile()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Customer Note");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Customer_noteRecordControl":
                 SetCustomer_noteRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Customer_noteRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetCustomer_noteRecordControl_Base()           
        
        {        
            if (Customer_noteRecordControl.Visible)
            {
                Customer_noteRecordControl.LoadData();
                Customer_noteRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Customer_noteRecordControl != null && this.Customer_noteRecordControl.DataSource != null)
                  {
                        id = this.Customer_noteRecordControl.DataSource.GetValue(this.Customer_noteRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Customer_noteRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Customer_noteRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Customer_noteRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Customer_noteRecordControl.DataSource.GetValue(this.Customer_noteRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
