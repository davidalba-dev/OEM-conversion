...
// This file implements the code-behind class for Add_Equipment_inventory_dotmed.aspx.
// App_Code\Add_Equipment_inventory_dotmed.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Equipment_inventory_dotmed
        : BaseApplicationPage
// Code-behind class for the Add_Equipment_inventory_dotmed page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Equipment_inventory_dotmed()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetEquipment_inventory_dotmedRecordControl()
        {
            SetEquipment_inventory_dotmedRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Equipment Inventory Dotmed");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Equipment_inventory_dotmedRecordControl":
                 SetEquipment_inventory_dotmedRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Equipment_inventory_dotmedRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetEquipment_inventory_dotmedRecordControl_Base()           
        
        {        
            if (Equipment_inventory_dotmedRecordControl.Visible)
            {
                Equipment_inventory_dotmedRecordControl.LoadData();
                Equipment_inventory_dotmedRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Equipment_inventory_dotmedRecordControl != null && this.Equipment_inventory_dotmedRecordControl.DataSource != null)
                  {
                        id = this.Equipment_inventory_dotmedRecordControl.DataSource.GetValue(this.Equipment_inventory_dotmedRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Equipment_inventory_dotmedRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Equipment_inventory_dotmedRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Equipment_inventory_dotmedRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Equipment_inventory_dotmedRecordControl.DataSource.GetValue(this.Equipment_inventory_dotmedRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
