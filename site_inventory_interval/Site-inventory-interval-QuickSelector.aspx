<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Site-inventory-interval-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="OEMConversion.UI.Site_inventory_interval_QuickSelector" %>
...
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Site_inventory_interval_QuickSelector" %>
