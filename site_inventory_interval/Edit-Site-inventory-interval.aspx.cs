...
// This file implements the code-behind class for Edit_Site_inventory_interval.aspx.
// App_Code\Edit_Site_inventory_interval.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Site_inventory_interval
        : BaseApplicationPage
// Code-behind class for the Edit_Site_inventory_interval page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Site_inventory_interval()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetSite_inventory_intervalRecordControl()
        {
            SetSite_inventory_intervalRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Site Inventory Interval");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Site_inventory_intervalRecordControl":
                 SetSite_inventory_intervalRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Site_inventory_intervalRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetSite_inventory_intervalRecordControl_Base()           
        
        {        
            if (Site_inventory_intervalRecordControl.Visible)
            {
                Site_inventory_intervalRecordControl.LoadData();
                Site_inventory_intervalRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Site_inventory_intervalRecordControl != null && this.Site_inventory_intervalRecordControl.DataSource != null)
                  {
                        id = this.Site_inventory_intervalRecordControl.DataSource.GetValue(this.Site_inventory_intervalRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Site_inventory_intervalRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Site_inventory_intervalRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Site_inventory_intervalRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Site_inventory_intervalRecordControl.DataSource.GetValue(this.Site_inventory_intervalRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
