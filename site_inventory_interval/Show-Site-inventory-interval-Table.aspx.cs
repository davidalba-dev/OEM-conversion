...
// This file implements the code-behind class for Show_Site_inventory_interval_Table.aspx.
// App_Code\Show_Site_inventory_interval_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Site_inventory_interval_Table
        : BaseApplicationPage
// Code-behind class for the Show_Site_inventory_interval_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Site_inventory_interval_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetSite_inventory_intervalTableControl()
        {
            SetSite_inventory_intervalTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = "Site Inventory Interval";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Site_inventory_intervalTableControl":
                 SetSite_inventory_intervalTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Site_inventory_intervalTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetSite_inventory_intervalTableControl_Base()           
        
        {        
            if (Site_inventory_intervalTableControl.Visible)
            {
                Site_inventory_intervalTableControl.LoadData();
                Site_inventory_intervalTableControl.DataBind();
            }
        }
