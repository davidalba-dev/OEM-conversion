...
// This file implements the code-behind class for Edit_Territory.aspx.
// App_Code\Edit_Territory.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Territory
        : BaseApplicationPage
// Code-behind class for the Edit_Territory page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Territory()
        {
            this.Initialize();
...
//        public void SetTerritoryTabContainer()
//        {
//            SetTerritoryTabContainer_Base(); 
//        }
...
//        }
        ...
        public void SetTerritoryRecordControl()
        {
            SetTerritoryRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Territory");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "TerritoryRecordControl":
                 SetTerritoryRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.TerritoryRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetTerritoryRecordControl_Base()           
        
        {        
            if (TerritoryRecordControl.Visible)
            {
                TerritoryRecordControl.LoadData();
                TerritoryRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.TerritoryRecordControl != null && this.TerritoryRecordControl.DataSource != null)
                  {
                        id = this.TerritoryRecordControl.DataSource.GetValue(this.TerritoryRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.TerritoryRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.TerritoryRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.TerritoryRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.TerritoryRecordControl.DataSource.GetValue(this.TerritoryRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
