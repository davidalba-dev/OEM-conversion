<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Territory_QuickSelector" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Territory-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="OEMConversion.UI.Territory_QuickSelector" %>
