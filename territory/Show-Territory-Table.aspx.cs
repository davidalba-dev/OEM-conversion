...
// This file implements the code-behind class for Show_Territory_Table.aspx.
// App_Code\Show_Territory_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Territory_Table
        : BaseApplicationPage
// Code-behind class for the Show_Territory_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Territory_Table()
        {
            this.Initialize();
...
//        public void SetTerritoryTableControl()
//        {
//            SetTerritoryTableControl_Base(); 
//        }
...
public void SetTerritoryTableControl1()
        {
            SetTerritoryTableControl1_Base(); 
        }
#endregion
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "TerritoryTableControl1":
                 SetTerritoryTableControl1();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.TerritoryTableControl1.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetTerritoryTableControl1_Base()           
        
        {        
            if (TerritoryTableControl1.Visible)
            {
                TerritoryTableControl1.LoadData();
                TerritoryTableControl1.DataBind();
            }
        }
