...
// This file implements the code-behind class for Add_Master_customer_ref.aspx.
// App_Code\Add_Master_customer_ref.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Master_customer_ref
        : BaseApplicationPage
// Code-behind class for the Add_Master_customer_ref page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Master_customer_ref()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetMaster_customer_refRecordControl()
        {
            SetMaster_customer_refRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Master Customer Reference");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Master_customer_refRecordControl":
                 SetMaster_customer_refRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Master_customer_refRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetMaster_customer_refRecordControl_Base()           
        
        {        
            if (Master_customer_refRecordControl.Visible)
            {
                Master_customer_refRecordControl.LoadData();
                Master_customer_refRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Master_customer_refRecordControl != null && this.Master_customer_refRecordControl.DataSource != null)
                  {
                        id = this.Master_customer_refRecordControl.DataSource.GetValue(this.Master_customer_refRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Master_customer_refRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Master_customer_refRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Master_customer_refRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Master_customer_refRecordControl.DataSource.GetValue(this.Master_customer_refRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
