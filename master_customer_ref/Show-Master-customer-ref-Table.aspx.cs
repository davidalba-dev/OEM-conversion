...
// This file implements the code-behind class for Show_Master_customer_ref_Table.aspx.
// App_Code\Show_Master_customer_ref_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Master_customer_ref_Table
        : BaseApplicationPage
// Code-behind class for the Show_Master_customer_ref_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Master_customer_ref_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetMaster_customer_refTableControl()
        {
            SetMaster_customer_refTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = "Master Customer Reference";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Master_customer_refTableControl":
                 SetMaster_customer_refTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Master_customer_refTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetMaster_customer_refTableControl_Base()           
        
        {        
            if (Master_customer_refTableControl.Visible)
            {
                Master_customer_refTableControl.LoadData();
                Master_customer_refTableControl.DataBind();
            }
        }
