<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Add_ServiceCodes" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Add-ServiceCodes.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Add_ServiceCodes" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title" Text="&lt;%#String.Concat(GetResourceValue(&quot;Title:Add&quot;),&quot;&quot;,&quot; Service Codes&quot;) %>">	</asp:Literal>
                      </td></tr></table>
...
</td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ServCategoryLabel" Text="EvaluateFormula(&quot;= \&quot;Service Category\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
</td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ServTypeLabel" Text="EvaluateFormula(&quot;= \&quot;Service Type\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:DropDownList runat="server" id="ServType" cssclass="field_input" onkeypress="dropDownListTypeAhead(this,false)"></asp:DropDownList>&nbsp;
<asp:RequiredFieldValidator runat="server" id="ServTypeRequiredFieldValidator" ControlToValidate="ServType" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueIsRequired&quot;, &quot;OEMConversion&quot;).Replace(&quot;{FieldName}&quot;, EvaluateFormula(&quot;= \&quot;Service Type\&quot;&quot;, true)) %>" enabled="True" initialvalue="--PLEASE_SELECT--" text="*"></asp:RequiredFieldValidator></span>
</td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ServChargeLabel" Text="EvaluateFormula(&quot;= \&quot;Service Charge\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
</td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ServCodeGroupLabel" Text="EvaluateFormula(&quot;= \&quot;Service Code Group\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
</td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ServDescLabel" Text="EvaluateFormula(&quot;= \&quot;Service Description\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><asp:TextBox runat="server" id="ServDesc" MaxLength="120" columns="50" cssclass="field_input" rows="3" textmode="MultiLine"></asp:TextBox>&nbsp;
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="ServDescTextBoxMaxLengthValidator" ControlToValidate="ServDesc" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;OEMConversion&quot;).Replace(&quot;{FieldName}&quot;, EvaluateFormula(&quot;= \&quot;Service Description\&quot;&quot;, true)) %>"></BaseClasses:TextBoxMaxLengthValidator></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="Service_activeLabel" Text="Service Active">	</asp:Literal></td><td class="tableCellValue"><asp:CheckBox runat="server" id="Service_active"></asp:CheckBox></td></tr></table></asp:panel>
</td></tr></table>
</asp:panel>
