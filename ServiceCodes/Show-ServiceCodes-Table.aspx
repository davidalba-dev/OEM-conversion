...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-ServiceCodes-Table.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Show_ServiceCodes_Table" %>
<%@ Register Tagprefix="Selectors" Namespace="OEMConversion" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Tagprefix="BaseClasses" Namespace="BaseClasses.Web.UI.WebControls" Assembly="BaseClasses" %>
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_ServiceCodes_Table" %>
...
<BaseClasses:QuickSelector runat="server" id="ServCodeGroupFilter" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single">	</BaseClasses:QuickSelector><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="ServiceCodesTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" colspan="2"><img src="../Images/space.gif" height="1" width="1" alt="" /></th><th class="thc"><asp:Literal runat="server" id="ServCategoryLabel" Text="EvaluateFormula(&quot;= \&quot;Service Category\&quot;&quot;, true)">	</asp:Literal></th><th class="thc"><asp:Literal runat="server" id="ServCodeLabel" Text="EvaluateFormula(&quot;= \&quot;Service Code\&quot;&quot;, true)">	</asp:Literal></th><th class="thc"><asp:LinkButton runat="server" id="ServCodeGroupLabel" tooltip="Sort by ServCodeGroup" Text="EvaluateFormula(&quot;= \&quot;Service Code Group\&quot;&quot;, true)" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="ServDescLabel" tooltip="Sort by ServDesc" Text="EvaluateFormula(&quot;= \&quot;Service Description\&quot;&quot;, true)" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="ServChargeLabel" tooltip="Sort by ServCharge" Text="EvaluateFormula(&quot;= \&quot;Service Charge\&quot;&quot;, true)" CausesValidation="False">	</asp:LinkButton></th></tr><asp:Repeater runat="server" id="ServiceCodesTableControlRepeater">		<ITEMTEMPLATE>		<OEMConversion:ServiceCodesTableControlRow runat="server" id="ServiceCodesTableControlRow">
<tr><td class="tableRowButtonsCellVertical" scope="row" style="font-size: 5px;" colspan="2">
                                ...
                                </td><td class="tableCellValue"><asp:Literal runat="server" id="ServCategory"></asp:Literal> </td><td class="tableCellValue"><asp:Literal runat="server" id="ServCode"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ServCodeGroup"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ServDesc"></asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="ServCharge"></asp:Literal></span>
</td></tr><tr><td class="tableRowDivider" colspan="6"></td><td class="tableRowDivider"></td></tr></OEMConversion:ServiceCodesTableControlRow>
</ITEMTEMPLATE>
