...
// This file implements the code-behind class for Edit_ServiceCodes.aspx.
// App_Code\Edit_ServiceCodes.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_ServiceCodes
        : BaseApplicationPage
// Code-behind class for the Edit_ServiceCodes page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_ServiceCodes()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetServiceCodesRecordControl()
        {
            SetServiceCodesRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Service Codes");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "ServiceCodesRecordControl":
                 SetServiceCodesRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.ServiceCodesRecordControl.SaveData();
        ...
        SetServiceCodesRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "ServiceCodesMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetServiceCodesRecordControl_Base()           
        
        {        
            if (ServiceCodesRecordControl.Visible)
            {
                ServiceCodesRecordControl.LoadData();
                ServiceCodesRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.ServiceCodesRecordControl != null && this.ServiceCodesRecordControl.DataSource != null)
                  {
                        id = this.ServiceCodesRecordControl.DataSource.GetValue(this.ServiceCodesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.ServiceCodesRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.ServiceCodesRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.ServiceCodesRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.ServiceCodesRecordControl.DataSource.GetValue(this.ServiceCodesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
