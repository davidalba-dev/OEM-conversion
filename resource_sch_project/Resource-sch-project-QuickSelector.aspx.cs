...
// This file implements the code-behind class for Resource_sch_project_QuickSelector.aspx.
// App_Code\Resource_sch_project_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
public partial class Resource_sch_project_QuickSelector
        : BaseApplicationPage
// Code-behind class for the Resource_sch_project_QuickSelector page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Resource_sch_project_QuickSelector()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_Search_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Resource_sch_project_QuickSelector.SelectorTableControl control = new OEMConversion.UI.Controls.Resource_sch_project_QuickSelector.SelectorTableControl();
