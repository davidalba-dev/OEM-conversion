...
// This file implements the code-behind class for Show_Resource_sch_project_Table.aspx.
// App_Code\Show_Resource_sch_project_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Resource_sch_project_Table
        : BaseApplicationPage
// Code-behind class for the Show_Resource_sch_project_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Resource_sch_project_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetResource_sch_projectTableControl()
        {
            SetResource_sch_projectTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = "Resource SCH Project";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Resource_sch_projectTableControl":
                 SetResource_sch_projectTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Resource_sch_projectTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Resource_sch_project_Table.Resource_sch_projectTableControl control = new OEMConversion.UI.Controls.Show_Resource_sch_project_Table.Resource_sch_projectTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetResource_sch_projectTableControl_Base()           
        
        {        
            if (Resource_sch_projectTableControl.Visible)
            {
                Resource_sch_projectTableControl.LoadData();
                Resource_sch_projectTableControl.DataBind();
            }
        }
