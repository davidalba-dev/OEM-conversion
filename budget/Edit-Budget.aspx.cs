...
// This file implements the code-behind class for Edit_Budget.aspx.
// App_Code\Edit_Budget.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Budget
        : BaseApplicationPage
// Code-behind class for the Edit_Budget page.
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetBudgetRecordControl()
        {
            SetBudgetRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Budget");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "BudgetRecordControl":
                 SetBudgetRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.BudgetRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetBudgetRecordControl_Base()           
        
        {        
            if (BudgetRecordControl.Visible)
            {
                BudgetRecordControl.LoadData();
                BudgetRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.BudgetRecordControl != null && this.BudgetRecordControl.DataSource != null)
                  {
                        id = this.BudgetRecordControl.DataSource.GetValue(this.BudgetRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.BudgetRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.BudgetRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.BudgetRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.BudgetRecordControl.DataSource.GetValue(this.BudgetRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
