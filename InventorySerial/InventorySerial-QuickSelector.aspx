<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.InventorySerial_QuickSelector" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="InventorySerial-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="OEMConversion.UI.InventorySerial_QuickSelector" %>
