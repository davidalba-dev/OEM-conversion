...
// This file implements the code-behind class for Edit_InventorySerial.aspx.
// App_Code\Edit_InventorySerial.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_InventorySerial
        : BaseApplicationPage
// Code-behind class for the Edit_InventorySerial page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_InventorySerial()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetInventorySerialRecordControl()
        {
            SetInventorySerialRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Inventory Serial");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "InventorySerialRecordControl":
                 SetInventorySerialRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.InventorySerialRecordControl.SaveData();
        ...
        SetInventorySerialRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "InventorySerialMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetInventorySerialRecordControl_Base()           
        
        {        
            if (InventorySerialRecordControl.Visible)
            {
                InventorySerialRecordControl.LoadData();
                InventorySerialRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.InventorySerialRecordControl != null && this.InventorySerialRecordControl.DataSource != null)
                  {
                        id = this.InventorySerialRecordControl.DataSource.GetValue(this.InventorySerialRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.InventorySerialRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.InventorySerialRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.InventorySerialRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.InventorySerialRecordControl.DataSource.GetValue(this.InventorySerialRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
