...
// This file implements the code-behind class for Show_FaultCodes.aspx.
// App_Code\Show_FaultCodes.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_FaultCodes
        : BaseApplicationPage
// Code-behind class for the Show_FaultCodes page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_FaultCodes()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetFaultCodesTabContainer_Base()           
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "FaultCodesTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "FaultCodesTabContainer").Visible = false;
