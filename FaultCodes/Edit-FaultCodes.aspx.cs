...
// This file implements the code-behind class for Edit_FaultCodes.aspx.
// App_Code\Edit_FaultCodes.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_FaultCodes
        : BaseApplicationPage
// Code-behind class for the Edit_FaultCodes page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_FaultCodes()
        {
            this.Initialize();
...
//        public void SetFaultCodesTabContainer()
//        {
//            SetFaultCodesTabContainer_Base(); 
//        }
        
        public void SetFaultCodesRecordControl()
        {
            SetFaultCodesRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Fault Codes");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "FaultCodesRecordControl":
                 SetFaultCodesRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.FaultCodesRecordControl.SaveData();
        ...
        SetFaultCodesRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "FaultCodesMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetFaultCodesRecordControl_Base()           
        
        {        
            if (FaultCodesRecordControl.Visible)
            {
                FaultCodesRecordControl.LoadData();
                FaultCodesRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.FaultCodesRecordControl != null && this.FaultCodesRecordControl.DataSource != null)
                  {
                        id = this.FaultCodesRecordControl.DataSource.GetValue(this.FaultCodesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.FaultCodesRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.FaultCodesRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.FaultCodesRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.FaultCodesRecordControl.DataSource.GetValue(this.FaultCodesRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
