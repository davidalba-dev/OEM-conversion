...
// This file implements the code-behind class for Edit_FaultCodes_Table.aspx.
// App_Code\Edit_FaultCodes_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_FaultCodes_Table
        : BaseApplicationPage
// Code-behind class for the Edit_FaultCodes_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_FaultCodes_Table()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Edit_FaultCodes_Table.FaultCodesTableControl control = new OEMConversion.UI.Controls.Edit_FaultCodes_Table.FaultCodesTableControl();
