...
// This file implements the code-behind class for Show_Conditions_Table_Mobile.aspx.
// App_Code\Show_Conditions_Table_Mobile.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Conditions_Table_Mobile
        : BaseApplicationPage
// Code-behind class for the Show_Conditions_Table_Mobile page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Conditions_Table_Mobile()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Conditions_Table_Mobile.ConditionsTableControl control = new OEMConversion.UI.Controls.Show_Conditions_Table_Mobile.ConditionsTableControl();
