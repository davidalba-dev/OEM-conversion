...
// This file implements the code-behind class for Edit_Conditions.aspx.
// App_Code\Edit_Conditions.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Conditions
        : BaseApplicationPage
// Code-behind class for the Edit_Conditions page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Conditions()
        {
            this.Initialize();
...
//        public void SetConditionsTabContainer()
//        {
//            SetConditionsTabContainer_Base(); 
//        }
        
        public void SetConditionsRecordControl()
        {
            SetConditionsRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Conditions");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "ConditionsRecordControl":
                 SetConditionsRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.ConditionsRecordControl.SaveData();
        ...
        SetConditionsRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "ConditionsMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetConditionsRecordControl_Base()           
        
        {        
            if (ConditionsRecordControl.Visible)
            {
                ConditionsRecordControl.LoadData();
                ConditionsRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.ConditionsRecordControl != null && this.ConditionsRecordControl.DataSource != null)
                  {
                        id = this.ConditionsRecordControl.DataSource.GetValue(this.ConditionsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.ConditionsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.ConditionsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.ConditionsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.ConditionsRecordControl.DataSource.GetValue(this.ConditionsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
