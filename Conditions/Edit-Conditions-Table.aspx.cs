...
// This file implements the code-behind class for Edit_Conditions_Table.aspx.
// App_Code\Edit_Conditions_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Conditions_Table
        : BaseApplicationPage
// Code-behind class for the Edit_Conditions_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Conditions_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetConditionsTableControl()
        {
            SetConditionsTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "ConditionsTableControl":
                 SetConditionsTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.ConditionsTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Edit_Conditions_Table.ConditionsTableControl control = new OEMConversion.UI.Controls.Edit_Conditions_Table.ConditionsTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetConditionsTableControl_Base()           
        
        {        
            if (ConditionsTableControl.Visible)
            {
                ConditionsTableControl.LoadData();
                ConditionsTableControl.DataBind();
            }
        }
