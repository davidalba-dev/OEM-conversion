...
// This file implements the code-behind class for Show_RepairOrders_Table_CustomerContact_History.aspx.
// App_Code\Show_RepairOrders_Table_CustomerContact_History.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_RepairOrders_Table_CustomerContact_History
        : BaseApplicationPage
// Code-behind class for the Show_RepairOrders_Table_CustomerContact_History page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_RepairOrders_Table_CustomerContact_History()
        {
            this.Initialize();
...
//        [System.Web.Services.WebMethod]
//        public static string[] GetAutoCompletionList_RepairOrder_CustomerContactSearchText1(string prefixText, int count)
//        {
//            // GetRepairOrder_CustomerContactSearchText1CompletionList gets the list of suggestions from the database.
//            // prefixText is the search text typed by the user .
//            // count specifies the number of suggestions to be returned.
//            // Customize by adding code before or after the call to  GetAutoCompletionList_RepairOrder_CustomerContactSearchText1_Base()
//            // or replace the call to GetAutoCompletionList_RepairOrder_CustomerContactSearchText1_Base().
//            return GetAutoCompletionList_RepairOrder_CustomerContactSearchText1_Base(prefixText, count);
//        }
...
//        public void SetRepairOrder_CustomerContactTableControl()
//        {
//            SetRepairOrder_CustomerContactTableControl_Base(); 
//        }
...
//public void SetRepairOrder_CustomerContact_HistoryTableControl()
//        {
//            SetRepairOrder_CustomerContact_HistoryTableControl_Base(); 
//        }
//[System.Web.Services.WebMethod]
//        public static string[] GetAutoCompletionList_RepairOrder_CustomerContact_HistorySearchText1(string prefixText, int count)
//        {
//            // GetRepairOrder_CustomerContact_HistorySearchText1CompletionList gets the list of suggestions from the database.
//            // prefixText is the search text typed by the user .
//            // count specifies the number of suggestions to be returned.
//            // Customize by adding code before or after the call to  GetAutoCompletionList_RepairOrder_CustomerContact_HistorySearchText1_Base()
//            // or replace the call to GetAutoCompletionList_RepairOrder_CustomerContact_HistorySearchText1_Base().
//            return GetAutoCompletionList_RepairOrder_CustomerContact_HistorySearchText1_Base(prefixText, count);
//        }
public void SetRepairOrder_CustomerContact_HistoryTableControl1()
        {
            SetRepairOrder_CustomerContact_HistoryTableControl1_Base(); 
        }
[System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_RepairOrder_CustomerContact_HistorySearchText2(string prefixText, int count)
        {
            // GetRepairOrder_CustomerContact_HistorySearchText2CompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_RepairOrder_CustomerContact_HistorySearchText2_Base()
            // or replace the call to GetAutoCompletionList_RepairOrder_CustomerContact_HistorySearchText2_Base().
            return GetAutoCompletionList_RepairOrder_CustomerContact_HistorySearchText2_Base(prefixText, count);
        }
#endregion
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "RepairOrder_CustomerContact_HistoryTableControl1":
                 SetRepairOrder_CustomerContact_HistoryTableControl1();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.RepairOrder_CustomerContact_HistoryTableControl1.SaveData();
    ...
    public static string[] GetAutoCompletionList_RepairOrder_CustomerContact_HistorySearchText2_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_RepairOrders_Table_CustomerContact_History.RepairOrder_CustomerContact_HistoryTableControl1 control = new OEMConversion.UI.Controls.Show_RepairOrders_Table_CustomerContact_History.RepairOrder_CustomerContact_HistoryTableControl1();
        
        return control.GetAutoCompletionList_RepairOrder_CustomerContact_HistorySearchText2(prefixText, count);
        ...
        SetRepairOrder_CustomerContact_HistoryTableControl1();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "RepairOrdersMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRepairOrder_CustomerContact_HistoryTableControl1_Base()           
        
        {        
            if (RepairOrder_CustomerContact_HistoryTableControl1.Visible)
            {
                RepairOrder_CustomerContact_HistoryTableControl1.LoadData();
                RepairOrder_CustomerContact_HistoryTableControl1.DataBind();
            }
        }
