...
// This file implements the code-behind class for Show_RepairOrders_Table_Corp.aspx.
// App_Code\Show_RepairOrders_Table_Corp.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_RepairOrders_Table_Corp
        : BaseApplicationPage
// Code-behind class for the Show_RepairOrders_Table_Corp page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_RepairOrders_Table_Corp()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_RepairOrders_Table_Corp.RepairOrdersTableControl control = new OEMConversion.UI.Controls.Show_RepairOrders_Table_Corp.RepairOrdersTableControl();
