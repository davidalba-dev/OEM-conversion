...
// This file implements the code-behind class for Bio_RepairOrders_Table.aspx.
// App_Code\Bio_RepairOrders_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Bio_RepairOrders_Table
        : BaseApplicationPage
// Code-behind class for the Bio_RepairOrders_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Bio_RepairOrders_Table()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Bio_RepairOrders_Table.RepairOrdersTableControl control = new OEMConversion.UI.Controls.Bio_RepairOrders_Table.RepairOrdersTableControl();
