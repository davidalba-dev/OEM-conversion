...
// This file implements the code-behind class for RepairOrder_POD_Mobile.aspx.
// App_Code\RepairOrder_POD_Mobile.Controls.vb contains the Table, Row and Record control classes
...
public partial class RepairOrder_POD_Mobile
        : BaseApplicationPage
// Code-behind class for the RepairOrder_POD_Mobile page.
	...
	public void SaveSignature() 
	{
		// Use the Me.CustomersRecordControl.GetRecord() to retrieve the record that was just updated.
          ...
          try
          {
              ...
              intPK = this.RepairOrdersRecordControl.GetRecord().RONo;             
              
              myRecord = RepairOrdersTable.GetRecord(intPK.ToString(), true);

              // Miles Gibson: June 28, 2017 -- check for a signature in the image, and then save it to the SignatureImage field

              // need this line to trigger the control to populate the ImageBytes variable
              this.WebSignature1.ExportToStreamOnly();
              myRecord.SignatureImage = this.WebSignature1.ImageBytes;
                myRecord.Save();
          ...
          {
               BaseClasses.Utils.DbUtils.RollBackTransaction(); 
              // Report the error message to the user.
              BaseClasses.Utils.MiscUtils.RegisterJScriptAlert(this, "UNIQUE_SCRIPTKEY", "Could not save signature. Error was: " + ex.Message);
              
          }
	
	}
	
      public RepairOrder_POD_Mobile()
        {
            this.Initialize();
...
public void SetPushButton()
		...
		public void PushButton_Click(object sender, EventArgs args)
        {
	SaveSignature();
...
//          // NOTE: If the Base function redirects to another page, any code here will not be executed.
//        }
public void SetPushButton1()
        {
            SetPushButton1_Base(); 
        }              
public void PushButton1_Click(object sender, EventArgs args)
        {
...
#region "Section 2: Do not modify this section."
      ...
      public void Page_InitializeEventHandlers_Base(object sender, System.EventArgs e)
      {
        ...
        if(!string.IsNullOrEmpty(this.Enctype)) this.Page.Form.Enctype = this.Enctype;
          ...
          // Setup the pagination events.
                    ...
                    this.PushButton.Click += PushButton_Click;
                        
                    this.PushButton1.Click += PushButton1_Click;
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetPushButton_Base()                
        ...
        public void SetPushButton1_Base()                
        ...
        public void PushButton_Click_Base(object sender, EventArgs args)
        {
      ...
      this.Response.Redirect(url);
        ...
        // event handler for PushButton
        public void PushButton1_Click_Base(object sender, EventArgs args)
        {
