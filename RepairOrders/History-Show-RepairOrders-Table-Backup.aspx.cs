...
// This file implements the code-behind class for History_Show_RepairOrders_Table_Backup.aspx.
...
public partial class History_Show_RepairOrders_Table_Backup
        : BaseApplicationPage
// Code-behind class for the History_Show_RepairOrders_Table_Backup page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public History_Show_RepairOrders_Table_Backup()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SaveData_Base()
      {
        ...
        this.RepairOrdersTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.History_Show_RepairOrders_Table_Backup.RepairOrdersTableControl control = new OEMConversion.UI.Controls.History_Show_RepairOrders_Table_Backup.RepairOrdersTableControl();
