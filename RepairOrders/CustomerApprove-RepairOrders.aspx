...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="CustomerApprove-RepairOrders.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.CustomerApprove_RepairOrders" %>
<%@ Register Tagprefix="Selectors" Namespace="OEMConversion" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Tagprefix="BaseClasses" Namespace="BaseClasses.Web.UI.WebControls" Assembly="BaseClasses" %>
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.CustomerApprove_RepairOrders" %>
...
</td><td class="dht" valign="middle"><OEMConversion:ThemeButton runat="server" id="SaveButton1" button-causesvalidation="True" button-commandname="UpdateData" button-text="Approve Repair Order" button-tooltip="Approve Repair Order" postback="True" sendemail1content="The+following+Repair+Estimate+has+been+approved.%0d%0a%0d%0aRoNo-%7bRepairOrdersRecordControl%3aNoUrlEncode%3aFDV%3aRONo%7d%0d%0aApproved+by%3a%7bRepairOrdersRecordControl%3aNoUrlEncode%3aFDV%3aROReference4%7d%0d%0aApproved+Date%2fTime%3a+%7bRepairOrdersRecordControl%3aNoUrlEncode%3aFDV%3aRODateEstimateApproved%7d" sendemail1forrecord="Current" sendemail1from="oeminfo%40oemmed.com" sendemail1subject="OEM+MED+-+Repair+Estimate+(Approval)" sendemail1to="oeminfo%40oemmed.com"></OEMConversion:ThemeButton></td></tr></table>
...
</td><td class="tableCellLabel"><asp:Literal runat="server" id="ROReference1Label" Text="EvaluateFormula(&quot;= \&quot;PO#\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ROReference1"></asp:Literal></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ROReference3Label" Text="EvaluateFormula(&quot;= \&quot;Case/Box\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ROReference3"></asp:Literal></td><td class="tableCellLabel"><asp:Literal runat="server" id="ROReference2Label" Text="EvaluateFormula(&quot;= \&quot;Dept\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="RODeptIDNew"></asp:Literal></span>
</td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ROMakeLabel" Text="EvaluateFormula(&quot;= \&quot;Make\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ROMake"></asp:Literal></td><td class="tableCellLabel"><asp:Literal runat="server" id="ROReference4Label1" Text="EvaluateFormula(&quot;= \&quot;Approved By\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:DropDownList runat="server" id="ROReference" backcolor="Yellow" cssclass="field_input" onkeypress="dropDownListTypeAhead(this,false)"></asp:DropDownList></span>
</td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ROModelLabel" Text="EvaluateFormula(&quot;= \&quot;Model\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ROModel"></asp:Literal></td><td class="tableCellLabel"><asp:Literal runat="server" id="RODateEstimateApprovedLabel" Text="EvaluateFormula(&quot;= \&quot;Date Est. Approved\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
<asp:TextBox runat="server" id="RODateEstimateApproved" Columns="20" MaxLength="30" backcolor="Yellow" cssclass="field_input" htmlencodevalue="Default" readonly="True"></asp:TextBox></td>
<td>
&nbsp;
...
</td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ROCategoryLabel" Text="EvaluateFormula(&quot;= \&quot;Category\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="category_id"></asp:Literal></td><td class="tableCellLabel"><asp:Literal runat="server" id="ROReference4Label" Text="EvaluateFormula(&quot;= \&quot;Approved By\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ROReference4"></asp:Literal> </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ROSerialNoLabel" Text="EvaluateFormula(&quot;= \&quot;Serial Number\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ROSerialNo"></asp:Literal></td><td class="tableCellLabel"><asp:Literal runat="server" id="ROConditionLabel" Text="EvaluateFormula(&quot;= \&quot;Condition\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ROCondition"></asp:Literal></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"><asp:Literal runat="server" id="ROFaultCodesLabel" Text="EvaluateFormula(&quot;= \&quot;Fault Code\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ROFaultCodes"></asp:Literal></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"><asp:Literal runat="server" id="RODescLabel" Text="EvaluateFormula(&quot;= \&quot;Description\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="RODesc"></asp:Literal></td></tr><tr><td class="tableCellLabel" colspan="4"><%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("CancelButton"))%>
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("EditButton"))%>
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("OKButton"))%>
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveAndNewButton"))%>
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
<BaseClasses:TabContainer runat="server" id="RepairOrdersRecordControlTabContainer" panellayout="Tabbed"> 
 <BaseClasses:TabPanel runat="server" id="TabPanel" requiredroles="&lt;PRoles>NO_ACCESS&lt;/PRoles>" HeaderText="Facility Details">	<ContentTemplate> 
...
<asp:Literal runat="server" id="CustNo"></asp:Literal></span>
 ...
 <BaseClasses:TabPanel runat="server" id="TabPanel1" requiredroles="&lt;PRoles>NO_ACCESS&lt;/PRoles>" HeaderText="Contact Details">	<ContentTemplate> 
...
<BaseClasses:TabPanel runat="server" id="TabPanel6" HeaderText="Est/Repair">	<ContentTemplate> 
  <OEMConversion:RepairOrdersRecordControl1 runat="server" id="RepairOrdersRecordControl1">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="panelTL"><img src="../Images/space.gif" class="panelTLSpace" alt="" /></td><td class="panelT"></td><td class="panelTR"><img src="../Images/space.gif" class="panelTRSpace" alt="" /></td></tr><tr><td class="panelHeaderL"></td><td class="dh">
                  ...
                  <asp:panel id="CollapsibleRegion6" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><asp:panel id="RepairOrdersRecordControl1Panel" runat="server"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ROEstimatedByLabel" Text="Estimated By">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ROEstimatedBy1"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ROWorkDoneNotesLabel2" Text="EvaluateFormula(&quot;= \&quot;Work Done Notes\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue" style="vertical-align:top;text-align:left;" rowspan="4"><asp:Literal runat="server" id="ROWorkDoneNotes2"></asp:Literal></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="RODateEstimateCompletedLabel1" Text="Date Est. Prepared">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
</td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ROHowApprovedLabel1" Text="How Approved">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ROHowApproved1"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ROProblemLabel" Text="RO Problem">	</asp:Literal></td><td class="tableCellValue" style="vertical-align:top;text-align:left;" rowspan="4"><asp:Literal runat="server" id="ROProblem"></asp:Literal></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="RODateEstimatedCompletionLabel1" Text="Est. Completion Date">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
<BaseClasses:TabPanel runat="server" id="TabPanel9" requiredroles="&lt;PRoles>5&lt;/PRoles>" HeaderText="Invoice Details">	<ContentTemplate> 
...
</td></tr><tr><td class="tableCellLabel"><OEMConversion:ThemeButton runat="server" id="CancelButton1" button-causesvalidation="false" button-commandname="Redirect" button-text="Return" button-tooltip="Return"></OEMConversion:ThemeButton></td><td class="tableCellLabel"></td><td class="tableCellLabel"></td><td class="tableCellLabel"></td></tr></table></asp:panel>
</td></tr></table>
</asp:panel>
                </td><td class="panelR"></td></tr><tr><td class="panelBL"><img src="../Images/space.gif" class="panelBLSpace" alt="" /></td><td class="panelB"></td><td class="panelBR"><img src="../Images/space.gif" class="panelBRSpace" alt="" /></td></tr></table>
