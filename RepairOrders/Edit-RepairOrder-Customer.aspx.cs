...
// This file implements the code-behind class for Edit_RepairOrder_Customer.aspx.
// App_Code\Edit_RepairOrder_Customer.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_RepairOrder_Customer
        : BaseApplicationPage
// Code-behind class for the Edit_RepairOrder_Customer page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_RepairOrder_Customer()
        {
            this.Initialize();
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.RepairOrdersRecordControl != null && this.RepairOrdersRecordControl.DataSource != null)
                  {
                        id = this.RepairOrdersRecordControl.DataSource.GetValue(this.RepairOrdersRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.RepairOrdersRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.RepairOrdersRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.RepairOrdersRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.RepairOrdersRecordControl.DataSource.GetValue(this.RepairOrdersRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
