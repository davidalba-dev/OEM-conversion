...
// This file implements the code-behind class for Start.aspx.
// App_Code\Start.Controls.vb contains the Table, Row and Record control classes
...
public partial class Start
        : BaseApplicationPage
// Code-behind class for the Start page.
...
//public void SetRepairOrdersCountChart()
//        {
//            SetRepairOrdersCountChart_Base();
//        }
public void SetRepairorder_dashboardTableControl()
        {
            SetRepairorder_dashboardTableControl_Base(); 
        }
//public void SetResource_sch_ticketTableControl()
//        {
//            SetResource_sch_ticketTableControl_Base(); 
//        }
//public void SetResource_sch_ticketTableControl1()
//        {
//            SetResource_sch_ticketTableControl1_Base(); 
//        }
public void SetPickup_requestTableControl()
        {
            SetPickup_requestTableControl_Base(); 
        }
public void SetVw_ticket_detailsTableControl()
        {
            SetVw_ticket_detailsTableControl_Base(); 
        }
public void SetVw_ticket_detailsTableControl1()
        {
            SetVw_ticket_detailsTableControl1_Base(); 
        }
#endregion
...
#region "Section 2: Do not modify this section."
      ...
      public void Page_InitializeEventHandlers_Base(object sender, System.EventArgs e)
      {
        ...
        protected virtual void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Authorize((Control)Pickup_requestTableControl, "1;2;3");
					
            this.Authorize((Control)Repairorder_dashboardTableControl, "1;2;3");
					
            this.Authorize((Control)Vw_ticket_detailsTableControl, "1;2;3");
					
            this.Authorize((Control)Vw_ticket_detailsTableControl1, "1;2;3");
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Pickup_requestTableControl":
                 SetPickup_requestTableControl();
                 break;
          
              case "Repairorder_dashboardTableControl":
                 SetRepairorder_dashboardTableControl();
                 break;
          
              case "Vw_ticket_detailsTableControl":
                 SetVw_ticket_detailsTableControl();
                 break;
          
              case "Vw_ticket_detailsTableControl1":
                 SetVw_ticket_detailsTableControl1();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Pickup_requestTableControl.SaveData();
        
        this.Repairorder_dashboardTableControl.SaveData();
        
        this.Vw_ticket_detailsTableControl.SaveData();
        
        this.Vw_ticket_detailsTableControl1.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetPickup_requestTableControl_Base()           
        
        {        
            if (Pickup_requestTableControl.Visible)
            {
                Pickup_requestTableControl.LoadData();
                Pickup_requestTableControl.DataBind();
            }
        }
      
        public void SetRepairorder_dashboardTableControl_Base()           
        
        {        
            if (Repairorder_dashboardTableControl.Visible)
            {
                Repairorder_dashboardTableControl.LoadData();
                Repairorder_dashboardTableControl.DataBind();
            }
        }
      
        public void SetVw_ticket_detailsTableControl_Base()           
        
        {        
            if (Vw_ticket_detailsTableControl.Visible)
            {
                Vw_ticket_detailsTableControl.LoadData();
                Vw_ticket_detailsTableControl.DataBind();
            }
        }
      
        public void SetVw_ticket_detailsTableControl1_Base()           
        
        {        
            if (Vw_ticket_detailsTableControl1.Visible)
            {
                Vw_ticket_detailsTableControl1.LoadData();
                Vw_ticket_detailsTableControl1.DataBind();
            }
        }
