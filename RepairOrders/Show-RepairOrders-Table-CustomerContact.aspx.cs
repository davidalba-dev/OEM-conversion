...
// This file implements the code-behind class for Show_RepairOrders_Table_CustomerContact.aspx.
// App_Code\Show_RepairOrders_Table_CustomerContact.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_RepairOrders_Table_CustomerContact
        : BaseApplicationPage
// Code-behind class for the Show_RepairOrders_Table_CustomerContact page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_RepairOrders_Table_CustomerContact()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "RepairOrder_CustomerContactTableControl":
                 SetRepairOrder_CustomerContactTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.RepairOrder_CustomerContactTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_RepairOrder_CustomerContactSearchText1_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_RepairOrders_Table_CustomerContact.RepairOrder_CustomerContactTableControl control = new OEMConversion.UI.Controls.Show_RepairOrders_Table_CustomerContact.RepairOrder_CustomerContactTableControl();
        
        return control.GetAutoCompletionList_RepairOrder_CustomerContactSearchText1(prefixText, count);
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRepairOrder_CustomerContactTableControl_Base()           
        
        {        
            if (RepairOrder_CustomerContactTableControl.Visible)
            {
                RepairOrder_CustomerContactTableControl.LoadData();
                RepairOrder_CustomerContactTableControl.DataBind();
            }
        }
