...
// This file implements the code-behind class for Notify_RepairOrders.aspx.
// App_Code\Notify_RepairOrders.Controls.vb contains the Table, Row and Record control classes
...
public partial class Notify_RepairOrders
        : BaseApplicationPage
// Code-behind class for the Notify_RepairOrders page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Notify_RepairOrders()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetRepairOrdersRecordControl()
        {
            SetRepairOrdersRecordControl_Base(); 
        }
...
[System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_CustomerContactNotifySearchText1(string prefixText, int count)
        {
            // GetCustomerContactNotifySearchText1CompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_CustomerContactNotifySearchText1_Base()
            // or replace the call to GetAutoCompletionList_CustomerContactNotifySearchText1_Base().
            return GetAutoCompletionList_CustomerContactNotifySearchText1_Base(prefixText, count);
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Repair Orders");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "RepairOrdersRecordControl":
                 SetRepairOrdersRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.RepairOrdersRecordControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_CustomerContactNotifySearchText1_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Notify_RepairOrders.CustomerContactNotifyTableControl control = new OEMConversion.UI.Controls.Notify_RepairOrders.CustomerContactNotifyTableControl();
        
        return control.GetAutoCompletionList_CustomerContactNotifySearchText1(prefixText, count);
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRepairOrdersRecordControl_Base()           
        
        {        
            if (RepairOrdersRecordControl.Visible)
            {
                RepairOrdersRecordControl.LoadData();
                RepairOrdersRecordControl.DataBind();
            }
        }
    ...
    public  void SendEmailOnSaveButton_Click_Base()
        ...
        SendEmail1From = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("tjennings%40pantheratech.com"), "", false);
        ...
        SendEmail1To = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("%7bCustomerContactNotifyTableControl%3aNoUrlEncode%3aFV%3aCustContactEmail%7d"), "" ,false);

          
        string SendEmail1Subject;
        //In case Subject includes expressions substitute them with values
        SendEmail1Subject = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("Your+subject+here"), "", false);
          
        string SendEmail1Content;
        //In case content has expressions substitude then with values
        SendEmail1Content = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("TEST"), "", false);
