<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Metal_RepairOrders_Table_Sales" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Metal-RepairOrders-Table-Sales.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Metal_RepairOrders_Table_Sales" %>
			...
			<ContentTemplate>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="updatePanelContent"><tr><td>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title" Text="Metal Repair Orders">	</asp:Literal>
                      </td></tr></table>
...
</td><td class="tableCellValueGrid"><asp:LinkButton runat="server" id="ROTechnician" causesvalidation="False" commandname="Redirect"></asp:LinkButton></td><td class="tableCellValueGrid"></td></tr></OEMConversion:RepairOrdersTableControlRow>
</ITEMTEMPLATE>

</asp:Repeater>
<tr summary="Footer"><td class="tableCellValue" colspan="17"><%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("CancelButton"))%>
...
<td>
&nbsp;
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="Expr1TextBoxMaxLengthValidator" ControlToValidate="Expr1" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;OEMConversion&quot;).Replace(&quot;{FieldName}&quot;, &quot;Metal&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></td>
</tr>
</table>
</span>
