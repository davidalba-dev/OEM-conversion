...
// This file implements the code-behind class for Show_RepairOrders_Table_Sales.aspx.
// App_Code\Show_RepairOrders_Table_Sales.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_RepairOrders_Table_Sales
        : BaseApplicationPage
// Code-behind class for the Show_RepairOrders_Table_Sales page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_RepairOrders_Table_Sales()
        {
            this.Initialize();
...
public void SetRepairOrdersTableControl1()
        {
            SetRepairOrdersTableControl1_Base(); 
        }
[System.Web.Services.WebMethod]
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "RepairOrdersTableControl1":
                 SetRepairOrdersTableControl1();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.RepairOrdersTableControl1.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText1_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_RepairOrders_Table_Sales.RepairOrdersTableControl1 control = new OEMConversion.UI.Controls.Show_RepairOrders_Table_Sales.RepairOrdersTableControl1();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRepairOrdersTableControl1_Base()           
        
        {        
            if (RepairOrdersTableControl1.Visible)
            {
                RepairOrdersTableControl1.LoadData();
                RepairOrdersTableControl1.DataBind();
            }
        }
