...
// This file implements the code-behind class for History_Show_RepairOrders_Table_Sales.aspx.
// App_Code\History_Show_RepairOrders_Table_Sales.Controls.vb contains the Table, Row and Record control classes
...
public partial class History_Show_RepairOrders_Table_Sales
        : BaseApplicationPage
// Code-behind class for the History_Show_RepairOrders_Table_Sales page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public History_Show_RepairOrders_Table_Sales()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_Repairorder_historySearchText1_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.History_Show_RepairOrders_Table_Sales.Repairorder_historyTableControl1 control = new OEMConversion.UI.Controls.History_Show_RepairOrders_Table_Sales.Repairorder_historyTableControl1();
