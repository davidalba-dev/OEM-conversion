...
// This file implements the code-behind class for Show_RepairOrders_Table_Customer.aspx.
// App_Code\Show_RepairOrders_Table_Customer.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_RepairOrders_Table_Customer
        : BaseApplicationPage
// Code-behind class for the Show_RepairOrders_Table_Customer page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_RepairOrders_Table_Customer()
        {
            this.Initialize();
...
//        }
public void SetRepairorder_customerTableControl()
        {
            SetRepairorder_customerTableControl_Base(); 
        }
[System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_Repairorder_customerSearchText1(string prefixText, int count)
        {
            // GetRepairorder_customerSearchText1CompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_Repairorder_customerSearchText1_Base()
            // or replace the call to GetAutoCompletionList_Repairorder_customerSearchText1_Base().
            return GetAutoCompletionList_Repairorder_customerSearchText1_Base(prefixText, count);
        }
#endregion
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Repairorder_customerTableControl":
                 SetRepairorder_customerTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Repairorder_customerTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_Repairorder_customerSearchText1_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_RepairOrders_Table_Customer.Repairorder_customerTableControl control = new OEMConversion.UI.Controls.Show_RepairOrders_Table_Customer.Repairorder_customerTableControl();
        
        return control.GetAutoCompletionList_Repairorder_customerSearchText1(prefixText, count);
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRepairorder_customerTableControl_Base()           
        
        {        
            if (Repairorder_customerTableControl.Visible)
            {
                Repairorder_customerTableControl.LoadData();
                Repairorder_customerTableControl.DataBind();
            }
        }
