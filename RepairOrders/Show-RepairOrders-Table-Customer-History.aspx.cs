...
// This file implements the code-behind class for Show_RepairOrders_Table_Customer_History.aspx.
// App_Code\Show_RepairOrders_Table_Customer_History.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_RepairOrders_Table_Customer_History
        : BaseApplicationPage
// Code-behind class for the Show_RepairOrders_Table_Customer_History page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_RepairOrders_Table_Customer_History()
        {
            this.Initialize();
...
#region "Ajax Functions"
        ...
        [System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_Repairorder_historySearchText1(string prefixText, int count)
        {
            // GetRepairorder_historySearchText1CompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_Repairorder_historySearchText1_Base()
            // or replace the call to GetAutoCompletionList_Repairorder_historySearchText1_Base().
            return GetAutoCompletionList_Repairorder_historySearchText1_Base(prefixText, count);
        }
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetRepairorder_historyTableControl1()
        {
            SetRepairorder_historyTableControl1_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Repairorder_historyTableControl1":
                 SetRepairorder_historyTableControl1();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Repairorder_historyTableControl1.SaveData();
    ...
    public static string[] GetAutoCompletionList_Repairorder_historySearchText1_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_RepairOrders_Table_Customer_History.Repairorder_historyTableControl1 control = new OEMConversion.UI.Controls.Show_RepairOrders_Table_Customer_History.Repairorder_historyTableControl1();
        
        return control.GetAutoCompletionList_Repairorder_historySearchText1(prefixText, count);
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRepairorder_historyTableControl1_Base()           
        
        {        
            if (Repairorder_historyTableControl1.Visible)
            {
                Repairorder_historyTableControl1.LoadData();
                Repairorder_historyTableControl1.DataBind();
            }
        }
