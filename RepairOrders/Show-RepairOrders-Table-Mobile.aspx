<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-RepairOrders-Table-Mobile.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Mobile.master" Inherits="OEMConversion.UI.Show_RepairOrders_Table_Mobile" %>
<%@ Register Tagprefix="OEMConversion" TagName="InfinitePaginationMobile" Src="../Shared/InfinitePaginationMobile.ascx" %>

<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_RepairOrders_Table_Mobile" %>
...
<tr onclick="RedirectByViewButton(event)"><td class="mobileTableCell" style="display:none;"><!-- Note: Cell Is Hidden --><asp:ImageButton runat="server" id="ViewRowButton" causesvalidation="False" commandname="Redirect" cssclass="button_link" imageurl="../Images/icon_view.gif" tooltip="&lt;%# GetResourceValue(&quot;Txt:ViewRecord&quot;, &quot;OEMConversion&quot;) %>">		
                  ...
                  &nbsp;
                </td><td class="mobileTableCell"><asp:Literal runat="server" id="ROCustName"></asp:Literal><br>
<asp:Literal runat="server" id="RODeptIDNew"></asp:Literal> <br>
<asp:Literal runat="server" id="RONo"></asp:Literal><br>
<asp:Literal runat="server" id="ROStatus"></asp:Literal></td></tr></OEMConversion:RepairOrdersTableControlRow>
</ITEMTEMPLATE>
