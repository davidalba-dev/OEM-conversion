...
// This file implements the code-behind class for Corp_Reports.aspx.
// App_Code\Corp_Reports.Controls.vb contains the Table, Row and Record control classes
...
public partial class Corp_Reports
        : BaseApplicationPage
// Code-behind class for the Corp_Reports page.
...
public void SetRepairorder_dashboardRecordControl()
        {
            SetRepairorder_dashboardRecordControl_Base(); 
        }
#endregion
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Repairorder_dashboardRecordControl":
                 SetRepairorder_dashboardRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Repairorder_dashboardRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRepairorder_dashboardRecordControl_Base()           
        
        {        
            if (Repairorder_dashboardRecordControl.Visible)
            {
                Repairorder_dashboardRecordControl.LoadData();
                Repairorder_dashboardRecordControl.DataBind();
            }
        }
