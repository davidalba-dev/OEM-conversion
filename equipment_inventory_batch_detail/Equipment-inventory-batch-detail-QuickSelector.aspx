<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Equipment_inventory_batch_detail_QuickSelector" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Equipment-inventory-batch-detail-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="OEMConversion.UI.Equipment_inventory_batch_detail_QuickSelector" %>
