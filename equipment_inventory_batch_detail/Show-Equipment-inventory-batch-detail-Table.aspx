...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-Equipment-inventory-batch-detail-Table.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Show_Equipment_inventory_batch_detail_Table" %>
<%@ Register Tagprefix="OEMConversion" TagName="ThemeButton" Src="../Shared/ThemeButton.ascx" %>

<%@ Register Tagprefix="Selectors" Namespace="OEMConversion" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_Equipment_inventory_batch_detail_Table" %>
...
<BaseClasses:QuickSelector runat="server" id="modelFilter" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single">	</BaseClasses:QuickSelector><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre">
                    <table id="Equipment_inventory_batch_detailTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" colspan="2" style="display:none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th></tr><asp:Repeater runat="server" id="Equipment_inventory_batch_detailTableControlRepeater">		<ITEMTEMPLATE>		<OEMConversion:Equipment_inventory_batch_detailTableControlRow runat="server" id="Equipment_inventory_batch_detailTableControlRow">
...
<asp:LinkButton runat="server" id="equipment_inventory_batch_id" causesvalidation="False" commandname="Redirect"></asp:LinkButton></span>
 </td><td class="tableCellLabel"><asp:Literal runat="server" id="EINLabel" Text="EIN">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="EIN"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="oem_einLabel" Text="OEM EIN">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="oem_ein"></asp:Literal> </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="purchase_priceLabel" Text="EvaluateFormula(&quot;= \&quot;Bid Price\&quot;&quot;, true)">	</asp:Literal> 
</td><td class="tableCellValue"><span style="white-space:nowrap;">
...
</td><td class="tableCellValue"><asp:LinkButton runat="server" id="condition_id" causesvalidation="False" commandname="Redirect"></asp:LinkButton> </td><td class="tableCellLabel"><asp:Literal runat="server" id="serial_numberLabel" Text="Serial Number">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="serial_number"></asp:Literal> </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="acceptedLabel" Text="Accepted">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="accepted"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="accessoriesLabel" Text="Accessories">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="accessories"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="equipment_inventory_disposition_idLabel" Text="Equipment Inventory Disposition">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="equipment_inventory_disposition_id"></asp:Literal> </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="oem_barcode_approveLabel" Text="OEM Barcode Approve">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="oem_barcode_approve"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="phiLabel" Text="PHI">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="phi"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="processedLabel" Text="Processed">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="processed"></asp:Literal> </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="modelLabel" Text="Model">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="model"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="makeLabel" Text="Make">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="make"></asp:Literal> </td><td class="tableCellLabel"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="commentLabel" Text="Comment">	</asp:Literal> 
</td><td class="tableCellValue" colspan="5"><asp:Literal runat="server" id="comment"></asp:Literal> </td></tr><tr><td class="tableRowDivider" colspan="8"></td></tr></OEMConversion:Equipment_inventory_batch_detailTableControlRow>
</ITEMTEMPLATE>
