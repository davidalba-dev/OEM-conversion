...
// This file implements the code-behind class for Show_Procurement_status_Table.aspx.
// App_Code\Show_Procurement_status_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Procurement_status_Table
        : BaseApplicationPage
// Code-behind class for the Show_Procurement_status_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Procurement_status_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetProcurement_statusTableControl()
        {
            SetProcurement_statusTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Procurement_statusTableControl":
                 SetProcurement_statusTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Procurement_statusTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetProcurement_statusTableControl_Base()           
        
        {        
            if (Procurement_statusTableControl.Visible)
            {
                Procurement_statusTableControl.LoadData();
                Procurement_statusTableControl.DataBind();
            }
        }
