...
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_Projects_Closed_Table" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-Projects-Closed-Table.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Show_Projects_Closed_Table" %>
			...
			<ContentTemplate>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="updatePanelContent"><tr><td>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                      ...
                      </td><td class="dht" valign="middle"><OEMConversion:ThemeButton runat="server" id="Button" button-causesvalidation="False" button-commandname="Redirect" button-text="Open Projects" button-tooltip="Open Projects"></OEMConversion:ThemeButton></td></tr></table>
...
<span style="white-space:nowrap;">
<asp:Literal runat="server" id="project_actual"></asp:Literal></span>
</td><td class="tableCellValue"><asp:Literal runat="server" id="project_cost"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="project_status_id"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="project_type_id"></asp:Literal></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="project_descriptionLabel" Text="EvaluateFormula(&quot;= \&quot;Description\&quot;&quot;, true)">	</asp:Literal> 
</td><td class="tableCellValue" colspan="6"><asp:Literal runat="server" id="project_description"></asp:Literal> </td><td class="tableCellValue"></td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableRowDivider" colspan="9"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td></tr></OEMConversion:ProjectTableControlRow>
</ITEMTEMPLATE>
