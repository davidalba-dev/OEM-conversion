...
// This file implements the code-behind class for Edit_Project.aspx.
// App_Code\Edit_Project.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Project
        : BaseApplicationPage
// Code-behind class for the Edit_Project page.
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetProjectRecordControl()
        {
            SetProjectRecordControl_Base(); 
        }
...
public void SetResource_sch_ticketTableControl()
        {
            SetResource_sch_ticketTableControl_Base(); 
        }
[System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_Resource_sch_ticketSearchText(string prefixText, int count)
        {
            // GetResource_sch_ticketSearchTextCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_Resource_sch_ticketSearchText_Base()
            // or replace the call to GetAutoCompletionList_Resource_sch_ticketSearchText_Base().
            return GetAutoCompletionList_Resource_sch_ticketSearchText_Base(prefixText, count);
        }
public void SetResource_sch_project_imgTableControl()
        {
            SetResource_sch_project_imgTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
      ...
      public void Page_InitializeEventHandlers_Base(object sender, System.EventArgs e)
      {
        ...
        protected virtual void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Authorize((Control)SaveButton, "3");
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Project");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "ProjectRecordControl":
                 SetProjectRecordControl();
                 break;
          
              case "Resource_sch_project_imgTableControl":
                 SetResource_sch_project_imgTableControl();
                 break;
          
              case "Resource_sch_ticketTableControl":
                 SetResource_sch_ticketTableControl();
                 break;
    ...
    public static string[] GetAutoCompletionList_Resource_sch_ticketSearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Edit_Project.Resource_sch_ticketTableControl control = new OEMConversion.UI.Controls.Edit_Project.Resource_sch_ticketTableControl();
        
        return control.GetAutoCompletionList_Resource_sch_ticketSearchText(prefixText, count);
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetProjectRecordControl_Base()           
        
        {        
            if (ProjectRecordControl.Visible)
            {
                ProjectRecordControl.LoadData();
                ProjectRecordControl.DataBind();
            }
        }
      
        public void SetResource_sch_project_imgTableControl_Base()           
        
        {        
            if (Resource_sch_project_imgTableControl.Visible)
            {
                Resource_sch_project_imgTableControl.LoadData();
                Resource_sch_project_imgTableControl.DataBind();
            }
        }
      
        public void SetResource_sch_ticketTableControl_Base()           
        
        {        
            if (Resource_sch_ticketTableControl.Visible)
            {
                Resource_sch_ticketTableControl.LoadData();
                Resource_sch_ticketTableControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.ProjectRecordControl != null && this.ProjectRecordControl.DataSource != null)
                  {
                        id = this.ProjectRecordControl.DataSource.GetValue(this.ProjectRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.ProjectRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.ProjectRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.ProjectRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.ProjectRecordControl.DataSource.GetValue(this.ProjectRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
