...
// This file implements the code-behind class for Show_Vw_resource_schedule_day_Table_Mobile.aspx.
// App_Code\Show_Vw_resource_schedule_day_Table_Mobile.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Vw_resource_schedule_day_Table_Mobile
        : BaseApplicationPage
// Code-behind class for the Show_Vw_resource_schedule_day_Table_Mobile page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Vw_resource_schedule_day_Table_Mobile()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetVw_resource_schedule_dayTableControl()
        {
            SetVw_resource_schedule_dayTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = "Resource Schedule Day";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Vw_resource_schedule_dayTableControl":
                 SetVw_resource_schedule_dayTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Vw_resource_schedule_dayTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Vw_resource_schedule_day_Table_Mobile.Vw_resource_schedule_dayTableControl control = new OEMConversion.UI.Controls.Show_Vw_resource_schedule_day_Table_Mobile.Vw_resource_schedule_dayTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetVw_resource_schedule_dayTableControl_Base()           
        
        {        
            if (Vw_resource_schedule_dayTableControl.Visible)
            {
                Vw_resource_schedule_dayTableControl.LoadData();
                Vw_resource_schedule_dayTableControl.DataBind();
            }
        }
