...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-Vw-resource-schedule-day-Table-Mobile.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Mobile.master" Inherits="OEMConversion.UI.Show_Vw_resource_schedule_day_Table_Mobile" %>
<%@ Register Tagprefix="BaseClasses" Namespace="BaseClasses.Web.UI.WebControls" Assembly="BaseClasses" %>
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_Vw_resource_schedule_day_Table_Mobile" %>
...
<asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
    ...
    <div id="scrollRegion" class="scrollRegion">              
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%"><tr><td>
                        <OEMConversion:Vw_resource_schedule_dayTableControl runat="server" id="Vw_resource_schedule_dayTableControl">	<table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td>
...
</td><td class="mobileFieldValueOnBottom"></td></tr><tr><td class="mobileFieldValueOnBottom"><OEMConversion:ThemeButtonMobile runat="server" id="SearchButton" button-causesvalidation="False" button-commandname="Search" button-text="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;OEMConversion&quot;) %>" button-tooltip="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;OEMConversion&quot;) %>" postback="False"></OEMConversion:ThemeButtonMobile></td><td class="mobileFieldValueOnBottom"></td></tr><tr><td class="mobileFieldLabelOnTop"><asp:Literal runat="server" id="resource_sch_priorityLabel" Text="Resource SCH Priority">	</asp:Literal></td><td class="mobileFieldLabelOnTop"></td></tr><tr><td class="mobileFieldValueOnBottom"><%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("FilterButton"))%>
<asp:DropDownList runat="server" id="resource_sch_priorityFilter" cssclass="mobileFilterInput" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
            ...
            <asp:DropDownList runat="server" id="SortControl" autopostback="True" cssclass="mobileFilterInput" priorityno="1">	</asp:DropDownList>
                  ...
                  </td></tr><tr><td class="mobileBody"><table id="Vw_resource_schedule_dayTableControlGrid" cellpadding="0" cellspacing="0" border="0" onkeydown="captureUpDownKey(this, event)" width="100%"><tr><th class="mobileTableCell" colspan="1" style="display:none"><!-- Note: Cell Is Hidden --></th><th class="mobileTableCell" scope="col" style="display:none"><!-- Note: Cell Is Hidden --></th><th class="mobileTableCell" scope="col" style="display:none"><!-- Note: Cell Is Hidden --></th></tr><asp:Repeater runat="server" id="Vw_resource_schedule_dayTableControlRepeater">		<ITEMTEMPLATE>
		<asp:Repeater runat="server" id="Vw_resource_schedule_dayTableControlRepeater1">				<ITEMTEMPLATE>		<OEMConversion:Vw_resource_schedule_dayTableControlRow runat="server" id="Vw_resource_schedule_dayTableControlRow">
<tr onclick="RedirectByViewButton(event)"><td class="mobileTableCell" style="display:none;"><!-- Note: Cell Is Hidden --><asp:ImageButton runat="server" id="ViewRowButton" causesvalidation="False" commandname="Redirect" cssclass="button_link" imageurl="../Images/icon_view.gif" tooltip="&lt;%# GetResourceValue(&quot;Txt:ViewRecord&quot;, &quot;OEMConversion&quot;) %>">		
                  ...
                  &nbsp;
                </td><td class="mobileTableCell"><asp:Label runat="server" id="subject" cssclass="mobileTableCellTitle"></asp:Label> 
                            <br />
                          <br />
                          <br />
                          <asp:Literal runat="server" id="CustName"></asp:Literal></td></tr></OEMConversion:Vw_resource_schedule_dayTableControlRow>
</ITEMTEMPLATE>
