...
// This file implements the code-behind class for Siteinv_serialno_view_QuickSelector.aspx.
// App_Code\Siteinv_serialno_view_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
public partial class Siteinv_serialno_view_QuickSelector
        : BaseApplicationPage
// Code-behind class for the Siteinv_serialno_view_QuickSelector page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Siteinv_serialno_view_QuickSelector()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_Search_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Siteinv_serialno_view_QuickSelector.SelectorTableControl control = new OEMConversion.UI.Controls.Siteinv_serialno_view_QuickSelector.SelectorTableControl();
