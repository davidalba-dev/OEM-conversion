...
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Siteinv_serialno_view_QuickSelector" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Siteinv-serialno-view-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="OEMConversion.UI.Siteinv_serialno_view_QuickSelector" %>
