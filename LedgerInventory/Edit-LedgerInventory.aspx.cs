...
// This file implements the code-behind class for Edit_LedgerInventory.aspx.
// App_Code\Edit_LedgerInventory.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_LedgerInventory
        : BaseApplicationPage
// Code-behind class for the Edit_LedgerInventory page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_LedgerInventory()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetLedgerInventoryRecordControl()
        {
            SetLedgerInventoryRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Ledger Inventory");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "LedgerInventoryRecordControl":
                 SetLedgerInventoryRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.LedgerInventoryRecordControl.SaveData();
        ...
        SetLedgerInventoryRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "LedgerInventoryMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetLedgerInventoryRecordControl_Base()           
        
        {        
            if (LedgerInventoryRecordControl.Visible)
            {
                LedgerInventoryRecordControl.LoadData();
                LedgerInventoryRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.LedgerInventoryRecordControl != null && this.LedgerInventoryRecordControl.DataSource != null)
                  {
                        id = this.LedgerInventoryRecordControl.DataSource.GetValue(this.LedgerInventoryRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.LedgerInventoryRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.LedgerInventoryRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.LedgerInventoryRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.LedgerInventoryRecordControl.DataSource.GetValue(this.LedgerInventoryRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
