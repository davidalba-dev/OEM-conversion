...
// This file implements the code-behind class for Show_LedgerInventory_Table_Mobile.aspx.
// App_Code\Show_LedgerInventory_Table_Mobile.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_LedgerInventory_Table_Mobile
        : BaseApplicationPage
// Code-behind class for the Show_LedgerInventory_Table_Mobile page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_LedgerInventory_Table_Mobile()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetLedgerInventoryTableControl()
        {
            SetLedgerInventoryTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "LedgerInventoryTableControl":
                 SetLedgerInventoryTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.LedgerInventoryTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_LedgerInventory_Table_Mobile.LedgerInventoryTableControl control = new OEMConversion.UI.Controls.Show_LedgerInventory_Table_Mobile.LedgerInventoryTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetLedgerInventoryTableControl_Base()           
        
        {        
            if (LedgerInventoryTableControl.Visible)
            {
                LedgerInventoryTableControl.LoadData();
                LedgerInventoryTableControl.DataBind();
            }
        }
