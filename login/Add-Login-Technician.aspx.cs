...
// This file implements the code-behind class for Add_Login_Technician.aspx.
// App_Code\Add_Login_Technician.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Login_Technician
        : BaseApplicationPage
// Code-behind class for the Add_Login_Technician page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Login_Technician()
        {
            this.Initialize();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
      ...
      this.RedirectBack();
        ...
        public void SaveButton_Click_Base(object sender, EventArgs args)
        {
            ...
            string url = @"../Technicians/Show-Technicians-Table.aspx";
