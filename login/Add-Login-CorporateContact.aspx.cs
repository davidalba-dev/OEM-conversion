...
// This file implements the code-behind class for Add_Login_CorporateContact.aspx.
// App_Code\Add_Login_CorporateContact.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Login_CorporateContact
        : BaseApplicationPage
// Code-behind class for the Add_Login_CorporateContact page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Login_CorporateContact()
        {
            this.Initialize();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
      ...
      this.RedirectBack();
        ...
        public void SaveButton_Click_Base(object sender, EventArgs args)
        {
            ...
            string url = @"../corporate_contacts/Edit-Corporate-contacts.aspx?corporate_contacts={LoginRecordControl:FV:corporatecontact_id}";
