...
// This file implements the code-behind class for Edit_Equipment_inventory_ad_category.aspx.
// App_Code\Edit_Equipment_inventory_ad_category.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Equipment_inventory_ad_category
        : BaseApplicationPage
// Code-behind class for the Edit_Equipment_inventory_ad_category page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Equipment_inventory_ad_category()
        {
            this.Initialize();
...
//        public void SetEquipment_inventory_ad_categoryRecordControl()
//        {
//            SetEquipment_inventory_ad_categoryRecordControl_Base(); 
//        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Equipment Inventory Advertisement Category");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Equipment_inventory_ad_categoryRecordControl":
                 SetEquipment_inventory_ad_categoryRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Equipment_inventory_ad_categoryRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetEquipment_inventory_ad_categoryRecordControl_Base()           
        
        {        
            if (Equipment_inventory_ad_categoryRecordControl.Visible)
            {
                Equipment_inventory_ad_categoryRecordControl.LoadData();
                Equipment_inventory_ad_categoryRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Equipment_inventory_ad_categoryRecordControl != null && this.Equipment_inventory_ad_categoryRecordControl.DataSource != null)
                  {
                        id = this.Equipment_inventory_ad_categoryRecordControl.DataSource.GetValue(this.Equipment_inventory_ad_categoryRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Equipment_inventory_ad_categoryRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Equipment_inventory_ad_categoryRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Equipment_inventory_ad_categoryRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Equipment_inventory_ad_categoryRecordControl.DataSource.GetValue(this.Equipment_inventory_ad_categoryRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
