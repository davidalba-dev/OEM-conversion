...
// This file implements the code-behind class for Show_Equipment_inventory_ad_category_Table.aspx.
// App_Code\Show_Equipment_inventory_ad_category_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Equipment_inventory_ad_category_Table
        : BaseApplicationPage
// Code-behind class for the Show_Equipment_inventory_ad_category_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Equipment_inventory_ad_category_Table()
        {
            this.Initialize();
...
//        public void SetEquipment_inventory_ad_categoryTableControl()
//        {
//            SetEquipment_inventory_ad_categoryTableControl_Base(); 
//        }
...
[System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_Equipment_inventory_ad_categorySearchText(string prefixText, int count)
        {
            // GetEquipment_inventory_ad_categorySearchTextCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_Equipment_inventory_ad_categorySearchText_Base()
            // or replace the call to GetAutoCompletionList_Equipment_inventory_ad_categorySearchText_Base().
            return GetAutoCompletionList_Equipment_inventory_ad_categorySearchText_Base(prefixText, count);
        }
#endregion
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = "Equipment Inventory Advertisement Category";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Equipment_inventory_ad_categoryTableControl":
                 SetEquipment_inventory_ad_categoryTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Equipment_inventory_ad_categoryTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_Equipment_inventory_ad_categorySearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Equipment_inventory_ad_category_Table.Equipment_inventory_ad_categoryTableControl control = new OEMConversion.UI.Controls.Show_Equipment_inventory_ad_category_Table.Equipment_inventory_ad_categoryTableControl();
        
        return control.GetAutoCompletionList_Equipment_inventory_ad_categorySearchText(prefixText, count);
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetEquipment_inventory_ad_categoryTableControl_Base()           
        
        {        
            if (Equipment_inventory_ad_categoryTableControl.Visible)
            {
                Equipment_inventory_ad_categoryTableControl.LoadData();
                Equipment_inventory_ad_categoryTableControl.DataBind();
            }
        }
