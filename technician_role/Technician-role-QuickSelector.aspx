<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Technician_role_QuickSelector" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Technician-role-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="OEMConversion.UI.Technician_role_QuickSelector" %>
