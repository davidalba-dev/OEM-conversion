...
// This file implements the code-behind class for Show_Technician_role_Table.aspx.
// App_Code\Show_Technician_role_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Technician_role_Table
        : BaseApplicationPage
// Code-behind class for the Show_Technician_role_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Technician_role_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetTechnician_roleTableControl()
        {
            SetTechnician_roleTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Technician_roleTableControl":
                 SetTechnician_roleTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Technician_roleTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Technician_role_Table.Technician_roleTableControl control = new OEMConversion.UI.Controls.Show_Technician_role_Table.Technician_roleTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetTechnician_roleTableControl_Base()           
        
        {        
            if (Technician_roleTableControl.Visible)
            {
                Technician_roleTableControl.LoadData();
                Technician_roleTableControl.DataBind();
            }
        }
