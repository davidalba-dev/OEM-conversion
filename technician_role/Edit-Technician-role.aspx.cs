...
// This file implements the code-behind class for Edit_Technician_role.aspx.
// App_Code\Edit_Technician_role.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Technician_role
        : BaseApplicationPage
// Code-behind class for the Edit_Technician_role page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Technician_role()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetTechnician_roleRecordControl()
        {
            SetTechnician_roleRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Technician Role");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Technician_roleRecordControl":
                 SetTechnician_roleRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Technician_roleRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetTechnician_roleRecordControl_Base()           
        
        {        
            if (Technician_roleRecordControl.Visible)
            {
                Technician_roleRecordControl.LoadData();
                Technician_roleRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Technician_roleRecordControl != null && this.Technician_roleRecordControl.DataSource != null)
                  {
                        id = this.Technician_roleRecordControl.DataSource.GetValue(this.Technician_roleRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Technician_roleRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Technician_roleRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Technician_roleRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Technician_roleRecordControl.DataSource.GetValue(this.Technician_roleRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
