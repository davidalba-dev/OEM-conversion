...
// This file implements the code-behind class for Edit_Customer_pay.aspx.
// App_Code\Edit_Customer_pay.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Customer_pay
        : BaseApplicationPage
// Code-behind class for the Edit_Customer_pay page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Customer_pay()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetCustomer_payRecordControl()
        {
            SetCustomer_payRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Customer Pay");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Customer_payRecordControl":
                 SetCustomer_payRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Customer_payRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetCustomer_payRecordControl_Base()           
        
        {        
            if (Customer_payRecordControl.Visible)
            {
                Customer_payRecordControl.LoadData();
                Customer_payRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Customer_payRecordControl != null && this.Customer_payRecordControl.DataSource != null)
                  {
                        id = this.Customer_payRecordControl.DataSource.GetValue(this.Customer_payRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Customer_payRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Customer_payRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Customer_payRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Customer_payRecordControl.DataSource.GetValue(this.Customer_payRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
