...
// This file implements the code-behind class for Edit_Loaner_inventory.aspx.
// App_Code\Edit_Loaner_inventory.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Loaner_inventory
        : BaseApplicationPage
// Code-behind class for the Edit_Loaner_inventory page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Loaner_inventory()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetLoaner_inventoryRecordControl()
        {
            SetLoaner_inventoryRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Loaner Inventory");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Loaner_inventoryRecordControl":
                 SetLoaner_inventoryRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Loaner_inventoryRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetLoaner_inventoryRecordControl_Base()           
        
        {        
            if (Loaner_inventoryRecordControl.Visible)
            {
                Loaner_inventoryRecordControl.LoadData();
                Loaner_inventoryRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Loaner_inventoryRecordControl != null && this.Loaner_inventoryRecordControl.DataSource != null)
                  {
                        id = this.Loaner_inventoryRecordControl.DataSource.GetValue(this.Loaner_inventoryRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Loaner_inventoryRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Loaner_inventoryRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Loaner_inventoryRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Loaner_inventoryRecordControl.DataSource.GetValue(this.Loaner_inventoryRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
