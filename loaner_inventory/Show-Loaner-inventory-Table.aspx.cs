...
// This file implements the code-behind class for Show_Loaner_inventory_Table.aspx.
// App_Code\Show_Loaner_inventory_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Loaner_inventory_Table
        : BaseApplicationPage
// Code-behind class for the Show_Loaner_inventory_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Loaner_inventory_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetLoaner_inventoryTableControl()
        {
            SetLoaner_inventoryTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Loaner_inventoryTableControl":
                 SetLoaner_inventoryTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Loaner_inventoryTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetLoaner_inventoryTableControl_Base()           
        
        {        
            if (Loaner_inventoryTableControl.Visible)
            {
                Loaner_inventoryTableControl.LoadData();
                Loaner_inventoryTableControl.DataBind();
            }
        }
