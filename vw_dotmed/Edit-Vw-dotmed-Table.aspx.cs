...
// This file implements the code-behind class for Edit_Vw_dotmed_Table.aspx.
// App_Code\Edit_Vw_dotmed_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Vw_dotmed_Table
        : BaseApplicationPage
// Code-behind class for the Edit_Vw_dotmed_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Vw_dotmed_Table()
        {
            this.Initialize();
...
//        }
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetVw_dotmedTableControl()
        {
            SetVw_dotmedTableControl_Base(); 
        }
...
public void SetVw_dotmedTableControl1()
        {
            SetVw_dotmedTableControl1_Base(); 
        }
//[System.Web.Services.WebMethod]
...
//        }
//public void SetDotmed_processTableControl()
//        {
//            SetDotmed_processTableControl_Base(); 
//        }
public void SetDotmed_processTableControl1()
        {
            SetDotmed_processTableControl1_Base(); 
        }
public void SetEquipment_inventory_dotmedTableControl()
        {
            SetEquipment_inventory_dotmedTableControl_Base(); 
        }
#endregion
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} VW Dotmed");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Dotmed_processTableControl1":
                 SetDotmed_processTableControl1();
                 break;
          
              case "Equipment_inventory_dotmedTableControl":
                 SetEquipment_inventory_dotmedTableControl();
                 break;
          
              case "Vw_dotmedTableControl":
                 SetVw_dotmedTableControl();
                 break;
          
              case "Vw_dotmedTableControl1":
                 SetVw_dotmedTableControl1();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Dotmed_processTableControl1.SaveData();
        
        this.Equipment_inventory_dotmedTableControl.SaveData();
        
        this.Vw_dotmedTableControl.SaveData();
        
        this.Vw_dotmedTableControl1.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetDotmed_processTableControl1_Base()           
        
        {        
            if (Dotmed_processTableControl1.Visible)
            {
                Dotmed_processTableControl1.LoadData();
                Dotmed_processTableControl1.DataBind();
            }
        }
      
        public void SetEquipment_inventory_dotmedTableControl_Base()           
        
        {        
            if (Equipment_inventory_dotmedTableControl.Visible)
            {
                Equipment_inventory_dotmedTableControl.LoadData();
                Equipment_inventory_dotmedTableControl.DataBind();
            }
        }
      
        public void SetVw_dotmedTableControl_Base()           
        
        {        
            if (Vw_dotmedTableControl.Visible)
            {
                Vw_dotmedTableControl.LoadData();
                Vw_dotmedTableControl.DataBind();
            }
        }
      
        public void SetVw_dotmedTableControl1_Base()           
        
        {        
            if (Vw_dotmedTableControl1.Visible)
            {
                Vw_dotmedTableControl1.LoadData();
                Vw_dotmedTableControl1.DataBind();
            }
        }
