...
// This file implements the code-behind class for Edit_Equipment_import.aspx.
// App_Code\Edit_Equipment_import.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Equipment_import
        : BaseApplicationPage
// Code-behind class for the Edit_Equipment_import page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Equipment_import()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetEquipment_importRecordControl()
        {
            SetEquipment_importRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Equipment_importRecordControl":
                 SetEquipment_importRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Equipment_importRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetEquipment_importRecordControl_Base()           
        
        {        
            if (Equipment_importRecordControl.Visible)
            {
                Equipment_importRecordControl.LoadData();
                Equipment_importRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Equipment_importRecordControl != null && this.Equipment_importRecordControl.DataSource != null)
                  {
                        id = this.Equipment_importRecordControl.DataSource.GetValue(this.Equipment_importRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Equipment_importRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Equipment_importRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Equipment_importRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Equipment_importRecordControl.DataSource.GetValue(this.Equipment_importRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
