...
// This file implements the code-behind class for Edit_Equipment_import_Table.aspx.
// App_Code\Edit_Equipment_import_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Equipment_import_Table
        : BaseApplicationPage
// Code-behind class for the Edit_Equipment_import_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Equipment_import_Table()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
      ...
      public void Page_InitializeEventHandlers_Base(object sender, System.EventArgs e)
      {
        ...
        private void Base_RegisterPostback()
        {
              ...
              this.RegisterPostBackTrigger(MiscUtils.FindControlRecursively(this,"SaveButton1"));
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Equipment Import");
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetSaveButton1_Base()                
              
        {
        
                    this.SaveButton1.Button.Attributes.Add("onclick", "SubmitHRefOnce(this, \"" + this.GetResourceValue("Txt:SaveRecord", "OEMConversion") + "\");");
        ...
        public void SaveButton_Click_Base(object sender, EventArgs args)
        {
            ...
            string url = @"../equipment_import_batch/Show-Equipment-import-batch-Table.aspx?custno={Equipment_import_batchRecordControl:FV:custno}";
      ...
      this.Response.Redirect(url);
        ...
        // event handler for Button
        public void SaveButton1_Click_Base(object sender, EventArgs args)
        {
