...
// This file implements the code-behind class for Action_Equipment_import_Table.aspx.
// App_Code\Action_Equipment_import_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Action_Equipment_import_Table
        : BaseApplicationPage
// Code-behind class for the Action_Equipment_import_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Action_Equipment_import_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetEquipment_importTableControl()
        {
            SetEquipment_importTableControl_Base(); 
        }
...
//        }
public void SetEquipment_import_batchRecordControl()
        {
            SetEquipment_import_batchRecordControl_Base(); 
        }
#endregion
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Equipment_import_batchRecordControl":
                 SetEquipment_import_batchRecordControl();
                 break;
          
              case "Equipment_importTableControl":
                 SetEquipment_importTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Equipment_import_batchRecordControl.SaveData();
        
        this.Equipment_importTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetEquipment_import_batchRecordControl_Base()           
        
        {        
            if (Equipment_import_batchRecordControl.Visible)
            {
                Equipment_import_batchRecordControl.LoadData();
                Equipment_import_batchRecordControl.DataBind();
            }
        }
      
        public void SetEquipment_importTableControl_Base()           
        
        {        
            if (Equipment_importTableControl.Visible)
            {
                Equipment_importTableControl.LoadData();
                Equipment_importTableControl.DataBind();
            }
        }
              ...
              
        {
            ...
            if (EvaluateFormula("Save").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "SaveButton").Visible = true;
            else if (EvaluateFormula("Save").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "SaveButton").Visible = false;
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Equipment_import_batchRecordControl != null && this.Equipment_import_batchRecordControl.DataSource != null)
                  {
                        id = this.Equipment_import_batchRecordControl.DataSource.GetValue(this.Equipment_import_batchRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Equipment_import_batchRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Equipment_import_batchRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Equipment_import_batchRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Equipment_import_batchRecordControl.DataSource.GetValue(this.Equipment_import_batchRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
