...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-Equipment-import-Table.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Show_Equipment_import_Table" %>
<%@ Register Tagprefix="Selectors" Namespace="OEMConversion" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_Equipment_import_Table" %>
...
<BaseClasses:QuickSelector runat="server" id="asset_tagFilter" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single">	</BaseClasses:QuickSelector><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre">
                    <table id="Equipment_importTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" colspan="2"></th><th class="thc"><asp:LinkButton runat="server" id="asset_tagLabel" tooltip="Sort by asset_tag" Text="Asset Tag" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="stateLabel" tooltip="Sort by state" Text="State" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="serial_numberLabel" tooltip="Sort by serial_number" Text="Serial Number" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="modelLabel" tooltip="Sort by model" Text="Model" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="addressLabel" tooltip="Sort by address" Text="Address" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="buildingLabel" tooltip="Sort by building" Text="Building" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="departmentLabel" tooltip="Sort by department" Text="Department" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="contact_firstLabel" tooltip="Sort by contact_first" Text="Contact" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="categoryLabel" tooltip="Sort by category" Text="Category" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="pm_last_fix_dateLabel" tooltip="Sort by pm_last_fix_date" Text="Last Fix Date" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="po_dateLabel" tooltip="Sort by po_date" Text="PO Date" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="pm_purchase_orderLabel" tooltip="Sort by pm_purchase_order" Text="EvaluateFormula(&quot;= \&quot;PO#\&quot;&quot;, true)" CausesValidation="False">	</asp:LinkButton></th></tr><asp:Repeater runat="server" id="Equipment_importTableControlRepeater">		<ITEMTEMPLATE>		<OEMConversion:Equipment_importTableControlRow runat="server" id="Equipment_importTableControlRow">
<tr><td class="tableRowButtonsCellVertical" scope="row" style="font-size: 5px;" colspan="2">
                                ...
                                </td><td class="tableCellValue"><asp:Literal runat="server" id="asset_tag"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="state"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="serial_number"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="model"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="address"></asp:Literal><br> 
<asp:Literal runat="server" id="city"></asp:Literal>&nbsp;<asp:Literal runat="server" id="address_state"></asp:Literal>&nbsp;<asp:Literal runat="server" id="zipcode"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="building"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="department"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="contact_first"></asp:Literal>&nbsp;<asp:Literal runat="server" id="contact_last"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="category"></asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="pm_last_fix_date"></asp:Literal></span>
</td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="po_date"></asp:Literal></span>
</td><td class="tableCellValue"><asp:Literal runat="server" id="pm_purchase_order"></asp:Literal></td></tr><tr><td class="tableRowDivider" colspan="9"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td></tr></OEMConversion:Equipment_importTableControlRow>
</ITEMTEMPLATE>
	...
	<asp:hiddenfield id="Equipment_importTableControl_PostbackTracker" runat="server" />
            ...
            </td></tr><tr><td></td></tr><tr><td><OEMConversion:ThemeButton runat="server" id="SaveButton" button-causesvalidation="True" button-commandname="UpdateData" button-text="Complete Batch Import" button-tooltip="Complete Batch Import" postback="True"></OEMConversion:ThemeButton></td></tr></table>
      </ContentTemplate>
</asp:UpdatePanel>
