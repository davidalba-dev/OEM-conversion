...
// This file implements the code-behind class for Edit_Equipment_inventory_sale_method.aspx.
// App_Code\Edit_Equipment_inventory_sale_method.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Equipment_inventory_sale_method
        : BaseApplicationPage
// Code-behind class for the Edit_Equipment_inventory_sale_method page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Equipment_inventory_sale_method()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetEquipment_inventory_sale_methodRecordControl()
        {
            SetEquipment_inventory_sale_methodRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Equipment Inventory Sale Method");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Equipment_inventory_sale_methodRecordControl":
                 SetEquipment_inventory_sale_methodRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Equipment_inventory_sale_methodRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetEquipment_inventory_sale_methodRecordControl_Base()           
        
        {        
            if (Equipment_inventory_sale_methodRecordControl.Visible)
            {
                Equipment_inventory_sale_methodRecordControl.LoadData();
                Equipment_inventory_sale_methodRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Equipment_inventory_sale_methodRecordControl != null && this.Equipment_inventory_sale_methodRecordControl.DataSource != null)
                  {
                        id = this.Equipment_inventory_sale_methodRecordControl.DataSource.GetValue(this.Equipment_inventory_sale_methodRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Equipment_inventory_sale_methodRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Equipment_inventory_sale_methodRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Equipment_inventory_sale_methodRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Equipment_inventory_sale_methodRecordControl.DataSource.GetValue(this.Equipment_inventory_sale_methodRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
