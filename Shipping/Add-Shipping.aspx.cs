...
// This file implements the code-behind class for Add_Shipping.aspx.
// App_Code\Add_Shipping.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Shipping
        : BaseApplicationPage
// Code-behind class for the Add_Shipping page.
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetShippingTabContainer()
        {
            SetShippingTabContainer_Base(); 
        }
        ...
        public void SetShippingRecordControl()
        {
            SetShippingRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Shipping");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "ShippingRecordControl":
                 SetShippingRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.ShippingRecordControl.SaveData();
        ...
        SetShippingRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "ShippingMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetShippingTabContainer_Base()           
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "ShippingTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "ShippingTabContainer").Visible = false;
        ...
        public void SetShippingRecordControl_Base()           
        
        {        
            if (ShippingRecordControl.Visible)
            {
                ShippingRecordControl.LoadData();
                ShippingRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.ShippingRecordControl != null && this.ShippingRecordControl.DataSource != null)
                  {
                        id = this.ShippingRecordControl.DataSource.GetValue(this.ShippingRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.ShippingRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.ShippingRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.ShippingRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.ShippingRecordControl.DataSource.GetValue(this.ShippingRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
