...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-Shipping-Table.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Show_Shipping_Table" %>
...
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_Shipping_Table" %>
...
<BaseClasses:QuickSelector runat="server" id="ShipViaFilter" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single">	</BaseClasses:QuickSelector><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="ShippingTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc"><img src="../Images/space.gif" height="1" width="1" alt="" /></th><th class="thc"><asp:Literal runat="server" id="ShipViaLabel" Text="Ship Via">	</asp:Literal></th><th class="thc"><asp:Literal runat="server" id="shipping_activeLabel" Text="Shipping Active">	</asp:Literal></th><th class="thc"></th><th class="thc"></th></tr><asp:Repeater runat="server" id="ShippingTableControlRepeater">		<ITEMTEMPLATE>		<OEMConversion:ShippingTableControlRow runat="server" id="ShippingTableControlRow">
<tr><td class="tableRowButtonsCellVertical" scope="row" style="font-size: 5px;">
                                ...
                                </td><td class="tableCellValue"><asp:Literal runat="server" id="ShipVia"></asp:Literal> </td><td class="tableCellValue"><asp:Literal runat="server" id="shipping_active"></asp:Literal></td><td class="tableCellLabel"></td><td class="tableCellValue"></td></tr><tr><td class="tableRowDivider" colspan="5"></td></tr></OEMConversion:ShippingTableControlRow>
</ITEMTEMPLATE>
