...
// This file implements the code-behind class for Edit_Shipping_Table.aspx.
// App_Code\Edit_Shipping_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Shipping_Table
        : BaseApplicationPage
// Code-behind class for the Edit_Shipping_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Shipping_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetShippingTableControl()
        {
            SetShippingTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "ShippingTableControl":
                 SetShippingTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.ShippingTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Edit_Shipping_Table.ShippingTableControl control = new OEMConversion.UI.Controls.Edit_Shipping_Table.ShippingTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetShippingTableControl_Base()           
        
        {        
            if (ShippingTableControl.Visible)
            {
                ShippingTableControl.LoadData();
                ShippingTableControl.DataBind();
            }
        }
