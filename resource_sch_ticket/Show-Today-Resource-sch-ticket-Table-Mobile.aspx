<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_Today_Resource_sch_ticket_Table_Mobile" %>

<%@ Register Tagprefix="OEMConversion" TagName="InfinitePaginationMobile" Src="../Shared/InfinitePaginationMobile.ascx" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-Today-Resource-sch-ticket-Table-Mobile.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Mobile.master" Inherits="OEMConversion.UI.Show_Today_Resource_sch_ticket_Table_Mobile" %>
...
<asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
    ...
    <div id="scrollRegion" class="scrollRegion">              
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%"><tr><td>
                      ...
                      <asp:Literal runat="server" id="Title0" Text="&lt;%#String.Concat(&quot; Today&#39;s Tickets&quot;) %>">	</asp:Literal>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="mobileFieldLabelOnTop"><asp:Literal runat="server" id="due_dateLabel" Text="Due Date">	</asp:Literal></td></tr><tr><td class="mobileFieldValueOnBottom"><asp:TextBox runat="server" id="due_dateFromFilter" columns="20" cssclass="mobileFieldInput" onkeyup="DateFormat(this, this.value, event.keyCode, &#39;m/d/yyyy&#39;)" timestring="&quot;00:00:00&quot;" AutoPostback="False" style="vertical-align:middle">	</asp:TextBox>
	<asp:ImageButton runat="server" ID="due_dateFromFilterPopupButton" ImageUrl="../Images/MobileCalendar.png" CausesValidation="false">
	</asp:ImageButton><Selectors:CalendarExtendarClass runat="server" ID="due_dateFromFilterCalenderExtender" TargetControlID="due_dateFromFilter" CssClass="MyCalendarMobile" OnClientShown="mobileCalendarShown" PopupPosition="BottomLeft" PopupButtonID="due_dateFromFilterPopupButton" Format="d">
	</Selectors:CalendarExtendarClass></td></tr><tr><td class="mobileFieldValueOnBottom"><OEMConversion:ThemeButtonMobile runat="server" id="FilterButton" button-causesvalidation="False" button-commandname="Search" button-text="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;OEMConversion&quot;) %>" button-tooltip="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;OEMConversion&quot;) %>" postback="False"></OEMConversion:ThemeButtonMobile></td></tr></table>
</asp:panel>
...
<tr onclick="RedirectByViewButton(event)"><td class="mobileTableCell" style="display:none;"><!-- Note: Cell Is Hidden --><asp:ImageButton runat="server" id="ViewRowButton" causesvalidation="False" commandname="Redirect" cssclass="button_link" imageurl="../Images/icon_view.gif" tooltip="&lt;%# GetResourceValue(&quot;Txt:ViewRecord&quot;, &quot;OEMConversion&quot;) %>">		
                  ...
                  &nbsp;
                          ...
                          <asp:Literal runat="server" id="subject"></asp:Literal> 
                            <br />
                          <br />
                          <asp:Literal runat="server" id="scheduled_date"></asp:Literal></td></tr></OEMConversion:Resource_sch_ticketTableControlRow>
</ITEMTEMPLATE>
