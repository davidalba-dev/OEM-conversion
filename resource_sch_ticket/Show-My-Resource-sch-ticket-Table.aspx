<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-My-Resource-sch-ticket-Table.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Show_My_Resource_sch_ticket_Table" %>
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_My_Resource_sch_ticket_Table" %>
			...
			<ContentTemplate>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="updatePanelContent"><tr><td>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title0" Text="My Ticket Dashboard">	</asp:Literal>
                      </td><td class="dht" valign="middle"><OEMConversion:ThemeButton runat="server" id="Button" button-causesvalidation="False" button-commandname="Redirect" button-text="Closed Tickets" button-tooltip="Closed Tickets"></OEMConversion:ThemeButton></td></tr></table>
...
<asp:DropDownList runat="server" id="resource_sch_status_idFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)" selectionmode="Single">	</asp:DropDownList><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
</td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td></tr></table>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre">
                    <table id="Resource_sch_ticketTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" colspan="2"></th><th class="thc"></th><th class="thc"></th><th class="thc"><asp:LinkButton runat="server" id="custnoLabel" Text="EvaluateFormula(&quot;= \&quot;Customer\&quot;&quot;, true)" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="project_idLabel" tooltip="Sort by project_id" Text="Project" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:Literal runat="server" id="subjectLabel" Text="Subject">	</asp:Literal></th><th class="thc"><asp:Literal runat="server" id="resource_sch_status_idLabel" Text="EvaluateFormula(&quot;= \&quot;Status\&quot;&quot;, true)">	</asp:Literal></th><th class="thc"><asp:LinkButton runat="server" id="resource_sch_priority_idLabel" Text="EvaluateFormula(&quot;= \&quot;Priority\&quot;&quot;, true)" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="scheduled_dateLabel" tooltip="Sort by scheduled_date" Text="Scheduled Date" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:Literal runat="server" id="estimated_duration_hoursLabel" Text="EvaluateFormula(&quot;= \&quot;Est. Hours\&quot;&quot;, true)">	</asp:Literal></th><th class="thc"><asp:LinkButton runat="server" id="ticket_actual_timeLabel" tooltip="Sort by ticket_actual_time" Text="Actual Time" CausesValidation="False">	</asp:LinkButton></th></tr><asp:Repeater runat="server" id="Resource_sch_ticketTableControlRepeater">		<ITEMTEMPLATE>		<OEMConversion:Resource_sch_ticketTableControlRow runat="server" id="Resource_sch_ticketTableControlRow">
...
</td><td class="tableCellValue"><asp:LinkButton runat="server" id="project_id" CommandName="Redirect"></asp:LinkButton></td><td class="tableCellValue"><asp:Literal runat="server" id="subject"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="resource_sch_status_id1"></asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
<asp:Literal runat="server" id="ticket_actual_time"></asp:Literal></span>
</td></tr><tr><td class="tableRowDivider" colspan="12"></td></tr></OEMConversion:Resource_sch_ticketTableControlRow>
</ITEMTEMPLATE>
