<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_All_Resource_sch_ticket_Table_Mobile" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-All-Resource-sch-ticket-Table-Mobile.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Mobile.master" Inherits="OEMConversion.UI.Show_All_Resource_sch_ticket_Table_Mobile" %>
...
<asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
    ...
    <div id="scrollRegion" class="scrollRegion">              
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%"><tr><td>
                      ...
                      <asp:Literal runat="server" id="Title0" Text="&lt;%#String.Concat(&quot; All Open Tickets&quot;) %>">	</asp:Literal>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="mobileFieldLabelOnTop"><asp:Literal runat="server" id="scheduled_dateLabel" Text="Scheduled Date">	</asp:Literal></td><td class="mobileFieldLabelOnTop"><OEMConversion:ThemeButtonMobile runat="server" id="FilterButton" button-causesvalidation="False" button-commandname="Search" button-text="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;OEMConversion&quot;) %>" button-tooltip="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;OEMConversion&quot;) %>" postback="False"></OEMConversion:ThemeButtonMobile></td></tr><tr><td class="mobileFieldLabelOnTop"><asp:TextBox runat="server" id="scheduled_dateFromFilter" columns="20" cssclass="mobileFieldInput" onkeyup="DateFormat(this, this.value, event.keyCode, &#39;m/d/yyyy&#39;)" timestring="&quot;00:00:00&quot;" AutoPostback="False" style="vertical-align:middle">	</asp:TextBox>
	...
	</Selectors:CalendarExtendarClass> </td><td class="mobileFieldLabelOnTop"></td></tr><tr><td class="mobileFieldLabelOnTop"><asp:Literal runat="server" id="technician_idLabel" Text="EvaluateFormula(&quot;= \&quot;Resource\&quot;&quot;, true)">	</asp:Literal></td><td class="mobileFieldLabelOnTop"></td></tr><tr><td class="mobileFieldLabelOnTop"><asp:DropDownList runat="server" id="technician_idFilter" cssclass="mobileFilterInput" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList> </td><td class="mobileFieldLabelOnTop"></td></tr></table>
</asp:panel>
...
<asp:Literal runat="server" id="technician_id"></asp:Literal></td></tr></OEMConversion:Resource_sch_ticketTableControlRow>
</ITEMTEMPLATE>
