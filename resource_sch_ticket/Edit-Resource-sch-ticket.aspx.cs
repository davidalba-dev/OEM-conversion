...
// This file implements the code-behind class for Edit_Resource_sch_ticket.aspx.
// App_Code\Edit_Resource_sch_ticket.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Resource_sch_ticket
        : BaseApplicationPage
// Code-behind class for the Edit_Resource_sch_ticket page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Resource_sch_ticket()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetResource_sch_ticketRecordControl()
        {
            SetResource_sch_ticketRecordControl_Base(); 
        }
...
public void SetResource_sch_timeTableControl()
        {
            SetResource_sch_timeTableControl_Base(); 
        }
public void SetResource_sch_ticket_imgTableControl()
        {
            SetResource_sch_ticket_imgTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Resource Ticket");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Resource_sch_ticket_imgTableControl":
                 SetResource_sch_ticket_imgTableControl();
                 break;
          
              case "Resource_sch_ticketRecordControl":
                 SetResource_sch_ticketRecordControl();
                 break;
          
              case "Resource_sch_timeTableControl":
                 SetResource_sch_timeTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Resource_sch_ticketRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetResource_sch_ticket_imgTableControl_Base()           
        
        {        
            if (Resource_sch_ticket_imgTableControl.Visible)
            {
                Resource_sch_ticket_imgTableControl.LoadData();
                Resource_sch_ticket_imgTableControl.DataBind();
            }
        }
      
        public void SetResource_sch_ticketRecordControl_Base()           
        
        {        
            if (Resource_sch_ticketRecordControl.Visible)
            {
                Resource_sch_ticketRecordControl.LoadData();
                Resource_sch_ticketRecordControl.DataBind();
            }
        }
      
        public void SetResource_sch_timeTableControl_Base()           
        
        {        
            if (Resource_sch_timeTableControl.Visible)
            {
                Resource_sch_timeTableControl.LoadData();
                Resource_sch_timeTableControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Resource_sch_ticketRecordControl != null && this.Resource_sch_ticketRecordControl.DataSource != null)
                  {
                        id = this.Resource_sch_ticketRecordControl.DataSource.GetValue(this.Resource_sch_ticketRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Resource_sch_ticketRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Resource_sch_ticketRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Resource_sch_ticketRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Resource_sch_ticketRecordControl.DataSource.GetValue(this.Resource_sch_ticketRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
