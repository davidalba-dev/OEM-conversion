...
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_My_Closed_Resource_sch_ticket_Table" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-My-Closed-Resource-sch-ticket-Table.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Show_My_Closed_Resource_sch_ticket_Table" %>
			...
			<ContentTemplate>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="updatePanelContent"><tr><td>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                      ...
                      </td><td class="dht" valign="middle"><OEMConversion:ThemeButton runat="server" id="Button" button-causesvalidation="False" button-commandname="Redirect" button-text="Open Tickets" button-tooltip="Open Tickets"></OEMConversion:ThemeButton></td></tr></table>
...
</td><td class="tableCellValue"><asp:Literal runat="server" id="project_id"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="subject"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="resource_sch_status_id1"></asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
</td></tr><tr><td class="tableRowDivider" colspan="11"></td></tr></OEMConversion:Resource_sch_ticketTableControlRow>
</ITEMTEMPLATE>
