...
// This file implements the code-behind class for Add_Serial_number.aspx.
// App_Code\Add_Serial_number.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Serial_number
        : BaseApplicationPage
// Code-behind class for the Add_Serial_number page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Serial_number()
        {
            this.Initialize();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
      ...
      this.CloseWindow(true);
        ...
        public void SaveButton_Click_Base(object sender, EventArgs args)
        {
            ...
            string url = @"../site_inventory/Add-Site-inventory.aspx?custno={Serial_numberRecordControl:FV:custno}";
