...
// This file implements the code-behind class for Add_Serial_number_Popup.aspx.
// App_Code\Add_Serial_number_Popup.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Serial_number_Popup
        : BaseApplicationPage
// Code-behind class for the Add_Serial_number_Popup page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Serial_number_Popup()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetSerial_numberRecordControl()
        {
            SetSerial_numberRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Serial Number");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Serial_numberRecordControl":
                 SetSerial_numberRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Serial_numberRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetSerial_numberRecordControl_Base()           
        
        {        
            if (Serial_numberRecordControl.Visible)
            {
                Serial_numberRecordControl.LoadData();
                Serial_numberRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Serial_numberRecordControl != null && this.Serial_numberRecordControl.DataSource != null)
                  {
                        id = this.Serial_numberRecordControl.DataSource.GetValue(this.Serial_numberRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Serial_numberRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Serial_numberRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Serial_numberRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Serial_numberRecordControl.DataSource.GetValue(this.Serial_numberRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
