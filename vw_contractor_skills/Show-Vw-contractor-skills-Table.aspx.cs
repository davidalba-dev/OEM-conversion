...
// This file implements the code-behind class for Show_Vw_contractor_skills_Table.aspx.
// App_Code\Show_Vw_contractor_skills_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Vw_contractor_skills_Table
        : BaseApplicationPage
// Code-behind class for the Show_Vw_contractor_skills_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Vw_contractor_skills_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetVw_contractor_skillsTableControl()
        {
            SetVw_contractor_skillsTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Vw_contractor_skillsTableControl":
                 SetVw_contractor_skillsTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Vw_contractor_skillsTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Vw_contractor_skills_Table.Vw_contractor_skillsTableControl control = new OEMConversion.UI.Controls.Show_Vw_contractor_skills_Table.Vw_contractor_skillsTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetVw_contractor_skillsTableControl_Base()           
        
        {        
            if (Vw_contractor_skillsTableControl.Visible)
            {
                Vw_contractor_skillsTableControl.LoadData();
                Vw_contractor_skillsTableControl.DataBind();
            }
        }
