...
// This file implements the code-behind class for Edit_Pickup_request.aspx.
// App_Code\Edit_Pickup_request.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Pickup_request
        : BaseApplicationPage
// Code-behind class for the Edit_Pickup_request page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Pickup_request()
        {
            this.Initialize();
...
public void SetPickup_request_commentTableControl1()
        {
            SetPickup_request_commentTableControl1_Base(); 
        }
public void SetPickup_request_commentTableControl()
        {
            SetPickup_request_commentTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Pickup Request");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Pickup_request_commentTableControl":
                 SetPickup_request_commentTableControl();
                 break;
          
              case "Pickup_request_commentTableControl1":
                 SetPickup_request_commentTableControl1();
                 break;
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetPickup_request_commentTableControl_Base()           
        
        {        
            if (Pickup_request_commentTableControl.Visible)
            {
                Pickup_request_commentTableControl.LoadData();
                Pickup_request_commentTableControl.DataBind();
            }
        }
      
        public void SetPickup_request_commentTableControl1_Base()           
        
        {        
            if (Pickup_request_commentTableControl1.Visible)
            {
                Pickup_request_commentTableControl1.LoadData();
                Pickup_request_commentTableControl1.DataBind();
            }
        }
