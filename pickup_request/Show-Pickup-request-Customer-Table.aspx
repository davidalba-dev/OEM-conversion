<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_Pickup_request_Customer_Table" %>

<%@ Register Tagprefix="OEMConversion" TagName="ThemeButtonWithArrow" Src="../Shared/ThemeButtonWithArrow.ascx" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-Pickup-request-Customer-Table.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Show_Pickup_request_Customer_Table" %>
...
</td></tr><tr><td class="tableRowDivider" colspan="8"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td></tr></OEMConversion:Pickup_requestTableControlRow>
</ITEMTEMPLATE>
