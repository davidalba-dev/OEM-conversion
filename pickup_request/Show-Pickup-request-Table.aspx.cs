...
// This file implements the code-behind class for Show_Pickup_request_Table.aspx.
// App_Code\Show_Pickup_request_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Pickup_request_Table
        : BaseApplicationPage
// Code-behind class for the Show_Pickup_request_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Pickup_request_Table()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Pickup_request_Table.Pickup_requestTableControl control = new OEMConversion.UI.Controls.Show_Pickup_request_Table.Pickup_requestTableControl();
