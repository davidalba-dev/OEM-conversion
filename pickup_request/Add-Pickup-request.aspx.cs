...
// This file implements the code-behind class for Add_Pickup_request.aspx.
// App_Code\Add_Pickup_request.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Pickup_request
        : BaseApplicationPage
// Code-behind class for the Add_Pickup_request page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Pickup_request()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetPickup_requestRecordControl()
        {
            SetPickup_requestRecordControl_Base(); 
        }
...
public void SetPickup_request_commentRecordControl()
        {
            SetPickup_request_commentRecordControl_Base(); 
        }
#endregion
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Pickup Request");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Pickup_request_commentRecordControl":
                 SetPickup_request_commentRecordControl();
                 break;
          
              case "Pickup_requestRecordControl":
                 SetPickup_requestRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Pickup_requestRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetPickup_request_commentRecordControl_Base()           
        
        {        
            if (Pickup_request_commentRecordControl.Visible)
            {
                Pickup_request_commentRecordControl.LoadData();
                Pickup_request_commentRecordControl.DataBind();
            }
        }
      
        public void SetPickup_requestRecordControl_Base()           
        
        {        
            if (Pickup_requestRecordControl.Visible)
            {
                Pickup_requestRecordControl.LoadData();
                Pickup_requestRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Pickup_request_commentRecordControl != null && this.Pickup_request_commentRecordControl.DataSource != null)
                  {
                        id = this.Pickup_request_commentRecordControl.DataSource.GetValue(this.Pickup_request_commentRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Pickup_request_commentRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Pickup_request_commentRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Pickup_request_commentRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Pickup_request_commentRecordControl.DataSource.GetValue(this.Pickup_request_commentRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
                  ...
                  if (this.Pickup_requestRecordControl != null && this.Pickup_requestRecordControl.DataSource != null)
                  {
                        id = this.Pickup_requestRecordControl.DataSource.GetValue(this.Pickup_requestRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Pickup_requestRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Pickup_requestRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Pickup_requestRecordControl.DataSource, null,variables);
                        }
                        else if (displayFieldName == "") 
                        {
                            value = id;
                        ...
                        {
                            value = this.Pickup_requestRecordControl.DataSource.GetValue(this.Pickup_requestRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
