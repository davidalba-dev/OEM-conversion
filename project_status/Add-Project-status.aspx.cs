...
// This file implements the code-behind class for Add_Project_status.aspx.
// App_Code\Add_Project_status.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Project_status
        : BaseApplicationPage
// Code-behind class for the Add_Project_status page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Project_status()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetProject_statusRecordControl()
        {
            SetProject_statusRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Project Status");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Project_statusRecordControl":
                 SetProject_statusRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Project_statusRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetProject_statusRecordControl_Base()           
        
        {        
            if (Project_statusRecordControl.Visible)
            {
                Project_statusRecordControl.LoadData();
                Project_statusRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Project_statusRecordControl != null && this.Project_statusRecordControl.DataSource != null)
                  {
                        id = this.Project_statusRecordControl.DataSource.GetValue(this.Project_statusRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Project_statusRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Project_statusRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Project_statusRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Project_statusRecordControl.DataSource.GetValue(this.Project_statusRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
