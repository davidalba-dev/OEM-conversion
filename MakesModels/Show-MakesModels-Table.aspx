<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_MakesModels_Table" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-MakesModels-Table.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Show_MakesModels_Table" %>
...
<asp:DropDownList runat="server" id="MakeFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single">	</asp:DropDownList><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
                                ...
                                </td></tr><tr><td class="popupTableCellLabel"><asp:Literal runat="server" id="makesmodels_activeLabel1" Text="EvaluateFormula(&quot;= \&quot;Active\&quot;&quot;, true)">	</asp:Literal></td><td class="popupTableCellValue"><asp:DropDownList runat="server" id="makesmodels_activeFilter" cssclass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)">	</asp:DropDownList> </td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td><td class="popupTableCellValue"></td></tr></table>

                          </div>
                        </td><td class="dher"><img src="../Images/space.gif" alt="" /></td></tr></table>

                </td><td class="panelHeaderR"></td></tr><tr><td class="panelL"></td><td>
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="MakesModelsTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc"><img src="../Images/space.gif" height="1" width="1" alt="" /></th><th class="thc"><asp:LinkButton runat="server" id="MakeLabel" tooltip="Sort by Make" Text="Make" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="ModelLabel" tooltip="Sort by Model" Text="Model" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="ModelDescLabel" tooltip="Sort by ModelDesc" Text="Model Description" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:Literal runat="server" id="ModelNotesLabel" Text="Model Notes">	</asp:Literal></th><th class="thc"><asp:LinkButton runat="server" id="ModelPackCodeLabel" tooltip="Sort by ModelPackCode" Text="Model Pack Code" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="CategoryLabel" tooltip="Sort by Category" Text="Category" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:LinkButton runat="server" id="makesmodels_activeLabel" tooltip="Sort by makesmodels_active" Text="EvaluateFormula(&quot;= \&quot;Active\&quot;&quot;, true)" CausesValidation="False">	</asp:LinkButton></th></tr><asp:Repeater runat="server" id="MakesModelsTableControlRepeater">		<ITEMTEMPLATE>		<OEMConversion:MakesModelsTableControlRow runat="server" id="MakesModelsTableControlRow">
<tr><td class="tableRowButtonsCellVertical" scope="row" style="font-size: 5px;">
                                ...
                                </td><td class="tableCellValue"><asp:Literal runat="server" id="Make"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="Model"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ModelDesc"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ModelNotes"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ModelPackCode"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="Category"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="makesmodels_active"></asp:Literal></td></tr></OEMConversion:MakesModelsTableControlRow>
</ITEMTEMPLATE>

</asp:Repeater>
<tr summary="Footer"><td class="tableCellValue" colspan="7"><%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("CancelButton"))%>
