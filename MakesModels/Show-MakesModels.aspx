<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Show_MakesModels" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Show-MakesModels.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Show_MakesModels" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td><asp:panel id="MakesModelsRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tableCellLabel"><asp:Literal runat="server" id="CategoryLabel" Text="Category">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="Category"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ModelDateRecordUpdatedLabel" Text="Model Date Record Updated">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="ModelDateRecordUpdated"></asp:Literal></span>
 </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="LastExtractionLabel" Text="Last Extraction">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="LastExtraction"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ModelMarkupRateLabel" Text="Model Markup Rate">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="ModelMarkupRate"></asp:Literal></span>
 </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ModelCopyAttachLabel" Text="Model Copy Attach">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ModelCopyAttach"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ModelVendNoLabel" Text="Model Vend Number">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="ModelVendNo"></asp:Literal></span>
 </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ModelCopyNotesLabel" Text="Model Copy Notes">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ModelCopyNotes"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ModelWarrantyLabel" Text="Model Warranty">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="ModelWarranty"></asp:Literal></span>
 </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ModelExcludeLabel" Text="Model Exclude">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ModelExclude"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ModelHandlingLabel" Text="Model Handling">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="ModelHandling"></asp:Literal></span>
 </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ModelExportIncludeLabel" Text="Model Export Include">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ModelExportInclude"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ModelLaborLabel" Text="Model Labor">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="ModelLabor"></asp:Literal></span>
 </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ModelExportRecordChangedLabel" Text="Model Export Record Changed">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ModelExportRecordChanged"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ModelPartsLabel" Text="Model Parts">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="ModelParts"></asp:Literal></span>
 </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ModelIgnoreSerialNoRulesLabel" Text="Model Ignore Serial No Rules">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ModelIgnoreSerialNoRules"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ModelReplaceCostNewLabel" Text="Model Replace Cost New">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="ModelReplaceCostNew"></asp:Literal></span>
 </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ModelPreapprovedLabel" Text="Model Preapproved">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ModelPreapproved"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ModelReplaceCostRefurbishedLabel" Text="Model Replace Cost Refurbished">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="ModelReplaceCostRefurbished"></asp:Literal></span>
 </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="MakeLabel" Text="Make">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="Make"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ModelShippingLabel" Text="Model Shipping">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="ModelShipping"></asp:Literal></span>
 </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ModelLabel" Text="Model">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="Model"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ModelTravelLabel" Text="Model Travel">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="ModelTravel"></asp:Literal></span>
 </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ModelBinLabel" Text="Model Binary">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ModelBin"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ModelDescLabel" Text="Model Description">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ModelDesc"></asp:Literal> </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ModelPackCodeLabel" Text="Model Pack Code">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ModelPackCode"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ModelReference1Label" Text="Model Reference 1">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ModelReference1"></asp:Literal> </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ModelReference2Label" Text="Model Reference 2">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ModelReference2"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ModelReference3Label" Text="Model Reference 3">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ModelReference3"></asp:Literal> </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ModelReference4Label" Text="Model Reference 4">	</asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ModelReference4"></asp:Literal> </td><td class="tableCellValue"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ModelNotesLabel" Text="Model Notes">	</asp:Literal></td><td class="tableCellValue" colspan="3"><asp:Literal runat="server" id="ModelNotes"></asp:Literal> </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ModelSubcontractNotesLabel" Text="Model Subcontract Notes">	</asp:Literal></td><td class="tableCellValue" colspan="3"><asp:Literal runat="server" id="ModelSubcontractNotes"></asp:Literal> </td></tr></table></asp:panel>
</td></tr></table>
</asp:panel>
...
</td></tr><tr><td><BaseClasses:TabContainer runat="server" id="MakesModelsTabContainer" panellayout="Tabbed">
...
</td><td class="tableCellValue"><asp:Literal runat="server" id="ROMake"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ROBatchIDLabel" Text="RO Batch">	</asp:Literal> 
...
</td><td class="tableCellValue"><asp:Literal runat="server" id="ROModel"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="ROBinLabel" Text="RO Binary">	</asp:Literal> 
...
<asp:Literal runat="server" id="RONo"></asp:Literal></span>
 </td><td class="tableCellLabel"><asp:Literal runat="server" id="ROCustom1Label" Text="RO Custom 1">	</asp:Literal> 
