...
// This file implements the code-behind class for Edit_MakesModels.aspx.
// App_Code\Edit_MakesModels.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_MakesModels
        : BaseApplicationPage
// Code-behind class for the Edit_MakesModels page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_MakesModels()
        {
            this.Initialize();
...
//        public void SetMakesModelsTabContainer()
//        {
//            SetMakesModelsTabContainer_Base(); 
//        }
        
        public void SetMakesModelsRecordControl()
        {
            SetMakesModelsRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Makes Models");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "MakesModelsRecordControl":
                 SetMakesModelsRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.MakesModelsRecordControl.SaveData();
        ...
        SetMakesModelsRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "MakesModelsMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetMakesModelsRecordControl_Base()           
        
        {        
            if (MakesModelsRecordControl.Visible)
            {
                MakesModelsRecordControl.LoadData();
                MakesModelsRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.MakesModelsRecordControl != null && this.MakesModelsRecordControl.DataSource != null)
                  {
                        id = this.MakesModelsRecordControl.DataSource.GetValue(this.MakesModelsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.MakesModelsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.MakesModelsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.MakesModelsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.MakesModelsRecordControl.DataSource.GetValue(this.MakesModelsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
