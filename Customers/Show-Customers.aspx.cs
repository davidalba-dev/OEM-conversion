...
// This file implements the code-behind class for Show_Customers.aspx.
// App_Code\Show_Customers.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Customers
        : BaseApplicationPage
// Code-behind class for the Show_Customers page.
...
#region "Section 2: Do not modify this section."
      ...
      public void Page_InitializeEventHandlers_Base(object sender, System.EventArgs e)
      {
        ...
        protected virtual void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Authorize((Control)EditButton, "3");
					
			this.Authorize(((Control)(this.FindControlRecursively("TabPanel2"))), "2;3");
					
			this.Authorize(((Control)(this.FindControlRecursively("TabPanel3"))), "2;3;4;5");
					
			if (!(((Control)(this.FindControl("TabContainer"))) == null)) {
				Control parentTC = ((Control)(this.FindControl("TabContainer")));
    ...
    public static string[] GetAutoCompletionList_Site_inventory_custcontactSearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Customers.Site_inventory_custcontactTableControl control = new OEMConversion.UI.Controls.Show_Customers.Site_inventory_custcontactTableControl();
    ...
    public static string[] GetAutoCompletionList_Site_inventory_custcontactSearchText1_Base(string prefixText, int count)
    {
        ...
        // Hence we can not invoke any method associated with any controls.
        // So, if we need to use any control in the page we need to instantiate it.
        OEMConversion.UI.Controls.Show_Customers.Site_inventory_custcontactTableControl1 control = new OEMConversion.UI.Controls.Show_Customers.Site_inventory_custcontactTableControl1();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRepairOrdersTableControl_Base()           
