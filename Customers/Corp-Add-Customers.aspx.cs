...
// This file implements the code-behind class for Corp_Add_Customers.aspx.
// App_Code\Corp_Add_Customers.Controls.vb contains the Table, Row and Record control classes
...
public partial class Corp_Add_Customers
        : BaseApplicationPage
// Code-behind class for the Corp_Add_Customers page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Corp_Add_Customers()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
      ...
      this.RedirectBack();
        ...
        public void SaveButton_Click_Base(object sender, EventArgs args)
        {
            ...
            string url = @"../CustomerContacts/Add-CustomerContacts.aspx?CustomerNo={CustomersRecordControl:FV:CustNo}";
    ...
    public  void SendEmailOnSaveButton_Click_Base()
        ...
        SendEmail1Content = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("The+following+new+Customer+Account+was+created+with+the+following+details%3a%0d%0a%0d%0aAccount+Name%3a+%7bCustomersRecordControl%3aNoUrlEncode%3aFDV%3aCustName%7d"), "", false);
