...
// This file implements the code-behind class for Customer_Edit_Customers.aspx.
// App_Code\Customer_Edit_Customers.Controls.vb contains the Table, Row and Record control classes
...
public partial class Customer_Edit_Customers
        : BaseApplicationPage
// Code-behind class for the Customer_Edit_Customers page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Customer_Edit_Customers()
        {
            this.Initialize();
...
//        }
//public void SetSite_inventoryTableControl1()
//        {
//            SetSite_inventoryTableControl1_Base(); 
//        }
public void SetSite_inventory_custcontactTableControl()
        {
            SetSite_inventory_custcontactTableControl_Base(); 
        }
[System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_Site_inventory_custcontactSearchText(string prefixText, int count)
        {
            // GetSite_inventory_custcontactSearchTextCompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_Site_inventory_custcontactSearchText_Base()
            // or replace the call to GetAutoCompletionList_Site_inventory_custcontactSearchText_Base().
            return GetAutoCompletionList_Site_inventory_custcontactSearchText_Base(prefixText, count);
        }
public void SetSite_inventory_custcontactTableControl1()
        {
            SetSite_inventory_custcontactTableControl1_Base(); 
        }
[System.Web.Services.WebMethod]
        public static string[] GetAutoCompletionList_Site_inventory_custcontactSearchText1(string prefixText, int count)
        {
            // GetSite_inventory_custcontactSearchText1CompletionList gets the list of suggestions from the database.
            // prefixText is the search text typed by the user .
            // count specifies the number of suggestions to be returned.
            // Customize by adding code before or after the call to  GetAutoCompletionList_Site_inventory_custcontactSearchText1_Base()
            // or replace the call to GetAutoCompletionList_Site_inventory_custcontactSearchText1_Base().
            return GetAutoCompletionList_Site_inventory_custcontactSearchText1_Base(prefixText, count);
        }
#endregion
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "CustomerContactsTableControl":
                 SetCustomerContactsTableControl();
                 break;
              ...
              case "DepartmentTableControl":
                 SetDepartmentTableControl();
                 break;
          
              case "Site_inventory_custcontactTableControl":
                 SetSite_inventory_custcontactTableControl();
                 break;
          
              case "Site_inventory_custcontactTableControl1":
                 SetSite_inventory_custcontactTableControl1();
                 break;
    ...
    public static string[] GetAutoCompletionList_DepartmentSearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Customer_Edit_Customers.DepartmentTableControl control = new OEMConversion.UI.Controls.Customer_Edit_Customers.DepartmentTableControl();
        
        return control.GetAutoCompletionList_DepartmentSearchText(prefixText, count);
            
    }
      
    public static string[] GetAutoCompletionList_Site_inventory_custcontactSearchText_Base(string prefixText, int count)
    {
        // Since this method is a shared/static method it does not maintain information about page or controls within the page.
        // Hence we can not invoke any method associated with any controls.
        // So, if we need to use any control in the page we need to instantiate it.
        OEMConversion.UI.Controls.Customer_Edit_Customers.Site_inventory_custcontactTableControl control = new OEMConversion.UI.Controls.Customer_Edit_Customers.Site_inventory_custcontactTableControl();
        
        return control.GetAutoCompletionList_Site_inventory_custcontactSearchText(prefixText, count);
            
    }
      
    public static string[] GetAutoCompletionList_Site_inventory_custcontactSearchText1_Base(string prefixText, int count)
    {
        // Since this method is a shared/static method it does not maintain information about page or controls within the page.
        // Hence we can not invoke any method associated with any controls.
        // So, if we need to use any control in the page we need to instantiate it.
        OEMConversion.UI.Controls.Customer_Edit_Customers.Site_inventory_custcontactTableControl1 control = new OEMConversion.UI.Controls.Customer_Edit_Customers.Site_inventory_custcontactTableControl1();
        
        return control.GetAutoCompletionList_Site_inventory_custcontactSearchText1(prefixText, count);
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetCustomerContactsTableControl_Base()           
        
        {        
            if (CustomerContactsTableControl.Visible)
            {
                CustomerContactsTableControl.LoadData();
                CustomerContactsTableControl.DataBind();
            }
        }
        ...
        public void SetDepartmentTableControl_Base()           
        
        {        
            if (DepartmentTableControl.Visible)
            {
                DepartmentTableControl.LoadData();
                DepartmentTableControl.DataBind();
            }
        }
      
        public void SetSite_inventory_custcontactTableControl_Base()           
        
        {        
            if (Site_inventory_custcontactTableControl.Visible)
            {
                Site_inventory_custcontactTableControl.LoadData();
                Site_inventory_custcontactTableControl.DataBind();
            }
        }
      
        public void SetSite_inventory_custcontactTableControl1_Base()           
        
        {        
            if (Site_inventory_custcontactTableControl1.Visible)
            {
                Site_inventory_custcontactTableControl1.LoadData();
                Site_inventory_custcontactTableControl1.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.CustomersRecordControl != null && this.CustomersRecordControl.DataSource != null)
                  {
                        id = this.CustomersRecordControl.DataSource.GetValue(this.CustomersRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.CustomersRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.CustomersRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.CustomersRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.CustomersRecordControl.DataSource.GetValue(this.CustomersRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
