...
// This file implements the code-behind class for Add_Customers_Basic.aspx.
// App_Code\Add_Customers_Basic.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Customers_Basic
        : BaseApplicationPage
// Code-behind class for the Add_Customers_Basic page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Customers_Basic()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Customers");
    ...
    public  void SendEmailOnSaveButton_Click_Base()
        ...
        SendEmail1To = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("oeminfo%40oemmed.com"), "" ,false);

          
        string SendEmail1CC;
        SendEmail1CC = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("kplante%40oemmed.com"), "", false);
          
        string SendEmail1Subject;
        //In case Subject includes expressions substitute them with values
        SendEmail1Subject = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("OEM+MED+Expertech-+New+Customer+Account"), "", false);
          
        string SendEmail1Content;
        //In case content has expressions substitude then with values
        SendEmail1Content = this.EvaluateExpressions(System.Web.HttpUtility.UrlDecode("The+following+new+Customer+Account+was+created+with+the+following+details%3a%0d%0a%0d%0aAccount+Name%3a+%7bCustomersRecordControl%3aNoUrlEncode%3aFDV%3aCustName%7d%0d%0a"), "", false);
