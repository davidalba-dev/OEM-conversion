<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Corp-Show-Customers.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Corp_Show_Customers" %>
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Corp_Show_Customers" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title" Text="Customer Details">	</asp:Literal>
                      </td></tr></table>
...
</td><td class="tableCellValue"><asp:Literal runat="server" id="ROContactName"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="ROCondition"></asp:Literal></td></tr></OEMConversion:RepairOrdersTableControlRow>
</ITEMTEMPLATE>
...
<%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("CancelButton"))%>
 ...
 <BaseClasses:TabPanel runat="server" id="TabPanel1" backcolor="Transparent" forecolor="Transparent" HeaderText="Customer Contacts">	<ContentTemplate> 
<OEMConversion:CustomerContactsTableControl runat="server" id="CustomerContactsTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="panelTL"><img src="../Images/space.gif" class="panelTLSpace" alt="" /></td><td class="panelT"></td><td class="panelTR"><img src="../Images/space.gif" class="panelTRSpace" alt="" /></td></tr><tr><td class="panelHeaderL"></td><td class="dh">
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title2" Text="&lt;%#String.Concat(&quot;Customer Contacts&quot;) %>">	</asp:Literal>
                      </td></tr></table>
...
<OEMConversion:DepartmentTableControl runat="server" id="DepartmentTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="panelTL"><img src="../Images/space.gif" class="panelTLSpace" alt="" /></td><td class="panelT"></td><td class="panelTR"><img src="../Images/space.gif" class="panelTRSpace" alt="" /></td></tr><tr><td class="panelHeaderL"></td><td class="dh">
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title5" Text="&lt;%#String.Concat(&quot;Department&quot;) %>">	</asp:Literal>
                      </td></tr></table>
...
<asp:AutoCompleteExtender id="Site_inventory_custcontactSearchTextAutoCompleteExtender" runat="server" TargetControlID="Site_inventory_custcontactSearchText" ServiceMethod="GetAutoCompletionList_Site_inventory_custcontactSearchText" MinimumPrefixLength="2" CompletionInterval="700" CompletionSetCount="10" CompletionListCssClass="autotypeahead_completionListElement" CompletionListItemCssClass="autotypeahead_listItem " CompletionListHighlightedItemCssClass="autotypeahead_highlightedListItem">
              ...
              <%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("SearchButton"))%>
                ...
                <asp:ImageButton runat="server" id="SearchButton" causesvalidation="False" commandname="Search" imageurl="../Images/panelSearchButton.png" tooltip="&lt;%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;OEMConversion&quot;) %>">		
                  ...
                  <asp:panel id="CollapsibleRegion6" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre"><table id="Site_inventory_custcontactTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc"><img src="../Images/space.gif" height="1" width="1" alt="" /></th><th class="thc"><asp:LinkButton runat="server" id="makeLabel1" tooltip="Sort by make" Text="Make" CausesValidation="False">	</asp:LinkButton></th><th class="thc"><asp:Literal runat="server" id="modelLabel1" Text="Model">	</asp:Literal></th><th class="thc"><asp:Literal runat="server" id="categoryLabel1" Text="Category">	</asp:Literal></th><th class="thc"><asp:Label runat="server" id="serial_noLabel1" Text="Serial Number">	</asp:Label></th><th class="thc"><asp:Literal runat="server" id="date_addedLabel1" Text="Date Added">	</asp:Literal></th><th class="thc"><asp:Literal runat="server" id="notesLabel1" Text="Notes">	</asp:Literal></th></tr><asp:Repeater runat="server" id="Site_inventory_custcontactTableControlRepeater">		<ITEMTEMPLATE>		<OEMConversion:Site_inventory_custcontactTableControlRow runat="server" id="Site_inventory_custcontactTableControlRow">
<tr><td class="tableRowButtonsCellVertical" scope="row" style="font-size: 5px;"></td><td class="tableCellValue"><asp:Literal runat="server" id="make1"></asp:Literal> </td><td class="tableCellValue"><asp:Literal runat="server" id="model1"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="category1"></asp:Literal></td><td class="tableCellValue"><asp:Literal runat="server" id="serial_no1"></asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
<BaseClasses:TabPanel runat="server" id="TabPanel6" HeaderText="Removed Inventory">	<ContentTemplate> 
  <OEMConversion:Site_inventory_custcontactTableControl1 runat="server" id="Site_inventory_custcontactTableControl1">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="panelTL"><img src="../Images/space.gif" class="panelTLSpace" alt="" /></td><td class="panelT"></td><td class="panelTR"><img src="../Images/space.gif" class="panelTRSpace" alt="" /></td></tr><tr><td class="panelHeaderL"></td><td class="dh">
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title6" Text="Removed Inventory Items">	</asp:Literal>
                      </td></tr></table>
