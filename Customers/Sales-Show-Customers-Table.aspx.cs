...
// This file implements the code-behind class for Sales_Show_Customers_Table.aspx.
// App_Code\Sales_Show_Customers_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Sales_Show_Customers_Table
        : BaseApplicationPage
// Code-behind class for the Sales_Show_Customers_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Sales_Show_Customers_Table()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Sales_Show_Customers_Table.CustomersTableControl control = new OEMConversion.UI.Controls.Sales_Show_Customers_Table.CustomersTableControl();
