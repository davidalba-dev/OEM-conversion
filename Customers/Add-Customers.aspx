<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Add_Customers" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Add-Customers.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OEMConversion.UI.Add_Customers" %>
...
</td><td class="tableCellLabel"><asp:Literal runat="server" id="customer_po_neededLabel" Text="EvaluateFormula(&quot;= \&quot;PO Needed\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><asp:CheckBox runat="server" id="customer_po_needed"></asp:CheckBox></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="CustNameLabel" Text="EvaluateFormula(&quot;= \&quot;Facility Name\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
</td><td class="tableCellLabel"><asp:Literal runat="server" id="customer_bill_faxLabel" Text="EvaluateFormula(&quot;= \&quot;Bill Fax\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><asp:CheckBox runat="server" id="customer_bill_fax"></asp:CheckBox></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="CustCityLabel" Text="EvaluateFormula(&quot;= \&quot;City\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
</td><td class="tableCellLabel"><asp:Literal runat="server" id="customer_bill_mailLabel" Text="EvaluateFormula(&quot;= \&quot;Bill Mail\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><asp:CheckBox runat="server" id="customer_bill_mail"></asp:CheckBox></td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="CustProvinceLabel" Text="EvaluateFormula(&quot;= \&quot;State\&quot;&quot;, true)">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
<asp:DropDownList runat="server" id="customer_type_id" cssclass="field_input" onkeypress="dropDownListTypeAhead(this,false)" tabindex="13"></asp:DropDownList>&nbsp;
...
</td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"><asp:Literal runat="server" id="customer_inventoryLabel" Text="Inventory">	</asp:Literal></td><td class="tableCellValue"><asp:CheckBox runat="server" id="customer_inventory"></asp:CheckBox></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellValue"></td><td class="tableCellValue"></td><td class="tableCellLabel"><asp:Literal runat="server" id="customer_scopeLabel" Text="Service">	</asp:Literal></td><td class="tableCellValue"><asp:CheckBox runat="server" id="customer_scope"></asp:CheckBox></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"><span style="white-space:nowrap;">
<table border="0" cellpadding="0" cellspacing="0">
<tr>
<td style="padding-right: 5px; vertical-align:top">
