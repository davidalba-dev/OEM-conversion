...
// This file implements the code-behind class for Corp_Show_Customers.aspx.
// App_Code\Corp_Show_Customers.Controls.vb contains the Table, Row and Record control classes
...
public partial class Corp_Show_Customers
        : BaseApplicationPage
// Code-behind class for the Corp_Show_Customers page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Corp_Show_Customers()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_Site_inventory_custcontactSearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Corp_Show_Customers.Site_inventory_custcontactTableControl control = new OEMConversion.UI.Controls.Corp_Show_Customers.Site_inventory_custcontactTableControl();
    ...
    public static string[] GetAutoCompletionList_Site_inventory_custcontactSearchText1_Base(string prefixText, int count)
    {
        ...
        // Hence we can not invoke any method associated with any controls.
        // So, if we need to use any control in the page we need to instantiate it.
        OEMConversion.UI.Controls.Corp_Show_Customers.Site_inventory_custcontactTableControl1 control = new OEMConversion.UI.Controls.Corp_Show_Customers.Site_inventory_custcontactTableControl1();
