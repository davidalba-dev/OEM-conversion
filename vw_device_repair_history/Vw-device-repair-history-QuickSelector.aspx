...
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Vw_device_repair_history_QuickSelector" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Vw-device-repair-history-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="OEMConversion.UI.Vw_device_repair_history_QuickSelector" %>
