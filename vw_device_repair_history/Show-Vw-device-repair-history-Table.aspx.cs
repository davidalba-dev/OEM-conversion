...
// This file implements the code-behind class for Show_Vw_device_repair_history_Table.aspx.
// App_Code\Show_Vw_device_repair_history_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Vw_device_repair_history_Table
        : BaseApplicationPage
// Code-behind class for the Show_Vw_device_repair_history_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Vw_device_repair_history_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetVw_device_repair_historyTableControl()
        {
            SetVw_device_repair_historyTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = "Device Repair History";
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Vw_device_repair_historyTableControl":
                 SetVw_device_repair_historyTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Vw_device_repair_historyTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Vw_device_repair_history_Table.Vw_device_repair_historyTableControl control = new OEMConversion.UI.Controls.Show_Vw_device_repair_history_Table.Vw_device_repair_historyTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetVw_device_repair_historyTableControl_Base()           
        
        {        
            if (Vw_device_repair_historyTableControl.Visible)
            {
                Vw_device_repair_historyTableControl.LoadData();
                Vw_device_repair_historyTableControl.DataBind();
            }
        }
