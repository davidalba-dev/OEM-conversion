...
// This file implements the code-behind class for Show_Vw_device_repair_history.aspx.
// App_Code\Show_Vw_device_repair_history.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Vw_device_repair_history
        : BaseApplicationPage
// Code-behind class for the Show_Vw_device_repair_history page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Vw_device_repair_history()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetVw_device_repair_historyRecordControl()
        {
            SetVw_device_repair_historyRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Vw_device_repair_historyRecordControl":
                 SetVw_device_repair_historyRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Vw_device_repair_historyRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetVw_device_repair_historyRecordControl_Base()           
        
        {        
            if (Vw_device_repair_historyRecordControl.Visible)
            {
                Vw_device_repair_historyRecordControl.LoadData();
                Vw_device_repair_historyRecordControl.DataBind();
            }
        }
