...
// This file implements the code-behind class for Vw_device_repair_history_QuickSelector.aspx.
// App_Code\Vw_device_repair_history_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
public partial class Vw_device_repair_history_QuickSelector
        : BaseApplicationPage
// Code-behind class for the Vw_device_repair_history_QuickSelector page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Vw_device_repair_history_QuickSelector()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_Search_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Vw_device_repair_history_QuickSelector.SelectorTableControl control = new OEMConversion.UI.Controls.Vw_device_repair_history_QuickSelector.SelectorTableControl();
