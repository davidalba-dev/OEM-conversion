...
// This file implements the code-behind class for Add_ApprovalMethods.aspx.
// App_Code\Add_ApprovalMethods.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_ApprovalMethods
        : BaseApplicationPage
// Code-behind class for the Add_ApprovalMethods page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_ApprovalMethods()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetApprovalMethodsTabContainer()
        {
            SetApprovalMethodsTabContainer_Base(); 
        }
        
        public void SetApprovalMethodsRecordControl()
        {
            SetApprovalMethodsRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Approval Methods");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "ApprovalMethodsRecordControl":
                 SetApprovalMethodsRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.ApprovalMethodsRecordControl.SaveData();
    ...
    DbUtils.StartTransaction();
            ...
            SetApprovalMethodsTabContainer(); 
        ...
        SetApprovalMethodsRecordControl();
                ...
                IMenuComponent menuComponent = ((IMenuComponent)(this.Master.FindControl("_Menu")));
                    if (!(menuComponent == null)) {
                        menuComponent.HiliteSettings = "ApprovalMethodsMenuItem";
                    }
                }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetApprovalMethodsTabContainer_Base()           
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "ApprovalMethodsTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "ApprovalMethodsTabContainer").Visible = false;
         
  
        }      
      
        public void SetApprovalMethodsRecordControl_Base()           
        
        {        
            if (ApprovalMethodsRecordControl.Visible)
            {
                ApprovalMethodsRecordControl.LoadData();
                ApprovalMethodsRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.ApprovalMethodsRecordControl != null && this.ApprovalMethodsRecordControl.DataSource != null)
                  {
                        id = this.ApprovalMethodsRecordControl.DataSource.GetValue(this.ApprovalMethodsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.ApprovalMethodsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.ApprovalMethodsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.ApprovalMethodsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.ApprovalMethodsRecordControl.DataSource.GetValue(this.ApprovalMethodsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
