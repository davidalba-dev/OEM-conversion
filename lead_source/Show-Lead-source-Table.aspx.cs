...
// This file implements the code-behind class for Show_Lead_source_Table.aspx.
// App_Code\Show_Lead_source_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Lead_source_Table
        : BaseApplicationPage
// Code-behind class for the Show_Lead_source_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Lead_source_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetLead_sourceTableControl()
        {
            SetLead_sourceTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Lead_sourceTableControl":
                 SetLead_sourceTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Lead_sourceTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetLead_sourceTableControl_Base()           
        
        {        
            if (Lead_sourceTableControl.Visible)
            {
                Lead_sourceTableControl.LoadData();
                Lead_sourceTableControl.DataBind();
            }
        }
