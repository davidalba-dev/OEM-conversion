...
// This file implements the code-behind class for Edit_Lead_source.aspx.
// App_Code\Edit_Lead_source.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Lead_source
        : BaseApplicationPage
// Code-behind class for the Edit_Lead_source page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Lead_source()
        {
            this.Initialize();
...
//        public void SetLead_sourceTabContainer()
//        {
//            SetLead_sourceTabContainer_Base(); 
//        }
        
        public void SetLead_sourceRecordControl()
        {
            SetLead_sourceRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Lead Source");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Lead_sourceRecordControl":
                 SetLead_sourceRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Lead_sourceRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetLead_sourceRecordControl_Base()           
        
        {        
            if (Lead_sourceRecordControl.Visible)
            {
                Lead_sourceRecordControl.LoadData();
                Lead_sourceRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Lead_sourceRecordControl != null && this.Lead_sourceRecordControl.DataSource != null)
                  {
                        id = this.Lead_sourceRecordControl.DataSource.GetValue(this.Lead_sourceRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Lead_sourceRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Lead_sourceRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Lead_sourceRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Lead_sourceRecordControl.DataSource.GetValue(this.Lead_sourceRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
