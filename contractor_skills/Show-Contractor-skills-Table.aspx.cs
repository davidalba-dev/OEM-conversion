...
// This file implements the code-behind class for Show_Contractor_skills_Table.aspx.
// App_Code\Show_Contractor_skills_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Contractor_skills_Table
        : BaseApplicationPage
// Code-behind class for the Show_Contractor_skills_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Contractor_skills_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetContractor_skillsTableControl()
        {
            SetContractor_skillsTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Contractor_skillsTableControl":
                 SetContractor_skillsTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Contractor_skillsTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Show_Contractor_skills_Table.Contractor_skillsTableControl control = new OEMConversion.UI.Controls.Show_Contractor_skills_Table.Contractor_skillsTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetContractor_skillsTableControl_Base()           
        
        {        
            if (Contractor_skillsTableControl.Visible)
            {
                Contractor_skillsTableControl.LoadData();
                Contractor_skillsTableControl.DataBind();
            }
        }
