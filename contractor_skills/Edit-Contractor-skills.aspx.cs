...
// This file implements the code-behind class for Edit_Contractor_skills.aspx.
// App_Code\Edit_Contractor_skills.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Contractor_skills
        : BaseApplicationPage
// Code-behind class for the Edit_Contractor_skills page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Contractor_skills()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetContractor_skillsRecordControl()
        {
            SetContractor_skillsRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Contractor Skills");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "Contractor_skillsRecordControl":
                 SetContractor_skillsRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.Contractor_skillsRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetContractor_skillsRecordControl_Base()           
        
        {        
            if (Contractor_skillsRecordControl.Visible)
            {
                Contractor_skillsRecordControl.LoadData();
                Contractor_skillsRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.Contractor_skillsRecordControl != null && this.Contractor_skillsRecordControl.DataSource != null)
                  {
                        id = this.Contractor_skillsRecordControl.DataSource.GetValue(this.Contractor_skillsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.Contractor_skillsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.Contractor_skillsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.Contractor_skillsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.Contractor_skillsRecordControl.DataSource.GetValue(this.Contractor_skillsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
