...
// This file implements the code-behind class for Contractor_skills_QuickSelector.aspx.
// App_Code\Contractor_skills_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
public partial class Contractor_skills_QuickSelector
        : BaseApplicationPage
// Code-behind class for the Contractor_skills_QuickSelector page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Contractor_skills_QuickSelector()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_Search_Base(string prefixText, int count)
    {
        ...
        OEMConversion.UI.Controls.Contractor_skills_QuickSelector.SelectorTableControl control = new OEMConversion.UI.Controls.Contractor_skills_QuickSelector.SelectorTableControl();
