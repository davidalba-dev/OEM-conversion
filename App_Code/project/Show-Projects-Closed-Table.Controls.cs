...
// Show_Projects_Closed_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Projects_Closed_Table
{
...
// Base class for the ProjectTableControlRow control on the Show_Projects_Closed_Table page.
...
// Base class for the ProjectTableControl control on the Show_Projects_Closed_Table page.
    ...
    public virtual void AddWarningMessageOnClick() {
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            if (EvaluateFormula("3", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.ProjectTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"project_.project_status_id"), EvaluateFormula("3", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Projects-Closed-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "project";
                // If Show-Projects-Closed-Table.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Projects-Closed-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "project";
                // If Show-Projects-Closed-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual ProjectTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ProjectTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Projects_Closed_Table.ProjectTableControlRow")));
