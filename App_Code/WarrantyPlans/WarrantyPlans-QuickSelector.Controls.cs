...
// WarrantyPlans_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.WarrantyPlans_QuickSelector
{
...
// Base class for the SelectorTableControlRow control on the WarrantyPlans_QuickSelector page.
...
public class BaseSelectorTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {
            // Load the data from the database into the DataSource DatabaseAYS_OEM%dbo.WarrantyPlans record.
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = WarrantyPlansTable.GetRecord(this.RecordUniqueId, true);
            ...
            this.DataSource = new WarrantyPlansRecord();
      ...
      // To customize, override this method in SelectorTableControlRow.
        ...
        public virtual void Delete()
        {
          ...
          WarrantyPlansTable.DeleteRecord(pkValue);
        ...
        public WarrantyPlansRecord DataSource {
            get {
                return (WarrantyPlansRecord)(this._DataSource);
            }
            set {
...
#region "Helper Properties"
    ...
    WarrantyPlansRecord rec = null;
        ...
        public virtual WarrantyPlansRecord GetRecord()
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return WarrantyPlansTable.GetRecord(this.RecordUniqueId, true);
...
// Base class for the SelectorTableControl control on the WarrantyPlans_QuickSelector page.
...
public class BaseSelectorTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(OEMConversion.Business.WarrantyPlansRecord);
                      this.DataSource = (WarrantyPlansRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    Type myrec = typeof(OEMConversion.Business.WarrantyPlansRecord);
                    this.DataSource = (WarrantyPlansRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual WarrantyPlansRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(WarrantyPlansTable.Column1, true);          
            // selCols.Add(WarrantyPlansTable.Column2, true);          
            // selCols.Add(WarrantyPlansTable.Column3, true);          
                  ...
                  
            {
                ...
                return WarrantyPlansTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                WarrantyPlansTable databaseTable = new WarrantyPlansTable();
                ...
                return (recList.ToArray(typeof(WarrantyPlansRecord)) as WarrantyPlansRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0 || selCols.HasPrimaryKey())
                ...
                return WarrantyPlansTable.GetRecordCount(join, where);
            else
            {
                WarrantyPlansTable databaseTable = new WarrantyPlansTable();
                databaseTable.SelectedColumns.Clear();
        ...
        {    
            ...
            {
                BaseColumn col = WarrantyPlansTable.GetColumnByName(field);
            ...
            if (includeFormulaAndDFKAParameter) 
            {
                if (formula != "")
                {
                    foreach (BaseColumn col in MiscUtils.GetFormulaFieldList(formula, WarrantyPlansTable.Instance.TableDefinition))
                    {
                        if (col != null && !columnList.Contains(col))
                            columnList.Add(col);             
                    }
                ...
                {
                    BaseColumn col = WarrantyPlansTable.GetColumnByName(displayFieldName);
                    if (col != null && !columnList.Contains(col))
                        columnList.Add(col);             
                }
            }
      ...
      public override void DataBind()
      {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            WarrantyPlansTable.Instance.InnerFilter = null;
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.Search, this.GetFromSession(this.Search)), true, false);
		        ...
		        if (!string.IsNullOrEmpty(this.Page.Request["dependOnField"]) && this.Page.Request["dependOnVal"] != null) {
			          BaseColumn dependOnCol = WarrantyPlansTable.GetColumnByName(this.Page.GetDecryptedURLParameter("dependOnField"));
                if (dependOnCol != null){                
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_Search(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            OEMConversion.Business.WarrantyPlansRecord[] recordList  = WarrantyPlansTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (WarrantyPlansRecord rec in recordList ){
      ...
      WarrantyPlansRecord rec = new WarrantyPlansRecord();
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new WarrantyPlansRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(OEMConversion.Business.WarrantyPlansRecord);
                this.DataSource = (WarrantyPlansRecord[])(finalList.ToArray(myrec));
      ...
      this.Page.Response.Redirect(url);
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = WarrantyPlansTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  WarrantyPlansRecord[] DataSource {
            ...
            get {
                return (WarrantyPlansRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.WarrantyPlans_QuickSelector.SelectorTableControlRow")));
