...
// Show_SC2_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_SC2_Mobile
{
...
// Base class for the SC2RecordControl control on the Show_SC2_Mobile page.
...
public class BaseSC2RecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in SC2RecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-SC2-Mobile"] = recId;
