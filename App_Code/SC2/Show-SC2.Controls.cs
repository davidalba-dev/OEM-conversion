...
// Show_SC2.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_SC2
{
...
public class SC2RecordControl : BaseSC2RecordControl
{
      
        // The BaseSC2RecordControl implements the LoadData, DataBind and other
...
// Base class for the SC2RecordControl control on the Show_SC2 page.
// Do not modify this class. Instead override any method in SC2RecordControl.
public class BaseSC2RecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseSC2RecordControl()
        {
        ...
        // To customize, override this method in SC2RecordControl.
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "SC2RecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            SC2Record[] recList = SC2Table.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = SC2Table.GetRecord(recList[0].GetID().ToXmlString(), true);
      ...
      // To customize, override this method in SC2RecordControl.
         ...
         
        {
            ...
            bool hasFiltersSC2RecordControl = false;
            hasFiltersSC2RecordControl = hasFiltersSC2RecordControl && false; // suppress warning
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["SC2"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "SC2"));
            }
            HttpContext.Current.Session["QueryString in Show-SC2"] = recId;
          ...
          wc.iAND(SC2Table.ServKey, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(SC2Table.ServKey));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(SC2Table.ServKey, BaseFilter.ComparisonOperator.EqualsTo, recId);
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseSC2RecordControl_Rec"];
            }
            set {
                this.ViewState["BaseSC2RecordControl_Rec"] = value;
            }
        }
