...
// Add_SC2.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_SC2
{
...
// Base class for the SC2RecordControl control on the Add_SC2 page.
...
public class BaseSC2RecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (SC2Record)SC2Record.Copy(recList[0], false);
        ...
        public virtual void SetServCategory()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = SC2Table.ServCategory.DefaultValue;
        ...
        public virtual void SetServType()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
              ...
              this.ServType.Text = EvaluateFormula("6", this.DataSource);
        ...
        public virtual void GetServCategory()
        {
         // Retrieve the value entered by the user on the ServCategory ASP:DropDownList, and
            ...
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.ServCategory), SC2Table.ServCategory);			
      ...
      // To customize, override this method in SC2RecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["SC2"];
            ...
            HttpContext.Current.Session["QueryString in Add-SC2"] = recId;
        ...
        protected virtual void PopulateServCategoryDropDownList(string selectedValue, int maxItems) 
        {
            ...
            if (wc.RunQuery)
            {
                foreach (string itemValue in SC2Table.GetValues(SC2Table.ServCategory, wc, orderBy, maxItems)) {
                    // Create the dropdown list item and add it to the list.
                    string fvalue = SC2Table.ServCategory.Format(itemValue);
            ...
            if (selectedValue != null &&
                ...
                !MiscUtils.SetSelectedDisplayText(this.ServCategory, SC2Table.ServCategory.Format(selectedValue)))
            {
                string fvalue = SC2Table.ServCategory.Format(selectedValue);
