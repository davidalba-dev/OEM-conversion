...
// Show_Vw_equipment_inventory_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Vw_equipment_inventory_Table
{
...
// Base class for the Vw_equipment_inventoryTableControlRow control on the Show_Vw_equipment_inventory_Table page.
...
// Base class for the Vw_equipment_inventoryTableControl control on the Show_Vw_equipment_inventory_Table page.
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Vw-equipment-inventory-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vw_equipment_inventory";
                // If Show-Vw-equipment-inventory-Table.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Vw-equipment-inventory-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vw_equipment_inventory";
                // If Show-Vw-equipment-inventory-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual Vw_equipment_inventoryTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Vw_equipment_inventoryTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Vw_equipment_inventory_Table.Vw_equipment_inventoryTableControlRow")));
