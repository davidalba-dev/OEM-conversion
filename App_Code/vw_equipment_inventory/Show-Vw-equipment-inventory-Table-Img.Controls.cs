...
// Show_Vw_equipment_inventory_Table_Img.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Vw_equipment_inventory_Table_Img
{
...
// Base class for the Vw_equipment_inventoryTableControlRow control on the Show_Vw_equipment_inventory_Table_Img page.
...
public class BaseVw_equipment_inventoryTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setequipment_inventory_pic1()
        {
            ...
            if (this.DataSource != null && this.DataSource.equipment_inventory_pic1Specified) {
                ...
                this.equipment_inventory_pic1.ImageUrl = this.DataSource.FormatImageUrl(Vw_equipment_inventoryView.equipment_inventory_pic1, this.Page.Encrypt("Vw_equipment_inventory"), this.Page.Encrypt("equipment_inventory_pic1"), this.Page.Encrypt(this.DataSource.GetID().ToXmlString()), 100);
...
// Base class for the Vw_equipment_inventoryTableControl control on the Show_Vw_equipment_inventory_Table_Img page.
...
public class BaseVw_equipment_inventoryTableControl : OEMConversion.UI.BaseApplicationTableControl
{
       ...
       public BaseVw_equipment_inventoryTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.dotmed_activeFilter)) 				
                    initialVal = this.GetFromSession(this.dotmed_activeFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"dotmed_active\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.dotmed_activeFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.dotmed_activeFilter.SelectedValue = initialVal;
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.oem_einFilter)) 				
                    initialVal = this.GetFromSession(this.oem_einFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"oem_ein\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.oem_einFilter.Text = initialVal;
            ...
            if (!this.Page.IsPostBack)
            {
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.serial_numberFilter.Text = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.dotmed_activeFilter.SelectedIndexChanged += new EventHandler(dotmed_activeFilter_SelectedIndexChanged);
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                Setdotmed_activeFilter();
                Setdotmed_activeLabel();
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public virtual void ResetControl()
        {
            ...
            this.dotmed_activeFilter.ClearSelection();
            ...
            this.oem_einFilter.Text = "";
            
            this.serial_numberFilter.Text = "";
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.category_idFilter)) {
                ...
                wc.iAND(Vw_equipment_inventoryView.category_id, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.category_idFilter, this.GetFromSession(this.category_idFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.condition_idFilter)) {
                        
                wc.iAND(Vw_equipment_inventoryView.condition_id, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.condition_idFilter, this.GetFromSession(this.condition_idFilter)), false, false);
            ...
            if (MiscUtils.IsValueSelected(this.date_receivedFromFilter)) {
                ...
                wc.iAND(Vw_equipment_inventoryView.date_received, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, val, false, false);
            ...
            if (MiscUtils.IsValueSelected(this.date_receivedToFilter)) {
                ...
                wc.iAND(Vw_equipment_inventoryView.date_received, BaseFilter.ComparisonOperator.Less_Than_Or_Equal, val, false, false);
            ...
            if (MiscUtils.IsValueSelected(this.date_soldFromFilter)) {
                ...
                val = d.ToShortDateString() + " " + "00:00:00";
                wc.iAND(Vw_equipment_inventoryView.date_sold, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, val, false, false);
            ...
            if (MiscUtils.IsValueSelected(this.date_soldToFilter)) {
                ...
                val = d.ToShortDateString() + " " + "23:59:59";
                wc.iAND(Vw_equipment_inventoryView.date_sold, BaseFilter.ComparisonOperator.Less_Than_Or_Equal, val, false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.dotmed_activeFilter)) {
                        
                wc.iAND(Vw_equipment_inventoryView.dotmed_active, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.dotmed_activeFilter, this.GetFromSession(this.dotmed_activeFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.make_idFilter)) {
                        
                wc.iAND(Vw_equipment_inventoryView.make_id, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.make_idFilter, this.GetFromSession(this.make_idFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.model_idFilter)) {
                        
                wc.iAND(Vw_equipment_inventoryView.model_id, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.model_idFilter, this.GetFromSession(this.model_idFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.oem_einFilter)) {
                        
                wc.iAND(Vw_equipment_inventoryView.oem_ein, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.oem_einFilter, this.GetFromSession(this.oem_einFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.received_from_customer_idFilter)) {
                        
                wc.iAND(Vw_equipment_inventoryView.received_from_customer_id, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.received_from_customer_idFilter, this.GetFromSession(this.received_from_customer_idFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.serial_numberFilter)) {
                        
                wc.iAND(Vw_equipment_inventoryView.serial_number, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.serial_numberFilter, this.GetFromSession(this.serial_numberFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.warehouse_idFilter)) {
                        
                wc.iAND(Vw_equipment_inventoryView.warehouse_id, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.warehouse_idFilter, this.GetFromSession(this.warehouse_idFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.warehouse_location_idFilter)) {
                        
                wc.iAND(Vw_equipment_inventoryView.warehouse_location_id, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.warehouse_location_idFilter, this.GetFromSession(this.warehouse_location_idFilter)), false, false);
      ...
      String category_idFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "category_idFilter_Ajax"];
            if (MiscUtils.IsValueSelected(category_idFilterSelectedValue)) {
                ...
                wc.iAND(Vw_equipment_inventoryView.category_id, BaseFilter.ComparisonOperator.EqualsTo, category_idFilterSelectedValue, false, false);
      ...
      String condition_idFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "condition_idFilter_Ajax"];
            if (MiscUtils.IsValueSelected(condition_idFilterSelectedValue)) {
                ...
                wc.iAND(Vw_equipment_inventoryView.condition_id, BaseFilter.ComparisonOperator.EqualsTo, condition_idFilterSelectedValue, false, false);
            ...
            if (MiscUtils.IsValueSelected(date_receivedFromFilterSelectedValue)) {
                ...
                wc.iAND(Vw_equipment_inventoryView.date_received, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, date_receivedFromFilterSelectedValue, false, false);
            ...
            if (MiscUtils.IsValueSelected(date_receivedToFilterSelectedValue)) {
                ...
                wc.iAND(Vw_equipment_inventoryView.date_received, BaseFilter.ComparisonOperator.Less_Than_Or_Equal, date_receivedToFilterSelectedValue, false, false);
            ...
            if (MiscUtils.IsValueSelected(date_soldFromFilterSelectedValue)) {
                ...
                wc.iAND(Vw_equipment_inventoryView.date_sold, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, date_soldFromFilterSelectedValue, false, false);
            ...
            if (MiscUtils.IsValueSelected(date_soldToFilterSelectedValue)) {
                ...
                wc.iAND(Vw_equipment_inventoryView.date_sold, BaseFilter.ComparisonOperator.Less_Than_Or_Equal, date_soldToFilterSelectedValue, false, false);
                    
            }         
      String dotmed_activeFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "dotmed_activeFilter_Ajax"];
            if (MiscUtils.IsValueSelected(dotmed_activeFilterSelectedValue)) {

              
                wc.iAND(Vw_equipment_inventoryView.dotmed_active, BaseFilter.ComparisonOperator.EqualsTo, dotmed_activeFilterSelectedValue, false, false);
      ...
      String make_idFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "make_idFilter_Ajax"];
            if (MiscUtils.IsValueSelected(make_idFilterSelectedValue)) {
                ...
                wc.iAND(Vw_equipment_inventoryView.make_id, BaseFilter.ComparisonOperator.EqualsTo, make_idFilterSelectedValue, false, false);
      ...
      String model_idFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "model_idFilter_Ajax"];
            if (MiscUtils.IsValueSelected(model_idFilterSelectedValue)) {
                ...
                wc.iAND(Vw_equipment_inventoryView.model_id, BaseFilter.ComparisonOperator.EqualsTo, model_idFilterSelectedValue, false, false);
                      
      }
                      
      String oem_einFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "oem_einFilter_Ajax"];
            if (MiscUtils.IsValueSelected(oem_einFilterSelectedValue)) {

              
                wc.iAND(Vw_equipment_inventoryView.oem_ein, BaseFilter.ComparisonOperator.EqualsTo, oem_einFilterSelectedValue, false, false);
      ...
      String received_from_customer_idFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "received_from_customer_idFilter_Ajax"];
            if (MiscUtils.IsValueSelected(received_from_customer_idFilterSelectedValue)) {
                ...
                wc.iAND(Vw_equipment_inventoryView.received_from_customer_id, BaseFilter.ComparisonOperator.EqualsTo, received_from_customer_idFilterSelectedValue, false, false);
      ...
      String serial_numberFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "serial_numberFilter_Ajax"];
            if (MiscUtils.IsValueSelected(serial_numberFilterSelectedValue)) {
                ...
                wc.iAND(Vw_equipment_inventoryView.serial_number, BaseFilter.ComparisonOperator.EqualsTo, serial_numberFilterSelectedValue, false, false);
      ...
      String warehouse_idFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "warehouse_idFilter_Ajax"];
            if (MiscUtils.IsValueSelected(warehouse_idFilterSelectedValue)) {
                ...
                wc.iAND(Vw_equipment_inventoryView.warehouse_id, BaseFilter.ComparisonOperator.EqualsTo, warehouse_idFilterSelectedValue, false, false);
      ...
      String warehouse_location_idFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "warehouse_location_idFilter_Ajax"];
            if (MiscUtils.IsValueSelected(warehouse_location_idFilterSelectedValue)) {
                ...
                wc.iAND(Vw_equipment_inventoryView.warehouse_location_id, BaseFilter.ComparisonOperator.EqualsTo, warehouse_location_idFilterSelectedValue, false, false);
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            if (EvaluateFormula("3", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Vw_equipment_inventoryView, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"vw_equipment_inventory_.disposition_id"), EvaluateFormula("3", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
      ...
      Vw_equipment_inventoryRecord rec = new Vw_equipment_inventoryRecord();
        ...
        public virtual void Setcategory_idLabel1()
                  {
                      ...
                      //Code for the text property is generated inside the .aspx file. 
                      //To override this property you can uncomment the following property and add you own value.
                      //this.category_idLabel1.Text = "Some value";
        ...
        public virtual void Setdotmed_activeLabel()
                  {
        ...
        public virtual void Setequipment_inventory_pic1Label()
                  {
                      ...
                      //Code for the text property is generated inside the .aspx file. 
                      //To override this property you can uncomment the following property and add you own value.
                      //this.equipment_inventory_pic1Label.Text = "Some value";
        ...
        public virtual void Setdotmed_activeFilter()
        {
            
            this.Populatedotmed_activeFilter(MiscUtils.GetSelectedValue(this.dotmed_activeFilter,  GetFromSession(this.dotmed_activeFilter)), 500);					
                    ...
                    
        {
            ...
            Vw_equipment_inventoryRecord[] itemValues  = null;
            if (wc.RunQuery)
            {
                int counter = 0;
                int pageNum = 0;
                ...
                do
                {
                    ...
                    itemValues = Vw_equipment_inventoryView.GetRecords(wc, orderBy, pageNum, maxItems);
                                    
                    foreach (Vw_equipment_inventoryRecord itemValue in itemValues) 
                    {
                    ...
                    
        {
            ...
            OrderBy orderBy = new OrderBy(false, false);
            orderBy.Add(Vw_equipment_inventoryView.condition_id, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = Vw_equipment_inventoryView.GetValues(Vw_equipment_inventoryView.condition_id, wc, orderBy, maxItems);
            ...
            // Create the item and add to the list.
            string fvalue;
            if ( Vw_equipment_inventoryView.condition_id.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = Vw_equipment_inventoryView.condition_id.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
        ...
        // Get the filters' data for dotmed_activeFilter.
                
        protected virtual void Populatedotmed_activeFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.dotmed_activeFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_dotmed_activeFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_dotmed_activeFilter function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.dotmed_activeFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
              
            OrderBy orderBy = new OrderBy(false, false);
                          orderBy.Add(Vw_equipment_inventoryView.dotmed_active, OrderByItem.OrderDir.Asc);
            ...
            if (wc.RunQuery)
            {
                ...
                do
                {
                    ...
                    foreach (Vw_equipment_inventoryRecord itemValue in itemValues) 
                    {
                        ...
                        string cvalue = null;
                        string fvalue = null;
                        if (itemValue.dotmed_activeSpecified) 
                        {
                            cvalue = itemValue.dotmed_active.ToString();
                            if (counter < maxItems && this.dotmed_activeFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                variables.Add(itemValue.TableAccess.TableDefinition.TableCodeName, itemValue);
                                fvalue = EvaluateFormula("dotmed_active", itemValue , variables, evaluator);
                                ...
                                ListItem dupItem = this.dotmed_activeFilter.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.dotmed_activeFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.dotmed_activeFilter, selectedValue);
            ...
            if (this.dotmed_activeFilter.SelectedValue != null && this.dotmed_activeFilter.Items.FindByValue(this.dotmed_activeFilter.SelectedValue) == null)
                this.dotmed_activeFilter.SelectedValue = null;
                    ...
                    
        {
            ...
            OrderBy orderBy = new OrderBy(false, false);
                          orderBy.Add(Vw_equipment_inventoryView.make_id, OrderByItem.OrderDir.Asc);
                    ...
                    
        {
            ...
            OrderBy orderBy = new OrderBy(false, false);
                          orderBy.Add(Vw_equipment_inventoryView.model_id, OrderByItem.OrderDir.Asc);
                    ...
                    foreach (CustomersRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.CustNoSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.received_from_customer_idFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                Boolean _isExpandableNonCompositeForeignKey = Vw_equipment_inventoryView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Vw_equipment_inventoryView.received_from_customer_id);
                                if(_isExpandableNonCompositeForeignKey && Vw_equipment_inventoryView.received_from_customer_id.IsApplyDisplayAs)
                                     fvalue = Vw_equipment_inventoryView.GetDFKA(itemValue, Vw_equipment_inventoryView.received_from_customer_id);
                    ...
                    foreach (WarehouseRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.warehouse_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.warehouse_idFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                Boolean _isExpandableNonCompositeForeignKey = Vw_equipment_inventoryView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Vw_equipment_inventoryView.warehouse_id);
                                if(_isExpandableNonCompositeForeignKey && Vw_equipment_inventoryView.warehouse_id.IsApplyDisplayAs)
                                     fvalue = Vw_equipment_inventoryView.GetDFKA(itemValue, Vw_equipment_inventoryView.warehouse_id);
                                if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
                    ...
                    foreach (Warehouse_locationRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.warehouse_location_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.warehouse_location_idFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                Boolean _isExpandableNonCompositeForeignKey = Vw_equipment_inventoryView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Vw_equipment_inventoryView.warehouse_location_id);
                                if(_isExpandableNonCompositeForeignKey && Vw_equipment_inventoryView.warehouse_location_id.IsApplyDisplayAs)
                                     fvalue = Vw_equipment_inventoryView.GetDFKA(itemValue, Vw_equipment_inventoryView.warehouse_location_id);
                                if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
        ...
        public virtual WhereClause CreateWhereClause_dotmed_activeFilter()
        {
            // Create a where clause for the filter dotmed_activeFilter.
            // This function is called by the Populate method to load the items 
            // in the dotmed_activeFilterDropDownList
        CompoundFilter filter = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
            WhereClause whereClause = new WhereClause();
            
            filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Vw_equipment_inventoryView, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"vw_equipment_inventory_.dotmed_active"), null, BaseClasses.Data.BaseFilter.ComparisonOperator.Not_Equals, false));
        ...
        CompoundFilter filter = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
            ...
            filter.AddFilter(new BaseClasses.Data.ColumnJoinFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Vw_equipment_inventoryView, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"vw_equipment_inventory_.model_id"), new BaseClasses.Data.IdentifierAliasInfo(@"vw_equipment_inventory_", null), BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.MakesModelsTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"MakesModels_.Model"), new BaseClasses.Data.IdentifierAliasInfo(@"MakesModels_", null),  BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
            if (EvaluateFormula("Vw_equipment_inventoryTableControl.make_idFilter.SelectedValue", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.MakesModelsTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"MakesModels_.Make"), EvaluateFormula("Vw_equipment_inventoryTableControl.make_idFilter.SelectedValue", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("Vw_equipment_inventoryTableControl.make_idFilter.SelectedValue", false) == "--PLEASE_SELECT--" || EvaluateFormula("Vw_equipment_inventoryTableControl.make_idFilter.SelectedValue", false) == "--ANY--") whereClause.RunQuery = false;
        ...
        CompoundFilter filter = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
            ...
            if (EvaluateFormula("Vw_equipment_inventoryTableControl.warehouse_idFilter.SelectedValue", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Warehouse_locationTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"warehouse_location_.warehouse_id"), EvaluateFormula("Vw_equipment_inventoryTableControl.warehouse_idFilter.SelectedValue", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("1", false) == "--PLEASE_SELECT--" || EvaluateFormula("1", false) == "--ANY--") whereClause.RunQuery = false;
         if (EvaluateFormula("Vw_equipment_inventoryTableControl.warehouse_idFilter.SelectedValue", false) == "--PLEASE_SELECT--" || EvaluateFormula("Vw_equipment_inventoryTableControl.warehouse_idFilter.SelectedValue", false) == "--ANY--") whereClause.RunQuery = false;
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.dotmed_activeFilter, this.dotmed_activeFilter.SelectedValue);
            ...
            this.SaveToSession(this.oem_einFilter, this.oem_einFilter.Text);
                  
            this.SaveToSession(this.received_from_customer_idFilter, this.received_from_customer_idFilter.SelectedValue);
                  
            this.SaveToSession(this.serial_numberFilter, this.serial_numberFilter.Text);
      ...
      this.SaveToSession("dotmed_activeFilter_Ajax", this.dotmed_activeFilter.SelectedValue);
      ...
      this.SaveToSession("oem_einFilter_Ajax", this.oem_einFilter.Text);
              
      this.SaveToSession("received_from_customer_idFilter_Ajax", this.received_from_customer_idFilter.SelectedValue);
              
      this.SaveToSession("serial_numberFilter_Ajax", this.serial_numberFilter.Text);
      ...
      this.SaveToSession("warehouse_location_idFilter_Ajax", this.warehouse_location_idFilter.SelectedValue);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.dotmed_activeFilter);
            this.RemoveFromSession(this.make_idFilter);
            this.RemoveFromSession(this.model_idFilter);
            this.RemoveFromSession(this.oem_einFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(dotmed_activeFilter))
                themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
            ...
            if (MiscUtils.IsValueSelected(oem_einFilter))
                themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Vw-equipment-inventory-Table-Img.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vw_equipment_inventory";
                // If Show-Vw-equipment-inventory-Table-Img.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Vw-equipment-inventory-Table-Img.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vw_equipment_inventory";
                // If Show-Vw-equipment-inventory-Table-Img.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        public virtual void LinkButton_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../vw_equipment_inventory/Show-Vw-equipment-inventory-Table.aspx";
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for FieldFilter
        protected virtual void dotmed_activeFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList dotmed_activeFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "dotmed_activeFilter");
            }
        }
        
        public System.Web.UI.WebControls.Literal dotmed_activeLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "dotmed_activeLabel");
            }
        }
        ...
        public System.Web.UI.WebControls.TextBox oem_einFilter {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "oem_einFilter");
            }
        }
        ...
        public System.Web.UI.WebControls.TextBox serial_numberFilter {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "serial_numberFilter");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual Vw_equipment_inventoryTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Vw_equipment_inventoryTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Vw_equipment_inventory_Table_Img.Vw_equipment_inventoryTableControlRow")));
