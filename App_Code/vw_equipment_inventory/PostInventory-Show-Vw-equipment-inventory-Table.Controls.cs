...
// PostInventory_Show_Vw_equipment_inventory_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.PostInventory_Show_Vw_equipment_inventory_Table
{
...
// Base class for the Vw_equipment_inventoryTableControlRow control on the PostInventory_Show_Vw_equipment_inventory_Table page.
...
// Base class for the Vw_equipment_inventoryTableControl control on the PostInventory_Show_Vw_equipment_inventory_Table page.
    ...
    public virtual void AddWarningMessageOnClick() {
      ...
      String warehouse_location_idFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "warehouse_location_idFilter_Ajax"];
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            if (EvaluateFormula("4", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Vw_equipment_inventoryView, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"vw_equipment_inventory_.disposition_id"), EvaluateFormula("4", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
      ...
      Vw_equipment_inventoryRecord rec = new Vw_equipment_inventoryRecord();
        ...
        public virtual void Setmake_idFilter()
        {
            ...
            this.Populatemake_idFilter(MiscUtils.GetSelectedValue(this.make_idFilter,  GetFromSession(this.make_idFilter)), 3000);					
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("PostInventory-Show-Vw-equipment-inventory-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vw_equipment_inventory";
                // If PostInventory-Show-Vw-equipment-inventory-Table.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("PostInventory-Show-Vw-equipment-inventory-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "vw_equipment_inventory";
                // If PostInventory-Show-Vw-equipment-inventory-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual Vw_equipment_inventoryTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Vw_equipment_inventoryTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.PostInventory_Show_Vw_equipment_inventory_Table.Vw_equipment_inventoryTableControlRow")));
