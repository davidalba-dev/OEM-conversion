...
// Add_Technicians.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Technicians
{
...
// Base class for the TechniciansRecordControl control on the Add_Technicians page.
...
public class BaseTechniciansRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (TechniciansRecord)TechniciansRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in TechniciansRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Technicians"];
            ...
            HttpContext.Current.Session["QueryString in Add-Technicians"] = recId;
