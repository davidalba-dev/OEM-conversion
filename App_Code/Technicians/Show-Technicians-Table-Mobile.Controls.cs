...
// Show_Technicians_Table_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Technicians_Table_Mobile
{
...
// Base class for the TechniciansTableControlRow control on the Show_Technicians_Table_Mobile page.
...
public class BaseTechniciansTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetTechName()
        {
            ...
            // Set the TechName Label on the webpage with value from the
            // DatabaseAYS_OEM%dbo.Technicians database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.Technicians record retrieved from the database.
            // this.TechName is the ASP:Label on the webpage.
      ...
      // To customize, override this method in TechniciansTableControlRow.
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../Technicians/Show-Technicians-Mobile.aspx?Technicians={PK}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Label TechName {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TechName");
            }
        }
...
// Base class for the TechniciansTableControl control on the Show_Technicians_Table_Mobile page.
...
public class BaseTechniciansTableControl : OEMConversion.UI.BaseApplicationTableControl
{
       ...
       public BaseTechniciansTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.TechNameFilter)) 				
                    initialVal = this.GetFromSession(this.TechNameFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"TechName\")");
                
                if (initialVal != null && initialVal != "")		
                {
                        
                    this.TechNameFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.TechNameFilter.SelectedValue = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.TechNameFilter.SelectedIndexChanged += new EventHandler(TechNameFilter_SelectedIndexChanged);
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep1 = (System.Web.UI.WebControls.Repeater)BaseClasses.Utils.MiscUtils.FindControlRecursively(rep.Items[PageIndex], "TechniciansTableControlRepeater1");
        ...
        public virtual void ResetControl()
        {
            ...
            this.TechNameFilter.ClearSelection();
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.SearchText, this.GetFromSession(this.SearchText)), true, false);
            ...
            if (MiscUtils.IsValueSelected(this.TechNameFilter)) {
                        
                wc.iAND(TechniciansTable.TechName, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.TechNameFilter, this.GetFromSession(this.TechNameFilter)), false, false);
      ...
      String TechNameFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "TechNameFilter_Ajax"];
            if (MiscUtils.IsValueSelected(TechNameFilterSelectedValue)) {

              
                wc.iAND(TechniciansTable.TechName, BaseFilter.ComparisonOperator.EqualsTo, TechNameFilterSelectedValue, false, false);
            ...
            foreach (TechniciansRecord rec in recordList ){
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, TechniciansTable.TechInitials.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (!this.ResetData)
            {
              ...
              TechniciansTableControlRow[] recControls = this.GetRecordControls();
                foreach (TechniciansTableControlRow recControl in recControls) 
		{
      ...
      TechniciansRecord rec = new TechniciansRecord();
        ...
        public virtual void SetTechNameFilter()
        {
            
            this.PopulateTechNameFilter(MiscUtils.GetSelectedValue(this.TechNameFilter,  GetFromSession(this.TechNameFilter)), 500);					
        ...
        // Get the filters' data for TechNameFilter.
                
        protected virtual void PopulateTechNameFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.TechNameFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_TechNameFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_TechNameFilter function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.TechNameFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
            ...
            if (wc.RunQuery)
            {
                ...
                values = TechniciansTable.GetValues(TechniciansTable.TechName, wc, orderBy, maxItems);
            ...
            string fvalue;
            if ( TechniciansTable.TechName.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = TechniciansTable.TechName.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
                ...
                ListItem dupItem = this.TechNameFilter.Items.FindByText(fvalue);
                ...
                this.TechNameFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.TechNameFilter, selectedValue);
            ...
            if (this.TechNameFilter.SelectedValue != null && this.TechNameFilter.Items.FindByValue(this.TechNameFilter.SelectedValue) == null)
                this.TechNameFilter.SelectedValue = null;
                           
        }
            
        public virtual WhereClause CreateWhereClause_TechNameFilter()
        {
            // Create a where clause for the filter TechNameFilter.
            // This function is called by the Populate method to load the items 
            // in the TechNameFilterDropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.TechNameFilter, this.TechNameFilter.SelectedValue);
      ...
      this.SaveToSession("TechNameFilter_Ajax", this.TechNameFilter.SelectedValue);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.TechNameFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void TechNameFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList TechNameFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TechNameFilter");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual TechniciansTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (TechniciansTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Technicians_Table_Mobile.TechniciansTableControlRow")));
