...
// Show_Technicians_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Technicians_Mobile
{
...
// Base class for the RepairOrdersTableControlRow control on the Show_Technicians_Mobile page.
...
// Base class for the RepairOrdersTableControl control on the Show_Technicians_Mobile page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Show_Technicians_Mobile.TechniciansRecordControl techniciansRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "TechniciansRecordControl") as OEMConversion.UI.Controls.Show_Technicians_Mobile.TechniciansRecordControl);
          
              if (techniciansRecordControlObj != null && techniciansRecordControlObj.GetRecord() != null && techniciansRecordControlObj.GetRecord().IsCreated && techniciansRecordControlObj.GetRecord().TechInitials != null)
              {
              wc.iAND(RepairOrdersTable.ROEstimatedBy, BaseFilter.ComparisonOperator.EqualsTo, techniciansRecordControlObj.GetRecord().TechInitials.ToString());
              selectedRecordKeyValue.AddElement(RepairOrdersTable.ROEstimatedBy.InternalName, techniciansRecordControlObj.GetRecord().TechInitials.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInTechniciansRecordControl = HttpContext.Current.Session["RepairOrdersTableControlWhereClause"] as string;
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Technicians_Mobile.RepairOrdersTableControlRow")));
...
// Base class for the TechniciansRecordControl control on the Show_Technicians_Mobile page.
...
public class BaseTechniciansRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in TechniciansRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-Technicians-Mobile"] = recId;
