...
// Show_Technicians_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Technicians_Table
{
...
// Base class for the TechniciansTableControlRow control on the Show_Technicians_Table page.
...
public class BaseTechniciansTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Settechnician_login_status()
        {
            
                    
            // Set the technician_login_status Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.Technicians database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.Technicians record retrieved from the database.
            // this.technician_login_status is the ASP:Literal on the webpage.
                  
            if (this.DataSource != null && this.DataSource.technician_login_statusSpecified) {
                								
                // If the technician_login_status is non-NULL, then format the value.
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(TechniciansTable.technician_login_status);
                                
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                this.technician_login_status.Text = formattedValue;
                   
            } 
            
            else {
            
                // technician_login_status is NULL in the database, so use the Default Value.  
                // Default Value could also be NULL.
        
              this.technician_login_status.Text = TechniciansTable.technician_login_status.Format(TechniciansTable.technician_login_status.DefaultValue);
        ...
        public virtual void Gettechnician_login_status()
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal technician_login_status {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "technician_login_status");
            }
        }
...
// Base class for the TechniciansTableControl control on the Show_Technicians_Table page.
...
public class BaseTechniciansTableControl : OEMConversion.UI.BaseApplicationTableControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            else
            {
                ...
                this.CurrentSortOrder.Add(TechniciansTable.TechName, OrderByItem.OrderDir.Asc);
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
              ...
              this.TechEmailLabel.Click += TechEmailLabel_Click;
            
              this.TechInitialsLabel.Click += TechInitialsLabel_Click;
            
              this.TechNameLabel.Click += TechNameLabel_Click;
            
              this.technician_activeLabel.Click += technician_activeLabel_Click;
            
              this.technician_login_statusLabel.Click += technician_login_statusLabel_Click;
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                Settechnician_login_statusLabel();
    ...
    public virtual void AddWarningMessageOnClick() {
      ...
      TechniciansRecord rec = new TechniciansRecord();
                        ...
                        if (recControl.technician_active.Text != "") {
                            rec.Parse(recControl.technician_active.Text, TechniciansTable.technician_active);
                  }
                
                        if (recControl.technician_login_status.Text != "") {
                            rec.Parse(recControl.technician_login_status.Text, TechniciansTable.technician_login_status);
                  }
        ...
        public virtual void Settechnician_login_statusLabel()
                  {
                  
                      //Code for the text property is generated inside the .aspx file. 
                      //To override this property you can uncomment the following property and add you own value.
                      //this.technician_login_statusLabel.Text = "Some value";
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void TechEmailLabel_Click(object sender, EventArgs args)
        {
            //Sorts by TechEmail when clicked.
              
            // Get previous sorting state for TechEmail.
        
            OrderByItem sd = this.CurrentSortOrder.Find(TechniciansTable.TechEmail);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for TechEmail.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(TechniciansTable.TechEmail, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by TechEmail, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void TechInitialsLabel_Click(object sender, EventArgs args)
        {
            //Sorts by TechInitials when clicked.
              
            // Get previous sorting state for TechInitials.
        
            OrderByItem sd = this.CurrentSortOrder.Find(TechniciansTable.TechInitials);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for TechInitials.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(TechniciansTable.TechInitials, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by TechInitials, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void TechNameLabel_Click(object sender, EventArgs args)
        {
            //Sorts by TechName when clicked.
              
            // Get previous sorting state for TechName.
        
            OrderByItem sd = this.CurrentSortOrder.Find(TechniciansTable.TechName);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for TechName.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(TechniciansTable.TechName, OrderByItem.OrderDir.Asc);
                ...
                // Previously sorted by TechName, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void technician_activeLabel_Click(object sender, EventArgs args)
        {
            //Sorts by technician_active when clicked.
              
            // Get previous sorting state for technician_active.
        
            OrderByItem sd = this.CurrentSortOrder.Find(TechniciansTable.technician_active);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for technician_active.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(TechniciansTable.technician_active, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by technician_active, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void technician_login_statusLabel_Click(object sender, EventArgs args)
        {
            //Sorts by technician_login_status when clicked.
              
            // Get previous sorting state for technician_login_status.
        
            OrderByItem sd = this.CurrentSortOrder.Find(TechniciansTable.technician_login_status);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for technician_login_status.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(TechniciansTable.technician_login_status, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by technician_login_status, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
             ...
             TechniciansTable.technician_active,
             TechniciansTable.technician_login_status,
             null};
             ...
             data.ColumnList.Add(new ExcelColumn(TechniciansTable.technician_active, "Default"));
             data.ColumnList.Add(new ExcelColumn(TechniciansTable.technician_login_status, "Default"));
        ...
        public virtual void NewButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../Technicians/Add-Technicians.aspx";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Technicians-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Technicians";
                // If Show-Technicians-Table.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 ...
                 report.AddColumn(TechniciansTable.technician_active.Name, ReportEnum.Align.Left, "${technician_active}", ReportEnum.Align.Left, 15);
                 report.AddColumn(TechniciansTable.technician_login_status.Name, ReportEnum.Align.Left, "${technician_login_status}", ReportEnum.Align.Left, 15);
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             report.AddData("${technician_active}", record.Format(TechniciansTable.technician_active), ReportEnum.Align.Left, 300);
                             report.AddData("${technician_login_status}", record.Format(TechniciansTable.technician_login_status), ReportEnum.Align.Left, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Technicians-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Technicians";
                // If Show-Technicians-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton TechEmailLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TechEmailLabel");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton TechInitialsLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TechInitialsLabel");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton TechNameLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TechNameLabel");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton technician_activeLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "technician_activeLabel");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton technician_login_statusLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "technician_login_statusLabel");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual TechniciansTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (TechniciansTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Technicians_Table.TechniciansTableControlRow")));
