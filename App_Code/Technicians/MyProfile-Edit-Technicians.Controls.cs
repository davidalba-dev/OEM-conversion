...
// MyProfile_Edit_Technicians.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.MyProfile_Edit_Technicians
{
...
// Base class for the LoginRecordControl control on the MyProfile_Edit_Technicians page.
...
public class BaseLoginRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
    ...
    OEMConversion.UI.Controls.MyProfile_Edit_Technicians.TechniciansRecordControl techniciansRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "TechniciansRecordControl") as OEMConversion.UI.Controls.MyProfile_Edit_Technicians.TechniciansRecordControl);
...
// Base class for the TechniciansRecordControl control on the MyProfile_Edit_Technicians page.
