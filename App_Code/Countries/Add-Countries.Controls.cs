...
// Add_Countries.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Countries
{
...
// Base class for the RepairOrdersTableControlRow control on the Add_Countries page.
...
// Base class for the RepairOrdersTableControl control on the Add_Countries page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Add_Countries.CountriesRecordControl countriesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "CountriesRecordControl") as OEMConversion.UI.Controls.Add_Countries.CountriesRecordControl);
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Add_Countries.RepairOrdersTableControlRow")));
...
// Base class for the CountriesRecordControl control on the Add_Countries page.
...
public class BaseCountriesRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in CountriesRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Add-Countries"] = recId;
