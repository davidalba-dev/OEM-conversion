...
// Show_Countries_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Countries_Table
{
...
// Base class for the CountriesTableControlRow control on the Show_Countries_Table page.
// Do not modify this class. Instead override any method in CountriesTableControlRow.
public class BaseCountriesTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetContinent()
        {
            ...
            // Set the Continent Literal on the webpage with value from the
            ...
            // this.Continent is the ASP:Literal on the webpage.
            ...
            // If the Continent is NULL or blank, then use the value specified  
            // on Properties.
            if (this.Continent.Text == null ||
                this.Continent.Text.Trim().Length == 0) {
        ...
        public virtual void SetCountry2()
        {
            ...
            // Set the Country2 Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.Countries database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.Countries record retrieved from the database.
            // this.Country2 is the ASP:Literal on the webpage.
            ...
            // If the Country2 is NULL or blank, then use the value specified  
            // on Properties.
            if (this.Country2.Text == null ||
                this.Country2.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.Country2.Text = "&nbsp;";
            }
        ...
        public virtual void SetPriority()
        {
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.Countries record retrieved from the database.
            // this.Priority is the ASP:Literal on the webpage.
            ...
            // on Properties.
            if (this.Priority.Text == null ||
                this.Priority.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.Priority.Text = "&nbsp;";
            }
      ...
      this.Page.CommitTransaction(sender);
        ...
        public virtual void EditRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../Countries/Edit-Countries.aspx?Countries={PK}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal Continent {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Continent");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal Country2 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Country2");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal Priority {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Priority");
            }
        }
...
// Base class for the CountriesTableControl control on the Show_Countries_Table page.
// Do not modify this class. Instead override any method in CountriesTableControl.
public class BaseCountriesTableControl : OEMConversion.UI.BaseApplicationTableControl
{
       ...
       public BaseCountriesTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.ContinentFilter)) 				
                    initialVal = this.GetFromSession(this.ContinentFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"Continent\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    string[] ContinentFilteritemListFromSession = initialVal.Split(',');
                    int index = 0;
                    foreach (string item in ContinentFilteritemListFromSession)
                    {
                        ...
                        {
                            this.ContinentFilter.Items.Add(item);
                            this.ContinentFilter.Items[index].Selected = true;
                            index += 1;
                        }
                    }
                    foreach (ListItem listItem in this.ContinentFilter.Items)
                    {
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.Country2Filter)) 				
                    initialVal = this.GetFromSession(this.Country2Filter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"Country2\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    string[] Country2FilteritemListFromSession = initialVal.Split(',');
                    int index = 0;
                    foreach (string item in Country2FilteritemListFromSession)
                    {
                        if (index == 0 && item.ToString().Equals(""))
                        {
                            // do nothing
                        ...
                        {
                            this.Country2Filter.Items.Add(item);
                            this.Country2Filter.Items[index].Selected = true;
                            index += 1;
                        }
                    }
                    foreach (ListItem listItem in this.Country2Filter.Items)
                    {
                        listItem.Selected = true;
                    }
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.OrderSort.SelectedIndexChanged += new EventHandler(OrderSort_SelectedIndexChanged);
              ...
              this.ContinentFilter.SelectedIndexChanged += ContinentFilter_SelectedIndexChanged;                  
                
              this.Country2Filter.SelectedIndexChanged += Country2Filter_SelectedIndexChanged;                  
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(OEMConversion.Business.CountriesRecord);
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public virtual void ResetControl()
        {
            ...
            this.ContinentFilter.ClearSelection();
            
            this.Country2Filter.ClearSelection();
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.ContinentFilter)) {
                        
                int selectedItemCount = 0;
                foreach (ListItem item in this.ContinentFilter.Items){
                    if (item.Selected) {
                        selectedItemCount += 1;
                ...
                foreach (ListItem item in this.ContinentFilter.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(CountriesTable.Continent, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
            ...
            if (MiscUtils.IsValueSelected(this.Country2Filter)) {
                        
                int selectedItemCount = 0;
                foreach (ListItem item in this.Country2Filter.Items){
                    if (item.Selected) {
                        selectedItemCount += 1;
                ...
                foreach (ListItem item in this.Country2Filter.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(CountriesTable.Country2, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
      ...
      cols.Add(CountriesTable.Continent, true);
      
      cols.Add(CountriesTable.Country, true);
      
      cols.Add(CountriesTable.Country2, true);
      ...
      String ContinentFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "ContinentFilter_Ajax"];
            if (MiscUtils.IsValueSelected(ContinentFilterSelectedValue)) {

              
        if (ContinentFilterSelectedValue != null){
                        string[] ContinentFilteritemListFromSession = ContinentFilterSelectedValue.Split(',');
                        int index = 0;
                        WhereClause filter = new WhereClause();
                        foreach (string item in ContinentFilteritemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(CountriesTable.Continent, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
      ...
      String Country2FilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "Country2Filter_Ajax"];
            if (MiscUtils.IsValueSelected(Country2FilterSelectedValue)) {

              
        if (Country2FilterSelectedValue != null){
                        string[] Country2FilteritemListFromSession = Country2FilterSelectedValue.Split(',');
                        int index = 0;
                        WhereClause filter = new WhereClause();
                        foreach (string item in Country2FilteritemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(CountriesTable.Country2, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_SearchText(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            OEMConversion.Business.CountriesRecord[] recordList  = CountriesTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            ...
            foreach (CountriesRecord rec in recordList ){
                ...
                resultItem = rec.Format(CountriesTable.Continent);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(CountriesTable.Continent.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, CountriesTable.Continent.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, CountriesTable.Country.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                resultItem = rec.Format(CountriesTable.Country2);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(CountriesTable.Country2.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, CountriesTable.Country2.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
      ...
      CountriesRecord rec = new CountriesRecord();
                        ...
                        if (recControl.Continent.Text != "") {
                            rec.Parse(recControl.Continent.Text, CountriesTable.Continent);
                  }
                        ...
                        if (recControl.Country2.Text != "") {
                            rec.Parse(recControl.Country2.Text, CountriesTable.Country2);
                  }
                
                        if (recControl.Priority.Text != "") {
                            rec.Parse(recControl.Priority.Text, CountriesTable.Priority);
                  }
                
                        if (recControl.Region.Text != "") {
                            rec.Parse(recControl.Region.Text, CountriesTable.Region);
                  }
        ...
        public virtual void SetContinentLabel1()
                  {
                  
                    
        }
                
        public virtual void SetCountry2Label1()
                  {
        ...
        public virtual void SetContinentFilter()
        {
            
            ArrayList ContinentFilterselectedFilterItemList = new ArrayList();
            string ContinentFilteritemsString = null;
            if (this.InSession(this.ContinentFilter))
                ContinentFilteritemsString = this.GetFromSession(this.ContinentFilter);
            
            if (ContinentFilteritemsString != null)
            {
                string[] ContinentFilteritemListFromSession = ContinentFilteritemsString.Split(',');
                foreach (string item in ContinentFilteritemListFromSession)
                {
                    ContinentFilterselectedFilterItemList.Add(item);
                }
            }
              
            			
            this.PopulateContinentFilter(MiscUtils.GetSelectedValueList(this.ContinentFilter, ContinentFilterselectedFilterItemList), 500);
                    
              string url = this.ModifyRedirectUrl("../Countries/Countries-QuickSelector.aspx", "", true);
              
              url = this.Page.ModifyRedirectUrl(url, "", true);                                  
              
              url += "?Target=" + this.ContinentFilter.ClientID + "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("Continent")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--ANY--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:All")) + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.ContinentFilter.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(ContinentFilter.AutoPostBack).ToLower() + ", event); return false;";
                  
                             
        }
            
        public virtual void SetCountry2Filter()
        {
            
            ArrayList Country2FilterselectedFilterItemList = new ArrayList();
            string Country2FilteritemsString = null;
            if (this.InSession(this.Country2Filter))
                Country2FilteritemsString = this.GetFromSession(this.Country2Filter);
            
            if (Country2FilteritemsString != null)
            {
                string[] Country2FilteritemListFromSession = Country2FilteritemsString.Split(',');
                foreach (string item in Country2FilteritemListFromSession)
                {
                    Country2FilterselectedFilterItemList.Add(item);
                }
            }
              
            			
            this.PopulateCountry2Filter(MiscUtils.GetSelectedValueList(this.Country2Filter, Country2FilterselectedFilterItemList), 500);
                    
              string url = this.ModifyRedirectUrl("../Countries/Countries-QuickSelector.aspx", "", true);
              
              url = this.Page.ModifyRedirectUrl(url, "", true);                                  
              
              url += "?Target=" + this.Country2Filter.ClientID + "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("Country2")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--ANY--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:All")) + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.Country2Filter.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(Country2Filter.AutoPostBack).ToLower() + ", event); return false;";
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Continent {Txt:Ascending}"), "Continent Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Continent {Txt:Descending}"), "Continent Desc"));
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Country 2 {Txt:Ascending}"), "Country2 Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Country 2 {Txt:Descending}"), "Country2 Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Priority {Txt:Ascending}"), "Priority Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Priority {Txt:Descending}"), "Priority Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Region {Txt:Ascending}"), "Region Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Region {Txt:Descending}"), "Region Desc"));
        ...
        // Get the filters' data for ContinentFilter.
                
        protected virtual void PopulateContinentFilter(ArrayList selectedValue, int maxItems)
                    
        {
            ...
            WhereClause wc = this.CreateWhereClause_ContinentFilter();            
            this.ContinentFilter.Items.Clear();
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_ContinentFilter function.
            // It is better to customize the where clause there.
             
            
            
            OrderBy orderBy = new OrderBy(false, false);
            orderBy.Add(CountriesTable.Continent, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = CountriesTable.GetValues(CountriesTable.Continent, wc, orderBy, maxItems);
            ...
            string fvalue;
            if ( CountriesTable.Continent.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = CountriesTable.Continent.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
                ...
                ListItem dupItem = this.ContinentFilter.Items.FindByText(fvalue);
                ...
                this.ContinentFilter.Items.Add(newItem);
            ...
            this.ContinentFilter.SetFieldMaxLength(50);
                                 
                  
            // Add the selected value.
            if (this.ContinentFilter.Items.Count == 0)
                this.ContinentFilter.Items.Add(new ListItem(Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
        ...
        // Get the filters' data for Country2Filter.
                
        protected virtual void PopulateCountry2Filter(ArrayList selectedValue, int maxItems)
                    
        {
            ...
            WhereClause wc = this.CreateWhereClause_Country2Filter();            
            this.Country2Filter.Items.Clear();
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_Country2Filter function.
            // It is better to customize the where clause there.
             
            
            
            OrderBy orderBy = new OrderBy(false, false);
            orderBy.Add(CountriesTable.Country2, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = CountriesTable.GetValues(CountriesTable.Country2, wc, orderBy, maxItems);
            ...
            // Create the item and add to the list.
            string fvalue;
            if ( CountriesTable.Country2.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = CountriesTable.Country2.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
                ...
                ListItem dupItem = this.Country2Filter.Items.FindByText(fvalue);
                ...
                ListItem newItem = new ListItem(fvalue, cvalue);
                this.Country2Filter.Items.Add(newItem);
            ...
            this.Country2Filter.SetFieldMaxLength(50);
                                 
                  
            // Add the selected value.
            if (this.Country2Filter.Items.Count == 0)
                this.Country2Filter.Items.Add(new ListItem(Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
        ...
        public virtual WhereClause CreateWhereClause_ContinentFilter()
        {
            // Create a where clause for the filter ContinentFilter.
            // This function is called by the Populate method to load the items 
            // in the ContinentFilterQuickSelector
            ...
            ContinentFilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.ContinentFilter, ContinentFilterselectedFilterItemList); 
            WhereClause wc = new WhereClause();
            if (ContinentFilterselectedFilterItemList == null || ContinentFilterselectedFilterItemList.Count == 0)
                wc.RunQuery = false;
            else            
            {
                foreach (string item in ContinentFilterselectedFilterItemList)
                {
            
      
   
                    wc.iOR(CountriesTable.Continent, BaseFilter.ComparisonOperator.EqualsTo, item);
        ...
        public virtual WhereClause CreateWhereClause_Country2Filter()
        {
            // Create a where clause for the filter Country2Filter.
            // This function is called by the Populate method to load the items 
            // in the Country2FilterQuickSelector
            ...
            Country2FilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.Country2Filter, Country2FilterselectedFilterItemList); 
            WhereClause wc = new WhereClause();
            if (Country2FilterselectedFilterItemList == null || Country2FilterselectedFilterItemList.Count == 0)
                wc.RunQuery = false;
            else            
            {
                foreach (string item in Country2FilterselectedFilterItemList)
                {
            
      
   
                    wc.iOR(CountriesTable.Country2, BaseFilter.ComparisonOperator.EqualsTo, item);
        ...
        protected override void SaveControlsToSession()
        {
            ...
            ArrayList ContinentFilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.ContinentFilter, null);
            string ContinentFilterSessionString = "";
            if (ContinentFilterselectedFilterItemList != null){
                foreach (string item in ContinentFilterselectedFilterItemList){
                    ContinentFilterSessionString = String.Concat(ContinentFilterSessionString ,"," , item);
                }
            }
            this.SaveToSession(this.ContinentFilter, ContinentFilterSessionString);
                  
            ArrayList Country2FilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.Country2Filter, null);
            string Country2FilterSessionString = "";
            if (Country2FilterselectedFilterItemList != null){
                foreach (string item in Country2FilterselectedFilterItemList){
                    Country2FilterSessionString = String.Concat(Country2FilterSessionString ,"," , item);
                }
            }
            this.SaveToSession(this.Country2Filter, Country2FilterSessionString);
        ...
        protected  void SaveControlsToSession_Ajax()
        {
            ...
            this.SaveToSession("ContinentFilter_Ajax", ContinentFilterSessionString);
            ...
            this.SaveToSession("Country2Filter_Ajax", Country2FilterSessionString);
      ...
      this.SaveToSession("SearchText_Ajax", this.SearchText.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.ContinentFilter);
            this.RemoveFromSession(this.Country2Filter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                    string url = "../Countries/Add-Countries.aspx?TabVisible=False&SaveAndNewVisible=False";
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "CountriesTableControl_PostbackTracker").ClientID);                           
                                
                string javascriptCall = "";
                
                    javascriptCall = "initializePopupPage(document.getElementById('" + MiscUtils.FindControlRecursively(this, "CountriesTableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(ContinentFilter))
                themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        
            if (MiscUtils.IsValueSelected(Country2Filter))
                themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              if (this.TotalRecords > 10000)
              {
                ...
                BaseColumn[] columns = new BaseColumn[] {
                             CountriesTable.Continent,
             CountriesTable.Country,
             CountriesTable.Country2,
             CountriesTable.Priority,
             CountriesTable.Region,
             null};
              ...
              DataForExport data = new DataForExport(CountriesTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(CountriesTable.Continent, "Default"));
             data.ColumnList.Add(new ExcelColumn(CountriesTable.Country, "Default"));
             data.ColumnList.Add(new ExcelColumn(CountriesTable.Country2, "Default"));
             data.ColumnList.Add(new ExcelColumn(CountriesTable.Priority, "0"));
             data.ColumnList.Add(new ExcelColumn(CountriesTable.Region, "Default"));
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Countries-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Countries";
                // If Show-Countries-Table.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(CountriesTable.Continent.Name, ReportEnum.Align.Left, "${Continent}", ReportEnum.Align.Left, 17);
                 report.AddColumn(CountriesTable.Country.Name, ReportEnum.Align.Left, "${Country}", ReportEnum.Align.Left, 28);
                 report.AddColumn(CountriesTable.Country2.Name, ReportEnum.Align.Left, "${Country2}", ReportEnum.Align.Left, 28);
                 report.AddColumn(CountriesTable.Priority.Name, ReportEnum.Align.Right, "${Priority}", ReportEnum.Align.Right, 15);
                 report.AddColumn(CountriesTable.Region.Name, ReportEnum.Align.Left, "${Region}", ReportEnum.Align.Left, 17);
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${Continent}", record.Format(CountriesTable.Continent), ReportEnum.Align.Left, 300);
                             report.AddData("${Country}", record.Format(CountriesTable.Country), ReportEnum.Align.Left, 300);
                             report.AddData("${Country2}", record.Format(CountriesTable.Country2), ReportEnum.Align.Left, 300);
                             report.AddData("${Priority}", record.Format(CountriesTable.Priority), ReportEnum.Align.Right, 300);
                             report.AddData("${Region}", record.Format(CountriesTable.Region), ReportEnum.Align.Left, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Countries-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Countries";
                // If Show-Countries-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        protected virtual void OrderSort_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in CountriesTable.GetColumns())
                  {
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(CountriesTable.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (CountriesTable.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && CountriesTable.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(CountriesTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(CountriesTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
        ...
        protected virtual void ContinentFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
        ...
        // event handler for FieldFilter
        protected virtual void Country2Filter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector ContinentFilter {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ContinentFilter");
            }
        }              
        
        public System.Web.UI.WebControls.Literal ContinentLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ContinentLabel1");
            }
        }
        
        public BaseClasses.Web.UI.WebControls.QuickSelector Country2Filter {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Country2Filter");
            }
        }              
        
        public System.Web.UI.WebControls.Literal Country2Label1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Country2Label1");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual CountriesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (CountriesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Countries_Table.CountriesTableControlRow")));
