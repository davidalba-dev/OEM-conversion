...
// Show_Countries_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Countries_Mobile
{
...
// Base class for the RepairOrdersTableControlRow control on the Show_Countries_Mobile page.
...
// Base class for the RepairOrdersTableControl control on the Show_Countries_Mobile page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Show_Countries_Mobile.CountriesRecordControl countriesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "CountriesRecordControl") as OEMConversion.UI.Controls.Show_Countries_Mobile.CountriesRecordControl);
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Countries_Mobile.RepairOrdersTableControlRow")));
...
// Base class for the CountriesRecordControl control on the Show_Countries_Mobile page.
...
public class BaseCountriesRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in CountriesRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-Countries-Mobile"] = recId;
