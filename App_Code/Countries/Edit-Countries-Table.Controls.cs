...
// Edit_Countries_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Countries_Table
{
...
// Base class for the CountriesTableControlRow control on the Edit_Countries_Table page.
...
public class BaseCountriesTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetContinent()
        {
            ...
            if (this.PreviousUIData.ContainsKey(this.Continent.ID))
            {
            
                this.Continent.Text = this.PreviousUIData[this.Continent.ID].ToString();
        ...
        public virtual void SetCountry2()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.Country2.ID))
            {
            
                this.Country2.Text = this.PreviousUIData[this.Country2.ID].ToString();
        ...
        public virtual void SetPriority()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.Priority.ID))
            {
            
                this.Priority.Text = this.PreviousUIData[this.Priority.ID].ToString();
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../Countries/Show-Countries.aspx?Countries={PK}";
...
// Base class for the CountriesTableControl control on the Edit_Countries_Table page.
...
#region "Helper Functions"
        ...
        public virtual CountriesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (CountriesTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_Countries_Table.CountriesTableControlRow")));
