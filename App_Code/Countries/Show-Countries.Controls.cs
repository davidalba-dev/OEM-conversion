...
// Show_Countries.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Countries
{
...
// Base class for the RepairOrdersTableControlRow control on the Show_Countries page.
...
// Base class for the RepairOrdersTableControl control on the Show_Countries page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Show_Countries.CountriesRecordControl countriesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "CountriesRecordControl") as OEMConversion.UI.Controls.Show_Countries.CountriesRecordControl);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                    string url = "../RepairOrders/Add-RepairOrders.aspx?ROCountry={CountriesRecordControl:FV:Country}&TabVisible=False&SaveAndNewVisible=False";
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Countries.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RepairOrders";
                // If Show-Countries.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Countries.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RepairOrders";
                // If Show-Countries.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Countries.RepairOrdersTableControlRow")));
...
// Base class for the CountriesRecordControl control on the Show_Countries page.
...
public class BaseCountriesRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in CountriesRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-Countries"] = recId;
