...
// Show_Countries_Table_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Countries_Table_Mobile
{
...
// Base class for the CountriesTableControlRow control on the Show_Countries_Table_Mobile page.
...
public class BaseCountriesTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetContinent()
        {
            ...
            // Set the Continent Label on the webpage with value from the
            ...
            // this.Continent is the ASP:Label on the webpage.
      ...
      // To customize, override this method in CountriesTableControlRow.
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../Countries/Show-Countries-Mobile.aspx?Countries={PK}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Label Continent {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Continent");
            }
        }
...
// Base class for the CountriesTableControl control on the Show_Countries_Table_Mobile page.
...
public class BaseCountriesTableControl : OEMConversion.UI.BaseApplicationTableControl
{
           ...
           // Setup the filter and search.
            ...
            if (!this.Page.IsPostBack)
            {
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.ContinentFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.ContinentFilter.SelectedValue = initialVal;
            ...
            if (!this.Page.IsPostBack)
            {
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.Country2Filter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.Country2Filter.SelectedValue = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.ContinentFilter.SelectedIndexChanged += new EventHandler(ContinentFilter_SelectedIndexChanged);
            
            this.Country2Filter.SelectedIndexChanged += new EventHandler(Country2Filter_SelectedIndexChanged);
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep1 = (System.Web.UI.WebControls.Repeater)BaseClasses.Utils.MiscUtils.FindControlRecursively(rep.Items[PageIndex], "CountriesTableControlRepeater1");
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.ContinentFilter)) {
                ...
                wc.iAND(CountriesTable.Continent, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.ContinentFilter, this.GetFromSession(this.ContinentFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.Country2Filter)) {
                        
                wc.iAND(CountriesTable.Country2, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.Country2Filter, this.GetFromSession(this.Country2Filter)), false, false);
      ...
      String ContinentFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "ContinentFilter_Ajax"];
            if (MiscUtils.IsValueSelected(ContinentFilterSelectedValue)) {
                ...
                wc.iAND(CountriesTable.Continent, BaseFilter.ComparisonOperator.EqualsTo, ContinentFilterSelectedValue, false, false);
      ...
      String Country2FilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "Country2Filter_Ajax"];
            if (MiscUtils.IsValueSelected(Country2FilterSelectedValue)) {
                ...
                wc.iAND(CountriesTable.Country2, BaseFilter.ComparisonOperator.EqualsTo, Country2FilterSelectedValue, false, false);
            ...
            foreach (CountriesRecord rec in recordList ){
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, CountriesTable.Continent.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, CountriesTable.Country.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, CountriesTable.Country2.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (!this.ResetData)
            {
              ...
              CountriesTableControlRow[] recControls = this.GetRecordControls();
                foreach (CountriesTableControlRow recControl in recControls) 
		{
      ...
      CountriesRecord rec = new CountriesRecord();
        ...
        public virtual void SetContinentFilter()
        {
            ...
            this.PopulateContinentFilter(MiscUtils.GetSelectedValue(this.ContinentFilter,  GetFromSession(this.ContinentFilter)), 500);					
        ...
        public virtual void SetCountry2Filter()
        {
            ...
            this.PopulateCountry2Filter(MiscUtils.GetSelectedValue(this.Country2Filter,  GetFromSession(this.Country2Filter)), 500);					
        ...
        protected virtual void PopulateContinentFilter(string selectedValue, int maxItems)
                    
        {
            ...
            // Setup the static list items        
                ...
                // Add the All item.
                this.ContinentFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.ContinentFilter, selectedValue);
            ...
            if (this.ContinentFilter.SelectedValue != null && this.ContinentFilter.Items.FindByValue(this.ContinentFilter.SelectedValue) == null)
                this.ContinentFilter.SelectedValue = null;
                           
        }
            
        // Get the filters' data for Country2Filter.
                
        protected virtual void PopulateCountry2Filter(string selectedValue, int maxItems)
                    
        {
            ...
            // Setup the static list items        
                ...
                // Add the All item.
                this.Country2Filter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.Country2Filter, selectedValue);
            ...
            if (this.Country2Filter.SelectedValue != null && this.Country2Filter.Items.FindByValue(this.Country2Filter.SelectedValue) == null)
                this.Country2Filter.SelectedValue = null;
        ...
        public virtual WhereClause CreateWhereClause_ContinentFilter()
        {
            ...
            // in the ContinentFilterDropDownList
        ...
        public virtual WhereClause CreateWhereClause_Country2Filter()
        {
            ...
            // This function is called by the Populate method to load the items 
            // in the Country2FilterDropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.ContinentFilter, this.ContinentFilter.SelectedValue);
                  
            this.SaveToSession(this.Country2Filter, this.Country2Filter.SelectedValue);
      ...
      this.SaveToSession("ContinentFilter_Ajax", this.ContinentFilter.SelectedValue);
              
      this.SaveToSession("Country2Filter_Ajax", this.Country2Filter.SelectedValue);
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList ContinentFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ContinentFilter");
            }
        }
        ...
        public System.Web.UI.WebControls.DropDownList Country2Filter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Country2Filter");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual CountriesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (CountriesTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Countries_Table_Mobile.CountriesTableControlRow")));
