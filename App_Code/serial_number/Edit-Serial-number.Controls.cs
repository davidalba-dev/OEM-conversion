...
// Edit_Serial_number.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Serial_number
{
...
// Base class for the Serial_numberRecordControl control on the Edit_Serial_number page.
...
public class BaseSerial_numberRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "Serial_numberRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            this.DataSource = Serial_numberTable.GetRecord(recList[0].GetID().ToXmlString(), true);
      ...
      // To customize, override this method in Serial_numberRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Serial_number"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "Serial_number"));
            }
            HttpContext.Current.Session["QueryString in Edit-Serial-number"] = recId;
