...
// Add_Serial_number_Popup.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Serial_number_Popup
{
...
// Base class for the Serial_numberRecordControl control on the Add_Serial_number_Popup page.
...
public class BaseSerial_numberRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setsite_inventory_id()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
              ...
              this.site_inventory_id.Text = EvaluateFormula("URL(\"site_inventory\")", this.DataSource);
      ...
      // To customize, override this method in Serial_numberRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Add-Serial-number-Popup"] = recId;
