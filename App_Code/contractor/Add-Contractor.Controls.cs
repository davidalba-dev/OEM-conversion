...
// Add_Contractor.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Contractor
{
...
// Base class for the ContractorRecordControl control on the Add_Contractor page.
...
public class BaseContractorRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (ContractorRecord)ContractorRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in ContractorRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Contractor"];
            ...
            HttpContext.Current.Session["QueryString in Add-Contractor"] = recId;
