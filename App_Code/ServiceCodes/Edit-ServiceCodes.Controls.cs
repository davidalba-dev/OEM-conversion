...
// Edit_ServiceCodes.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_ServiceCodes
{
...
// Base class for the ServiceCodesRecordControl control on the Edit_ServiceCodes page.
...
public class BaseServiceCodesRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in ServiceCodesRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Edit-ServiceCodes"] = recId;
