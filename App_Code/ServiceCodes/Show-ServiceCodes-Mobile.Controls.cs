...
// Show_ServiceCodes_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_ServiceCodes_Mobile
{
...
// Base class for the ServiceCodesRecordControl control on the Show_ServiceCodes_Mobile page.
...
public class BaseServiceCodesRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in ServiceCodesRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-ServiceCodes-Mobile"] = recId;
