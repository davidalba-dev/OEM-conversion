...
// Edit_Security_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Security_Table
{
...
// Base class for the SecurityTableControlRow control on the Edit_Security_Table page.
...
public class BaseSecurityTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.contact_id.SelectedIndexChanged += contact_id_SelectedIndexChanged;                  
              ...
              this.deptid.SelectedIndexChanged += deptid_SelectedIndexChanged;                  
        ...
        public virtual void Setcontact_id()
        {
            ...
            if (this.PreviousUIData.ContainsKey(this.contact_id.ID))
            {
                if (this.PreviousUIData[this.contact_id.ID] == null)
                    selectedValue = null;
                else
                    selectedValue = this.PreviousUIData[this.contact_id.ID].ToString();
            }
            
            
            // Set the contact_id QuickSelector on the webpage with value from the
            ...
            // this.contact_id is the ASP:QuickSelector on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.contact_idSpecified)
            {
                            
                // If the contact_id is non-NULL, then format the value.
                // The Format method will return the Display Foreign Key As (DFKA) value
                selectedValue = this.DataSource.contact_id.ToString();
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = SecurityTable.contact_id.DefaultValue;
                				
            }			
                
            // Add the Please Select item.
            if (selectedValue == null || selectedValue == "")
                  MiscUtils.ResetSelectedItem(this.contact_id, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "OEMConversion"), "--PLEASE_SELECT--"));
                        
                  
            // Populate the item(s) to the control
            
            this.contact_id.SetFieldMaxLength(50);
            ...
            if (selectedValue != null &&
                selectedValue.Trim() != "" &&
                !MiscUtils.SetSelectedValue(this.contact_id, selectedValue) &&
                !MiscUtils.SetSelectedDisplayText(this.contact_id, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        Boolean _isExpandableNonCompositeForeignKey = SecurityTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(SecurityTable.contact_id);
                        if(_isExpandableNonCompositeForeignKey && SecurityTable.contact_id.IsApplyDisplayAs)
                            fvalue = SecurityTable.GetDFKA(itemValue, SecurityTable.contact_id);
                        if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
                            fvalue = itemValue.Format(CustomerContactsTable.CustContactName);
                            					
                        if (fvalue == null || fvalue.Trim() == "") fvalue = cvalue;
                        MiscUtils.ResetSelectedItem(this.contact_id, new ListItem(fvalue, cvalue));                      
                    }
                }
                catch
                {
              ...
              url += "?Target=" + this.contact_id.ClientID + "&DFKA=" + (this.Page as BaseApplicationPage).Encrypt("CustContactName")+ "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("CustContactKey")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--PLEASE_SELECT--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:PleaseSelect"))+ "&Mode=" + (this.Page as BaseApplicationPage).Encrypt("FieldValueSingleSelection") + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.contact_id.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(contact_id.AutoPostBack).ToLower() + ", event); return false;";
                ...
                !MiscUtils.SetSelectedDisplayText(this.corporate_id, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        Boolean _isExpandableNonCompositeForeignKey = SecurityTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(SecurityTable.corporate_id);
                        if(_isExpandableNonCompositeForeignKey && SecurityTable.corporate_id.IsApplyDisplayAs)
                            fvalue = SecurityTable.GetDFKA(itemValue, SecurityTable.corporate_id);
                        if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
                ...
                !MiscUtils.SetSelectedDisplayText(this.custno, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        Boolean _isExpandableNonCompositeForeignKey = SecurityTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(SecurityTable.custno);
                        if(_isExpandableNonCompositeForeignKey && SecurityTable.custno.IsApplyDisplayAs)
                            fvalue = SecurityTable.GetDFKA(itemValue, SecurityTable.custno);
                        if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
              ...
              url += "?Target=" + this.custno.ClientID + "&DFKA=" + (this.Page as BaseApplicationPage).Encrypt("CustContactName")+ "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("CustNo")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--PLEASE_SELECT--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:PleaseSelect"))+ "&Mode=" + (this.Page as BaseApplicationPage).Encrypt("FieldValueSingleSelection") + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
        ...
        public virtual void Setdeptid()
        {
            ...
            // If selection was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.deptid.ID))
            {
                if (this.PreviousUIData[this.deptid.ID] == null)
                    selectedValue = null;
                else
                    selectedValue = this.PreviousUIData[this.deptid.ID].ToString();
            }
            
            
            // Set the deptid QuickSelector on the webpage with value from the
            // DatabaseAYS_OEM%dbo.security database record.
            
            // this.DataSource is the DatabaseAYS_OEM%dbo.security record retrieved from the database.
            // this.deptid is the ASP:QuickSelector on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.deptidSpecified)
            {
                            
                // If the deptid is non-NULL, then format the value.
                // The Format method will return the Display Foreign Key As (DFKA) value
                selectedValue = this.DataSource.deptid.ToString();
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = SecurityTable.deptid.DefaultValue;
                				
            }			
                
            // Add the Please Select item.
            if (selectedValue == null || selectedValue == "")
                  MiscUtils.ResetSelectedItem(this.deptid, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "OEMConversion"), "--PLEASE_SELECT--"));
                        
                  
            // Populate the item(s) to the control
            
            this.deptid.SetFieldMaxLength(50);
            ...
            if (selectedValue != null &&
                selectedValue.Trim() != "" &&
                !MiscUtils.SetSelectedValue(this.deptid, selectedValue) &&
                !MiscUtils.SetSelectedDisplayText(this.deptid, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        Boolean _isExpandableNonCompositeForeignKey = SecurityTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(SecurityTable.deptid);
                        if(_isExpandableNonCompositeForeignKey && SecurityTable.deptid.IsApplyDisplayAs)
                            fvalue = SecurityTable.GetDFKA(itemValue, SecurityTable.deptid);
                        if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
                            fvalue = itemValue.Format(DepartmentTable.department_name);
                            					
                        if (fvalue == null || fvalue.Trim() == "") fvalue = cvalue;
                        MiscUtils.ResetSelectedItem(this.deptid, new ListItem(fvalue, cvalue));                      
                    }
                }
                catch
                {
              ...
              string url = this.ModifyRedirectUrl("../department/Department-QuickSelector.aspx", "", true);
              
              url = this.Page.ModifyRedirectUrl(url, "", true);                                  
              
              url += "?Target=" + this.deptid.ClientID + "&DFKA=" + (this.Page as BaseApplicationPage).Encrypt("department_name")+ "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("department_id")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--PLEASE_SELECT--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:PleaseSelect"))+ "&Mode=" + (this.Page as BaseApplicationPage).Encrypt("FieldValueSingleSelection") + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.deptid.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(deptid.AutoPostBack).ToLower() + ", event); return false;";
        ...
        public virtual void SetdeptidLabel()
                  {
        ...
        {
         // Retrieve the value entered by the user on the contact_id ASP:QuickSelector, and
            // save it into the contact_id field in DataSource DatabaseAYS_OEM%dbo.security record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.contact_id), SecurityTable.contact_id);			
        ...
        public virtual void Getcustno()
        {
         // Retrieve the value entered by the user on the custno ASP:QuickSelector, and
            ...
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.custno), SecurityTable.custno);			
                			 
        }
                
        public virtual void Getdeptid()
        {
         // Retrieve the value entered by the user on the deptid ASP:QuickSelector, and
            // save it into the deptid field in DataSource DatabaseAYS_OEM%dbo.security record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.deptid), SecurityTable.deptid);			
      ...
      // To customize, override this method in SecurityTableControlRow.
        ...
        protected virtual void contact_id_SelectedIndexChanged(object sender, EventArgs args)
        {
        ...
        protected virtual void deptid_SelectedIndexChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector contact_id {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "contact_id");
            }
        }              
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector deptid {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "deptid");
            }
        }              
            
        public System.Web.UI.WebControls.Literal deptidLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "deptidLabel");
            }
        }
...
// Base class for the SecurityTableControl control on the Edit_Security_Table page.
       ...
       public BaseSecurityTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.contact_idFilter)) 				
                    initialVal = this.GetFromSession(this.contact_idFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"contact_id\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    string[] contact_idFilteritemListFromSession = initialVal.Split(',');
                    int index = 0;
                    foreach (string item in contact_idFilteritemListFromSession)
                    {
                        ...
                        {
                            this.contact_idFilter.Items.Add(item);
                            this.contact_idFilter.Items[index].Selected = true;
                            index += 1;
                        }
                    }
                    foreach (ListItem listItem in this.contact_idFilter.Items)
                    {
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.OrderSort.SelectedIndexChanged += new EventHandler(OrderSort_SelectedIndexChanged);
              ...
              this.contact_idFilter.SelectedIndexChanged += contact_idFilter_SelectedIndexChanged;                  
      ...
      public override void DataBind()
      {
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(SecurityTable.deptid, this.DataSource);
        }
        ...
        public virtual void ResetControl()
        {
            ...
            this.contact_idFilter.ClearSelection();
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.contact_idFilter)) {
                        
                int selectedItemCount = 0;
                foreach (ListItem item in this.contact_idFilter.Items){
                    if (item.Selected) {
                        selectedItemCount += 1;
                ...
                foreach (ListItem item in this.contact_idFilter.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(SecurityTable.contact_id, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
      ...
      cols.Add(SecurityTable.contact_id, true);
      ...
      String contact_idFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "contact_idFilter_Ajax"];
            if (MiscUtils.IsValueSelected(contact_idFilterSelectedValue)) {

              
        if (contact_idFilterSelectedValue != null){
                        string[] contact_idFilteritemListFromSession = contact_idFilterSelectedValue.Split(',');
                        int index = 0;
                        WhereClause filter = new WhereClause();
                        foreach (string item in contact_idFilteritemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(SecurityTable.contact_id, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_SearchText(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            OEMConversion.Business.SecurityRecord[] recordList  = SecurityTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (SecurityRecord rec in recordList ){
                ...
                resultItem = rec.Format(SecurityTable.contact_id);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(SecurityTable.contact_id.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, SecurityTable.contact_id.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
      ...
      SecurityRecord rec = new SecurityRecord();
                        ...
                        if (MiscUtils.IsValueSelected(recControl.contact_id)) {
                            rec.Parse(recControl.contact_id.SelectedItem.Value, SecurityTable.contact_id);
                        }
                        ...
                        if (MiscUtils.IsValueSelected(recControl.custno)) {
                            rec.Parse(recControl.custno.SelectedItem.Value, SecurityTable.custno);
                        }
                        if (MiscUtils.IsValueSelected(recControl.deptid)) {
                            rec.Parse(recControl.deptid.SelectedItem.Value, SecurityTable.deptid);
                        }
        ...
        public virtual void Setcontact_idLabel1()
                  {
        ...
        public virtual void Setcontact_idFilter()
        {
            
            ArrayList contact_idFilterselectedFilterItemList = new ArrayList();
            string contact_idFilteritemsString = null;
            if (this.InSession(this.contact_idFilter))
                contact_idFilteritemsString = this.GetFromSession(this.contact_idFilter);
            
            if (contact_idFilteritemsString != null)
            {
                string[] contact_idFilteritemListFromSession = contact_idFilteritemsString.Split(',');
                foreach (string item in contact_idFilteritemListFromSession)
                {
                    contact_idFilterselectedFilterItemList.Add(item);
                }
            }
              
            			
            this.Populatecontact_idFilter(MiscUtils.GetSelectedValueList(this.contact_idFilter, contact_idFilterselectedFilterItemList), 500);
                    
              string url = this.ModifyRedirectUrl("../CustomerContacts/CustomerContacts-QuickSelector.aspx", "", true);
              
              url = this.Page.ModifyRedirectUrl(url, "", true);                                  
              
              url += "?Target=" + this.contact_idFilter.ClientID + "&DFKA=" + (this.Page as BaseApplicationPage).Encrypt("CustContactName")+ "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("CustContactKey")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--ANY--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:All")) + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.contact_idFilter.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(contact_idFilter.AutoPostBack).ToLower() + ", event); return false;";
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Contact {Txt:Ascending}"), "contact_id Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Contact {Txt:Descending}"), "contact_id Desc"));
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Department {Txt:Ascending}"), "deptid Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Department {Txt:Descending}"), "deptid Desc"));
        ...
        // Get the filters' data for contact_idFilter.
                
        protected virtual void Populatecontact_idFilter(ArrayList selectedValue, int maxItems)
                    
        {
            ...
            WhereClause wc = this.CreateWhereClause_contact_idFilter();            
            this.contact_idFilter.Items.Clear();
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_contact_idFilter function.
            ...
            if (wc.RunQuery)
            {
                ...
                do
                {
                    ...
                    foreach (CustomerContactsRecord itemValue in itemValues) 
                    {
                        ...
                        {
                            cvalue = itemValue.CustContactKey.ToString();
                            if (counter < maxItems && this.contact_idFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                ListItem dupItem = this.contact_idFilter.Items.FindByText(fvalue);
                                ...
                                this.contact_idFilter.Items.Add(newItem);
            ...
            this.contact_idFilter.SetFieldMaxLength(50);
                                 
                  
            // Add the selected value.
            if (this.contact_idFilter.Items.Count == 0)
                this.contact_idFilter.Items.Add(new ListItem(Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
        ...
        public virtual WhereClause CreateWhereClause_contact_idFilter()
        {
            // Create a where clause for the filter contact_idFilter.
            // This function is called by the Populate method to load the items 
            // in the contact_idFilterQuickSelector
            ...
            contact_idFilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.contact_idFilter, contact_idFilterselectedFilterItemList); 
            WhereClause wc = new WhereClause();
            if (contact_idFilterselectedFilterItemList == null || contact_idFilterselectedFilterItemList.Count == 0)
                wc.RunQuery = false;
            else            
            {
                foreach (string item in contact_idFilterselectedFilterItemList)
                {
            	  
                    wc.iOR(CustomerContactsTable.CustContactKey, BaseFilter.ComparisonOperator.EqualsTo, item);                  
        ...
        protected override void SaveControlsToSession()
        {
            ...
            ArrayList contact_idFilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.contact_idFilter, null);
            string contact_idFilterSessionString = "";
            if (contact_idFilterselectedFilterItemList != null){
                foreach (string item in contact_idFilterselectedFilterItemList){
                    contact_idFilterSessionString = String.Concat(contact_idFilterSessionString ,"," , item);
                }
            }
            this.SaveToSession(this.contact_idFilter, contact_idFilterSessionString);
        ...
        protected  void SaveControlsToSession_Ajax()
        {
            ...
            this.SaveToSession("contact_idFilter_Ajax", contact_idFilterSessionString);
      ...
      this.SaveToSession("SearchText_Ajax", this.SearchText.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.contact_idFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(contact_idFilter))
        ...
        protected virtual void OrderSort_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in SecurityTable.GetColumns())
                  {
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(SecurityTable.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (SecurityTable.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && SecurityTable.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(SecurityTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(SecurityTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
        ...
        protected virtual void contact_idFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector contact_idFilter {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "contact_idFilter");
            }
        }              
        
        public System.Web.UI.WebControls.Literal contact_idLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "contact_idLabel1");
            }
        }
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (SecurityTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        SecurityTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual SecurityTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SecurityTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_Security_Table.SecurityTableControlRow")));
