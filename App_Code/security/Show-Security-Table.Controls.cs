...
// Show_Security_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Security_Table
{
...
// Base class for the SecurityTableControlRow control on the Show_Security_Table page.
...
public class BaseSecurityTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.contact_id.Click += contact_id_Click;
        ...
        public virtual void Setcontact_id()
        {
            ...
            // Set the contact_id LinkButton on the webpage with value from the
            ...
            // this.contact_id is the ASP:LinkButton on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.contact_idSpecified) {
               ...
               if(_isExpandableNonCompositeForeignKey &&SecurityTable.contact_id.IsApplyDisplayAs)
                     ...
                     formattedValue = SecurityTable.GetDFKA(this.DataSource.contact_id.ToString(),SecurityTable.contact_id, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(SecurityTable.contact_id);
                                  
                                
                this.contact_id.Text = formattedValue;
                
                  this.contact_id.ToolTip = "Go to " + this.contact_id.Text.Replace("<wbr/>", "");
        ...
        public virtual void Setcorporate_id()
        {
            ...
            if (this.DataSource != null && this.DataSource.corporate_idSpecified) {
               ...
               if(_isExpandableNonCompositeForeignKey &&SecurityTable.corporate_id.IsApplyDisplayAs)
                     ...
                     formattedValue = SecurityTable.GetDFKA(this.DataSource.corporate_id.ToString(),SecurityTable.corporate_id, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(SecurityTable.corporate_id);
              ...
              this.corporate_id.Text = SecurityTable.corporate_id.Format(SecurityTable.corporate_id.DefaultValue);
        ...
        public virtual void Setcustno()
        {
            ...
            if (this.DataSource != null && this.DataSource.custnoSpecified) {
               ...
               if(_isExpandableNonCompositeForeignKey &&SecurityTable.custno.IsApplyDisplayAs)
                     ...
                     formattedValue = SecurityTable.GetDFKA(this.DataSource.custno.ToString(),SecurityTable.custno, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(SecurityTable.custno);
              ...
              this.custno.Text = SecurityTable.custno.Format(SecurityTable.custno.DefaultValue);
        ...
        public virtual void Setdeptid()
        {
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.security record retrieved from the database.
            // this.deptid is the ASP:Literal on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.deptidSpecified) {
               ...
               if(_isExpandableNonCompositeForeignKey &&SecurityTable.deptid.IsApplyDisplayAs)
                     ...
                     formattedValue = SecurityTable.GetDFKA(this.DataSource.deptid.ToString(),SecurityTable.deptid, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(SecurityTable.deptid);
                                  
                                
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                this.deptid.Text = formattedValue;
              ...
              this.deptid.Text = SecurityTable.deptid.Format(SecurityTable.deptid.DefaultValue);
            		
            }
            
            // If the deptid is NULL or blank, then use the value specified  
            // on Properties.
            if (this.deptid.Text == null ||
                this.deptid.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.deptid.Text = "&nbsp;";
            }
      ...
      // To customize, override this method in SecurityTableControlRow.
        ...
        public virtual void contact_id_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../CustomerContacts/Show-CustomerContacts.aspx?CustomerContacts={SecurityTableControlRow:FK:FK_security_CustomerContacts}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void custno_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Customers/Show-Customers.aspx?Customers={SecurityTableControlRow:FK:FK_security_Customers}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton contact_id {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "contact_id");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal deptid {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "deptid");
            }
        }
...
// Base class for the SecurityTableControl control on the Show_Security_Table page.
    ...
    // Setup default pagination settings.
      ...
      SecurityRecord rec = new SecurityRecord();
                        ...
                        if (recControl.corporate_id.Text != "") {
                            rec.Parse(recControl.corporate_id.Text, SecurityTable.corporate_id);
                  }
                
                        if (recControl.custno.Text != "") {
                            rec.Parse(recControl.custno.Text, SecurityTable.custno);
                  }
                
                        if (recControl.deptid.Text != "") {
                            rec.Parse(recControl.deptid.Text, SecurityTable.deptid);
                  }
...
#region "Helper Functions"
        ...
        public virtual SecurityTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SecurityTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Security_Table.SecurityTableControlRow")));
