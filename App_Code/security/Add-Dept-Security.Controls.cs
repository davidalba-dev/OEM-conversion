...
// Add_Dept_Security.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Dept_Security
{
...
// Base class for the SecurityRecordControl control on the Add_Dept_Security page.
...
public class BaseSecurityRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (SecurityRecord)SecurityRecord.Copy(recList[0], false);
        ...
        public virtual void Setcontact_id()
        {
            ...
            // Set the contact_id DropDownList on the webpage with value from the
            ...
            // this.contact_id is the ASP:DropDownList on the webpage.
            ...
            else
            {
                ...
                selectedValue = EvaluateFormula("URL(\"contact_id\")");
            ...
            this.Populatecontact_idDropDownList(selectedValue, 100);              
        ...
        public virtual void Setdeptid()
        {
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.security record retrieved from the database.
            // this.deptid is the ASP:DropDownList on the webpage.
            ...
            else
            {
                ...
                selectedValue = EvaluateFormula("URL(\"deptid\")");
            ...
            this.PopulatedeptidDropDownList(selectedValue, 100);              
        ...
        {
         // Retrieve the value entered by the user on the contact_id ASP:DropDownList, and
      ...
      // To customize, override this method in SecurityRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Security"];
            ...
            HttpContext.Current.Session["QueryString in Add-Dept-Security"] = recId;
        ...
        public virtual WhereClause CreateWhereClause_contact_idDropDownList() 
        {
            ...
            if (EvaluateFormula("URL(\"CustomerContact\")", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.CustomerContactsTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"CustomerContacts_.CustContactKey"), EvaluateFormula("URL(\"CustomerContact\")", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("URL(\"CustomerContact\")", false) == "--PLEASE_SELECT--" || EvaluateFormula("URL(\"CustomerContact\")", false) == "--ANY--") whereClause.RunQuery = false;
        ...
        public virtual WhereClause CreateWhereClause_deptidDropDownList() 
        {
            // By default, we simply return a new WhereClause.
            // Add additional where clauses to restrict the items shown in the dropdown list.
            ...
            filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.DepartmentTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"department_.custno"), EvaluateFormula("URL(\"Custno\")", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
        ...
        // Fill the contact_id list.
        protected virtual void Populatecontact_idDropDownList(string selectedValue, int maxItems) 
        {
            		  					                
            this.contact_id.Items.Clear();
            
            // 1. Setup the static list items        
            		  			
            // 2. Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_contact_idDropDownList function.
            // It is better to customize the where clause there.
            
                      
            WhereClause wc = CreateWhereClause_contact_idDropDownList();
            ...
            // 3. Read a total of maxItems from the database and insert them into the contact_idDropDownList.
                ...
                do
                {
                    ...
                    foreach (CustomerContactsRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.CustContactKeySpecified) 
                        {
                            ...
                            if (counter < maxItems && this.contact_id.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                ListItem dupItem = this.contact_id.Items.FindByText(fvalue);
                                ...
                                this.contact_id.Items.Add(newItem);
        ...
        protected virtual void PopulatedeptidDropDownList(string selectedValue, int maxItems) 
        {
            		  					                
            this.deptid.Items.Clear();
            
            // 1. Setup the static list items        
            
              // Add the Please Select item.
              this.deptid.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "OEMConversion"), "--PLEASE_SELECT--"));
            		  			
            // 2. Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_deptidDropDownList function.
            // It is better to customize the where clause there.
            
                      
            WhereClause wc = CreateWhereClause_deptidDropDownList();
            ...
            // 3. Read a total of maxItems from the database and insert them into the deptidDropDownList.
                ...
                do
                {
                    ...
                    foreach (DepartmentRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.department_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.deptid.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                ListItem dupItem = this.deptid.Items.FindByText(fvalue);
        ...
        protected virtual void contact_id_SelectedIndexChanged(object sender, EventArgs args)
        {
            ...
            string val = (string)(this.Page.Session[contact_id.ClientID + "_SelectedValue"]);
            string displayText = (string)(this.Page.Session[contact_id.ClientID + "_SelectedDisplayText"]);
            if (!string.IsNullOrEmpty(displayText) && !string.IsNullOrEmpty(val)) {
	            this.contact_id.Items.Add(new ListItem(displayText, val));
	            this.contact_id.SelectedIndex = this.contact_id.Items.Count - 1;
	            this.Page.Session.Remove(contact_id.ClientID + "_SelectedValue");
	            this.Page.Session.Remove(contact_id.ClientID + "_SelectedDisplayText");
            }
        ...
        protected virtual void deptid_SelectedIndexChanged(object sender, EventArgs args)
        {
            // for the value inserted by quick add button or large list selector, 
            // the value is necessary to be inserted by this event during postback 
            string val = (string)(this.Page.Session[deptid.ClientID + "_SelectedValue"]);
            string displayText = (string)(this.Page.Session[deptid.ClientID + "_SelectedDisplayText"]);
            if (!string.IsNullOrEmpty(displayText) && !string.IsNullOrEmpty(val)) {
	            this.deptid.Items.Add(new ListItem(displayText, val));
	            this.deptid.SelectedIndex = this.deptid.Items.Count - 1;
	            this.Page.Session.Remove(deptid.ClientID + "_SelectedValue");
	            this.Page.Session.Remove(deptid.ClientID + "_SelectedDisplayText");
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList contact_id {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "contact_id");
            }
        }
        ...
        public System.Web.UI.WebControls.DropDownList deptid {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "deptid");
            }
        }
