...
// Edit_Security.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Security
{
...
public class SecurityRecordControl : BaseSecurityRecordControl
{
      
        // The BaseSecurityRecordControl implements the LoadData, DataBind and other
...
// Base class for the SecurityRecordControl control on the Edit_Security page.
// Do not modify this class. Instead override any method in SecurityRecordControl.
public class BaseSecurityRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseSecurityRecordControl()
        {
        ...
        // To customize, override this method in SecurityRecordControl.
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "SecurityRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            SecurityRecord[] recList = SecurityTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = SecurityTable.GetRecord(recList[0].GetID().ToXmlString(), true);
      ...
      // To customize, override this method in SecurityRecordControl.
         ...
         
        {
            ...
            bool hasFiltersSecurityRecordControl = false;
            hasFiltersSecurityRecordControl = hasFiltersSecurityRecordControl && false; // suppress warning
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Security"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "Security"));
            }
            HttpContext.Current.Session["QueryString in Edit-Security"] = recId;
          ...
          wc.iAND(SecurityTable.security_id, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(SecurityTable.security_id));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(SecurityTable.security_id, BaseFilter.ComparisonOperator.EqualsTo, recId);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseSecurityRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseSecurityRecordControl_Rec"] = value;
            }
        }
