...
// Edit_Equipment_inventory_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Equipment_inventory_Table
{
...
// Base class for the Equipment_inventoryTableControlRow control on the Edit_Equipment_inventory_Table page.
...
public class BaseEquipment_inventoryTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.encoded_inventory_id.TextChanged += encoded_inventory_id_TextChanged;
        ...
        public virtual void Setencoded_inventory_id()
        {
            
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.encoded_inventory_id.ID))
            {
            
                this.encoded_inventory_id.Text = this.PreviousUIData[this.encoded_inventory_id.ID].ToString();
              
                return;
            }
            
                    
            // Set the encoded_inventory_id TextBox on the webpage with value from the
            ...
            // this.encoded_inventory_id is the ASP:TextBox on the webpage.
                  
            if (this.DataSource != null && this.DataSource.IsCreated) {
                								
                // If the encoded_inventory_id is non-NULL, then format the value.
                // The Format method will use the Display Format
                string formattedValue = EvaluateFormula("inventory_id", this.DataSource);
                    
                this.encoded_inventory_id.Text = formattedValue;
                   
            } 
            
            else {
            
                // encoded_inventory_id is NULL in the database, so use the Default Value.  
                // Default Value could also be NULL.
        
              this.encoded_inventory_id.Text = Equipment_inventoryTable.encoded_inventory_id.Format(Equipment_inventoryTable.encoded_inventory_id.DefaultValue);
        ...
        public virtual void Setinventory_id()
        {
            ...
            if (this.DataSource != null && this.DataSource.inventory_idSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(Equipment_inventoryTable.inventory_id);
              ...
              this.inventory_id.Text = Equipment_inventoryTable.inventory_id.Format(Equipment_inventoryTable.inventory_id.DefaultValue);
        ...
        public virtual void GetUIData()
        {
            ...
            Getencoded_inventory_id();
            Getinventory_id();
        }
        
        
        public virtual void Getencoded_inventory_id()
        {
            
            // Retrieve the value entered by the user on the encoded_inventory_id ASP:TextBox, and
            // save it into the encoded_inventory_id field in DataSource DatabaseAYS_OEM%dbo.equipment_inventory record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(EvaluateFormula("ENCRYPT(Equipment_inventoryTableControlRow.encoded_inventory_id.Text)"), Equipment_inventoryTable.encoded_inventory_id);							
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void encoded_inventory_id_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox encoded_inventory_id {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "encoded_inventory_id");
            }
        }
...
// Base class for the Equipment_inventoryTableControl control on the Edit_Equipment_inventory_Table page.
...
public class BaseEquipment_inventoryTableControl : OEMConversion.UI.BaseApplicationTableControl
{
       ...
       public BaseEquipment_inventoryTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.encoded_inventory_idFilter)) 				
                    initialVal = this.GetFromSession(this.encoded_inventory_idFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"encoded_inventory_id\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    string[] encoded_inventory_idFilteritemListFromSession = initialVal.Split(',');
                    int index = 0;
                    foreach (string item in encoded_inventory_idFilteritemListFromSession)
                    {
                        ...
                        {
                            this.encoded_inventory_idFilter.Items.Add(item);
                            this.encoded_inventory_idFilter.Items[index].Selected = true;
                            index += 1;
                        }
                    }
                    foreach (ListItem listItem in this.encoded_inventory_idFilter.Items)
                    {
    ...
    // Setup default pagination settings.
            ...
            this.PageSize = Convert.ToInt32(this.GetFromSession(this, "Page_Size", "1500"));
       ...
       // Setup the sorting events.
            ...
            this.SortControl.SelectedIndexChanged += new EventHandler(SortControl_SelectedIndexChanged);
              ...
              this.encoded_inventory_idFilter.SelectedIndexChanged += encoded_inventory_idFilter_SelectedIndexChanged;                  
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                Setencoded_inventory_idFilter();
                Setencoded_inventory_idLabel();
                Setencoded_inventory_idLabel1();
        ...
        public virtual void ResetControl()
        {
            ...
            this.encoded_inventory_idFilter.ClearSelection();
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.encoded_inventory_idFilter)) {
                        
                int selectedItemCount = 0;
                foreach (ListItem item in this.encoded_inventory_idFilter.Items){
                    if (item.Selected) {
                        selectedItemCount += 1;
                ...
                foreach (ListItem item in this.encoded_inventory_idFilter.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(Equipment_inventoryTable.encoded_inventory_id, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
      ...
      cols.Add(Equipment_inventoryTable.equipment_inventory_pic1_name, true);
      ...
      String encoded_inventory_idFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "encoded_inventory_idFilter_Ajax"];
            if (MiscUtils.IsValueSelected(encoded_inventory_idFilterSelectedValue)) {

              
        if (encoded_inventory_idFilterSelectedValue != null){
                        string[] encoded_inventory_idFilteritemListFromSession = encoded_inventory_idFilterSelectedValue.Split(',');
                        int index = 0;
                        WhereClause filter = new WhereClause();
                        foreach (string item in encoded_inventory_idFilteritemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(Equipment_inventoryTable.encoded_inventory_id, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_SearchText(String prefixText,int count)
        {
            ...
            foreach (Equipment_inventoryRecord rec in recordList ){
                ...
                resultItem = rec.Format(Equipment_inventoryTable.equipment_inventory_pic1_name);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(Equipment_inventoryTable.equipment_inventory_pic1_name.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, Equipment_inventoryTable.equipment_inventory_pic1_name.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
      ...
      Equipment_inventoryRecord rec = new Equipment_inventoryRecord();
                        ...
                        if (recControl.encoded_inventory_id.Text != "") {
                            rec.Parse(recControl.encoded_inventory_id.Text, Equipment_inventoryTable.encoded_inventory_id);
                  }
                
                        if (recControl.inventory_id.Text != "") {
                            rec.Parse(recControl.inventory_id.Text, Equipment_inventoryTable.inventory_id);
                  }
        ...
        public virtual void Setencoded_inventory_idLabel()
                  {
                  
                    
        }
                
        public virtual void Setencoded_inventory_idLabel1()
                  {
        ...
        public virtual void Setencoded_inventory_idFilter()
        {
            
            ArrayList encoded_inventory_idFilterselectedFilterItemList = new ArrayList();
            string encoded_inventory_idFilteritemsString = null;
            if (this.InSession(this.encoded_inventory_idFilter))
                encoded_inventory_idFilteritemsString = this.GetFromSession(this.encoded_inventory_idFilter);
            
            if (encoded_inventory_idFilteritemsString != null)
            {
                string[] encoded_inventory_idFilteritemListFromSession = encoded_inventory_idFilteritemsString.Split(',');
                foreach (string item in encoded_inventory_idFilteritemListFromSession)
                {
                    encoded_inventory_idFilterselectedFilterItemList.Add(item);
                }
            }
              
            			
            this.Populateencoded_inventory_idFilter(MiscUtils.GetSelectedValueList(this.encoded_inventory_idFilter, encoded_inventory_idFilterselectedFilterItemList), 500);
                    
              string url = this.ModifyRedirectUrl("../equipment_inventory/Equipment-inventory-QuickSelector.aspx", "", true);
              
              url = this.Page.ModifyRedirectUrl(url, "", true);                                  
              
              url += "?Target=" + this.encoded_inventory_idFilter.ClientID + "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("encoded_inventory_id")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--ANY--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:All")) + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.encoded_inventory_idFilter.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(encoded_inventory_idFilter.AutoPostBack).ToLower() + ", event); return false;";
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Inventory {Txt:Ascending}"), "inventory_id Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Inventory {Txt:Descending}"), "inventory_id Desc"));
        ...
        // Get the filters' data for encoded_inventory_idFilter.
                
        protected virtual void Populateencoded_inventory_idFilter(ArrayList selectedValue, int maxItems)
                    
        {
            ...
            WhereClause wc = this.CreateWhereClause_encoded_inventory_idFilter();            
            this.encoded_inventory_idFilter.Items.Clear();
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_encoded_inventory_idFilter function.
            // It is better to customize the where clause there.
             
            
            
            OrderBy orderBy = new OrderBy(false, false);
            orderBy.Add(Equipment_inventoryTable.encoded_inventory_id, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = Equipment_inventoryTable.GetValues(Equipment_inventoryTable.encoded_inventory_id, wc, orderBy, maxItems);
            ...
            string fvalue;
            if ( Equipment_inventoryTable.encoded_inventory_id.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = Equipment_inventoryTable.encoded_inventory_id.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
                ...
                ListItem dupItem = this.encoded_inventory_idFilter.Items.FindByText(fvalue);
                ...
                this.encoded_inventory_idFilter.Items.Add(newItem);
            ...
            this.encoded_inventory_idFilter.SetFieldMaxLength(50);
                                 
                  
            // Add the selected value.
            if (this.encoded_inventory_idFilter.Items.Count == 0)
                this.encoded_inventory_idFilter.Items.Add(new ListItem(Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
        ...
        public virtual WhereClause CreateWhereClause_encoded_inventory_idFilter()
        {
            // Create a where clause for the filter encoded_inventory_idFilter.
            // This function is called by the Populate method to load the items 
            // in the encoded_inventory_idFilterQuickSelector
            ...
            encoded_inventory_idFilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.encoded_inventory_idFilter, encoded_inventory_idFilterselectedFilterItemList); 
            WhereClause wc = new WhereClause();
            if (encoded_inventory_idFilterselectedFilterItemList == null || encoded_inventory_idFilterselectedFilterItemList.Count == 0)
                wc.RunQuery = false;
            else            
            {
                foreach (string item in encoded_inventory_idFilterselectedFilterItemList)
                {
            
      
   
                    wc.iOR(Equipment_inventoryTable.encoded_inventory_id, BaseFilter.ComparisonOperator.EqualsTo, item);
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("Equipment_inventoryTableControlRepeater");
        ...
        protected override void SaveControlsToSession()
        {
            ...
            ArrayList encoded_inventory_idFilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.encoded_inventory_idFilter, null);
            string encoded_inventory_idFilterSessionString = "";
            if (encoded_inventory_idFilterselectedFilterItemList != null){
                foreach (string item in encoded_inventory_idFilterselectedFilterItemList){
                    encoded_inventory_idFilterSessionString = String.Concat(encoded_inventory_idFilterSessionString ,"," , item);
                }
            }
            this.SaveToSession(this.encoded_inventory_idFilter, encoded_inventory_idFilterSessionString);
        ...
        protected  void SaveControlsToSession_Ajax()
        {
            ...
            this.SaveToSession("encoded_inventory_idFilter_Ajax", encoded_inventory_idFilterSessionString);
      ...
      this.SaveToSession("SearchText_Ajax", this.SearchText.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.encoded_inventory_idFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(encoded_inventory_idFilter))
        ...
        protected virtual void encoded_inventory_idFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector encoded_inventory_idFilter {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "encoded_inventory_idFilter");
            }
        }              
        
        public System.Web.UI.WebControls.Literal encoded_inventory_idLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "encoded_inventory_idLabel");
            }
        }
        
        public System.Web.UI.WebControls.Literal encoded_inventory_idLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "encoded_inventory_idLabel1");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual Equipment_inventoryTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Equipment_inventoryTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_Equipment_inventory_Table.Equipment_inventoryTableControlRow")));
