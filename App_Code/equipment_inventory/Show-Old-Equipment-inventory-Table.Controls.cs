...
// Show_Old_Equipment_inventory_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Old_Equipment_inventory_Table
{
...
// Base class for the Equipment_inventoryTableControlRow control on the Show_Old_Equipment_inventory_Table page.
...
public class BaseEquipment_inventoryTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in Equipment_inventoryTableControlRow.
        ...
        public virtual void EditRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../equipment_inventory/Edit-Old-Equipment-inventory.aspx?Equipment_inventory={Equipment_inventoryTableControlRow:PK}";
...
// Base class for the Equipment_inventoryTableControl control on the Show_Old_Equipment_inventory_Table page.
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Old-Equipment-inventory-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "equipment_inventory";
                // If Show-Old-Equipment-inventory-Table.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Old-Equipment-inventory-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "equipment_inventory";
                // If Show-Old-Equipment-inventory-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual Equipment_inventoryTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Equipment_inventoryTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Old_Equipment_inventory_Table.Equipment_inventoryTableControlRow")));
