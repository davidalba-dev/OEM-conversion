...
// Loaner_Show_Equipment_inventory_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Loaner_Show_Equipment_inventory_Table
{
...
// Base class for the Equipment_inventoryTableControlRow control on the Loaner_Show_Equipment_inventory_Table page.
...
public class BaseEquipment_inventoryTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setvendno()
        {
            ...
            if (this.DataSource != null && this.DataSource.vendnoSpecified) {
               ...
               if(_isExpandableNonCompositeForeignKey &&Equipment_inventoryTable.vendno.IsApplyDisplayAs)
                     ...
                     formattedValue = Equipment_inventoryTable.GetDFKA(this.DataSource.vendno.ToString(),Equipment_inventoryTable.vendno, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(Equipment_inventoryTable.vendno);
              ...
              this.vendno.Text = Equipment_inventoryTable.vendno.Format(Equipment_inventoryTable.vendno.DefaultValue);
        ...
        public virtual void Setcategory_idLabel()
                  {
                        ...
                        this.category_idLabel.Text = EvaluateFormula("if(new_category_id>=1,\"Category:\",\"\")");
        ...
        public virtual void Setmake_idLabel1()
                  {
                        ...
                        this.make_idLabel1.Text = EvaluateFormula("if(ISNULL(make_id),\"\",\"Make:</b>\" + make_id + \"</br>\")");
        ...
        public virtual void Setmodel_idLabel()
                  {
                        ...
                        this.model_idLabel.Text = EvaluateFormula("if(ISNULL(model_id),\"\",\"Model:</b>\" + model_id + \"</br>\")");
      ...
      // To customize, override this method in Equipment_inventoryTableControlRow.
        ...
        public virtual void EditRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../equipment_inventory/Edit-Loaner-Equipment-inventory.aspx?Equipment_inventory={PK}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void vendno_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Vendors/Show-Vendors.aspx?Vendors={Equipment_inventoryTableControlRow:FK:FK_equipment_inventory_Vendors}";
...
// Base class for the Equipment_inventoryTableControl control on the Loaner_Show_Equipment_inventory_Table page.
...
public class BaseEquipment_inventoryTableControl : OEMConversion.UI.BaseApplicationTableControl
{
       ...
       public BaseEquipment_inventoryTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.equip_inv_ad_cat_id_1Filter)) 				
                    initialVal = this.GetFromSession(this.equip_inv_ad_cat_id_1Filter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"equip_inv_ad_cat_id_1\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.equip_inv_ad_cat_id_1Filter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.equip_inv_ad_cat_id_1Filter.SelectedValue = initialVal;
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.equip_inv_ad_cat_id_2Filter)) 				
                    initialVal = this.GetFromSession(this.equip_inv_ad_cat_id_2Filter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"equip_inv_ad_cat_id_2\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.equip_inv_ad_cat_id_2Filter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.equip_inv_ad_cat_id_2Filter.SelectedValue = initialVal;
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.warehouse_idFilter)) 				
                    initialVal = this.GetFromSession(this.warehouse_idFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"warehouse_id\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.warehouse_idFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.warehouse_idFilter.SelectedValue = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
              ...
              this.vendnoLabel.Click += vendnoLabel_Click;
            ...
            this.equip_inv_ad_cat_id_1Filter.SelectedIndexChanged += new EventHandler(equip_inv_ad_cat_id_1Filter_SelectedIndexChanged);
            
            this.equip_inv_ad_cat_id_2Filter.SelectedIndexChanged += new EventHandler(equip_inv_ad_cat_id_2Filter_SelectedIndexChanged);
            ...
            this.warehouse_idFilter.SelectedIndexChanged += new EventHandler(warehouse_idFilter_SelectedIndexChanged);
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                Setequip_inv_ad_cat_id_1Filter();
                Setequip_inv_ad_cat_id_1Label();
                Setequip_inv_ad_cat_id_2Filter();
                Setequip_inv_ad_cat_id_2Label();
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(Equipment_inventoryTable.vendno, this.DataSource);
        ...
        public virtual void ResetControl()
        {
            ...
            this.equip_inv_ad_cat_id_1Filter.ClearSelection();
            
            this.equip_inv_ad_cat_id_2Filter.ClearSelection();
            ...
            this.warehouse_idFilter.ClearSelection();
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.equip_inv_ad_cat_id_1Filter)) {
                        
                wc.iAND(Equipment_inventoryTable.equip_inv_ad_cat_id_1, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.equip_inv_ad_cat_id_1Filter, this.GetFromSession(this.equip_inv_ad_cat_id_1Filter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.equip_inv_ad_cat_id_2Filter)) {
                        
                wc.iAND(Equipment_inventoryTable.equip_inv_ad_cat_id_2, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.equip_inv_ad_cat_id_2Filter, this.GetFromSession(this.equip_inv_ad_cat_id_2Filter)), false, false);
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.SearchText, this.GetFromSession(this.SearchText)), true, false);
            ...
            if (MiscUtils.IsValueSelected(this.warehouse_idFilter)) {
                        
                wc.iAND(Equipment_inventoryTable.warehouse_id, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.warehouse_idFilter, this.GetFromSession(this.warehouse_idFilter)), false, false);
      ...
      String equip_inv_ad_cat_id_1FilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "equip_inv_ad_cat_id_1Filter_Ajax"];
            if (MiscUtils.IsValueSelected(equip_inv_ad_cat_id_1FilterSelectedValue)) {

              
                wc.iAND(Equipment_inventoryTable.equip_inv_ad_cat_id_1, BaseFilter.ComparisonOperator.EqualsTo, equip_inv_ad_cat_id_1FilterSelectedValue, false, false);
                      
      }
                      
      String equip_inv_ad_cat_id_2FilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "equip_inv_ad_cat_id_2Filter_Ajax"];
            if (MiscUtils.IsValueSelected(equip_inv_ad_cat_id_2FilterSelectedValue)) {

              
                wc.iAND(Equipment_inventoryTable.equip_inv_ad_cat_id_2, BaseFilter.ComparisonOperator.EqualsTo, equip_inv_ad_cat_id_2FilterSelectedValue, false, false);
      ...
      String warehouse_idFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "warehouse_idFilter_Ajax"];
            if (MiscUtils.IsValueSelected(warehouse_idFilterSelectedValue)) {

              
                wc.iAND(Equipment_inventoryTable.warehouse_id, BaseFilter.ComparisonOperator.EqualsTo, warehouse_idFilterSelectedValue, false, false);
      ...
      String warehouse_location_idFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "warehouse_location_idFilter_Ajax"];
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            if (EvaluateFormula("1", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Equipment_inventoryTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"equipment_inventory_.equipment_inventory_old"), EvaluateFormula("1", false), BaseClasses.Data.BaseFilter.ComparisonOperator.Not_Equals, false));
            if (EvaluateFormula("2", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Equipment_inventoryTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"equipment_inventory_.equipment_type_id"), EvaluateFormula("2", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
      ...
      Equipment_inventoryRecord rec = new Equipment_inventoryRecord();
                        ...
                        if (recControl.vendno.Text != "") {
                            rec.Parse(recControl.vendno.Text, Equipment_inventoryTable.vendno);
                  }
        ...
        public virtual void Setequip_inv_ad_cat_id_1Label()
                  {
                  
                      //Code for the text property is generated inside the .aspx file. 
                      //To override this property you can uncomment the following property and add you own value.
                      //this.equip_inv_ad_cat_id_1Label.Text = "Some value";
                    
                    
        }
                
        public virtual void Setequip_inv_ad_cat_id_2Label()
                  {
                  
                      //Code for the text property is generated inside the .aspx file. 
                      //To override this property you can uncomment the following property and add you own value.
                      //this.equip_inv_ad_cat_id_2Label.Text = "Some value";
        ...
        public virtual void Setequip_inv_ad_cat_id_1Filter()
        {
            
            this.Populateequip_inv_ad_cat_id_1Filter(MiscUtils.GetSelectedValue(this.equip_inv_ad_cat_id_1Filter,  GetFromSession(this.equip_inv_ad_cat_id_1Filter)), 500);					
                                     
        }
            
        public virtual void Setequip_inv_ad_cat_id_2Filter()
        {
            
            this.Populateequip_inv_ad_cat_id_2Filter(MiscUtils.GetSelectedValue(this.equip_inv_ad_cat_id_2Filter,  GetFromSession(this.equip_inv_ad_cat_id_2Filter)), 500);					
        ...
        public virtual void Setwarehouse_idFilter()
        {
            
            // Set AutoPostBack to true so that when the control value is changed, to refresh warehouse_location_idFilter controls
            this.warehouse_idFilter.AutoPostBack = true;
            
            this.Populatewarehouse_idFilter(MiscUtils.GetSelectedValue(this.warehouse_idFilter,  GetFromSession(this.warehouse_idFilter)), 500);					
        ...
        // Get the filters' data for equip_inv_ad_cat_id_1Filter.
                
        protected virtual void Populateequip_inv_ad_cat_id_1Filter(string selectedValue, int maxItems)
                    
        {
            ...
            this.equip_inv_ad_cat_id_1Filter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_equip_inv_ad_cat_id_1Filter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_equip_inv_ad_cat_id_1Filter function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.equip_inv_ad_cat_id_1Filter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
              
            OrderBy orderBy = new OrderBy(false, false);
                          orderBy.Add(Equipment_inventory_ad_categoryTable.equipment_inventory_ad_category_name, OrderByItem.OrderDir.Asc);
            ...
            Equipment_inventory_ad_categoryRecord[] itemValues  = null;
            if (wc.RunQuery)
            {
                int counter = 0;
                int pageNum = 0;
                ...
                do
                {
                    ...
                    itemValues = Equipment_inventory_ad_categoryTable.GetRecords(wc, orderBy, pageNum, maxItems);
                                    
                    foreach (Equipment_inventory_ad_categoryRecord itemValue in itemValues) 
                    {
                        // Create the item and add to the list.
                        string cvalue = null;
                        string fvalue = null;
                        if (itemValue.equipment_inventory_ad_category_idSpecified) 
                        {
                            cvalue = itemValue.equipment_inventory_ad_category_id.ToString();
                            if (counter < maxItems && this.equip_inv_ad_cat_id_1Filter.Items.FindByValue(cvalue) == null)
                            {
                                    
                                Boolean _isExpandableNonCompositeForeignKey = Equipment_inventoryTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Equipment_inventoryTable.equip_inv_ad_cat_id_1);
                                if(_isExpandableNonCompositeForeignKey && Equipment_inventoryTable.equip_inv_ad_cat_id_1.IsApplyDisplayAs)
                                     fvalue = Equipment_inventoryTable.GetDFKA(itemValue, Equipment_inventoryTable.equip_inv_ad_cat_id_1);
                                if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
                                     fvalue = itemValue.Format(Equipment_inventory_ad_categoryTable.equipment_inventory_ad_category_id);
                                ...
                                ListItem dupItem = this.equip_inv_ad_cat_id_1Filter.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.equip_inv_ad_cat_id_1Filter.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.equip_inv_ad_cat_id_1Filter, selectedValue);
            ...
            if (this.equip_inv_ad_cat_id_1Filter.SelectedValue != null && this.equip_inv_ad_cat_id_1Filter.Items.FindByValue(this.equip_inv_ad_cat_id_1Filter.SelectedValue) == null)
                this.equip_inv_ad_cat_id_1Filter.SelectedValue = null;
                           
        }
            
        // Get the filters' data for equip_inv_ad_cat_id_2Filter.
                
        protected virtual void Populateequip_inv_ad_cat_id_2Filter(string selectedValue, int maxItems)
                    
        {
            ...
            this.equip_inv_ad_cat_id_2Filter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_equip_inv_ad_cat_id_2Filter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_equip_inv_ad_cat_id_2Filter function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.equip_inv_ad_cat_id_2Filter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
            ...
            if (wc.RunQuery)
            {
                ...
                do
                {
                    ...
                    foreach (Equipment_inventory_ad_categoryRecord itemValue in itemValues) 
                    {
                        ...
                        {
                            cvalue = itemValue.equipment_inventory_ad_category_id.ToString();
                            if (counter < maxItems && this.equip_inv_ad_cat_id_2Filter.Items.FindByValue(cvalue) == null)
                            {
                                    
                                Boolean _isExpandableNonCompositeForeignKey = Equipment_inventoryTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Equipment_inventoryTable.equip_inv_ad_cat_id_2);
                                if(_isExpandableNonCompositeForeignKey && Equipment_inventoryTable.equip_inv_ad_cat_id_2.IsApplyDisplayAs)
                                     fvalue = Equipment_inventoryTable.GetDFKA(itemValue, Equipment_inventoryTable.equip_inv_ad_cat_id_2);
                                if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
                                     fvalue = itemValue.Format(Equipment_inventory_ad_categoryTable.equipment_inventory_ad_category_id);
                                ...
                                ListItem dupItem = this.equip_inv_ad_cat_id_2Filter.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.equip_inv_ad_cat_id_2Filter.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.equip_inv_ad_cat_id_2Filter, selectedValue);
            ...
            if (this.equip_inv_ad_cat_id_2Filter.SelectedValue != null && this.equip_inv_ad_cat_id_2Filter.Items.FindByValue(this.equip_inv_ad_cat_id_2Filter.SelectedValue) == null)
                this.equip_inv_ad_cat_id_2Filter.SelectedValue = null;
        ...
        // Get the filters' data for warehouse_idFilter.
                
        protected virtual void Populatewarehouse_idFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.warehouse_idFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_warehouse_idFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_warehouse_idFilter function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.warehouse_idFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
                ...
                do
                {
                    ...
                    foreach (WarehouseRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.warehouse_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.warehouse_idFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                ListItem dupItem = this.warehouse_idFilter.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.warehouse_idFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.warehouse_idFilter, selectedValue);
            ...
            if (this.warehouse_idFilter.SelectedValue != null && this.warehouse_idFilter.Items.FindByValue(this.warehouse_idFilter.SelectedValue) == null)
                this.warehouse_idFilter.SelectedValue = null;
        ...
        public virtual WhereClause CreateWhereClause_equip_inv_ad_cat_id_1Filter()
        {
            // Create a where clause for the filter equip_inv_ad_cat_id_1Filter.
            // This function is called by the Populate method to load the items 
            // in the equip_inv_ad_cat_id_1FilterDropDownList
        CompoundFilter filter = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
            WhereClause whereClause = new WhereClause();
            
            if (EvaluateFormula("1", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Equipment_inventory_ad_categoryTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"equipment_inventory_ad_category_.equipment_inventory_ad_category_active"), EvaluateFormula("1", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("1", false) == "--PLEASE_SELECT--" || EvaluateFormula("1", false) == "--ANY--") whereClause.RunQuery = false;
        ...
        public virtual WhereClause CreateWhereClause_equip_inv_ad_cat_id_2Filter()
        {
            // Create a where clause for the filter equip_inv_ad_cat_id_2Filter.
            // This function is called by the Populate method to load the items 
            // in the equip_inv_ad_cat_id_2FilterDropDownList
        CompoundFilter filter = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
            WhereClause whereClause = new WhereClause();
        ...
        public virtual WhereClause CreateWhereClause_warehouse_idFilter()
        {
            // Create a where clause for the filter warehouse_idFilter.
            // This function is called by the Populate method to load the items 
            // in the warehouse_idFilterDropDownList
        CompoundFilter filter = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
            WhereClause whereClause = new WhereClause();
        ...
        CompoundFilter filter = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
            ...
            if (EvaluateFormula("Equipment_inventoryTableControl.warehouse_idFilter.SelectedValue", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Warehouse_locationTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"warehouse_location_.warehouse_id"), EvaluateFormula("Equipment_inventoryTableControl.warehouse_idFilter.SelectedValue", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("1", false) == "--PLEASE_SELECT--" || EvaluateFormula("1", false) == "--ANY--") whereClause.RunQuery = false;
         if (EvaluateFormula("Equipment_inventoryTableControl.warehouse_idFilter.SelectedValue", false) == "--PLEASE_SELECT--" || EvaluateFormula("Equipment_inventoryTableControl.warehouse_idFilter.SelectedValue", false) == "--ANY--") whereClause.RunQuery = false;
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.equip_inv_ad_cat_id_1Filter, this.equip_inv_ad_cat_id_1Filter.SelectedValue);
                  
            this.SaveToSession(this.equip_inv_ad_cat_id_2Filter, this.equip_inv_ad_cat_id_2Filter.SelectedValue);
            ...
            this.SaveToSession(this.warehouse_idFilter, this.warehouse_idFilter.SelectedValue);
      ...
      this.SaveToSession("equip_inv_ad_cat_id_1Filter_Ajax", this.equip_inv_ad_cat_id_1Filter.SelectedValue);
              
      this.SaveToSession("equip_inv_ad_cat_id_2Filter_Ajax", this.equip_inv_ad_cat_id_2Filter.SelectedValue);
      ...
      this.SaveToSession("warehouse_idFilter_Ajax", this.warehouse_idFilter.SelectedValue);
      ...
      this.SaveToSession("warehouse_location_idFilter_Ajax", this.warehouse_location_idFilter.SelectedValue);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.equip_inv_ad_cat_id_1Filter);
            this.RemoveFromSession(this.equip_inv_ad_cat_id_2Filter);
            ...
            this.RemoveFromSession(this.warehouse_idFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(equip_inv_ad_cat_id_1Filter))
                themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        
            if (MiscUtils.IsValueSelected(equip_inv_ad_cat_id_2Filter))
                themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
            ...
            if (MiscUtils.IsValueSelected(warehouse_idFilter))
                themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        ...
        public virtual void vendnoLabel_Click(object sender, EventArgs args)
        {
            //Sorts by vendno when clicked.
              
            // Get previous sorting state for vendno.
        
            OrderByItem sd = this.CurrentSortOrder.Find(Equipment_inventoryTable.vendno);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for vendno.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(Equipment_inventoryTable.vendno, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by vendno, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void warehouse_idLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(Equipment_inventoryTable.warehouse_id);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(Equipment_inventoryTable.warehouse_id, OrderByItem.OrderDir.Asc);
        ...
        public virtual void NewButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../equipment_inventory/Add-Loaner-Equipment-inventory.aspx";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Loaner-Show-Equipment-inventory-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "equipment_inventory";
                // If Loaner-Show-Equipment-inventory-Table.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 ...
                 report.AddColumn(Equipment_inventoryTable.vendno.Name, ReportEnum.Align.Left, "${vendno}", ReportEnum.Align.Left, 18);
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.vendno)){
                                 ...
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = Equipment_inventoryTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Equipment_inventoryTable.vendno);
                                 _DFKA = Equipment_inventoryTable.GetDFKA(record.vendno.ToString(), Equipment_inventoryTable.vendno,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  Equipment_inventoryTable.vendno.IsApplyDisplayAs){
                                     report.AddData("${vendno}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${vendno}", record.Format(Equipment_inventoryTable.vendno), ReportEnum.Align.Left);
                                 }
                             }
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Loaner-Show-Equipment-inventory-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "equipment_inventory";
                // If Loaner-Show-Equipment-inventory-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        // event handler for FieldFilter
        protected virtual void equip_inv_ad_cat_id_1Filter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
        ...
        // event handler for FieldFilter
        protected virtual void equip_inv_ad_cat_id_2Filter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
        ...
        // event handler for FieldFilter
        protected virtual void warehouse_idFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList equip_inv_ad_cat_id_1Filter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "equip_inv_ad_cat_id_1Filter");
            }
        }
        
        public System.Web.UI.WebControls.Literal equip_inv_ad_cat_id_1Label {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "equip_inv_ad_cat_id_1Label");
            }
        }
        
        public System.Web.UI.WebControls.DropDownList equip_inv_ad_cat_id_2Filter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "equip_inv_ad_cat_id_2Filter");
            }
        }
        
        public System.Web.UI.WebControls.Literal equip_inv_ad_cat_id_2Label {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "equip_inv_ad_cat_id_2Label");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton vendnoLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "vendnoLabel");
            }
        }
        
        public System.Web.UI.WebControls.DropDownList warehouse_idFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "warehouse_idFilter");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual Equipment_inventoryTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Equipment_inventoryTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Loaner_Show_Equipment_inventory_Table.Equipment_inventoryTableControlRow")));
