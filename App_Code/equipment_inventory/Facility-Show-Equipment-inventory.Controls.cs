...
// Facility_Show_Equipment_inventory.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Facility_Show_Equipment_inventory
{
...
// Base class for the Equipment_inventoryRecordControl control on the Facility_Show_Equipment_inventory page.
...
public class BaseEquipment_inventoryRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in Equipment_inventoryRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["equipment_id"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "equipment_id"));
            }
            HttpContext.Current.Session["QueryString in Facility-Show-Equipment-inventory"] = recId;
