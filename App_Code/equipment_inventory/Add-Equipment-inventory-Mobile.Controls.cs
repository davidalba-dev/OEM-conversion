...
// Add_Equipment_inventory_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Equipment_inventory_Mobile
{
...
// Base class for the Equipment_inventoryRecordControl control on the Add_Equipment_inventory_Mobile page.
...
public class BaseEquipment_inventoryRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setreceived_from_contact_id()
        {
            ...
            else
            {
                ...
                selectedValue = EvaluateFormula("URL(\"received_from_contact_id\")");
        ...
        public virtual void Setsale_method_id()
        {
            ...
            else
            {
                ...
                selectedValue = EvaluateFormula("URL(\"sale_method_id\")");
        ...
        public virtual void Setsold_from_id()
        {
            ...
            else
            {
                ...
                selectedValue = EvaluateFormula("URL(\"sold_from_id\")");
      ...
      // To customize, override this method in Equipment_inventoryRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Add-Equipment-inventory-Mobile"] = recId;
