...
// Show_Equipment_inventory_Table_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Equipment_inventory_Table_Mobile
{
...
// Base class for the Equipment_inventoryTableControlRow control on the Show_Equipment_inventory_Table_Mobile page.
...
public class BaseEquipment_inventoryTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setequipment_inventory_pic1()
        {
            ...
            if (this.DataSource != null && this.DataSource.equipment_inventory_pic1Specified) {
                ...
                this.equipment_inventory_pic1.ImageUrl = this.DataSource.FormatImageUrl(Equipment_inventoryTable.equipment_inventory_pic1, this.Page.Encrypt("Equipment_inventory"), this.Page.Encrypt("equipment_inventory_pic1"), this.Page.Encrypt(this.DataSource.GetID().ToXmlString()), 20);
      ...
      // To customize, override this method in Equipment_inventoryTableControlRow.
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../equipment_inventory/Show-Equipment-inventory-Mobile.aspx?Equipment_inventory={PK}";
...
// Base class for the Equipment_inventoryTableControl control on the Show_Equipment_inventory_Table_Mobile page.
...
public class BaseEquipment_inventoryTableControl : OEMConversion.UI.BaseApplicationTableControl
{
            ...
            foreach (Equipment_inventoryRecord rec in recordList ){
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, Equipment_inventoryTable.oem_ein.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void NewButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../equipment_inventory/Add-Equipment-inventory-Mobile.aspx";
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (Equipment_inventoryTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        Equipment_inventoryTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual Equipment_inventoryTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Equipment_inventoryTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Equipment_inventory_Table_Mobile.Equipment_inventoryTableControlRow")));
