...
// Edit_Technician_team.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Technician_team
{
...
// Base class for the Technician_teamRecordControl control on the Edit_Technician_team page.
...
public class BaseTechnician_teamRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.oem_team_id.TextChanged += oem_team_id_TextChanged;
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "Technician_teamRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            this.DataSource = Technician_teamTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public virtual void Setoem_team_id()
        {
            ...
            // Set the oem_team_id TextBox on the webpage with value from the
            ...
            // this.oem_team_id is the ASP:TextBox on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.oem_team_idSpecified) {
               ...
               string formattedValue = this.DataSource.oem_team_id.ToString();
              ...
              this.oem_team_id.Text = Technician_teamTable.oem_team_id.DefaultValue;
        ...
        public virtual void Settechnician_id()
        {
            ...
            if (this.DataSource != null && this.DataSource.technician_idSpecified) {
              ...
              this.technician_id.Text = Technician_teamTable.technician_id.DefaultValue;
        ...
        public virtual void Getoem_team_id()
        {
            ...
            // Retrieve the value entered by the user on the oem_team_id ASP:TextBox, and
            // save it into the oem_team_id field in DataSource DatabaseAYS_OEM%dbo.technician_team record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.oem_team_id.Text, Technician_teamTable.oem_team_id);							
      ...
      // To customize, override this method in Technician_teamRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Technician_team"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "Technician_team"));
            }
            HttpContext.Current.Session["QueryString in Edit-Technician-team"] = recId;
        ...
        protected virtual void oem_team_id_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox oem_team_id {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "oem_team_id");
            }
        }
