...
// Edit_Loaner_history.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Loaner_history
{
...
// Base class for the Loaner_historyRecordControl control on the Edit_Loaner_history page.
// Do not modify this class. Instead override any method in Loaner_historyRecordControl.
public class BaseLoaner_historyRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseLoaner_historyRecordControl()
        {
        ...
        // To customize, override this method in Loaner_historyRecordControl.
        ...
        {      
              ...
              this.technician_in.SelectedIndexChanged += technician_in_SelectedIndexChanged;
            
              this.custcontactkey.SelectedIndexChanged += custcontactkey_SelectedIndexChanged;
            
              this.date_in.TextChanged += date_in_TextChanged;
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "Loaner_historyRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            Loaner_historyRecord[] recList = Loaner_historyTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = Loaner_historyTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetronoLabel();
                Settechnician_in();
                Settechnician_inLabel();
                Settechnician_out();
                Settechnician_outLabel();
        ...
        public virtual void Setcustno()
        {
            ...
            // Set AutoPostBack to true so that when the control value is changed, to refresh custcontactkey controls
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = Loaner_historyTable.custno.DefaultValue;
            ...
            this.PopulatecustnoDropDownList(selectedValue, 3000);              
                
                  
        }
                
        public virtual void Setdate_in()
        {
            
                    
            // Set the date_in TextBox on the webpage with value from the
            // DatabaseAYS_OEM%dbo.loaner_history database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.loaner_history record retrieved from the database.
            // this.date_in is the ASP:TextBox on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.date_inSpecified) {
               ...
               string formattedValue = this.DataSource.Format(Loaner_historyTable.date_in, @"d");
                ...
                this.date_in.Text = formattedValue;
              ...
              this.date_in.Text = Loaner_historyTable.date_in.Format(Loaner_historyTable.date_in.DefaultValue, @"d");
        ...
        public virtual void Setdate_out()
        {
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.loaner_history record retrieved from the database.
            // this.date_out is the ASP:Literal on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.date_outSpecified) {
               ...
               string formattedValue = this.DataSource.Format(Loaner_historyTable.date_out, @"d");
                ...
                this.date_out.Text = formattedValue;
              ...
              this.date_out.Text = Loaner_historyTable.date_out.Format(Loaner_historyTable.date_out.DefaultValue, @"d");
        ...
        public virtual void Setinventory_id()
        {
            ...
            if (this.DataSource != null && this.DataSource.inventory_idSpecified) {
              ...
              this.inventory_id.Text = Loaner_historyTable.inventory_id.Format(Loaner_historyTable.inventory_id.DefaultValue);
        ...
        public virtual void Setrono()
        {
            ...
            if (this.DataSource != null && this.DataSource.ronoSpecified) {
              ...
              this.rono.Text = Loaner_historyTable.rono.Format(Loaner_historyTable.rono.DefaultValue);
            		
            }
                               
        }
                
        public virtual void Settechnician_in()
        {
            ...
            // Set the technician_in DropDownList on the webpage with value from the
            // DatabaseAYS_OEM%dbo.loaner_history database record.
            
            // this.DataSource is the DatabaseAYS_OEM%dbo.loaner_history record retrieved from the database.
            // this.technician_in is the ASP:DropDownList on the webpage.
            
            // You can modify this method directly, or replace it with a call to
            //     base.Settechnician_in();
            // and add your own custom code before or after the call to the base function.
            ...
            if (this.DataSource != null && this.DataSource.technician_inSpecified)
            {
                ...
                // The Format method will return the Display Foreign Key As (DFKA) value
                selectedValue = this.DataSource.technician_in.ToString();
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = Loaner_historyTable.technician_in.DefaultValue;
            ...
            this.Populatetechnician_inDropDownList(selectedValue, 100);              
                
                  
        }
                
        public virtual void Settechnician_out()
        {
            
                    
            // Set the technician_out Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.loaner_history database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.loaner_history record retrieved from the database.
            // this.technician_out is the ASP:Literal on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.technician_outSpecified) {
               ...
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                ...
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                this.technician_out.Text = formattedValue;
              ...
              this.technician_out.Text = Loaner_historyTable.technician_out.Format(Loaner_historyTable.technician_out.DefaultValue);
        ...
        public virtual void Setcustcontactkey()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = Loaner_historyTable.custcontactkey.DefaultValue;
        ...
        public virtual void Setdate_inLabel()
                  {
                  
                    
        }
                
        public virtual void Setdate_outLabel()
                  {
        ...
        public virtual void Settechnician_inLabel()
                  {
                  
                    
        }
                
        public virtual void Settechnician_outLabel()
                  {
        ...
        public virtual void Getcustno()
        {
         // Retrieve the value entered by the user on the custno ASP:DropDownList, and
            // save it into the custno field in DataSource DatabaseAYS_OEM%dbo.loaner_history record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.custno), Loaner_historyTable.custno);			
                			 
        }
                
        public virtual void Getdate_in()
        {
            
            // Retrieve the value entered by the user on the date_in ASP:TextBox, and
            // save it into the date_in field in DataSource DatabaseAYS_OEM%dbo.loaner_history record.
            ...
            this.DataSource.Parse(this.date_in.Text, Loaner_historyTable.date_in);							
                          
                      
        }
                
        public virtual void Getdate_out()
        {
        ...
        public virtual void Gettechnician_in()
        {
         // Retrieve the value entered by the user on the technician_in ASP:DropDownList, and
            // save it into the technician_in field in DataSource DatabaseAYS_OEM%dbo.loaner_history record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.technician_in), Loaner_historyTable.technician_in);			
                			 
        }
                
        public virtual void Gettechnician_out()
        {
        ...
        public virtual void Getcustcontactkey()
        {
         // Retrieve the value entered by the user on the custcontactkey ASP:DropDownList, and
            // save it into the custcontactkey field in DataSource DatabaseAYS_OEM%dbo.loaner_history record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.custcontactkey), Loaner_historyTable.custcontactkey);			
      ...
      // To customize, override this method in Loaner_historyRecordControl.
         ...
         
        {
            ...
            bool hasFiltersLoaner_historyRecordControl = false;
            hasFiltersLoaner_historyRecordControl = hasFiltersLoaner_historyRecordControl && false; // suppress warning
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Loaner_history"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "Loaner_history"));
            }
            HttpContext.Current.Session["QueryString in Edit-Loaner-history"] = recId;
          ...
          wc.iAND(Loaner_historyTable.loaner_id, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(Loaner_historyTable.loaner_id));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(Loaner_historyTable.loaner_id, BaseFilter.ComparisonOperator.EqualsTo, recId);
        ...
        public virtual WhereClause CreateWhereClause_technician_inDropDownList() 
        {
            // By default, we simply return a new WhereClause.
            // Add additional where clauses to restrict the items shown in the dropdown list.
        ...
        public virtual WhereClause CreateWhereClause_custcontactkeyDropDownList() 
        {
            ...
            if (EvaluateFormula("Loaner_historyRecordControl.custno.SelectedValue", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.CustomerContactsTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"CustomerContacts_.CustNo"), EvaluateFormula("Loaner_historyRecordControl.custno.SelectedValue", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("1", false) == "--PLEASE_SELECT--" || EvaluateFormula("1", false) == "--ANY--") whereClause.RunQuery = false;
         if (EvaluateFormula("Loaner_historyRecordControl.custno.SelectedValue", false) == "--PLEASE_SELECT--" || EvaluateFormula("Loaner_historyRecordControl.custno.SelectedValue", false) == "--ANY--") whereClause.RunQuery = false;
                        ...
                        if (itemValue.CustNoSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.custno.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                if(_isExpandableNonCompositeForeignKey && Loaner_historyTable.custno.IsApplyDisplayAs)
                                    fvalue = Loaner_historyTable.GetDFKA(itemValue, Loaner_historyTable.custno);
        ...
        // Fill the technician_in list.
        protected virtual void Populatetechnician_inDropDownList(string selectedValue, int maxItems) 
        {
            		  					                
            this.technician_in.Items.Clear();
            
            // 1. Setup the static list items        
            
              // Add the Please Select item.
              this.technician_in.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "OEMConversion"), "--PLEASE_SELECT--"));
            		  			
            // 2. Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_technician_inDropDownList function.
            // It is better to customize the where clause there.
            
                      
            WhereClause wc = CreateWhereClause_technician_inDropDownList();
            ...
            // 3. Read a total of maxItems from the database and insert them into the technician_inDropDownList.
                ...
                do
                {
                    ...
                    foreach (TechniciansRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.technician_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.technician_in.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                ListItem dupItem = this.technician_in.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.technician_in.Items.Add(newItem);
            ...
            if (selectedValue != null &&
                selectedValue.Trim() != "" &&
                !MiscUtils.SetSelectedValue(this.technician_in, selectedValue) &&
                !MiscUtils.SetSelectedDisplayText(this.technician_in, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        if (fvalue == null || fvalue.Trim() == "") fvalue = cvalue;
                        MiscUtils.ResetSelectedItem(this.technician_in, new ListItem(fvalue, cvalue));                      
                    }
                }
                catch
                {
                        ...
                        if (itemValue.CustContactKeySpecified) 
                        {
                            ...
                            if (counter < maxItems && this.custcontactkey.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                if(_isExpandableNonCompositeForeignKey && Loaner_historyTable.custcontactkey.IsApplyDisplayAs)
                                    fvalue = Loaner_historyTable.GetDFKA(itemValue, Loaner_historyTable.custcontactkey);
                                if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
        ...
        protected virtual void technician_in_SelectedIndexChanged(object sender, EventArgs args)
        {
            // for the value inserted by quick add button or large list selector, 
            // the value is necessary to be inserted by this event during postback 
            string val = (string)(this.Page.Session[technician_in.ClientID + "_SelectedValue"]);
            string displayText = (string)(this.Page.Session[technician_in.ClientID + "_SelectedDisplayText"]);
            if (!string.IsNullOrEmpty(displayText) && !string.IsNullOrEmpty(val)) {
	            this.technician_in.Items.Add(new ListItem(displayText, val));
	            this.technician_in.SelectedIndex = this.technician_in.Items.Count - 1;
	            this.Page.Session.Remove(technician_in.ClientID + "_SelectedValue");
	            this.Page.Session.Remove(technician_in.ClientID + "_SelectedDisplayText");
            }
        ...
        protected virtual void date_in_TextChanged(object sender, EventArgs args)
        {
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseLoaner_historyRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseLoaner_historyRecordControl_Rec"] = value;
            }
        }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox date_in {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "date_in");
            }
        }
            
        public System.Web.UI.WebControls.Literal date_inLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "date_inLabel");
            }
        }
        
        public System.Web.UI.WebControls.Literal date_out {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "date_out");
            }
        }
            
        public System.Web.UI.WebControls.Literal date_outLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "date_outLabel");
            }
        }
        ...
        public System.Web.UI.WebControls.DropDownList technician_in {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "technician_in");
            }
        }
            
        public System.Web.UI.WebControls.Literal technician_inLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "technician_inLabel");
            }
        }
        
        public System.Web.UI.WebControls.Literal technician_out {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "technician_out");
            }
        }
            
        public System.Web.UI.WebControls.Literal technician_outLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "technician_outLabel");
            }
        }
