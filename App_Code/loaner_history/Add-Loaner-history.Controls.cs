...
// Add_Loaner_history.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Loaner_history
{
...
// Base class for the Loaner_historyRecordControl control on the Add_Loaner_history page.
...
public class BaseLoaner_historyRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.technician_out.SelectedIndexChanged += technician_out_SelectedIndexChanged;
            
              this.custcontactkey.SelectedIndexChanged += custcontactkey_SelectedIndexChanged;
            
              this.date_out.TextChanged += date_out_TextChanged;
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (Loaner_historyRecord)Loaner_historyRecord.Copy(recList[0], false);
        ...
        public virtual void Setdate_out()
        {
            ...
            // Set the date_out TextBox on the webpage with value from the
            // DatabaseAYS_OEM%dbo.loaner_history database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.loaner_history record retrieved from the database.
            // this.date_out is the ASP:TextBox on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
              ...
              this.date_out.Text = EvaluateFormula("Today()", this.DataSource, @"d");
        ...
        public virtual void Setinventory_id()
        {
            ...
            else
            {
                ...
                selectedValue = EvaluateFormula("URL(\"equipment_inventory_id\")");
        ...
        public virtual void Settechnician_out()
        {
            ...
            // Set the technician_out DropDownList on the webpage with value from the
            // DatabaseAYS_OEM%dbo.loaner_history database record.
            
            // this.DataSource is the DatabaseAYS_OEM%dbo.loaner_history record retrieved from the database.
            // this.technician_out is the ASP:DropDownList on the webpage.
            
            // You can modify this method directly, or replace it with a call to
            //     base.Settechnician_out();
            // and add your own custom code before or after the call to the base function.
            ...
            if (this.DataSource != null && this.DataSource.IsCreated)
            {
                ...
                selectedValue = this.DataSource.technician_out.ToString();
            ...
            else
            {
                ...
                selectedValue = EvaluateFormula("URL(\"technician_out\")");
            ...
            this.Populatetechnician_outDropDownList(selectedValue, 100);              
        ...
        public virtual void Setcustcontactkey()
        {
            ...
            this.PopulatecustcontactkeyDropDownList(selectedValue, 1500);              
        ...
        public virtual void Getdate_out()
        {
            ...
            // Retrieve the value entered by the user on the date_out ASP:TextBox, and
            // save it into the date_out field in DataSource DatabaseAYS_OEM%dbo.loaner_history record.
            ...
            this.DataSource.Parse(this.date_out.Text, Loaner_historyTable.date_out);							
        ...
        public virtual void Getinventory_id()
        {
         // Retrieve the value entered by the user on the inventory_id ASP:DropDownList, and
            // save it into the inventory_id field in DataSource DatabaseAYS_OEM%dbo.loaner_history record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.inventory_id), Loaner_historyTable.inventory_id);			
        ...
        public virtual void Getrono()
        {
         // Retrieve the value entered by the user on the rono ASP:DropDownList, and
            // save it into the rono field in DataSource DatabaseAYS_OEM%dbo.loaner_history record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.rono), Loaner_historyTable.rono);			
                			 
        }
                
        public virtual void Gettechnician_out()
        {
         // Retrieve the value entered by the user on the technician_out ASP:DropDownList, and
            // save it into the technician_out field in DataSource DatabaseAYS_OEM%dbo.loaner_history record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.technician_out), Loaner_historyTable.technician_out);			
      ...
      // To customize, override this method in Loaner_historyRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Loaner_history"];
            ...
            HttpContext.Current.Session["QueryString in Add-Loaner-history"] = recId;
        ...
        public virtual WhereClause CreateWhereClause_inventory_idDropDownList() 
        {
            ...
            if (EvaluateFormula("URL(\"equipment_inventory_id\")", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Equipment_inventoryTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"equipment_inventory_.inventory_id"), EvaluateFormula("URL(\"equipment_inventory_id\")", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("URL(\"equipment_inventory_id\")", false) == "--PLEASE_SELECT--" || EvaluateFormula("URL(\"equipment_inventory_id\")", false) == "--ANY--") whereClause.RunQuery = false;
        ...
        public virtual WhereClause CreateWhereClause_ronoDropDownList() 
        {
            ...
            if (EvaluateFormula("Loaner_historyRecordControl.custno.SelectedValue", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.RepairOrdersTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"RepairOrders_.ROCustNo"), EvaluateFormula("Loaner_historyRecordControl.custno.SelectedValue", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
            ...
            if (EvaluateFormula("24", false) != "")filter1.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.RepairOrdersTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"RepairOrders_.ROStatus"), EvaluateFormula("24", false), BaseClasses.Data.BaseFilter.ComparisonOperator.Not_Equals, false));
            if (EvaluateFormula("Loaner_historyRecordControl.custno.SelectedValue", false) != "")filter1.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.RepairOrdersTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"RepairOrders_.ROCustNo"), EvaluateFormula("Loaner_historyRecordControl.custno.SelectedValue", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
        ...
        public virtual WhereClause CreateWhereClause_technician_outDropDownList() 
        {
            // By default, we simply return a new WhereClause.
            // Add additional where clauses to restrict the items shown in the dropdown list.
                    ...
                    foreach (RepairOrdersRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.RONoSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.rono.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                fvalue = EvaluateFormula("=RepairOrders.RONo", itemValue, variables2, evaluator);
                ...
                !MiscUtils.SetSelectedDisplayText(this.rono, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        fvalue = EvaluateFormula("=RepairOrders.RONo", itemValue, variables2, evaluator2);
        ...
        // Fill the technician_out list.
        protected virtual void Populatetechnician_outDropDownList(string selectedValue, int maxItems) 
        {
            		  					                
            this.technician_out.Items.Clear();
            
            // 1. Setup the static list items        
            		  			
            // 2. Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_technician_outDropDownList function.
            // It is better to customize the where clause there.
            
                      
            WhereClause wc = CreateWhereClause_technician_outDropDownList();
            ...
            // 3. Read a total of maxItems from the database and insert them into the technician_outDropDownList.
                ...
                do
                {
                    ...
                    foreach (TechniciansRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.technician_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.technician_out.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                ListItem dupItem = this.technician_out.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.technician_out.Items.Add(newItem);
            ...
            if (selectedValue != null &&
                selectedValue.Trim() != "" &&
                !MiscUtils.SetSelectedValue(this.technician_out, selectedValue) &&
                !MiscUtils.SetSelectedDisplayText(this.technician_out, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        if (fvalue == null || fvalue.Trim() == "") fvalue = cvalue;
                        MiscUtils.ResetSelectedItem(this.technician_out, new ListItem(fvalue, cvalue));                      
                    }
                }
                catch
                {
        ...
        protected virtual void technician_out_SelectedIndexChanged(object sender, EventArgs args)
        {
            // for the value inserted by quick add button or large list selector, 
            // the value is necessary to be inserted by this event during postback 
            string val = (string)(this.Page.Session[technician_out.ClientID + "_SelectedValue"]);
            string displayText = (string)(this.Page.Session[technician_out.ClientID + "_SelectedDisplayText"]);
            if (!string.IsNullOrEmpty(displayText) && !string.IsNullOrEmpty(val)) {
	            this.technician_out.Items.Add(new ListItem(displayText, val));
	            this.technician_out.SelectedIndex = this.technician_out.Items.Count - 1;
	            this.Page.Session.Remove(technician_out.ClientID + "_SelectedValue");
	            this.Page.Session.Remove(technician_out.ClientID + "_SelectedDisplayText");
            }
        ...
        protected virtual void date_out_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox date_out {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "date_out");
            }
        }
        ...
        public System.Web.UI.WebControls.DropDownList technician_out {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "technician_out");
            }
        }
    ...
    Loaner_historyRecord rec = null;
             ...
             
        {
            ...
            return new Loaner_historyRecord();
