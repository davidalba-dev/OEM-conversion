...
// Edit_Contractor_skills.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Contractor_skills
{
...
public class Contractor_skillsRecordControl : BaseContractor_skillsRecordControl
{
      
        // The BaseContractor_skillsRecordControl implements the LoadData, DataBind and other
...
// Base class for the Contractor_skills_matrixTableControlRow control on the Edit_Contractor_skills page.
...
public class BaseContractor_skills_matrixTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setcontractor_id()
        {
            ...
            if (this.DataSource != null && this.DataSource.contractor_idSpecified) {
               ...
               Boolean _isExpandableNonCompositeForeignKey = Contractor_skills_matrixTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Contractor_skills_matrixTable.contractor_id);
               if(_isExpandableNonCompositeForeignKey &&Contractor_skills_matrixTable.contractor_id.IsApplyDisplayAs)
                                  
                     formattedValue = Contractor_skills_matrixTable.GetDFKA(this.DataSource.contractor_id.ToString(),Contractor_skills_matrixTable.contractor_id, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(Contractor_skills_matrixTable.contractor_id);
              ...
              this.contractor_id.Text = Contractor_skills_matrixTable.contractor_id.Format(Contractor_skills_matrixTable.contractor_id.DefaultValue);
            		
            }
            
            // If the contractor_id is NULL or blank, then use the value specified  
            // on Properties.
            if (this.contractor_id.Text == null ||
                this.contractor_id.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.contractor_id.Text = "&nbsp;";
            }
        ...
        Contractor_skillsRecordControl parentCtrl;
      
            parentCtrl = (Contractor_skillsRecordControl)this.Page.FindControlRecursively("Contractor_skillsRecordControl");
        ...
        throw new Exception(Page.GetResourceValue("Err:NoParentRecId", "OEMConversion"));
          ...
          this.DataSource.contractor_skill_id = parentCtrl.DataSource.contractor_skill_id;
      ...
      // To customize, override this method in Contractor_skills_matrixTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersContractor_skillsRecordControl = false;
            hasFiltersContractor_skillsRecordControl = hasFiltersContractor_skillsRecordControl && false; // suppress warning
        ...
        public virtual void EditRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../contractor/Edit-Contractor.aspx?contractor={Contractor_skills_matrixTableControlRow:FV:contractor_id}";
...
// Base class for the Contractor_skills_matrixTableControl control on the Edit_Contractor_skills page.
...
public class BaseContractor_skills_matrixTableControl : OEMConversion.UI.BaseApplicationTableControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            else
            {
                ...
                this.CurrentSortOrder.Add(Contractor_skills_matrixTable.contractor_id, OrderByItem.OrderDir.Asc);
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(Contractor_skills_matrixTable.contractor_id, this.DataSource);
        }
    ...
    OEMConversion.UI.Controls.Edit_Contractor_skills.Contractor_skillsRecordControl contractor_skillsRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "Contractor_skillsRecordControl") as OEMConversion.UI.Controls.Edit_Contractor_skills.Contractor_skillsRecordControl);
          
              if (contractor_skillsRecordControlObj != null && contractor_skillsRecordControlObj.GetRecord() != null && contractor_skillsRecordControlObj.GetRecord().IsCreated)
              {
              wc.iAND(Contractor_skills_matrixTable.contractor_skill_id, BaseFilter.ComparisonOperator.EqualsTo, contractor_skillsRecordControlObj.GetRecord().contractor_skill_id.ToString());
              selectedRecordKeyValue.AddElement(Contractor_skills_matrixTable.contractor_skill_id.InternalName, contractor_skillsRecordControlObj.GetRecord().contractor_skill_id.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInContractor_skillsRecordControl = HttpContext.Current.Session["Contractor_skills_matrixTableControlWhereClause"] as string;
      
      if (selectedRecordInContractor_skillsRecordControl != null && KeyValue.IsXmlKey(selectedRecordInContractor_skillsRecordControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInContractor_skillsRecordControl);
      
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(Contractor_skills_matrixTable.contractor_skill_id))
      {
      wc.iAND(Contractor_skills_matrixTable.contractor_skill_id, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(Contractor_skills_matrixTable.contractor_skill_id).ToString());
      }
      ...
      Contractor_skills_matrixRecord rec = new Contractor_skills_matrixRecord();
                        ...
                        if (recControl.contractor_id.Text != "") {
                            rec.Parse(recControl.contractor_id.Text, Contractor_skills_matrixTable.contractor_id);
                  }
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Contractor Skill {Txt:Ascending}"), "contractor_skill_id Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Contractor Skill {Txt:Descending}"), "contractor_skill_id Desc"));
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                    string url = "../contractor_skills_matrix/Add-Contractor-skills-matrix.aspx?TabVisible=False&SaveAndNewVisible=False";
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              if (this.TotalRecords > 10000)
              {
                ...
                BaseColumn[] columns = new BaseColumn[] {
                             Contractor_skills_matrixTable.contractor_id,
             null};
              ...
              DataForExport data = new DataForExport(Contractor_skills_matrixTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(Contractor_skills_matrixTable.contractor_id, "Default"));
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Edit-Contractor-skills.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "contractor_skills_matrix";
                // If Edit-Contractor-skills.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(Contractor_skills_matrixTable.contractor_id.Name, ReportEnum.Align.Left, "${contractor_id}", ReportEnum.Align.Left, 28);
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                 ...
                                 report.AddData("${contractor_id}", "",ReportEnum.Align.Left, 300);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = Contractor_skills_matrixTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Contractor_skills_matrixTable.contractor_id);
                                 _DFKA = Contractor_skills_matrixTable.GetDFKA(record.contractor_id.ToString(), Contractor_skills_matrixTable.contractor_id,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  Contractor_skills_matrixTable.contractor_id.IsApplyDisplayAs){
                                     report.AddData("${contractor_id}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${contractor_id}", record.Format(Contractor_skills_matrixTable.contractor_id), ReportEnum.Align.Left, 300);
                                 }
                             }
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Edit-Contractor-skills.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "contractor_skills_matrix";
                // If Edit-Contractor-skills.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual Contractor_skills_matrixTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Contractor_skills_matrixTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_Contractor_skills.Contractor_skills_matrixTableControlRow")));
...
// Base class for the Contractor_skillsRecordControl control on the Edit_Contractor_skills page.
// Do not modify this class. Instead override any method in Contractor_skillsRecordControl.
public class BaseContractor_skillsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseContractor_skillsRecordControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        // To customize, override this method in Contractor_skillsRecordControl.
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
        ...
        {      
              ...
              this.skill_active.CheckedChanged += skill_active_CheckedChanged;
            
              this.skill_name.TextChanged += skill_name_TextChanged;
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "Contractor_skillsRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            Contractor_skillsRecord[] recList = Contractor_skillsTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = Contractor_skillsTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public virtual void Setskill_active()
        {
            ...
            // Set the skill_active CheckBox on the webpage with value from the
            ...
            // this.skill_active is the ASP:CheckBox on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.skill_activeSpecified) {
                ...
                this.skill_active.Checked = this.DataSource.skill_active;
                ...
                // Default Value could also be NULL.
                if (!this.DataSource.IsCreated) 
                    this.skill_active.Checked = Contractor_skillsTable.skill_active.ParseValue(Contractor_skillsTable.skill_active.DefaultValue).ToBoolean();                
        ...
        public virtual void Setskill_name()
        {
            ...
            // Set the skill_name TextBox on the webpage with value from the
            // DatabaseAYS_OEM%dbo.contractor_skills database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.contractor_skills record retrieved from the database.
            // this.skill_name is the ASP:TextBox on the webpage.
        ...
        {	
            ...
            // Retrieve the value entered by the user on the skill_active ASP:CheckBox, and
            // save it into the skill_active field in DataSource DatabaseAYS_OEM%dbo.contractor_skills record.
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.skill_active = this.skill_active.Checked;						
        ...
        public virtual void Getskill_name()
        {
            ...
            // Retrieve the value entered by the user on the skill_name ASP:TextBox, and
            // save it into the skill_name field in DataSource DatabaseAYS_OEM%dbo.contractor_skills record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.skill_name.Text, Contractor_skillsTable.skill_name);							
      ...
      // To customize, override this method in Contractor_skillsRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Contractor_skills"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "Contractor_skills"));
            }
            HttpContext.Current.Session["QueryString in Edit-Contractor-skills"] = recId;
          ...
          wc.iAND(Contractor_skillsTable.contractor_skill_id, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(Contractor_skillsTable.contractor_skill_id));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(Contractor_skillsTable.contractor_skill_id, BaseFilter.ComparisonOperator.EqualsTo, recId);
        ...
        protected virtual void skill_active_CheckedChanged(object sender, EventArgs args)
        {
           						
        }
            
        protected virtual void skill_name_TextChanged(object sender, EventArgs args)
        {
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseContractor_skillsRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseContractor_skillsRecordControl_Rec"] = value;
            }
        }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.CheckBox skill_active {
            get {
                return (System.Web.UI.WebControls.CheckBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "skill_active");
            }
        }
        ...
        public System.Web.UI.WebControls.TextBox skill_name {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "skill_name");
            }
        }
