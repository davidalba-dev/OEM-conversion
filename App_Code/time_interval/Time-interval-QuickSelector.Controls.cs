...
// Time_interval_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Time_interval_QuickSelector
{
...
// Base class for the SelectorTableControlRow control on the Time_interval_QuickSelector page.
...
public class BaseSelectorTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {
            // Load the data from the database into the DataSource DatabaseAYS_OEM%dbo.time_interval record.
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = Time_intervalTable.GetRecord(this.RecordUniqueId, true);
            ...
            this.DataSource = new Time_intervalRecord();
      ...
      // To customize, override this method in SelectorTableControlRow.
        ...
        public virtual void Delete()
        {
          ...
          Time_intervalTable.DeleteRecord(pkValue);
        ...
        public Time_intervalRecord DataSource {
            get {
                return (Time_intervalRecord)(this._DataSource);
            }
            set {
...
#region "Helper Properties"
    ...
    Time_intervalRecord rec = null;
        ...
        public virtual Time_intervalRecord GetRecord()
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return Time_intervalTable.GetRecord(this.RecordUniqueId, true);
...
// Base class for the SelectorTableControl control on the Time_interval_QuickSelector page.
...
public class BaseSelectorTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(OEMConversion.Business.Time_intervalRecord);
                      this.DataSource = (Time_intervalRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    Type myrec = typeof(OEMConversion.Business.Time_intervalRecord);
                    this.DataSource = (Time_intervalRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual Time_intervalRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(Time_intervalTable.Column1, true);          
            // selCols.Add(Time_intervalTable.Column2, true);          
            // selCols.Add(Time_intervalTable.Column3, true);          
                  ...
                  
            {
                ...
                return Time_intervalTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                Time_intervalTable databaseTable = new Time_intervalTable();
                ...
                return (recList.ToArray(typeof(Time_intervalRecord)) as Time_intervalRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0 || selCols.HasPrimaryKey())
                ...
                return Time_intervalTable.GetRecordCount(join, where);
            else
            {
                Time_intervalTable databaseTable = new Time_intervalTable();
                databaseTable.SelectedColumns.Clear();
        ...
        {    
            ...
            {
                BaseColumn col = Time_intervalTable.GetColumnByName(field);
            ...
            if (includeFormulaAndDFKAParameter) 
            {
                if (formula != "")
                {
                    foreach (BaseColumn col in MiscUtils.GetFormulaFieldList(formula, Time_intervalTable.Instance.TableDefinition))
                    {
                        if (col != null && !columnList.Contains(col))
                            columnList.Add(col);             
                    }
                ...
                {
                    BaseColumn col = Time_intervalTable.GetColumnByName(displayFieldName);
                    if (col != null && !columnList.Contains(col))
                        columnList.Add(col);             
                }
            }
      ...
      public override void DataBind()
      {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            Time_intervalTable.Instance.InnerFilter = null;
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.Search, this.GetFromSession(this.Search)), true, false);
		        ...
		        if (!string.IsNullOrEmpty(this.Page.Request["dependOnField"]) && this.Page.Request["dependOnVal"] != null) {
			          BaseColumn dependOnCol = Time_intervalTable.GetColumnByName(this.Page.GetDecryptedURLParameter("dependOnField"));
                if (dependOnCol != null){                
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_Search(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            OEMConversion.Business.Time_intervalRecord[] recordList  = Time_intervalTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (Time_intervalRecord rec in recordList ){
      ...
      Time_intervalRecord rec = new Time_intervalRecord();
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new Time_intervalRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(OEMConversion.Business.Time_intervalRecord);
                this.DataSource = (Time_intervalRecord[])(finalList.ToArray(myrec));
      ...
      this.Page.Response.Redirect(url);
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = Time_intervalTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  Time_intervalRecord[] DataSource {
            ...
            get {
                return (Time_intervalRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Time_interval_QuickSelector.SelectorTableControlRow")));
