...
namespace OEMConversion.UI.Controls.Edit_Role
{
...
public class RoleRecordControl : BaseRoleRecordControl
{
...
// Base class for the LoginTableControlRow control on the Edit_Role page.
...
public class BaseLoginTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setcustomer_contact_id()
        {
            ...
            if (this.PreviousUIData.ContainsKey(this.customer_contact_id.ID))
            {
                if (this.PreviousUIData[this.customer_contact_id.ID] == null)
                    selectedValue = null;
                else
                    selectedValue = this.PreviousUIData[this.customer_contact_id.ID].ToString();
            }
            
            
            // Set the customer_contact_id QuickSelector on the webpage with value from the
            ...
            // this.customer_contact_id is the ASP:QuickSelector on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.customer_contact_idSpecified)
            {
                            
                // If the customer_contact_id is non-NULL, then format the value.
            ...
            else
            {
                ...
                // customer_contact_id is NULL in the database, so use the Default Value.  
                // Default Value could also be NULL.
                if (this.DataSource != null && this.DataSource.IsCreated)
                    selectedValue = null;
                else
                    selectedValue = LoginTable.customer_contact_id.DefaultValue;
                				
            }			
                
            // Add the Please Select item.
            if (selectedValue == null || selectedValue == "")
                  MiscUtils.ResetSelectedItem(this.customer_contact_id, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "OEMConversion"), "--PLEASE_SELECT--"));
                        
                  
            // Populate the item(s) to the control
            
            this.customer_contact_id.SetFieldMaxLength(50);
                ...
                !MiscUtils.SetSelectedDisplayText(this.customer_contact_id, selectedValue))
            {
              ...
              url += "?Target=" + this.customer_contact_id.ClientID + "&DFKA=" + (this.Page as BaseApplicationPage).Encrypt("CustContactName")+ "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("CustContactKey")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--PLEASE_SELECT--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:PleaseSelect"))+ "&Mode=" + (this.Page as BaseApplicationPage).Encrypt("FieldValueSingleSelection") + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.customer_contact_id.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(customer_contact_id.AutoPostBack).ToLower() + ", event); return false;";
        ...
        public virtual void Setlogin_active()
        {
            ...
            if (this.PreviousUIData.ContainsKey(this.login_active.ID))
            {
                this.login_active.Checked = Convert.ToBoolean(this.PreviousUIData[this.login_active.ID]);
                return;
            }	
        ...
        public virtual void Settechnician_id()
        {
            ...
            // If selection was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.technician_id.ID))
            {
                if (this.PreviousUIData[this.technician_id.ID] == null)
                    selectedValue = null;
                else
                    selectedValue = this.PreviousUIData[this.technician_id.ID].ToString();
            }
        ...
        public virtual void Setuser_email()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.user_email.ID))
            {
            
                this.user_email.Text = this.PreviousUIData[this.user_email.ID].ToString();
        ...
        public virtual void Setcustomer_contact_idLabel()
                  {
        ...
        RoleRecordControl parentCtrl;
      
            parentCtrl = (RoleRecordControl)this.Page.FindControlRecursively("RoleRecordControl");
        ...
        throw new Exception(Page.GetResourceValue("Err:NoParentRecId", "OEMConversion"));
          ...
          this.DataSource.role_id = parentCtrl.DataSource.role_id;
        ...
        {
         // Retrieve the value entered by the user on the customer_contact_id ASP:QuickSelector, and
      ...
      // To customize, override this method in LoginTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersRoleRecordControl = false;
            hasFiltersRoleRecordControl = hasFiltersRoleRecordControl && false; // suppress warning
        ...
        LoginTableControl tc= ((LoginTableControl)MiscUtils.GetParentControlObject(this, "LoginTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((LoginTableControlRow)this);
                    }
                    this.Visible = false;
...
#region "Helper Properties"
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector customer_contact_id {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "customer_contact_id");
            }
        }              
            
        public System.Web.UI.WebControls.Literal customer_contact_idLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "customer_contact_idLabel");
            }
        }
...
// Base class for the LoginTableControl control on the Edit_Role page.
...
public class BaseLoginTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
      ...
      public override void DataBind()
      {
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(LoginTable.customer_contact_id, this.DataSource);
            this.Page.PregetDfkaRecords(LoginTable.technician_id, this.DataSource);
        }
    ...
    OEMConversion.UI.Controls.Edit_Role.RoleRecordControl roleRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "RoleRecordControl") as OEMConversion.UI.Controls.Edit_Role.RoleRecordControl);
          
              if (roleRecordControlObj != null && roleRecordControlObj.GetRecord() != null && roleRecordControlObj.GetRecord().IsCreated)
              {
              wc.iAND(LoginTable.role_id, BaseFilter.ComparisonOperator.EqualsTo, roleRecordControlObj.GetRecord().role_id.ToString());
              selectedRecordKeyValue.AddElement(LoginTable.role_id.InternalName, roleRecordControlObj.GetRecord().role_id.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInRoleRecordControl = HttpContext.Current.Session["LoginTableControlWhereClause"] as string;
      
      if (selectedRecordInRoleRecordControl != null && KeyValue.IsXmlKey(selectedRecordInRoleRecordControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInRoleRecordControl);
      
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(LoginTable.role_id))
      {
      wc.iAND(LoginTable.role_id, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(LoginTable.role_id).ToString());
      }
      ...
      LoginRecord rec = new LoginRecord();
                        ...
                        if (MiscUtils.IsValueSelected(recControl.customer_contact_id)) {
                            rec.Parse(recControl.customer_contact_id.SelectedItem.Value, LoginTable.customer_contact_id);
                        }
                        rec.login_active = recControl.login_active.Checked;
                
                        if (recControl.password.Text != "") {
                            rec.Parse(recControl.password.Text, LoginTable.password);
                  }
                
                        if (MiscUtils.IsValueSelected(recControl.technician_id)) {
                            rec.Parse(recControl.technician_id.SelectedItem.Value, LoginTable.technician_id);
                        }
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer Contact {Txt:Ascending}"), "customer_contact_id Asc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer Contact {Txt:Descending}"), "customer_contact_id Desc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Login Active {Txt:Ascending}"), "login_active Asc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Login Active {Txt:Descending}"), "login_active Desc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Technician {Txt:Ascending}"), "technician_id Asc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Technician {Txt:Descending}"), "technician_id Desc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("User Email {Txt:Ascending}"), "user_email Asc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("User Email {Txt:Descending}"), "user_email Desc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Username {Txt:Ascending}"), "username Asc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Username {Txt:Descending}"), "username Desc"));
                ...
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Corporatecontact {Txt:Ascending}"), "corporatecontact_id Asc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Corporatecontact {Txt:Descending}"), "corporatecontact_id Desc"));
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("LoginTableControlRepeater");
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        protected virtual void OrderSort1_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in LoginTable.GetColumns())
                  {
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(LoginTable.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (LoginTable.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && LoginTable.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(LoginTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(LoginTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (LoginTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        LoginTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual LoginTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (LoginTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_Role.LoginTableControlRow")));
...
public class BaseRoleRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseRoleRecordControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        {      
              ...
              this.role_name.TextChanged += role_name_TextChanged;
            
        }

        public virtual void LoadData()  
        {
            // Load the data from the database into the DataSource DatabaseAYS_OEM%dbo.role record.
            // It is better to make changes to functions called by LoadData such as
            // CreateWhereClause, rather than making changes here.
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = RoleTable.GetRecord(this.RecordUniqueId, true);
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "RoleRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            if (wc == null || !(wc.RunQuery)) {
                this.DataSource = new RoleRecord();
            ...
            RoleRecord[] recList = RoleTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = RoleTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public virtual void Setrole_name()
        {
            ...
            // DatabaseAYS_OEM%dbo.role database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.role record retrieved from the database.
            // this.role_name is the ASP:TextBox on the webpage.
                  
            if (this.DataSource != null && this.DataSource.role_nameSpecified) {
                								
                // If the role_name is non-NULL, then format the value.
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(RoleTable.role_name);
              ...
              this.role_name.Text = RoleTable.role_name.Format(RoleTable.role_name.DefaultValue);
        ...
        public virtual void Getrole_name()
        {
            ...
            // save it into the role_name field in DataSource DatabaseAYS_OEM%dbo.role record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.role_name.Text, RoleTable.role_name);							
      ...
      // To customize, override this method in RoleRecordControl.
         ...
         
        {
            ...
            WhereClause wc;
            RoleTable.Instance.InnerFilter = null;
            wc = new WhereClause();
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Role"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "Role"));
            }
        ...
        protected virtual void role_name_TextChanged(object sender, EventArgs args)
        {
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseRoleRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseRoleRecordControl_Rec"] = value;
            }
        }
        
        public RoleRecord DataSource {
            get {
                return (RoleRecord)(this._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox role_name {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "role_name");
            }
        }
    ...
    RoleRecord rec = null;
        ...
        public virtual RoleRecord GetRecord()
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return RoleTable.GetRecord(this.RecordUniqueId, true);
