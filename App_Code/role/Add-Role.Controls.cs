...
namespace OEMConversion.UI.Controls.Add_Role
{
...
// Base class for the LoginTableControlRow control on the Add_Role page.
...
// Base class for the LoginTableControl control on the Add_Role page.
...
public class BaseLoginTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Add_Role.RoleRecordControl roleRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "RoleRecordControl") as OEMConversion.UI.Controls.Add_Role.RoleRecordControl);
...
#region "Helper Functions"
        ...
        public virtual LoginTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (LoginTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Add_Role.LoginTableControlRow")));
...
public class BaseRoleRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (RoleRecord)RoleRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in RoleRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Role"];
