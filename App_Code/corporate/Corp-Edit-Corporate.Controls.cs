...
// Corp_Edit_Corporate.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Corp_Edit_Corporate
{
...
// Base class for the Corporate_contactsTableControlRow control on the Corp_Edit_Corporate page.
...
// Base class for the Corporate_contactsTableControl control on the Corp_Edit_Corporate page.
...
public class BaseCorporate_contactsTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Corp_Edit_Corporate.CorporateRecordControl corporateRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "CorporateRecordControl") as OEMConversion.UI.Controls.Corp_Edit_Corporate.CorporateRecordControl);
...
#region "Helper Functions"
        ...
        public virtual Corporate_contactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Corporate_contactsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Corp_Edit_Corporate.Corporate_contactsTableControlRow")));
...
// Base class for the CustomersTableControlRow control on the Corp_Edit_Corporate page.
...
// Base class for the CustomersTableControl control on the Corp_Edit_Corporate page.
...
#region "Helper Functions"
        ...
        public virtual CustomersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (CustomersTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Corp_Edit_Corporate.CustomersTableControlRow")));
...
// Base class for the CorporateRecordControl control on the Corp_Edit_Corporate page.
...
public class BaseCorporateRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setcorporate_active()
        {
            ...
            // Set the corporate_active Literal on the webpage with value from the
            ...
            // this.corporate_active is the ASP:Literal on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.corporate_activeSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(CorporateTable.corporate_active);
                                
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                this.corporate_active.Text = formattedValue;
              ...
              this.corporate_active.Text = CorporateTable.corporate_active.Format(CorporateTable.corporate_active.DefaultValue);
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal corporate_active {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "corporate_active");
            }
        }
