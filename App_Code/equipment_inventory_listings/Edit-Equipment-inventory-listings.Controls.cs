...
// Edit_Equipment_inventory_listings.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Equipment_inventory_listings
{
...
// Base class for the Equipment_inventory_listingsRecordControl control on the Edit_Equipment_inventory_listings page.
...
public class BaseEquipment_inventory_listingsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.listing_removal_confirmed_by.SelectedIndexChanged += listing_removal_confirmed_by_SelectedIndexChanged;
              ...
              this.listing_removal_confirm_date.TextChanged += listing_removal_confirm_date_TextChanged;
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "Equipment_inventory_listingsRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            this.DataSource = Equipment_inventory_listingsTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                Setlisting_removal_confirm_date();
                Setlisting_removal_confirm_dateLabel();
                Setlisting_removal_confirmed_by();
                Setlisting_removal_confirmed_byLabel();
        ...
        public virtual void Setlisting_removal_confirm_date()
        {
            
                    
            // Set the listing_removal_confirm_date TextBox on the webpage with value from the
            // DatabaseAYS_OEM%dbo.equipment_inventory_listings database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.equipment_inventory_listings record retrieved from the database.
            // this.listing_removal_confirm_date is the ASP:TextBox on the webpage.
                  
            if (this.DataSource != null && this.DataSource.listing_removal_confirm_dateSpecified) {
                								
                // If the listing_removal_confirm_date is non-NULL, then format the value.
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(Equipment_inventory_listingsTable.listing_removal_confirm_date, @"d");
                                
                this.listing_removal_confirm_date.Text = formattedValue;
                   
            } 
            
            else {
            
                // listing_removal_confirm_date is NULL in the database, so use the Default Value.  
                // Default Value could also be NULL.
        
              this.listing_removal_confirm_date.Text = Equipment_inventory_listingsTable.listing_removal_confirm_date.Format(Equipment_inventory_listingsTable.listing_removal_confirm_date.DefaultValue, @"d");
        ...
        public virtual void Setlisting_removal_confirmed_by()
        {
            ...
            // Set the listing_removal_confirmed_by DropDownList on the webpage with value from the
            // DatabaseAYS_OEM%dbo.equipment_inventory_listings database record.
            
            // this.DataSource is the DatabaseAYS_OEM%dbo.equipment_inventory_listings record retrieved from the database.
            // this.listing_removal_confirmed_by is the ASP:DropDownList on the webpage.
            
            // You can modify this method directly, or replace it with a call to
            //     base.Setlisting_removal_confirmed_by();
            // and add your own custom code before or after the call to the base function.

            
            if (this.DataSource != null && this.DataSource.listing_removal_confirmed_bySpecified)
            {
                            
                // If the listing_removal_confirmed_by is non-NULL, then format the value.
                // The Format method will return the Display Foreign Key As (DFKA) value
                selectedValue = this.DataSource.listing_removal_confirmed_by.ToString();
                
            }
            else
            {
                
                // listing_removal_confirmed_by is NULL in the database, so use the Default Value.  
                // Default Value could also be NULL.
                if (this.DataSource != null && this.DataSource.IsCreated)
                    selectedValue = null;
                else
                    selectedValue = Equipment_inventory_listingsTable.listing_removal_confirmed_by.DefaultValue;
            ...
            this.Populatelisting_removal_confirmed_byDropDownList(selectedValue, 100);              
        ...
        public virtual void Setlisting_start_date()
        {
            ...
            if (this.DataSource != null && this.DataSource.listing_start_dateSpecified) {
              ...
              this.listing_start_date.Text = Equipment_inventory_listingsTable.listing_start_date.Format(Equipment_inventory_listingsTable.listing_start_date.DefaultValue, @"d");
        ...
        public virtual void Setlisting_removal_confirm_dateLabel()
                  {
                  
                        this.listing_removal_confirm_dateLabel.Text = EvaluateFormula("\"Removal Confirm Date\"");
                      
                    
        }
                
        public virtual void Setlisting_removal_confirmed_byLabel()
                  {
                  
                        this.listing_removal_confirmed_byLabel.Text = EvaluateFormula("\"Confirmed By\"");
        ...
        public virtual void GetUIData()
        {
            ...
            Getlisting_amount();
            Getlisting_end_date();
            Getlisting_removal_confirm_date();
            Getlisting_removal_confirmed_by();
        ...
        public virtual void Getlisting_removal_confirm_date()
        {
            
            // Retrieve the value entered by the user on the listing_removal_confirm_date ASP:TextBox, and
            // save it into the listing_removal_confirm_date field in DataSource DatabaseAYS_OEM%dbo.equipment_inventory_listings record.
            // Parse will also validate the date to ensure it is of the proper format
            // and a valid date.  The format is verified based on the current culture 
            // settings including the order of month, day and year and the separator character.
            // Parse throws an exception if the date is invalid.
            ...
            // Save the value to data source
            this.DataSource.Parse(this.listing_removal_confirm_date.Text, Equipment_inventory_listingsTable.listing_removal_confirm_date);							
                          
                      
        }
                
        public virtual void Getlisting_removal_confirmed_by()
        {
         // Retrieve the value entered by the user on the listing_removal_confirmed_by ASP:DropDownList, and
            // save it into the listing_removal_confirmed_by field in DataSource DatabaseAYS_OEM%dbo.equipment_inventory_listings record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.listing_removal_confirmed_by), Equipment_inventory_listingsTable.listing_removal_confirmed_by);			
      ...
      // To customize, override this method in Equipment_inventory_listingsRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Equipment_inventory_listings"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "Equipment_inventory_listings"));
            }
            HttpContext.Current.Session["QueryString in Edit-Equipment-inventory-listings"] = recId;
        ...
        public virtual WhereClause CreateWhereClause_listing_removal_confirmed_byDropDownList() 
        {
            // By default, we simply return a new WhereClause.
            // Add additional where clauses to restrict the items shown in the dropdown list.
        ...
        // Fill the listing_removal_confirmed_by list.
        protected virtual void Populatelisting_removal_confirmed_byDropDownList(string selectedValue, int maxItems) 
        {
            		  					                
            this.listing_removal_confirmed_by.Items.Clear();
            
            // 1. Setup the static list items        
            
              // Add the Please Select item.
              this.listing_removal_confirmed_by.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "OEMConversion"), "--PLEASE_SELECT--"));
            		  			
            // 2. Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_listing_removal_confirmed_byDropDownList function.
            // It is better to customize the where clause there.
            
                      
            WhereClause wc = CreateWhereClause_listing_removal_confirmed_byDropDownList();
            ...
            // 3. Read a total of maxItems from the database and insert them into the listing_removal_confirmed_byDropDownList.
                ...
                do
                {
                    ...
                    foreach (TechniciansRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.technician_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.listing_removal_confirmed_by.Items.FindByValue(cvalue) == null)
                            {
                                     
                                Boolean _isExpandableNonCompositeForeignKey = Equipment_inventory_listingsTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Equipment_inventory_listingsTable.listing_removal_confirmed_by);
                                if(_isExpandableNonCompositeForeignKey && Equipment_inventory_listingsTable.listing_removal_confirmed_by.IsApplyDisplayAs)
                                    fvalue = Equipment_inventory_listingsTable.GetDFKA(itemValue, Equipment_inventory_listingsTable.listing_removal_confirmed_by);
                                ...
                                ListItem dupItem = this.listing_removal_confirmed_by.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.listing_removal_confirmed_by.Items.Add(newItem);
            ...
            if (selectedValue != null &&
                selectedValue.Trim() != "" &&
                !MiscUtils.SetSelectedValue(this.listing_removal_confirmed_by, selectedValue) &&
                !MiscUtils.SetSelectedDisplayText(this.listing_removal_confirmed_by, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        if (fvalue == null || fvalue.Trim() == "") fvalue = cvalue;
                        MiscUtils.ResetSelectedItem(this.listing_removal_confirmed_by, new ListItem(fvalue, cvalue));                      
                    }
                }
                catch
                {
        ...
        protected virtual void listing_removal_confirmed_by_SelectedIndexChanged(object sender, EventArgs args)
        {
            // for the value inserted by quick add button or large list selector, 
            // the value is necessary to be inserted by this event during postback 
            string val = (string)(this.Page.Session[listing_removal_confirmed_by.ClientID + "_SelectedValue"]);
            string displayText = (string)(this.Page.Session[listing_removal_confirmed_by.ClientID + "_SelectedDisplayText"]);
            if (!string.IsNullOrEmpty(displayText) && !string.IsNullOrEmpty(val)) {
	            this.listing_removal_confirmed_by.Items.Add(new ListItem(displayText, val));
	            this.listing_removal_confirmed_by.SelectedIndex = this.listing_removal_confirmed_by.Items.Count - 1;
	            this.Page.Session.Remove(listing_removal_confirmed_by.ClientID + "_SelectedValue");
	            this.Page.Session.Remove(listing_removal_confirmed_by.ClientID + "_SelectedDisplayText");
            }
        ...
        protected virtual void listing_removal_confirm_date_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox listing_removal_confirm_date {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "listing_removal_confirm_date");
            }
        }
            
        public System.Web.UI.WebControls.Literal listing_removal_confirm_dateLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "listing_removal_confirm_dateLabel");
            }
        }
        
        public System.Web.UI.WebControls.DropDownList listing_removal_confirmed_by {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "listing_removal_confirmed_by");
            }
        }
            
        public System.Web.UI.WebControls.Literal listing_removal_confirmed_byLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "listing_removal_confirmed_byLabel");
            }
        }
             ...
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return Equipment_inventory_listingsTable.GetRecord(this.RecordUniqueId, true);
