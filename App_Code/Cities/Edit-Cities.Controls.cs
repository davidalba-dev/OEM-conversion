...
// Edit_Cities.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Cities
{
...
// Base class for the RepairOrdersTableControlRow control on the Edit_Cities page.
...
public class BaseRepairOrdersTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        throw new Exception(Page.GetResourceValue("Err:NoParentRecId", "OEMConversion"));
          ...
          this.DataSource.ROCity = parentCtrl.DataSource.City;
...
// Base class for the RepairOrdersTableControl control on the Edit_Cities page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Edit_Cities.CitiesRecordControl citiesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "CitiesRecordControl") as OEMConversion.UI.Controls.Edit_Cities.CitiesRecordControl);
          
              if (citiesRecordControlObj != null && citiesRecordControlObj.GetRecord() != null && citiesRecordControlObj.GetRecord().IsCreated && citiesRecordControlObj.GetRecord().City != null)
              {
              wc.iAND(RepairOrdersTable.ROCity, BaseFilter.ComparisonOperator.EqualsTo, citiesRecordControlObj.GetRecord().City.ToString());
              selectedRecordKeyValue.AddElement(RepairOrdersTable.ROCity.InternalName, citiesRecordControlObj.GetRecord().City.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInCitiesRecordControl = HttpContext.Current.Session["RepairOrdersTableControlWhereClause"] as string;
      ...
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(RepairOrdersTable.ROCity))
      {
      wc.iAND(RepairOrdersTable.ROCity, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(RepairOrdersTable.ROCity).ToString());
      }
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_Cities.RepairOrdersTableControlRow")));
...
// Base class for the CitiesRecordControl control on the Edit_Cities page.
// Do not modify this class. Instead override any method in CitiesRecordControl.
public class BaseCitiesRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in CitiesRecordControl.
         ...
         
        {
            ...
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "Cities"));
            }
            HttpContext.Current.Session["QueryString in Edit-Cities"] = recId;
          ...
          wc.iAND(CitiesTable.City, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(CitiesTable.City));
        
          wc.iAND(CitiesTable.Country, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(CitiesTable.Country));
        
          wc.iAND(CitiesTable.ProvCode, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(CitiesTable.ProvCode));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(CitiesTable.City, BaseFilter.ComparisonOperator.EqualsTo, recId);
        
          wc.iAND(CitiesTable.Country, BaseFilter.ComparisonOperator.EqualsTo, recId);
        
          wc.iAND(CitiesTable.ProvCode, BaseFilter.ComparisonOperator.EqualsTo, recId);
