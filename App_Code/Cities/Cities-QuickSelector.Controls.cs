...
// Cities_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Cities_QuickSelector
{
...
// Base class for the SelectorTableControlRow control on the Cities_QuickSelector page.
...
// Base class for the SelectorTableControl control on the Cities_QuickSelector page.
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Cities_QuickSelector.SelectorTableControlRow")));
