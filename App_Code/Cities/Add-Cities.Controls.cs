...
// Add_Cities.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Cities
{
...
// Base class for the RepairOrdersTableControlRow control on the Add_Cities page.
...
// Base class for the RepairOrdersTableControl control on the Add_Cities page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Add_Cities.CitiesRecordControl citiesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "CitiesRecordControl") as OEMConversion.UI.Controls.Add_Cities.CitiesRecordControl);
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Add_Cities.RepairOrdersTableControlRow")));
...
// Base class for the CitiesRecordControl control on the Add_Cities page.
...
public class BaseCitiesRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in CitiesRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Add-Cities"] = recId;
