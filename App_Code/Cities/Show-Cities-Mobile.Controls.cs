...
// Show_Cities_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Cities_Mobile
{
...
// Base class for the RepairOrdersTableControlRow control on the Show_Cities_Mobile page.
...
// Base class for the RepairOrdersTableControl control on the Show_Cities_Mobile page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Show_Cities_Mobile.CitiesRecordControl citiesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "CitiesRecordControl") as OEMConversion.UI.Controls.Show_Cities_Mobile.CitiesRecordControl);
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Cities_Mobile.RepairOrdersTableControlRow")));
...
// Base class for the CitiesRecordControl control on the Show_Cities_Mobile page.
...
public class BaseCitiesRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in CitiesRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-Cities-Mobile"] = recId;
