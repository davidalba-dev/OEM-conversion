...
// Show_ApprovalMethods.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_ApprovalMethods
{
...
// Base class for the RepairOrdersTableControlRow control on the Show_ApprovalMethods page.
...
public class BaseRepairOrdersTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetROCondition()
        {
            ...
            // If the ROCondition is NULL or blank, then use the value specified  
            // on Properties.
            if (this.ROCondition.Text == null ||
                this.ROCondition.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.ROCondition.Text = "&nbsp;";
            }
...
// Base class for the RepairOrdersTableControl control on the Show_ApprovalMethods page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Show_ApprovalMethods.ApprovalMethodsRecordControl approvalMethodsRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "ApprovalMethodsRecordControl") as OEMConversion.UI.Controls.Show_ApprovalMethods.ApprovalMethodsRecordControl);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                    string url = "../RepairOrders/Add-RepairOrders.aspx?ROHowApproved={ApprovalMethodsRecordControl:FV:ApprovalMethod}&TabVisible=False&SaveAndNewVisible=False";
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-ApprovalMethods.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RepairOrders";
                // If Show-ApprovalMethods.PDFButton.report specifies a valid report template,
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.ROBillingNo)){
                                 report.AddData("${ROBillingNo}", "",ReportEnum.Align.Right, 300);
                             }else{
                                 ...
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  RepairOrdersTable.ROBillingNo.IsApplyDisplayAs){
                                     report.AddData("${ROBillingNo}", _DFKA,ReportEnum.Align.Right, 300);
                                 }else{
                                     report.AddData("${ROBillingNo}", record.Format(RepairOrdersTable.ROBillingNo), ReportEnum.Align.Right, 300);
                                 }
                             }
                             ...
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.ROCondition)){
                                 report.AddData("${ROCondition}", "",ReportEnum.Align.Left, 300);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 ...
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  RepairOrdersTable.ROCondition.IsApplyDisplayAs){
                                     report.AddData("${ROCondition}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${ROCondition}", record.Format(RepairOrdersTable.ROCondition), ReportEnum.Align.Left, 300);
                                 }
                             }
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-ApprovalMethods.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RepairOrders";
                // If Show-ApprovalMethods.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_ApprovalMethods.RepairOrdersTableControlRow")));
...
// Base class for the ApprovalMethodsRecordControl control on the Show_ApprovalMethods page.
...
public class BaseApprovalMethodsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "ApprovalMethodsRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            this.DataSource = ApprovalMethodsTable.GetRecord(recList[0].GetID().ToXmlString(), true);
      ...
      // To customize, override this method in ApprovalMethodsRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["ApprovalMethods"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "ApprovalMethods"));
            }
            HttpContext.Current.Session["QueryString in Show-ApprovalMethods"] = recId;
