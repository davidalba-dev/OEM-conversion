...
// Add_ApprovalMethods.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_ApprovalMethods
{
...
public class ApprovalMethodsRecordControl : BaseApprovalMethodsRecordControl
{
      
        // The BaseApprovalMethodsRecordControl implements the LoadData, DataBind and other
...
// Base class for the RepairOrdersTableControlRow control on the Add_ApprovalMethods page.
...
public class BaseRepairOrdersTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        ApprovalMethodsRecordControl parentCtrl;
      
            parentCtrl = (ApprovalMethodsRecordControl)this.Page.FindControlRecursively("ApprovalMethodsRecordControl");
        ...
        throw new Exception(Page.GetResourceValue("Err:NoParentRecId", "OEMConversion"));
          ...
          this.DataSource.ROHowApproved = parentCtrl.DataSource.ApprovalMethod;
      ...
      // To customize, override this method in RepairOrdersTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersApprovalMethodsRecordControl = false;
            hasFiltersApprovalMethodsRecordControl = hasFiltersApprovalMethodsRecordControl && false; // suppress warning
...
// Base class for the RepairOrdersTableControl control on the Add_ApprovalMethods page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Add_ApprovalMethods.ApprovalMethodsRecordControl approvalMethodsRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "ApprovalMethodsRecordControl") as OEMConversion.UI.Controls.Add_ApprovalMethods.ApprovalMethodsRecordControl);
          
              if (approvalMethodsRecordControlObj != null && approvalMethodsRecordControlObj.GetRecord() != null && approvalMethodsRecordControlObj.GetRecord().IsCreated && approvalMethodsRecordControlObj.GetRecord().ApprovalMethod != null)
              {
              wc.iAND(RepairOrdersTable.ROHowApproved, BaseFilter.ComparisonOperator.EqualsTo, approvalMethodsRecordControlObj.GetRecord().ApprovalMethod.ToString());
              selectedRecordKeyValue.AddElement(RepairOrdersTable.ROHowApproved.InternalName, approvalMethodsRecordControlObj.GetRecord().ApprovalMethod.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInApprovalMethodsRecordControl = HttpContext.Current.Session["RepairOrdersTableControlWhereClause"] as string;
      
      if (selectedRecordInApprovalMethodsRecordControl != null && KeyValue.IsXmlKey(selectedRecordInApprovalMethodsRecordControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInApprovalMethodsRecordControl);
      
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(RepairOrdersTable.ROHowApproved))
      {
      wc.iAND(RepairOrdersTable.ROHowApproved, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(RepairOrdersTable.ROHowApproved).ToString());
      }
      ...
      RepairOrdersRecord rec = new RepairOrdersRecord();
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("RO Billing Number {Txt:Ascending}"), "ROBillingNo Asc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("RO Billing Number {Txt:Descending}"), "ROBillingNo Desc"));
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Add_ApprovalMethods.RepairOrdersTableControlRow")));
...
// Base class for the ApprovalMethodsRecordControl control on the Add_ApprovalMethods page.
// Do not modify this class. Instead override any method in ApprovalMethodsRecordControl.
public class BaseApprovalMethodsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseApprovalMethodsRecordControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        // To customize, override this method in ApprovalMethodsRecordControl.
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
        ...
        {      
              ...
              this.Approve_active.CheckedChanged += Approve_active_CheckedChanged;
        ...
        public virtual void LoadData()  
        {
            ...
            ApprovalMethodsRecord[] recList = ApprovalMethodsTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = (ApprovalMethodsRecord)ApprovalMethodsRecord.Copy(recList[0], false);
        ...
        public virtual void SetApprove_active()
        {
            ...
            // Set the Approve_active CheckBox on the webpage with value from the
            // DatabaseAYS_OEM%dbo.ApprovalMethods database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.ApprovalMethods record retrieved from the database.
            // this.Approve_active is the ASP:CheckBox on the webpage.
                  
            if (this.DataSource != null && this.DataSource.Approve_activeSpecified) {
                							
                // If the Approve_active is non-NULL, then format the value.
                // The Format method will use the Display Format
                this.Approve_active.Checked = this.DataSource.Approve_active;
                ...
                // Default Value could also be NULL.
                if (!this.DataSource.IsCreated) 
                    this.Approve_active.Checked = ApprovalMethodsTable.Approve_active.ParseValue(ApprovalMethodsTable.Approve_active.DefaultValue).ToBoolean();                
        ...
        {	
            ...
            // Retrieve the value entered by the user on the Approve_active ASP:CheckBox, and
            // save it into the Approve_active field in DataSource DatabaseAYS_OEM%dbo.ApprovalMethods record.
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Approve_active = this.Approve_active.Checked;						
      ...
      // To customize, override this method in ApprovalMethodsRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["ApprovalMethods"];
            ...
            HttpContext.Current.Session["QueryString in Add-ApprovalMethods"] = recId;
          ...
          wc.iAND(ApprovalMethodsTable.ApprovalMethod, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(ApprovalMethodsTable.ApprovalMethod));
             
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(ApprovalMethodsTable.ApprovalMethod, BaseFilter.ComparisonOperator.EqualsTo, recId);
        ...
        protected virtual void Approve_active_CheckedChanged(object sender, EventArgs args)
        {
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseApprovalMethodsRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseApprovalMethodsRecordControl_Rec"] = value;
            }
        }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.CheckBox Approve_active {
            get {
                return (System.Web.UI.WebControls.CheckBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Approve_active");
            }
        }
    ...
    ApprovalMethodsRecord rec = null;
             ...
             
        {
            ...
            return new ApprovalMethodsRecord();
