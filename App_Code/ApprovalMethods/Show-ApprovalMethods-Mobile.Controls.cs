...
// Show_ApprovalMethods_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_ApprovalMethods_Mobile
{
...
// Base class for the RepairOrdersTableControlRow control on the Show_ApprovalMethods_Mobile page.
...
// Base class for the RepairOrdersTableControl control on the Show_ApprovalMethods_Mobile page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Show_ApprovalMethods_Mobile.ApprovalMethodsRecordControl approvalMethodsRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "ApprovalMethodsRecordControl") as OEMConversion.UI.Controls.Show_ApprovalMethods_Mobile.ApprovalMethodsRecordControl);
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Show_ApprovalMethods_Mobile.RepairOrdersTableControlRow")));
...
// Base class for the ApprovalMethodsRecordControl control on the Show_ApprovalMethods_Mobile page.
...
public class BaseApprovalMethodsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in ApprovalMethodsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-ApprovalMethods-Mobile"] = recId;
