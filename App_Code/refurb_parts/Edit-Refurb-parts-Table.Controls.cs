...
// Edit_Refurb_parts_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Refurb_parts_Table
{
...
// Base class for the Refurb_partsTableControlRow control on the Edit_Refurb_parts_Table page.
...
public class BaseRefurb_partsTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setrefurb_part_active()
        {
            ...
            if (this.PreviousUIData.ContainsKey(this.refurb_part_active.ID))
            {
                this.refurb_part_active.Checked = Convert.ToBoolean(this.PreviousUIData[this.refurb_part_active.ID]);
                return;
            }	
        ...
        public virtual void Setrefurb_part_cost()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.refurb_part_cost.ID))
            {
            
                this.refurb_part_cost.Text = this.PreviousUIData[this.refurb_part_cost.ID].ToString();
        ...
        public virtual void Setrefurb_part_name()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.refurb_part_name.ID))
            {
            
                this.refurb_part_name.Text = this.PreviousUIData[this.refurb_part_name.ID].ToString();
        ...
        public virtual void Setrefurb_part_number()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.refurb_part_number.ID))
            {
            
                this.refurb_part_number.Text = this.PreviousUIData[this.refurb_part_number.ID].ToString();
        ...
        public virtual void Setrefurb_part_retail()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.refurb_part_retail.ID))
            {
            
                this.refurb_part_retail.Text = this.PreviousUIData[this.refurb_part_retail.ID].ToString();
        ...
        public virtual void Setvendno()
        {
            ...
            {
                if (this.PreviousUIData[this.vendno.ID] == null)
                    selectedValue = null;
                else
                    selectedValue = this.PreviousUIData[this.vendno.ID].ToString();
            }
            
            
            // Set the vendno QuickSelector on the webpage with value from the
            // DatabaseAYS_OEM%dbo.refurb_parts database record.
            
            // this.DataSource is the DatabaseAYS_OEM%dbo.refurb_parts record retrieved from the database.
            // this.vendno is the ASP:QuickSelector on the webpage.
            ...
            if (selectedValue == null || selectedValue == "")
                  MiscUtils.ResetSelectedItem(this.vendno, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "OEMConversion"), "--PLEASE_SELECT--"));
                        
                  
            // Populate the item(s) to the control
            
            this.vendno.SetFieldMaxLength(50);
                ...
                !MiscUtils.SetSelectedDisplayText(this.vendno, selectedValue))
            {
              ...
              url += "?Target=" + this.vendno.ClientID + "&Formula=" + (this.Page as BaseApplicationPage).Encrypt("= Vendors.VendName")+ "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("VendNo")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--PLEASE_SELECT--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:PleaseSelect"))+ "&Mode=" + (this.Page as BaseApplicationPage).Encrypt("FieldValueSingleSelection") + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.vendno.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(vendno.AutoPostBack).ToLower() + ", event); return false;";
        ...
        {
         // Retrieve the value entered by the user on the vendno ASP:QuickSelector, and
...
#region "Helper Properties"
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector vendno {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "vendno");
            }
        }              
...
// Base class for the Refurb_partsTableControl control on the Edit_Refurb_parts_Table page.
...
public class BaseRefurb_partsTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
      ...
      Refurb_partsRecord rec = new Refurb_partsRecord();
                        ...
                        rec.refurb_part_active = recControl.refurb_part_active.Checked;
                        ...
                        if (MiscUtils.IsValueSelected(recControl.vendno)) {
                            rec.Parse(recControl.vendno.SelectedItem.Value, Refurb_partsTable.vendno);
                        }
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("Refurb_partsTableControlRepeater");
...
#region "Helper Functions"
        ...
        public virtual Refurb_partsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Refurb_partsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_Refurb_parts_Table.Refurb_partsTableControlRow")));
