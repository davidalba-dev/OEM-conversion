...
// Edit_Refurb_parts.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Refurb_parts
{
...
// Base class for the Refurb_partsRecordControl control on the Edit_Refurb_parts page.
...
public class BaseRefurb_partsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "Refurb_partsRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            this.DataSource = Refurb_partsTable.GetRecord(recList[0].GetID().ToXmlString(), true);
      ...
      // To customize, override this method in Refurb_partsRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Refurb_parts"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "Refurb_parts"));
            }
            HttpContext.Current.Session["QueryString in Edit-Refurb-parts"] = recId;
