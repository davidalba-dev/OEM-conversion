...
// Show_Loaner_request_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Loaner_request_Table
{
...
// Base class for the Loaner_requestTableControlRow control on the Show_Loaner_request_Table page.
...
public class BaseLoaner_requestTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setloaner_type_id()
        {
            ...
            if (this.DataSource != null && this.DataSource.loaner_type_idSpecified) {
              ...
              this.loaner_type_id.Text = Loaner_requestTable.loaner_type_id.Format(Loaner_requestTable.loaner_type_id.DefaultValue);
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void custcontactkey_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../CustomerContacts/Edit-CustomerContacts.aspx?CustomerContacts={Loaner_requestTableControlRow:FK:FK_loaner_request_CustomerContacts}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void custno_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Customers/Edit-Customers.aspx?Customers={Loaner_requestTableControlRow:FK:FK_loaner_request_Customers}";
...
// Base class for the Loaner_requestTableControl control on the Show_Loaner_request_Table page.
...
public class BaseLoaner_requestTableControl : OEMConversion.UI.BaseApplicationTableControl
{
       ...
       public BaseLoaner_requestTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.loaner_status_idFilter)) 				
                    initialVal = this.GetFromSession(this.loaner_status_idFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"loaner_status_id\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.loaner_status_idFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.loaner_status_idFilter.SelectedValue = initialVal;
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.request_type_idFilter)) 				
                    initialVal = this.GetFromSession(this.request_type_idFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"request_type_id\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.request_type_idFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.request_type_idFilter.SelectedValue = initialVal;
            ...
            else
            {
                ...
                this.CurrentSortOrder.Add(Loaner_requestTable.loaner_return_date, OrderByItem.OrderDir.Desc);
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
              ...
              this.loaner_end_dateLabel.Click += loaner_end_dateLabel_Click;
            
              this.loaner_start_dateLabel.Click += loaner_start_dateLabel_Click;
            ...
            this.loaner_status_idFilter.SelectedIndexChanged += new EventHandler(loaner_status_idFilter_SelectedIndexChanged);
            
            this.request_type_idFilter.SelectedIndexChanged += new EventHandler(request_type_idFilter_SelectedIndexChanged);
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                Setloaner_status_idFilter();
                Setloaner_status_idLabel();
                Setloaner_status_idLabel1();
                Setloaner_type_idLabel();
                
                Setno_chargeLabel();
                
                
                Setrequest_type_idFilter();
                Setrequest_type_idLabel();
                Setrequest_type_idLabel1();
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public virtual void ResetControl()
        {
            ...
            this.loaner_status_idFilter.ClearSelection();
            
            this.request_type_idFilter.ClearSelection();
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.loaner_status_idFilter)) {
                        
                wc.iAND(Loaner_requestTable.loaner_status_id, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.loaner_status_idFilter, this.GetFromSession(this.loaner_status_idFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.request_type_idFilter)) {
                        
                wc.iAND(Loaner_requestTable.request_type_id, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.request_type_idFilter, this.GetFromSession(this.request_type_idFilter)), false, false);
      ...
      cols.Add(Loaner_requestTable.custcontactkey, true);
      
      cols.Add(Loaner_requestTable.custno, true);
      ...
      String loaner_status_idFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "loaner_status_idFilter_Ajax"];
            if (MiscUtils.IsValueSelected(loaner_status_idFilterSelectedValue)) {

              
                wc.iAND(Loaner_requestTable.loaner_status_id, BaseFilter.ComparisonOperator.EqualsTo, loaner_status_idFilterSelectedValue, false, false);
                      
      }
                      
      String request_type_idFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "request_type_idFilter_Ajax"];
            if (MiscUtils.IsValueSelected(request_type_idFilterSelectedValue)) {

              
                wc.iAND(Loaner_requestTable.request_type_id, BaseFilter.ComparisonOperator.EqualsTo, request_type_idFilterSelectedValue, false, false);
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_SearchText(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            OEMConversion.Business.Loaner_requestRecord[] recordList  = Loaner_requestTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (Loaner_requestRecord rec in recordList ){
                ...
                resultItem = rec.Format(Loaner_requestTable.custcontactkey);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(Loaner_requestTable.custcontactkey.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, Loaner_requestTable.custcontactkey.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                resultItem = rec.Format(Loaner_requestTable.custno);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(Loaner_requestTable.custno.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, Loaner_requestTable.custno.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
      ...
      Loaner_requestRecord rec = new Loaner_requestRecord();
                        ...
                        if (recControl.loaner_type_id.Text != "") {
                            rec.Parse(recControl.loaner_type_id.Text, Loaner_requestTable.loaner_type_id);
                  }
        ...
        public virtual void Setloaner_status_idLabel1()
                  {
                  
                        this.loaner_status_idLabel1.Text = EvaluateFormula("\"Status\"");
        ...
        public virtual void Setrequest_type_idLabel1()
                  {
        ...
        public virtual void Setloaner_status_idFilter()
        {
            
            this.Populateloaner_status_idFilter(MiscUtils.GetSelectedValue(this.loaner_status_idFilter,  GetFromSession(this.loaner_status_idFilter)), 500);					
                                     
        }
            
        public virtual void Setrequest_type_idFilter()
        {
            
            this.Populaterequest_type_idFilter(MiscUtils.GetSelectedValue(this.request_type_idFilter,  GetFromSession(this.request_type_idFilter)), 500);					
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Loaner End Date {Txt:Ascending}"), "loaner_end_date Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Loaner End Date {Txt:Descending}"), "loaner_end_date Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Loaner Inventory {Txt:Ascending}"), "loaner_inventory_id Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Loaner Inventory {Txt:Descending}"), "loaner_inventory_id Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Loaner Rate {Txt:Ascending}"), "loaner_rate Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Loaner Rate {Txt:Descending}"), "loaner_rate Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Loaner Start Date {Txt:Ascending}"), "loaner_start_date Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Loaner Start Date {Txt:Descending}"), "loaner_start_date Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Loaner Status {Txt:Ascending}"), "loaner_status_id Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Loaner Status {Txt:Descending}"), "loaner_status_id Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Loaner Type {Txt:Ascending}"), "loaner_type_id Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Loaner Type {Txt:Descending}"), "loaner_type_id Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("No Charge {Txt:Ascending}"), "no_charge Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("No Charge {Txt:Descending}"), "no_charge Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Loaner Returned To {Txt:Ascending}"), "loaner_returned_to Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Loaner Returned To {Txt:Descending}"), "loaner_returned_to Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Loaner Return Date {Txt:Ascending}"), "loaner_return_date Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Loaner Return Date {Txt:Descending}"), "loaner_return_date Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Request Type {Txt:Ascending}"), "request_type_id Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Request Type {Txt:Descending}"), "request_type_id Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Delivered By {Txt:Ascending}"), "delivered_by Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Delivered By {Txt:Descending}"), "delivered_by Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Rono {Txt:Ascending}"), "rono Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Rono {Txt:Descending}"), "rono Desc"));
        ...
        // Get the filters' data for loaner_status_idFilter.
                
        protected virtual void Populateloaner_status_idFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.loaner_status_idFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_loaner_status_idFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_loaner_status_idFilter function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.loaner_status_idFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
                ...
                do
                {
                    ...
                    foreach (Loaner_statusRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.loaner_status_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.loaner_status_idFilter.Items.FindByValue(cvalue) == null)
                            {
                                    
                                Boolean _isExpandableNonCompositeForeignKey = Loaner_requestTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Loaner_requestTable.loaner_status_id);
                                if(_isExpandableNonCompositeForeignKey && Loaner_requestTable.loaner_status_id.IsApplyDisplayAs)
                                     fvalue = Loaner_requestTable.GetDFKA(itemValue, Loaner_requestTable.loaner_status_id);
                                if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
                                     fvalue = itemValue.Format(Loaner_statusTable.loaner_status_id);
                                ...
                                ListItem dupItem = this.loaner_status_idFilter.Items.FindByText(fvalue);
                                ...
                                this.loaner_status_idFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.loaner_status_idFilter, selectedValue);
            ...
            if (this.loaner_status_idFilter.SelectedValue != null && this.loaner_status_idFilter.Items.FindByValue(this.loaner_status_idFilter.SelectedValue) == null)
                this.loaner_status_idFilter.SelectedValue = null;
                           
        }
            
        // Get the filters' data for request_type_idFilter.
                
        protected virtual void Populaterequest_type_idFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.request_type_idFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_request_type_idFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_request_type_idFilter function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.request_type_idFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
                ...
                do
                {
                    ...
                    foreach (Request_typeRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.request_type_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.request_type_idFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                fvalue = EvaluateFormula("= Request_type.request_type", itemValue , variables, evaluator);
                                ...
                                ListItem dupItem = this.request_type_idFilter.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.request_type_idFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.request_type_idFilter, selectedValue);
            ...
            if (this.request_type_idFilter.SelectedValue != null && this.request_type_idFilter.Items.FindByValue(this.request_type_idFilter.SelectedValue) == null)
                this.request_type_idFilter.SelectedValue = null;
                           
        }
            
        public virtual WhereClause CreateWhereClause_loaner_status_idFilter()
        {
            // Create a where clause for the filter loaner_status_idFilter.
            // This function is called by the Populate method to load the items 
            // in the loaner_status_idFilterDropDownList
        ...
        public virtual WhereClause CreateWhereClause_request_type_idFilter()
        {
            // Create a where clause for the filter request_type_idFilter.
            // This function is called by the Populate method to load the items 
            // in the request_type_idFilterDropDownList
        CompoundFilter filter = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
            WhereClause whereClause = new WhereClause();
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.loaner_status_idFilter, this.loaner_status_idFilter.SelectedValue);
                  
            this.SaveToSession(this.request_type_idFilter, this.request_type_idFilter.SelectedValue);
      ...
      this.SaveToSession("loaner_status_idFilter_Ajax", this.loaner_status_idFilter.SelectedValue);
              
      this.SaveToSession("request_type_idFilter_Ajax", this.request_type_idFilter.SelectedValue);
      ...
      this.SaveToSession("SearchText_Ajax", this.SearchText.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.loaner_status_idFilter);
            this.RemoveFromSession(this.request_type_idFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                    string url = "../loaner_request/Add-Loaner-request.aspx?TabVisible=False&SaveAndNewVisible=False";
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "Loaner_requestTableControl_PostbackTracker").ClientID);                           
                                
                string javascriptCall = "";
                
                    javascriptCall = "initializePopupPage(document.getElementById('" + MiscUtils.FindControlRecursively(this, "Loaner_requestTableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(loaner_status_idFilter))
                themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        
            if (MiscUtils.IsValueSelected(request_type_idFilter))
                themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        ...
        public virtual void loaner_end_dateLabel_Click(object sender, EventArgs args)
        {
            //Sorts by loaner_end_date when clicked.
              
            // Get previous sorting state for loaner_end_date.
        
            OrderByItem sd = this.CurrentSortOrder.Find(Loaner_requestTable.loaner_end_date);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for loaner_end_date.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(Loaner_requestTable.loaner_end_date, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by loaner_end_date, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void loaner_start_dateLabel_Click(object sender, EventArgs args)
        {
            //Sorts by loaner_start_date when clicked.
              
            // Get previous sorting state for loaner_start_date.
        
            OrderByItem sd = this.CurrentSortOrder.Find(Loaner_requestTable.loaner_start_date);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for loaner_start_date.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(Loaner_requestTable.loaner_start_date, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by loaner_start_date, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Loaner-request-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "loaner_request";
                // If Show-Loaner-request-Table.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Loaner-request-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "loaner_request";
                // If Show-Loaner-request-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        protected virtual void SortControl_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in Loaner_requestTable.GetColumns())
                  {
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(Loaner_requestTable.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (Loaner_requestTable.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && Loaner_requestTable.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(Loaner_requestTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(Loaner_requestTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
        ...
        protected virtual void loaner_status_idFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
        ...
        // event handler for FieldFilter
        protected virtual void request_type_idFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton loaner_end_dateLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "loaner_end_dateLabel");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton loaner_start_dateLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "loaner_start_dateLabel");
            }
        }
        
        public System.Web.UI.WebControls.DropDownList loaner_status_idFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "loaner_status_idFilter");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal loaner_status_idLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "loaner_status_idLabel1");
            }
        }
        ...
        public System.Web.UI.WebControls.DropDownList request_type_idFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "request_type_idFilter");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal request_type_idLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "request_type_idLabel1");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual Loaner_requestTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Loaner_requestTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Loaner_request_Table.Loaner_requestTableControlRow")));
