...
// Add_Loaner_request.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Loaner_request
{
...
// Base class for the Loaner_requestRecordControl control on the Add_Loaner_request page.
...
public class BaseLoaner_requestRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setcustno()
        {
            ...
            this.PopulatecustnoDropDownList(selectedValue, 5000);              
        ...
        public virtual void Getcreated_by()
        {
         // Retrieve the value entered by the user on the created_by ASP:DropDownList, and
            // save it into the created_by field in DataSource DatabaseAYS_OEM%dbo.loaner_request record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.created_by), Loaner_requestTable.created_by);			
      ...
      // To customize, override this method in Loaner_requestRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Add-Loaner-request"] = recId;
        ...
        protected virtual void Populateloaner_inventory_idDropDownList(string selectedValue, int maxItems) 
        {
            ...
            OrderBy orderBy = new OrderBy(false, false);
                          orderBy.Add(Loaner_inventoryTable.make, OrderByItem.OrderDir.Asc);
              orderBy.Add(Loaner_inventoryTable.model, OrderByItem.OrderDir.Asc);
