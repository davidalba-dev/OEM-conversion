...
// Edit_Resource_sch_time_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Resource_sch_time_Mobile
{
...
// Base class for the Resource_sch_timeRecordControl control on the Edit_Resource_sch_time_Mobile page.
...
public class BaseResource_sch_timeRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in Resource_sch_timeRecordControl.
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            if (EvaluateFormula("URL(\"resource_sch_time\")", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Resource_sch_timeTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"resource_sch_time_.resource_sch_time_id"), EvaluateFormula("URL(\"resource_sch_time\")", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("URL(\"resource_sch_time\")", false) == "--PLEASE_SELECT--" || EvaluateFormula("URL(\"resource_sch_time\")", false) == "--ANY--") whereClause.RunQuery = false;
