...
// Add_Resource_sch_time.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Resource_sch_time
{
...
// Base class for the Resource_sch_timeRecordControl control on the Add_Resource_sch_time page.
...
public class BaseResource_sch_timeRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.resource_sch_technician_id1.SelectedIndexChanged += resource_sch_technician_id1_SelectedIndexChanged;
            
              this.time_interval_id.SelectedIndexChanged += time_interval_id_SelectedIndexChanged;
            
              this.resource_sch_ticket_id.TextChanged += resource_sch_ticket_id_TextChanged;
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                Setresource_sch_technician_id1();
        ...
        public virtual void Setresource_sch_technician_id1()
        {
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.resource_sch_time record retrieved from the database.
            // this.resource_sch_technician_id1 is the ASP:DropDownList on the webpage.
            
            // You can modify this method directly, or replace it with a call to
            //     base.Setresource_sch_technician_id1();
            // and add your own custom code before or after the call to the base function.
            ...
            this.Populateresource_sch_technician_id1DropDownList(selectedValue, 100);              
        ...
        public virtual void Setresource_sch_ticket_id()
        {
            ...
            // Set the resource_sch_ticket_id TextBox on the webpage with value from the
            // DatabaseAYS_OEM%dbo.resource_sch_time database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.resource_sch_time record retrieved from the database.
            // this.resource_sch_ticket_id is the ASP:TextBox on the webpage.
                  
            if (this.DataSource != null && this.DataSource.IsCreated) {
                								
                // If the resource_sch_ticket_id is non-NULL, then format the value.
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = this.DataSource.resource_sch_ticket_id.ToString();
              ...
              this.resource_sch_ticket_id.Text = EvaluateFormula("URL(\"resource_sch_ticket_id\")", this.DataSource);
        ...
        public virtual void Setresource_sch_time_date()
        {
            ...
            if (this.DataSource != null && this.DataSource.resource_sch_time_dateSpecified) {
               ...
               string formattedValue = this.DataSource.Format(Resource_sch_timeTable.resource_sch_time_date, @"g");
              ...
              this.resource_sch_time_date.Text = Resource_sch_timeTable.resource_sch_time_date.Format(Resource_sch_timeTable.resource_sch_time_date.DefaultValue, @"g");
        ...
        public virtual void Setresource_sch_technician_idLabel()
                  {
                      ...
                      //this.resource_sch_technician_idLabel.Text = "Some value";
        ...
        public virtual void GetUIData()
        {
            ...
            Getresource_sch_technician_id1();
        ...
        public virtual void Getresource_sch_technician_id1()
        {
         // Retrieve the value entered by the user on the resource_sch_technician_id ASP:DropDownList, and
            // save it into the resource_sch_technician_id field in DataSource DatabaseAYS_OEM%dbo.resource_sch_time record.
            ...
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.resource_sch_technician_id1), Resource_sch_timeTable.resource_sch_technician_id);			
        ...
        public virtual void Getresource_sch_ticket_id()
        {
            ...
            // Retrieve the value entered by the user on the resource_sch_ticket_id ASP:TextBox, and
            // save it into the resource_sch_ticket_id field in DataSource DatabaseAYS_OEM%dbo.resource_sch_time record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.resource_sch_ticket_id.Text, Resource_sch_timeTable.resource_sch_ticket_id);							
      ...
      // To customize, override this method in Resource_sch_timeRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Add-Resource-sch-time"] = recId;
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            this.Page.Authorize((Control)resource_sch_technician_id, "1;2");
					
            this.Page.Authorize((Control)resource_sch_technician_id1, "3");
					
            this.Page.Authorize((Control)resource_sch_technician_idLabel, "3");
        ...
        public virtual WhereClause CreateWhereClause_resource_sch_technician_id1DropDownList() 
        {
            // By default, we simply return a new WhereClause.
            // Add additional where clauses to restrict the items shown in the dropdown list.
        ...
        // Fill the resource_sch_technician_id1 list.
        protected virtual void Populateresource_sch_technician_id1DropDownList(string selectedValue, int maxItems) 
        {
            		  					                
            this.resource_sch_technician_id1.Items.Clear();
            
            // 1. Setup the static list items        
            		  			
            // 2. Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_resource_sch_technician_id1DropDownList function.
            // It is better to customize the where clause there.
            
                      
            WhereClause wc = CreateWhereClause_resource_sch_technician_id1DropDownList();
            ...
            // 3. Read a total of maxItems from the database and insert them into the resource_sch_technician_id1DropDownList.
            TechniciansRecord[] itemValues  = null;
            if (wc.RunQuery)
            {
                int counter = 0;
                ...
                do
                {
                    ...
                    foreach (TechniciansRecord itemValue in itemValues) 
                    {
                        ...
                        {
                            cvalue = itemValue.technician_id.ToString().ToString();
                            if (counter < maxItems && this.resource_sch_technician_id1.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                ListItem dupItem = this.resource_sch_technician_id1.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.resource_sch_technician_id1.Items.Add(newItem);
            ...
            if (selectedValue != null &&
                selectedValue.Trim() != "" &&
                !MiscUtils.SetSelectedValue(this.resource_sch_technician_id1, selectedValue) &&
                !MiscUtils.SetSelectedDisplayText(this.resource_sch_technician_id1, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        if (fvalue == null || fvalue.Trim() == "") fvalue = cvalue;
                        MiscUtils.ResetSelectedItem(this.resource_sch_technician_id1, new ListItem(fvalue, cvalue));                      
                    }
                }
                catch
                {
        ...
        protected virtual void resource_sch_technician_id1_SelectedIndexChanged(object sender, EventArgs args)
        {
            // for the value inserted by quick add button or large list selector, 
            // the value is necessary to be inserted by this event during postback 
            string val = (string)(this.Page.Session[resource_sch_technician_id1.ClientID + "_SelectedValue"]);
            string displayText = (string)(this.Page.Session[resource_sch_technician_id1.ClientID + "_SelectedDisplayText"]);
            if (!string.IsNullOrEmpty(displayText) && !string.IsNullOrEmpty(val)) {
	            this.resource_sch_technician_id1.Items.Add(new ListItem(displayText, val));
	            this.resource_sch_technician_id1.SelectedIndex = this.resource_sch_technician_id1.Items.Count - 1;
	            this.Page.Session.Remove(resource_sch_technician_id1.ClientID + "_SelectedValue");
	            this.Page.Session.Remove(resource_sch_technician_id1.ClientID + "_SelectedDisplayText");
            }
        ...
        protected virtual void resource_sch_ticket_id_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList resource_sch_technician_id1 {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "resource_sch_technician_id1");
            }
        }
        ...
        public System.Web.UI.WebControls.TextBox resource_sch_ticket_id {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "resource_sch_ticket_id");
            }
        }
        ...
        public System.Web.UI.WebControls.Label resource_sch_time_minLabel {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "resource_sch_time_minLabel");
            }
        }
