...
// Add_Timesheet_Resource_sch_time.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Timesheet_Resource_sch_time
{
...
// Base class for the Resource_sch_timeRecordControl control on the Add_Timesheet_Resource_sch_time page.
...
public class BaseResource_sch_timeRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Settime_interval_idLabel()
                  {
      ...
      // To customize, override this method in Resource_sch_timeRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Add-Timesheet-Resource-sch-time"] = recId;
        ...
        protected virtual void Populateresource_sch_ticket_idDropDownList(string selectedValue, int maxItems) 
        {
            ...
            OrderBy orderBy = new OrderBy(false, false);
                          orderBy.Add(Resource_sch_ticketTable.project_id, OrderByItem.OrderDir.Asc);
                    ...
                    foreach (Resource_sch_ticketRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.resource_sch_ticket_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.resource_sch_ticket_id.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                fvalue = EvaluateFormula("=\"Ticket#\" + \"-\" + resource_sch_ticket_id + \"-\" + Resource_sch_ticket.subject", itemValue, variables2, evaluator);
                ...
                !MiscUtils.SetSelectedDisplayText(this.resource_sch_ticket_id, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        fvalue = EvaluateFormula("=\"Ticket#\" + \"-\" + resource_sch_ticket_id + \"-\" + Resource_sch_ticket.subject", itemValue, variables2, evaluator2);
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal time_interval_idLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "time_interval_idLabel");
            }
        }
