...
// Edit_Resource_sch_time.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Resource_sch_time
{
...
// Base class for the Resource_sch_timeRecordControl control on the Edit_Resource_sch_time page.
...
public class BaseResource_sch_timeRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "Resource_sch_timeRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            this.DataSource = Resource_sch_timeTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public virtual void Setresource_sch_technician_id()
        {
            ...
            // Set the resource_sch_technician_id Literal on the webpage with value from the
            ...
            // this.resource_sch_technician_id is the ASP:Literal on the webpage.
        ...
        public virtual void Settime_interval_id()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = Resource_sch_timeTable.time_interval_id.DefaultValue;
      ...
      // To customize, override this method in Resource_sch_timeRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Resource_sch_time"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "Resource_sch_time"));
            }
            HttpContext.Current.Session["QueryString in Edit-Resource-sch-time"] = recId;
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal resource_sch_technician_id {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "resource_sch_technician_id");
            }
        }
