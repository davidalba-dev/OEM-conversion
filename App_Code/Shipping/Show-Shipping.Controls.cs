...
// Show_Shipping.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Shipping
{
...
public class ShippingRecordControl : BaseShippingRecordControl
{
      
        // The BaseShippingRecordControl implements the LoadData, DataBind and other
...
// Base class for the RepairOrdersTableControlRow control on the Show_Shipping page.
...
public class BaseRepairOrdersTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        ShippingRecordControl parentCtrl;
      
            parentCtrl = (ShippingRecordControl)this.Page.FindControlRecursively("ShippingRecordControl");
        ...
        throw new Exception(Page.GetResourceValue("Err:NoParentRecId", "OEMConversion"));
          ...
          this.DataSource.ROShipVia = parentCtrl.DataSource.ShipVia;
      ...
      // To customize, override this method in RepairOrdersTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersShippingRecordControl = false;
            hasFiltersShippingRecordControl = hasFiltersShippingRecordControl && false; // suppress warning
...
// Base class for the RepairOrdersTableControl control on the Show_Shipping page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Show_Shipping.ShippingRecordControl shippingRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "ShippingRecordControl") as OEMConversion.UI.Controls.Show_Shipping.ShippingRecordControl);
          
              if (shippingRecordControlObj != null && shippingRecordControlObj.GetRecord() != null && shippingRecordControlObj.GetRecord().IsCreated && shippingRecordControlObj.GetRecord().ShipVia != null)
              {
              wc.iAND(RepairOrdersTable.ROShipVia, BaseFilter.ComparisonOperator.EqualsTo, shippingRecordControlObj.GetRecord().ShipVia.ToString());
              selectedRecordKeyValue.AddElement(RepairOrdersTable.ROShipVia.InternalName, shippingRecordControlObj.GetRecord().ShipVia.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInShippingRecordControl = HttpContext.Current.Session["RepairOrdersTableControlWhereClause"] as string;
      
      if (selectedRecordInShippingRecordControl != null && KeyValue.IsXmlKey(selectedRecordInShippingRecordControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInShippingRecordControl);
      
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(RepairOrdersTable.ROShipVia))
      {
      wc.iAND(RepairOrdersTable.ROShipVia, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(RepairOrdersTable.ROShipVia).ToString());
      }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                    string url = "../RepairOrders/Add-RepairOrders.aspx?ROShipVia={ShippingRecordControl:FV:ShipVia}&TabVisible=False&SaveAndNewVisible=False";
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Shipping.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RepairOrders";
                // If Show-Shipping.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Shipping.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RepairOrders";
                // If Show-Shipping.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Shipping.RepairOrdersTableControlRow")));
...
// Base class for the ShippingRecordControl control on the Show_Shipping page.
// Do not modify this class. Instead override any method in ShippingRecordControl.
public class BaseShippingRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseShippingRecordControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        // To customize, override this method in ShippingRecordControl.
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "ShippingRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            ShippingRecord[] recList = ShippingTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = ShippingTable.GetRecord(recList[0].GetID().ToXmlString(), true);
      ...
      // To customize, override this method in ShippingRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Shipping"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "Shipping"));
            }
            HttpContext.Current.Session["QueryString in Show-Shipping"] = recId;
          ...
          wc.iAND(ShippingTable.ShipVia, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(ShippingTable.ShipVia));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(ShippingTable.ShipVia, BaseFilter.ComparisonOperator.EqualsTo, recId);
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseShippingRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseShippingRecordControl_Rec"] = value;
            }
        }
