...
// Show_Shipping_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Shipping_Mobile
{
...
// Base class for the RepairOrdersTableControlRow control on the Show_Shipping_Mobile page.
...
// Base class for the RepairOrdersTableControl control on the Show_Shipping_Mobile page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Show_Shipping_Mobile.ShippingRecordControl shippingRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "ShippingRecordControl") as OEMConversion.UI.Controls.Show_Shipping_Mobile.ShippingRecordControl);
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Shipping_Mobile.RepairOrdersTableControlRow")));
...
// Base class for the ShippingRecordControl control on the Show_Shipping_Mobile page.
...
public class BaseShippingRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in ShippingRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-Shipping-Mobile"] = recId;
