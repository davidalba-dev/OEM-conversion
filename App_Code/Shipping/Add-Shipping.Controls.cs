...
// Add_Shipping.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Shipping
{
...
// Base class for the RepairOrdersTableControlRow control on the Add_Shipping page.
...
// Base class for the RepairOrdersTableControl control on the Add_Shipping page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Add_Shipping.ShippingRecordControl shippingRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "ShippingRecordControl") as OEMConversion.UI.Controls.Add_Shipping.ShippingRecordControl);
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Add_Shipping.RepairOrdersTableControlRow")));
...
// Base class for the ShippingRecordControl control on the Add_Shipping page.
...
public class BaseShippingRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.shipping_active.CheckedChanged += shipping_active_CheckedChanged;
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (ShippingRecord)ShippingRecord.Copy(recList[0], false);
        ...
        public virtual void Setshipping_active()
        {
            ...
            // Set the shipping_active CheckBox on the webpage with value from the
            ...
            if (this.DataSource != null && this.DataSource.shipping_activeSpecified) {
                ...
                // Default Value could also be NULL.
                if (!this.DataSource.IsCreated) 
                    this.shipping_active.Checked = ShippingTable.shipping_active.ParseValue(ShippingTable.shipping_active.DefaultValue).ToBoolean();                
        ...
        public virtual void Setshipping_activeLabel()
                  {
                      ...
                      //Code for the text property is generated inside the .aspx file. 
                      //To override this property you can uncomment the following property and add you own value.
                      //this.shipping_activeLabel.Text = "Some value";
        ...
        {	
            ...
            // Retrieve the value entered by the user on the shipping_active ASP:CheckBox, and
            // save it into the shipping_active field in DataSource DatabaseAYS_OEM%dbo.Shipping record.
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.shipping_active = this.shipping_active.Checked;						
      ...
      // To customize, override this method in ShippingRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Shipping"];
            ...
            HttpContext.Current.Session["QueryString in Add-Shipping"] = recId;
        ...
        protected virtual void shipping_active_CheckedChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.CheckBox shipping_active {
            get {
                return (System.Web.UI.WebControls.CheckBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "shipping_active");
            }
        }
