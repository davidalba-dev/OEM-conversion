...
// Add_Warehouse.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Warehouse
{
...
// Base class for the WarehouseRecordControl control on the Add_Warehouse page.
...
public class BaseWarehouseRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (WarehouseRecord)WarehouseRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in WarehouseRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Warehouse"];
            ...
            HttpContext.Current.Session["QueryString in Add-Warehouse"] = recId;
