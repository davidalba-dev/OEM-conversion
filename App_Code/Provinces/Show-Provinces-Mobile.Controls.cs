...
// Show_Provinces_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Provinces_Mobile
{
...
// Base class for the RepairOrdersTableControlRow control on the Show_Provinces_Mobile page.
...
// Base class for the RepairOrdersTableControl control on the Show_Provinces_Mobile page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Show_Provinces_Mobile.ProvincesRecordControl provincesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "ProvincesRecordControl") as OEMConversion.UI.Controls.Show_Provinces_Mobile.ProvincesRecordControl);
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Provinces_Mobile.RepairOrdersTableControlRow")));
...
// Base class for the ProvincesRecordControl control on the Show_Provinces_Mobile page.
...
public class BaseProvincesRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in ProvincesRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-Provinces-Mobile"] = recId;
