...
// Edit_Provinces.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Provinces
{
...
public class ProvincesRecordControl : BaseProvincesRecordControl
{
      
        // The BaseProvincesRecordControl implements the LoadData, DataBind and other
...
// Base class for the RepairOrdersTableControlRow control on the Edit_Provinces page.
...
public class BaseRepairOrdersTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        ProvincesRecordControl parentCtrl;
      
            parentCtrl = (ProvincesRecordControl)this.Page.FindControlRecursively("ProvincesRecordControl");
        ...
        throw new Exception(Page.GetResourceValue("Err:NoParentRecId", "OEMConversion"));
          ...
          this.DataSource.ROProvince = parentCtrl.DataSource.ProvCode;
      ...
      // To customize, override this method in RepairOrdersTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersProvincesRecordControl = false;
            hasFiltersProvincesRecordControl = hasFiltersProvincesRecordControl && false; // suppress warning
...
// Base class for the RepairOrdersTableControl control on the Edit_Provinces page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Edit_Provinces.ProvincesRecordControl provincesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "ProvincesRecordControl") as OEMConversion.UI.Controls.Edit_Provinces.ProvincesRecordControl);
          
              if (provincesRecordControlObj != null && provincesRecordControlObj.GetRecord() != null && provincesRecordControlObj.GetRecord().IsCreated && provincesRecordControlObj.GetRecord().ProvCode != null)
              {
              wc.iAND(RepairOrdersTable.ROProvince, BaseFilter.ComparisonOperator.EqualsTo, provincesRecordControlObj.GetRecord().ProvCode.ToString());
              selectedRecordKeyValue.AddElement(RepairOrdersTable.ROProvince.InternalName, provincesRecordControlObj.GetRecord().ProvCode.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInProvincesRecordControl = HttpContext.Current.Session["RepairOrdersTableControlWhereClause"] as string;
      
      if (selectedRecordInProvincesRecordControl != null && KeyValue.IsXmlKey(selectedRecordInProvincesRecordControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInProvincesRecordControl);
      
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(RepairOrdersTable.ROProvince))
      {
      wc.iAND(RepairOrdersTable.ROProvince, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(RepairOrdersTable.ROProvince).ToString());
      }
      ...
      RepairOrdersRecord rec = new RepairOrdersRecord();
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("RO Country {Txt:Ascending}"), "ROCountry Asc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("RO Country {Txt:Descending}"), "ROCountry Desc"));
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_Provinces.RepairOrdersTableControlRow")));
...
// Base class for the ProvincesRecordControl control on the Edit_Provinces page.
// Do not modify this class. Instead override any method in ProvincesRecordControl.
public class BaseProvincesRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseProvincesRecordControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        // To customize, override this method in ProvincesRecordControl.
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "ProvincesRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            ProvincesRecord[] recList = ProvincesTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = ProvincesTable.GetRecord(recList[0].GetID().ToXmlString(), true);
      ...
      // To customize, override this method in ProvincesRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Provinces"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "Provinces"));
            }
            HttpContext.Current.Session["QueryString in Edit-Provinces"] = recId;
          ...
          wc.iAND(ProvincesTable.ProvName, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(ProvincesTable.ProvName));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(ProvincesTable.ProvName, BaseFilter.ComparisonOperator.EqualsTo, recId);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseProvincesRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseProvincesRecordControl_Rec"] = value;
            }
        }
