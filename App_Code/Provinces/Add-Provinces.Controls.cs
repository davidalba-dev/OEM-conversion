...
// Add_Provinces.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Provinces
{
...
// Base class for the RepairOrdersTableControlRow control on the Add_Provinces page.
...
// Base class for the RepairOrdersTableControl control on the Add_Provinces page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Add_Provinces.ProvincesRecordControl provincesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "ProvincesRecordControl") as OEMConversion.UI.Controls.Add_Provinces.ProvincesRecordControl);
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Add_Provinces.RepairOrdersTableControlRow")));
...
// Base class for the ProvincesRecordControl control on the Add_Provinces page.
...
public class BaseProvincesRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (ProvincesRecord)ProvincesRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in ProvincesRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Provinces"];
            ...
            HttpContext.Current.Session["QueryString in Add-Provinces"] = recId;
