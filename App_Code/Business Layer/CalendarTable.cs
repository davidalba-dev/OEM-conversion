...
public class CalendarTable : BaseCalendarTable, System.Runtime.Serialization.ISerializable, ISingleton
{
...
#region "ISerializable Members"
    ...
    {
        info.SetType(typeof(CalendarTable_SerializationHelper)); //No other values need to be added
    }

#region "Class CalendarTable_SerializationHelper"

    [SerializableAttribute()]
    private class CalendarTable_SerializationHelper: System.Runtime.Serialization.IObjectReference
    {
    ...
    /// </remarks>
    public readonly static CalendarTable Instance = new CalendarTable();
