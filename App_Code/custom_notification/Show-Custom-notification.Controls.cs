...
// Show_Custom_notification.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Custom_notification
{
...
public class Custom_notificationRecordControl : BaseCustom_notificationRecordControl
{
      
        // The BaseCustom_notificationRecordControl implements the LoadData, DataBind and other
...
// Base class for the Notification_logTableControlRow control on the Show_Custom_notification page.
...
public class BaseNotification_logTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setcustno()
        {
            ...
            if (this.DataSource != null && this.DataSource.custnoSpecified) {
               ...
               Boolean _isExpandableNonCompositeForeignKey = Notification_logTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Notification_logTable.custno);
               if(_isExpandableNonCompositeForeignKey &&Notification_logTable.custno.IsApplyDisplayAs)
                                  
                     formattedValue = Notification_logTable.GetDFKA(this.DataSource.custno.ToString(),Notification_logTable.custno, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(Notification_logTable.custno);
              ...
              this.custno.Text = Notification_logTable.custno.Format(Notification_logTable.custno.DefaultValue);
        ...
        public virtual void Setnotify_url()
        {
            ...
            // Set the notify_url Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.notification_log database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.notification_log record retrieved from the database.
            // this.notify_url is the ASP:Literal on the webpage.
                  
            if (this.DataSource != null && this.DataSource.notify_urlSpecified) {
               ...
               string formattedValue = this.DataSource.Format(Notification_logTable.notify_url);
                ...
                if(formattedValue != null){
                    ...
                    // For fields values larger than the PopupTheshold on Properties, display a popup.
                    if (originalLength >= popupThreshold) {
                        String name = HttpUtility.HtmlEncode(Notification_logTable.notify_url.Name);
                        ...
                        formattedValue = "<a onclick=\'gPersist=true;\' class=\'truncatedText\' onmouseout=\'detailRolloverPopupClose();\' " +
                            "onmouseover=\'SaveMousePosition(event); delayRolloverPopup(\"PageMethods.GetRecordFieldValue(\\\"" + "NULL" + "\\\", \\\"OEMConversion.Business.Notification_logTable, App_Code\\\",\\\"" +
                              (HttpUtility.UrlEncode(this.DataSource.GetID().ToString())).Replace("\\","\\\\\\\\") + "\\\", \\\"notify_url\\\", \\\"notify_url\\\", \\\"" +NetUtils.EncodeStringForHtmlDisplay(name.Substring(0, name.Length)) + "\\\",\\\"" + Page.GetResourceValue("Btn:Close", "OEMConversion") + "\\\", " +
                        " false, 200," +
                            " 300, true, PopupDisplayWindowCallBackWith20);\", 500);'>" + NetUtils.EncodeStringForHtmlDisplay(formattedValue.Substring(0, Math.Min(maxLength, formattedValue.Length)));
                        if (maxLength == (int)(300))
                            {
              ...
              this.notify_url.Text = Notification_logTable.notify_url.Format(Notification_logTable.notify_url.DefaultValue);
            		
            }
            
            // If the notify_url is NULL or blank, then use the value specified  
            // on Properties.
            if (this.notify_url.Text == null ||
                this.notify_url.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.notify_url.Text = "&nbsp;";
            }
        ...
        public virtual void Setrono()
        {
            ...
            if (this.DataSource != null && this.DataSource.ronoSpecified) {
                ...
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = "";
               Boolean _isExpandableNonCompositeForeignKey = Notification_logTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Notification_logTable.rono);
               if(_isExpandableNonCompositeForeignKey &&Notification_logTable.rono.IsApplyDisplayAs)
                                  
                     formattedValue = Notification_logTable.GetDFKA(this.DataSource.rono.ToString(),Notification_logTable.rono, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(Notification_logTable.rono);
              ...
              this.rono.Text = Notification_logTable.rono.Format(Notification_logTable.rono.DefaultValue);
        ...
        public virtual void Setnotify_urlLabel()
                  {
        ...
        Custom_notificationRecordControl parentCtrl;
      
            parentCtrl = (Custom_notificationRecordControl)this.Page.FindControlRecursively("Custom_notificationRecordControl");
        ...
        throw new Exception(Page.GetResourceValue("Err:NoParentRecId", "OEMConversion"));
          ...
          this.DataSource.custom_notificatian_id = parentCtrl.DataSource.custom_notification_id;
      ...
      // To customize, override this method in Notification_logTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersCustom_notificationRecordControl = false;
            hasFiltersCustom_notificationRecordControl = hasFiltersCustom_notificationRecordControl && false; // suppress warning
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void custno_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Customers/Show-Customers.aspx?Customers={Notification_logTableControlRow:FK:FK_notification_log_Customers}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void rono_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../RepairOrders/Show-RepairOrders.aspx?RepairOrders={Notification_logTableControlRow:FK:FK_notification_log_RepairOrders}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal notify_url {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "notify_url");
            }
        }
            
        public System.Web.UI.WebControls.Literal notify_urlLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "notify_urlLabel");
            }
        }
...
// Base class for the Notification_logTableControl control on the Show_Custom_notification page.
...
public class BaseNotification_logTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(Notification_logTable.custno, this.DataSource);
            this.Page.PregetDfkaRecords(Notification_logTable.notified_by, this.DataSource);
            this.Page.PregetDfkaRecords(Notification_logTable.rono, this.DataSource);
        }
    ...
    OEMConversion.UI.Controls.Show_Custom_notification.Custom_notificationRecordControl custom_notificationRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "Custom_notificationRecordControl") as OEMConversion.UI.Controls.Show_Custom_notification.Custom_notificationRecordControl);
          
              if (custom_notificationRecordControlObj != null && custom_notificationRecordControlObj.GetRecord() != null && custom_notificationRecordControlObj.GetRecord().IsCreated)
              {
              wc.iAND(Notification_logTable.custom_notificatian_id, BaseFilter.ComparisonOperator.EqualsTo, custom_notificationRecordControlObj.GetRecord().custom_notification_id.ToString());
              selectedRecordKeyValue.AddElement(Notification_logTable.custom_notificatian_id.InternalName, custom_notificationRecordControlObj.GetRecord().custom_notification_id.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInCustom_notificationRecordControl = HttpContext.Current.Session["Notification_logTableControlWhereClause"] as string;
      
      if (selectedRecordInCustom_notificationRecordControl != null && KeyValue.IsXmlKey(selectedRecordInCustom_notificationRecordControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInCustom_notificationRecordControl);
      
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(Notification_logTable.custom_notificatian_id))
      {
      wc.iAND(Notification_logTable.custom_notificatian_id, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(Notification_logTable.custom_notificatian_id).ToString());
      }
      ...
      Notification_logRecord rec = new Notification_logRecord();
                        ...
                        if (recControl.custno.Text != "") {
                            rec.Parse(recControl.custno.Text, Notification_logTable.custno);
                  }
                        ...
                        if (recControl.notify_url.Text != "") {
                            rec.Parse(recControl.notify_url.Text, Notification_logTable.notify_url);
                  }
                        ...
                        if (recControl.rono.Text != "") {
                            rec.Parse(recControl.rono.Text, Notification_logTable.rono);
                  }
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Notified By {Txt:Ascending}"), "notified_by Asc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Notified By {Txt:Descending}"), "notified_by Desc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Notify Date And Time {Txt:Ascending}"), "notify_datetime Asc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Notify Date And Time {Txt:Descending}"), "notify_datetime Desc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Notify Message {Txt:Ascending}"), "notify_message Asc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Notify Message {Txt:Descending}"), "notify_message Desc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Notify 1 {Txt:Ascending}"), "notify1 Asc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Notify 1 {Txt:Descending}"), "notify1 Desc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Notify 2 {Txt:Ascending}"), "notify2 Asc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Notify 2 {Txt:Descending}"), "notify2 Desc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Notify 3 {Txt:Ascending}"), "notify3 Asc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Notify 3 {Txt:Descending}"), "notify3 Desc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Rono {Txt:Ascending}"), "rono Asc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Rono {Txt:Descending}"), "rono Desc"));
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
                    ...
                    this.ImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=Notification_log" ;
              ...
              
        {
              ...
              try
              {
                    string url = "../notification_log/Add-Notification-log.aspx?custom_notificatian_id={Custom_notificationRecordControl:FV:custom_notification_id}&TabVisible=False&SaveAndNewVisible=False";
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "Notification_logTableControl_PostbackTracker").ClientID);                           
                                
                string javascriptCall = "";
                
                    javascriptCall = "initializePopupPage(document.getElementById('" + MiscUtils.FindControlRecursively(this, "Notification_logTableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = Notification_logTable.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
              
                // Add each of the columns in order of export.
                BaseColumn[] columns = new BaseColumn[] {
                             Notification_logTable.rono,
             Notification_logTable.notified_by,
             Notification_logTable.notify1,
             Notification_logTable.notify2,
             Notification_logTable.notify3,
             Notification_logTable.notify_message,
             Notification_logTable.notify_datetime,
             Notification_logTable.custno,
             Notification_logTable.notify_url,
             null};
                ExportDataToCSV exportData = new ExportDataToCSV(Notification_logTable.Instance,wc,orderBy,columns);
                exportData.StartExport(this.Page.Response, true);

                DataForExport dataForCSV = new DataForExport(Notification_logTable.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(Notification_logTable.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(Notification_logTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(Notification_logTable.rono, "Default"));
             data.ColumnList.Add(new ExcelColumn(Notification_logTable.notified_by, "Default"));
             data.ColumnList.Add(new ExcelColumn(Notification_logTable.notify1, "Default"));
             data.ColumnList.Add(new ExcelColumn(Notification_logTable.notify2, "Default"));
             data.ColumnList.Add(new ExcelColumn(Notification_logTable.notify3, "Default"));
             data.ColumnList.Add(new ExcelColumn(Notification_logTable.notify_message, "Default"));
             data.ColumnList.Add(new ExcelColumn(Notification_logTable.notify_datetime, "Short Date"));
             data.ColumnList.Add(new ExcelColumn(Notification_logTable.custno, "Default"));
             data.ColumnList.Add(new ExcelColumn(Notification_logTable.notify_url, "Default"));
              ...
              {
                val = Notification_logTable.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Custom-notification.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "notification_log";
                // If Show-Custom-notification.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(Notification_logTable.rono.Name, ReportEnum.Align.Left, "${rono}", ReportEnum.Align.Left, 22);
                 report.AddColumn(Notification_logTable.notified_by.Name, ReportEnum.Align.Left, "${notified_by}", ReportEnum.Align.Left, 24);
                 report.AddColumn(Notification_logTable.notify1.Name, ReportEnum.Align.Left, "${notify1}", ReportEnum.Align.Left, 28);
                 report.AddColumn(Notification_logTable.notify2.Name, ReportEnum.Align.Left, "${notify2}", ReportEnum.Align.Left, 28);
                 report.AddColumn(Notification_logTable.notify3.Name, ReportEnum.Align.Left, "${notify3}", ReportEnum.Align.Left, 28);
                 report.AddColumn(Notification_logTable.notify_message.Name, ReportEnum.Align.Left, "${notify_message}", ReportEnum.Align.Left, 28);
                 report.AddColumn(Notification_logTable.notify_datetime.Name, ReportEnum.Align.Left, "${notify_datetime}", ReportEnum.Align.Left, 20);
                 report.AddColumn(Notification_logTable.custno.Name, ReportEnum.Align.Left, "${custno}", ReportEnum.Align.Left, 22);
                 report.AddColumn(Notification_logTable.notify_url.Name, ReportEnum.Align.Left, "${notify_url}", ReportEnum.Align.Left, 28);
                ...
                ColumnList columns = Notification_logTable.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = Notification_logTable.GetRecordCount(joinFilter,whereClause);
                Notification_logRecord[] records = null;
                
                do
                {
                    
                    records = Notification_logTable.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( Notification_logRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                 ...
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = Notification_logTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Notification_logTable.rono);
                                 _DFKA = Notification_logTable.GetDFKA(record.rono.ToString(), Notification_logTable.rono,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  Notification_logTable.rono.IsApplyDisplayAs){
                                     report.AddData("${rono}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${rono}", record.Format(Notification_logTable.rono), ReportEnum.Align.Left);
                                 }
                             }
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.notified_by)){
                                 report.AddData("${notified_by}", "",ReportEnum.Align.Left);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = Notification_logTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Notification_logTable.notified_by);
                                 _DFKA = Notification_logTable.GetDFKA(record.notified_by.ToString(), Notification_logTable.notified_by,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  Notification_logTable.notified_by.IsApplyDisplayAs){
                                     report.AddData("${notified_by}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${notified_by}", record.Format(Notification_logTable.notified_by), ReportEnum.Align.Left);
                                 }
                             }
                             report.AddData("${notify1}", record.Format(Notification_logTable.notify1), ReportEnum.Align.Left, 300);
                             report.AddData("${notify2}", record.Format(Notification_logTable.notify2), ReportEnum.Align.Left, 300);
                             report.AddData("${notify3}", record.Format(Notification_logTable.notify3), ReportEnum.Align.Left, 300);
                             report.AddData("${notify_message}", record.Format(Notification_logTable.notify_message), ReportEnum.Align.Left, 300);
                             report.AddData("${notify_datetime}", record.Format(Notification_logTable.notify_datetime), ReportEnum.Align.Left, 300);
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.custno)){
                                 report.AddData("${custno}", "",ReportEnum.Align.Left);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = Notification_logTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Notification_logTable.custno);
                                 _DFKA = Notification_logTable.GetDFKA(record.custno.ToString(), Notification_logTable.custno,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  Notification_logTable.custno.IsApplyDisplayAs){
                                     report.AddData("${custno}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${custno}", record.Format(Notification_logTable.custno), ReportEnum.Align.Left);
                                 }
                             }
                             report.AddData("${notify_url}", record.Format(Notification_logTable.notify_url), ReportEnum.Align.Left, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Custom-notification.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "notification_log";
                // If Show-Custom-notification.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        protected virtual void OrderSort1_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in Notification_logTable.GetColumns())
                  {
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(Notification_logTable.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (Notification_logTable.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && Notification_logTable.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(Notification_logTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(Notification_logTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
...
#region "Helper Functions"
        ...
        public virtual Notification_logTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Notification_logTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Custom_notification.Notification_logTableControlRow")));
...
// Base class for the Custom_notificationRecordControl control on the Show_Custom_notification page.
// Do not modify this class. Instead override any method in Custom_notificationRecordControl.
public class BaseCustom_notificationRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseCustom_notificationRecordControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        // To customize, override this method in Custom_notificationRecordControl.
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
        ...
        public virtual void LoadData()  
        {
            // Load the data from the database into the DataSource DatabaseAYS_OEM%dbo.custom_notification record.
            // It is better to make changes to functions called by LoadData such as
            // CreateWhereClause, rather than making changes here.
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = Custom_notificationTable.GetRecord(this.RecordUniqueId, true);
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "Custom_notificationRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            if (wc == null || !(wc.RunQuery)) {
                this.DataSource = new Custom_notificationRecord();
            ...
            Custom_notificationRecord[] recList = Custom_notificationTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = Custom_notificationTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                Setcustom_notification_active();
                Setcustom_notification_activeLabel();
                Setcustom_notification_msg();
                Setcustom_notification_msgLabel();
            ...
            bool shouldResetControl = false;
            if (shouldResetControl) { }; // prototype usage to void compiler warnings
            Notification_logTableControl recNotification_logTableControl = (Notification_logTableControl)(MiscUtils.FindControlRecursively(this.Page, "Notification_logTableControl"));
        ...
        this.Page.SetControl("Notification_logTableControl");
        
        }
        
        
        public virtual void Setcustom_notification_active()
        {
            
                    
            // Set the custom_notification_active Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.custom_notification database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.custom_notification record retrieved from the database.
            // this.custom_notification_active is the ASP:Literal on the webpage.
                  
            if (this.DataSource != null && this.DataSource.custom_notification_activeSpecified) {
                								
                // If the custom_notification_active is non-NULL, then format the value.
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(Custom_notificationTable.custom_notification_active);
                                
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                this.custom_notification_active.Text = formattedValue;
                   
            } 
            
            else {
            
                // custom_notification_active is NULL in the database, so use the Default Value.  
                // Default Value could also be NULL.
        
              this.custom_notification_active.Text = Custom_notificationTable.custom_notification_active.Format(Custom_notificationTable.custom_notification_active.DefaultValue);
            		
            }
            
            // If the custom_notification_active is NULL or blank, then use the value specified  
            // on Properties.
            if (this.custom_notification_active.Text == null ||
                this.custom_notification_active.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.custom_notification_active.Text = "&nbsp;";
            }
                                     
        }
                
        public virtual void Setcustom_notification_msg()
        {
            
                    
            // Set the custom_notification_msg Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.custom_notification database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.custom_notification record retrieved from the database.
            // this.custom_notification_msg is the ASP:Literal on the webpage.
                  
            if (this.DataSource != null && this.DataSource.custom_notification_msgSpecified) {
                								
                // If the custom_notification_msg is non-NULL, then format the value.
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(Custom_notificationTable.custom_notification_msg);
                ...
                if(formattedValue != null){
                    ...
                    // For fields values larger than the PopupTheshold on Properties, display a popup.
                    if (originalLength >= popupThreshold) {
                        String name = HttpUtility.HtmlEncode(Custom_notificationTable.custom_notification_msg.Name);
                        ...
                        formattedValue = "<a onclick=\'gPersist=true;\' class=\'truncatedText\' onmouseout=\'detailRolloverPopupClose();\' " +
                            "onmouseover=\'SaveMousePosition(event); delayRolloverPopup(\"PageMethods.GetRecordFieldValue(\\\"" + "NULL" + "\\\", \\\"OEMConversion.Business.Custom_notificationTable, App_Code\\\",\\\"" +
                              (HttpUtility.UrlEncode(this.DataSource.GetID().ToString())).Replace("\\","\\\\\\\\") + "\\\", \\\"custom_notification_msg\\\", \\\"custom_notification_msg\\\", \\\"" +NetUtils.EncodeStringForHtmlDisplay(name.Substring(0, name.Length)) + "\\\",\\\"" + Page.GetResourceValue("Btn:Close", "OEMConversion") + "\\\", " +
                        " false, 200," +
                            " 300, true, PopupDisplayWindowCallBackWith20);\", 500);'>" + NetUtils.EncodeStringForHtmlDisplay(formattedValue.Substring(0, Math.Min(maxLength, formattedValue.Length)));
                        if (maxLength == (int)(300))
                            {
                ...
                this.custom_notification_msg.Text = formattedValue;
                   
            } 
            
            else {
            
                // custom_notification_msg is NULL in the database, so use the Default Value.  
                // Default Value could also be NULL.
        
              this.custom_notification_msg.Text = Custom_notificationTable.custom_notification_msg.Format(Custom_notificationTable.custom_notification_msg.DefaultValue);
            		
            }
            
            // If the custom_notification_msg is NULL or blank, then use the value specified  
            // on Properties.
            if (this.custom_notification_msg.Text == null ||
                this.custom_notification_msg.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.custom_notification_msg.Text = "&nbsp;";
            }
                                     
        }
                
        public virtual void Setcustom_notification_activeLabel()
                  {
                  
                    
        }
                
        public virtual void Setcustom_notification_msgLabel()
                  {
        ...
        public virtual void GetUIData()
        {
            ...
            Getcustom_notification_active();
            Getcustom_notification_msg();
        }
        
        
        public virtual void Getcustom_notification_active()
        {
            
        }
                
        public virtual void Getcustom_notification_msg()
        {
      ...
      // To customize, override this method in Custom_notificationRecordControl.
         ...
         
        {
            ...
            WhereClause wc;
            Custom_notificationTable.Instance.InnerFilter = null;
            wc = new WhereClause();
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Custom_notification"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "Custom_notification"));
            }
            HttpContext.Current.Session["QueryString in Show-Custom-notification"] = recId;
          ...
          wc.iAND(Custom_notificationTable.custom_notification_id, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(Custom_notificationTable.custom_notification_id));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(Custom_notificationTable.custom_notification_id, BaseFilter.ComparisonOperator.EqualsTo, recId);
        ...
        public virtual void Delete()
        {
            ...
            KeyValue pkValue = KeyValue.XmlToKey(this.RecordUniqueId);
          Custom_notificationTable.DeleteRecord(pkValue);
        ...
        public virtual void DialogEditButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../custom_notification/Edit-Custom-notification.aspx?Custom_notification={PK}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseCustom_notificationRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseCustom_notificationRecordControl_Rec"] = value;
            }
        }
        
        public Custom_notificationRecord DataSource {
            get {
                return (Custom_notificationRecord)(this._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal custom_notification_active {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "custom_notification_active");
            }
        }
            
        public System.Web.UI.WebControls.Literal custom_notification_activeLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "custom_notification_activeLabel");
            }
        }
        
        public System.Web.UI.WebControls.Literal custom_notification_msg {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "custom_notification_msg");
            }
        }
            
        public System.Web.UI.WebControls.Literal custom_notification_msgLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "custom_notification_msgLabel");
            }
        }
    ...
    Custom_notificationRecord rec = null;
        ...
        public virtual Custom_notificationRecord GetRecord()
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return Custom_notificationTable.GetRecord(this.RecordUniqueId, true);
