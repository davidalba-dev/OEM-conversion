...
// Add_Customer_note.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Customer_note
{
...
// Base class for the Customer_noteRecordControl control on the Add_Customer_note page.
...
public class BaseCustomer_noteRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setcustomer_note_date()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
              ...
              this.customer_note_date.Text = EvaluateFormula("Now()", this.DataSource, @"g");
        ...
        public virtual void Getcustno()
        {
            ...
            this.DataSource.Parse(this.custno.Text, Customer_noteTable.custno);							
      ...
      // To customize, override this method in Customer_noteRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Add-Customer-note"] = recId;
