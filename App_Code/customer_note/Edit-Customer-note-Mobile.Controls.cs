...
// Edit_Customer_note_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Customer_note_Mobile
{
...
// Base class for the Customer_noteRecordControl control on the Edit_Customer_note_Mobile page.
...
public class BaseCustomer_noteRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in Customer_noteRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Edit-Customer-note-Mobile"] = recId;
