...
// Edit_Customer_note.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Customer_note
{
...
// Base class for the Customer_noteRecordControl control on the Edit_Customer_note page.
...
public class BaseCustomer_noteRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "Customer_noteRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            this.DataSource = Customer_noteTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public virtual void Setcustno()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = Customer_noteTable.custno.DefaultValue;
        ...
        public virtual void Setcustomer_note()
        {
            ...
            if (this.DataSource != null && this.DataSource.customer_noteSpecified) {
               ...
               string formattedValue = this.DataSource.Format(Customer_noteTable.customer_note);
                ...
                this.customer_note.Content = formattedValue;
            ...
            this.customer_note.Content = Customer_noteTable.customer_note.Format(Customer_noteTable.customer_note.DefaultValue);
        ...
        public virtual void Setcustomer_note_createdby()
        {
            ...
            // Set the customer_note_createdby QuickSelector on the webpage with value from the
            // DatabaseAYS_OEM%dbo.customer_note database record.
            
            // this.DataSource is the DatabaseAYS_OEM%dbo.customer_note record retrieved from the database.
            // this.customer_note_createdby is the ASP:QuickSelector on the webpage.
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = Customer_noteTable.customer_note_createdby.DefaultValue;
                				
            }			
                
            // Add the Please Select item.
            if (selectedValue == null || selectedValue == "")
                  MiscUtils.ResetSelectedItem(this.customer_note_createdby, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "OEMConversion"), "--PLEASE_SELECT--"));
                        
                  
            // Populate the item(s) to the control
            
            this.customer_note_createdby.SetFieldMaxLength(50);
                ...
                !MiscUtils.SetSelectedDisplayText(this.customer_note_createdby, selectedValue))
            {
              ...
              string url = this.ModifyRedirectUrl("../login/Login-QuickSelector.aspx", "", true);
              
              url = this.Page.ModifyRedirectUrl(url, "", true);                                  
              
              url += "?Target=" + this.customer_note_createdby.ClientID + "&DFKA=" + (this.Page as BaseApplicationPage).Encrypt("username")+ "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("login_id")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--PLEASE_SELECT--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:PleaseSelect"))+ "&Mode=" + (this.Page as BaseApplicationPage).Encrypt("FieldValueSingleSelection") + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.customer_note_createdby.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(customer_note_createdby.AutoPostBack).ToLower() + ", event); return false;";
        ...
        public virtual void Getcustomer_note()
        {
            ...
            this.DataSource.Parse(this.customer_note.Content, Customer_noteTable.customer_note);							
        ...
        {
         // Retrieve the value entered by the user on the customer_note_createdby ASP:QuickSelector, and
      ...
      // To customize, override this method in Customer_noteRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Customer_note"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "Customer_note"));
            }
            HttpContext.Current.Session["QueryString in Edit-Customer-note"] = recId;
        ...
        protected virtual void customer_note_TextChanged(object sender, EventArgs args)
        {
                ...
                // this event handler is not supported since customer_note is an Ajax HTML Editor.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal custnoLabel {
            get {
              ...
              public AjaxControlToolkit.HTMLEditor.Editor customer_note {
              get {
                  return (AjaxControlToolkit.HTMLEditor.Editor)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "customer_note");
                  }
              }
          
        public BaseClasses.Web.UI.WebControls.QuickSelector customer_note_createdby {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "customer_note_createdby");
            }
        }              
