...
// Show_Today_Resource_sch_ticket_Table_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Today_Resource_sch_ticket_Table_Mobile
{
...
// Base class for the Resource_sch_ticketTableControlRow control on the Show_Today_Resource_sch_ticket_Table_Mobile page.
...
public class BaseResource_sch_ticketTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in Resource_sch_ticketTableControlRow.
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../resource_sch_ticket/Edit-Resource-sch-ticket-Mobile.aspx?resource_sch_ticket={Resource_sch_ticketTableControlRow:FV:resource_sch_ticket_id}";
...
// Base class for the Resource_sch_ticketTableControl control on the Show_Today_Resource_sch_ticket_Table_Mobile page.
...
public class BaseResource_sch_ticketTableControl : OEMConversion.UI.BaseApplicationTableControl
{
       ...
       public BaseResource_sch_ticketTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.due_dateFromFilter)) 				
                    initialVal = this.GetFromSession(this.due_dateFromFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"due_dateFrom\")");
                
                if (initialVal != null && initialVal != "")		
                {
                        
                    this.due_dateFromFilter.Text = initialVal;
            ...
            else
            {
                ...
                this.CurrentSortOrder.Add(Resource_sch_ticketTable.scheduled_date, OrderByItem.OrderDir.Desc);
    ...
    // Setup default pagination settings.
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep1 = (System.Web.UI.WebControls.Repeater)BaseClasses.Utils.MiscUtils.FindControlRecursively(rep.Items[PageIndex], "Resource_sch_ticketTableControlRepeater1");
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.due_dateFromFilter)) {
                string val = MiscUtils.GetSelectedValue(this.due_dateFromFilter, this.GetFromSession(this.due_dateFromFilter));
                DateTime d = DateParser.ParseDate(val, DateColumn.DEFAULT_FORMAT);
                    
                val = d.ToShortDateString() + " " + "00:00:00";
                wc.iAND(Resource_sch_ticketTable.due_date, BaseFilter.ComparisonOperator.EqualsTo, val, false, false);
        ...
        public virtual WhereClause CreateWhereClause(String searchText, String fromSearchControl, String AutoTypeAheadSearch, String AutoTypeAheadWordSeparators)
        {
            ...
            string due_dateFromFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "due_dateFromFilter_Ajax"];
            if (MiscUtils.IsValueSelected(due_dateFromFilterSelectedValue)) {
                DateTime d = DateParser.ParseDate(due_dateFromFilterSelectedValue, DateColumn.DEFAULT_FORMAT);
                due_dateFromFilterSelectedValue = d.ToShortDateString() + " " + "00:00:00";
                    
                wc.iAND(Resource_sch_ticketTable.due_date, BaseFilter.ComparisonOperator.EqualsTo, due_dateFromFilterSelectedValue, false, false);
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            if (EvaluateFormula("Today()", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Resource_sch_ticketTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"resource_sch_ticket_.scheduled_date"), EvaluateFormula("Today()", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (!this.ResetData)
            {
              System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Resource_sch_ticketTableControlRepeater"));
              if (rep == null){return;}
              Resource_sch_ticketTableControlRow[] recControls = this.GetRecordControls();
                foreach (Resource_sch_ticketTableControlRow recControl in recControls) 
		{
      ...
      Resource_sch_ticketRecord rec = new Resource_sch_ticketRecord();
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.due_dateFromFilter, this.due_dateFromFilter.Text);
      ...
      this.SaveToSession("due_dateFromFilter_Ajax", this.due_dateFromFilter.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.due_dateFromFilter);
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox due_dateFromFilter {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "due_dateFromFilter");
            }
        }
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (Resource_sch_ticketTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        Resource_sch_ticketTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual Resource_sch_ticketTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Resource_sch_ticketTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Today_Resource_sch_ticket_Table_Mobile.Resource_sch_ticketTableControlRow")));
