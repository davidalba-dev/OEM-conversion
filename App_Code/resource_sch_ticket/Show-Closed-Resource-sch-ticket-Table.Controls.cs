...
// Show_Closed_Resource_sch_ticket_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Closed_Resource_sch_ticket_Table
{
...
// Base class for the Resource_sch_ticketTableControlRow control on the Show_Closed_Resource_sch_ticket_Table page.
...
// Base class for the Resource_sch_ticketTableControl control on the Show_Closed_Resource_sch_ticket_Table page.
        ...
        public virtual void Setproject_idLabel()
                  {
                      ...
                      //this.project_idLabel.Text = "Some value";
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Closed-Resource-sch-ticket-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "resource_sch_ticket";
                // If Show-Closed-Resource-sch-ticket-Table.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Closed-Resource-sch-ticket-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "resource_sch_ticket";
                // If Show-Closed-Resource-sch-ticket-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual Resource_sch_ticketTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Resource_sch_ticketTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Closed_Resource_sch_ticket_Table.Resource_sch_ticketTableControlRow")));
