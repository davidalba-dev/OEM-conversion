...
// Show_Resource_sch_ticket_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Resource_sch_ticket_Table
{
...
// Base class for the Resource_sch_ticketTableControlRow control on the Show_Resource_sch_ticket_Table page.
...
public class BaseResource_sch_ticketTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.contractor_contact_id.Click += contractor_contact_id_Click;
                        
                    this.contractor_id.Click += contractor_id_Click;
        ...
        public virtual void Setcontractor_contact_id()
        {
            ...
            // Set the contractor_contact_id LinkButton on the webpage with value from the
            ...
            // this.contractor_contact_id is the ASP:LinkButton on the webpage.
                  
            if (this.DataSource != null && this.DataSource.contractor_contact_idSpecified) {
                								
                // If the contractor_contact_id is non-NULL, then format the value.
               ...
               if(_isExpandableNonCompositeForeignKey &&Resource_sch_ticketTable.contractor_contact_id.IsApplyDisplayAs)
                     ...
                     formattedValue = Resource_sch_ticketTable.GetDFKA(this.DataSource.contractor_contact_id.ToString(),Resource_sch_ticketTable.contractor_contact_id, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(Resource_sch_ticketTable.contractor_contact_id);
                                  
                                
                this.contractor_contact_id.Text = formattedValue;
                   
            } 
            
            else {
            
                // contractor_contact_id is NULL in the database, so use the Default Value.  
                // Default Value could also be NULL.
        
              this.contractor_contact_id.Text = Resource_sch_ticketTable.contractor_contact_id.Format(Resource_sch_ticketTable.contractor_contact_id.DefaultValue);
        ...
        public virtual void Setcontractor_id()
        {
            ...
            // Set the contractor_id LinkButton on the webpage with value from the
            // DatabaseAYS_OEM%dbo.resource_sch_ticket database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.resource_sch_ticket record retrieved from the database.
            // this.contractor_id is the ASP:LinkButton on the webpage.
                  
            if (this.DataSource != null && this.DataSource.contractor_idSpecified) {
                								
                // If the contractor_id is non-NULL, then format the value.
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = "";
               Boolean _isExpandableNonCompositeForeignKey = Resource_sch_ticketTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Resource_sch_ticketTable.contractor_id);
               if(_isExpandableNonCompositeForeignKey &&Resource_sch_ticketTable.contractor_id.IsApplyDisplayAs)
                                  
                     formattedValue = Resource_sch_ticketTable.GetDFKA(this.DataSource.contractor_id.ToString(),Resource_sch_ticketTable.contractor_id, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(Resource_sch_ticketTable.contractor_id);
              ...
              this.contractor_id.Text = Resource_sch_ticketTable.contractor_id.Format(Resource_sch_ticketTable.contractor_id.DefaultValue);
        ...
        public virtual void Setdue_date()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
                ...
                string formattedValue = EvaluateFormula("if(due_date<Today(),\"<div style='background-color:#ffcccc;'>\" + format(due_date, \"d\") + \" </div>\",\"<div style='background-color:#b3ffb3;'>\" + format(due_date,\"d\") + \" </div>\")", this.DataSource, @"d");
        ...
        public virtual void Setticket_actual_time()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
                ...
                // The Format method will use the Display Format
                string formattedValue = EvaluateFormula("if(ticket_actual_time>esthours,\"<div style='background-color:#ffcccc;'>\" + ticket_actual_time + \" </div>\",\"<div style='background-color:#b3ffb3;'>\" + ticket_actual_time + \" </div>\")", this.DataSource);
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void contractor_contact_id_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../contractor_contact/Edit-Contractor-contact.aspx?contractor_contact={Resource_sch_ticketTableControlRow:FV:contractor_contact_id}";
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for LinkButton
        public virtual void contractor_id_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../contractor/Edit-Contractor.aspx?contractor={Resource_sch_ticketTableControlRow:FV:contractor_id}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton contractor_contact_id {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "contractor_contact_id");
            }
        }
            
        public System.Web.UI.WebControls.LinkButton contractor_id {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "contractor_id");
            }
        }
...
// Base class for the Resource_sch_ticketTableControl control on the Show_Resource_sch_ticket_Table page.
...
public class BaseResource_sch_ticketTableControl : OEMConversion.UI.BaseApplicationTableControl
{
       ...
       public BaseResource_sch_ticketTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.contractor_idFilter)) 				
                    initialVal = this.GetFromSession(this.contractor_idFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"contractor_id\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.contractor_idFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.contractor_idFilter.SelectedValue = initialVal;
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.contractor_contact_idFilter)) 				
                    initialVal = this.GetFromSession(this.contractor_contact_idFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"contractor_contact_id\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.contractor_contact_idFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.contractor_contact_idFilter.SelectedValue = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
              ...
              this.resource_sch_ticket_idLabel.Click += resource_sch_ticket_idLabel_Click;
            ...
            this.contractor_idFilter.SelectedIndexChanged += new EventHandler(contractor_idFilter_SelectedIndexChanged);
            ...
            this.contractor_contact_idFilter.SelectedIndexChanged += new EventHandler(contractor_contact_idFilter_SelectedIndexChanged);
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                Setcontractor_contact_idFilter();
                SetExcelButton();
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(Resource_sch_ticketTable.contractor_contact_id, this.DataSource);
            this.Page.PregetDfkaRecords(Resource_sch_ticketTable.contractor_id, this.DataSource);
            ...
            this.Page.PregetDfkaRecords(Resource_sch_ticketTable.resource_sch_ticket_id, this.DataSource);
        ...
        public virtual void ResetControl()
        {
            ...
            this.contractor_idFilter.ClearSelection();
            ...
            this.contractor_contact_idFilter.ClearSelection();
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.contractor_idFilter)) {
                        
                wc.iAND(Resource_sch_ticketTable.contractor_id, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.contractor_idFilter, this.GetFromSession(this.contractor_idFilter)), false, false);
            ...
            if (MiscUtils.IsValueSelected(this.contractor_contact_idFilter)) {
                        
                wc.iAND(Resource_sch_ticketTable.contractor_contact_id, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.contractor_contact_idFilter, this.GetFromSession(this.contractor_contact_idFilter)), false, false);
      ...
      String contractor_idFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "contractor_idFilter_Ajax"];
            if (MiscUtils.IsValueSelected(contractor_idFilterSelectedValue)) {

              
                wc.iAND(Resource_sch_ticketTable.contractor_id, BaseFilter.ComparisonOperator.EqualsTo, contractor_idFilterSelectedValue, false, false);
      ...
      String contractor_contact_idFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "contractor_contact_idFilter_Ajax"];
            if (MiscUtils.IsValueSelected(contractor_contact_idFilterSelectedValue)) {

              
                wc.iAND(Resource_sch_ticketTable.contractor_contact_id, BaseFilter.ComparisonOperator.EqualsTo, contractor_contact_idFilterSelectedValue, false, false);
      ...
      Resource_sch_ticketRecord rec = new Resource_sch_ticketRecord();
                        ...
                        if (recControl.contractor_contact_id.Text != "") {
                            rec.Parse(recControl.contractor_contact_id.Text, Resource_sch_ticketTable.contractor_contact_id);
                  }
                
                        if (recControl.contractor_id.Text != "") {
                            rec.Parse(recControl.contractor_id.Text, Resource_sch_ticketTable.contractor_id);
                  }
                        ...
                        if (recControl.due_date.Text != "") {
                            rec.Parse(recControl.due_date.Text, Resource_sch_ticketTable.due_date);
                  }
                        ...
                        if (recControl.resource_sch_ticket_id.Text != "") {
                            rec.Parse(recControl.resource_sch_ticket_id.Text, Resource_sch_ticketTable.resource_sch_ticket_id);
                  }
        ...
        public virtual void Setresource_sch_ticket_idLabel()
                  {
                      ...
                      //this.resource_sch_ticket_idLabel.Text = "Some value";
        ...
        public virtual void Setcontractor_idFilter()
        {
            
            // Set AutoPostBack to true so that when the control value is changed, to refresh contractor_contact_idFilter controls
            this.contractor_idFilter.AutoPostBack = true;
            
            this.Populatecontractor_idFilter(MiscUtils.GetSelectedValue(this.contractor_idFilter,  GetFromSession(this.contractor_idFilter)), 500);					
        ...
        public virtual void Setcontractor_contact_idFilter()
        {
            
            this.Populatecontractor_contact_idFilter(MiscUtils.GetSelectedValue(this.contractor_contact_idFilter,  GetFromSession(this.contractor_contact_idFilter)), 500);					
                                     
        }
            
        // Get the filters' data for contractor_idFilter.
                
        protected virtual void Populatecontractor_idFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.contractor_idFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_contractor_idFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_contractor_idFilter function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.contractor_idFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
                ...
                do
                {
                    ...
                    foreach (ContractorRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.contractor_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.contractor_idFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                fvalue = EvaluateFormula("= Contractor.contractor_name", itemValue , variables, evaluator);
                                ...
                                ListItem dupItem = this.contractor_idFilter.Items.FindByText(fvalue);
                                ...
                                this.contractor_idFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                MiscUtils.SetSelectedValue(this.contractor_idFilter, selectedValue);
            ...
            if (this.contractor_idFilter.SelectedValue != null && this.contractor_idFilter.Items.FindByValue(this.contractor_idFilter.SelectedValue) == null)
                this.contractor_idFilter.SelectedValue = null;
        ...
        // Get the filters' data for contractor_contact_idFilter.
                
        protected virtual void Populatecontractor_contact_idFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.contractor_contact_idFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_contractor_contact_idFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_contractor_contact_idFilter function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.contractor_contact_idFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
                ...
                do
                {
                    ...
                    foreach (Contractor_contactRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.contractor_contact_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.contractor_contact_idFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                ListItem dupItem = this.contractor_contact_idFilter.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.contractor_contact_idFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.contractor_contact_idFilter, selectedValue);
            ...
            if (this.contractor_contact_idFilter.SelectedValue != null && this.contractor_contact_idFilter.Items.FindByValue(this.contractor_contact_idFilter.SelectedValue) == null)
                this.contractor_contact_idFilter.SelectedValue = null;
                           
        }
            
        public virtual WhereClause CreateWhereClause_contractor_idFilter()
        {
            // Create a where clause for the filter contractor_idFilter.
            // This function is called by the Populate method to load the items 
            // in the contractor_idFilterDropDownList
        CompoundFilter filter = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
            WhereClause whereClause = new WhereClause();
        ...
        public virtual WhereClause CreateWhereClause_contractor_contact_idFilter()
        {
            // Create a where clause for the filter contractor_contact_idFilter.
            // This function is called by the Populate method to load the items 
            // in the contractor_contact_idFilterDropDownList
        CompoundFilter filter = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
            WhereClause whereClause = new WhereClause();
            
            if (EvaluateFormula("Resource_sch_ticketTableControl.contractor_idFilter.SelectedValue", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Contractor_contactTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"contractor_contact_.contractor_id"), EvaluateFormula("Resource_sch_ticketTableControl.contractor_idFilter.SelectedValue", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         ...
         if (EvaluateFormula("Resource_sch_ticketTableControl.contractor_idFilter.SelectedValue", false) == "--PLEASE_SELECT--" || EvaluateFormula("Resource_sch_ticketTableControl.contractor_idFilter.SelectedValue", false) == "--ANY--") whereClause.RunQuery = false;
         if (EvaluateFormula("1", false) == "--PLEASE_SELECT--" || EvaluateFormula("1", false) == "--ANY--") whereClause.RunQuery = false;
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.contractor_idFilter, this.contractor_idFilter.SelectedValue);
            ...
            this.SaveToSession(this.contractor_contact_idFilter, this.contractor_contact_idFilter.SelectedValue);
      ...
      this.SaveToSession("contractor_idFilter_Ajax", this.contractor_idFilter.SelectedValue);
      ...
      this.SaveToSession("contractor_contact_idFilter_Ajax", this.contractor_contact_idFilter.SelectedValue);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.contractor_idFilter);
            ...
            this.RemoveFromSession(this.contractor_contact_idFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(contractor_idFilter))
            ...
            if (MiscUtils.IsValueSelected(contractor_contact_idFilter))
                themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        ...
        public virtual void due_dateLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(Resource_sch_ticketTable.due_date);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(Resource_sch_ticketTable.due_date, OrderByItem.OrderDir.Asc);
        ...
        public virtual void resource_sch_ticket_idLabel_Click(object sender, EventArgs args)
        {
            //Sorts by resource_sch_ticket_id when clicked.
              
            // Get previous sorting state for resource_sch_ticket_id.
        
            OrderByItem sd = this.CurrentSortOrder.Find(Resource_sch_ticketTable.resource_sch_ticket_id);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(Resource_sch_ticketTable.resource_sch_ticket_id, OrderByItem.OrderDir.Asc);
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              if (this.TotalRecords > 10000)
              {
                ...
                BaseColumn[] columns = new BaseColumn[] {
                             Resource_sch_ticketTable.resource_sch_ticket_id,
             ...
             Resource_sch_ticketTable.due_date,
             ...
             Resource_sch_ticketTable.contractor_id,
             Resource_sch_ticketTable.contractor_contact_id,
             ...
             null};
              ...
              DataForExport data = new DataForExport(Resource_sch_ticketTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(Resource_sch_ticketTable.resource_sch_ticket_id, "Default"));
             ...
             data.ColumnList.Add(new ExcelColumn(Resource_sch_ticketTable.due_date, "Short Date"));
             ...
             data.ColumnList.Add(new ExcelColumn(Resource_sch_ticketTable.contractor_id, "Default"));
             data.ColumnList.Add(new ExcelColumn(Resource_sch_ticketTable.contractor_contact_id, "Default"));
        ...
        public virtual void NewButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../resource_sch_ticket/Add-Resource-sch-ticket.aspx";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Resource-sch-ticket-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "resource_sch_ticket";
                // If Show-Resource-sch-ticket-Table.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(Resource_sch_ticketTable.resource_sch_ticket_id.Name, ReportEnum.Align.Left, "${resource_sch_ticket_id}", ReportEnum.Align.Left, 30);
                 ...
                 report.AddColumn(Resource_sch_ticketTable.due_date.Name, ReportEnum.Align.Left, "${due_date}", ReportEnum.Align.Left, 20);
                 ...
                 report.AddColumn(Resource_sch_ticketTable.contractor_id.Name, ReportEnum.Align.Left, "${contractor_id}", ReportEnum.Align.Left, 28);
                 report.AddColumn(Resource_sch_ticketTable.contractor_contact_id.Name, ReportEnum.Align.Left, "${contractor_contact_id}", ReportEnum.Align.Left, 30);
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                 ...
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = Resource_sch_ticketTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Resource_sch_ticketTable.resource_sch_ticket_id);
                                 _DFKA = Resource_sch_ticketTable.GetDFKA(record.resource_sch_ticket_id.ToString(), Resource_sch_ticketTable.resource_sch_ticket_id,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  Resource_sch_ticketTable.resource_sch_ticket_id.IsApplyDisplayAs){
                                     report.AddData("${resource_sch_ticket_id}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${resource_sch_ticket_id}", record.Format(Resource_sch_ticketTable.resource_sch_ticket_id), ReportEnum.Align.Left, 300);
                                 }
                             }
                             ...
                             report.AddData("${due_date}", record.Format(Resource_sch_ticketTable.due_date), ReportEnum.Align.Left, 300);
                             ...
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.contractor_id)){
                                 report.AddData("${contractor_id}", "",ReportEnum.Align.Left);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = Resource_sch_ticketTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Resource_sch_ticketTable.contractor_id);
                                 _DFKA = Resource_sch_ticketTable.GetDFKA(record.contractor_id.ToString(), Resource_sch_ticketTable.contractor_id,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  Resource_sch_ticketTable.contractor_id.IsApplyDisplayAs){
                                     report.AddData("${contractor_id}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${contractor_id}", record.Format(Resource_sch_ticketTable.contractor_id), ReportEnum.Align.Left);
                                 }
                             }
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.contractor_contact_id)){
                                 report.AddData("${contractor_contact_id}", "",ReportEnum.Align.Left);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = Resource_sch_ticketTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Resource_sch_ticketTable.contractor_contact_id);
                                 _DFKA = Resource_sch_ticketTable.GetDFKA(record.contractor_contact_id.ToString(), Resource_sch_ticketTable.contractor_contact_id,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  Resource_sch_ticketTable.contractor_contact_id.IsApplyDisplayAs){
                                     report.AddData("${contractor_contact_id}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${contractor_contact_id}", record.Format(Resource_sch_ticketTable.contractor_contact_id), ReportEnum.Align.Left);
                                 }
                             }
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Resource-sch-ticket-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "resource_sch_ticket";
                // If Show-Resource-sch-ticket-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        public virtual void Button_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../project/Show-Project-Table.aspx";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void Button1_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../resource_sch_ticket/Show-Closed-Resource-sch-ticket-Table.aspx";
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void contractor_idFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
        ...
        // event handler for FieldFilter
        protected virtual void contractor_contact_idFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList contractor_idFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "contractor_idFilter");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton resource_sch_ticket_idLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "resource_sch_ticket_idLabel");
            }
        }
        ...
        public System.Web.UI.WebControls.DropDownList contractor_contact_idFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "contractor_contact_idFilter");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual Resource_sch_ticketTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Resource_sch_ticketTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Resource_sch_ticket_Table.Resource_sch_ticketTableControlRow")));
