...
// Show_My_Closed_Resource_sch_ticket_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_My_Closed_Resource_sch_ticket_Table
{
...
// Base class for the Resource_sch_ticketTableControlRow control on the Show_My_Closed_Resource_sch_ticket_Table page.
...
public class BaseResource_sch_ticketTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setproject_id()
        {
            ...
            // Set the project_id Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.resource_sch_ticket database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.resource_sch_ticket record retrieved from the database.
            // this.project_id is the ASP:Literal on the webpage.
            ...
            // If the project_id is NULL or blank, then use the value specified  
            // on Properties.
...
// Base class for the Resource_sch_ticketTableControl control on the Show_My_Closed_Resource_sch_ticket_Table page.
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-My-Closed-Resource-sch-ticket-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "resource_sch_ticket";
                // If Show-My-Closed-Resource-sch-ticket-Table.PDFButton.report specifies a valid report template,
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.project_id)){
                                 report.AddData("${project_id}", "",ReportEnum.Align.Left, 300);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 ...
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  Resource_sch_ticketTable.project_id.IsApplyDisplayAs){
                                     report.AddData("${project_id}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${project_id}", record.Format(Resource_sch_ticketTable.project_id), ReportEnum.Align.Left, 300);
                                 }
                             }
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-My-Closed-Resource-sch-ticket-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "resource_sch_ticket";
                // If Show-My-Closed-Resource-sch-ticket-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual Resource_sch_ticketTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Resource_sch_ticketTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_My_Closed_Resource_sch_ticket_Table.Resource_sch_ticketTableControlRow")));
