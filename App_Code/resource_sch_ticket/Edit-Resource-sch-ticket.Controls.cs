...
// Edit_Resource_sch_ticket.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Resource_sch_ticket
{
...
public class Resource_sch_timeTableControl : BaseResource_sch_timeTableControl
{
    // The BaseResource_sch_timeTableControl class implements the LoadData, DataBind, CreateWhereClause
    // and other methods to load and display the data in a table control.

    // This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
    // The Resource_sch_timeTableControlRow class offers another place where you can customize
    // the DataBind, GetUIData, SaveData and Validate methods specific to each row displayed on the table.
    
}
public class Resource_sch_timeTableControlRow : BaseResource_sch_timeTableControlRow
{
      
        // The BaseResource_sch_timeTableControlRow implements code for a ROW within the
        // the Resource_sch_timeTableControl table.  The BaseResource_sch_timeTableControlRow implements the DataBind and SaveData methods.
        // The loading of data is actually performed by the LoadData method in the base class of Resource_sch_timeTableControl.

        // This is the ideal place to add your code customizations. For example, you can override the DataBind, 
        // SaveData, GetUIData, and Validate methods.
        
}
public class Resource_sch_ticket_imgTableControl : BaseResource_sch_ticket_imgTableControl
{
    // The BaseResource_sch_ticket_imgTableControl class implements the LoadData, DataBind, CreateWhereClause
    // and other methods to load and display the data in a table control.

    // This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
    // The Resource_sch_ticket_imgTableControlRow class offers another place where you can customize
    // the DataBind, GetUIData, SaveData and Validate methods specific to each row displayed on the table.
    
}
public class Resource_sch_ticket_imgTableControlRow : BaseResource_sch_ticket_imgTableControlRow
{
      
        // The BaseResource_sch_ticket_imgTableControlRow implements code for a ROW within the
        // the Resource_sch_ticket_imgTableControl table.  The BaseResource_sch_ticket_imgTableControlRow implements the DataBind and SaveData methods.
        // The loading of data is actually performed by the LoadData method in the base class of Resource_sch_ticket_imgTableControl.
...
// Base class for the Resource_sch_ticket_imgTableControlRow control on the Edit_Resource_sch_ticket page.
// Do not modify this class. Instead override any method in Resource_sch_ticket_imgTableControlRow.
public class BaseResource_sch_ticket_imgTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseResource_sch_ticket_imgTableControlRow()
        {
        ...
        // To customize, override this method in Resource_sch_ticket_imgTableControlRow.
        ...
        {
            // Load the data from the database into the DataSource DatabaseAYS_OEM%dbo.resource_sch_ticket_img record.
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = Resource_sch_ticket_imgTable.GetRecord(this.RecordUniqueId, true);
              
                return;
            }
      
            // Since this is a row in the table, the data for this row is loaded by the 
            // LoadData method of the BaseResource_sch_ticket_imgTableControl when the data for the entire
            // table is loaded.
            
            this.DataSource = new Resource_sch_ticket_imgRecord();
        ...
        public virtual void Setresource_sch_ticket_img()
        {
            // Set the resource_sch_ticket_img Image on the webpage with value from the
            // DatabaseAYS_OEM%dbo.resource_sch_ticket_img database record.
            
            // this.DataSource is the DatabaseAYS_OEM%dbo.resource_sch_ticket_img record retrieved from the database.
            // this.resource_sch_ticket_img is the ASP:Image on the webpage.

            if (this.DataSource != null && this.DataSource.resource_sch_ticket_imgSpecified) {
                // If the resource_sch_ticket_img is non-NULL, then format the value.
                // The Format method will use the Display Format
                  String name = HttpUtility.HtmlEncode(Resource_sch_ticket_imgTable.resource_sch_ticket_img.Name);
                  ...
                  this.resource_sch_ticket_img.Attributes.Add("onclick", "gPersist=true;");
                  this.resource_sch_ticket_img.Attributes.Add("onmouseout","detailRolloverPopupClose();");
                  this.resource_sch_ticket_img.Attributes.Add("onmouseover","SaveMousePosition(event);delayRolloverPopup(\"PageMethods.GetImage(\\\"" + "NULL" +
                  "\\\", \\\"" + this.Page.Encrypt("Resource_sch_ticket_img") +
                  "\\\", \\\"" + this.Page.Encrypt(HttpUtility.UrlEncode(this.DataSource.GetID().ToString())) + 
                  "\\\", \\\"" + this.Page.Encrypt("resource_sch_ticket_img") + "\\\", \\\"" + NetUtils.EncodeStringForHtmlDisplay(name.Substring(0, name.Length))+ "\\\",\\\"" + Page.GetResourceValue("Btn:Close", "OEMConversion") + "\\\", false, 200," +
                  " 300, true, PopupDisplayWindowCallBackWith20);\", 500);");
                        
                // Shrunk image size specified by ImagePercentSize on Properties.
                this.resource_sch_ticket_img.ImageUrl = this.DataSource.FormatImageUrl(Resource_sch_ticket_imgTable.resource_sch_ticket_img, this.Page.Encrypt("Resource_sch_ticket_img"), this.Page.Encrypt("resource_sch_ticket_img"), this.Page.Encrypt(this.DataSource.GetID().ToXmlString()), 100);
                            
                this.resource_sch_ticket_img.Visible = true;
                                    
            } 
            else {
                // resource_sch_ticket_img is NULL in the database, so use the Default Value.  
                // Default Value could also be NULL.
                this.resource_sch_ticket_img.Visible = false;
            }
        ...
        Resource_sch_ticketRecordControl parentCtrl;
      
            parentCtrl = (Resource_sch_ticketRecordControl)this.Page.FindControlRecursively("Resource_sch_ticketRecordControl");
        ...
        throw new Exception(Page.GetResourceValue("Err:NoParentRecId", "OEMConversion"));
          ...
          this.DataSource.resource_sch_ticket_id = parentCtrl.DataSource.resource_sch_ticket_id;
            ...
            if (this.DataSource.IsAnyValueChanged) {
                ...
                ((Resource_sch_ticket_imgTableControl)MiscUtils.GetParentControlObject(this, "Resource_sch_ticket_imgTableControl")).DataChanged = true;
                ((Resource_sch_ticket_imgTableControl)MiscUtils.GetParentControlObject(this, "Resource_sch_ticket_imgTableControl")).ResetData = true;
            }
      ...
      // To customize, override this method in Resource_sch_ticket_imgTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersResource_sch_ticket_imgTableControl = false;
            hasFiltersResource_sch_ticket_imgTableControl = hasFiltersResource_sch_ticket_imgTableControl && false; // suppress warning
            ...
            bool hasFiltersResource_sch_timeTableControl = false;
            hasFiltersResource_sch_timeTableControl = hasFiltersResource_sch_timeTableControl && false; // suppress warning
        ...
        public virtual void Delete()
        {
          ...
          Resource_sch_ticket_imgTable.DeleteRecord(pkValue);
      ...
      this.Page.CommitTransaction(sender);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseResource_sch_ticket_imgTableControlRow_Rec"];
            }
            set {
                this.ViewState["BaseResource_sch_ticket_imgTableControlRow_Rec"] = value;
            }
        }
        
        public Resource_sch_ticket_imgRecord DataSource {
            get {
                return (Resource_sch_ticket_imgRecord)(this._DataSource);
            }
            set {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Image resource_sch_ticket_img {
            get {
                return (System.Web.UI.WebControls.Image)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "resource_sch_ticket_img");
            }
        }
    ...
    {
        Resource_sch_ticket_imgRecord rec = null;
    ...
    Resource_sch_ticket_imgRecord rec = null;
        ...
        public virtual Resource_sch_ticket_imgRecord GetRecord()
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return Resource_sch_ticket_imgTable.GetRecord(this.RecordUniqueId, true);
...
// Base class for the Resource_sch_ticket_imgTableControl control on the Edit_Resource_sch_ticket page.
// Do not modify this class. Instead override any method in Resource_sch_ticket_imgTableControl.
public class BaseResource_sch_ticket_imgTableControl : OEMConversion.UI.BaseApplicationTableControl
{
         
       public BaseResource_sch_ticket_imgTableControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(OEMConversion.Business.Resource_sch_ticket_imgRecord);
                      this.DataSource = (Resource_sch_ticket_imgRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    foreach (Resource_sch_ticket_imgTableControlRow rc in this.GetRecordControls()) {
                        if (!rc.IsNewRecord) {
                    ...
                    Type myrec = typeof(OEMConversion.Business.Resource_sch_ticket_imgRecord);
                    this.DataSource = (Resource_sch_ticket_imgRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual Resource_sch_ticket_imgRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(Resource_sch_ticket_imgTable.Column1, true);          
            // selCols.Add(Resource_sch_ticket_imgTable.Column2, true);          
            // selCols.Add(Resource_sch_ticket_imgTable.Column3, true);          
                  ...
                  
            {
                ...
                return Resource_sch_ticket_imgTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                Resource_sch_ticket_imgTable databaseTable = new Resource_sch_ticket_imgTable();
                ...
                return (recList.ToArray(typeof(Resource_sch_ticket_imgRecord)) as Resource_sch_ticket_imgRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0)                 
                ...
                return Resource_sch_ticket_imgTable.GetRecordCount(join, where);
            else
            {
                Resource_sch_ticket_imgTable databaseTable = new Resource_sch_ticket_imgTable();
                databaseTable.SelectedColumns.Clear();
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Resource_sch_ticket_imgTableControlRepeater"));
        if (rep == null){return;}
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            Resource_sch_ticket_imgTableControlRow recControl = (Resource_sch_ticket_imgTableControlRow)(repItem.FindControl("Resource_sch_ticket_imgTableControlRow"));
        ...
        protected virtual void BindPaginationControls()
        {
            ...
            // Bind the buttons for Resource_sch_ticket_imgTableControl pagination.
        ...
        public virtual void SaveData()
        {
            ...
            foreach (Resource_sch_ticket_imgTableControlRow recCtl in this.GetRecordControls())
            {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            Resource_sch_ticket_imgTable.Instance.InnerFilter = null;
    ...
    OEMConversion.UI.Controls.Edit_Resource_sch_ticket.Resource_sch_ticketRecordControl resource_sch_ticketRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "Resource_sch_ticketRecordControl") as OEMConversion.UI.Controls.Edit_Resource_sch_ticket.Resource_sch_ticketRecordControl);
          
              if (resource_sch_ticketRecordControlObj != null && resource_sch_ticketRecordControlObj.GetRecord() != null && resource_sch_ticketRecordControlObj.GetRecord().IsCreated)
              {
              wc.iAND(Resource_sch_ticket_imgTable.resource_sch_ticket_id, BaseFilter.ComparisonOperator.EqualsTo, resource_sch_ticketRecordControlObj.GetRecord().resource_sch_ticket_id.ToString());
              selectedRecordKeyValue.AddElement(Resource_sch_ticket_imgTable.resource_sch_ticket_id.InternalName, resource_sch_ticketRecordControlObj.GetRecord().resource_sch_ticket_id.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      HttpContext.Current.Session["Resource_sch_ticket_imgTableControlWhereClause"] = selectedRecordKeyValue.ToXmlString();
      ...
      string selectedRecordInResource_sch_ticketRecordControl = HttpContext.Current.Session["Resource_sch_ticket_imgTableControlWhereClause"] as string;
      
      if (selectedRecordInResource_sch_ticketRecordControl != null && KeyValue.IsXmlKey(selectedRecordInResource_sch_ticketRecordControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInResource_sch_ticketRecordControl);
      
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(Resource_sch_ticket_imgTable.resource_sch_ticket_id))
      {
      wc.iAND(Resource_sch_ticket_imgTable.resource_sch_ticket_id, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(Resource_sch_ticket_imgTable.resource_sch_ticket_id).ToString());
      }
      ...
      Resource_sch_ticket_imgRecord rec = new Resource_sch_ticket_imgRecord();
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new Resource_sch_ticket_imgRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(OEMConversion.Business.Resource_sch_ticket_imgRecord);
                this.DataSource = (Resource_sch_ticket_imgRecord[])(finalList.ToArray(myrec));
        ...
        public void AddToDeletedRecordIds(Resource_sch_ticket_imgTableControlRow rec)
        {
            if (rec.IsNewRecord) {
                return;
            }
        ...
        protected virtual bool InDeletedRecordIds(Resource_sch_ticket_imgTableControlRow rec)            
        {
            if (this.DeletedRecordIds == null || this.DeletedRecordIds.Length == 0) {
                return (false);
            }
    ...
    this.RemoveFromSession(this, "Page_Size");
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            string orderByStr = (string)ViewState["Resource_sch_ticket_imgTableControl_OrderBy"];
        ...
        {            
            ...
            if (this.CurrentSortOrder != null) {
                this.ViewState["Resource_sch_ticket_imgTableControl_OrderBy"] = this.CurrentSortOrder.ToXmlString();
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                    string url = "../resource_sch_ticket_img/Add-Resource-sch-ticket-img.aspx?SaveAndNewVisible=False&TabVisible=False&ticket_id={Resource_sch_ticketRecordControl:FV:resource_sch_ticket_id}";
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "Resource_sch_ticket_imgTableControl_PostbackTracker").ClientID);                           
                                
                string javascriptCall = "";
                
                    javascriptCall = "initializePopupPage(document.getElementById('" + MiscUtils.FindControlRecursively(this, "Resource_sch_ticket_imgTableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = Resource_sch_ticket_imgTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  Resource_sch_ticket_imgRecord[] DataSource {
            ...
            get {
                return (Resource_sch_ticket_imgRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Functions"
        ...
        public override string EvaluateExpressions(string url, string arg, bool bEncrypt)
        {
            ...
            if (needToProcess) {
                Resource_sch_ticket_imgTableControlRow recCtl = this.GetSelectedRecordControl();
        ...
        public virtual Resource_sch_ticket_imgTableControlRow GetSelectedRecordControl()
        {
        ...
        public virtual Resource_sch_ticket_imgTableControlRow[] GetSelectedRecordControls()
        {
        
            return (Resource_sch_ticket_imgTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_Resource_sch_ticket.Resource_sch_ticket_imgTableControlRow")));
          
        }

        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            Resource_sch_ticket_imgTableControlRow[] recordList = this.GetSelectedRecordControls();
            if (recordList.Length == 0) {
                // Localization.
                throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "OEMConversion"));
            }
            
            foreach (Resource_sch_ticket_imgTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
        ...
        public virtual Resource_sch_ticket_imgTableControlRow[] GetRecordControls()
        {
            Control[] recCtrls = BaseClasses.Utils.MiscUtils.FindControlsRecursively(this, "Resource_sch_ticket_imgTableControlRow");
	          List<Resource_sch_ticket_imgTableControlRow> list = new List<Resource_sch_ticket_imgTableControlRow>();
	          foreach (Resource_sch_ticket_imgTableControlRow recCtrl in recCtrls) {
		          list.Add(recCtrl);
	          }
	          return list.ToArray();
        }
...
// Base class for the Resource_sch_timeTableControlRow control on the Edit_Resource_sch_ticket page.
// Do not modify this class. Instead override any method in Resource_sch_timeTableControlRow.
public class BaseResource_sch_timeTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseResource_sch_timeTableControlRow()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        // To customize, override this method in Resource_sch_timeTableControlRow.
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.resource_sch_technician_id.Click += resource_sch_technician_id_Click;
        ...
        public virtual void LoadData()  
        {
            ...
            // Since this is a row in the table, the data for this row is loaded by the 
            // LoadData method of the BaseResource_sch_timeTableControl when the data for the entire
            // table is loaded.
        ...
        public virtual void Setresource_sch_technician_id()
        {
            ...
            // Set the resource_sch_technician_id LinkButton on the webpage with value from the
            ...
            // this.resource_sch_technician_id is the ASP:LinkButton on the webpage.
                  
            if (this.DataSource != null && this.DataSource.resource_sch_technician_idSpecified) {
                								
                // If the resource_sch_technician_id is non-NULL, then format the value.
               ...
               if(_isExpandableNonCompositeForeignKey &&Resource_sch_timeTable.resource_sch_technician_id.IsApplyDisplayAs)
                     ...
                     formattedValue = Resource_sch_timeTable.GetDFKA(this.DataSource.resource_sch_technician_id.ToString(),Resource_sch_timeTable.resource_sch_technician_id, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(Resource_sch_timeTable.resource_sch_technician_id);
                                  
                                
                this.resource_sch_technician_id.Text = formattedValue;
                
                  this.resource_sch_technician_id.ToolTip = "Go to " + this.resource_sch_technician_id.Text.Replace("<wbr/>", "");
                   
            } 
            
            else {
            
                // resource_sch_technician_id is NULL in the database, so use the Default Value.  
                // Default Value could also be NULL.
        
              this.resource_sch_technician_id.Text = Resource_sch_timeTable.resource_sch_technician_id.Format(Resource_sch_timeTable.resource_sch_technician_id.DefaultValue);
        ...
        public virtual void Setresource_sch_time_date()
        {
            ...
            // Set the resource_sch_time_date Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.resource_sch_time database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.resource_sch_time record retrieved from the database.
            // this.resource_sch_time_date is the ASP:Literal on the webpage.
                  
            if (this.DataSource != null && this.DataSource.resource_sch_time_dateSpecified) {
              ...
              this.resource_sch_time_date.Text = Resource_sch_timeTable.resource_sch_time_date.Format(Resource_sch_timeTable.resource_sch_time_date.DefaultValue, @"d");
            		
            }
            
            // If the resource_sch_time_date is NULL or blank, then use the value specified  
            // on Properties.
            if (this.resource_sch_time_date.Text == null ||
                this.resource_sch_time_date.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.resource_sch_time_date.Text = "&nbsp;";
            }
                                     
        }
                
        public virtual void Settimehours()
        {
            
                    
            // Set the timehours Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.resource_sch_time database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.resource_sch_time record retrieved from the database.
            // this.timehours is the ASP:Literal on the webpage.
                  
            if (this.DataSource != null && this.DataSource.timehoursSpecified) {
                								
                // If the timehours is non-NULL, then format the value.
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(Resource_sch_timeTable.timehours);
                                
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                this.timehours.Text = formattedValue;
                   
            } 
            
            else {
            
                // timehours is NULL in the database, so use the Default Value.  
                // Default Value could also be NULL.
        
              this.timehours.Text = Resource_sch_timeTable.timehours.Format(Resource_sch_timeTable.timehours.DefaultValue);
        ...
        throw new Exception(Page.GetResourceValue("Err:NoParentRecId", "OEMConversion"));
          ...
          this.DataSource.resource_sch_ticket_id = parentCtrl.DataSource.resource_sch_ticket_id;
            ...
            if (this.DataSource.IsAnyValueChanged) {
                ...
                // Set the DataChanged flag to True for the for the related panels so they get refreshed as well.
                ((Resource_sch_timeTableControl)MiscUtils.GetParentControlObject(this, "Resource_sch_timeTableControl")).DataChanged = true;
                ((Resource_sch_timeTableControl)MiscUtils.GetParentControlObject(this, "Resource_sch_timeTableControl")).ResetData = true;
            }
        ...
        public virtual void Gettimehours()
        {
      ...
      // To customize, override this method in Resource_sch_timeTableControlRow.
        ...
        public virtual void EditRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../resource_sch_time/Edit-Resource-sch-time.aspx?Resource_sch_time={PK}";
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for LinkButton
        public virtual void resource_sch_technician_id_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Technicians/Show-Technicians.aspx?Technicians={Resource_sch_timeTableControlRow:FK:FK_resource_sch_time_Technicians}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseResource_sch_timeTableControlRow_Rec"];
            }
            set {
                this.ViewState["BaseResource_sch_timeTableControlRow_Rec"] = value;
            }
        }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton resource_sch_technician_id {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "resource_sch_technician_id");
            }
        }
            
        public System.Web.UI.WebControls.Literal resource_sch_time_date {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "resource_sch_time_date");
            }
        }
            
        public System.Web.UI.WebControls.Literal timehours {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "timehours");
            }
        }
             ...
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return Resource_sch_timeTable.GetRecord(this.RecordUniqueId, true);
...
// Base class for the Resource_sch_timeTableControl control on the Edit_Resource_sch_ticket page.
// Do not modify this class. Instead override any method in Resource_sch_timeTableControl.
public class BaseResource_sch_timeTableControl : OEMConversion.UI.BaseApplicationTableControl
{
         
       public BaseResource_sch_timeTableControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.resource_sch_technician_idFilter1)) 				
                    initialVal = this.GetFromSession(this.resource_sch_technician_idFilter1);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"resource_sch_technician_id\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    string[] resource_sch_technician_idFilter1itemListFromSession = initialVal.Split(',');
                    int index = 0;
                    foreach (string item in resource_sch_technician_idFilter1itemListFromSession)
                    {
                        ...
                        {
                            this.resource_sch_technician_idFilter1.Items.Add(item);
                            this.resource_sch_technician_idFilter1.Items[index].Selected = true;
                            index += 1;
                        }
                    }
                    foreach (ListItem listItem in this.resource_sch_technician_idFilter1.Items)
                    {
            ...
            else
            {
                ...
                this.CurrentSortOrder.Add(Resource_sch_timeTable.resource_sch_time_date, OrderByItem.OrderDir.Desc);
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.SortControl.SelectedIndexChanged += new EventHandler(SortControl_SelectedIndexChanged);
              ...
              this.resource_sch_technician_idFilter1.SelectedIndexChanged += resource_sch_technician_idFilter1_SelectedIndexChanged;                  
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                        // Initialize an empty array of records
                      ArrayList alist = new ArrayList(0);
                      Type myrec = typeof(OEMConversion.Business.Resource_sch_timeRecord);
                      this.DataSource = (Resource_sch_timeRecord[])(alist.ToArray(myrec));
                      // Add records to the list if needed.
                      this.AddNewRecords();
                      this._TotalRecords = 0;
                      this._TotalPages = 0;
                ...
                if (this.AddNewRecord > 0) {
                    // Make sure to preserve the previously entered data on new rows.
                    ArrayList postdata = new ArrayList(0);
                    foreach (Resource_sch_timeTableControlRow rc in this.GetRecordControls()) {
                        if (!rc.IsNewRecord) {
                            rc.DataSource = rc.GetRecord();
                            rc.GetUIData();
                            postdata.Add(rc.DataSource);
                    ...
                    Type myrec = typeof(OEMConversion.Business.Resource_sch_timeRecord);
                    this.DataSource = (Resource_sch_timeRecord[])(postdata.ToArray(myrec));
                } 
                else {
                    // Get the records from the database
        ...
        public virtual Resource_sch_timeRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            // by default, Select * will be executed to get a list of records.  If you want to run Select Distinct with certain column only, add the column to selCols
            ColumnList selCols = new ColumnList();                 
            ...
            // However, if you don't specify PK, row button click might show an error message.
            // And make sure you write similar code in GetRecordCount as well
            // selCols.Add(Resource_sch_timeTable.Column1, true);          
            // selCols.Add(Resource_sch_timeTable.Column2, true);          
            // selCols.Add(Resource_sch_timeTable.Column3, true);          
                  ...
                  
            {
                ...
                return Resource_sch_timeTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                Resource_sch_timeTable databaseTable = new Resource_sch_timeTable();
                databaseTable.SelectedColumns.Clear();
                databaseTable.SelectedColumns.AddRange(selCols);
                ...
                orderBy.ExpandForeignKeyColums = false;
                recList = databaseTable.GetRecordList(join, where.GetFilter(), null, orderBy, pageIndex, pageSize);
                return (recList.ToArray(typeof(Resource_sch_timeRecord)) as Resource_sch_timeRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0)                 
                ...
                return Resource_sch_timeTable.GetRecordCount(join, where);
            else
            {
                Resource_sch_timeTable databaseTable = new Resource_sch_timeTable();
                databaseTable.SelectedColumns.Clear();
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Resource_sch_timeTableControlRepeater"));
        if (rep == null){return;}
        rep.DataSource = this.DataSource;
        rep.DataBind();
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Loop through all rows in the table, set its DataSource and call DataBind().
            Resource_sch_timeTableControlRow recControl = (Resource_sch_timeTableControlRow)(repItem.FindControl("Resource_sch_timeTableControlRow"));
            recControl.DataSource = this.DataSource[index];            
            if (this.UIData.Count > index)
                recControl.PreviousUIData = this.UIData[index];
            recControl.DataBind();
            ...
            // Call the Set methods for each controls on the panel
                ...
                Setresource_sch_technician_idFilter1();
                Setresource_sch_technician_idLabel();
                Setresource_sch_technician_idLabel2();
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(Resource_sch_timeTable.resource_sch_technician_id, this.DataSource);
        }
        ...
        public virtual void ResetControl()
        {
            ...
            this.resource_sch_technician_idFilter1.ClearSelection();
        ...
        protected virtual void BindPaginationControls()
        {
            ...
            // Bind the buttons for Resource_sch_timeTableControl pagination.
        ...
        public virtual void SaveData()
        {
            ...
            foreach (Resource_sch_timeTableControlRow recCtl in this.GetRecordControls())
            {
    ...
    OEMConversion.UI.Controls.Edit_Resource_sch_ticket.Resource_sch_ticketRecordControl resource_sch_ticketRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "Resource_sch_ticketRecordControl") as OEMConversion.UI.Controls.Edit_Resource_sch_ticket.Resource_sch_ticketRecordControl);
              ...
              if (resource_sch_ticketRecordControlObj != null && resource_sch_ticketRecordControlObj.GetRecord() != null && resource_sch_ticketRecordControlObj.GetRecord().IsCreated)
              {
              wc.iAND(Resource_sch_timeTable.resource_sch_ticket_id, BaseFilter.ComparisonOperator.EqualsTo, resource_sch_ticketRecordControlObj.GetRecord().resource_sch_ticket_id.ToString());
              selectedRecordKeyValue.AddElement(Resource_sch_timeTable.resource_sch_ticket_id.InternalName, resource_sch_ticketRecordControlObj.GetRecord().resource_sch_ticket_id.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      HttpContext.Current.Session["Resource_sch_timeTableControlWhereClause"] = selectedRecordKeyValue.ToXmlString();
    
            if (MiscUtils.IsValueSelected(this.resource_sch_technician_idFilter1)) {
                        
                int selectedItemCount = 0;
                foreach (ListItem item in this.resource_sch_technician_idFilter1.Items){
                    if (item.Selected) {
                        selectedItemCount += 1;
                ...
                foreach (ListItem item in this.resource_sch_technician_idFilter1.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(Resource_sch_timeTable.resource_sch_technician_id, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
      ...
      string selectedRecordInResource_sch_ticketRecordControl = HttpContext.Current.Session["Resource_sch_timeTableControlWhereClause"] as string;
      
      if (selectedRecordInResource_sch_ticketRecordControl != null && KeyValue.IsXmlKey(selectedRecordInResource_sch_ticketRecordControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInResource_sch_ticketRecordControl);
      
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(Resource_sch_timeTable.resource_sch_ticket_id))
      {
      wc.iAND(Resource_sch_timeTable.resource_sch_ticket_id, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(Resource_sch_timeTable.resource_sch_ticket_id).ToString());
      }
      ...
      String resource_sch_technician_idFilter1SelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "resource_sch_technician_idFilter1_Ajax"];
            if (MiscUtils.IsValueSelected(resource_sch_technician_idFilter1SelectedValue)) {

              
        if (resource_sch_technician_idFilter1SelectedValue != null){
                        string[] resource_sch_technician_idFilter1itemListFromSession = resource_sch_technician_idFilter1SelectedValue.Split(',');
                        int index = 0;
                        WhereClause filter = new WhereClause();
                        foreach (string item in resource_sch_technician_idFilter1itemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(Resource_sch_timeTable.resource_sch_technician_id, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (recControl.Visible && recControl.IsNewRecord) {
      Resource_sch_timeRecord rec = new Resource_sch_timeRecord();
        
                        if (recControl.resource_sch_technician_id.Text != "") {
                            rec.Parse(recControl.resource_sch_technician_id.Text, Resource_sch_timeTable.resource_sch_technician_id);
                  }
                
                        if (recControl.resource_sch_time_date.Text != "") {
                            rec.Parse(recControl.resource_sch_time_date.Text, Resource_sch_timeTable.resource_sch_time_date);
                  }
                
                        if (recControl.timehours.Text != "") {
                            rec.Parse(recControl.timehours.Text, Resource_sch_timeTable.timehours);
                  }
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new Resource_sch_timeRecord());
                newUIDataList.Insert(0, new Hashtable());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(OEMConversion.Business.Resource_sch_timeRecord);
                this.DataSource = (Resource_sch_timeRecord[])(finalList.ToArray(myrec));
        ...
        public void AddToDeletedRecordIds(Resource_sch_timeTableControlRow rec)
        {
            if (rec.IsNewRecord) {
                return;
            }
        ...
        protected virtual bool InDeletedRecordIds(Resource_sch_timeTableControlRow rec)            
        {
            if (this.DeletedRecordIds == null || this.DeletedRecordIds.Length == 0) {
                return (false);
            }
        ...
        public virtual void Setresource_sch_technician_idLabel()
                  {
                  
                        this.resource_sch_technician_idLabel.Text = EvaluateFormula("\"Resource\"");
                      
                    
        }
                
        public virtual void Setresource_sch_technician_idLabel2()
                  {
                  
                        this.resource_sch_technician_idLabel2.Text = EvaluateFormula("\"Resource\"");
        ...
        public virtual void Setresource_sch_technician_idFilter1()
        {
            
            ArrayList resource_sch_technician_idFilter1selectedFilterItemList = new ArrayList();
            string resource_sch_technician_idFilter1itemsString = null;
            if (this.InSession(this.resource_sch_technician_idFilter1))
                resource_sch_technician_idFilter1itemsString = this.GetFromSession(this.resource_sch_technician_idFilter1);
            
            if (resource_sch_technician_idFilter1itemsString != null)
            {
                string[] resource_sch_technician_idFilter1itemListFromSession = resource_sch_technician_idFilter1itemsString.Split(',');
                foreach (string item in resource_sch_technician_idFilter1itemListFromSession)
                {
                    resource_sch_technician_idFilter1selectedFilterItemList.Add(item);
                }
            }
              
            			
            this.Populateresource_sch_technician_idFilter1(MiscUtils.GetSelectedValueList(this.resource_sch_technician_idFilter1, resource_sch_technician_idFilter1selectedFilterItemList), 500);
                    
              string url = this.ModifyRedirectUrl("../Technicians/Technicians-QuickSelector.aspx", "", true);
              
              url = this.Page.ModifyRedirectUrl(url, "", true);                                  
              
              url += "?Target=" + this.resource_sch_technician_idFilter1.ClientID + "&Formula=" + (this.Page as BaseApplicationPage).Encrypt("=Technicians.TechName")+ "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("technician_id")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--ANY--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:All")) + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.resource_sch_technician_idFilter1.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(resource_sch_technician_idFilter1.AutoPostBack).ToLower() + ", event); return false;";
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Resource SCH Technician {Txt:Ascending}"), "resource_sch_technician_id Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Resource SCH Technician {Txt:Descending}"), "resource_sch_technician_id Desc"));
                ...
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Resource SCH Time Date {Txt:Ascending}"), "resource_sch_time_date Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Resource SCH Time Date {Txt:Descending}"), "resource_sch_time_date Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Resource SCH Time Hours {Txt:Ascending}"), "resource_sch_time_hours Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Resource SCH Time Hours {Txt:Descending}"), "resource_sch_time_hours Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Time Interval {Txt:Ascending}"), "time_interval_id Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Time Interval {Txt:Descending}"), "time_interval_id Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Resource SCH Time Minimum {Txt:Ascending}"), "resource_sch_time_min Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Resource SCH Time Minimum {Txt:Descending}"), "resource_sch_time_min Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Time Entry Year {Txt:Ascending}"), "timeentryyear Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Time Entry Year {Txt:Descending}"), "timeentryyear Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Time Entryweek {Txt:Ascending}"), "timeentryweek Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Time Entryweek {Txt:Descending}"), "timeentryweek Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Time Hours {Txt:Ascending}"), "timehours Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Time Hours {Txt:Descending}"), "timehours Desc"));
        ...
        // Get the filters' data for resource_sch_technician_idFilter1.
                
        protected virtual void Populateresource_sch_technician_idFilter1(ArrayList selectedValue, int maxItems)
                    
        {
            ...
            WhereClause wc = this.CreateWhereClause_resource_sch_technician_idFilter1();            
            this.resource_sch_technician_idFilter1.Items.Clear();
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_resource_sch_technician_idFilter1 function.
                ...
                do
                {
                    ...
                    foreach (TechniciansRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.technician_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.resource_sch_technician_idFilter1.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                ListItem dupItem = this.resource_sch_technician_idFilter1.Items.FindByText(fvalue);
                                ...
                                this.resource_sch_technician_idFilter1.Items.Add(newItem);
            ...
            this.resource_sch_technician_idFilter1.SetFieldMaxLength(50);
                                 
                  
            // Add the selected value.
            if (this.resource_sch_technician_idFilter1.Items.Count == 0)
                this.resource_sch_technician_idFilter1.Items.Add(new ListItem(Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
        ...
        public virtual WhereClause CreateWhereClause_resource_sch_technician_idFilter1()
        {
            // Create a where clause for the filter resource_sch_technician_idFilter1.
            // This function is called by the Populate method to load the items 
            // in the resource_sch_technician_idFilter1QuickSelector
            ...
            resource_sch_technician_idFilter1selectedFilterItemList = MiscUtils.GetSelectedValueList(this.resource_sch_technician_idFilter1, resource_sch_technician_idFilter1selectedFilterItemList); 
            WhereClause wc = new WhereClause();
            if (resource_sch_technician_idFilter1selectedFilterItemList == null || resource_sch_technician_idFilter1selectedFilterItemList.Count == 0)
                wc.RunQuery = false;
            else            
            {
                foreach (string item in resource_sch_technician_idFilter1selectedFilterItemList)
                {
        ...
        protected override void SaveControlsToSession()
        {
            ...
            ArrayList resource_sch_technician_idFilter1selectedFilterItemList = MiscUtils.GetSelectedValueList(this.resource_sch_technician_idFilter1, null);
            string resource_sch_technician_idFilter1SessionString = "";
            if (resource_sch_technician_idFilter1selectedFilterItemList != null){
                foreach (string item in resource_sch_technician_idFilter1selectedFilterItemList){
                    resource_sch_technician_idFilter1SessionString = String.Concat(resource_sch_technician_idFilter1SessionString ,"," , item);
                }
            }
            this.SaveToSession(this.resource_sch_technician_idFilter1, resource_sch_technician_idFilter1SessionString);
        ...
        protected  void SaveControlsToSession_Ajax()
        {
            ...
            this.SaveToSession("resource_sch_technician_idFilter1_Ajax", resource_sch_technician_idFilter1SessionString);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.resource_sch_technician_idFilter1);
    ...
    this.RemoveFromSession(this, "Page_Size");
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            string orderByStr = (string)ViewState["Resource_sch_timeTableControl_OrderBy"];
        ...
        {            
            ...
            if (this.CurrentSortOrder != null) {
                this.ViewState["Resource_sch_timeTableControl_OrderBy"] = this.CurrentSortOrder.ToXmlString();
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                    string url = "../resource_sch_time/Add-Resource-sch-time.aspx?TabVisible=False&SaveAndNewVisible=False&resource_sch_ticket_id={Resource_sch_ticketRecordControl:FV:resource_sch_ticket_id}";
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "Resource_sch_timeTableControl_PostbackTracker").ClientID);                           
                                
                string javascriptCall = "";
                
                    javascriptCall = "initializePopupPage(document.getElementById('" + MiscUtils.FindControlRecursively(this, "Resource_sch_timeTableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(resource_sch_technician_idFilter1))
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = Resource_sch_timeTable.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
              
                // Add each of the columns in order of export.
                BaseColumn[] columns = new BaseColumn[] {
                             Resource_sch_timeTable.resource_sch_technician_id,
             Resource_sch_timeTable.resource_sch_time_date,
             Resource_sch_timeTable.timehours,
             null};
                ExportDataToCSV exportData = new ExportDataToCSV(Resource_sch_timeTable.Instance,wc,orderBy,columns);
                exportData.StartExport(this.Page.Response, true);

                DataForExport dataForCSV = new DataForExport(Resource_sch_timeTable.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(Resource_sch_timeTable.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(Resource_sch_timeTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(Resource_sch_timeTable.resource_sch_technician_id, "Default"));
             data.ColumnList.Add(new ExcelColumn(Resource_sch_timeTable.resource_sch_time_date, "Short Date"));
             data.ColumnList.Add(new ExcelColumn(Resource_sch_timeTable.timehours, "Standard"));
              ...
              {
                val = Resource_sch_timeTable.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Edit-Resource-sch-ticket.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "resource_sch_time";
                // If Edit-Resource-sch-ticket.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(Resource_sch_timeTable.resource_sch_technician_id.Name, ReportEnum.Align.Left, "${resource_sch_technician_id}", ReportEnum.Align.Left, 20);
                 report.AddColumn(Resource_sch_timeTable.resource_sch_time_date.Name, ReportEnum.Align.Left, "${resource_sch_time_date}", ReportEnum.Align.Left, 20);
                 report.AddColumn(Resource_sch_timeTable.timehours.Name, ReportEnum.Align.Right, "${timehours}", ReportEnum.Align.Right, 16);
                ...
                ColumnList columns = Resource_sch_timeTable.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = Resource_sch_timeTable.GetRecordCount(joinFilter,whereClause);
                Resource_sch_timeRecord[] records = null;
                
                do
                {
                    
                    records = Resource_sch_timeTable.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( Resource_sch_timeRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 if (BaseClasses.Utils.MiscUtils.IsNull(record.resource_sch_technician_id)){
                                 report.AddData("${resource_sch_technician_id}", "",ReportEnum.Align.Left);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = Resource_sch_timeTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Resource_sch_timeTable.resource_sch_technician_id);
                                 _DFKA = Resource_sch_timeTable.GetDFKA(record.resource_sch_technician_id.ToString(), Resource_sch_timeTable.resource_sch_technician_id,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  Resource_sch_timeTable.resource_sch_technician_id.IsApplyDisplayAs){
                                     report.AddData("${resource_sch_technician_id}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${resource_sch_technician_id}", record.Format(Resource_sch_timeTable.resource_sch_technician_id), ReportEnum.Align.Left);
                                 }
                             }
                             report.AddData("${resource_sch_time_date}", record.Format(Resource_sch_timeTable.resource_sch_time_date), ReportEnum.Align.Left, 300);
                             report.AddData("${timehours}", record.Format(Resource_sch_timeTable.timehours), ReportEnum.Align.Right, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Edit-Resource-sch-ticket.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "resource_sch_time";
                // If Edit-Resource-sch-ticket.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        protected virtual void SortControl_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in Resource_sch_timeTable.GetColumns())
                  {
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(Resource_sch_timeTable.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (Resource_sch_timeTable.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && Resource_sch_timeTable.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(Resource_sch_timeTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(Resource_sch_timeTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
        ...
        protected virtual void resource_sch_technician_idFilter1_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = Resource_sch_timeTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
                return (this._TotalRecords);
            }
            set {
        ...
        public  Resource_sch_timeRecord[] DataSource {
            ...
            get {
                return (Resource_sch_timeRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Properties"
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector resource_sch_technician_idFilter1 {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "resource_sch_technician_idFilter1");
            }
        }              
        
        public System.Web.UI.WebControls.Literal resource_sch_technician_idLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "resource_sch_technician_idLabel");
            }
        }
        
        public System.Web.UI.WebControls.Literal resource_sch_technician_idLabel2 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "resource_sch_technician_idLabel2");
            }
        }
...
#region "Helper Functions"
        ...
        public override string EvaluateExpressions(string url, string arg, bool bEncrypt)
        {
            bool needToProcess = AreAnyUrlParametersForMe(url, arg);
            if (needToProcess) {
                Resource_sch_timeTableControlRow recCtl = this.GetSelectedRecordControl();
                if (recCtl == null && url.IndexOf("{") >= 0) {
                    // Localization.
                    throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "OEMConversion"));
                }
        ...
        public virtual Resource_sch_timeTableControlRow GetSelectedRecordControl()
        {
        ...
        public virtual Resource_sch_timeTableControlRow[] GetSelectedRecordControls()
        {
        
            return (Resource_sch_timeTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_Resource_sch_ticket.Resource_sch_timeTableControlRow")));
          
        }

        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            Resource_sch_timeTableControlRow[] recordList = this.GetSelectedRecordControls();
            if (recordList.Length == 0) {
                // Localization.
                throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "OEMConversion"));
            }
            
            foreach (Resource_sch_timeTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
                    if (!recCtl.IsNewRecord) {
        ...
        public virtual Resource_sch_timeTableControlRow[] GetRecordControls()
        {
            Control[] recCtrls = BaseClasses.Utils.MiscUtils.FindControlsRecursively(this, "Resource_sch_timeTableControlRow");
	          List<Resource_sch_timeTableControlRow> list = new List<Resource_sch_timeTableControlRow>();
	          foreach (Resource_sch_timeTableControlRow recCtrl in recCtrls) {
		          list.Add(recCtrl);
	          }
	          return list.ToArray();
        }
...
// Base class for the Resource_sch_ticketRecordControl control on the Edit_Resource_sch_ticket page.
...
public class BaseResource_sch_ticketRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.modified_by1.SelectedIndexChanged += modified_by1_SelectedIndexChanged;
              ...
              this.modified_datetime1.TextChanged += modified_datetime1_TextChanged;
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                Setmodified_by1();
                Setmodified_byLabel();
                Setmodified_datetime();
                Setmodified_datetime1();
                Setmodified_datetimeLabel();
                Setproject_id();
                Setproject_idLabel();
                Setproject_role_id();
            ...
            bool shouldResetControl = false;
            if (shouldResetControl) { }; // prototype usage to void compiler warnings
            Resource_sch_ticket_imgTableControl recResource_sch_ticket_imgTableControl = (Resource_sch_ticket_imgTableControl)(MiscUtils.FindControlRecursively(this.Page, "Resource_sch_ticket_imgTableControl"));
        
          if (shouldResetControl || this.Page.IsPageRefresh)
          {
             recResource_sch_ticket_imgTableControl.ResetControl();
          }
                  
        this.Page.SetControl("Resource_sch_ticket_imgTableControl");
        Resource_sch_timeTableControl recResource_sch_timeTableControl = (Resource_sch_timeTableControl)(MiscUtils.FindControlRecursively(this.Page, "Resource_sch_timeTableControl"));
        
          if (shouldResetControl || this.Page.IsPageRefresh)
          {
             recResource_sch_timeTableControl.ResetControl();
          }
                  
        this.Page.SetControl("Resource_sch_timeTableControl");
        ...
        public virtual void Setcreated_by()
        {
            ...
            if (this.DataSource != null && this.DataSource.created_bySpecified) {
                ...
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = "";
               Boolean _isExpandableNonCompositeForeignKey = Resource_sch_ticketTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Resource_sch_ticketTable.created_by);
               if(_isExpandableNonCompositeForeignKey &&Resource_sch_ticketTable.created_by.IsApplyDisplayAs)
                                  
                     formattedValue = Resource_sch_ticketTable.GetDFKA(this.DataSource.created_by.ToString(),Resource_sch_ticketTable.created_by, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(Resource_sch_ticketTable.created_by);
              ...
              this.created_by.Text = Resource_sch_ticketTable.created_by.Format(Resource_sch_ticketTable.created_by.DefaultValue);
        ...
        public virtual void Setcreated_datetime()
        {
            ...
            if (this.DataSource != null && this.DataSource.created_datetimeSpecified) {
              ...
              this.created_datetime.Text = Resource_sch_ticketTable.created_datetime.Format(Resource_sch_ticketTable.created_datetime.DefaultValue, @"g");
        ...
        public virtual void Setmodified_by()
        {
            
                    
            // Set the modified_by Label on the webpage with value from the
            // DatabaseAYS_OEM%dbo.resource_sch_ticket database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.resource_sch_ticket record retrieved from the database.
            // this.modified_by is the ASP:Label on the webpage.
                  
            if (this.DataSource != null && this.DataSource.modified_bySpecified) {
                								
                // If the modified_by is non-NULL, then format the value.
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = "";
               Boolean _isExpandableNonCompositeForeignKey = Resource_sch_ticketTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Resource_sch_ticketTable.modified_by);
               if(_isExpandableNonCompositeForeignKey &&Resource_sch_ticketTable.modified_by.IsApplyDisplayAs)
                                  
                     formattedValue = Resource_sch_ticketTable.GetDFKA(this.DataSource.modified_by.ToString(),Resource_sch_ticketTable.modified_by, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(Resource_sch_ticketTable.modified_by);
                ...
                // modified_by is NULL in the database, so use the Default Value.  
                // Default Value could also be NULL.
        
              this.modified_by.Text = Resource_sch_ticketTable.modified_by.Format(Resource_sch_ticketTable.modified_by.DefaultValue);
            		
            }
                               
        }
                
        public virtual void Setmodified_by1()
        {
            ...
            // Set the modified_by DropDownList on the webpage with value from the
            // DatabaseAYS_OEM%dbo.resource_sch_ticket database record.
            
            // this.DataSource is the DatabaseAYS_OEM%dbo.resource_sch_ticket record retrieved from the database.
            // this.modified_by1 is the ASP:DropDownList on the webpage.
            
            // You can modify this method directly, or replace it with a call to
            //     base.Setmodified_by1();
            // and add your own custom code before or after the call to the base function.
            ...
            if (this.DataSource != null && this.DataSource.modified_bySpecified)
            {
                ...
                // If the modified_by is non-NULL, then format the value.
                // The Format method will return the Display Foreign Key As (DFKA) value
                selectedValue = this.DataSource.modified_by.ToString();
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = Resource_sch_ticketTable.modified_by.DefaultValue;
            ...
            this.Populatemodified_by1DropDownList(selectedValue, 100);              
                
                  
        }
                
        public virtual void Setmodified_datetime()
        {
            
                    
            // Set the modified_datetime Label on the webpage with value from the
            // DatabaseAYS_OEM%dbo.resource_sch_ticket database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.resource_sch_ticket record retrieved from the database.
            // this.modified_datetime is the ASP:Label on the webpage.
                  
            if (this.DataSource != null && this.DataSource.modified_datetimeSpecified) {
                								
                // If the modified_datetime is non-NULL, then format the value.
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(Resource_sch_ticketTable.modified_datetime, @"g");
                                
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                this.modified_datetime.Text = formattedValue;
                   
            } 
            
            else {
            
                // modified_datetime is NULL in the database, so use the Default Value.  
                // Default Value could also be NULL.
        
              this.modified_datetime.Text = Resource_sch_ticketTable.modified_datetime.Format(Resource_sch_ticketTable.modified_datetime.DefaultValue, @"g");
            		
            }
                               
        }
                
        public virtual void Setmodified_datetime1()
        {
            
                    
            // Set the modified_datetime TextBox on the webpage with value from the
            // DatabaseAYS_OEM%dbo.resource_sch_ticket database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.resource_sch_ticket record retrieved from the database.
            // this.modified_datetime1 is the ASP:TextBox on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
                ...
                this.modified_datetime1.Text = formattedValue;
              ...
              this.modified_datetime1.Text = Resource_sch_ticketTable.modified_datetime.Format(Resource_sch_ticketTable.modified_datetime.DefaultValue, @"g");
        ...
        public virtual void Setresource_sch_ticket_id()
        {
            ...
            if (this.DataSource != null && this.DataSource.resource_sch_ticket_idSpecified) {
                ...
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = "";
               Boolean _isExpandableNonCompositeForeignKey = Resource_sch_ticketTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Resource_sch_ticketTable.resource_sch_ticket_id);
               if(_isExpandableNonCompositeForeignKey &&Resource_sch_ticketTable.resource_sch_ticket_id.IsApplyDisplayAs)
                                  
                     formattedValue = Resource_sch_ticketTable.GetDFKA(this.DataSource.resource_sch_ticket_id.ToString(),Resource_sch_ticketTable.resource_sch_ticket_id, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(Resource_sch_ticketTable.resource_sch_ticket_id);
              ...
              this.resource_sch_ticket_id.Text = Resource_sch_ticketTable.resource_sch_ticket_id.Format(Resource_sch_ticketTable.resource_sch_ticket_id.DefaultValue);
        ...
        public virtual void Setrono()
        {
            ...
            if (this.DataSource != null && this.DataSource.ronoSpecified) {
                ...
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = "";
               Boolean _isExpandableNonCompositeForeignKey = Resource_sch_ticketTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Resource_sch_ticketTable.rono);
               if(_isExpandableNonCompositeForeignKey &&Resource_sch_ticketTable.rono.IsApplyDisplayAs)
                                  
                     formattedValue = Resource_sch_ticketTable.GetDFKA(this.DataSource.rono.ToString(),Resource_sch_ticketTable.rono, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(Resource_sch_ticketTable.rono);
              ...
              this.rono.Text = Resource_sch_ticketTable.rono.Format(Resource_sch_ticketTable.rono.DefaultValue);
        ...
        public virtual void Settime_interval_id()
        {
            ...
            if (this.DataSource != null && this.DataSource.time_interval_idSpecified)
            {
                            
                // If the time_interval_id is non-NULL, then format the value.
                // The Format method will return the Display Foreign Key As (DFKA) value
            ...
            else
            {
                ...
                // time_interval_id is NULL in the database, so use the Default Value.  
                // Default Value could also be NULL.
                if (this.DataSource != null && this.DataSource.IsCreated)
                    selectedValue = null;
                else
                    selectedValue = Resource_sch_ticketTable.time_interval_id.DefaultValue;
        ...
        public virtual void Setmodified_byLabel()
                  {
                  
                    
        }
                
        public virtual void Setmodified_datetimeLabel()
                  {
        ...
        public virtual void SetronoLabel()
                  {
                        ...
                        this.ronoLabel.Text = EvaluateFormula("if(rono>1,\"RO#\",\"\")");
        ...
        public virtual void SaveData()
        {
            ...
            // For Master-Detail relationships, save data on the Detail table(s)            
          Resource_sch_ticket_imgTableControl recResource_sch_ticket_imgTableControl = (Resource_sch_ticket_imgTableControl)(MiscUtils.FindControlRecursively(this.Page, "Resource_sch_ticket_imgTableControl"));
        recResource_sch_ticket_imgTableControl.SaveData();
          Resource_sch_timeTableControl recResource_sch_timeTableControl = (Resource_sch_timeTableControl)(MiscUtils.FindControlRecursively(this.Page, "Resource_sch_timeTableControl"));
        recResource_sch_timeTableControl.SaveData();
        ...
        public virtual void GetUIData()
        {
            ...
            Getmodified_by();
            Getmodified_by1();
            Getmodified_datetime();
            Getmodified_datetime1();
            Getproject_id();
            Getproject_role_id();
        ...
        public virtual void Getmodified_by()
        {
            
        }
                
        public virtual void Getmodified_by1()
        {
         // Retrieve the value entered by the user on the modified_by ASP:DropDownList, and
            // save it into the modified_by field in DataSource DatabaseAYS_OEM%dbo.resource_sch_ticket record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.modified_by1), Resource_sch_ticketTable.modified_by);			
                			 
        }
                
        public virtual void Getmodified_datetime()
        {
            
        }
                
        public virtual void Getmodified_datetime1()
        {
            
            // Retrieve the value entered by the user on the modified_datetime ASP:TextBox, and
            // save it into the modified_datetime field in DataSource DatabaseAYS_OEM%dbo.resource_sch_ticket record.
            // Parse will also validate the date to ensure it is of the proper format
            // and a valid date.  The format is verified based on the current culture 
            // settings including the order of month, day and year and the separator character.
            // Parse throws an exception if the date is invalid.
            ...
            // Save the value to data source
            this.DataSource.Parse(this.modified_datetime1.Text, Resource_sch_ticketTable.modified_datetime);							
      ...
      // To customize, override this method in Resource_sch_ticketRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Edit-Resource-sch-ticket"] = recId;
        ...
        public virtual WhereClause CreateWhereClause_modified_by1DropDownList() 
        {
            // By default, we simply return a new WhereClause.
            // Add additional where clauses to restrict the items shown in the dropdown list.
        ...
        // Fill the modified_by1 list.
        protected virtual void Populatemodified_by1DropDownList(string selectedValue, int maxItems) 
        {
            		  					                
            this.modified_by1.Items.Clear();
            
            // 1. Setup the static list items        
            		  			
            // 2. Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_modified_by1DropDownList function.
            // It is better to customize the where clause there.
            
                      
            WhereClause wc = CreateWhereClause_modified_by1DropDownList();
            ...
            // 3. Read a total of maxItems from the database and insert them into the modified_by1DropDownList.
            TechniciansRecord[] itemValues  = null;
            if (wc.RunQuery)
            {
                int counter = 0;
                ...
                do
                {
                    ...
                    foreach (TechniciansRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.technician_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.modified_by1.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                ListItem dupItem = this.modified_by1.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.modified_by1.Items.Add(newItem);
            ...
            if (selectedValue != null &&
                selectedValue.Trim() != "" &&
                !MiscUtils.SetSelectedValue(this.modified_by1, selectedValue) &&
                !MiscUtils.SetSelectedDisplayText(this.modified_by1, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        if (fvalue == null || fvalue.Trim() == "") fvalue = cvalue;
                        MiscUtils.ResetSelectedItem(this.modified_by1, new ListItem(fvalue, cvalue));                      
                    }
                }
                catch
                {
        ...
        protected virtual void modified_by1_SelectedIndexChanged(object sender, EventArgs args)
        {
            // for the value inserted by quick add button or large list selector, 
            // the value is necessary to be inserted by this event during postback 
            string val = (string)(this.Page.Session[modified_by1.ClientID + "_SelectedValue"]);
            string displayText = (string)(this.Page.Session[modified_by1.ClientID + "_SelectedDisplayText"]);
            if (!string.IsNullOrEmpty(displayText) && !string.IsNullOrEmpty(val)) {
	            this.modified_by1.Items.Add(new ListItem(displayText, val));
	            this.modified_by1.SelectedIndex = this.modified_by1.Items.Count - 1;
	            this.Page.Session.Remove(modified_by1.ClientID + "_SelectedValue");
	            this.Page.Session.Remove(modified_by1.ClientID + "_SelectedDisplayText");
            }
        ...
        protected virtual void modified_datetime1_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Label modified_by {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "modified_by");
            }
        }
            
        public System.Web.UI.WebControls.DropDownList modified_by1 {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "modified_by1");
            }
        }
        ...
        public System.Web.UI.WebControls.Label modified_datetime {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "modified_datetime");
            }
        }
            
        public System.Web.UI.WebControls.TextBox modified_datetime1 {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "modified_datetime1");
            }
        }
            
        public System.Web.UI.WebControls.Literal modified_datetimeLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "modified_datetimeLabel");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal ticket_costLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ticket_costLabel");
            }
        }
