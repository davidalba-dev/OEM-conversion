...
// Project_Add_Resource_sch_ticket.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Project_Add_Resource_sch_ticket
{
...
// Base class for the Resource_sch_ticketRecordControl control on the Project_Add_Resource_sch_ticket page.
...
public class BaseResource_sch_ticketRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in Resource_sch_ticketRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Project-Add-Resource-sch-ticket"] = recId;
