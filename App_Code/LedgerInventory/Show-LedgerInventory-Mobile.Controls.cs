...
// Show_LedgerInventory_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_LedgerInventory_Mobile
{
...
// Base class for the LedgerInventoryRecordControl control on the Show_LedgerInventory_Mobile page.
...
public class BaseLedgerInventoryRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "LedgerInventoryRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            this.DataSource = LedgerInventoryTable.GetRecord(recList[0].GetID().ToXmlString(), true);
      ...
      // To customize, override this method in LedgerInventoryRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["LedgerInventory"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "LedgerInventory"));
            }
            HttpContext.Current.Session["QueryString in Show-LedgerInventory-Mobile"] = recId;
