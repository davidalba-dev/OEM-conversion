...
// Show_LedgerInventory_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_LedgerInventory_Table
{
...
// Base class for the LedgerInventoryTableControlRow control on the Show_LedgerInventory_Table page.
...
public class BaseLedgerInventoryTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetLdgBin()
        {
            ...
            // Set the LdgBin Literal on the webpage with value from the
            ...
            // this.LdgBin is the ASP:Literal on the webpage.
            ...
            // If the LdgBin is NULL or blank, then use the value specified  
            // on Properties.
            if (this.LdgBin.Text == null ||
                this.LdgBin.Text.Trim().Length == 0) {
        ...
        public virtual void SetLdgBuyPrice()
        {
            ...
            // Set the LdgBuyPrice Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.LedgerInventory database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.LedgerInventory record retrieved from the database.
            // this.LdgBuyPrice is the ASP:Literal on the webpage.
            ...
            // If the LdgBuyPrice is NULL or blank, then use the value specified  
            // on Properties.
            if (this.LdgBuyPrice.Text == null ||
                this.LdgBuyPrice.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.LdgBuyPrice.Text = "&nbsp;";
            }
        ...
        public virtual void SetLdgExportInclude()
        {
            ...
            if (this.DataSource != null && this.DataSource.LdgExportIncludeSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(LedgerInventoryTable.LdgExportInclude);
              ...
              this.LdgExportInclude.Text = LedgerInventoryTable.LdgExportInclude.Format(LedgerInventoryTable.LdgExportInclude.DefaultValue);
        ...
        public virtual void SetLdgExportRecordChanged()
        {
            ...
            if (this.DataSource != null && this.DataSource.LdgExportRecordChangedSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(LedgerInventoryTable.LdgExportRecordChanged);
              ...
              this.LdgExportRecordChanged.Text = LedgerInventoryTable.LdgExportRecordChanged.Format(LedgerInventoryTable.LdgExportRecordChanged.DefaultValue);
        ...
        public virtual void SetLdgLocation()
        {
            ...
            // Set the LdgLocation Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.LedgerInventory database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.LedgerInventory record retrieved from the database.
            // this.LdgLocation is the ASP:Literal on the webpage.
            ...
            // If the LdgLocation is NULL or blank, then use the value specified  
            // on Properties.
            if (this.LdgLocation.Text == null ||
                this.LdgLocation.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.LdgLocation.Text = "&nbsp;";
            }
        ...
        public virtual void SetLdgPartNo()
        {
            ...
            // Set the LdgPartNo Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.LedgerInventory database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.LedgerInventory record retrieved from the database.
            // this.LdgPartNo is the ASP:Literal on the webpage.
            ...
            // If the LdgPartNo is NULL or blank, then use the value specified  
            // on Properties.
            if (this.LdgPartNo.Text == null ||
                this.LdgPartNo.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.LdgPartNo.Text = "&nbsp;";
            }
        ...
        public virtual void SetLdgQuantity()
        {
            ...
            // Set the LdgQuantity Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.LedgerInventory database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.LedgerInventory record retrieved from the database.
            // this.LdgQuantity is the ASP:Literal on the webpage.
            ...
            // If the LdgQuantity is NULL or blank, then use the value specified  
            // on Properties.
            if (this.LdgQuantity.Text == null ||
                this.LdgQuantity.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.LdgQuantity.Text = "&nbsp;";
            }
        ...
        public virtual void SetLdgSellPrice()
        {
            ...
            // Set the LdgSellPrice Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.LedgerInventory database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.LedgerInventory record retrieved from the database.
            // this.LdgSellPrice is the ASP:Literal on the webpage.
            ...
            // If the LdgSellPrice is NULL or blank, then use the value specified  
            // on Properties.
            if (this.LdgSellPrice.Text == null ||
                this.LdgSellPrice.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.LdgSellPrice.Text = "&nbsp;";
            }
        ...
        public virtual void SetLdgSerialNo()
        {
            ...
            // Set the LdgSerialNo Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.LedgerInventory database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.LedgerInventory record retrieved from the database.
            // this.LdgSerialNo is the ASP:Literal on the webpage.
            ...
            // If the LdgSerialNo is NULL or blank, then use the value specified  
            // on Properties.
            if (this.LdgSerialNo.Text == null ||
                this.LdgSerialNo.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.LdgSerialNo.Text = "&nbsp;";
            }
        ...
        public virtual void SetLdgUser()
        {
            ...
            // Set the LdgUser Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.LedgerInventory database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.LedgerInventory record retrieved from the database.
            // this.LdgUser is the ASP:Literal on the webpage.
            ...
            // If the LdgUser is NULL or blank, then use the value specified  
            // on Properties.
            if (this.LdgUser.Text == null ||
                this.LdgUser.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.LdgUser.Text = "&nbsp;";
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal LdgBin {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "LdgBin");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal LdgBuyPrice {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "LdgBuyPrice");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal LdgLocation {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "LdgLocation");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal LdgPartNo {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "LdgPartNo");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal LdgQuantity {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "LdgQuantity");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal LdgSellPrice {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "LdgSellPrice");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal LdgSerialNo {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "LdgSerialNo");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal LdgUser {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "LdgUser");
            }
        }
...
// Base class for the LedgerInventoryTableControl control on the Show_LedgerInventory_Table page.
...
public class BaseLedgerInventoryTableControl : OEMConversion.UI.BaseApplicationTableControl
{
       ...
       public BaseLedgerInventoryTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.LdgPartNoFilter)) 				
                    initialVal = this.GetFromSession(this.LdgPartNoFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"LdgPartNo\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    string[] LdgPartNoFilteritemListFromSession = initialVal.Split(',');
                    int index = 0;
                    foreach (string item in LdgPartNoFilteritemListFromSession)
                    {
                        if (index == 0 && item.ToString().Equals(""))
                        {
                            // do nothing
                        ...
                        {
                            this.LdgPartNoFilter.Items.Add(item);
                            this.LdgPartNoFilter.Items[index].Selected = true;
                            index += 1;
                        }
                    }
                    foreach (ListItem listItem in this.LdgPartNoFilter.Items)
                    {
                        listItem.Selected = true;
                    }
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.OrderSort.SelectedIndexChanged += new EventHandler(OrderSort_SelectedIndexChanged);
              ...
              this.LdgPartNoFilter.SelectedIndexChanged += LdgPartNoFilter_SelectedIndexChanged;                  
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public virtual void ResetControl()
        {
            ...
            this.LdgPartNoFilter.ClearSelection();
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.LdgPartNoFilter)) {
                        
                int selectedItemCount = 0;
                foreach (ListItem item in this.LdgPartNoFilter.Items){
                    if (item.Selected) {
                        selectedItemCount += 1;
                ...
                foreach (ListItem item in this.LdgPartNoFilter.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(LedgerInventoryTable.LdgPartNo, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
      ...
      String LdgPartNoFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "LdgPartNoFilter_Ajax"];
            if (MiscUtils.IsValueSelected(LdgPartNoFilterSelectedValue)) {

              
        if (LdgPartNoFilterSelectedValue != null){
                        string[] LdgPartNoFilteritemListFromSession = LdgPartNoFilterSelectedValue.Split(',');
                        int index = 0;
                        WhereClause filter = new WhereClause();
                        foreach (string item in LdgPartNoFilteritemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(LedgerInventoryTable.LdgPartNo, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
      ...
      LedgerInventoryRecord rec = new LedgerInventoryRecord();
                        ...
                        if (recControl.LdgExportInclude.Text != "") {
                            rec.Parse(recControl.LdgExportInclude.Text, LedgerInventoryTable.LdgExportInclude);
                  }
                
                        if (recControl.LdgExportRecordChanged.Text != "") {
                            rec.Parse(recControl.LdgExportRecordChanged.Text, LedgerInventoryTable.LdgExportRecordChanged);
                  }
        ...
        public virtual void SetLdgPartNoLabel1()
                  {
        ...
        public virtual void SetLdgPartNoFilter()
        {
            
            ArrayList LdgPartNoFilterselectedFilterItemList = new ArrayList();
            string LdgPartNoFilteritemsString = null;
            if (this.InSession(this.LdgPartNoFilter))
                LdgPartNoFilteritemsString = this.GetFromSession(this.LdgPartNoFilter);
            
            if (LdgPartNoFilteritemsString != null)
            {
                string[] LdgPartNoFilteritemListFromSession = LdgPartNoFilteritemsString.Split(',');
                foreach (string item in LdgPartNoFilteritemListFromSession)
                {
                    LdgPartNoFilterselectedFilterItemList.Add(item);
                }
            }
              
            			
            this.PopulateLdgPartNoFilter(MiscUtils.GetSelectedValueList(this.LdgPartNoFilter, LdgPartNoFilterselectedFilterItemList), 500);
                    
              string url = this.ModifyRedirectUrl("../LedgerInventory/LedgerInventory-QuickSelector.aspx", "", true);
              
              url = this.Page.ModifyRedirectUrl(url, "", true);                                  
              
              url += "?Target=" + this.LdgPartNoFilter.ClientID + "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("LdgPartNo")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--ANY--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:All")) + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.LdgPartNoFilter.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(LdgPartNoFilter.AutoPostBack).ToLower() + ", event); return false;";
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("LDG Reference {Txt:Ascending}"), "LdgReference Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("LDG Reference {Txt:Descending}"), "LdgReference Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("LDG Serial Number {Txt:Ascending}"), "LdgSerialNo Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("LDG Serial Number {Txt:Descending}"), "LdgSerialNo Desc"));
        ...
        // Get the filters' data for LdgPartNoFilter.
                
        protected virtual void PopulateLdgPartNoFilter(ArrayList selectedValue, int maxItems)
                    
        {
            ...
            WhereClause wc = this.CreateWhereClause_LdgPartNoFilter();            
            this.LdgPartNoFilter.Items.Clear();
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_LdgPartNoFilter function.
            // It is better to customize the where clause there.
             
            
            
            OrderBy orderBy = new OrderBy(false, false);
            orderBy.Add(LedgerInventoryTable.LdgPartNo, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = LedgerInventoryTable.GetValues(LedgerInventoryTable.LdgPartNo, wc, orderBy, maxItems);
            ...
            // Create the item and add to the list.
            string fvalue;
            if ( LedgerInventoryTable.LdgPartNo.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = LedgerInventoryTable.LdgPartNo.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
                ...
                ListItem dupItem = this.LdgPartNoFilter.Items.FindByText(fvalue);
                ...
                ListItem newItem = new ListItem(fvalue, cvalue);
                this.LdgPartNoFilter.Items.Add(newItem);
            ...
            this.LdgPartNoFilter.SetFieldMaxLength(50);
                                 
                  
            // Add the selected value.
            if (this.LdgPartNoFilter.Items.Count == 0)
                this.LdgPartNoFilter.Items.Add(new ListItem(Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
        ...
        public virtual WhereClause CreateWhereClause_LdgPartNoFilter()
        {
            // Create a where clause for the filter LdgPartNoFilter.
            // This function is called by the Populate method to load the items 
            // in the LdgPartNoFilterQuickSelector
            ...
            LdgPartNoFilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.LdgPartNoFilter, LdgPartNoFilterselectedFilterItemList); 
            WhereClause wc = new WhereClause();
            if (LdgPartNoFilterselectedFilterItemList == null || LdgPartNoFilterselectedFilterItemList.Count == 0)
                wc.RunQuery = false;
            else            
            {
                foreach (string item in LdgPartNoFilterselectedFilterItemList)
                {
            
      
   
                    wc.iOR(LedgerInventoryTable.LdgPartNo, BaseFilter.ComparisonOperator.EqualsTo, item);
        ...
        protected override void SaveControlsToSession()
        {
            ...
            ArrayList LdgPartNoFilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.LdgPartNoFilter, null);
            string LdgPartNoFilterSessionString = "";
            if (LdgPartNoFilterselectedFilterItemList != null){
                foreach (string item in LdgPartNoFilterselectedFilterItemList){
                    LdgPartNoFilterSessionString = String.Concat(LdgPartNoFilterSessionString ,"," , item);
                }
            }
            this.SaveToSession(this.LdgPartNoFilter, LdgPartNoFilterSessionString);
        ...
        protected  void SaveControlsToSession_Ajax()
        {
            ...
            this.SaveToSession("LdgPartNoFilter_Ajax", LdgPartNoFilterSessionString);
      ...
      this.SaveToSession("SearchText_Ajax", this.SearchText.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.LdgPartNoFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                    string url = "../LedgerInventory/Add-LedgerInventory.aspx?TabVisible=False&SaveAndNewVisible=False";
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "LedgerInventoryTableControl_PostbackTracker").ClientID);                           
                                
                string javascriptCall = "";
                
                    javascriptCall = "initializePopupPage(document.getElementById('" + MiscUtils.FindControlRecursively(this, "LedgerInventoryTableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(LdgPartNoFilter))
                themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = LedgerInventoryTable.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
              
                // Add each of the columns in order of export.
                BaseColumn[] columns = new BaseColumn[] {
                             LedgerInventoryTable.LdgBin,
             LedgerInventoryTable.LdgBuyPrice,
             LedgerInventoryTable.LdgExported,
             LedgerInventoryTable.LdgExportInclude,
             LedgerInventoryTable.LdgExportRecordChanged,
             LedgerInventoryTable.LdgFormNo,
             LedgerInventoryTable.LdgFormType,
             LedgerInventoryTable.LdgLocation,
             LedgerInventoryTable.LdgPartNo,
             LedgerInventoryTable.LdgQuantity,
             LedgerInventoryTable.LdgRecDate,
             LedgerInventoryTable.LdgReference,
             LedgerInventoryTable.LdgSellPrice,
             LedgerInventoryTable.LdgSerialNo,
             LedgerInventoryTable.LdgTrnDate,
             LedgerInventoryTable.LdgUser,
             null};
                ExportDataToCSV exportData = new ExportDataToCSV(LedgerInventoryTable.Instance,wc,orderBy,columns);
                exportData.StartExport(this.Page.Response, true);

                DataForExport dataForCSV = new DataForExport(LedgerInventoryTable.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(LedgerInventoryTable.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(LedgerInventoryTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(LedgerInventoryTable.LdgBin, "Default"));
             data.ColumnList.Add(new ExcelColumn(LedgerInventoryTable.LdgBuyPrice, "Currency"));
             data.ColumnList.Add(new ExcelColumn(LedgerInventoryTable.LdgExported, "Short Date"));
             data.ColumnList.Add(new ExcelColumn(LedgerInventoryTable.LdgExportInclude, "Default"));
             data.ColumnList.Add(new ExcelColumn(LedgerInventoryTable.LdgExportRecordChanged, "Default"));
             data.ColumnList.Add(new ExcelColumn(LedgerInventoryTable.LdgFormNo, "0"));
             data.ColumnList.Add(new ExcelColumn(LedgerInventoryTable.LdgFormType, "Default"));
             data.ColumnList.Add(new ExcelColumn(LedgerInventoryTable.LdgLocation, "0"));
             data.ColumnList.Add(new ExcelColumn(LedgerInventoryTable.LdgPartNo, "Default"));
             data.ColumnList.Add(new ExcelColumn(LedgerInventoryTable.LdgQuantity, "Standard"));
             data.ColumnList.Add(new ExcelColumn(LedgerInventoryTable.LdgRecDate, "Short Date"));
             data.ColumnList.Add(new ExcelColumn(LedgerInventoryTable.LdgReference, "Default"));
             data.ColumnList.Add(new ExcelColumn(LedgerInventoryTable.LdgSellPrice, "Currency"));
             data.ColumnList.Add(new ExcelColumn(LedgerInventoryTable.LdgSerialNo, "Default"));
             data.ColumnList.Add(new ExcelColumn(LedgerInventoryTable.LdgTrnDate, "Short Date"));
             data.ColumnList.Add(new ExcelColumn(LedgerInventoryTable.LdgUser, "Default"));
              ...
              {
                val = LedgerInventoryTable.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-LedgerInventory-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "LedgerInventory";
                // If Show-LedgerInventory-Table.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(LedgerInventoryTable.LdgBin.Name, ReportEnum.Align.Left, "${LdgBin}", ReportEnum.Align.Left, 20);
                 report.AddColumn(LedgerInventoryTable.LdgBuyPrice.Name, ReportEnum.Align.Right, "${LdgBuyPrice}", ReportEnum.Align.Right, 20);
                 report.AddColumn(LedgerInventoryTable.LdgExported.Name, ReportEnum.Align.Left, "${LdgExported}", ReportEnum.Align.Left, 20);
                 report.AddColumn(LedgerInventoryTable.LdgExportInclude.Name, ReportEnum.Align.Left, "${LdgExportInclude}", ReportEnum.Align.Left, 15);
                 report.AddColumn(LedgerInventoryTable.LdgExportRecordChanged.Name, ReportEnum.Align.Left, "${LdgExportRecordChanged}", ReportEnum.Align.Left, 15);
                 report.AddColumn(LedgerInventoryTable.LdgFormNo.Name, ReportEnum.Align.Right, "${LdgFormNo}", ReportEnum.Align.Right, 15);
                 report.AddColumn(LedgerInventoryTable.LdgFormType.Name, ReportEnum.Align.Left, "${LdgFormType}", ReportEnum.Align.Left, 15);
                 report.AddColumn(LedgerInventoryTable.LdgLocation.Name, ReportEnum.Align.Right, "${LdgLocation}", ReportEnum.Align.Right, 15);
                 report.AddColumn(LedgerInventoryTable.LdgPartNo.Name, ReportEnum.Align.Left, "${LdgPartNo}", ReportEnum.Align.Left, 24);
                 report.AddColumn(LedgerInventoryTable.LdgQuantity.Name, ReportEnum.Align.Right, "${LdgQuantity}", ReportEnum.Align.Right, 20);
                 report.AddColumn(LedgerInventoryTable.LdgRecDate.Name, ReportEnum.Align.Left, "${LdgRecDate}", ReportEnum.Align.Left, 20);
                 report.AddColumn(LedgerInventoryTable.LdgReference.Name, ReportEnum.Align.Left, "${LdgReference}", ReportEnum.Align.Left, 20);
                 report.AddColumn(LedgerInventoryTable.LdgSellPrice.Name, ReportEnum.Align.Right, "${LdgSellPrice}", ReportEnum.Align.Right, 20);
                 report.AddColumn(LedgerInventoryTable.LdgSerialNo.Name, ReportEnum.Align.Left, "${LdgSerialNo}", ReportEnum.Align.Left, 28);
                 report.AddColumn(LedgerInventoryTable.LdgTrnDate.Name, ReportEnum.Align.Left, "${LdgTrnDate}", ReportEnum.Align.Left, 20);
                 report.AddColumn(LedgerInventoryTable.LdgUser.Name, ReportEnum.Align.Left, "${LdgUser}", ReportEnum.Align.Left, 15);
                ...
                ColumnList columns = LedgerInventoryTable.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = LedgerInventoryTable.GetRecordCount(joinFilter,whereClause);
                LedgerInventoryRecord[] records = null;
                
                do
                {
                    
                    records = LedgerInventoryTable.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( LedgerInventoryRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${LdgBin}", record.Format(LedgerInventoryTable.LdgBin), ReportEnum.Align.Left, 300);
                             report.AddData("${LdgBuyPrice}", record.Format(LedgerInventoryTable.LdgBuyPrice), ReportEnum.Align.Right, 300);
                             report.AddData("${LdgExported}", record.Format(LedgerInventoryTable.LdgExported), ReportEnum.Align.Left, 300);
                             report.AddData("${LdgExportInclude}", record.Format(LedgerInventoryTable.LdgExportInclude), ReportEnum.Align.Left, 300);
                             report.AddData("${LdgExportRecordChanged}", record.Format(LedgerInventoryTable.LdgExportRecordChanged), ReportEnum.Align.Left, 300);
                             report.AddData("${LdgFormNo}", record.Format(LedgerInventoryTable.LdgFormNo), ReportEnum.Align.Right, 300);
                             report.AddData("${LdgFormType}", record.Format(LedgerInventoryTable.LdgFormType), ReportEnum.Align.Left, 300);
                             report.AddData("${LdgLocation}", record.Format(LedgerInventoryTable.LdgLocation), ReportEnum.Align.Right, 300);
                             report.AddData("${LdgPartNo}", record.Format(LedgerInventoryTable.LdgPartNo), ReportEnum.Align.Left, 300);
                             report.AddData("${LdgQuantity}", record.Format(LedgerInventoryTable.LdgQuantity), ReportEnum.Align.Right, 300);
                             report.AddData("${LdgRecDate}", record.Format(LedgerInventoryTable.LdgRecDate), ReportEnum.Align.Left, 300);
                             report.AddData("${LdgReference}", record.Format(LedgerInventoryTable.LdgReference), ReportEnum.Align.Left, 300);
                             report.AddData("${LdgSellPrice}", record.Format(LedgerInventoryTable.LdgSellPrice), ReportEnum.Align.Right, 300);
                             report.AddData("${LdgSerialNo}", record.Format(LedgerInventoryTable.LdgSerialNo), ReportEnum.Align.Left, 300);
                             report.AddData("${LdgTrnDate}", record.Format(LedgerInventoryTable.LdgTrnDate), ReportEnum.Align.Left, 300);
                             report.AddData("${LdgUser}", record.Format(LedgerInventoryTable.LdgUser), ReportEnum.Align.Left, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-LedgerInventory-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "LedgerInventory";
                // If Show-LedgerInventory-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        // event handler for FieldFilter
        protected virtual void LdgPartNoFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector LdgPartNoFilter {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "LdgPartNoFilter");
            }
        }              
        
        public System.Web.UI.WebControls.Literal LdgPartNoLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "LdgPartNoLabel1");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual LedgerInventoryTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (LedgerInventoryTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_LedgerInventory_Table.LedgerInventoryTableControlRow")));
