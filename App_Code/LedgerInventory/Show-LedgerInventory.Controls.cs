...
// Show_LedgerInventory.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_LedgerInventory
{
...
// Base class for the LedgerInventoryRecordControl control on the Show_LedgerInventory page.
...
public class BaseLedgerInventoryRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in LedgerInventoryRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-LedgerInventory"] = recId;
