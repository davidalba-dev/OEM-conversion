...
// Edit_LedgerInventory.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_LedgerInventory
{
...
// Base class for the LedgerInventoryRecordControl control on the Edit_LedgerInventory page.
...
public class BaseLedgerInventoryRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in LedgerInventoryRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Edit-LedgerInventory"] = recId;
