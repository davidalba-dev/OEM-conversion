...
// Show_LedgerInventory_Table_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_LedgerInventory_Table_Mobile
{
...
// Base class for the LedgerInventoryTableControlRow control on the Show_LedgerInventory_Table_Mobile page.
...
public class BaseLedgerInventoryTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetLdgBin()
        {
            ...
            // Set the LdgBin Label on the webpage with value from the
            ...
            // this.LdgBin is the ASP:Label on the webpage.
      ...
      // To customize, override this method in LedgerInventoryTableControlRow.
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../LedgerInventory/Show-LedgerInventory-Mobile.aspx?LedgerInventory={PK}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Label LdgBin {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "LdgBin");
            }
        }
...
// Base class for the LedgerInventoryTableControl control on the Show_LedgerInventory_Table_Mobile page.
...
public class BaseLedgerInventoryTableControl : OEMConversion.UI.BaseApplicationTableControl
{
       ...
       public BaseLedgerInventoryTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.LdgBinFilter)) 				
                    initialVal = this.GetFromSession(this.LdgBinFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"LdgBin\")");
                
                if (initialVal != null && initialVal != "")		
                {
                        
                    this.LdgBinFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.LdgBinFilter.SelectedValue = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.LdgBinFilter.SelectedIndexChanged += new EventHandler(LdgBinFilter_SelectedIndexChanged);
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep1 = (System.Web.UI.WebControls.Repeater)BaseClasses.Utils.MiscUtils.FindControlRecursively(rep.Items[PageIndex], "LedgerInventoryTableControlRepeater1");
        ...
        public virtual void ResetControl()
        {
            ...
            this.LdgBinFilter.ClearSelection();
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.LdgBinFilter)) {
                        
                wc.iAND(LedgerInventoryTable.LdgBin, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.LdgBinFilter, this.GetFromSession(this.LdgBinFilter)), false, false);
      ...
      String LdgBinFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "LdgBinFilter_Ajax"];
            if (MiscUtils.IsValueSelected(LdgBinFilterSelectedValue)) {

              
                wc.iAND(LedgerInventoryTable.LdgBin, BaseFilter.ComparisonOperator.EqualsTo, LdgBinFilterSelectedValue, false, false);
      ...
      foreach(BaseColumn col in cols)
      {
            ...
            foreach (LedgerInventoryRecord rec in recordList ){
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, LedgerInventoryTable.LdgFormType.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, LedgerInventoryTable.LdgPartNo.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (!this.ResetData)
            {
              System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "LedgerInventoryTableControlRepeater"));
              if (rep == null){return;}
              LedgerInventoryTableControlRow[] recControls = this.GetRecordControls();
                foreach (LedgerInventoryTableControlRow recControl in recControls) 
		{
      ...
      LedgerInventoryRecord rec = new LedgerInventoryRecord();
        ...
        public virtual void SetLdgBinFilter()
        {
            
            this.PopulateLdgBinFilter(MiscUtils.GetSelectedValue(this.LdgBinFilter,  GetFromSession(this.LdgBinFilter)), 500);					
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("LDG Buy Price {Txt:Ascending}"), "LdgBuyPrice Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("LDG Buy Price {Txt:Descending}"), "LdgBuyPrice Desc"));
        ...
        // Get the filters' data for LdgBinFilter.
                
        protected virtual void PopulateLdgBinFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.LdgBinFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_LdgBinFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_LdgBinFilter function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.LdgBinFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
              
            
            
            OrderBy orderBy = new OrderBy(false, false);
            orderBy.Add(LedgerInventoryTable.LdgBin, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = LedgerInventoryTable.GetValues(LedgerInventoryTable.LdgBin, wc, orderBy, maxItems);
            ...
            string fvalue;
            if ( LedgerInventoryTable.LdgBin.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = LedgerInventoryTable.LdgBin.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
                ...
                ListItem dupItem = this.LdgBinFilter.Items.FindByText(fvalue);
                ...
                this.LdgBinFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.LdgBinFilter, selectedValue);
            ...
            if (this.LdgBinFilter.SelectedValue != null && this.LdgBinFilter.Items.FindByValue(this.LdgBinFilter.SelectedValue) == null)
                this.LdgBinFilter.SelectedValue = null;
                           
        }
            
        public virtual WhereClause CreateWhereClause_LdgBinFilter()
        {
            // Create a where clause for the filter LdgBinFilter.
            // This function is called by the Populate method to load the items 
            // in the LdgBinFilterDropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.LdgBinFilter, this.LdgBinFilter.SelectedValue);
      ...
      this.SaveToSession("LdgBinFilter_Ajax", this.LdgBinFilter.SelectedValue);
      ...
      this.SaveToSession("SearchText_Ajax", this.SearchText.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.LdgBinFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void LdgBinFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList LdgBinFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "LdgBinFilter");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual LedgerInventoryTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (LedgerInventoryTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Show_LedgerInventory_Table_Mobile.LedgerInventoryTableControlRow")));
