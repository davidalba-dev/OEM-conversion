...
// Show_Vendors.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Vendors
{
...
// Base class for the RepairOrdersTableControlRow control on the Show_Vendors page.
...
public class BaseRepairOrdersTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.ROEstimatedBy.Click += ROEstimatedBy_Click;
                        
                    this.ROHowApproved.Click += ROHowApproved_Click;
                        
                    this.ROReceivedBy.Click += ROReceivedBy_Click;
        ...
        public virtual void SetROEstimatedBy()
        {
            ...
            // Set the ROEstimatedBy LinkButton on the webpage with value from the
            // DatabaseAYS_OEM%dbo.RepairOrders database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.RepairOrders record retrieved from the database.
            // this.ROEstimatedBy is the ASP:LinkButton on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.ROEstimatedBySpecified) {
               ...
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                ...
                this.ROEstimatedBy.Text = formattedValue;
                  ...
                  this.ROEstimatedBy.ToolTip = "Go to " + this.ROEstimatedBy.Text.Replace("<wbr/>", "");
        ...
        public virtual void SetROReceivedBy()
        {
            ...
            // Set the ROReceivedBy LinkButton on the webpage with value from the
            // DatabaseAYS_OEM%dbo.RepairOrders database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.RepairOrders record retrieved from the database.
            // this.ROReceivedBy is the ASP:LinkButton on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.ROReceivedBySpecified) {
               ...
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                ...
                this.ROReceivedBy.Text = formattedValue;
                  ...
                  this.ROReceivedBy.ToolTip = "Go to " + this.ROReceivedBy.Text.Replace("<wbr/>", "");
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for LinkButton
        public virtual void ROEstimatedBy_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Technicians/Show-Technicians.aspx?Technicians={RepairOrdersTableControlRow:FK:VFK_RepairOrders_ROEstimatedBy_1}";
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for LinkButton
        public virtual void ROReceivedBy_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Technicians/Show-Technicians.aspx?Technicians={RepairOrdersTableControlRow:FK:VFK_RepairOrders_ROReceivedBy_1}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton ROEstimatedBy {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROEstimatedBy");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton ROReceivedBy {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROReceivedBy");
            }
        }
...
// Base class for the RepairOrdersTableControl control on the Show_Vendors page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Show_Vendors.VendorsRecordControl vendorsRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "VendorsRecordControl") as OEMConversion.UI.Controls.Show_Vendors.VendorsRecordControl);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                    string url = "../RepairOrders/Add-RepairOrders.aspx?ROSubcontractVendNo={VendorsRecordControl:FV:VendNo}&TabVisible=False&SaveAndNewVisible=False";
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Vendors.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RepairOrders";
                // If Show-Vendors.PDFButton.report specifies a valid report template,
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.ROEstimatedBy)){
                                 report.AddData("${ROEstimatedBy}", "",ReportEnum.Align.Left);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 ...
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  RepairOrdersTable.ROEstimatedBy.IsApplyDisplayAs){
                                     report.AddData("${ROEstimatedBy}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${ROEstimatedBy}", record.Format(RepairOrdersTable.ROEstimatedBy), ReportEnum.Align.Left);
                                 }
                             }
                             ...
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.ROReceivedBy)){
                                 report.AddData("${ROReceivedBy}", "",ReportEnum.Align.Left);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 ...
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  RepairOrdersTable.ROReceivedBy.IsApplyDisplayAs){
                                     report.AddData("${ROReceivedBy}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${ROReceivedBy}", record.Format(RepairOrdersTable.ROReceivedBy), ReportEnum.Align.Left);
                                 }
                             }
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Vendors.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RepairOrders";
                // If Show-Vendors.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Vendors.RepairOrdersTableControlRow")));
...
// Base class for the VendorsRecordControl control on the Show_Vendors page.
...
public class BaseVendorsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in VendorsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-Vendors"] = recId;
