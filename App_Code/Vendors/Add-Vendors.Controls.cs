...
// Add_Vendors.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Vendors
{
...
// Base class for the VendorsRecordControl control on the Add_Vendors page.
...
public class BaseVendorsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (VendorsRecord)VendorsRecord.Copy(recList[0], false);
        ...
        public virtual void SetVendNo()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
              ...
              this.VendNo.Text = EvaluateFormula("URL(\"vendno\")", this.DataSource);
        ...
        public virtual void GetVendNo()
        {
            ...
            // Save the value to data source
            this.DataSource.Parse(this.VendNo.Text, VendorsTable.VendNo);							
      ...
      // To customize, override this method in VendorsRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Vendors"];
            ...
            HttpContext.Current.Session["QueryString in Add-Vendors"] = recId;
