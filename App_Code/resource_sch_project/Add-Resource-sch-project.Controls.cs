...
// Add_Resource_sch_project.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Resource_sch_project
{
...
// Base class for the Resource_sch_projectRecordControl control on the Add_Resource_sch_project page.
...
public class BaseResource_sch_projectRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.resource_sch_project_custno.SelectedIndexChanged += resource_sch_project_custno_SelectedIndexChanged;
            
              this.resource_sch_project_status_id.SelectedIndexChanged += resource_sch_project_status_id_SelectedIndexChanged;
            
              this.resource_sch_project_active.CheckedChanged += resource_sch_project_active_CheckedChanged;
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (Resource_sch_projectRecord)Resource_sch_projectRecord.Copy(recList[0], false);
        ...
        public virtual void Setresource_sch_project_active()
        {
            ...
            // Set the resource_sch_project_active CheckBox on the webpage with value from the
            // DatabaseAYS_OEM%dbo.resource_sch_project database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.resource_sch_project record retrieved from the database.
            // this.resource_sch_project_active is the ASP:CheckBox on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.resource_sch_project_activeSpecified) {
                ...
                // The Format method will use the Display Format
                this.resource_sch_project_active.Checked = this.DataSource.resource_sch_project_active;
                ...
                // Default Value could also be NULL.
                if (!this.DataSource.IsCreated) 
                    this.resource_sch_project_active.Checked = Resource_sch_projectTable.resource_sch_project_active.ParseValue(Resource_sch_projectTable.resource_sch_project_active.DefaultValue).ToBoolean();                
        ...
        public virtual void Setresource_sch_project_custno()
        {
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.resource_sch_project record retrieved from the database.
            // this.resource_sch_project_custno is the ASP:DropDownList on the webpage.
            
            // You can modify this method directly, or replace it with a call to
            //     base.Setresource_sch_project_custno();
            // and add your own custom code before or after the call to the base function.
            ...
            this.Populateresource_sch_project_custnoDropDownList(selectedValue, 2500);              
        ...
        public virtual void Getcreated_by()
        {
         // Retrieve the value entered by the user on the created_by ASP:DropDownList, and
            // save it into the created_by field in DataSource DatabaseAYS_OEM%dbo.resource_sch_project record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.created_by), Resource_sch_projectTable.created_by);			
        ...
        public virtual void Getcreated_datetime()
        {
            ...
            // save it into the created_datetime field in DataSource DatabaseAYS_OEM%dbo.resource_sch_project record.
            ...
            this.DataSource.Parse(this.created_datetime.Text, Resource_sch_projectTable.created_datetime);							
        ...
        {	
            ...
            // Retrieve the value entered by the user on the resource_sch_project_active ASP:CheckBox, and
            // save it into the resource_sch_project_active field in DataSource DatabaseAYS_OEM%dbo.resource_sch_project record.
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.resource_sch_project_active = this.resource_sch_project_active.Checked;						
        ...
        public virtual void Getresource_sch_project_custno()
        {
         // Retrieve the value entered by the user on the resource_sch_project_custno ASP:DropDownList, and
            ...
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.resource_sch_project_custno), Resource_sch_projectTable.resource_sch_project_custno);			
      ...
      // To customize, override this method in Resource_sch_projectRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Resource_sch_project"];
            ...
            HttpContext.Current.Session["QueryString in Add-Resource-sch-project"] = recId;
        ...
        public virtual WhereClause CreateWhereClause_resource_sch_project_custnoDropDownList() 
        {
            // By default, we simply return a new WhereClause.
            // Add additional where clauses to restrict the items shown in the dropdown list.
        ...
        // Fill the resource_sch_project_custno list.
        protected virtual void Populateresource_sch_project_custnoDropDownList(string selectedValue, int maxItems) 
        {
            		  					                
            this.resource_sch_project_custno.Items.Clear();
            
            // 1. Setup the static list items        
            
              // Add the Please Select item.
              this.resource_sch_project_custno.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "OEMConversion"), "--PLEASE_SELECT--"));
            		  			
            // 2. Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_resource_sch_project_custnoDropDownList function.
            // It is better to customize the where clause there.
            
                      
            WhereClause wc = CreateWhereClause_resource_sch_project_custnoDropDownList();
            ...
            // 3. Read a total of maxItems from the database and insert them into the resource_sch_project_custnoDropDownList.
                ...
                do
                {
                    ...
                    foreach (CustomersRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.CustNoSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.resource_sch_project_custno.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                ListItem dupItem = this.resource_sch_project_custno.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.resource_sch_project_custno.Items.Add(newItem);
            ...
            if (selectedValue != null &&
                selectedValue.Trim() != "" &&
                !MiscUtils.SetSelectedValue(this.resource_sch_project_custno, selectedValue) &&
                !MiscUtils.SetSelectedDisplayText(this.resource_sch_project_custno, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        if (fvalue == null || fvalue.Trim() == "") fvalue = cvalue;
                        MiscUtils.ResetSelectedItem(this.resource_sch_project_custno, new ListItem(fvalue, cvalue));                      
                    }
                }
                catch
                {
        ...
        protected virtual void resource_sch_project_custno_SelectedIndexChanged(object sender, EventArgs args)
        {
            // for the value inserted by quick add button or large list selector, 
            // the value is necessary to be inserted by this event during postback 
            string val = (string)(this.Page.Session[resource_sch_project_custno.ClientID + "_SelectedValue"]);
            string displayText = (string)(this.Page.Session[resource_sch_project_custno.ClientID + "_SelectedDisplayText"]);
            if (!string.IsNullOrEmpty(displayText) && !string.IsNullOrEmpty(val)) {
	            this.resource_sch_project_custno.Items.Add(new ListItem(displayText, val));
	            this.resource_sch_project_custno.SelectedIndex = this.resource_sch_project_custno.Items.Count - 1;
	            this.Page.Session.Remove(resource_sch_project_custno.ClientID + "_SelectedValue");
	            this.Page.Session.Remove(resource_sch_project_custno.ClientID + "_SelectedDisplayText");
            }
        ...
        protected virtual void resource_sch_project_active_CheckedChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.CheckBox resource_sch_project_active {
            get {
                return (System.Web.UI.WebControls.CheckBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "resource_sch_project_active");
            }
        }
        ...
        public System.Web.UI.WebControls.DropDownList resource_sch_project_custno {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "resource_sch_project_custno");
            }
        }
    ...
    Resource_sch_projectRecord rec = null;
             ...
             
        {
            ...
            return new Resource_sch_projectRecord();
