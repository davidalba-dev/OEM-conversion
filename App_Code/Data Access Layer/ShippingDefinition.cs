...
/// <see cref="ShippingTable">OEMConversion.ShippingTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="ShippingTable"></seealso>
public class ShippingDefinition
{
#region "Definition (XML) for ShippingDefinition table"
	//Next 275 lines contain Table Definition (XML) for table "ShippingDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>ShipCharge</columnName>");
         tbf.Append(      @"<columnUIName>Ship Charge</columnUIName>");
         tbf.Append(      @"<columnType>Boolean</columnType>");
         tbf.Append(      @"<columnDBType>bit</columnDBType>");
         tbf.Append(      @"<columnLengthSet></columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<columnName>ShipTracking</columnName>");
         tbf.Append(      @"<columnUIName>Ship Tracking</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         ...
         tbf.Append(      @"<columnName>shipping_active</columnName>");
         tbf.Append(      @"<columnUIName>Shipping Active</columnUIName>");
         tbf.Append(      @"<columnType>Boolean</columnType>");
         tbf.Append(      @"<columnDBType>bit</columnDBType>");
         tbf.Append(      @"<columnLengthSet></columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>Shipping</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>Shipping_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Shipping</TableCodeName>");
         tbf.Append(  @"<FolderName>Shipping</FolderName>");
         tbf.Append(  @"<MenuName>Shipping</MenuName>");
         tbf.Append(  @"<QSPath>../Shipping/Shipping-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionShipping</TableStoredProcPrefix>");
