...
/// <see cref="WarrantyPlansTable">OEMConversion.WarrantyPlansTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="WarrantyPlansTable"></seealso>
public class WarrantyPlansDefinition
{
#region "Definition (XML) for WarrantyPlansDefinition table"
	//Next 287 lines contain Table Definition (XML) for table "WarrantyPlansDefinition"
	...
	/// <see cref="WarrantyPlansTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>PlanBillingNo</columnName>");
         tbf.Append(      @"<columnUIName>Plan Billing Number</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         ...
         tbf.Append(      @"<columnName>PlanDesc</columnName>");
         tbf.Append(      @"<columnUIName>Plan Description</columnUIName>");
         ...
         tbf.Append(      @"<columnName>PlanName</columnName>");
         tbf.Append(      @"<columnUIName>Plan Name</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>nvarchar</columnDBType>");
         ...
         tbf.Append(      @"<columnName>PlanWarranty</columnName>");
         tbf.Append(      @"<columnUIName>Plan Warranty</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>tinyint</columnDBType>");
         tbf.Append(      @"<columnLengthSet>3.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>WarrantyPlans</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>WarrantyPlans_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>WarrantyPlans</TableCodeName>");
         tbf.Append(  @"<FolderName>WarrantyPlans</FolderName>");
         tbf.Append(  @"<MenuName>Warranty Plans</MenuName>");
         tbf.Append(  @"<QSPath>../WarrantyPlans/WarrantyPlans-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionWarrantyPlans</TableStoredProcPrefix>");
