...
/// <see cref="Repair_order_notesTable">OEMConversion.Repair_order_notesTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Repair_order_notesTable"></seealso>
public class Repair_order_notesDefinition
{
#region "Definition (XML) for Repair_order_notesDefinition table"
	//Next 230 lines contain Table Definition (XML) for table "Repair_order_notesDefinition"
	...
	/// <see cref="Repair_order_notesTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>repair_order_note_id</columnName>");
         tbf.Append(      @"<columnUIName>Repair Order Note</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_repair_order_notes_Technicians</columnFKName>");
         ...
         tbf.Append(      @"<columnName>note_date_time</columnName>");
         tbf.Append(      @"<columnUIName>Note Date Time</columnUIName>");
         ...
         tbf.Append(      @"<columnName>repair_order_note</columnName>");
         tbf.Append(      @"<columnUIName>Repair Order Note</columnUIName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_repair_order_notes_RepairOrders</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>repair_order_notes</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>repair_order_notes_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Repair_order_notes</TableCodeName>");
         tbf.Append(  @"<FolderName>repair_order_notes</FolderName>");
         tbf.Append(  @"<MenuName>Repair Order Notes</MenuName>");
         tbf.Append(  @"<QSPath>../repair_order_notes/Repair-order-notes-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionRepair_order_notes</TableStoredProcPrefix>");
