...
/// <see cref="Contractor_skillsTable">OEMConversion.Contractor_skillsTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Contractor_skillsTable"></seealso>
public class Contractor_skillsDefinition
{
#region "Definition (XML) for Contractor_skillsDefinition table"
	//Next 99 lines contain Table Definition (XML) for table "Contractor_skillsDefinition"
	...
	/// <see cref="Contractor_skillsTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>contractor_skills</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>contractor_skills_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>contractor_skills</FolderName>");
         tbf.Append(  @"<MenuName>Contractor Skills</MenuName>");
         tbf.Append(  @"<QSPath>../contractor_skills/Contractor-skills-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Contractor_skills</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionContractor_skills</TableStoredProcPrefix>");
