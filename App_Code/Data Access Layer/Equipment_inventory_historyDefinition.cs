...
/// <see cref="Equipment_inventory_historyTable">OEMConversion.Equipment_inventory_historyTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Equipment_inventory_historyTable"></seealso>
public class Equipment_inventory_historyDefinition
{
#region "Definition (XML) for Equipment_inventory_historyDefinition table"
	//Next 393 lines contain Table Definition (XML) for table "Equipment_inventory_historyDefinition"
	...
	/// <see cref="Equipment_inventory_historyTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>equipment_inventory_history_id</columnName>");
         tbf.Append(      @"<columnUIName>Equipment Inventory History</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_equipment_inventory_history_warehouse</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_equipment_inventory_history_warehouse_location</columnFKName>");
         ...
         tbf.Append(      @"<columnName>datetime_moved</columnName>");
         tbf.Append(      @"<columnUIName>Date And Time Moved</columnUIName>");
         tbf.Append(      @"<columnType>Date</columnType>");
         tbf.Append(      @"<columnDBType>datetime</columnDBType>");
         tbf.Append(      @"<columnLengthSet></columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<columnName>customercontact_id</columnName>");
         tbf.Append(      @"<columnUIName>Customercontact</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_equipment_inventory_history_CustomerContacts</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_equipment_inventory_history_equipment_inventory</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_equipment_inventory_history_Technicians</columnFKName>");
         ...
         tbf.Append(      @"<columnName>exchange_inventory_id</columnName>");
         tbf.Append(      @"<columnUIName>Exchange Inventory</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>equipment_inventory_history</TableName>");
         tbf.Append(  @"<Version>3</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>equipment_inventory_history_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Equipment_inventory_history</TableCodeName>");
         tbf.Append(  @"<FolderName>equipment_inventory_history</FolderName>");
         tbf.Append(  @"<MenuName>Equipment Inventory History</MenuName>");
         tbf.Append(  @"<QSPath>../equipment_inventory_history/Equipment-inventory-history-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionEquipment_inventory_history</TableStoredProcPrefix>");
