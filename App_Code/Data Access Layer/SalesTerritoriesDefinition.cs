...
/// <see cref="SalesTerritoriesTable">OEMConversion.SalesTerritoriesTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="SalesTerritoriesTable"></seealso>
public class SalesTerritoriesDefinition
{
#region "Definition (XML) for SalesTerritoriesDefinition table"
	//Next 130 lines contain Table Definition (XML) for table "SalesTerritoriesDefinition"
	...
	/// <see cref="SalesTerritoriesTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>sales_territories_id</columnName>");
         tbf.Append(      @"<columnUIName>Sales Territories</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_SalesTerritories_territory</columnFKName>");
         ...
         tbf.Append(        @"<columnFKColumnDisplay>territory_name</columnFKColumnDisplay>");
         ...
         tbf.Append(      @"<columnUIName Source=""User"">= &quot;Sales Rep.&quot;</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_SalesTerritories_Technicians</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>SalesTerritories</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>SalesTerritories_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>SalesTerritories</FolderName>");
         tbf.Append(  @"<MenuName>Sales Territories</MenuName>");
         tbf.Append(  @"<QSPath>../SalesTerritories/SalesTerritories-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>SalesTerritories</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionSalesTerritories</TableStoredProcPrefix>");
