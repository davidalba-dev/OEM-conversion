...
/// <see cref="Project_statusTable">OEMConversion.Project_statusTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Project_statusTable"></seealso>
public class Project_statusDefinition
{
#region "Definition (XML) for Project_statusDefinition table"
	//Next 127 lines contain Table Definition (XML) for table "Project_statusDefinition"
	...
	/// <see cref="Project_statusTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>project_status</columnName>");
         ...
         tbf.Append(      @"<columnName>project_status_active</columnName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>project_status</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>project_status_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>project_status</FolderName>");
         tbf.Append(  @"<MenuName>Project Status</MenuName>");
         tbf.Append(  @"<QSPath>../project_status/Project-status-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Project_status</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionProject_status</TableStoredProcPrefix>");
