...
/// <see cref="Pickup_request_commentTable">OEMConversion.Pickup_request_commentTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Pickup_request_commentTable"></seealso>
public class Pickup_request_commentDefinition
{
#region "Definition (XML) for Pickup_request_commentDefinition table"
	//Next 268 lines contain Table Definition (XML) for table "Pickup_request_commentDefinition"
	...
	/// <see cref="Pickup_request_commentTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>pickup_request_comment_id</columnName>");
         tbf.Append(      @"<columnUIName>Pickup Request Comment</columnUIName>");
         ...
         tbf.Append(      @"<columnName>pickup_request_comment</columnName>");
         tbf.Append(      @"<columnUIName>Pickup Request Comment</columnUIName>");
         ...
         tbf.Append(      @"<columnName>pickup_request_private</columnName>");
         tbf.Append(      @"<columnUIName Source=""User"">= &quot;Private Comment&quot;</columnUIName>");
         ...
         tbf.Append(      @"<columnName>pickup_request_comment_datetime</columnName>");
         tbf.Append(      @"<columnUIName>Pickup Request Comment Date A~Time</columnUIName>");
         ...
         tbf.Append(      @"<columnName>pickup_request_comment_createdby</columnName>");
         tbf.Append(      @"<columnUIName>Pickup Request Comment Createdby</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(        @"<columnFKName>FK_pickup_request_comment_Technicians</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_pickup_request_comment_pickup_request</columnFKName>");
         tbf.Append(        @"<columnFKTable>OEMConversion.Business.Pickup_requestTable, App_Code</columnFKTable>");
         tbf.Append(        @"<columnFKOwner>dbo</columnFKOwner>");
         tbf.Append(        @"<columnFKColumn>pickup_request_id</columnFKColumn>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>pickup_request_comment</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>pickup_request_comment_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Pickup_request_comment</TableCodeName>");
         tbf.Append(  @"<FolderName>pickup_request_comment</FolderName>");
         tbf.Append(  @"<MenuName>Pickup Request Comment</MenuName>");
         tbf.Append(  @"<QSPath>../pickup_request_comment/Pickup-request-comment-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionPickup_request_comment</TableStoredProcPrefix>");
