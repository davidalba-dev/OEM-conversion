...
/// <see cref="Vw_site_inventory_customerView">OEMConversion.Vw_site_inventory_customerView</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Vw_site_inventory_customerView"></seealso>
public class Vw_site_inventory_customerDefinition
{
#region "Definition (XML) for Vw_site_inventory_customerDefinition table"
	//Next 139 lines contain Table Definition (XML) for table "Vw_site_inventory_customerDefinition"
	...
	/// <see cref="Vw_site_inventory_customerView"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnUIName Source=""User"">Site Inventory Contract</columnUIName>");
         ...
         tbf.Append(      @"<columnName>site_inventory_custno</columnName>");
         tbf.Append(      @"<columnUIName>Site Inventory Custno</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>vw_site_inventory_customer</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>vw_site_inventory_customer_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>vw_site_inventory_customer</FolderName>");
         tbf.Append(  @"<MenuName>Site Inventory Customer</MenuName>");
         tbf.Append(  @"<QSPath>../vw_site_inventory_customer/Vw-site-inventory-customer-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Vw_site_inventory_customer</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionVw_site_inventory_customer</TableStoredProcPrefix>");
