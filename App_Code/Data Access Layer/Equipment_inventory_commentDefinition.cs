...
/// <see cref="Equipment_inventory_commentTable">OEMConversion.Equipment_inventory_commentTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Equipment_inventory_commentTable"></seealso>
public class Equipment_inventory_commentDefinition
{
#region "Definition (XML) for Equipment_inventory_commentDefinition table"
	//Next 232 lines contain Table Definition (XML) for table "Equipment_inventory_commentDefinition"
	...
	/// <see cref="Equipment_inventory_commentTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>equipment_inventory_comment_id</columnName>");
         tbf.Append(      @"<columnUIName>Equipment Inventory Comment</columnUIName>");
         ...
         tbf.Append(      @"<columnName>equipment_inventory_id</columnName>");
         tbf.Append(      @"<columnUIName>Equipment Inventory</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>numeric</columnDBType>");
         tbf.Append(      @"<columnLengthSet>18.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(        @"<columnFKName>FK_equipment_inventory_comment_equipment_inventory</columnFKName>");
         ...
         tbf.Append(      @"<columnName>equipment_inventory_comment</columnName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_equipment_inventory_comment_Technicians</columnFKName>");
         ...
         tbf.Append(      @"<columnName>comment_datetime</columnName>");
         tbf.Append(      @"<columnUIName>Comment Date And Time</columnUIName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>equipment_inventory_comment</TableName>");
         tbf.Append(  @"<Version>2</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>equipment_inventory_comment_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Equipment_inventory_comment</TableCodeName>");
         tbf.Append(  @"<FolderName>equipment_inventory_comment</FolderName>");
         tbf.Append(  @"<MenuName>Equipment Inventory Comment</MenuName>");
         tbf.Append(  @"<QSPath>../equipment_inventory_comment/Equipment-inventory-comment-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionEquipment_inventory_comment</TableStoredProcPrefix>");
