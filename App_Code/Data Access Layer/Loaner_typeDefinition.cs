...
/// <see cref="Loaner_typeTable">OEMConversion.Loaner_typeTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Loaner_typeTable"></seealso>
public class Loaner_typeDefinition
{
#region "Definition (XML) for Loaner_typeDefinition table"
	//Next 113 lines contain Table Definition (XML) for table "Loaner_typeDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>loaner_type</columnName>");
         tbf.Append(      @"<columnUIName>Loaner Type</columnUIName>");
         ...
         tbf.Append(      @"<columnName>loaner_type_active</columnName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>loaner_type</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>loaner_type_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>loaner_type</FolderName>");
         tbf.Append(  @"<MenuName>Loaner Type</MenuName>");
         tbf.Append(  @"<QSPath>../loaner_type/Loaner-type-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Loaner_type</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionLoaner_type</TableStoredProcPrefix>");
