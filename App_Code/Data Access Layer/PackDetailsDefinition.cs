...
/// <see cref="PackDetailsTable">OEMConversion.PackDetailsTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="PackDetailsTable"></seealso>
public class PackDetailsDefinition
{
#region "Definition (XML) for PackDetailsDefinition table"
	//Next 256 lines contain Table Definition (XML) for table "PackDetailsDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>PackItemDesc</columnName>");
         tbf.Append(      @"<columnUIName>Pack Item Description</columnUIName>");
         ...
         tbf.Append(      @"<columnName>PackLineType</columnName>");
         tbf.Append(      @"<columnUIName>Pack Line Type</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         ...
         tbf.Append(      @"<columnName>PackPartNo</columnName>");
         tbf.Append(      @"<columnUIName>Pack Part Number</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>nvarchar</columnDBType>");
         ...
         tbf.Append(      @"<columnName>PackQuantity</columnName>");
         tbf.Append(      @"<columnUIName>Pack Quantity</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         ...
         tbf.Append(      @"<columnName>PackSellPrice</columnName>");
         tbf.Append(      @"<columnUIName>Pack Sell Price</columnUIName>");
         ...
         tbf.Append(      @"<columnName>PackSort</columnName>");
         tbf.Append(      @"<columnUIName>Pack Sort</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>PackDetails</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>PackDetails_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>PackDetails</FolderName>");
         tbf.Append(  @"<MenuName>Pack Details</MenuName>");
         tbf.Append(  @"<QSPath>../PackDetails/PackDetails-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>PackDetails</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionPackDetails</TableStoredProcPrefix>");
