...
/// <see cref="Procurement_manufacturerTable">OEMConversion.Procurement_manufacturerTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Procurement_manufacturerTable"></seealso>
public class Procurement_manufacturerDefinition
{
#region "Definition (XML) for Procurement_manufacturerDefinition table"
	//Next 127 lines contain Table Definition (XML) for table "Procurement_manufacturerDefinition"
	...
	/// <see cref="Procurement_manufacturerTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>procurement_manufacturer_id</columnName>");
         tbf.Append(      @"<columnUIName>Procurement Manufacturer</columnUIName>");
         ...
         tbf.Append(      @"<columnName>manufacturer_name</columnName>");
         tbf.Append(      @"<columnUIName Source=""User"">= &quot;Manufacturer&quot;</columnUIName>");
         ...
         tbf.Append(      @"<columnName>manufacturer_active</columnName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>procurement_manufacturer</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>procurement_manufacturer_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>procurement_manufacturer</FolderName>");
         tbf.Append(  @"<MenuName>Procurement Manufacturer</MenuName>");
         tbf.Append(  @"<QSPath>../procurement_manufacturer/Procurement-manufacturer-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Procurement_manufacturer</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionProcurement_manufacturer</TableStoredProcPrefix>");
