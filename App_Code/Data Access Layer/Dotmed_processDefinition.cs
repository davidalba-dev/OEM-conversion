...
/// <see cref="Dotmed_processTable">OEMConversion.Dotmed_processTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Dotmed_processTable"></seealso>
public class Dotmed_processDefinition
{
#region "Definition (XML) for Dotmed_processDefinition table"
	//Next 111 lines contain Table Definition (XML) for table "Dotmed_processDefinition"
	...
	/// <see cref="Dotmed_processTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>dotmed_process_id</columnName>");
         tbf.Append(      @"<columnUIName>Dotmed Process</columnUIName>");
         ...
         tbf.Append(      @"<columnName>item_id</columnName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>dotmed_process</TableName>");
         tbf.Append(  @"<Version>3</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>dotmed_process_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Dotmed_process</TableCodeName>");
         tbf.Append(  @"<FolderName>dotmed_process</FolderName>");
         tbf.Append(  @"<MenuName>Dotmed Process</MenuName>");
         tbf.Append(  @"<QSPath>../dotmed_process/Dotmed-process-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionDotmed_process</TableStoredProcPrefix>");
