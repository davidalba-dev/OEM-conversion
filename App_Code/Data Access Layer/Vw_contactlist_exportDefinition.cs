...
/// <see cref="Vw_contactlist_exportView">OEMConversion.Vw_contactlist_exportView</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Vw_contactlist_exportView"></seealso>
public class Vw_contactlist_exportDefinition
{
#region "Definition (XML) for Vw_contactlist_exportDefinition table"
	//Next 924 lines contain Table Definition (XML) for table "Vw_contactlist_exportDefinition"
	...
	/// <see cref="Vw_contactlist_exportView"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>vw_contactlist_export</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>vw_contactlist_export_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>vw_contactlist_export</FolderName>");
         tbf.Append(  @"<MenuName>Contactlist Export</MenuName>");
         tbf.Append(  @"<QSPath>../vw_contactlist_export/Vw-contactlist-export-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Vw_contactlist_export</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionVw_contactlist_export</TableStoredProcPrefix>");
