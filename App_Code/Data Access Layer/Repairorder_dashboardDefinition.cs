...
/// <see cref="Repairorder_dashboardView">OEMConversion.Repairorder_dashboardView</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Repairorder_dashboardView"></seealso>
public class Repairorder_dashboardDefinition
{
#region "Definition (XML) for Repairorder_dashboardDefinition table"
	//Next 138 lines contain Table Definition (XML) for table "Repairorder_dashboardDefinition"
	...
	/// <see cref="Repairorder_dashboardView"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnUIName Source=""User"">STA Number</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>repairorder_dashboard</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>repairorder_dashboard_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Repairorder_dashboard</TableCodeName>");
         tbf.Append(  @"<FolderName>repairorder_dashboard</FolderName>");
         tbf.Append(  @"<MenuName>Repairorder Dashboard</MenuName>");
         tbf.Append(  @"<QSPath>../repairorder_dashboard/Repairorder-dashboard-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionRepairorder_dashboard</TableStoredProcPrefix>");
