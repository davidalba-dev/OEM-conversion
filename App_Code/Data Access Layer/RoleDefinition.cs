...
/// <see cref="RoleTable">OEMConversion.RoleTable</see> class
...
#region "Definition (XML) for RoleDefinition table"
	//Next 73 lines contain Table Definition (XML) for table "RoleDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionRole</TableStoredProcPrefix>");
