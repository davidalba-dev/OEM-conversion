...
/// <see cref="Request_typeTable">OEMConversion.Request_typeTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Request_typeTable"></seealso>
public class Request_typeDefinition
{
#region "Definition (XML) for Request_typeDefinition table"
	//Next 99 lines contain Table Definition (XML) for table "Request_typeDefinition"
	...
	/// <see cref="Request_typeTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>request_type</columnName>");
         tbf.Append(      @"<columnUIName>Request Type</columnUIName>");
         ...
         tbf.Append(      @"<columnName>request_active</columnName>");
         tbf.Append(      @"<columnUIName>Request Active</columnUIName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>request_type</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>request_type_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>request_type</FolderName>");
         tbf.Append(  @"<MenuName>Request Type</MenuName>");
         tbf.Append(  @"<QSPath>../request_type/Request-type-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Request_type</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionRequest_type</TableStoredProcPrefix>");
