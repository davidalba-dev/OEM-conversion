...
/// <see cref="WarehouseTable">OEMConversion.WarehouseTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="WarehouseTable"></seealso>
public class WarehouseDefinition
{
#region "Definition (XML) for WarehouseDefinition table"
	//Next 170 lines contain Table Definition (XML) for table "WarehouseDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>warehouse_name</columnName>");
         tbf.Append(      @"<columnUIName>Warehouse Name</columnUIName>");
         ...
         tbf.Append(      @"<columnName>warehouse_active</columnName>");
         tbf.Append(      @"<columnUIName>Warehouse Active</columnUIName>");
         ...
         tbf.Append(      @"<columnName>warehouse_customer_id</columnName>");
         tbf.Append(      @"<columnUIName>Warehouse Customer</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         ...
         tbf.Append(        @"<columnFKName>FK_warehouse_Customers</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>warehouse</TableName>");
         tbf.Append(  @"<Version>2</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>warehouse_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Warehouse</TableCodeName>");
         tbf.Append(  @"<FolderName>warehouse</FolderName>");
         tbf.Append(  @"<MenuName>Warehouse</MenuName>");
         tbf.Append(  @"<QSPath>../warehouse/Warehouse-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionWarehouse</TableStoredProcPrefix>");
