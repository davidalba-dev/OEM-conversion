...
/// <see cref="Payment_methodTable">OEMConversion.Payment_methodTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Payment_methodTable"></seealso>
public class Payment_methodDefinition
{
#region "Definition (XML) for Payment_methodDefinition table"
	//Next 99 lines contain Table Definition (XML) for table "Payment_methodDefinition"
	...
	/// <see cref="Payment_methodTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>payment_method_id</columnName>");
         ...
         tbf.Append(      @"<columnName>payment_method</columnName>");
         tbf.Append(      @"<columnUIName>Payment Method</columnUIName>");
         ...
         tbf.Append(      @"<columnName>payment_active</columnName>");
         tbf.Append(      @"<columnUIName>Payment Active</columnUIName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>payment_method</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>payment_method_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>payment_method</FolderName>");
         tbf.Append(  @"<MenuName>Payment Method</MenuName>");
         tbf.Append(  @"<QSPath>../payment_method/Payment-method-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Payment_method</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionPayment_method</TableStoredProcPrefix>");
