...
/// <see cref="Max_customerView">OEMConversion.Max_customerView</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Max_customerView"></seealso>
public class Max_customerDefinition
{
#region "Definition (XML) for Max_customerDefinition table"
	//Next 61 lines contain Table Definition (XML) for table "Max_customerDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>Expr</columnName>");
         tbf.Append(      @"<columnUIName>Expiration</columnUIName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>max_customer</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>max_customer_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>max_customer</FolderName>");
         tbf.Append(  @"<MenuName>Maximum Customer</MenuName>");
         tbf.Append(  @"<QSPath>../max_customer/Max-customer-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Max_customer</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionMax_customer</TableStoredProcPrefix>");
