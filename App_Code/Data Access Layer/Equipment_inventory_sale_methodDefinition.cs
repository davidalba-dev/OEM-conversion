...
/// <see cref="Equipment_inventory_sale_methodTable">OEMConversion.Equipment_inventory_sale_methodTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Equipment_inventory_sale_methodTable"></seealso>
public class Equipment_inventory_sale_methodDefinition
{
#region "Definition (XML) for Equipment_inventory_sale_methodDefinition table"
	//Next 125 lines contain Table Definition (XML) for table "Equipment_inventory_sale_methodDefinition"
	...
	/// <see cref="Equipment_inventory_sale_methodTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>equipment_inventory_sale_method_id</columnName>");
         tbf.Append(      @"<columnUIName>Equipment Inventory Sale Method</columnUIName>");
         ...
         tbf.Append(      @"<columnName>eqiupment_inventory_sale_method</columnName>");
         tbf.Append(      @"<columnUIName>Eqiupment Inventory Sale Method</columnUIName>");
         ...
         tbf.Append(      @"<columnName>equipment_inventory_sale_method_active</columnName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>equipment_inventory_sale_method</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>equipment_inventory_sale_method_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Equipment_inventory_sale_method</TableCodeName>");
         tbf.Append(  @"<FolderName>equipment_inventory_sale_method</FolderName>");
         tbf.Append(  @"<MenuName>Equipment Inventory Sale Method</MenuName>");
         tbf.Append(  @"<QSPath>../equipment_inventory_sale_method/Equipment-inventory-sale-method-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionEquipment_inventory_sale_method</TableStoredProcPrefix>");
