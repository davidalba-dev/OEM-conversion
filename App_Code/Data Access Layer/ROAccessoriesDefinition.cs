...
/// <see cref="ROAccessoriesTable">OEMConversion.ROAccessoriesTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="ROAccessoriesTable"></seealso>
public class ROAccessoriesDefinition
{
#region "Definition (XML) for ROAccessoriesDefinition table"
	//Next 203 lines contain Table Definition (XML) for table "ROAccessoriesDefinition"
	...
	/// <see cref="ROAccessoriesTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>AccItemDesc</columnName>");
         tbf.Append(      @"<columnUIName>ACC Item Description</columnUIName>");
         ...
         tbf.Append(      @"<columnName>AccMake</columnName>");
         tbf.Append(      @"<columnUIName>ACC Make</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>nvarchar</columnDBType>");
         tbf.Append(      @"<columnLengthSet>30</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<columnName>AccModel</columnName>");
         tbf.Append(      @"<columnUIName>ACC Model</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>nvarchar</columnDBType>");
         ...
         tbf.Append(      @"<columnName>AccSerialNo</columnName>");
         tbf.Append(      @"<columnUIName>ACC Serial Number</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>nvarchar</columnDBType>");
         tbf.Append(      @"<columnLengthSet>40</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>ROAccessories</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>ROAccessories_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>ROAccessories</FolderName>");
         tbf.Append(  @"<MenuName>RO Accessories</MenuName>");
         tbf.Append(  @"<QSPath>../ROAccessories/ROAccessories-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>ROAccessories</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionROAccessories</TableStoredProcPrefix>");
