...
/// <see cref="ROReference4View">OEMConversion.ROReference4View</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="ROReference4View"></seealso>
public class ROReference4Definition
{
#region "Definition (XML) for ROReference4Definition table"
	//Next 176 lines contain Table Definition (XML) for table "ROReference4Definition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>ROReference4</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>ROReference4_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>ROReference4</FolderName>");
         tbf.Append(  @"<MenuName>RO Reference 4</MenuName>");
         tbf.Append(  @"<QSPath>../ROReference4/ROReference4-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>ROReference4</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionROReference4</TableStoredProcPrefix>");
