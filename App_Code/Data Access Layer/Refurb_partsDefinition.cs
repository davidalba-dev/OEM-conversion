...
/// <see cref="Refurb_partsTable">OEMConversion.Refurb_partsTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Refurb_partsTable"></seealso>
public class Refurb_partsDefinition
{
#region "Definition (XML) for Refurb_partsDefinition table"
	//Next 373 lines contain Table Definition (XML) for table "Refurb_partsDefinition"
	...
	/// <see cref="Refurb_partsTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>refurb_part_description</columnName>");
         ...
         tbf.Append(      @"<columnName>refurb_vendor_id</columnName>");
         ...
         tbf.Append(      @"<columnUIName Source=""User"">= &quot;Cost&quot;</columnUIName>");
         ...
         tbf.Append(      @"<columnUIName Source=""User"">= &quot;Retail&quot;</columnUIName>");
         tbf.Append(      @"<columnType>Currency</columnType>");
         tbf.Append(      @"<columnDBType>money</columnDBType>");
         tbf.Append(      @"<columnLengthSet>19.4</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<columnName>refurb_part_active</columnName>");
         ...
         tbf.Append(        @"<columnFKName>FK_refurb_parts_Vendors</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>refurb_parts</TableName>");
         tbf.Append(  @"<Version>3</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>refurb_parts_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Refurb_parts</TableCodeName>");
         tbf.Append(  @"<FolderName>refurb_parts</FolderName>");
         tbf.Append(  @"<MenuName>Refurb Parts</MenuName>");
         tbf.Append(  @"<QSPath>../refurb_parts/Refurb-parts-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionRefurb_parts</TableStoredProcPrefix>");
