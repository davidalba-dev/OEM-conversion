...
/// <see cref="Contractor_contact_rateTable">OEMConversion.Contractor_contact_rateTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Contractor_contact_rateTable"></seealso>
public class Contractor_contact_rateDefinition
{
#region "Definition (XML) for Contractor_contact_rateDefinition table"
	//Next 163 lines contain Table Definition (XML) for table "Contractor_contact_rateDefinition"
	...
	/// <see cref="Contractor_contact_rateTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>contractor_contact_rate_id</columnName>");
         tbf.Append(      @"<columnUIName>Contractor Contact Rate</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_contractor_contact_rate_contractor_contact</columnFKName>");
         ...
         tbf.Append(      @"<columnName>rate</columnName>");
         tbf.Append(      @"<columnUIName>Rate</columnUIName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>contractor_contact_rate</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>contractor_contact_rate_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>contractor_contact_rate</FolderName>");
         tbf.Append(  @"<MenuName>Contractor Contact Rate</MenuName>");
         tbf.Append(  @"<QSPath>../contractor_contact_rate/Contractor-contact-rate-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Contractor_contact_rate</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionContractor_contact_rate</TableStoredProcPrefix>");
