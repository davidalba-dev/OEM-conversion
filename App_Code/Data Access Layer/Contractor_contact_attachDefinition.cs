...
/// <see cref="Contractor_contact_attachTable">OEMConversion.Contractor_contact_attachTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Contractor_contact_attachTable"></seealso>
public class Contractor_contact_attachDefinition
{
#region "Definition (XML) for Contractor_contact_attachDefinition table"
	//Next 134 lines contain Table Definition (XML) for table "Contractor_contact_attachDefinition"
	...
	/// <see cref="Contractor_contact_attachTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>contractor_contact_attach_id</columnName>");
         tbf.Append(      @"<columnUIName>Contractor Contact Attach</columnUIName>");
         ...
         tbf.Append(      @"<columnName>attachment_name</columnName>");
         tbf.Append(      @"<columnUIName>Attachment Name</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_contractor_contact_attach_contractor_contact</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>contractor_contact_attach</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>contractor_contact_attach_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>contractor_contact_attach</FolderName>");
         tbf.Append(  @"<MenuName>Contractor Contact Attach</MenuName>");
         tbf.Append(  @"<QSPath>../contractor_contact_attach/Contractor-contact-attach-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Contractor_contact_attach</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionContractor_contact_attach</TableStoredProcPrefix>");
