...
/// <see cref="StageTable">OEMConversion.StageTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="StageTable"></seealso>
public class StageDefinition
{
#region "Definition (XML) for StageDefinition table"
	//Next 99 lines contain Table Definition (XML) for table "StageDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>stage_name</columnName>");
         tbf.Append(      @"<columnUIName>Stage Name</columnUIName>");
         ...
         tbf.Append(      @"<columnName>stage_active</columnName>");
         tbf.Append(      @"<columnUIName>Stage Active</columnUIName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>stage</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>stage_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>stage</FolderName>");
         tbf.Append(  @"<MenuName>Stage</MenuName>");
         tbf.Append(  @"<QSPath>../stage/Stage-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Stage</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionStage</TableStoredProcPrefix>");
