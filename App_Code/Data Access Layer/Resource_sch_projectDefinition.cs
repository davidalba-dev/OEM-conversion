...
/// <see cref="Resource_sch_projectTable">OEMConversion.Resource_sch_projectTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Resource_sch_projectTable"></seealso>
public class Resource_sch_projectDefinition
{
#region "Definition (XML) for Resource_sch_projectDefinition table"
	//Next 289 lines contain Table Definition (XML) for table "Resource_sch_projectDefinition"
	...
	/// <see cref="Resource_sch_projectTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>resource_sch_project_name</columnName>");
         tbf.Append(      @"<columnUIName Source=""User"">= &quot;Project Name&quot;</columnUIName>");
         ...
         tbf.Append(      @"<columnName>resource_sch_project_custno</columnName>");
         ...
         tbf.Append(        @"<columnFKName>FK_resource_sch_project_Customers</columnFKName>");
         ...
         tbf.Append(      @"<columnName>resource_sch_project_active</columnName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_resource_sch_project_resource_sch_project_status</columnFKName>");
         tbf.Append(        @"<columnFKTable>OEMConversion.Business.Resource_sch_project_statusTable, App_Code</columnFKTable>");
         tbf.Append(        @"<columnFKOwner>dbo</columnFKOwner>");
         tbf.Append(        @"<columnFKColumn>resource_sch_project_status_id</columnFKColumn>");
         tbf.Append(        @"<columnFKColumnDisplay>=Resource_sch_project_status.resource_sch_project_status</columnFKColumnDisplay>");
         tbf.Append(        @"<foreignKeyType>Explicit</foreignKeyType>");
         tbf.Append(      "</foreignKey>");
         tbf.Append(      @"<applyDFKA>Y</applyDFKA>");
         tbf.Append(      @"<applyInitializeInsertingRecord>N</applyInitializeInsertingRecord>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_resource_sch_project_Technicians</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>resource_sch_project</TableName>");
         tbf.Append(  @"<Version>2</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>resource_sch_project_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Resource_sch_project</TableCodeName>");
         tbf.Append(  @"<FolderName>resource_sch_project</FolderName>");
         tbf.Append(  @"<MenuName>Resource SCH Project</MenuName>");
         tbf.Append(  @"<QSPath>../resource_sch_project/Resource-sch-project-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionResource_sch_project</TableStoredProcPrefix>");
