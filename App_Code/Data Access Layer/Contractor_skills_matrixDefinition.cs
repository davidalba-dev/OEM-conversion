...
/// <see cref="Contractor_skills_matrixTable">OEMConversion.Contractor_skills_matrixTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Contractor_skills_matrixTable"></seealso>
public class Contractor_skills_matrixDefinition
{
#region "Definition (XML) for Contractor_skills_matrixDefinition table"
	//Next 117 lines contain Table Definition (XML) for table "Contractor_skills_matrixDefinition"
	...
	/// <see cref="Contractor_skills_matrixTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnUIName>Contractor Skill Matrix</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_contractor_skills_matrix_contractor_skills</columnFKName>");
         ...
         tbf.Append(        @"<columnFKColumnDisplay>skill_name</columnFKColumnDisplay>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_contractor_skills_matrix_contractor</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>contractor_skills_matrix</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>contractor_skills_matrix_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>contractor_skills_matrix</FolderName>");
         tbf.Append(  @"<MenuName>Contractor Skills Matrix</MenuName>");
         tbf.Append(  @"<QSPath>../contractor_skills_matrix/Contractor-skills-matrix-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Contractor_skills_matrix</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionContractor_skills_matrix</TableStoredProcPrefix>");
