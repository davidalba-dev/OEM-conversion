...
/// <see cref="Equipment_inventory_dispositionTable">OEMConversion.Equipment_inventory_dispositionTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Equipment_inventory_dispositionTable"></seealso>
public class Equipment_inventory_dispositionDefinition
{
#region "Definition (XML) for Equipment_inventory_dispositionDefinition table"
	//Next 113 lines contain Table Definition (XML) for table "Equipment_inventory_dispositionDefinition"
	...
	/// <see cref="Equipment_inventory_dispositionTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>equipment_inventory_disposition</columnName>");
         tbf.Append(      @"<columnUIName>Equipment Inventory Disposition</columnUIName>");
         ...
         tbf.Append(      @"<columnName>equipment_inventory_disposition_active</columnName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>equipment_inventory_disposition</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>equipment_inventory_disposition_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>equipment_inventory_disposition</FolderName>");
         tbf.Append(  @"<MenuName>Equipment Inventory Disposition</MenuName>");
         tbf.Append(  @"<QSPath>../equipment_inventory_disposition/Equipment-inventory-disposition-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Equipment_inventory_disposition</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionEquipment_inventory_disposition</TableStoredProcPrefix>");
