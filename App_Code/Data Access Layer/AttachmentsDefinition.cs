...
/// <see cref="AttachmentsTable">OEMConversion.AttachmentsTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="AttachmentsTable"></seealso>
public class AttachmentsDefinition
{
#region "Definition (XML) for AttachmentsDefinition table"
	//Next 238 lines contain Table Definition (XML) for table "AttachmentsDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>AttData</columnName>");
         tbf.Append(      @"<columnUIName>Att Data</columnUIName>");
         ...
         tbf.Append(      @"<columnName>AttFilename</columnName>");
         tbf.Append(      @"<columnUIName>Att Filename</columnUIName>");
         ...
         tbf.Append(      @"<columnName>AttKey</columnName>");
         tbf.Append(      @"<columnUIName>Att Key</columnUIName>");
         ...
         tbf.Append(      @"<columnName>AttPrint</columnName>");
         tbf.Append(      @"<columnUIName>Att Print</columnUIName>");
         ...
         tbf.Append(      @"<columnName>AttRecKey</columnName>");
         tbf.Append(      @"<columnUIName>Att Received Key</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(        @"<columnFKName>FK_Attachments_RepairOrders</columnFKName>");
         ...
         tbf.Append(      @"<columnName>AttTable</columnName>");
         tbf.Append(      @"<columnUIName>Att</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>nvarchar</columnDBType>");
         ...
         tbf.Append(      @"<columnName>AttType</columnName>");
         tbf.Append(      @"<columnUIName>Att Type</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>Attachments</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>Attachments_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>Attachments</FolderName>");
         tbf.Append(  @"<MenuName>Attachments</MenuName>");
         tbf.Append(  @"<QSPath>../Attachments/Attachments-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Attachments</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionAttachments</TableStoredProcPrefix>");
