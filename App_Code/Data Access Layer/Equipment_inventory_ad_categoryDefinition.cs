...
/// <see cref="Equipment_inventory_ad_categoryTable">OEMConversion.Equipment_inventory_ad_categoryTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Equipment_inventory_ad_categoryTable"></seealso>
public class Equipment_inventory_ad_categoryDefinition
{
#region "Definition (XML) for Equipment_inventory_ad_categoryDefinition table"
	//Next 99 lines contain Table Definition (XML) for table "Equipment_inventory_ad_categoryDefinition"
	...
	/// <see cref="Equipment_inventory_ad_categoryTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>equipment_inventory_ad_category_id</columnName>");
         tbf.Append(      @"<columnUIName>Equipment Inventory Advertise~egory</columnUIName>");
         ...
         tbf.Append(      @"<columnName>equipment_inventory_ad_category_name</columnName>");
         tbf.Append(      @"<columnUIName>Equipment Inventory Advertise~Name</columnUIName>");
         ...
         tbf.Append(      @"<columnName>equipment_inventory_ad_category_active</columnName>");
         tbf.Append(      @"<columnUIName>Equipment Inventory Advertise~ctive</columnUIName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>equipment_inventory_ad_category</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>equipment_inventory_ad_category_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>equipment_inventory_ad_category</FolderName>");
         tbf.Append(  @"<MenuName>Equipment Inventory Advertise~egory</MenuName>");
         tbf.Append(  @"<QSPath>../equipment_inventory_ad_category/Equipment-inventory-ad-category-QuickSelector1.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Equipment_inventory_ad_category</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionEquipment_inventory_ad_category</TableStoredProcPrefix>");
