...
/// <see cref="ProvincesTable">OEMConversion.ProvincesTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="ProvincesTable"></seealso>
public class ProvincesDefinition
{
#region "Definition (XML) for ProvincesDefinition table"
	//Next 237 lines contain Table Definition (XML) for table "ProvincesDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>GeoGroup</columnName>");
         tbf.Append(      @"<columnUIName>Geographical Group</columnUIName>");
         ...
         tbf.Append(      @"<columnName>ProvCodeDisplay</columnName>");
         tbf.Append(      @"<columnUIName>Province Code Display</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>nvarchar</columnDBType>");
         ...
         tbf.Append(      @"<columnName>Prov_active</columnName>");
         tbf.Append(      @"<columnUIName>Province Active</columnUIName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>Provinces</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>Provinces_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Provinces</TableCodeName>");
         tbf.Append(  @"<FolderName>Provinces</FolderName>");
         tbf.Append(  @"<MenuName>Provinces</MenuName>");
         tbf.Append(  @"<QSPath>../Provinces/Provinces-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionProvinces</TableStoredProcPrefix>");
