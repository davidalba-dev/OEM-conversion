...
/// <see cref="Inventory_locationTable">OEMConversion.Inventory_locationTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Inventory_locationTable"></seealso>
public class Inventory_locationDefinition
{
#region "Definition (XML) for Inventory_locationDefinition table"
	//Next 181 lines contain Table Definition (XML) for table "Inventory_locationDefinition"
	...
	/// <see cref="Inventory_locationTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>inventory_location_id</columnName>");
         ...
         tbf.Append(      @"<columnName>inventory_name</columnName>");
         tbf.Append(      @"<columnUIName>Inventory Name</columnUIName>");
         ...
         tbf.Append(      @"<columnName>inventory_loc_notes</columnName>");
         tbf.Append(      @"<columnUIName>Inventory Location Notes</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>varchar</columnDBType>");
         ...
         tbf.Append(      @"<columnName>inventory_loc_active</columnName>");
         tbf.Append(      @"<columnUIName>Inventory Location Active</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_inventory_location_Customers</columnFKName>");
         ...
         tbf.Append(        @"<columnFKColumnDisplay>=Customers.CustContactName</columnFKColumnDisplay>");
         ...
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>VFK_inventory_location_custno_1</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>inventory_location</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>inventory_location_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>inventory_location</FolderName>");
         tbf.Append(  @"<MenuName>Inventory Location</MenuName>");
         tbf.Append(  @"<QSPath>../inventory_location/Inventory-location-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Inventory_location</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionInventory_location</TableStoredProcPrefix>");
