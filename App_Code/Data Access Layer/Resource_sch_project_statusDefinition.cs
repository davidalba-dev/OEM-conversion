...
/// <see cref="Resource_sch_project_statusTable">OEMConversion.Resource_sch_project_statusTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Resource_sch_project_statusTable"></seealso>
public class Resource_sch_project_statusDefinition
{
#region "Definition (XML) for Resource_sch_project_statusDefinition table"
	//Next 127 lines contain Table Definition (XML) for table "Resource_sch_project_statusDefinition"
	...
	/// <see cref="Resource_sch_project_statusTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>resource_sch_project_status_id</columnName>");
         tbf.Append(      @"<columnUIName>Resource SCH Project Status</columnUIName>");
         ...
         tbf.Append(      @"<columnName>resource_sch_project_status</columnName>");
         tbf.Append(      @"<columnUIName Source=""User"">= &quot;Project Status&quot;</columnUIName>");
         ...
         tbf.Append(      @"<columnName>resource_sch_project_status_active</columnName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>resource_sch_project_status</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>resource_sch_project_status_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>resource_sch_project_status</FolderName>");
         tbf.Append(  @"<MenuName>Resource SCH Project Status</MenuName>");
         tbf.Append(  @"<QSPath>../resource_sch_project_status/Resource-sch-project-status-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Resource_sch_project_status</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionResource_sch_project_status</TableStoredProcPrefix>");
