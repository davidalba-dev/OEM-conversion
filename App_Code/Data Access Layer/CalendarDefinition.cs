...
/// <see cref="CalendarTable">OEMConversion.CalendarTable</see> class
...
#region "Definition (XML) for CalendarDefinition table"
	//Next 302 lines contain Table Definition (XML) for table "CalendarDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>calendar_id</columnName>");
         ...
         tbf.Append(      @"<columnName>calendar_date</columnName>");
         ...
         tbf.Append(      @"<columnName>date_week</columnName>");
         tbf.Append(      @"<columnUIName>Date Week</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<columnName>date_year</columnName>");
         tbf.Append(      @"<columnUIName>Date Year</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<columnName>week_next</columnName>");
         tbf.Append(      @"<columnUIName>Week Next</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<columnName>week_previous</columnName>");
         tbf.Append(      @"<columnUIName>Week Previous</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<columnName>year_next</columnName>");
         tbf.Append(      @"<columnUIName>Year Next</columnUIName>");
         ...
         tbf.Append(      @"<columnName>year_previous</columnName>");
         tbf.Append(      @"<columnUIName>Year Previous</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>varchar</columnDBType>");
         tbf.Append(      @"<columnLengthSet>4</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(  @"<FolderName>calendar</FolderName>");
         tbf.Append(  @"<MenuName>Calendar</MenuName>");
         tbf.Append(  @"<QSPath>../calendar/Calendar-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionCalendar</TableStoredProcPrefix>");
