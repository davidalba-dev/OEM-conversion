...
/// <see cref="Customer_noteTable">OEMConversion.Customer_noteTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Customer_noteTable"></seealso>
public class Customer_noteDefinition
{
#region "Definition (XML) for Customer_noteDefinition table"
	//Next 170 lines contain Table Definition (XML) for table "Customer_noteDefinition"
	...
	/// <see cref="Customer_noteTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>customer_note_id</columnName>");
         tbf.Append(      @"<columnUIName>Customer Note</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_customer_note_Customers</columnFKName>");
         ...
         tbf.Append(      @"<columnName>customer_note</columnName>");
         tbf.Append(      @"<columnUIName>Customer Note</columnUIName>");
         ...
         tbf.Append(      @"<columnName>customer_note_date</columnName>");
         tbf.Append(      @"<columnUIName>Customer Note Date</columnUIName>");
         ...
         tbf.Append(      @"<columnName>customer_note_createdby</columnName>");
         tbf.Append(      @"<columnUIName>Customer Note Createdby</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_customer_note_login</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>customer_note</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>customer_note_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>customer_note</FolderName>");
         tbf.Append(  @"<MenuName>Customer Note</MenuName>");
         tbf.Append(  @"<QSPath>../customer_note/Customer-note-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Customer_note</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionCustomer_note</TableStoredProcPrefix>");
