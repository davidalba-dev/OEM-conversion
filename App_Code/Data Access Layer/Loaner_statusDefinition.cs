...
/// <see cref="Loaner_statusTable">OEMConversion.Loaner_statusTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Loaner_statusTable"></seealso>
public class Loaner_statusDefinition
{
#region "Definition (XML) for Loaner_statusDefinition table"
	//Next 127 lines contain Table Definition (XML) for table "Loaner_statusDefinition"
	...
	/// <see cref="Loaner_statusTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnUIName>Loaner Status</columnUIName>");
         ...
         tbf.Append(      @"<columnName>loaner_status</columnName>");
         ...
         tbf.Append(      @"<columnName>loaner_status_active</columnName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>loaner_status</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>loaner_status_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>loaner_status</FolderName>");
         tbf.Append(  @"<MenuName>Loaner Status</MenuName>");
         tbf.Append(  @"<QSPath>../loaner_status/Loaner-status-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Loaner_status</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionLoaner_status</TableStoredProcPrefix>");
