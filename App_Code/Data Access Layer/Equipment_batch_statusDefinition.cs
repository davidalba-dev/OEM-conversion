...
/// <see cref="Equipment_batch_statusTable">OEMConversion.Equipment_batch_statusTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Equipment_batch_statusTable"></seealso>
public class Equipment_batch_statusDefinition
{
#region "Definition (XML) for Equipment_batch_statusDefinition table"
	//Next 99 lines contain Table Definition (XML) for table "Equipment_batch_statusDefinition"
	...
	/// <see cref="Equipment_batch_statusTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>equipment_batch_status_id</columnName>");
         tbf.Append(      @"<columnUIName>Equipment Batch Status</columnUIName>");
         ...
         tbf.Append(      @"<columnName>batch_status</columnName>");
         ...
         tbf.Append(      @"<columnName>batch_status_active</columnName>");
         tbf.Append(      @"<columnUIName>Batch Status Active</columnUIName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>equipment_batch_status</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>equipment_batch_status_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>equipment_batch_status</FolderName>");
         tbf.Append(  @"<MenuName>Equipment Batch Status</MenuName>");
         tbf.Append(  @"<QSPath>../equipment_batch_status/Equipment-batch-status-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Equipment_batch_status</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionEquipment_batch_status</TableStoredProcPrefix>");
