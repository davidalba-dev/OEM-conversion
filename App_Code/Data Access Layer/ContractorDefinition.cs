...
/// <see cref="ContractorTable">OEMConversion.ContractorTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="ContractorTable"></seealso>
public class ContractorDefinition
{
#region "Definition (XML) for ContractorDefinition table"
	//Next 373 lines contain Table Definition (XML) for table "ContractorDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnUIName Source=""User"">= &quot;Contractor&quot;</columnUIName>");
         ...
         tbf.Append(      @"<columnName>contractor_address</columnName>");
         ...
         tbf.Append(      @"<columnName>contractor_address2</columnName>");
         ...
         tbf.Append(      @"<columnName>contractor_city</columnName>");
         ...
         tbf.Append(      @"<columnName>province_id</columnName>");
         ...
         tbf.Append(        @"<columnFKName>VFK_contractor_province_id_1</columnFKName>");
         ...
         tbf.Append(      @"<columnName>contractor_zip</columnName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>contractor</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>contractor_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Contractor</TableCodeName>");
         tbf.Append(  @"<FolderName>contractor</FolderName>");
         tbf.Append(  @"<MenuName>Contractor</MenuName>");
         tbf.Append(  @"<QSPath>../contractor/Contractor-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionContractor</TableStoredProcPrefix>");
