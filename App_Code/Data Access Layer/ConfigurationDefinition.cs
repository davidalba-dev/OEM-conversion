...
/// <see cref="ConfigurationTable">OEMConversion.ConfigurationTable</see> class
...
#region "Definition (XML) for ConfigurationDefinition table"
	//Next 199 lines contain Table Definition (XML) for table "ConfigurationDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>configuration_id</columnName>");
         ...
         tbf.Append(      @"<columnName>config_title</columnName>");
         tbf.Append(      @"<columnUIName>Configuration Title</columnUIName>");
         ...
         tbf.Append(      @"<columnName>config_active</columnName>");
         tbf.Append(      @"<columnUIName>Configuration Active</columnUIName>");
         ...
         tbf.Append(      @"<columnName>configuration_type</columnName>");
         tbf.Append(      @"<columnUIName>Configuration Type</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionConfiguration</TableStoredProcPrefix>");
