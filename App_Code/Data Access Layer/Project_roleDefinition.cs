...
/// <see cref="Project_roleTable">OEMConversion.Project_roleTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Project_roleTable"></seealso>
public class Project_roleDefinition
{
#region "Definition (XML) for Project_roleDefinition table"
	//Next 197 lines contain Table Definition (XML) for table "Project_roleDefinition"
	...
	/// <see cref="Project_roleTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>project_role</columnName>");
         tbf.Append(      @"<columnUIName>Project Role</columnUIName>");
         ...
         tbf.Append(      @"<columnName>project_role_active</columnName>");
         tbf.Append(      @"<columnUIName>Project Role Active</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_project_role_Technicians</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>project_role</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>project_role_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Project_role</TableCodeName>");
         tbf.Append(  @"<FolderName>project_role</FolderName>");
         tbf.Append(  @"<MenuName>Project Role</MenuName>");
         tbf.Append(  @"<QSPath>../project_role/Project-role-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionProject_role</TableStoredProcPrefix>");
