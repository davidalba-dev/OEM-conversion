...
/// <see cref="CategoryView">OEMConversion.CategoryView</see> class
...
#region "Definition (XML) for CategoryDefinition table"
	//Next 61 lines contain Table Definition (XML) for table "CategoryDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionCategory</TableStoredProcPrefix>");
