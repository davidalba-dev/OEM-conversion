...
/// <see cref="Repair_FaultView">OEMConversion.Repair_FaultView</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Repair_FaultView"></seealso>
public class Repair_FaultDefinition
{
#region "Definition (XML) for Repair_FaultDefinition table"
	//Next 177 lines contain Table Definition (XML) for table "Repair_FaultDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>Repair_Fault</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>Repair_Fault_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>Repair_Fault</FolderName>");
         tbf.Append(  @"<MenuName>Repair Fault</MenuName>");
         tbf.Append(  @"<QSPath>../Repair_Fault/Repair-Fault-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Repair_Fault</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionRepair_Fault</TableStoredProcPrefix>");
