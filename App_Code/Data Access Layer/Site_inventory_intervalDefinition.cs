...
/// <see cref="Site_inventory_intervalTable">OEMConversion.Site_inventory_intervalTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Site_inventory_intervalTable"></seealso>
public class Site_inventory_intervalDefinition
{
#region "Definition (XML) for Site_inventory_intervalDefinition table"
	//Next 99 lines contain Table Definition (XML) for table "Site_inventory_intervalDefinition"
	...
	/// <see cref="Site_inventory_intervalTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>site_inventory_interval_id</columnName>");
         tbf.Append(      @"<columnUIName>Site Inventory Interval</columnUIName>");
         ...
         tbf.Append(      @"<columnName>site_inventory_interval</columnName>");
         tbf.Append(      @"<columnUIName>Site Inventory Interval</columnUIName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>site_inventory_interval</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>site_inventory_interval_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>site_inventory_interval</FolderName>");
         tbf.Append(  @"<MenuName>Site Inventory Interval</MenuName>");
         tbf.Append(  @"<QSPath>../site_inventory_interval/Site-inventory-interval-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Site_inventory_interval</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionSite_inventory_interval</TableStoredProcPrefix>");
