...
/// <see cref="Technician_teamTable">OEMConversion.Technician_teamTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Technician_teamTable"></seealso>
public class Technician_teamDefinition
{
#region "Definition (XML) for Technician_teamDefinition table"
	//Next 155 lines contain Table Definition (XML) for table "Technician_teamDefinition"
	...
	/// <see cref="Technician_teamTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>techncian_team_id</columnName>");
         tbf.Append(      @"<columnUIName>Techncian Team</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_technician_team_Technicians</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_technician_team_oem_team</columnFKName>");
         tbf.Append(        @"<columnFKTable>OEMConversion.Business.Oem_teamTable, App_Code</columnFKTable>");
         tbf.Append(        @"<columnFKOwner>dbo</columnFKOwner>");
         tbf.Append(        @"<columnFKColumn>oem_team_id</columnFKColumn>");
         tbf.Append(        @"<columnFKColumnDisplay>= Oem_team.oem_team_name</columnFKColumnDisplay>");
         tbf.Append(        @"<foreignKeyType>Explicit</foreignKeyType>");
         tbf.Append(      "</foreignKey>");
         tbf.Append(      @"<applyDFKA>Y</applyDFKA>");
         tbf.Append(      @"<applyInitializeInsertingRecord>N</applyInitializeInsertingRecord>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>technician_team</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>technician_team_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Technician_team</TableCodeName>");
         tbf.Append(  @"<FolderName>technician_team</FolderName>");
         tbf.Append(  @"<MenuName>Technician Team</MenuName>");
         tbf.Append(  @"<QSPath>../technician_team/Technician-team-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionTechnician_team</TableStoredProcPrefix>");
