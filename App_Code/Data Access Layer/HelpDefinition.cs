...
/// <see cref="HelpTable">OEMConversion.HelpTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="HelpTable"></seealso>
public class HelpDefinition
{
#region "Definition (XML) for HelpDefinition table"
	//Next 135 lines contain Table Definition (XML) for table "HelpDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>help_id</columnName>");
         tbf.Append(      @"<columnUIName>Help</columnUIName>");
         ...
         tbf.Append(      @"<columnName>Help Title</columnName>");
         tbf.Append(      @"<columnUIName>Help Title</columnUIName>");
         ...
         tbf.Append(      @"<columnName>help_file</columnName>");
         tbf.Append(      @"<columnUIName>Help File</columnUIName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>Help</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>Help_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Help</TableCodeName>");
         tbf.Append(  @"<FolderName>Help</FolderName>");
         tbf.Append(  @"<MenuName>Help</MenuName>");
         tbf.Append(  @"<QSPath>../Help/Help-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionHelp</TableStoredProcPrefix>");
