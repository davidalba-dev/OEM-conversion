...
/// <see cref="Customer_typeTable">OEMConversion.Customer_typeTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Customer_typeTable"></seealso>
public class Customer_typeDefinition
{
#region "Definition (XML) for Customer_typeDefinition table"
	//Next 99 lines contain Table Definition (XML) for table "Customer_typeDefinition"
	...
	/// <see cref="Customer_typeTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>customer_type_active</columnName>");
         tbf.Append(      @"<columnUIName>Customer Type Active</columnUIName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>customer_type</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>customer_type_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>customer_type</FolderName>");
         tbf.Append(  @"<MenuName>Customer Type</MenuName>");
         tbf.Append(  @"<QSPath>../customer_type/Customer-type-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Customer_type</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionCustomer_type</TableStoredProcPrefix>");
