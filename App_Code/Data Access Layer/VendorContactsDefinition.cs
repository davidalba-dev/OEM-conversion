...
/// <see cref="VendorContactsTable">OEMConversion.VendorContactsTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="VendorContactsTable"></seealso>
public class VendorContactsDefinition
{
#region "Definition (XML) for VendorContactsDefinition table"
	//Next 281 lines contain Table Definition (XML) for table "VendorContactsDefinition"
	...
	/// <see cref="VendorContactsTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>VendContactEmail</columnName>");
         tbf.Append(      @"<columnUIName>Vend Contact Email</columnUIName>");
         ...
         tbf.Append(      @"<columnName>VendContactFax</columnName>");
         tbf.Append(      @"<columnUIName>Vend Contact Fax</columnUIName>");
         ...
         tbf.Append(      @"<columnName>VendContactKey</columnName>");
         tbf.Append(      @"<columnUIName>Vend Contact Key</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<columnUIName>Vend Contact Name</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>nvarchar</columnDBType>");
         tbf.Append(      @"<columnLengthSet>32</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<columnName>VendContactPhoneBusiness</columnName>");
         tbf.Append(      @"<columnUIName>Vend Contact Phone Business</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>nvarchar</columnDBType>");
         tbf.Append(      @"<columnLengthSet>32</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<columnName>VendContactPhoneMobile</columnName>");
         tbf.Append(      @"<columnUIName>Vend Contact Phone Mobile</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>nvarchar</columnDBType>");
         tbf.Append(      @"<columnLengthSet>32</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<columnName>VendContactTitle</columnName>");
         tbf.Append(      @"<columnUIName>Vend Contact Title</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>nvarchar</columnDBType>");
         tbf.Append(      @"<columnLengthSet>32</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<columnName>VendContactType</columnName>");
         tbf.Append(      @"<columnUIName>Vend Contact Type</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>VendorContacts</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>VendorContacts_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>VendorContacts</FolderName>");
         tbf.Append(  @"<MenuName>Vendor Contacts</MenuName>");
         tbf.Append(  @"<QSPath>../VendorContacts/VendorContacts-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>VendorContacts</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionVendorContacts</TableStoredProcPrefix>");
