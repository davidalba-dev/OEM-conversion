...
/// <see cref="Vw_resource_schedule_weekView">OEMConversion.Vw_resource_schedule_weekView</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Vw_resource_schedule_weekView"></seealso>
public class Vw_resource_schedule_weekDefinition
{
#region "Definition (XML) for Vw_resource_schedule_weekDefinition table"
	//Next 542 lines contain Table Definition (XML) for table "Vw_resource_schedule_weekDefinition"
	...
	/// <see cref="Vw_resource_schedule_weekView"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnUIName Source=""User"">= &quot;Details&quot;</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>varchar</columnDBType>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>vw_resource_schedule_week</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>vw_resource_schedule_week_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Vw_resource_schedule_week</TableCodeName>");
         tbf.Append(  @"<FolderName>vw_resource_schedule_week</FolderName>");
         tbf.Append(  @"<MenuName>Resource Schedule Week</MenuName>");
         tbf.Append(  @"<QSPath>../vw_resource_schedule_week/Vw-resource-schedule-week-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionVw_resource_schedule_week</TableStoredProcPrefix>");
