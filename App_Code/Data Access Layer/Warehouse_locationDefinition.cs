...
/// <see cref="Warehouse_locationTable">OEMConversion.Warehouse_locationTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Warehouse_locationTable"></seealso>
public class Warehouse_locationDefinition
{
#region "Definition (XML) for Warehouse_locationDefinition table"
	//Next 208 lines contain Table Definition (XML) for table "Warehouse_locationDefinition"
	...
	/// <see cref="Warehouse_locationTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>warehouse_location_active</columnName>");
         tbf.Append(      @"<columnUIName>Warehouse Location Active</columnUIName>");
         ...
         tbf.Append(      @"<columnName>warehouse_location_description</columnName>");
         tbf.Append(      @"<columnUIName>Warehouse Location Description</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>varchar</columnDBType>");
         ...
         tbf.Append(        @"<columnFKName>FK_warehouse_location_warehouse</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>warehouse_location</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>warehouse_location_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Warehouse_location</TableCodeName>");
         tbf.Append(  @"<FolderName>warehouse_location</FolderName>");
         tbf.Append(  @"<MenuName>Warehouse Location</MenuName>");
         tbf.Append(  @"<QSPath>../warehouse_location/Warehouse-location-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionWarehouse_location</TableStoredProcPrefix>");
