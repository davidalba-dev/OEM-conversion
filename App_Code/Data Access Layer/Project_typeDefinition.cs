...
/// <see cref="Project_typeTable">OEMConversion.Project_typeTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Project_typeTable"></seealso>
public class Project_typeDefinition
{
#region "Definition (XML) for Project_typeDefinition table"
	//Next 127 lines contain Table Definition (XML) for table "Project_typeDefinition"
	...
	/// <see cref="Project_typeTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>project_type</columnName>");
         tbf.Append(      @"<columnUIName Source=""User"">= &quot;Type&quot;</columnUIName>");
         ...
         tbf.Append(      @"<columnName>project_type_active</columnName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>project_type</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>project_type_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>project_type</FolderName>");
         tbf.Append(  @"<MenuName>Project Type</MenuName>");
         tbf.Append(  @"<QSPath>../project_type/Project-type-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Project_type</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionProject_type</TableStoredProcPrefix>");
