...
/// <see cref="ConditionsTable">OEMConversion.ConditionsTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="ConditionsTable"></seealso>
public class ConditionsDefinition
{
#region "Definition (XML) for ConditionsDefinition table"
	//Next 199 lines contain Table Definition (XML) for table "ConditionsDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>condition_active</columnName>");
         tbf.Append(      @"<columnUIName>Condition Active</columnUIName>");
         tbf.Append(      @"<columnType>Boolean</columnType>");
         tbf.Append(      @"<columnDBType>bit</columnDBType>");
         tbf.Append(      @"<columnLengthSet></columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>Conditions</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>Conditions_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Conditions</TableCodeName>");
         tbf.Append(  @"<FolderName>Conditions</FolderName>");
         tbf.Append(  @"<MenuName>Conditions</MenuName>");
         tbf.Append(  @"<QSPath>../Conditions/Conditions-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionConditions</TableStoredProcPrefix>");
