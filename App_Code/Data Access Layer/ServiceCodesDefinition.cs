...
/// <see cref="ServiceCodesTable">OEMConversion.ServiceCodesTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="ServiceCodesTable"></seealso>
public class ServiceCodesDefinition
{
#region "Definition (XML) for ServiceCodesDefinition table"
	//Next 751 lines contain Table Definition (XML) for table "ServiceCodesDefinition"
	...
	/// <see cref="ServiceCodesTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnUIName Source=""User"">= &quot;Service Category&quot;</columnUIName>");
         ...
         tbf.Append(      @"<columnUIName Source=""User"">= &quot;Service Charge&quot;</columnUIName>");
         ...
         tbf.Append(      @"<columnUIName Source=""User"">= &quot;Service Code&quot;</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>nvarchar</columnDBType>");
         ...
         tbf.Append(      @"<columnCollation>SQL_Latin1_General_CP1_CI_AS</columnCollation>");
         tbf.Append(      @"<columnFullText Source=""User"">N</columnFullText>");
         tbf.Append(      @"<columnVisibleWidth>50</columnVisibleWidth>");
         tbf.Append(      @"<columnTableAliasName></columnTableAliasName>");
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<applyDFKA>N</applyDFKA>");
         tbf.Append(      @"<applyInitializeInsertingRecord>N</applyInitializeInsertingRecord>");
         ...
         tbf.Append(      @"<columnUIName Source=""User"">= &quot;Service Code Group&quot;</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>nvarchar</columnDBType>");
         ...
         tbf.Append(      @"<columnUIName Source=""User"">= &quot;Date Record Added&quot;</columnUIName>");
         ...
         tbf.Append(      @"<columnUIName Source=""User"">= &quot;Service Default&quot;</columnUIName>");
         ...
         tbf.Append(      @"<columnUIName Source=""User"">= &quot;Service Description&quot;</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>nvarchar</columnDBType>");
         ...
         tbf.Append(      @"<columnUIName Source=""User"">= &quot;Service Notes&quot;</columnUIName>");
         tbf.Append(      @"<columnType>Very Large String</columnType>");
         tbf.Append(      @"<columnDBType>nvarchar(max)</columnDBType>");
         tbf.Append(      @"<columnLengthSet>1073741823</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<columnUIName Source=""User"">= &quot;Service Type&quot;</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>ServiceCodes</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>ServiceCodes_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>ServiceCodes</TableCodeName>");
         tbf.Append(  @"<FolderName>ServiceCodes</FolderName>");
         tbf.Append(  @"<MenuName>Service Codes</MenuName>");
         tbf.Append(  @"<QSPath>../ServiceCodes/ServiceCodes-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionServiceCodes</TableStoredProcPrefix>");
