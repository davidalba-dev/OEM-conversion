...
/// <see cref="DepartmentTable">OEMConversion.DepartmentTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="DepartmentTable"></seealso>
public class DepartmentDefinition
{
#region "Definition (XML) for DepartmentDefinition table"
	//Next 325 lines contain Table Definition (XML) for table "DepartmentDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(        @"<columnFKName>FK_department_Customers</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_department_CustomerContacts</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_department_CustomerContacts1</columnFKName>");
         tbf.Append(        @"<columnFKTable>OEMConversion.Business.CustomerContactsTable, App_Code</columnFKTable>");
         tbf.Append(        @"<columnFKOwner>dbo</columnFKOwner>");
         tbf.Append(        @"<columnFKColumn>CustContactKey</columnFKColumn>");
         tbf.Append(        @"<columnFKColumnDisplay>=CustomerContacts.CustContactName</columnFKColumnDisplay>");
         ...
         tbf.Append(      @"<columnName>customercontact_primary_phone</columnName>");
         tbf.Append(      @"<columnUIName>Customercontact Primary Phone</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>varchar</columnDBType>");
         ...
         tbf.Append(      @"<columnName>customercontact_secondary_phone</columnName>");
         tbf.Append(      @"<columnUIName>Customercontact Secondary Phone</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>varchar</columnDBType>");
         tbf.Append(      @"<columnLengthSet>32</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>department</TableName>");
         tbf.Append(  @"<Version>2</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>department_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Department</TableCodeName>");
         tbf.Append(  @"<FolderName>department</FolderName>");
         tbf.Append(  @"<MenuName>Department</MenuName>");
         tbf.Append(  @"<QSPath>../department/Department-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionDepartment</TableStoredProcPrefix>");
