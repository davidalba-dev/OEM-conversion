...
/// <see cref="Lead_sourceTable">OEMConversion.Lead_sourceTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Lead_sourceTable"></seealso>
public class Lead_sourceDefinition
{
#region "Definition (XML) for Lead_sourceDefinition table"
	//Next 99 lines contain Table Definition (XML) for table "Lead_sourceDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>lead_source</columnName>");
         tbf.Append(      @"<columnUIName>Lead Source</columnUIName>");
         ...
         tbf.Append(      @"<columnName>lead_source_active</columnName>");
         tbf.Append(      @"<columnUIName>Lead Source Active</columnUIName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>lead_source</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>lead_source_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>lead_source</FolderName>");
         tbf.Append(  @"<MenuName>Lead Source</MenuName>");
         tbf.Append(  @"<QSPath>../lead_source/Lead-source-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Lead_source</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionLead_source</TableStoredProcPrefix>");
