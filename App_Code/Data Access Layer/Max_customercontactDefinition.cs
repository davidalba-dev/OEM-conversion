...
/// <see cref="Max_customercontactView">OEMConversion.Max_customercontactView</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Max_customercontactView"></seealso>
public class Max_customercontactDefinition
{
#region "Definition (XML) for Max_customercontactDefinition table"
	//Next 61 lines contain Table Definition (XML) for table "Max_customercontactDefinition"
	...
	/// <see cref="Max_customercontactView"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>max_customercontact</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>max_customercontact_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>max_customercontact</FolderName>");
         tbf.Append(  @"<MenuName>Maximum Customercontact</MenuName>");
         tbf.Append(  @"<QSPath>../max_customercontact/Max-customercontact-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Max_customercontact</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionMax_customercontact</TableStoredProcPrefix>");
