...
/// <see cref="Resource_sch_priorityTable">OEMConversion.Resource_sch_priorityTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Resource_sch_priorityTable"></seealso>
public class Resource_sch_priorityDefinition
{
#region "Definition (XML) for Resource_sch_priorityDefinition table"
	//Next 127 lines contain Table Definition (XML) for table "Resource_sch_priorityDefinition"
	...
	/// <see cref="Resource_sch_priorityTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>resource_sch_priority_active</columnName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>resource_sch_priority</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>resource_sch_priority_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>resource_sch_priority</FolderName>");
         tbf.Append(  @"<MenuName>Resource SCH Priority</MenuName>");
         tbf.Append(  @"<QSPath>../resource_sch_priority/Resource-sch-priority-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Resource_sch_priority</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionResource_sch_priority</TableStoredProcPrefix>");
