...
/// <see cref="Vw_contractor_skillsView">OEMConversion.Vw_contractor_skillsView</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Vw_contractor_skillsView"></seealso>
public class Vw_contractor_skillsDefinition
{
#region "Definition (XML) for Vw_contractor_skillsDefinition table"
	//Next 305 lines contain Table Definition (XML) for table "Vw_contractor_skillsDefinition"
	...
	/// <see cref="Vw_contractor_skillsView"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>skill_name</columnName>");
         tbf.Append(      @"<columnUIName>Skill Name</columnUIName>");
         ...
         tbf.Append(      @"<columnName>skill_active</columnName>");
         tbf.Append(      @"<columnUIName>Skill Active</columnUIName>");
         ...
         tbf.Append(      @"<columnName>contractor_name</columnName>");
         tbf.Append(      @"<columnUIName>Contractor Name</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>varchar</columnDBType>");
         tbf.Append(      @"<columnLengthSet>50</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(        @"<columnFKName>VFK_vw_contractor_skills_contractor_id_1</columnFKName>");
         ...
         tbf.Append(        @"<columnFKColumnDisplay>= Contractor.contractor_name</columnFKColumnDisplay>");
         tbf.Append(        @"<foreignKeyType>Implicit</foreignKeyType>");
         tbf.Append(      "</foreignKey>");
         tbf.Append(    "</Column>");
         tbf.Append(    @"<Column InternalName=""4"" Priority=""5"" ColumnNum=""4"">");
         tbf.Append(      @"<columnName>contractor_skill_id</columnName>");
         tbf.Append(      @"<columnUIName>Contractor Skill</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<updatingFormula></updatingFormula>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>VFK_vw_contractor_skills_contractor_skill_id_1</columnFKName>");
         tbf.Append(        @"<columnFKTable>OEMConversion.Business.Contractor_skillsTable, App_Code</columnFKTable>");
         tbf.Append(        @"<columnFKOwner>dbo</columnFKOwner>");
         tbf.Append(        @"<columnFKColumn>contractor_skill_id</columnFKColumn>");
         tbf.Append(        @"<columnFKColumnDisplay>= Contractor_skills.skill_name</columnFKColumnDisplay>");
         tbf.Append(        @"<foreignKeyType>Implicit</foreignKeyType>");
         tbf.Append(      "</foreignKey>");
         tbf.Append(    "</Column>");
         ...
         tbf.Append(      @"<columnName>contractor_skill_matrix_id</columnName>");
         tbf.Append(      @"<columnUIName Source=""User"">Contractor Skill Matrix</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>vw_contractor_skills</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>vw_contractor_skills_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Vw_contractor_skills</TableCodeName>");
         tbf.Append(  @"<FolderName>vw_contractor_skills</FolderName>");
         tbf.Append(  @"<MenuName>Contractor Skills1</MenuName>");
         tbf.Append(  @"<QSPath>../vw_contractor_skills/Vw-contractor-skills-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionVw_contractor_skills</TableStoredProcPrefix>");
