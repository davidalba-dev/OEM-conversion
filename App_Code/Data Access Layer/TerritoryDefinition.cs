...
/// <see cref="TerritoryTable">OEMConversion.TerritoryTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="TerritoryTable"></seealso>
public class TerritoryDefinition
{
#region "Definition (XML) for TerritoryDefinition table"
	//Next 99 lines contain Table Definition (XML) for table "TerritoryDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnUIName>Territory</columnUIName>");
         ...
         tbf.Append(      @"<columnName>territory_name</columnName>");
         tbf.Append(      @"<columnUIName>Territory Name</columnUIName>");
         ...
         tbf.Append(      @"<columnName>territory_active</columnName>");
         tbf.Append(      @"<columnUIName>Territory Active</columnUIName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>territory</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>territory_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>territory</FolderName>");
         tbf.Append(  @"<MenuName>Territory</MenuName>");
         tbf.Append(  @"<QSPath>../territory/Territory-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Territory</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionTerritory</TableStoredProcPrefix>");
