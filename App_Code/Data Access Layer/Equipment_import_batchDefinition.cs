...
/// <see cref="Equipment_import_batchTable">OEMConversion.Equipment_import_batchTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Equipment_import_batchTable"></seealso>
public class Equipment_import_batchDefinition
{
#region "Definition (XML) for Equipment_import_batchDefinition table"
	//Next 192 lines contain Table Definition (XML) for table "Equipment_import_batchDefinition"
	...
	/// <see cref="Equipment_import_batchTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>batch_date_created</columnName>");
         tbf.Append(      @"<columnUIName>Batch Date Created</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>VFK_equipment_import_batch_custno_1</columnFKName>");
         ...
         tbf.Append(      @"<columnName>technician</columnName>");
         ...
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>VFK_equipment_import_batch_technician_1</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>equipment_import_batch</TableName>");
         tbf.Append(  @"<Version>2</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>equipment_import_batch_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Equipment_import_batch</TableCodeName>");
         tbf.Append(  @"<FolderName>equipment_import_batch</FolderName>");
         tbf.Append(  @"<MenuName>Equipment Import Batch</MenuName>");
         tbf.Append(  @"<QSPath>../equipment_import_batch/Equipment-import-batch-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionEquipment_import_batch</TableStoredProcPrefix>");
