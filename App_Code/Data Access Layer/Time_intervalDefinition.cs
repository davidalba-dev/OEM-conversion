...
/// <see cref="Time_intervalTable">OEMConversion.Time_intervalTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Time_intervalTable"></seealso>
public class Time_intervalDefinition
{
#region "Definition (XML) for Time_intervalDefinition table"
	//Next 97 lines contain Table Definition (XML) for table "Time_intervalDefinition"
	...
	/// <see cref="Time_intervalTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>time_interval</columnName>");
         tbf.Append(      @"<columnUIName>Time Interval</columnUIName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>time_interval</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>time_interval_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Time_interval</TableCodeName>");
         tbf.Append(  @"<FolderName>time_interval</FolderName>");
         tbf.Append(  @"<MenuName>Time Interval</MenuName>");
         tbf.Append(  @"<QSPath>../time_interval/Time-interval-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionTime_interval</TableStoredProcPrefix>");
