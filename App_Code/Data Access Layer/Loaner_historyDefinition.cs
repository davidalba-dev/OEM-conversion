...
/// <see cref="Loaner_historyTable">OEMConversion.Loaner_historyTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Loaner_historyTable"></seealso>
public class Loaner_historyDefinition
{
#region "Definition (XML) for Loaner_historyDefinition table"
	//Next 419 lines contain Table Definition (XML) for table "Loaner_historyDefinition"
	...
	/// <see cref="Loaner_historyTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>loaner_id</columnName>");
         tbf.Append(      @"<columnUIName>Loaner</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_loaner_history_equipment_inventory</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_loaner_history_Customers</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_loaner_history_CustomerContacts</columnFKName>");
         ...
         tbf.Append(      @"<columnName>date_out</columnName>");
         tbf.Append(      @"<columnUIName>Date Out</columnUIName>");
         ...
         tbf.Append(      @"<columnName>technician_out</columnName>");
         tbf.Append(      @"<columnUIName>Technician Out</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_loaner_history_Technicians</columnFKName>");
         ...
         tbf.Append(      @"<columnName>date_in</columnName>");
         tbf.Append(      @"<columnUIName>Date In</columnUIName>");
         tbf.Append(      @"<columnType>Date</columnType>");
         tbf.Append(      @"<columnDBType>date</columnDBType>");
         tbf.Append(      @"<columnLengthSet></columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<columnName>technician_in</columnName>");
         tbf.Append(      @"<columnUIName>Technician In</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_loaner_history_Technicians1</columnFKName>");
         tbf.Append(        @"<columnFKTable>OEMConversion.Business.TechniciansTable, App_Code</columnFKTable>");
         tbf.Append(        @"<columnFKOwner>dbo</columnFKOwner>");
         tbf.Append(        @"<columnFKColumn>technician_id</columnFKColumn>");
         tbf.Append(        @"<columnFKColumnDisplay>TechName</columnFKColumnDisplay>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_loaner_history_RepairOrders</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>loaner_history</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>loaner_history_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Loaner_history</TableCodeName>");
         tbf.Append(  @"<FolderName>loaner_history</FolderName>");
         tbf.Append(  @"<MenuName>Loaner History</MenuName>");
         tbf.Append(  @"<QSPath>../loaner_history/Loaner-history-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionLoaner_history</TableStoredProcPrefix>");
