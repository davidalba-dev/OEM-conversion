...
/// <see cref="ApprovalMethodsTable">OEMConversion.ApprovalMethodsTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="ApprovalMethodsTable"></seealso>
public class ApprovalMethodsDefinition
{
#region "Definition (XML) for ApprovalMethodsDefinition table"
	//Next 199 lines contain Table Definition (XML) for table "ApprovalMethodsDefinition"
	...
	/// <see cref="ApprovalMethodsTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>ApprovalMethod</columnName>");
         tbf.Append(      @"<columnUIName>Approval Method</columnUIName>");
         ...
         tbf.Append(      @"<columnName>Approve_active</columnName>");
         tbf.Append(      @"<columnUIName>Approve Active</columnUIName>");
         tbf.Append(      @"<columnType>Boolean</columnType>");
         tbf.Append(      @"<columnDBType>bit</columnDBType>");
         tbf.Append(      @"<columnLengthSet></columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>ApprovalMethods</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>ApprovalMethods_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>ApprovalMethods</TableCodeName>");
         tbf.Append(  @"<FolderName>ApprovalMethods</FolderName>");
         tbf.Append(  @"<MenuName>Approval Methods</MenuName>");
         tbf.Append(  @"<QSPath>../ApprovalMethods/ApprovalMethods-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionApprovalMethods</TableStoredProcPrefix>");
