...
/// <see cref="Procurement_statusTable">OEMConversion.Procurement_statusTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Procurement_statusTable"></seealso>
public class Procurement_statusDefinition
{
#region "Definition (XML) for Procurement_statusDefinition table"
	//Next 161 lines contain Table Definition (XML) for table "Procurement_statusDefinition"
	...
	/// <see cref="Procurement_statusTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnUIName>Procurement Status</columnUIName>");
         ...
         tbf.Append(      @"<columnName>procurement_status</columnName>");
         ...
         tbf.Append(      @"<columnName>procurement_status_active</columnName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>procurement_status</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>procurement_status_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Procurement_status</TableCodeName>");
         tbf.Append(  @"<FolderName>procurement_status</FolderName>");
         tbf.Append(  @"<MenuName>Procurement Status</MenuName>");
         tbf.Append(  @"<QSPath>../procurement_status/Procurement-status-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionProcurement_status</TableStoredProcPrefix>");
