...
/// <see cref="Site_inventory_contractTable">OEMConversion.Site_inventory_contractTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Site_inventory_contractTable"></seealso>
public class Site_inventory_contractDefinition
{
#region "Definition (XML) for Site_inventory_contractDefinition table"
	//Next 502 lines contain Table Definition (XML) for table "Site_inventory_contractDefinition"
	...
	/// <see cref="Site_inventory_contractTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(        @"<columnFKName>FK_site_inventory_contract_CustomerContacts</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_site_inventory_contract_Customers</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_site_inventory_contract_corporate</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_site_inventory_contract_corporate_contacts</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_site_inventory_contract_Technicians</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>site_inventory_contract</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>site_inventory_contract_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Site_inventory_contract</TableCodeName>");
         tbf.Append(  @"<FolderName>site_inventory_contract</FolderName>");
         tbf.Append(  @"<MenuName>Site Inventory Contract</MenuName>");
         tbf.Append(  @"<QSPath>../site_inventory_contract/Site-inventory-contract-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionSite_inventory_contract</TableStoredProcPrefix>");
