...
/// <see cref="Custom_notificationTable">OEMConversion.Custom_notificationTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Custom_notificationTable"></seealso>
public class Custom_notificationDefinition
{
#region "Definition (XML) for Custom_notificationDefinition table"
	//Next 99 lines contain Table Definition (XML) for table "Custom_notificationDefinition"
	...
	/// <see cref="Custom_notificationTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>custom_notification_id</columnName>");
         tbf.Append(      @"<columnUIName>Custom Notification</columnUIName>");
         ...
         tbf.Append(      @"<columnName>custom_notification_msg</columnName>");
         tbf.Append(      @"<columnUIName>Custom Notification Message</columnUIName>");
         ...
         tbf.Append(      @"<columnName>custom_notification_active</columnName>");
         tbf.Append(      @"<columnUIName>Custom Notification Active</columnUIName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>custom_notification</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>custom_notification_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>custom_notification</FolderName>");
         tbf.Append(  @"<MenuName>Custom Notification</MenuName>");
         tbf.Append(  @"<QSPath>../custom_notification/Custom-notification-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Custom_notification</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionCustom_notification</TableStoredProcPrefix>");
