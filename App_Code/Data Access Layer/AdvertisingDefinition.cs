...
/// <see cref="AdvertisingTable">OEMConversion.AdvertisingTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="AdvertisingTable"></seealso>
public class AdvertisingDefinition
{
#region "Definition (XML) for AdvertisingDefinition table"
	//Next 199 lines contain Table Definition (XML) for table "AdvertisingDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>Advertising</columnName>");
         tbf.Append(      @"<columnUIName>Advertising</columnUIName>");
         ...
         tbf.Append(      @"<columnName>Advertising_active</columnName>");
         tbf.Append(      @"<columnUIName>Advertising Active</columnUIName>");
         tbf.Append(      @"<columnType>Boolean</columnType>");
         tbf.Append(      @"<columnDBType>bit</columnDBType>");
         tbf.Append(      @"<columnLengthSet></columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>Advertising</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>Advertising_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Advertising</TableCodeName>");
         tbf.Append(  @"<FolderName>Advertising</FolderName>");
         tbf.Append(  @"<MenuName>Advertising</MenuName>");
         tbf.Append(  @"<QSPath>../Advertising/Advertising-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionAdvertising</TableStoredProcPrefix>");
