...
/// <see cref="Equipment_typeTable">OEMConversion.Equipment_typeTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="Equipment_typeTable"></seealso>
public class Equipment_typeDefinition
{
#region "Definition (XML) for Equipment_typeDefinition table"
	//Next 99 lines contain Table Definition (XML) for table "Equipment_typeDefinition"
	...
	/// <see cref="Equipment_typeTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>eqiupment_type_active</columnName>");
         tbf.Append(      @"<columnUIName>Eqiupment Type Active</columnUIName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>equipment_type</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>equipment_type_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>equipment_type</FolderName>");
         tbf.Append(  @"<MenuName>Equipment Type</MenuName>");
         tbf.Append(  @"<QSPath>../equipment_type/Equipment-type-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Equipment_type</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOEMConversionEquipment_type</TableStoredProcPrefix>");
