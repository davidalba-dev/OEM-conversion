...
// Show_InventorySerial.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_InventorySerial
{
...
// Base class for the InventorySerialRecordControl control on the Show_InventorySerial page.
...
public class BaseInventorySerialRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in InventorySerialRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-InventorySerial"] = recId;
