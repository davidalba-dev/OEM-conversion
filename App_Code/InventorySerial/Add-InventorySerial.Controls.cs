...
// Add_InventorySerial.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_InventorySerial
{
...
// Base class for the InventorySerialRecordControl control on the Add_InventorySerial page.
...
public class BaseInventorySerialRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (InventorySerialRecord)InventorySerialRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in InventorySerialRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["InventorySerial"];
            ...
            HttpContext.Current.Session["QueryString in Add-InventorySerial"] = recId;
...
#region "Helper Properties"
    ...
    InventorySerialRecord rec = null;
             ...
             
        {
            ...
            return new InventorySerialRecord();
