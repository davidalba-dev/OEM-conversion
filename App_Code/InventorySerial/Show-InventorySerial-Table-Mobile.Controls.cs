...
// Show_InventorySerial_Table_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_InventorySerial_Table_Mobile
{
...
// Base class for the InventorySerialTableControlRow control on the Show_InventorySerial_Table_Mobile page.
...
public class BaseInventorySerialTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetSerPartNo()
        {
            ...
            // Set the SerPartNo Label on the webpage with value from the
            // DatabaseAYS_OEM%dbo.InventorySerial database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.InventorySerial record retrieved from the database.
            // this.SerPartNo is the ASP:Label on the webpage.
      ...
      // To customize, override this method in InventorySerialTableControlRow.
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../InventorySerial/Show-InventorySerial-Mobile.aspx?InventorySerial={PK}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Label SerPartNo {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "SerPartNo");
            }
        }
...
// Base class for the InventorySerialTableControl control on the Show_InventorySerial_Table_Mobile page.
...
public class BaseInventorySerialTableControl : OEMConversion.UI.BaseApplicationTableControl
{
       ...
       public BaseInventorySerialTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.SerDetailNoFromFilter)) 				
                    initialVal = this.GetFromSession(this.SerDetailNoFromFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"SerDetailNoFrom\")");
                
                if (initialVal != null && initialVal != "")		
                {
                        
                    this.SerDetailNoFromFilter.Text = initialVal;
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.SerDetailNoToFilter)) 				
                    initialVal = this.GetFromSession(this.SerDetailNoToFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"SerDetailNoTo\")");
                
                if (initialVal != null && initialVal != "")		
                {
                        
                    this.SerDetailNoToFilter.Text = initialVal;
            ...
            if (!this.Page.IsPostBack)
            {
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.SerPartNoFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.SerPartNoFilter.SelectedValue = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.SerPartNoFilter.SelectedIndexChanged += new EventHandler(SerPartNoFilter_SelectedIndexChanged);
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep1 = (System.Web.UI.WebControls.Repeater)BaseClasses.Utils.MiscUtils.FindControlRecursively(rep.Items[PageIndex], "InventorySerialTableControlRepeater1");
        ...
        public virtual void ResetControl()
        {
            ...
            this.SerDetailNoFromFilter.Text = "";
            
            this.SerDetailNoToFilter.Text = "";
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.SearchText, this.GetFromSession(this.SearchText)), true, false);
            ...
            if (MiscUtils.IsValueSelected(this.SerDetailNoFromFilter)) {
                        
                wc.iAND(InventorySerialTable.SerDetailNo, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, MiscUtils.GetSelectedValue(this.SerDetailNoFromFilter, this.GetFromSession(this.SerDetailNoFromFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.SerDetailNoToFilter)) {
                        
                wc.iAND(InventorySerialTable.SerDetailNo, BaseFilter.ComparisonOperator.Less_Than_Or_Equal, MiscUtils.GetSelectedValue(this.SerDetailNoToFilter, this.GetFromSession(this.SerDetailNoToFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.SerPartNoFilter)) {
                        
                wc.iAND(InventorySerialTable.SerPartNo, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.SerPartNoFilter, this.GetFromSession(this.SerPartNoFilter)), false, false);
      ...
      String SerDetailNoFromFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "SerDetailNoFromFilter_Ajax"];
            if (MiscUtils.IsValueSelected(SerDetailNoFromFilterSelectedValue)) {

              
                wc.iAND(InventorySerialTable.SerDetailNo, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, SerDetailNoFromFilterSelectedValue, false, false);
                      
      }
                      
      String SerDetailNoToFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "SerDetailNoToFilter_Ajax"];
            if (MiscUtils.IsValueSelected(SerDetailNoToFilterSelectedValue)) {

              
                wc.iAND(InventorySerialTable.SerDetailNo, BaseFilter.ComparisonOperator.Less_Than_Or_Equal, SerDetailNoToFilterSelectedValue, false, false);
      ...
      String SerPartNoFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "SerPartNoFilter_Ajax"];
            if (MiscUtils.IsValueSelected(SerPartNoFilterSelectedValue)) {
                ...
                wc.iAND(InventorySerialTable.SerPartNo, BaseFilter.ComparisonOperator.EqualsTo, SerPartNoFilterSelectedValue, false, false);
            ...
            foreach (InventorySerialRecord rec in recordList ){
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, InventorySerialTable.SerFormType.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, InventorySerialTable.SerPartNo.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, InventorySerialTable.SerSerialNo.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (!this.ResetData)
            {
              System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "InventorySerialTableControlRepeater"));
              if (rep == null){return;}
              InventorySerialTableControlRow[] recControls = this.GetRecordControls();
                foreach (InventorySerialTableControlRow recControl in recControls) 
		{
      ...
      InventorySerialRecord rec = new InventorySerialRecord();
        ...
        public virtual void SetSerPartNoFilter()
        {
            ...
            this.PopulateSerPartNoFilter(MiscUtils.GetSelectedValue(this.SerPartNoFilter,  GetFromSession(this.SerPartNoFilter)), 500);					
        ...
        protected virtual void PopulateSerPartNoFilter(string selectedValue, int maxItems)
                    
        {
            ...
            // Setup the static list items        
                ...
                // Add the All item.
                this.SerPartNoFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.SerPartNoFilter, selectedValue);
            ...
            if (this.SerPartNoFilter.SelectedValue != null && this.SerPartNoFilter.Items.FindByValue(this.SerPartNoFilter.SelectedValue) == null)
                this.SerPartNoFilter.SelectedValue = null;
        ...
        public virtual WhereClause CreateWhereClause_SerPartNoFilter()
        {
            ...
            // in the SerPartNoFilterDropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.SerDetailNoFromFilter, this.SerDetailNoFromFilter.Text);
                  
            this.SaveToSession(this.SerDetailNoToFilter, this.SerDetailNoToFilter.Text);
                  
            this.SaveToSession(this.SerPartNoFilter, this.SerPartNoFilter.SelectedValue);
      ...
      this.SaveToSession("SerDetailNoFromFilter_Ajax", this.SerDetailNoFromFilter.Text);
              
      this.SaveToSession("SerDetailNoToFilter_Ajax", this.SerDetailNoToFilter.Text);
              
      this.SaveToSession("SerPartNoFilter_Ajax", this.SerPartNoFilter.SelectedValue);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.SerDetailNoFromFilter);
            this.RemoveFromSession(this.SerDetailNoToFilter);
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox SerDetailNoFromFilter {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "SerDetailNoFromFilter");
            }
        }
        ...
        public System.Web.UI.WebControls.TextBox SerDetailNoToFilter {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "SerDetailNoToFilter");
            }
        }
        
        public System.Web.UI.WebControls.DropDownList SerPartNoFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "SerPartNoFilter");
            }
        }
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (InventorySerialTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        InventorySerialTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual InventorySerialTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (InventorySerialTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Show_InventorySerial_Table_Mobile.InventorySerialTableControlRow")));
