...
// Edit_InventorySerial_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_InventorySerial_Table
{
...
// Base class for the InventorySerialTableControlRow control on the Edit_InventorySerial_Table page.
...
public class BaseInventorySerialTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetSerDetailNo()
        {
            ...
            if (this.PreviousUIData.ContainsKey(this.SerDetailNo.ID))
            {
            
                this.SerDetailNo.Text = this.PreviousUIData[this.SerDetailNo.ID].ToString();
        ...
        public virtual void SetSerFormNo()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.SerFormNo.ID))
            {
            
                this.SerFormNo.Text = this.PreviousUIData[this.SerFormNo.ID].ToString();
        ...
        public virtual void SetSerFormType()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.SerFormType.ID))
            {
            
                this.SerFormType.Text = this.PreviousUIData[this.SerFormType.ID].ToString();
        ...
        public virtual void SetSerLocation()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.SerLocation.ID))
            {
            
                this.SerLocation.Text = this.PreviousUIData[this.SerLocation.ID].ToString();
        ...
        public virtual void SetSerPartNo()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.SerPartNo.ID))
            {
            
                this.SerPartNo.Text = this.PreviousUIData[this.SerPartNo.ID].ToString();
        ...
        public virtual void SetSerSerialNo()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.SerSerialNo.ID))
            {
            
                this.SerSerialNo.Text = this.PreviousUIData[this.SerSerialNo.ID].ToString();
      ...
      // To customize, override this method in InventorySerialTableControlRow.
        ...
        InventorySerialTableControl tc= ((InventorySerialTableControl)MiscUtils.GetParentControlObject(this, "InventorySerialTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((InventorySerialTableControlRow)this);
                    }
                    this.Visible = false;
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../InventorySerial/Show-InventorySerial.aspx?InventorySerial={PK}";
...
// Base class for the InventorySerialTableControl control on the Edit_InventorySerial_Table page.
    ...
    // Setup default pagination settings.
      ...
      InventorySerialRecord rec = new InventorySerialRecord();
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("InventorySerialTableControlRepeater");
...
#region "Helper Functions"
        ...
        public virtual InventorySerialTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (InventorySerialTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_InventorySerial_Table.InventorySerialTableControlRow")));
