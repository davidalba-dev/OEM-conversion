...
// Edit_Budget.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Budget
{
...
// Base class for the BudgetRecordControl control on the Edit_Budget page.
...
public class BaseBudgetRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "BudgetRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            this.DataSource = BudgetTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public virtual void Setcontract_id()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = BudgetTable.contract_id.DefaultValue;
      ...
      // To customize, override this method in BudgetRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Budget"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "Budget"));
            }
            HttpContext.Current.Session["QueryString in Edit-Budget"] = recId;
