...
// Add_Equipment_inventory_comment.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Equipment_inventory_comment
{
...
// Base class for the Equipment_inventory_commentRecordControl control on the Add_Equipment_inventory_comment page.
...
public class BaseEquipment_inventory_commentRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setcomment_datetime()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
              ...
              this.comment_datetime.Text = EvaluateFormula("Now()", this.DataSource, @"g");
        ...
        public virtual void Setequipment_inventory_id()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
              ...
              this.equipment_inventory_id.Text = EvaluateFormula("URL(\"Equipment_id\")", this.DataSource);
        ...
        public virtual void Settechnician_id()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = Equipment_inventory_commentTable.technician_id.DefaultValue;
        ...
        public virtual void Gettechnician_id()
        {
         // Retrieve the value entered by the user on the technician_id ASP:DropDownList, and
            ...
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.technician_id), Equipment_inventory_commentTable.technician_id);			
      ...
      // To customize, override this method in Equipment_inventory_commentRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Add-Equipment-inventory-comment"] = recId;
