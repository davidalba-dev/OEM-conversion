...
// Show_Equipment_inventory_comment_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Equipment_inventory_comment_Mobile
{
...
// Base class for the Equipment_inventory_commentRecordControl control on the Show_Equipment_inventory_comment_Mobile page.
...
public class BaseEquipment_inventory_commentRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setequipment_inventory_id()
        {
            ...
            // Set the equipment_inventory_id Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.equipment_inventory_comment database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.equipment_inventory_comment record retrieved from the database.
            // this.equipment_inventory_id is the ASP:Literal on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.equipment_inventory_idSpecified) {
               ...
               Boolean _isExpandableNonCompositeForeignKey = Equipment_inventory_commentTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Equipment_inventory_commentTable.equipment_inventory_id);
               if(_isExpandableNonCompositeForeignKey &&Equipment_inventory_commentTable.equipment_inventory_id.IsApplyDisplayAs)
                                  
                     formattedValue = Equipment_inventory_commentTable.GetDFKA(this.DataSource.equipment_inventory_id.ToString(),Equipment_inventory_commentTable.equipment_inventory_id, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(Equipment_inventory_commentTable.equipment_inventory_id);
              ...
              this.equipment_inventory_id.Text = Equipment_inventory_commentTable.equipment_inventory_id.Format(Equipment_inventory_commentTable.equipment_inventory_id.DefaultValue);
            		
            }
            
            // If the equipment_inventory_id is NULL or blank, then use the value specified  
            // on Properties.
            if (this.equipment_inventory_id.Text == null ||
                this.equipment_inventory_id.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.equipment_inventory_id.Text = "&nbsp;";
            }
        ...
        public virtual void Settechnician_id()
        {
            ...
            if (this.DataSource != null && this.DataSource.technician_idSpecified) {
              ...
              this.technician_id.Text = Equipment_inventory_commentTable.technician_id.Format(Equipment_inventory_commentTable.technician_id.DefaultValue);
      ...
      // To customize, override this method in Equipment_inventory_commentRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-Equipment-inventory-comment-Mobile"] = recId;
      ...
      this.Page.RedirectBack();
        ...
        public virtual void EditButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../equipment_inventory_comment/Edit-Equipment-inventory-comment-Mobile.aspx?Equipment_inventory_comment={PK}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal equipment_inventory_id {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "equipment_inventory_id");
            }
        }
