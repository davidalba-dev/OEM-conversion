...
// Edit_Equipment_inventory_batch_barcode.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Equipment_inventory_batch_barcode
{
...
// Base class for the Equipment_inventory_batch_detailTableControlRow control on the Edit_Equipment_inventory_batch_barcode page.
...
public class BaseEquipment_inventory_batch_detailTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setmake()
        {
            ...
            this.PopulatemakeDropDownList(selectedValue, 500);              
        ...
        public virtual void Setmodel()
        {
            ...
            this.PopulatemodelDropDownList(selectedValue, 500);              
      ...
      // To customize, override this method in Equipment_inventory_batch_detailTableControlRow.
        ...
        public virtual WhereClause CreateWhereClause_modelDropDownList() 
        {
            ...
            if (EvaluateFormula("1", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.MakesModelsTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"MakesModels_.makesmodels_active"), EvaluateFormula("1", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
            if (EvaluateFormula("Equipment_inventory_batch_detailTableControlRow.make.SelectedValue", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.MakesModelsTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"MakesModels_.Make"), EvaluateFormula("Equipment_inventory_batch_detailTableControlRow.make.SelectedValue", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("1", false) == "--PLEASE_SELECT--" || EvaluateFormula("1", false) == "--ANY--") whereClause.RunQuery = false;
         if (EvaluateFormula("Equipment_inventory_batch_detailTableControlRow.make.SelectedValue", false) == "--PLEASE_SELECT--" || EvaluateFormula("Equipment_inventory_batch_detailTableControlRow.make.SelectedValue", false) == "--ANY--") whereClause.RunQuery = false;
        ...
        protected virtual void PopulatemakeDropDownList(string selectedValue, int maxItems) 
        {
            ...
            if (wc.RunQuery)
            {
                foreach (string itemValue in Equipment_inventory_batch_detailTable.GetValues(Equipment_inventory_batch_detailTable.make, wc, orderBy, maxItems)) {
                    // Create the dropdown list item and add it to the list.
                    string fvalue = Equipment_inventory_batch_detailTable.make.Format(itemValue);
                ...
                !MiscUtils.SetSelectedDisplayText(this.make, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        Boolean _isExpandableNonCompositeForeignKey = Equipment_inventory_batch_detailTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Equipment_inventory_batch_detailTable.make);
                        if(_isExpandableNonCompositeForeignKey && Equipment_inventory_batch_detailTable.make.IsApplyDisplayAs)
                            fvalue = Equipment_inventory_batch_detailTable.GetDFKA(itemValue, Equipment_inventory_batch_detailTable.make);
                        if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
        ...
        protected virtual void PopulatemodelDropDownList(string selectedValue, int maxItems) 
        {
            ...
            if (wc.RunQuery)
            {
                foreach (string itemValue in Equipment_inventory_batch_detailTable.GetValues(Equipment_inventory_batch_detailTable.model, wc, orderBy, maxItems)) {
                    // Create the dropdown list item and add it to the list.
                    string fvalue = Equipment_inventory_batch_detailTable.model.Format(itemValue);
                    if (fvalue == null || fvalue.Trim() == "") fvalue = itemValue;				
                ...
                !MiscUtils.SetSelectedDisplayText(this.model, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        Boolean _isExpandableNonCompositeForeignKey = Equipment_inventory_batch_detailTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Equipment_inventory_batch_detailTable.model);
                        if(_isExpandableNonCompositeForeignKey && Equipment_inventory_batch_detailTable.model.IsApplyDisplayAs)
                            fvalue = Equipment_inventory_batch_detailTable.GetDFKA(itemValue, Equipment_inventory_batch_detailTable.model);
                        if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
...
// Base class for the Equipment_inventory_batch_detailTableControl control on the Edit_Equipment_inventory_batch_barcode page.
...
#region "Helper Functions"
        ...
        public virtual Equipment_inventory_batch_detailTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Equipment_inventory_batch_detailTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_Equipment_inventory_batch_barcode.Equipment_inventory_batch_detailTableControlRow")));
...
// Base class for the Equipment_inventory_batch_detailTableControl1Row control on the Edit_Equipment_inventory_batch_barcode page.
...
public class BaseEquipment_inventory_batch_detailTableControl1Row : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.condition_id1.SelectedIndexChanged += condition_id1_SelectedIndexChanged;
              ...
              this.make1.SelectedIndexChanged += make1_SelectedIndexChanged;
            
              this.model1.SelectedIndexChanged += model1_SelectedIndexChanged;
            
              this.accepted1.CheckedChanged += accepted1_CheckedChanged;
            
              this.accessories1.CheckedChanged += accessories1_CheckedChanged;
            
              this.oem_barcode_approve1.CheckedChanged += oem_barcode_approve1_CheckedChanged;
            
              this.phi1.CheckedChanged += phi1_CheckedChanged;
            
              this.comment1.TextChanged += comment1_TextChanged;
            
              this.EIN1.TextChanged += EIN1_TextChanged;
            
              this.purchase_price1.TextChanged += purchase_price1_TextChanged;
        ...
        public virtual void Setaccepted1()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.accepted1.ID))
            {
                this.accepted1.Checked = Convert.ToBoolean(this.PreviousUIData[this.accepted1.ID]);
                return;
            }	
            ...
            if (this.DataSource != null && this.DataSource.acceptedSpecified) {
                ...
                // Default Value could also be NULL.
                if (!this.DataSource.IsCreated) 
                    this.accepted1.Checked = Equipment_inventory_batch_detailTable.accepted.ParseValue(Equipment_inventory_batch_detailTable.accepted.DefaultValue).ToBoolean();                
        ...
        public virtual void Setaccessories1()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.accessories1.ID))
            {
                this.accessories1.Checked = Convert.ToBoolean(this.PreviousUIData[this.accessories1.ID]);
                return;
            }	
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.equipment_inventory_batch_detail record retrieved from the database.
            // this.accessories1 is the ASP:CheckBox on the webpage.
                  
            if (this.DataSource != null && this.DataSource.accessoriesSpecified) {
                							
                // If the accessories is non-NULL, then format the value.
                // The Format method will use the Display Format
                this.accessories1.Checked = this.DataSource.accessories;
                ...
                // Default Value could also be NULL.
                if (!this.DataSource.IsCreated) 
                    this.accessories1.Checked = Equipment_inventory_batch_detailTable.accessories.ParseValue(Equipment_inventory_batch_detailTable.accessories.DefaultValue).ToBoolean();                
        ...
        public virtual void Setcondition_id1()
        {
            ...
            // If selection was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.condition_id1.ID))
            {
                if (this.PreviousUIData[this.condition_id1.ID] == null)
                    selectedValue = null;
                else
                    selectedValue = this.PreviousUIData[this.condition_id1.ID].ToString();
            }
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.equipment_inventory_batch_detail record retrieved from the database.
            // this.condition_id1 is the ASP:DropDownList on the webpage.
            
            // You can modify this method directly, or replace it with a call to
            //     base.Setcondition_id1();
            // and add your own custom code before or after the call to the base function.
            ...
            this.Populatecondition_id1DropDownList(selectedValue, 100);              
        ...
        public virtual void SetEIN1()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.EIN1.ID))
            {
            
                this.EIN1.Text = this.PreviousUIData[this.EIN1.ID].ToString();
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.equipment_inventory_batch_detail record retrieved from the database.
            // this.EIN1 is the ASP:TextBox on the webpage.
        ...
        public virtual void Setmake1()
        {
            ...
            // Set AutoPostBack to true so that when the control value is changed, to refresh model1 controls
            this.make1.AutoPostBack = true;
            ...
            // If selection was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.make1.ID))
            {
                if (this.PreviousUIData[this.make1.ID] == null)
                    selectedValue = null;
                else
                    selectedValue = this.PreviousUIData[this.make1.ID].ToString();
            }
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.equipment_inventory_batch_detail record retrieved from the database.
            // this.make1 is the ASP:DropDownList on the webpage.
            ...
            this.Populatemake1DropDownList(selectedValue, 500);              
        ...
        public virtual void Setmodel1()
        {
            ...
            // If selection was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.model1.ID))
            {
                if (this.PreviousUIData[this.model1.ID] == null)
                    selectedValue = null;
                else
                    selectedValue = this.PreviousUIData[this.model1.ID].ToString();
            }
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.equipment_inventory_batch_detail record retrieved from the database.
            // this.model1 is the ASP:DropDownList on the webpage.
            ...
            this.Populatemodel1DropDownList(selectedValue, 500);              
        ...
        public virtual void Setoem_barcode_approve1()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.oem_barcode_approve1.ID))
            {
                this.oem_barcode_approve1.Checked = Convert.ToBoolean(this.PreviousUIData[this.oem_barcode_approve1.ID]);
                return;
            }	
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.equipment_inventory_batch_detail record retrieved from the database.
            // this.oem_barcode_approve1 is the ASP:CheckBox on the webpage.
                  
            if (this.DataSource != null && this.DataSource.oem_barcode_approveSpecified) {
                							
                // If the oem_barcode_approve is non-NULL, then format the value.
                // The Format method will use the Display Format
                this.oem_barcode_approve1.Checked = this.DataSource.oem_barcode_approve;
                ...
                // Default Value could also be NULL.
                if (!this.DataSource.IsCreated) 
                    this.oem_barcode_approve1.Checked = Equipment_inventory_batch_detailTable.oem_barcode_approve.ParseValue(Equipment_inventory_batch_detailTable.oem_barcode_approve.DefaultValue).ToBoolean();                
        ...
        public virtual void Setphi1()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.phi1.ID))
            {
                this.phi1.Checked = Convert.ToBoolean(this.PreviousUIData[this.phi1.ID]);
                return;
            }	
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.equipment_inventory_batch_detail record retrieved from the database.
            // this.phi1 is the ASP:CheckBox on the webpage.
                  
            if (this.DataSource != null && this.DataSource.phiSpecified) {
                							
                // If the phi is non-NULL, then format the value.
                // The Format method will use the Display Format
                this.phi1.Checked = this.DataSource.phi;
                ...
                // Default Value could also be NULL.
                if (!this.DataSource.IsCreated) 
                    this.phi1.Checked = Equipment_inventory_batch_detailTable.phi.ParseValue(Equipment_inventory_batch_detailTable.phi.DefaultValue).ToBoolean();                
        ...
        public virtual void Setpurchase_price1()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.purchase_price1.ID))
            {
            
                this.purchase_price1.Text = this.PreviousUIData[this.purchase_price1.ID].ToString();
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.equipment_inventory_batch_detail record retrieved from the database.
            // this.purchase_price1 is the ASP:TextBox on the webpage.
        ...
        {	
            ...
            this.DataSource.accepted = this.accepted1.Checked;						
        ...
        {	
            ...
            this.DataSource.accessories = this.accessories1.Checked;						
        ...
        public virtual void Getcomment1()
        {
            ...
            // Save the value to data source
            this.DataSource.Parse(this.comment1.Text, Equipment_inventory_batch_detailTable.comment);							
        ...
        public virtual void Getcondition_id1()
        {
         // Retrieve the value entered by the user on the condition_id ASP:DropDownList, and
            ...
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.condition_id1), Equipment_inventory_batch_detailTable.condition_id);			
        ...
        public virtual void GetEIN1()
        {
            ...
            // Save the value to data source
            this.DataSource.Parse(this.EIN1.Text, Equipment_inventory_batch_detailTable.EIN);							
        ...
        public virtual void Getmake1()
        {
         // Retrieve the value entered by the user on the make ASP:DropDownList, and
            ...
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.make1), Equipment_inventory_batch_detailTable.make);			
        ...
        public virtual void Getmodel1()
        {
         // Retrieve the value entered by the user on the model ASP:DropDownList, and
            ...
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.model1), Equipment_inventory_batch_detailTable.model);			
        ...
        {	
            ...
            this.DataSource.oem_barcode_approve = this.oem_barcode_approve1.Checked;						
        ...
        {	
            ...
            this.DataSource.phi = this.phi1.Checked;						
        ...
        public virtual void Getpurchase_price1()
        {
            ...
            // Save the value to data source
            this.DataSource.Parse(this.purchase_price1.Text, Equipment_inventory_batch_detailTable.purchase_price);							
        ...
        public virtual void Getserial_number1()
        {
            ...
            // Save the value to data source
            this.DataSource.Parse(this.serial_number1.Text, Equipment_inventory_batch_detailTable.serial_number);							
      ...
      // To customize, override this method in Equipment_inventory_batch_detailTableControl1Row.
        ...
        public virtual WhereClause CreateWhereClause_condition_id1DropDownList() 
        {
            // By default, we simply return a new WhereClause.
            // Add additional where clauses to restrict the items shown in the dropdown list.
        ...
        public virtual WhereClause CreateWhereClause_make1DropDownList() 
        {
            // By default, we simply return a new WhereClause.
            // Add additional where clauses to restrict the items shown in the dropdown list.
        ...
        public virtual WhereClause CreateWhereClause_model1DropDownList() 
        {
            // By default, we simply return a new WhereClause.
            // Add additional where clauses to restrict the items shown in the dropdown list.
            ...
            if (EvaluateFormula("1", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.MakesModelsTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"MakesModels_.makesmodels_active"), EvaluateFormula("1", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
            if (EvaluateFormula("Equipment_inventory_batch_detailTableControl1Row.make1.SelectedValue", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.MakesModelsTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"MakesModels_.Make"), EvaluateFormula("Equipment_inventory_batch_detailTableControl1Row.make1.SelectedValue", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("1", false) == "--PLEASE_SELECT--" || EvaluateFormula("1", false) == "--ANY--") whereClause.RunQuery = false;
         if (EvaluateFormula("Equipment_inventory_batch_detailTableControl1Row.make1.SelectedValue", false) == "--PLEASE_SELECT--" || EvaluateFormula("Equipment_inventory_batch_detailTableControl1Row.make1.SelectedValue", false) == "--ANY--") whereClause.RunQuery = false;
        ...
        // Fill the condition_id1 list.
        protected virtual void Populatecondition_id1DropDownList(string selectedValue, int maxItems) 
        {
            		  					                
            this.condition_id1.Items.Clear();
            
            // 1. Setup the static list items        
            
              // Add the Please Select item.
              this.condition_id1.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "OEMConversion"), "--PLEASE_SELECT--"));
            		  			
            // 2. Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_condition_id1DropDownList function.
            // It is better to customize the where clause there.
            
                      
            WhereClause wc = CreateWhereClause_condition_id1DropDownList();
            ...
            // 3. Read a total of maxItems from the database and insert them into the condition_id1DropDownList.
            ConditionsRecord[] itemValues  = null;
            if (wc.RunQuery)
            {
                int counter = 0;
                ...
                do
                {
                    ...
                    foreach (ConditionsRecord itemValue in itemValues) 
                    {
                        ...
                        {
                            cvalue = itemValue.Condition.ToString();
                            if (counter < maxItems && this.condition_id1.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                ListItem dupItem = this.condition_id1.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.condition_id1.Items.Add(newItem);
            ...
            if (selectedValue != null &&
                selectedValue.Trim() != "" &&
                !MiscUtils.SetSelectedValue(this.condition_id1, selectedValue) &&
                !MiscUtils.SetSelectedDisplayText(this.condition_id1, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        if (fvalue == null || fvalue.Trim() == "") fvalue = cvalue;
                        MiscUtils.ResetSelectedItem(this.condition_id1, new ListItem(fvalue, cvalue));                      
                    }
                }
                catch
                {
        ...
        // Fill the make1 list.
        protected virtual void Populatemake1DropDownList(string selectedValue, int maxItems) 
        {
            		  					                
            this.make1.Items.Clear();
            
            // 1. Setup the static list items        
            
              // Add the Please Select item.
              this.make1.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "OEMConversion"), "--PLEASE_SELECT--"));
            		  			
            // 2. Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_make1DropDownList function.
            // It is better to customize the where clause there.
            
                      
            WhereClause wc = CreateWhereClause_make1DropDownList();
            ...
            if (wc.RunQuery)
            {
                foreach (string itemValue in Equipment_inventory_batch_detailTable.GetValues(Equipment_inventory_batch_detailTable.make, wc, orderBy, maxItems)) {
                    ...
                    ListItem dupItem = this.make1.Items.FindByText(fvalue);
            ...
            if (selectedValue != null &&
                selectedValue.Trim() != "" &&
                !MiscUtils.SetSelectedValue(this.make1, selectedValue) &&
                !MiscUtils.SetSelectedDisplayText(this.make1, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        if (fvalue == null || fvalue.Trim() == "") fvalue = cvalue;
                        MiscUtils.ResetSelectedItem(this.make1, new ListItem(fvalue, cvalue));                      
                    }
                }
                catch
                {
        ...
        // Fill the model1 list.
        protected virtual void Populatemodel1DropDownList(string selectedValue, int maxItems) 
        {
            		  					                
            this.model1.Items.Clear();
            
            // 1. Setup the static list items        
            
              // Add the Please Select item.
              this.model1.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "OEMConversion"), "--PLEASE_SELECT--"));
            		  			
            // 2. Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_model1DropDownList function.
            // It is better to customize the where clause there.
            
                      
            WhereClause wc = CreateWhereClause_model1DropDownList();
            ...
            if (wc.RunQuery)
            {
                foreach (string itemValue in Equipment_inventory_batch_detailTable.GetValues(Equipment_inventory_batch_detailTable.model, wc, orderBy, maxItems)) {
                    ...
                    ListItem dupItem = this.model1.Items.FindByText(fvalue);
            ...
            if (selectedValue != null &&
                selectedValue.Trim() != "" &&
                !MiscUtils.SetSelectedValue(this.model1, selectedValue) &&
                !MiscUtils.SetSelectedDisplayText(this.model1, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        if (fvalue == null || fvalue.Trim() == "") fvalue = cvalue;
                        MiscUtils.ResetSelectedItem(this.model1, new ListItem(fvalue, cvalue));                      
                    }
                }
                catch
                {
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void condition_id1_SelectedIndexChanged(object sender, EventArgs args)
        {
            // for the value inserted by quick add button or large list selector, 
            // the value is necessary to be inserted by this event during postback 
            string val = (string)(this.Page.Session[condition_id1.ClientID + "_SelectedValue"]);
            string displayText = (string)(this.Page.Session[condition_id1.ClientID + "_SelectedDisplayText"]);
            if (!string.IsNullOrEmpty(displayText) && !string.IsNullOrEmpty(val)) {
	            this.condition_id1.Items.Add(new ListItem(displayText, val));
	            this.condition_id1.SelectedIndex = this.condition_id1.Items.Count - 1;
	            this.Page.Session.Remove(condition_id1.ClientID + "_SelectedValue");
	            this.Page.Session.Remove(condition_id1.ClientID + "_SelectedDisplayText");
            }
        ...
        protected virtual void make1_SelectedIndexChanged(object sender, EventArgs args)
        {
            // for the value inserted by quick add button or large list selector, 
            // the value is necessary to be inserted by this event during postback 
            string val = (string)(this.Page.Session[make1.ClientID + "_SelectedValue"]);
            string displayText = (string)(this.Page.Session[make1.ClientID + "_SelectedDisplayText"]);
            if (!string.IsNullOrEmpty(displayText) && !string.IsNullOrEmpty(val)) {
	            this.make1.Items.Add(new ListItem(displayText, val));
	            this.make1.SelectedIndex = this.make1.Items.Count - 1;
	            this.Page.Session.Remove(make1.ClientID + "_SelectedValue");
	            this.Page.Session.Remove(make1.ClientID + "_SelectedDisplayText");
            }
        ...
        protected virtual void model1_SelectedIndexChanged(object sender, EventArgs args)
        {
            // for the value inserted by quick add button or large list selector, 
            // the value is necessary to be inserted by this event during postback 
            string val = (string)(this.Page.Session[model1.ClientID + "_SelectedValue"]);
            string displayText = (string)(this.Page.Session[model1.ClientID + "_SelectedDisplayText"]);
            if (!string.IsNullOrEmpty(displayText) && !string.IsNullOrEmpty(val)) {
	            this.model1.Items.Add(new ListItem(displayText, val));
	            this.model1.SelectedIndex = this.model1.Items.Count - 1;
	            this.Page.Session.Remove(model1.ClientID + "_SelectedValue");
	            this.Page.Session.Remove(model1.ClientID + "_SelectedDisplayText");
            }
           						
        }
            
        protected virtual void accepted1_CheckedChanged(object sender, EventArgs args)
        {
           						
        }
            
        protected virtual void accessories1_CheckedChanged(object sender, EventArgs args)
        {
           						
        }
            
        protected virtual void oem_barcode_approve1_CheckedChanged(object sender, EventArgs args)
        {
           						
        }
            
        protected virtual void phi1_CheckedChanged(object sender, EventArgs args)
        {
        ...
        protected virtual void EIN1_TextChanged(object sender, EventArgs args)
        {
                    
              }
            
        protected virtual void purchase_price1_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.CheckBox accepted1 {
            get {
                return (System.Web.UI.WebControls.CheckBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "accepted1");
            }
        }
            
        public System.Web.UI.WebControls.CheckBox accessories1 {
            get {
                return (System.Web.UI.WebControls.CheckBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "accessories1");
            }
        }
        ...
        public System.Web.UI.WebControls.DropDownList condition_id1 {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "condition_id1");
            }
        }
        ...
        public System.Web.UI.WebControls.TextBox EIN1 {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "EIN1");
            }
        }
        ...
        public System.Web.UI.WebControls.DropDownList make1 {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "make1");
            }
        }
            
        public System.Web.UI.WebControls.DropDownList model1 {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "model1");
            }
        }
            
        public System.Web.UI.WebControls.CheckBox oem_barcode_approve1 {
            get {
                return (System.Web.UI.WebControls.CheckBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "oem_barcode_approve1");
            }
        }
            
        public System.Web.UI.WebControls.CheckBox phi1 {
            get {
                return (System.Web.UI.WebControls.CheckBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "phi1");
            }
        }
            
        public System.Web.UI.WebControls.TextBox purchase_price1 {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "purchase_price1");
            }
        }
...
// Base class for the Equipment_inventory_batch_detailTableControl1 control on the Edit_Equipment_inventory_batch_barcode page.
...
public class BaseEquipment_inventory_batch_detailTableControl1 : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    Equipment_inventory_batchRecordControl equipment_inventory_batchRecordControlObj = (MiscUtils.GetParentControlObject(this, "Equipment_inventory_batchRecordControl") as Equipment_inventory_batchRecordControl);
      ...
      Equipment_inventory_batch_detailRecord rec = new Equipment_inventory_batch_detailRecord();
                        ...
                        rec.accepted = recControl.accepted1.Checked;
                
                        rec.accessories = recControl.accessories1.Checked;
                
                        if (recControl.comment1.Text != "") {
                            rec.Parse(recControl.comment1.Text, Equipment_inventory_batch_detailTable.comment);
                  }
                
                        if (MiscUtils.IsValueSelected(recControl.condition_id1)) {
                            rec.Parse(recControl.condition_id1.SelectedItem.Value, Equipment_inventory_batch_detailTable.condition_id);
                        }
                        ...
                        if (MiscUtils.IsValueSelected(recControl.make1)) {
                            rec.Parse(recControl.make1.SelectedItem.Value, Equipment_inventory_batch_detailTable.make);
                        }
                        if (MiscUtils.IsValueSelected(recControl.model1)) {
                            rec.Parse(recControl.model1.SelectedItem.Value, Equipment_inventory_batch_detailTable.model);
                        }
                        rec.oem_barcode_approve = recControl.oem_barcode_approve1.Checked;
                
                        rec.phi = recControl.phi1.Checked;
...
#region "Helper Functions"
        ...
        public virtual Equipment_inventory_batch_detailTableControl1Row[] GetSelectedRecordControls()
        {
            ...
            return (Equipment_inventory_batch_detailTableControl1Row[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_Equipment_inventory_batch_barcode.Equipment_inventory_batch_detailTableControl1Row")));
...
// Base class for the Equipment_inventory_batchRecordControl control on the Edit_Equipment_inventory_batch_barcode page.
...
public class BaseEquipment_inventory_batchRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in Equipment_inventory_batchRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Edit-Equipment-inventory-batch-barcode"] = recId;
...
// Base class for the Max_customerRecordControl control on the Edit_Equipment_inventory_batch_barcode page.
