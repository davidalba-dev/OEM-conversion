...
// Equipment_inventory_batch_customer.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Equipment_inventory_batch_customer
{
...
// Base class for the Equipment_inventory_batch_detailTableControlRow control on the Equipment_inventory_batch_customer page.
        ...
        public virtual string EvaluateFormula(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS, FormulaEvaluator e)
        {
            ...
            if (includeDS)
            {
                ...
                // add datasource as variables for formula evaluation
                  Equipment_inventory_batch_detailTableControl panel;
                panel = (Equipment_inventory_batch_detailTableControl)(this.GetParentTableControl());
                  
                e.Variables.Add("Equipment_inventory_batch_detailCountQuery", panel.Equipment_inventory_batch_detailCountQuery);                                                       
                        
                e.Variables.Add("Equipment_inventory_batchCountQuery", panel.Equipment_inventory_batchCountQuery);                                                       
...
// Base class for the Equipment_inventory_batch_detailTableControl control on the Equipment_inventory_batch_customer page.
    ...
    // Setup default pagination settings.
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
                  ...
                  LoadData_Equipment_inventory_batch_detailCountQuery();
       
                  LoadData_Equipment_inventory_batchCountQuery();
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetEINLabel();
                SetEINLabel2();
                SetEquipment_inventory_batch_detailCountControl();
        ...
        public virtual void RegisterPostback()
        {
          ...
          public virtual string EvaluateFormula(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS, FormulaEvaluator e)
          {
            ...
            if (includeDS)
            {
                ...
                if (Equipment_inventory_batch_detailCountQuery != null) e.Variables.Add("Equipment_inventory_batch_detailCountQuery", Equipment_inventory_batch_detailCountQuery);                                                       
                    
                if (Equipment_inventory_batchCountQuery != null) e.Variables.Add("Equipment_inventory_batchCountQuery", Equipment_inventory_batchCountQuery);                                                       
      ...
      Equipment_inventory_batch_detailRecord rec = new Equipment_inventory_batch_detailRecord();
        ...
        public virtual void SetEquipment_inventory_batch_detailCountControl()
                  {
                  
                        this.Equipment_inventory_batch_detailCountControl.Text = EvaluateFormula("LOOKUP(Equipment_inventory_batch_detailCountQuery, \"\")");
        ...
        public virtual WhereClause CreateWhereClause_Equipment_inventory_batch_detailCountQuery()
        
        {
            ...
            WhereClause qc = this.CreateQueryClause_Equipment_inventory_batch_detailCountQuery();
            if (qc != null) {
                wc.iAND(qc);
            }
        ...
        public virtual WhereClause CreateWhereClause_Equipment_inventory_batchCountQuery()
        ...
        public virtual WhereClause CreateQueryClause_Equipment_inventory_batch_detailCountQuery()
        
        {
            ...
            if (EvaluateFormula("URL(\"equipment_inventory_batch\")", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Equipment_inventory_batch_detailTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"equipment_inventory_batch_detail_.equipment_inventory_batch_id"), EvaluateFormula("URL(\"equipment_inventory_batch\")", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
            if (EvaluateFormula("1", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Equipment_inventory_batch_detailTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"equipment_inventory_batch_detail_.accepted"), EvaluateFormula("1", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("URL(\"equipment_inventory_batch\")", false) == "--PLEASE_SELECT--" || EvaluateFormula("URL(\"equipment_inventory_batch\")", false) == "--ANY--") whereClause.RunQuery = false;
        ...
        public virtual void LoadData_Equipment_inventory_batch_detailCountQuery()
        
        {
          
              if (!(this.ResetData || this.DataChanged || _Equipment_inventory_batch_detailCountQuery.DataChanged) && this.Page.IsPostBack  && this.Page.Request["__EVENTTARGET"] != "isd_geo_location") return;
        
              _Equipment_inventory_batch_detailCountQuery.DataChanged = true;
          
              this._Equipment_inventory_batch_detailCountQuery.Initialize("Equipment_inventory_batch_detailCountQuery", Equipment_inventory_batch_detailTable.Instance, 0, 0);
            
               
              // Add the primary key of the record
              WhereClause wc = CreateWhereClause_Equipment_inventory_batch_detailCountQuery();
              this._Equipment_inventory_batch_detailCountQuery.WhereClause.iAND(wc);                      
          
              // Define selects
          
              this._Equipment_inventory_batch_detailCountQuery.AddSelectItem(new SelectItem(SelectItem.Operation.SUM, new SelectItem(Equipment_inventory_batch_detailTable.purchase_price, Equipment_inventory_batch_detailTable.Instance, false, "", ""), "purchase_priceSum"));
              
              // Define joins if there are any
          
              this._Equipment_inventory_batch_detailCountQuery.AddAggregateOrderBy("purchase_priceSum", OrderByItem.OrderDir.Asc);
              
              this._Equipment_inventory_batch_detailCountQuery.LoadData(false, this._Equipment_inventory_batch_detailCountQuery.PageSize, this._Equipment_inventory_batch_detailCountQuery.PageIndex);                       
                        
        }
      
        public virtual void LoadData_Equipment_inventory_batchCountQuery()
        
        {
          
              if (!(this.ResetData || this.DataChanged || _Equipment_inventory_batchCountQuery.DataChanged) && this.Page.IsPostBack  && this.Page.Request["__EVENTTARGET"] != "isd_geo_location") return;
        
              _Equipment_inventory_batchCountQuery.DataChanged = true;
          
              this._Equipment_inventory_batchCountQuery.Initialize("Equipment_inventory_batchCountQuery", Equipment_inventory_batchTable.Instance, 0, 0);
            
               
              // Add the primary key of the record
              WhereClause wc = CreateWhereClause_Equipment_inventory_batchCountQuery();
              this._Equipment_inventory_batchCountQuery.WhereClause.iAND(wc);                      
          
              // Define selects
          
                    this._Equipment_inventory_batchCountQuery.AddSelectItem(new SelectItem(SelectItem.Operation.COUNT, new SelectItem(SelectItem.ItemType.AllColumns, Equipment_inventory_batchTable.Instance, "Equipment_inventory_batchCount", ""), "Equipment_inventory_batchCount"));
              
              // Define joins if there are any
          
              this._Equipment_inventory_batchCountQuery.LoadData(false, this._Equipment_inventory_batchCountQuery.PageSize, this._Equipment_inventory_batchCountQuery.PageIndex);                       
                        
        }
      
        private DataSource _Equipment_inventory_batch_detailCountQuery = new DataSource();
        public DataSource Equipment_inventory_batch_detailCountQuery
        {
            get
            {
                return _Equipment_inventory_batch_detailCountQuery;
             }
        }
      
        private DataSource _Equipment_inventory_batchCountQuery = new DataSource();
        public DataSource Equipment_inventory_batchCountQuery
        {
            get
            {
                return _Equipment_inventory_batchCountQuery;
             }
        }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal Equipment_inventory_batch_detailCountControl {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Equipment_inventory_batch_detailCountControl");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual Equipment_inventory_batch_detailTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Equipment_inventory_batch_detailTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Equipment_inventory_batch_customer.Equipment_inventory_batch_detailTableControlRow")));
...
// Base class for the Equipment_inventory_batchRecordControl control on the Equipment_inventory_batch_customer page.
...
public class BaseEquipment_inventory_batchRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in Equipment_inventory_batchRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Equipment-inventory-batch-customer"] = recId;
