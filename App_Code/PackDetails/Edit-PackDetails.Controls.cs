...
// Edit_PackDetails.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_PackDetails
{
...
// Base class for the PackDetailsRecordControl control on the Edit_PackDetails page.
...
public class BasePackDetailsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in PackDetailsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Edit-PackDetails"] = recId;
