...
// Show_PackDetails_Table_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_PackDetails_Table_Mobile
{
...
// Base class for the PackDetailsTableControlRow control on the Show_PackDetails_Table_Mobile page.
...
public class BasePackDetailsTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetPackItemDesc()
        {
            ...
            // Set the PackItemDesc Label on the webpage with value from the
            ...
            // this.PackItemDesc is the ASP:Label on the webpage.
      ...
      // To customize, override this method in PackDetailsTableControlRow.
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../PackDetails/Show-PackDetails-Mobile.aspx?PackDetails={PK}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Label PackItemDesc {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PackItemDesc");
            }
        }
...
// Base class for the PackDetailsTableControl control on the Show_PackDetails_Table_Mobile page.
...
public class BasePackDetailsTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep1 = (System.Web.UI.WebControls.Repeater)BaseClasses.Utils.MiscUtils.FindControlRecursively(rep.Items[PageIndex], "PackDetailsTableControlRepeater1");
      ...
      foreach(BaseColumn col in cols)
      {
            ...
            foreach (PackDetailsRecord rec in recordList ){
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, PackDetailsTable.PackPartNo.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (!this.ResetData)
            {
              System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PackDetailsTableControlRepeater"));
              if (rep == null){return;}
              PackDetailsTableControlRow[] recControls = this.GetRecordControls();
                foreach (PackDetailsTableControlRow recControl in recControls) 
		{
...
#region "Helper Functions"
        ...
        public virtual PackDetailsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PackDetailsTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Show_PackDetails_Table_Mobile.PackDetailsTableControlRow")));
