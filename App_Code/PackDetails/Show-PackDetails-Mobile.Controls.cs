...
// Show_PackDetails_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_PackDetails_Mobile
{
...
public class PackDetailsRecordControl : BasePackDetailsRecordControl
{
      
        // The BasePackDetailsRecordControl implements the LoadData, DataBind and other
...
// Base class for the PackDetailsRecordControl control on the Show_PackDetails_Mobile page.
// Do not modify this class. Instead override any method in PackDetailsRecordControl.
public class BasePackDetailsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        public BasePackDetailsRecordControl()
        {
        ...
        // To customize, override this method in PackDetailsRecordControl.
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "PackDetailsRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            PackDetailsRecord[] recList = PackDetailsTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = PackDetailsTable.GetRecord(recList[0].GetID().ToXmlString(), true);
      ...
      // To customize, override this method in PackDetailsRecordControl.
         ...
         
        {
            ...
            bool hasFiltersPackDetailsRecordControl = false;
            hasFiltersPackDetailsRecordControl = hasFiltersPackDetailsRecordControl && false; // suppress warning
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["PackDetails"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "PackDetails"));
            }
            HttpContext.Current.Session["QueryString in Show-PackDetails-Mobile"] = recId;
          ...
          wc.iAND(PackDetailsTable.PackSort, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(PackDetailsTable.PackSort));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(PackDetailsTable.PackSort, BaseFilter.ComparisonOperator.EqualsTo, recId);
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BasePackDetailsRecordControl_Rec"];
            }
            set {
                this.ViewState["BasePackDetailsRecordControl_Rec"] = value;
            }
        }
