...
// Add_PackDetails.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_PackDetails
{
...
// Base class for the PackDetailsRecordControl control on the Add_PackDetails page.
...
public class BasePackDetailsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (PackDetailsRecord)PackDetailsRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in PackDetailsRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["PackDetails"];
            ...
            HttpContext.Current.Session["QueryString in Add-PackDetails"] = recId;
