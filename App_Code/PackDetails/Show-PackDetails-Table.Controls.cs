...
// Show_PackDetails_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_PackDetails_Table
{
...
// Base class for the PackDetailsTableControlRow control on the Show_PackDetails_Table page.
...
public class BasePackDetailsTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetPackItemDesc()
        {
            ...
            // Set the PackItemDesc Literal on the webpage with value from the
            ...
            // this.PackItemDesc is the ASP:Literal on the webpage.
            ...
            // If the PackItemDesc is NULL or blank, then use the value specified  
            // on Properties.
            if (this.PackItemDesc.Text == null ||
                this.PackItemDesc.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.PackItemDesc.Text = "&nbsp;";
            }
        ...
        public virtual void SetPackKey()
        {
            ...
            // Set the PackKey Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.PackDetails database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.PackDetails record retrieved from the database.
            // this.PackKey is the ASP:Literal on the webpage.
            ...
            // If the PackKey is NULL or blank, then use the value specified  
            // on Properties.
            if (this.PackKey.Text == null ||
                this.PackKey.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.PackKey.Text = "&nbsp;";
            }
        ...
        public virtual void SetPackLineType()
        {
            ...
            // Set the PackLineType Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.PackDetails database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.PackDetails record retrieved from the database.
            // this.PackLineType is the ASP:Literal on the webpage.
            ...
            // If the PackLineType is NULL or blank, then use the value specified  
            // on Properties.
            if (this.PackLineType.Text == null ||
                this.PackLineType.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.PackLineType.Text = "&nbsp;";
            }
        ...
        public virtual void SetPackPartNo()
        {
            ...
            // Set the PackPartNo Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.PackDetails database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.PackDetails record retrieved from the database.
            // this.PackPartNo is the ASP:Literal on the webpage.
            ...
            // If the PackPartNo is NULL or blank, then use the value specified  
            // on Properties.
            if (this.PackPartNo.Text == null ||
                this.PackPartNo.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.PackPartNo.Text = "&nbsp;";
            }
        ...
        public virtual void SetPackQuantity()
        {
            ...
            // Set the PackQuantity Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.PackDetails database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.PackDetails record retrieved from the database.
            // this.PackQuantity is the ASP:Literal on the webpage.
            ...
            // If the PackQuantity is NULL or blank, then use the value specified  
            // on Properties.
            if (this.PackQuantity.Text == null ||
                this.PackQuantity.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.PackQuantity.Text = "&nbsp;";
            }
        ...
        public virtual void SetPackSellPrice()
        {
            ...
            // Set the PackSellPrice Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.PackDetails database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.PackDetails record retrieved from the database.
            // this.PackSellPrice is the ASP:Literal on the webpage.
            ...
            // If the PackSellPrice is NULL or blank, then use the value specified  
            // on Properties.
            if (this.PackSellPrice.Text == null ||
                this.PackSellPrice.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.PackSellPrice.Text = "&nbsp;";
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal PackItemDesc {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PackItemDesc");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal PackKey {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PackKey");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal PackLineType {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PackLineType");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal PackPartNo {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PackPartNo");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal PackQuantity {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PackQuantity");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal PackSellPrice {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PackSellPrice");
            }
        }
...
// Base class for the PackDetailsTableControl control on the Show_PackDetails_Table page.
...
public class BasePackDetailsTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                    string url = "../PackDetails/Add-PackDetails.aspx?TabVisible=False&SaveAndNewVisible=False";
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "PackDetailsTableControl_PostbackTracker").ClientID);                           
                                
                string javascriptCall = "";
                
                    javascriptCall = "initializePopupPage(document.getElementById('" + MiscUtils.FindControlRecursively(this, "PackDetailsTableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = PackDetailsTable.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
              
                // Add each of the columns in order of export.
                BaseColumn[] columns = new BaseColumn[] {
                             PackDetailsTable.PackItemDesc,
             PackDetailsTable.PackKey,
             PackDetailsTable.PackLineType,
             PackDetailsTable.PackPartNo,
             PackDetailsTable.PackQuantity,
             PackDetailsTable.PackSellPrice,
             PackDetailsTable.SessionID,
             null};
                ExportDataToCSV exportData = new ExportDataToCSV(PackDetailsTable.Instance,wc,orderBy,columns);
                exportData.StartExport(this.Page.Response, true);

                DataForExport dataForCSV = new DataForExport(PackDetailsTable.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(PackDetailsTable.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(PackDetailsTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(PackDetailsTable.PackItemDesc, "Default"));
             data.ColumnList.Add(new ExcelColumn(PackDetailsTable.PackKey, "0"));
             data.ColumnList.Add(new ExcelColumn(PackDetailsTable.PackLineType, "0"));
             data.ColumnList.Add(new ExcelColumn(PackDetailsTable.PackPartNo, "Default"));
             data.ColumnList.Add(new ExcelColumn(PackDetailsTable.PackQuantity, "Standard"));
             data.ColumnList.Add(new ExcelColumn(PackDetailsTable.PackSellPrice, "Currency"));
             data.ColumnList.Add(new ExcelColumn(PackDetailsTable.SessionID, "0"));
              ...
              {
                val = PackDetailsTable.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-PackDetails-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "PackDetails";
                // If Show-PackDetails-Table.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(PackDetailsTable.PackItemDesc.Name, ReportEnum.Align.Left, "${PackItemDesc}", ReportEnum.Align.Left, 28);
                 report.AddColumn(PackDetailsTable.PackKey.Name, ReportEnum.Align.Right, "${PackKey}", ReportEnum.Align.Right, 15);
                 report.AddColumn(PackDetailsTable.PackLineType.Name, ReportEnum.Align.Right, "${PackLineType}", ReportEnum.Align.Right, 15);
                 report.AddColumn(PackDetailsTable.PackPartNo.Name, ReportEnum.Align.Left, "${PackPartNo}", ReportEnum.Align.Left, 24);
                 report.AddColumn(PackDetailsTable.PackQuantity.Name, ReportEnum.Align.Right, "${PackQuantity}", ReportEnum.Align.Right, 20);
                 report.AddColumn(PackDetailsTable.PackSellPrice.Name, ReportEnum.Align.Right, "${PackSellPrice}", ReportEnum.Align.Right, 20);
                 report.AddColumn(PackDetailsTable.SessionID.Name, ReportEnum.Align.Right, "${SessionID}", ReportEnum.Align.Right, 15);
                ...
                ColumnList columns = PackDetailsTable.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = PackDetailsTable.GetRecordCount(joinFilter,whereClause);
                PackDetailsRecord[] records = null;
                
                do
                {
                    
                    records = PackDetailsTable.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( PackDetailsRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${PackItemDesc}", record.Format(PackDetailsTable.PackItemDesc), ReportEnum.Align.Left, 300);
                             report.AddData("${PackKey}", record.Format(PackDetailsTable.PackKey), ReportEnum.Align.Right, 300);
                             report.AddData("${PackLineType}", record.Format(PackDetailsTable.PackLineType), ReportEnum.Align.Right, 300);
                             report.AddData("${PackPartNo}", record.Format(PackDetailsTable.PackPartNo), ReportEnum.Align.Left, 300);
                             report.AddData("${PackQuantity}", record.Format(PackDetailsTable.PackQuantity), ReportEnum.Align.Right, 300);
                             report.AddData("${PackSellPrice}", record.Format(PackDetailsTable.PackSellPrice), ReportEnum.Align.Right, 300);
                             report.AddData("${SessionID}", record.Format(PackDetailsTable.SessionID), ReportEnum.Align.Right, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-PackDetails-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "PackDetails";
                // If Show-PackDetails-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual PackDetailsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PackDetailsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_PackDetails_Table.PackDetailsTableControlRow")));
