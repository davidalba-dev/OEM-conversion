...
// Pop_Edit_Site_inventory_contract.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Pop_Edit_Site_inventory_contract
{
...
// Base class for the Site_inventory_contractRecordControl control on the Pop_Edit_Site_inventory_contract page.
...
public class BaseSite_inventory_contractRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Getcustno()
        {
         // Retrieve the value entered by the user on the custno ASP:DropDownList, and
            // save it into the custno field in DataSource DatabaseAYS_OEM%dbo.site_inventory_contract record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.custno), Site_inventory_contractTable.custno);			
        ...
        public virtual void Getcustcontactkey()
        {
         // Retrieve the value entered by the user on the custcontactkey ASP:DropDownList, and
            // save it into the custcontactkey field in DataSource DatabaseAYS_OEM%dbo.site_inventory_contract record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.custcontactkey), Site_inventory_contractTable.custcontactkey);			
      ...
      // To customize, override this method in Site_inventory_contractRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Pop-Edit-Site-inventory-contract"] = recId;
        ...
        public virtual WhereClause CreateWhereClause_custcontactkeyDropDownList() 
        {
            ...
            if (EvaluateFormula("Site_inventory_contractRecordControl.custno.SelectedValue", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.CustomerContactsTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"CustomerContacts_.CustNo"), EvaluateFormula("Site_inventory_contractRecordControl.custno.SelectedValue", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("1", false) == "--PLEASE_SELECT--" || EvaluateFormula("1", false) == "--ANY--") whereClause.RunQuery = false;
         if (EvaluateFormula("Site_inventory_contractRecordControl.custno.SelectedValue", false) == "--PLEASE_SELECT--" || EvaluateFormula("Site_inventory_contractRecordControl.custno.SelectedValue", false) == "--ANY--") whereClause.RunQuery = false;
