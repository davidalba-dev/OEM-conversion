...
// Add_Site_inventory_contract.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Site_inventory_contract
{
...
// Base class for the Site_inventory_contractRecordControl control on the Add_Site_inventory_contract page.
...
public class BaseSite_inventory_contractRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in Site_inventory_contractRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Add-Site-inventory-contract"] = recId;
