...
// Pop_Edit_Site_inventory_contract_healthcare.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Pop_Edit_Site_inventory_contract_healthcare
{
...
// Base class for the Site_inventory_contractRecordControl control on the Pop_Edit_Site_inventory_contract_healthcare page.
...
public class BaseSite_inventory_contractRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in Site_inventory_contractRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Pop-Edit-Site-inventory-contract-healthcare"] = recId;
