...
// Show_Department_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Department_Table
{
...
// Base class for the DepartmentTableControlRow control on the Show_Department_Table page.
...
// Base class for the DepartmentTableControl control on the Show_Department_Table page.
...
public class BaseDepartmentTableControl : OEMConversion.UI.BaseApplicationTableControl
{
       ...
       public BaseDepartmentTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.department_activeFilter)) 				
                    initialVal = this.GetFromSession(this.department_activeFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"department_active\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.department_activeFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.department_activeFilter.SelectedValue = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.department_activeFilter.SelectedIndexChanged += new EventHandler(department_activeFilter_SelectedIndexChanged);
      ...
      public override void DataBind()
      {
        ...
        public virtual void ResetControl()
        {
            ...
            this.department_activeFilter.ClearSelection();
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.department_activeFilter)) {
                        
                wc.iAND(DepartmentTable.department_active, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.department_activeFilter, this.GetFromSession(this.department_activeFilter)), false, false);
      ...
      String department_activeFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "department_activeFilter_Ajax"];
            if (MiscUtils.IsValueSelected(department_activeFilterSelectedValue)) {

              
                wc.iAND(DepartmentTable.department_active, BaseFilter.ComparisonOperator.EqualsTo, department_activeFilterSelectedValue, false, false);
      ...
      DepartmentRecord rec = new DepartmentRecord();
        ...
        public virtual void Setdepartment_activeFilter()
        {
            
            this.Populatedepartment_activeFilter(MiscUtils.GetSelectedValue(this.department_activeFilter,  GetFromSession(this.department_activeFilter)), 500);					
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Department Active {Txt:Ascending}"), "department_active Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Department Active {Txt:Descending}"), "department_active Desc"));
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customercontact Primary Phone {Txt:Ascending}"), "customercontact_primary_phone Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customercontact Primary Phone {Txt:Descending}"), "customercontact_primary_phone Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customercontact Secondary Phone {Txt:Ascending}"), "customercontact_secondary_phone Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customercontact Secondary Phone {Txt:Descending}"), "customercontact_secondary_phone Desc"));
        ...
        // Get the filters' data for department_activeFilter.
                
        protected virtual void Populatedepartment_activeFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.department_activeFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_department_activeFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_department_activeFilter function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.department_activeFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
              
            
            
            OrderBy orderBy = new OrderBy(false, false);
            orderBy.Add(DepartmentTable.department_active, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = DepartmentTable.GetValues(DepartmentTable.department_active, wc, orderBy, maxItems);
            ...
            string fvalue;
            if ( DepartmentTable.department_active.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = DepartmentTable.department_active.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
                ...
                ListItem dupItem = this.department_activeFilter.Items.FindByText(fvalue);
                ...
                this.department_activeFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.department_activeFilter, selectedValue);
            ...
            if (this.department_activeFilter.SelectedValue != null && this.department_activeFilter.Items.FindByValue(this.department_activeFilter.SelectedValue) == null)
                this.department_activeFilter.SelectedValue = null;
                           
        }
            
        public virtual WhereClause CreateWhereClause_department_activeFilter()
        {
            // Create a where clause for the filter department_activeFilter.
            // This function is called by the Populate method to load the items 
            // in the department_activeFilterDropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.department_activeFilter, this.department_activeFilter.SelectedValue);
      ...
      this.SaveToSession("department_activeFilter_Ajax", this.department_activeFilter.SelectedValue);
      ...
      this.SaveToSession("SearchText_Ajax", this.SearchText.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.department_activeFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(department_activeFilter))
        ...
        protected virtual void OrderSort_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in DepartmentTable.GetColumns())
                  {
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(DepartmentTable.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (DepartmentTable.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && DepartmentTable.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(DepartmentTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(DepartmentTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
        ...
        protected virtual void department_activeFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList department_activeFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "department_activeFilter");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual DepartmentTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (DepartmentTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Department_Table.DepartmentTableControlRow")));
