...
// Add_Department.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Department
{
...
// Base class for the DepartmentRecordControl control on the Add_Department page.
...
public class BaseDepartmentRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (DepartmentRecord)DepartmentRecord.Copy(recList[0], false);
        ...
        public virtual void Getcustno()
        {
            ...
            this.DataSource.Parse(this.custno.Text, DepartmentTable.custno);							
      ...
      // To customize, override this method in DepartmentRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Department"];
            ...
            HttpContext.Current.Session["QueryString in Add-Department"] = recId;
