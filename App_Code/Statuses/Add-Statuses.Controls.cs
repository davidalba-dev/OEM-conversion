...
// Add_Statuses.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Statuses
{
...
public class StatusesRecordControl : BaseStatusesRecordControl
{
      
        // The BaseStatusesRecordControl implements the LoadData, DataBind and other
...
// Base class for the RepairOrdersTableControlRow control on the Add_Statuses page.
...
public class BaseRepairOrdersTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.ROAccessory4.SelectedIndexChanged += ROAccessory4_SelectedIndexChanged;                  
        ...
        public virtual void SetROAccessory4()
        {
            ...
            {
                if (this.PreviousUIData[this.ROAccessory4.ID] == null)
                    selectedValue = null;
                else
                    selectedValue = this.PreviousUIData[this.ROAccessory4.ID].ToString();
            }
            
            
            // Set the ROAccessory4 QuickSelector on the webpage with value from the
            // DatabaseAYS_OEM%dbo.RepairOrders database record.
            
            // this.DataSource is the DatabaseAYS_OEM%dbo.RepairOrders record retrieved from the database.
            // this.ROAccessory4 is the ASP:QuickSelector on the webpage.
            
            // You can modify this method directly, or replace it with a call to
            //     base.SetROAccessory4();
            ...
            if (this.DataSource != null && this.DataSource.ROAccessory4Specified)
            {
                ...
                selectedValue = this.DataSource.ROAccessory4.ToString();
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = RepairOrdersTable.ROAccessory4.DefaultValue;
                				
            }			
                
            // Add the Please Select item.
            if (selectedValue == null || selectedValue == "")
                  MiscUtils.ResetSelectedItem(this.ROAccessory4, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "OEMConversion"), "--PLEASE_SELECT--"));
                        
                  
            // Populate the item(s) to the control
            
            this.ROAccessory4.SetFieldMaxLength(50);
            ...
            if (selectedValue != null &&
                selectedValue.Trim() != "" &&
                !MiscUtils.SetSelectedValue(this.ROAccessory4, selectedValue) &&
                !MiscUtils.SetSelectedDisplayText(this.ROAccessory4, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        if(_isExpandableNonCompositeForeignKey && RepairOrdersTable.ROAccessory4.IsApplyDisplayAs)
                            fvalue = RepairOrdersTable.GetDFKA(itemValue, RepairOrdersTable.ROAccessory4);
                        if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
                            fvalue = itemValue.Format(CustomerContactsTable.CustContactName);
                            					
                        if (fvalue == null || fvalue.Trim() == "") fvalue = cvalue;
                        MiscUtils.ResetSelectedItem(this.ROAccessory4, new ListItem(fvalue, cvalue));                      
                    }
                }
                catch
                {
              ...
              url += "?Target=" + this.ROAccessory4.ClientID + "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("CustContactName")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--PLEASE_SELECT--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:PleaseSelect"))+ "&Mode=" + (this.Page as BaseApplicationPage).Encrypt("FieldValueSingleSelection") + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.ROAccessory4.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(ROAccessory4.AutoPostBack).ToLower() + ", event); return false;";
        ...
        public virtual void SetROReference4()
        {
            ...
            // If selection was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.ROReference4.ID))
            {
                if (this.PreviousUIData[this.ROReference4.ID] == null)
                    selectedValue = null;
                else
                    selectedValue = this.PreviousUIData[this.ROReference4.ID].ToString();
            }
            
            
            // Set the ROReference4 QuickSelector on the webpage with value from the
            // DatabaseAYS_OEM%dbo.RepairOrders database record.
            
            // this.DataSource is the DatabaseAYS_OEM%dbo.RepairOrders record retrieved from the database.
            // this.ROReference4 is the ASP:QuickSelector on the webpage.
            ...
            // Add the Please Select item.
            if (selectedValue == null || selectedValue == "")
                  MiscUtils.ResetSelectedItem(this.ROReference4, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "OEMConversion"), "--PLEASE_SELECT--"));
                        
                  
            // Populate the item(s) to the control
            
            this.ROReference4.SetFieldMaxLength(50);
                ...
                !MiscUtils.SetSelectedDisplayText(this.ROReference4, selectedValue))
            {
              ...
              url += "?Target=" + this.ROReference4.ClientID + "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("CustContactName")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--PLEASE_SELECT--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:PleaseSelect"))+ "&Mode=" + (this.Page as BaseApplicationPage).Encrypt("FieldValueSingleSelection") + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.ROReference4.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(ROReference4.AutoPostBack).ToLower() + ", event); return false;";
        ...
        StatusesRecordControl parentCtrl;
      
            parentCtrl = (StatusesRecordControl)this.Page.FindControlRecursively("StatusesRecordControl");
        ...
        throw new Exception(Page.GetResourceValue("Err:NoParentRecId", "OEMConversion"));
          ...
          this.DataSource.ROStatus = parentCtrl.DataSource.StaNumber;
        ...
        {
         // Retrieve the value entered by the user on the ROAccessory4 ASP:QuickSelector, and
            // save it into the ROAccessory4 field in DataSource DatabaseAYS_OEM%dbo.RepairOrders record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.ROAccessory4), RepairOrdersTable.ROAccessory4);			
        ...
        {
         // Retrieve the value entered by the user on the ROReference4 ASP:QuickSelector, and
      ...
      // To customize, override this method in RepairOrdersTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersStatusesRecordControl = false;
            hasFiltersStatusesRecordControl = hasFiltersStatusesRecordControl && false; // suppress warning
        ...
        protected virtual void ROAccessory4_SelectedIndexChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector ROAccessory4 {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROAccessory4");
            }
        }              
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector ROReference4 {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROReference4");
            }
        }              
...
// Base class for the RepairOrdersTableControl control on the Add_Statuses page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Add_Statuses.StatusesRecordControl statusesRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "StatusesRecordControl") as OEMConversion.UI.Controls.Add_Statuses.StatusesRecordControl);
          
              if (statusesRecordControlObj != null && statusesRecordControlObj.GetRecord() != null && statusesRecordControlObj.GetRecord().IsCreated)
              {
              wc.iAND(RepairOrdersTable.ROStatus, BaseFilter.ComparisonOperator.EqualsTo, statusesRecordControlObj.GetRecord().StaNumber.ToString());
              selectedRecordKeyValue.AddElement(RepairOrdersTable.ROStatus.InternalName, statusesRecordControlObj.GetRecord().StaNumber.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInStatusesRecordControl = HttpContext.Current.Session["RepairOrdersTableControlWhereClause"] as string;
      
      if (selectedRecordInStatusesRecordControl != null && KeyValue.IsXmlKey(selectedRecordInStatusesRecordControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInStatusesRecordControl);
      
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(RepairOrdersTable.ROStatus))
      {
      wc.iAND(RepairOrdersTable.ROStatus, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(RepairOrdersTable.ROStatus).ToString());
      }
      ...
      RepairOrdersRecord rec = new RepairOrdersRecord();
                        ...
                        if (MiscUtils.IsValueSelected(recControl.ROAccessory4)) {
                            rec.Parse(recControl.ROAccessory4.SelectedItem.Value, RepairOrdersTable.ROAccessory4);
                        }
                        ...
                        if (MiscUtils.IsValueSelected(recControl.ROReference4)) {
                            rec.Parse(recControl.ROReference4.SelectedItem.Value, RepairOrdersTable.ROReference4);
                        }
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Light Cable {Txt:Ascending}"), "ROAccessory4 Asc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Light Cable {Txt:Descending}"), "ROAccessory4 Desc"));
                ...
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Condition {Txt:Ascending}"), "ROCondition Asc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Condition {Txt:Descending}"), "ROCondition Desc"));
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Add_Statuses.RepairOrdersTableControlRow")));
...
// Base class for the StatusesRecordControl control on the Add_Statuses page.
// Do not modify this class. Instead override any method in StatusesRecordControl.
public class BaseStatusesRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseStatusesRecordControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        // To customize, override this method in StatusesRecordControl.
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
        ...
        {      
              ...
              this.historyro_active.CheckedChanged += historyro_active_CheckedChanged;
            
              this.status_active.CheckedChanged += status_active_CheckedChanged;
            
              this.StaCustomCaption.TextChanged += StaCustomCaption_TextChanged;
            
              this.StaLetter.TextChanged += StaLetter_TextChanged;
            
              this.status_color.TextChanged += status_color_TextChanged;
            
              this.status_customer_caption.TextChanged += status_customer_caption_TextChanged;
        ...
        public virtual void LoadData()  
        {
            ...
            StatusesRecord[] recList = StatusesTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = (StatusesRecord)StatusesRecord.Copy(recList[0], false);
        ...
        public virtual void Sethistoryro_active()
        {
            ...
            // Set the historyro_active CheckBox on the webpage with value from the
            ...
            // this.historyro_active is the ASP:CheckBox on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.historyro_activeSpecified) {
                ...
                // The Format method will use the Display Format
                this.historyro_active.Checked = this.DataSource.historyro_active;
                ...
                // Default Value could also be NULL.
                if (!this.DataSource.IsCreated) 
                    this.historyro_active.Checked = StatusesTable.historyro_active.ParseValue(StatusesTable.historyro_active.DefaultValue).ToBoolean();                
        ...
        public virtual void SetStaCustomCaption()
        {
            ...
            // Set the StaCustomCaption TextBox on the webpage with value from the
            // DatabaseAYS_OEM%dbo.Statuses database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.Statuses record retrieved from the database.
            // this.StaCustomCaption is the ASP:TextBox on the webpage.
        ...
        public virtual void SetStaLetter()
        {
            ...
            // Set the StaLetter TextBox on the webpage with value from the
            // DatabaseAYS_OEM%dbo.Statuses database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.Statuses record retrieved from the database.
            // this.StaLetter is the ASP:TextBox on the webpage.
        ...
        public virtual void Setstatus_active()
        {
            ...
            // Set the status_active CheckBox on the webpage with value from the
            // DatabaseAYS_OEM%dbo.Statuses database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.Statuses record retrieved from the database.
            // this.status_active is the ASP:CheckBox on the webpage.
                  
            if (this.DataSource != null && this.DataSource.status_activeSpecified) {
                							
                // If the status_active is non-NULL, then format the value.
                // The Format method will use the Display Format
                this.status_active.Checked = this.DataSource.status_active;
                ...
                // Default Value could also be NULL.
                if (!this.DataSource.IsCreated) 
                    this.status_active.Checked = StatusesTable.status_active.ParseValue(StatusesTable.status_active.DefaultValue).ToBoolean();                
        ...
        public virtual void Setstatus_color()
        {
            ...
            // Set the status_color TextBox on the webpage with value from the
            // DatabaseAYS_OEM%dbo.Statuses database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.Statuses record retrieved from the database.
            // this.status_color is the ASP:TextBox on the webpage.
                  
            if (this.DataSource != null && this.DataSource.status_colorSpecified) {
                								
                // If the status_color is non-NULL, then format the value.
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(StatusesTable.status_color);
        ...
        public virtual void Setstatus_customer_caption()
        {
            ...
            // Set the status_customer_caption TextBox on the webpage with value from the
            // DatabaseAYS_OEM%dbo.Statuses database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.Statuses record retrieved from the database.
            // this.status_customer_caption is the ASP:TextBox on the webpage.
        ...
        public virtual void SetHyperLink()
                  {
        ...
        {	
            ...
            // Retrieve the value entered by the user on the historyro_active ASP:CheckBox, and
            // save it into the historyro_active field in DataSource DatabaseAYS_OEM%dbo.Statuses record.
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.historyro_active = this.historyro_active.Checked;						
        ...
        public virtual void GetStaCustomCaption()
        {
            ...
            // Retrieve the value entered by the user on the StaCustomCaption ASP:TextBox, and
            // save it into the StaCustomCaption field in DataSource DatabaseAYS_OEM%dbo.Statuses record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.StaCustomCaption.Text, StatusesTable.StaCustomCaption);							
        ...
        public virtual void GetStaLetter()
        {
            ...
            // Retrieve the value entered by the user on the StaLetter ASP:TextBox, and
            // save it into the StaLetter field in DataSource DatabaseAYS_OEM%dbo.Statuses record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.StaLetter.Text, StatusesTable.StaLetter);							
        ...
        {	
            ...
            // Retrieve the value entered by the user on the status_active ASP:CheckBox, and
            // save it into the status_active field in DataSource DatabaseAYS_OEM%dbo.Statuses record.
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.status_active = this.status_active.Checked;						
        ...
        public virtual void Getstatus_color()
        {
            ...
            // Retrieve the value entered by the user on the status_color ASP:TextBox, and
            // save it into the status_color field in DataSource DatabaseAYS_OEM%dbo.Statuses record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.status_color.Text, StatusesTable.status_color);							
        ...
        public virtual void Getstatus_customer_caption()
        {
            ...
            // Retrieve the value entered by the user on the status_customer_caption ASP:TextBox, and
            // save it into the status_customer_caption field in DataSource DatabaseAYS_OEM%dbo.Statuses record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.status_customer_caption.Text, StatusesTable.status_customer_caption);							
      ...
      // To customize, override this method in StatusesRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Statuses"];
            ...
            HttpContext.Current.Session["QueryString in Add-Statuses"] = recId;
          ...
          wc.iAND(StatusesTable.StaNumber, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(StatusesTable.StaNumber));
             
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(StatusesTable.StaNumber, BaseFilter.ComparisonOperator.EqualsTo, recId);
        ...
        protected virtual void historyro_active_CheckedChanged(object sender, EventArgs args)
        {
           						
        }
            
        protected virtual void status_active_CheckedChanged(object sender, EventArgs args)
        {
           						
        }
            
        protected virtual void StaCustomCaption_TextChanged(object sender, EventArgs args)
        {
                    
              }
            
        protected virtual void StaLetter_TextChanged(object sender, EventArgs args)
        {
                    
              }
            
        protected virtual void status_color_TextChanged(object sender, EventArgs args)
        {
                    
              }
            
        protected virtual void status_customer_caption_TextChanged(object sender, EventArgs args)
        {
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseStatusesRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseStatusesRecordControl_Rec"] = value;
            }
        }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.CheckBox historyro_active {
            get {
                return (System.Web.UI.WebControls.CheckBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "historyro_active");
            }
        }
            
        public System.Web.UI.WebControls.Literal historyro_activeLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "historyro_activeLabel");
            }
        }
        
        public System.Web.UI.WebControls.HyperLink HyperLink {
            get {
                return (System.Web.UI.WebControls.HyperLink)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HyperLink");
            }
        }
        
        public System.Web.UI.WebControls.TextBox StaCustomCaption {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "StaCustomCaption");
            }
        }
        ...
        public System.Web.UI.WebControls.TextBox StaLetter {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "StaLetter");
            }
        }
            
        public System.Web.UI.WebControls.Literal StaLetterLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "StaLetterLabel");
            }
        }
        
        public System.Web.UI.WebControls.CheckBox status_active {
            get {
                return (System.Web.UI.WebControls.CheckBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "status_active");
            }
        }
            
        public System.Web.UI.WebControls.Literal status_activeLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "status_activeLabel");
            }
        }
        
        public System.Web.UI.WebControls.TextBox status_color {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "status_color");
            }
        }
            
        public System.Web.UI.WebControls.Literal status_colorLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "status_colorLabel");
            }
        }
        
        public System.Web.UI.WebControls.TextBox status_customer_caption {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "status_customer_caption");
            }
        }
