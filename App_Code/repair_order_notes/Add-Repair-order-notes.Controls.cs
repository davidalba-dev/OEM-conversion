...
// Add_Repair_order_notes.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Repair_order_notes
{
...
// Base class for the Repair_order_notesRecordControl control on the Add_Repair_order_notes page.
...
public class BaseRepair_order_notesRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (Repair_order_notesRecord)Repair_order_notesRecord.Copy(recList[0], false);
        ...
        public virtual void Setnote_date_time()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
              ...
              this.note_date_time.Text = EvaluateFormula("Now()", this.DataSource, @"g");
      ...
      // To customize, override this method in Repair_order_notesRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Repair_order_notes"];
            ...
            HttpContext.Current.Session["QueryString in Add-Repair-order-notes"] = recId;
        ...
        public virtual WhereClause CreateWhereClause_ronoDropDownList() 
        {
            ...
            if (EvaluateFormula("URL(\"rono\")", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.RepairOrdersTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"RepairOrders_.RONo"), EvaluateFormula("URL(\"rono\")", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("URL(\"rono\")", false) == "--PLEASE_SELECT--" || EvaluateFormula("URL(\"rono\")", false) == "--ANY--") whereClause.RunQuery = false;
...
#region "Helper Properties"
    ...
    Repair_order_notesRecord rec = null;
             ...
             
        {
            ...
            return new Repair_order_notesRecord();
