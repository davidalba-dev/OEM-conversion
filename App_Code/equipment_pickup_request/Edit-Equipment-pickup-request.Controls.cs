...
// Edit_Equipment_pickup_request.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Equipment_pickup_request
{
...
// Base class for the Equipment_pickup_requestRecordControl control on the Edit_Equipment_pickup_request page.
...
public class BaseEquipment_pickup_requestRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setinventory_id()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = Equipment_pickup_requestTable.inventory_id.DefaultValue;
        ...
        public virtual void Setpicked_up_datetime()
        {
            ...
            if (this.DataSource != null && this.DataSource.picked_up_datetimeSpecified) {
                								
                // If the picked_up_datetime is non-NULL, then format the value.
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(Equipment_pickup_requestTable.picked_up_datetime, @"g");
        ...
        public virtual void Setprocessed()
        {
            ...
            if (this.DataSource != null && this.DataSource.processedSpecified) {
                ...
                // Default Value could also be NULL.
                if (!this.DataSource.IsCreated) 
                    this.processed.Checked = Equipment_pickup_requestTable.processed.ParseValue(Equipment_pickup_requestTable.processed.DefaultValue).ToBoolean();                
        ...
        public virtual void Settechnician_id()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = Equipment_pickup_requestTable.technician_id.DefaultValue;
        ...
        public virtual void Getinventory_id()
        {
         // Retrieve the value entered by the user on the inventory_id ASP:DropDownList, and
            // save it into the inventory_id field in DataSource DatabaseAYS_OEM%dbo.equipment_pickup_request record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.inventory_id), Equipment_pickup_requestTable.inventory_id);			
        ...
        public virtual void Getpicked_up_datetime()
        {
            ...
            // Retrieve the value entered by the user on the picked_up_datetime ASP:TextBox, and
            // save it into the picked_up_datetime field in DataSource DatabaseAYS_OEM%dbo.equipment_pickup_request record.
            ...
            this.DataSource.Parse(this.picked_up_datetime.Text, Equipment_pickup_requestTable.picked_up_datetime);							
        ...
        public virtual void Getpicked_up_from()
        {
            ...
            // Retrieve the value entered by the user on the picked_up_from ASP:TextBox, and
            // save it into the picked_up_from field in DataSource DatabaseAYS_OEM%dbo.equipment_pickup_request record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.picked_up_from.Text, Equipment_pickup_requestTable.picked_up_from);							
        ...
        {	
            ...
            // save it into the processed field in DataSource DatabaseAYS_OEM%dbo.equipment_pickup_request record.
            // Custom validation should be performed in Validate, not here.
        ...
        public virtual void Gettechnician_id()
        {
         // Retrieve the value entered by the user on the technician_id ASP:DropDownList, and
            // save it into the technician_id field in DataSource DatabaseAYS_OEM%dbo.equipment_pickup_request record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.technician_id), Equipment_pickup_requestTable.technician_id);			
      ...
      // To customize, override this method in Equipment_pickup_requestRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Edit-Equipment-pickup-request"] = recId;
        ...
        public virtual WhereClause CreateWhereClause_inventory_idDropDownList() 
        {
            ...
            // Examples:
            // wc.iAND(Equipment_inventoryTable.inventory_id, BaseFilter.ComparisonOperator.EqualsTo, "XYZ");
        ...
        protected virtual void Populateinventory_idDropDownList(string selectedValue, int maxItems) 
        {
            ...
            OrderBy orderBy = new OrderBy(false, false);
                          orderBy.Add(Equipment_inventoryTable.oem_ein, OrderByItem.OrderDir.Asc);
                    ...
                    foreach (Equipment_inventoryRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.inventory_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.inventory_id.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                fvalue = EvaluateFormula("=Equipment_inventory.oem_ein", itemValue, variables2, evaluator);
                ...
                !MiscUtils.SetSelectedDisplayText(this.inventory_id, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        fvalue = EvaluateFormula("=Equipment_inventory.oem_ein", itemValue, variables2, evaluator2);
        ...
        protected virtual void Populatepicked_up_byDropDownList(string selectedValue, int maxItems) 
        {
            ...
            // 1. Setup the static list items        
              ...
              // Add the Please Select item.
              this.picked_up_by.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "OEMConversion"), "--PLEASE_SELECT--"));
                        ...
                        if (itemValue.ProvNameSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.pickup_state.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                if(_isExpandableNonCompositeForeignKey && Equipment_pickup_requestTable.pickup_state.IsApplyDisplayAs)
                                    fvalue = Equipment_pickup_requestTable.GetDFKA(itemValue, Equipment_pickup_requestTable.pickup_state);
                                if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
