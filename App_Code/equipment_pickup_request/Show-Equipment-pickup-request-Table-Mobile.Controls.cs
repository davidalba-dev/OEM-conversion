...
// Show_Equipment_pickup_request_Table_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Equipment_pickup_request_Table_Mobile
{
...
// Base class for the Equipment_pickup_requestTableControlRow control on the Show_Equipment_pickup_request_Table_Mobile page.
...
public class BaseEquipment_pickup_requestTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setcustno()
        {
            ...
            // Set the custno Label on the webpage with value from the
            ...
            // this.custno is the ASP:Label on the webpage.
      ...
      // To customize, override this method in Equipment_pickup_requestTableControlRow.
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../equipment_pickup_request/Edit-Equipment-pickup-request-Mobile.aspx?Equipment_pickup_request={PK}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Label custno {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "custno");
            }
        }
...
// Base class for the Equipment_pickup_requestTableControl control on the Show_Equipment_pickup_request_Table_Mobile page.
...
public class BaseEquipment_pickup_requestTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep1 = (System.Web.UI.WebControls.Repeater)BaseClasses.Utils.MiscUtils.FindControlRecursively(rep.Items[PageIndex], "Equipment_pickup_requestTableControlRepeater1");
      ...
      String custnoFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "custnoFilter_Ajax"];
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (!this.ResetData)
            {
              System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Equipment_pickup_requestTableControlRepeater"));
              if (rep == null){return;}
              Equipment_pickup_requestTableControlRow[] recControls = this.GetRecordControls();
                foreach (Equipment_pickup_requestTableControlRow recControl in recControls) 
		{
      ...
      Equipment_pickup_requestRecord rec = new Equipment_pickup_requestRecord();
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer Contact {Txt:Ascending}"), "custcontactkey Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer Contact {Txt:Descending}"), "custcontactkey Desc"));
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (Equipment_pickup_requestTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        Equipment_pickup_requestTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual Equipment_pickup_requestTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Equipment_pickup_requestTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Equipment_pickup_request_Table_Mobile.Equipment_pickup_requestTableControlRow")));
