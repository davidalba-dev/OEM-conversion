...
// Show_Equipment_pickup_request_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Equipment_pickup_request_Table
{
...
// Base class for the Equipment_pickup_requestTableControlRow control on the Show_Equipment_pickup_request_Table page.
...
// Base class for the Equipment_pickup_requestTableControl control on the Show_Equipment_pickup_request_Table page.
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Equipment-pickup-request-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "equipment_pickup_request";
                // If Show-Equipment-pickup-request-Table.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Equipment-pickup-request-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "equipment_pickup_request";
                // If Show-Equipment-pickup-request-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        public virtual void Button_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../equipment_pickup_request/Show-Equipment-pickup-request-history-Table.aspx";
...
#region "Helper Functions"
        ...
        public virtual Equipment_pickup_requestTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Equipment_pickup_requestTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Equipment_pickup_request_Table.Equipment_pickup_requestTableControlRow")));
