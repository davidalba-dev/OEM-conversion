...
// Show_Equipment_pickup_request_Table1.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Equipment_pickup_request_Table1
{
...
// Base class for the Equipment_pickup_requestTableControlRow control on the Show_Equipment_pickup_request_Table1 page.
...
public class BaseEquipment_pickup_requestTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void custno_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Customers/Show-Customers.aspx?Customers={Equipment_pickup_requestTableControlRow:FK:VFK_equipment_pickup_request_custno_1}";
...
// Base class for the Equipment_pickup_requestTableControl control on the Show_Equipment_pickup_request_Table1 page.
...
public class BaseEquipment_pickup_requestTableControl : OEMConversion.UI.BaseApplicationTableControl
{
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.custnoFilter)) {
                ...
                foreach (ListItem item in this.custnoFilter.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(Equipment_pickup_requestTable.custno, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
      ...
      String custnoFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "custnoFilter_Ajax"];
        ...
        if (custnoFilterSelectedValue != null){
                        ...
                        foreach (string item in custnoFilteritemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(Equipment_pickup_requestTable.custno, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
      ...
      Equipment_pickup_requestRecord rec = new Equipment_pickup_requestRecord();
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer {Txt:Ascending}"), "custno Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer {Txt:Descending}"), "custno Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Pickkup Date {Txt:Ascending}"), "pickkup_date Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Pickkup Date {Txt:Descending}"), "pickkup_date Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Pickup Time {Txt:Ascending}"), "pickup_time Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Pickup Time {Txt:Descending}"), "pickup_time Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Picked Up By {Txt:Ascending}"), "picked_up_by Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Picked Up By {Txt:Descending}"), "picked_up_by Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Picked Up Date And Time {Txt:Ascending}"), "picked_up_datetime Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Picked Up Date And Time {Txt:Descending}"), "picked_up_datetime Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Picked Up From {Txt:Ascending}"), "picked_up_from Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Picked Up From {Txt:Descending}"), "picked_up_from Desc"));
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
                    ...
                    this.ImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=Equipment_pickup_request" ;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Equipment-pickup-request-Table1.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "equipment_pickup_request";
                // If Show-Equipment-pickup-request-Table1.PDFButton.report specifies a valid report template,
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                 ...
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  Equipment_pickup_requestTable.custno.IsApplyDisplayAs){
                                     ...
                                     report.AddData("${custno}", record.Format(Equipment_pickup_requestTable.custno), ReportEnum.Align.Left);
                                 }
                             }
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Equipment-pickup-request-Table1.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "equipment_pickup_request";
                // If Show-Equipment-pickup-request-Table1.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        protected virtual void SortControl_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in Equipment_pickup_requestTable.GetColumns())
                  {
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(Equipment_pickup_requestTable.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (Equipment_pickup_requestTable.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && Equipment_pickup_requestTable.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(Equipment_pickup_requestTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(Equipment_pickup_requestTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
...
#region "Helper Functions"
        ...
        public virtual Equipment_pickup_requestTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Equipment_pickup_requestTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Equipment_pickup_request_Table1.Equipment_pickup_requestTableControlRow")));
