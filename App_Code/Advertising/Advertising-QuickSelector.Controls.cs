...
// Advertising_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Advertising_QuickSelector
{
...
// Base class for the SelectorTableControlRow control on the Advertising_QuickSelector page.
...
public class BaseSelectorTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {
            // Load the data from the database into the DataSource DatabaseAYS_OEM%dbo.Advertising record.
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = AdvertisingTable.GetRecord(this.RecordUniqueId, true);
            ...
            this.DataSource = new AdvertisingRecord();
      ...
      // To customize, override this method in SelectorTableControlRow.
        ...
        public virtual void Delete()
        {
          ...
          AdvertisingTable.DeleteRecord(pkValue);
        ...
        public AdvertisingRecord DataSource {
            get {
                return (AdvertisingRecord)(this._DataSource);
            }
            set {
...
#region "Helper Properties"
    ...
    AdvertisingRecord rec = null;
        ...
        public virtual AdvertisingRecord GetRecord()
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return AdvertisingTable.GetRecord(this.RecordUniqueId, true);
...
// Base class for the SelectorTableControl control on the Advertising_QuickSelector page.
...
public class BaseSelectorTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(OEMConversion.Business.AdvertisingRecord);
                      this.DataSource = (AdvertisingRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    Type myrec = typeof(OEMConversion.Business.AdvertisingRecord);
                    this.DataSource = (AdvertisingRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual AdvertisingRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(AdvertisingTable.Column1, true);          
            // selCols.Add(AdvertisingTable.Column2, true);          
            // selCols.Add(AdvertisingTable.Column3, true);          
                  ...
                  
            {
                ...
                return AdvertisingTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                AdvertisingTable databaseTable = new AdvertisingTable();
                ...
                return (recList.ToArray(typeof(AdvertisingRecord)) as AdvertisingRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0 || selCols.HasPrimaryKey())
                ...
                return AdvertisingTable.GetRecordCount(join, where);
            else
            {
                AdvertisingTable databaseTable = new AdvertisingTable();
                databaseTable.SelectedColumns.Clear();
        ...
        {    
            ...
            {
                BaseColumn col = AdvertisingTable.GetColumnByName(field);
            ...
            if (includeFormulaAndDFKAParameter) 
            {
                if (formula != "")
                {
                    foreach (BaseColumn col in MiscUtils.GetFormulaFieldList(formula, AdvertisingTable.Instance.TableDefinition))
                    {
                        if (col != null && !columnList.Contains(col))
                            columnList.Add(col);             
                    }
                ...
                {
                    BaseColumn col = AdvertisingTable.GetColumnByName(displayFieldName);
                    if (col != null && !columnList.Contains(col))
                        columnList.Add(col);             
                }
            }
      ...
      public override void DataBind()
      {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            AdvertisingTable.Instance.InnerFilter = null;
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.Search, this.GetFromSession(this.Search)), true, false);
		        ...
		        if (!string.IsNullOrEmpty(this.Page.Request["dependOnField"]) && this.Page.Request["dependOnVal"] != null) {
			          BaseColumn dependOnCol = AdvertisingTable.GetColumnByName(this.Page.GetDecryptedURLParameter("dependOnField"));
                if (dependOnCol != null){                
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_Search(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            OEMConversion.Business.AdvertisingRecord[] recordList  = AdvertisingTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (AdvertisingRecord rec in recordList ){
      ...
      AdvertisingRecord rec = new AdvertisingRecord();
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new AdvertisingRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(OEMConversion.Business.AdvertisingRecord);
                this.DataSource = (AdvertisingRecord[])(finalList.ToArray(myrec));
      ...
      this.Page.Response.Redirect(url);
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = AdvertisingTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  AdvertisingRecord[] DataSource {
            ...
            get {
                return (AdvertisingRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Advertising_QuickSelector.SelectorTableControlRow")));
