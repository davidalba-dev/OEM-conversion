...
// Add_Equipment_inventory_parts.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Equipment_inventory_parts
{
...
// Base class for the Equipment_inventory_partsRecordControl control on the Add_Equipment_inventory_parts page.
...
public class BaseEquipment_inventory_partsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (Equipment_inventory_partsRecord)Equipment_inventory_partsRecord.Copy(recList[0], false);
        ...
        public virtual void Setrefurb_part_id()
        {
            ...
            else
            {
                ...
                selectedValue = EvaluateFormula("URL(\"refurb_part_id\")");
        ...
        public virtual void Setrefurb_part_idLabel()
                  {
      ...
      // To customize, override this method in Equipment_inventory_partsRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Equipment_inventory_parts"];
            ...
            HttpContext.Current.Session["QueryString in Add-Equipment-inventory-parts"] = recId;
                    ...
                    foreach (Refurb_partsRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.refurb_part_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.refurb_part_id.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                fvalue = EvaluateFormula("=Refurb_parts.refurb_part_name + \" \" + Format(Refurb_parts.refurb_part_retail,\"c\")", itemValue, variables2, evaluator);
                ...
                !MiscUtils.SetSelectedDisplayText(this.refurb_part_id, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        fvalue = EvaluateFormula("=Refurb_parts.refurb_part_name + \" \" + Format(Refurb_parts.refurb_part_retail,\"c\")", itemValue, variables2, evaluator2);
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal refurb_part_idLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "refurb_part_idLabel");
            }
        }
    ...
    Equipment_inventory_partsRecord rec = null;
             ...
             
        {
            ...
            return new Equipment_inventory_partsRecord();
