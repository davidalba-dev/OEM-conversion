...
// RepairOrder_POD_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.RepairOrder_POD_Mobile
{
...
// Base class for the DetailsSC2Row control on the RepairOrder_POD_Mobile page.
...
// Base class for the DetailsSC2 control on the RepairOrder_POD_Mobile page.
...
#region "Helper Functions"
        ...
        public virtual DetailsSC2Row[] GetSelectedRecordControls()
        {
            ...
            return (DetailsSC2Row[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.RepairOrder_POD_Mobile.DetailsSC2Row")));
...
// Base class for the CustomersRecordControl control on the RepairOrder_POD_Mobile page.
...
// Base class for the InvoiceDetails control on the RepairOrder_POD_Mobile page.
...
public class BaseInvoiceDetails : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in InvoiceDetails.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in RepairOrder-POD-Mobile"] = recId;
...
// Base class for the RepairOrdersRecordControl control on the RepairOrder_POD_Mobile page.
...
public class BaseRepairOrdersRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetRODateEstimateCompleted()
        {
            ...
            if (this.DataSource != null && this.DataSource.RODateEstimateCompletedSpecified) {
              ...
              this.RODateEstimateCompleted.Text = RepairOrdersTable.RODateEstimateCompleted.Format(RepairOrdersTable.RODateEstimateCompleted.DefaultValue, @"d");
        ...
        public virtual void SetRODateEstimatedCompletion()
        {
            ...
            if (this.DataSource != null && this.DataSource.RODateEstimatedCompletionSpecified) {
              ...
              this.RODateEstimatedCompletion.Text = RepairOrdersTable.RODateEstimatedCompletion.Format(RepairOrdersTable.RODateEstimatedCompletion.DefaultValue, @"d");
...
// Base class for the RepairOrdersRecordControl1 control on the RepairOrder_POD_Mobile page.
...
public class BaseRepairOrdersRecordControl1 : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.signature_datetime.TextChanged += signature_datetime_TextChanged;
        ...
        public virtual void Setsignature_datetime()
        {
            ...
            // Set the signature_datetime TextBox on the webpage with value from the
            // DatabaseAYS_OEM%dbo.RepairOrders database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.RepairOrders record retrieved from the database.
            // this.signature_datetime is the ASP:TextBox on the webpage.
        ...
        public virtual void Getsignature_datetime()
        {
            ...
            // Retrieve the value entered by the user on the signature_datetime ASP:TextBox, and
            // save it into the signature_datetime field in DataSource DatabaseAYS_OEM%dbo.RepairOrders record.
            ...
            this.DataSource.Parse(EvaluateFormula("Now()"), RepairOrdersTable.signature_datetime);							
      ...
      // To customize, override this method in RepairOrdersRecordControl1.
        ...
        protected virtual void signature_datetime_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox signature_datetime {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "signature_datetime");
            }
        }
