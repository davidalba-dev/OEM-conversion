...
// Show_RepairOrders_Table_Mobile1.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_RepairOrders_Table_Mobile1
{
...
// Base class for the RepairOrdersTableControlRow control on the Show_RepairOrders_Table_Mobile1 page.
...
public class BaseRepairOrdersTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetROAccessory4()
        {
            ...
            // Set the ROAccessory4 Label on the webpage with value from the
            ...
            // this.ROAccessory4 is the ASP:Label on the webpage.
        ...
        public virtual void SetROCustName()
        {
            ...
            // Set the ROCustName Label on the webpage with value from the
            // DatabaseAYS_OEM%dbo.RepairOrders database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.RepairOrders record retrieved from the database.
            // this.ROCustName is the ASP:Label on the webpage.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Label ROAccessory4 {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROAccessory4");
            }
        }
            
        public System.Web.UI.WebControls.Label ROCustName {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROCustName");
            }
        }
...
// Base class for the RepairOrdersTableControl control on the Show_RepairOrders_Table_Mobile1 page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
           ...
           // Setup the filter and search.
            ...
            if (!this.Page.IsPostBack)
            {
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.RONoFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.RONoFilter.SelectedValue = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.RONoFilter.SelectedIndexChanged += new EventHandler(RONoFilter_SelectedIndexChanged);
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep1 = (System.Web.UI.WebControls.Repeater)BaseClasses.Utils.MiscUtils.FindControlRecursively(rep.Items[PageIndex], "RepairOrdersTableControlRepeater1");
        ...
        public virtual void ResetControl()
        {
            ...
            this.RONoFilter.ClearSelection();
            ...
            foreach (RepairOrdersRecord rec in recordList ){
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, RepairOrdersTable.ROCustName.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, RepairOrdersTable.RODesc.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, RepairOrdersTable.ROBatchID.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, RepairOrdersTable.ROEmail.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, RepairOrdersTable.ROPhoneBusiness.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (!this.ResetData)
            {
              ...
              RepairOrdersTableControlRow[] recControls = this.GetRecordControls();
                foreach (RepairOrdersTableControlRow recControl in recControls) 
		{
      ...
      RepairOrdersRecord rec = new RepairOrdersRecord();
        ...
        public virtual void SetRONoFilter()
        {
            
            this.PopulateRONoFilter(MiscUtils.GetSelectedValue(this.RONoFilter,  GetFromSession(this.RONoFilter)), 500);					
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Light Cable {Txt:Ascending}"), "ROAccessory4 Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Light Cable {Txt:Descending}"), "ROAccessory4 Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Facility Name {Txt:Ascending}"), "ROCustName Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Facility Name {Txt:Descending}"), "ROCustName Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("RO# {Txt:Ascending}"), "RONo Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("RO# {Txt:Descending}"), "RONo Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Signature Image {Txt:Ascending}"), "SignatureImage Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Signature Image {Txt:Descending}"), "SignatureImage Desc"));
                ...
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Signature Date And Time {Txt:Ascending}"), "signature_datetime Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Signature Date And Time {Txt:Descending}"), "signature_datetime Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Loaner Required {Txt:Ascending}"), "loaner_required Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Loaner Required {Txt:Descending}"), "loaner_required Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Label Required {Txt:Ascending}"), "label_required Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Label Required {Txt:Descending}"), "label_required Desc"));
                ...
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Approver Email {Txt:Ascending}"), "approver_email Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Approver Email {Txt:Descending}"), "approver_email Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer Encrypt {Txt:Ascending}"), "customer_encrypt Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer Encrypt {Txt:Descending}"), "customer_encrypt Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Serial Encrypt {Txt:Ascending}"), "serial_encrypt Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Serial Encrypt {Txt:Descending}"), "serial_encrypt Desc"));
        ...
        // Get the filters' data for RONoFilter.
                
        protected virtual void PopulateRONoFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.RONoFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_RONoFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_RONoFilter function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.RONoFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
              
            OrderBy orderBy = new OrderBy(false, false);
                          orderBy.Add(RODetailsTable.RONo, OrderByItem.OrderDir.Asc);
            ...
            RODetailsRecord[] itemValues  = null;
            if (wc.RunQuery)
            {
                int counter = 0;
                int pageNum = 0;
                ...
                do
                {
                    ...
                    itemValues = RODetailsTable.GetRecords(wc, orderBy, pageNum, maxItems);
                                    
                    foreach (RODetailsRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.RONoSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.RONoFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                ListItem dupItem = this.RONoFilter.Items.FindByText(fvalue);
                                ...
                                this.RONoFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.RONoFilter, selectedValue);
            ...
            if (this.RONoFilter.SelectedValue != null && this.RONoFilter.Items.FindByValue(this.RONoFilter.SelectedValue) == null)
                this.RONoFilter.SelectedValue = null;
                           
        }
            
        public virtual WhereClause CreateWhereClause_RONoFilter()
        {
            // Create a where clause for the filter RONoFilter.
            // This function is called by the Populate method to load the items 
            // in the RONoFilterDropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.RONoFilter, this.RONoFilter.SelectedValue);
      ...
      this.SaveToSession("RONoFilter_Ajax", this.RONoFilter.SelectedValue);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void RONoFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList RONoFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RONoFilter");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Show_RepairOrders_Table_Mobile1.RepairOrdersTableControlRow")));
