...
// Show_RepairOrders_Mobile1.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_RepairOrders_Mobile1
{
...
// Base class for the RepairOrdersRecordControl control on the Show_RepairOrders_Mobile1 page.
...
public class BaseRepairOrdersRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in RepairOrdersRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-RepairOrders-Mobile1"] = recId;
