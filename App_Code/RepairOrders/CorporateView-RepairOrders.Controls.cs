...
// CorporateView_RepairOrders.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.CorporateView_RepairOrders
{
...
// Base class for the RODetailsTableControlRow control on the CorporateView_RepairOrders page.
...
// Base class for the RODetailsTableControl control on the CorporateView_RepairOrders page.
...
#region "Helper Functions"
        ...
        public virtual RODetailsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RODetailsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.CorporateView_RepairOrders.RODetailsTableControlRow")));
...
// Base class for the RODetailsTableControl1Row control on the CorporateView_RepairOrders page.
...
// Base class for the RODetailsTableControl1 control on the CorporateView_RepairOrders page.
...
#region "Helper Functions"
        ...
        public virtual RODetailsTableControl1Row[] GetSelectedRecordControls()
        {
            ...
            return (RODetailsTableControl1Row[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.CorporateView_RepairOrders.RODetailsTableControl1Row")));
...
// Base class for the RODetailsTableControl2Row control on the CorporateView_RepairOrders page.
...
// Base class for the RODetailsTableControl2 control on the CorporateView_RepairOrders page.
...
#region "Helper Functions"
        ...
        public virtual RODetailsTableControl2Row[] GetSelectedRecordControls()
        {
            ...
            return (RODetailsTableControl2Row[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.CorporateView_RepairOrders.RODetailsTableControl2Row")));
...
// Base class for the AccessoriesRecordControl control on the CorporateView_RepairOrders page.
...
public class BaseAccessoriesRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in AccessoriesRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in CorporateView-RepairOrders"] = recId;
...
// Base class for the CustomerContactsRecordControl control on the CorporateView_RepairOrders page.
...
// Base class for the CustomersRecordControl control on the CorporateView_RepairOrders page.
...
// Base class for the RepairOrdersRecordControl control on the CorporateView_RepairOrders page.
...
public class BaseRepairOrdersRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetROFaultCodes()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
                ...
                // The Format method will return the Display Foreign Key As (DFKA) value
                string formattedValue = EvaluateFormula("IF(IsNull(ROFaultCodes),\"\",\"\" + GetColumnValue(\"FaultCodes\", ROFaultCodes, \"FaultCode\") + \"-\" + GetColumnValue(\"FaultCodes\", ROFaultCodes, \"FaultDesc\") +\"\")", this.DataSource);
        ...
        public virtual void SetROStatus()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
                ...
                // The Format method will return the Display Foreign Key As (DFKA) value
                string formattedValue = EvaluateFormula("GetColumnValue(\"Statues\",ROStatus,\"status_customer_caption\")", this.DataSource);
        ...
        public virtual void SetROWorkDoneNotes()
        {
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.RepairOrders record retrieved from the database.
            // this.ROWorkDoneNotes is the ASP:Literal on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.ROWorkDoneNotesSpecified) {
               ...
               string formattedValue = this.DataSource.Format(RepairOrdersTable.ROWorkDoneNotes);
                    ...
                    if (originalLength >= popupThreshold) {
                        ...
                        formattedValue = "<a onclick=\'gPersist=true;\' class=\'truncatedText\' onmouseout=\'detailRolloverPopupClose();\' " +
                            "onmouseover=\'SaveMousePosition(event); delayRolloverPopup(\"PageMethods.GetRecordFieldValue(\\\"" + "NULL" + "\\\", \\\"OEMConversion.Business.RepairOrdersTable, App_Code\\\",\\\"" +
                              (HttpUtility.UrlEncode(this.DataSource.GetID().ToString())).Replace("\\","\\\\\\\\") + "\\\", \\\"ROWorkDoneNotes\\\", \\\"ROWorkDoneNotes\\\", \\\"" +NetUtils.EncodeStringForHtmlDisplay(name.Substring(0, name.Length)) + "\\\",\\\"" + Page.GetResourceValue("Btn:Close", "OEMConversion") + "\\\", " +
                        " false, 200," +
                ...
                this.ROWorkDoneNotes.Text = formattedValue;
              ...
              this.ROWorkDoneNotes.Text = RepairOrdersTable.ROWorkDoneNotes.Format(RepairOrdersTable.ROWorkDoneNotes.DefaultValue);
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal ROWorkDoneNotes {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROWorkDoneNotes");
            }
        }
...
// Base class for the RepairOrdersRecordControl1 control on the CorporateView_RepairOrders page.
...
// Base class for the RepairOrdersRecordControl2 control on the CorporateView_RepairOrders page.
...
public class BaseRepairOrdersRecordControl2 : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetROWarranty1()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
                ...
                // The Format method will return the Display Foreign Key As (DFKA) value
                string formattedValue = EvaluateFormula("GetColumnValue(\"WarrantyPlans\",ROWarranty, \"PlanName\")", this.DataSource);
