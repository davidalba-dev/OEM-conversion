...
// History_Show_RepairOrders_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.History_Show_RepairOrders_Table
{
...
//public class Repairorder_historyViewControlRow : BaseRepairorder_historyViewControlRow
//{
//      
//        // The BaseRepairorder_historyViewControlRow implements code for a ROW within the
//        // the Repairorder_historyViewControl table.  The BaseRepairorder_historyViewControlRow implements the DataBind and SaveData methods.
//        // The loading of data is actually performed by the LoadData method in the base class of Repairorder_historyViewControl.
//
...
//public class Repairorder_historyViewControl : BaseRepairorder_historyViewControl
//{
//    // The BaseRepairorder_historyViewControl class implements the LoadData, DataBind, CreateWhereClause
//    // and other methods to load and display the data in a table control.
//
//    // This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
//    // The Repairorder_historyViewControlRow class offers another place where you can customize
...
// Base class for the Repairorder_historyTableControl1Row control on the History_Show_RepairOrders_Table page.
...
// Base class for the Repairorder_historyTableControl1 control on the History_Show_RepairOrders_Table page.
    ...
    public virtual void AddWarningMessageOnClick() {
      ...
      Repairorder_historyRecord rec = new Repairorder_historyRecord();
        ...
        CompoundFilter filter = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
            ...
            if (EvaluateFormula("Repairorder_historyTableControl1.ROCustNoFilter.SelectedValue", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.DepartmentTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"department_.custno"), EvaluateFormula("Repairorder_historyTableControl1.ROCustNoFilter.SelectedValue", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("History-Show-RepairOrders-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "repairorder_history";
                // If History-Show-RepairOrders-Table.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("History-Show-RepairOrders-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "repairorder_history";
                // If History-Show-RepairOrders-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual Repairorder_historyTableControl1Row[] GetSelectedRecordControls()
        {
            ...
            return (Repairorder_historyTableControl1Row[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.History_Show_RepairOrders_Table.Repairorder_historyTableControl1Row")));
