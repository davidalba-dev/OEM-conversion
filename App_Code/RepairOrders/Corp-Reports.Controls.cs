...
// Corp_Reports.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Corp_Reports
{
...
public class Repairorder_dashboardRecordControl : BaseRepairorder_dashboardRecordControl
{
      
        // The BaseRepairorder_dashboardRecordControl implements the LoadData, DataBind and other
...
// Base class for the Repairorder_dashboardRecordControl control on the Corp_Reports page.
// Do not modify this class. Instead override any method in Repairorder_dashboardRecordControl.
public class BaseRepairorder_dashboardRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseRepairorder_dashboardRecordControl()
        {
        ...
        // To customize, override this method in Repairorder_dashboardRecordControl.
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "Repairorder_dashboardRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            Repairorder_dashboardRecord[] recList = Repairorder_dashboardView.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = Repairorder_dashboardView.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public virtual void SetExpr1()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
                ...
                string formattedValue = EvaluateFormula("\"<a href= 'http://166.62.86.196/ReportServer/Pages/ReportViewer.aspx?%2fOEM%2fRepairOrderHistory&rs:Command=Render' target='_blank'><img src=../images/pdf-icon.png align=absmiddle></a>\"", this.DataSource);
        ...
        public virtual void SetExpr1Label1()
                  {
                  
                      //Code for the text property is generated inside the .aspx file. 
                      //To override this property you can uncomment the following property and add you own value.
                      //this.Expr1Label1.Text = "Some value";
      ...
      // To customize, override this method in Repairorder_dashboardRecordControl.
         ...
         
        {
            ...
            bool hasFiltersRepairorder_dashboardRecordControl = false;
            hasFiltersRepairorder_dashboardRecordControl = hasFiltersRepairorder_dashboardRecordControl && false; // suppress warning
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseRepairorder_dashboardRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseRepairorder_dashboardRecordControl_Rec"] = value;
            }
        }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal Expr1Label1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Expr1Label1");
            }
        }
