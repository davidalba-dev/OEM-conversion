...
// Show_RepairOrders_Table_CustomerContact.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_RepairOrders_Table_CustomerContact
{
...
// Base class for the RepairOrder_CustomerContactTableControlRow control on the Show_RepairOrders_Table_CustomerContact page.
// Do not modify this class. Instead override any method in RepairOrder_CustomerContactTableControlRow.
public class BaseRepairOrder_CustomerContactTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseRepairOrder_CustomerContactTableControlRow()
        {
        ...
        // To customize, override this method in RepairOrder_CustomerContactTableControlRow.
        ...
        {
            // Load the data from the database into the DataSource DatabaseAYS_OEM%dbo.RepairOrder_CustomerContact record.
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = RepairOrder_CustomerContactView.GetRecord(this.RecordUniqueId, true);
              
                return;
            }
      
            // Since this is a row in the table, the data for this row is loaded by the 
            // LoadData method of the BaseRepairOrder_CustomerContactTableControl when the data for the entire
            // table is loaded.
            
            this.DataSource = new RepairOrder_CustomerContactRecord();
        ...
        public virtual void Setcategory_id()
        {
            ...
            // DatabaseAYS_OEM%dbo.RepairOrder_CustomerContact database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.RepairOrder_CustomerContact record retrieved from the database.
            ...
            if (this.DataSource != null && this.DataSource.category_idSpecified) {
               ...
               Boolean _isExpandableNonCompositeForeignKey = RepairOrder_CustomerContactView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RepairOrder_CustomerContactView.category_id);
               if(_isExpandableNonCompositeForeignKey &&RepairOrder_CustomerContactView.category_id.IsApplyDisplayAs)
                                  
                     formattedValue = RepairOrder_CustomerContactView.GetDFKA(this.DataSource.category_id.ToString(),RepairOrder_CustomerContactView.category_id, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(RepairOrder_CustomerContactView.category_id);
              ...
              this.category_id.Text = RepairOrder_CustomerContactView.category_id.Format(RepairOrder_CustomerContactView.category_id.DefaultValue);
        ...
        public virtual void Setro_subtotal()
        {
            ...
            if (this.DataSource != null && this.DataSource.ro_subtotalSpecified) {
               ...
               string formattedValue = this.DataSource.Format(RepairOrder_CustomerContactView.ro_subtotal, @"C");
              ...
              this.ro_subtotal.Text = RepairOrder_CustomerContactView.ro_subtotal.Format(RepairOrder_CustomerContactView.ro_subtotal.DefaultValue, @"C");
        ...
        public virtual void SetRODate1()
        {
            ...
            if (this.DataSource != null && this.DataSource.RODateSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(RepairOrder_CustomerContactView.RODate, @"d");
              ...
              this.RODate1.Text = RepairOrder_CustomerContactView.RODate.Format(RepairOrder_CustomerContactView.RODate.DefaultValue, @"d");
        ...
        public virtual void SetRODeptIDNew()
        {
            ...
            if (this.DataSource != null && this.DataSource.RODeptIDNewSpecified) {
                ...
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = "";
               Boolean _isExpandableNonCompositeForeignKey = RepairOrder_CustomerContactView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RepairOrder_CustomerContactView.RODeptIDNew);
               if(_isExpandableNonCompositeForeignKey &&RepairOrder_CustomerContactView.RODeptIDNew.IsApplyDisplayAs)
                                  
                     formattedValue = RepairOrder_CustomerContactView.GetDFKA(this.DataSource.RODeptIDNew.ToString(),RepairOrder_CustomerContactView.RODeptIDNew, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(RepairOrder_CustomerContactView.RODeptIDNew);
              ...
              this.RODeptIDNew.Text = RepairOrder_CustomerContactView.RODeptIDNew.Format(RepairOrder_CustomerContactView.RODeptIDNew.DefaultValue);
        ...
        public virtual void SetROFaultCodes()
        {
            ...
            if (this.DataSource != null && this.DataSource.ROFaultCodesSpecified) {
                ...
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = "";
               Boolean _isExpandableNonCompositeForeignKey = RepairOrder_CustomerContactView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RepairOrder_CustomerContactView.ROFaultCodes);
               if(_isExpandableNonCompositeForeignKey &&RepairOrder_CustomerContactView.ROFaultCodes.IsApplyDisplayAs)
                                  
                     formattedValue = RepairOrder_CustomerContactView.GetDFKA(this.DataSource.ROFaultCodes.ToString(),RepairOrder_CustomerContactView.ROFaultCodes, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(RepairOrder_CustomerContactView.ROFaultCodes);
              ...
              this.ROFaultCodes.Text = RepairOrder_CustomerContactView.ROFaultCodes.Format(RepairOrder_CustomerContactView.ROFaultCodes.DefaultValue);
        ...
        public virtual void SetROMake1()
        {
            ...
            if (this.DataSource != null && this.DataSource.ROMakeSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(RepairOrder_CustomerContactView.ROMake);
              ...
              this.ROMake1.Text = RepairOrder_CustomerContactView.ROMake.Format(RepairOrder_CustomerContactView.ROMake.DefaultValue);
        ...
        public virtual void SetROModel1()
        {
            ...
            if (this.DataSource != null && this.DataSource.ROModelSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(RepairOrder_CustomerContactView.ROModel);
              ...
              this.ROModel1.Text = RepairOrder_CustomerContactView.ROModel.Format(RepairOrder_CustomerContactView.ROModel.DefaultValue);
        ...
        public virtual void SetRONo1()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
              ...
              this.RONo1.Text = RepairOrder_CustomerContactView.RONo.Format(RepairOrder_CustomerContactView.RONo.DefaultValue);
        ...
        public virtual void SetROReference()
        {
            ...
            if (this.DataSource != null && this.DataSource.ROReference1Specified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(RepairOrder_CustomerContactView.ROReference1);
              ...
              this.ROReference.Text = RepairOrder_CustomerContactView.ROReference1.Format(RepairOrder_CustomerContactView.ROReference1.DefaultValue);
        ...
        public virtual void SetROReference5()
        {
            ...
            if (this.DataSource != null && this.DataSource.ROReference4Specified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(RepairOrder_CustomerContactView.ROReference4);
              ...
              this.ROReference5.Text = RepairOrder_CustomerContactView.ROReference4.Format(RepairOrder_CustomerContactView.ROReference4.DefaultValue);
        ...
        public virtual void SetROSerialNo1()
        {
            ...
            if (this.DataSource != null && this.DataSource.ROSerialNoSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(RepairOrder_CustomerContactView.ROSerialNo);
              ...
              this.ROSerialNo1.Text = RepairOrder_CustomerContactView.ROSerialNo.Format(RepairOrder_CustomerContactView.ROSerialNo.DefaultValue);
        ...
        public virtual void SetROStatus1()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
                ...
                // The Format method will return the Display Foreign Key As (DFKA) value
                string formattedValue = EvaluateFormula("\"<div style='background-color:#\" + GetColumnValue(\"statuses\",ROStatus,\"status_color\")+\";'>\" + status_customer_caption + \" </div>\"", this.DataSource);
              ...
              this.ROStatus1.Text = RepairOrder_CustomerContactView.ROStatus.Format(RepairOrder_CustomerContactView.ROStatus.DefaultValue);
        ...
        public virtual void SaveData()
        {
            ...
            if (this.DataSource.IsAnyValueChanged) {
                ...
                ((RepairOrder_CustomerContactTableControl)MiscUtils.GetParentControlObject(this, "RepairOrder_CustomerContactTableControl")).DataChanged = true;
                ((RepairOrder_CustomerContactTableControl)MiscUtils.GetParentControlObject(this, "RepairOrder_CustomerContactTableControl")).ResetData = true;
            }
      ...
      // To customize, override this method in RepairOrder_CustomerContactTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersRepairOrder_CustomerContactTableControl = false;
            hasFiltersRepairOrder_CustomerContactTableControl = hasFiltersRepairOrder_CustomerContactTableControl && false; // suppress warning
        ...
        public virtual void Delete()
        {
          ...
          RepairOrder_CustomerContactView.DeleteRecord(pkValue);
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseRepairOrder_CustomerContactTableControlRow_Rec"];
            }
            set {
                this.ViewState["BaseRepairOrder_CustomerContactTableControlRow_Rec"] = value;
            }
        }
        
        public RepairOrder_CustomerContactRecord DataSource {
            get {
                return (RepairOrder_CustomerContactRecord)(this._DataSource);
            }
            set {
...
#region "Helper Properties"
    ...
    RepairOrder_CustomerContactRecord rec = null;
        ...
        public virtual RepairOrder_CustomerContactRecord GetRecord()
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return RepairOrder_CustomerContactView.GetRecord(this.RecordUniqueId, true);
...
// Base class for the RepairOrder_CustomerContactTableControl control on the Show_RepairOrders_Table_CustomerContact page.
// Do not modify this class. Instead override any method in RepairOrder_CustomerContactTableControl.
public class BaseRepairOrder_CustomerContactTableControl : OEMConversion.UI.BaseApplicationTableControl
{
         
       public BaseRepairOrder_CustomerContactTableControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.RepairOrder_CustomerContactSearchText1)) 				
                    initialVal = this.GetFromSession(this.RepairOrder_CustomerContactSearchText1);
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.RepairOrder_CustomerContactSearchText1.Text = initialVal;
            ...
            else
            {
                ...
                this.CurrentSortOrder.Add(RepairOrder_CustomerContactView.RODate, OrderByItem.OrderDir.Desc);
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
              ...
              this.ROReference2Label2.Click += ROReference2Label2_Click;
         ...
         //' Setup events for others
            AjaxControlToolkit.ToolkitScriptManager.RegisterStartupScript(this, this.GetType(), "RepairOrder_CustomerContactSearchText1SearchBoxText", "setSearchBoxText(\"" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "\", \"" + RepairOrder_CustomerContactSearchText1.ClientID + "\");", true);
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(OEMConversion.Business.RepairOrder_CustomerContactRecord);
                      this.DataSource = (RepairOrder_CustomerContactRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    foreach (RepairOrder_CustomerContactTableControlRow rc in this.GetRecordControls()) {
                        if (!rc.IsNewRecord) {
                    ...
                    Type myrec = typeof(OEMConversion.Business.RepairOrder_CustomerContactRecord);
                    this.DataSource = (RepairOrder_CustomerContactRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual RepairOrder_CustomerContactRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(RepairOrder_CustomerContactView.Column1, true);          
            // selCols.Add(RepairOrder_CustomerContactView.Column2, true);          
            // selCols.Add(RepairOrder_CustomerContactView.Column3, true);          
                  ...
                  
            {
                ...
                return RepairOrder_CustomerContactView.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                RepairOrder_CustomerContactView databaseTable = new RepairOrder_CustomerContactView();
                ...
                return (recList.ToArray(typeof(RepairOrder_CustomerContactRecord)) as RepairOrder_CustomerContactRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0)                 
                ...
                return RepairOrder_CustomerContactView.GetRecordCount(join, where);
            else
            {
                RepairOrder_CustomerContactView databaseTable = new RepairOrder_CustomerContactView();
                databaseTable.SelectedColumns.Clear();
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RepairOrder_CustomerContactTableControlRepeater"));
        if (rep == null){return;}
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            RepairOrder_CustomerContactTableControlRow recControl = (RepairOrder_CustomerContactTableControlRow)(repItem.FindControl("RepairOrder_CustomerContactTableControlRow"));
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetRepairOrder_CustomerContactSearchText1();
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(RepairOrder_CustomerContactView.category_id, this.DataSource);
            this.Page.PregetDfkaRecords(RepairOrder_CustomerContactView.RODeptIDNew, this.DataSource);
            this.Page.PregetDfkaRecords(RepairOrder_CustomerContactView.ROFaultCodes, this.DataSource);
            this.Page.PregetDfkaRecords(RepairOrder_CustomerContactView.ROStatus, this.DataSource);
        }
        ...
        public virtual void ResetControl()
        {
            ...
            this.RepairOrder_CustomerContactSearchText1.Text = "";
        ...
        protected virtual void BindPaginationControls()
        {
            ...
            // Bind the buttons for RepairOrder_CustomerContactTableControl pagination.
        ...
        public virtual void SaveData()
        {
            ...
            foreach (RepairOrder_CustomerContactTableControlRow recCtl in this.GetRecordControls())
            {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            RepairOrder_CustomerContactView.Instance.InnerFilter = null;
            ...
            if (MiscUtils.IsValueSelected(this.category_idFilter)) {
                ...
                wc.iAND(RepairOrder_CustomerContactView.category_id, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.category_idFilter, this.GetFromSession(this.category_idFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.RepairOrder_CustomerContactSearchText1)) {
                if (this.RepairOrder_CustomerContactSearchText1.Text == BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) ) {
                        this.RepairOrder_CustomerContactSearchText1.Text = "";
                } else {
                  // Strip "..." from begin and ending of the search text, otherwise the search will return 0 values as in database "..." is not stored.
                  if (this.RepairOrder_CustomerContactSearchText1.Text.StartsWith("...")) {
                      this.RepairOrder_CustomerContactSearchText1.Text = this.RepairOrder_CustomerContactSearchText1.Text.Substring(3,this.RepairOrder_CustomerContactSearchText1.Text.Length-3);
                  }
                  if (this.RepairOrder_CustomerContactSearchText1.Text.EndsWith("...")) {
                      this.RepairOrder_CustomerContactSearchText1.Text = this.RepairOrder_CustomerContactSearchText1.Text.Substring(0,this.RepairOrder_CustomerContactSearchText1.Text.Length-3);
                      // Strip the last word as well as it is likely only a partial word
                      int endindex = this.RepairOrder_CustomerContactSearchText1.Text.Length - 1;
                      while (!Char.IsWhiteSpace(RepairOrder_CustomerContactSearchText1.Text[endindex]) && endindex > 0) {
                          endindex--;
                      }
                      if (endindex > 0) {
                          this.RepairOrder_CustomerContactSearchText1.Text = this.RepairOrder_CustomerContactSearchText1.Text.Substring(0, endindex);
                      }
                  }
                }
                string formatedSearchText = MiscUtils.GetSelectedValue(this.RepairOrder_CustomerContactSearchText1, this.GetFromSession(this.RepairOrder_CustomerContactSearchText1));
      ...
      cols.Add(RepairOrder_CustomerContactView.ROMake, true);
      
      cols.Add(RepairOrder_CustomerContactView.ROModel, true);
      
      foreach(BaseColumn col in cols)
      {
      
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.RepairOrder_CustomerContactSearchText1, this.GetFromSession(this.RepairOrder_CustomerContactSearchText1)), true, false);
            ...
            if (MiscUtils.IsValueSelected(this.RODeptIDNewFromFilter)) {
                ...
                wc.iAND(RepairOrder_CustomerContactView.RODeptIDNew, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.RODeptIDNewFromFilter, this.GetFromSession(this.RODeptIDNewFromFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.ROFaultCodesFilter)) {
                        
                wc.iAND(RepairOrder_CustomerContactView.ROFaultCodes, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.ROFaultCodesFilter, this.GetFromSession(this.ROFaultCodesFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.RONoFromFilter)) {
                        
                wc.iAND(RepairOrder_CustomerContactView.RONo, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.RONoFromFilter, this.GetFromSession(this.RONoFromFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.ROSerialNoFilter)) {
                        
                wc.iAND(RepairOrder_CustomerContactView.ROSerialNo, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.ROSerialNoFilter, this.GetFromSession(this.ROSerialNoFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.ROMakeFilter)) {
                        
                wc.iAND(RepairOrder_CustomerContactView.ROMake, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.ROMakeFilter, this.GetFromSession(this.ROMakeFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.ROModelFilter)) {
                        
                wc.iAND(RepairOrder_CustomerContactView.ROModel, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.ROModelFilter, this.GetFromSession(this.ROModelFilter)), false, false);
      ...
      String category_idFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "category_idFilter_Ajax"];
            if (MiscUtils.IsValueSelected(category_idFilterSelectedValue)) {
                ...
                wc.iAND(RepairOrder_CustomerContactView.category_id, BaseFilter.ComparisonOperator.EqualsTo, category_idFilterSelectedValue, false, false);
                      
      }
                      
            if (MiscUtils.IsValueSelected(searchText) && fromSearchControl == "RepairOrder_CustomerContactSearchText1") {
      ...
      String RODeptIDNewFromFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "RODeptIDNewFromFilter_Ajax"];
            if (MiscUtils.IsValueSelected(RODeptIDNewFromFilterSelectedValue)) {
                ...
                wc.iAND(RepairOrder_CustomerContactView.RODeptIDNew, BaseFilter.ComparisonOperator.EqualsTo, RODeptIDNewFromFilterSelectedValue, false, false);
      ...
      String ROFaultCodesFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "ROFaultCodesFilter_Ajax"];
            if (MiscUtils.IsValueSelected(ROFaultCodesFilterSelectedValue)) {
                ...
                wc.iAND(RepairOrder_CustomerContactView.ROFaultCodes, BaseFilter.ComparisonOperator.EqualsTo, ROFaultCodesFilterSelectedValue, false, false);
      ...
      String RONoFromFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "RONoFromFilter_Ajax"];
            if (MiscUtils.IsValueSelected(RONoFromFilterSelectedValue)) {
                ...
                wc.iAND(RepairOrder_CustomerContactView.RONo, BaseFilter.ComparisonOperator.EqualsTo, RONoFromFilterSelectedValue, false, false);
      ...
      String ROSerialNoFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "ROSerialNoFilter_Ajax"];
            if (MiscUtils.IsValueSelected(ROSerialNoFilterSelectedValue)) {
                ...
                wc.iAND(RepairOrder_CustomerContactView.ROSerialNo, BaseFilter.ComparisonOperator.EqualsTo, ROSerialNoFilterSelectedValue, false, false);
      ...
      String ROMakeFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "ROMakeFilter_Ajax"];
            if (MiscUtils.IsValueSelected(ROMakeFilterSelectedValue)) {
                ...
                wc.iAND(RepairOrder_CustomerContactView.ROMake, BaseFilter.ComparisonOperator.EqualsTo, ROMakeFilterSelectedValue, false, false);
      ...
      String ROModelFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "ROModelFilter_Ajax"];
            if (MiscUtils.IsValueSelected(ROModelFilterSelectedValue)) {
                ...
                wc.iAND(RepairOrder_CustomerContactView.ROModel, BaseFilter.ComparisonOperator.EqualsTo, ROModelFilterSelectedValue, false, false);
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            filter.AddFilter(new BaseClasses.Data.ColumnJoinFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.RepairOrder_CustomerContactView, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"RepairOrder_CustomerContact_.RODeptIDNew"), new BaseClasses.Data.IdentifierAliasInfo(@"RepairOrder_CustomerContact_", null), BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.SecurityTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"security_.deptid"), new BaseClasses.Data.IdentifierAliasInfo(@"security_", null),  BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
            ...
            filter.AddFilter(new BaseClasses.Data.ColumnJoinFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.RepairOrder_CustomerContactView, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"RepairOrder_CustomerContact_.ROCustNo"), new BaseClasses.Data.IdentifierAliasInfo(@"RepairOrder_CustomerContact_", null), BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.LoginTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"login_.custno"), new BaseClasses.Data.IdentifierAliasInfo(@"login_", null),  BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
        ...
        public virtual string[] GetAutoCompletionList_RepairOrder_CustomerContactSearchText1(String prefixText,int count)
        {
            ArrayList resultList = new ArrayList();
            ArrayList wordList= new ArrayList();
            
            CompoundFilter filterJoin = CreateCompoundJoinFilter();    
            WhereClause wc = CreateWhereClause(prefixText,"RepairOrder_CustomerContactSearchText1", "WordsStartingWithSearchString", "[^a-zA-Z0-9]");
            if(count==0) count = 10;
            OEMConversion.Business.RepairOrder_CustomerContactRecord[] recordList  = RepairOrder_CustomerContactView.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (RepairOrder_CustomerContactRecord rec in recordList ){
                ...
                resultItem = rec.Format(RepairOrder_CustomerContactView.ROMake);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(RepairOrder_CustomerContactView.ROMake.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, RepairOrder_CustomerContactView.ROMake.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                resultItem = rec.Format(RepairOrder_CustomerContactView.ROModel);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(RepairOrder_CustomerContactView.ROModel.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, RepairOrder_CustomerContactView.ROModel.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
      ...
      RepairOrder_CustomerContactRecord rec = new RepairOrder_CustomerContactRecord();
        
                        if (recControl.category_id.Text != "") {
                            rec.Parse(recControl.category_id.Text, RepairOrder_CustomerContactView.category_id);
                  }
                
                        if (recControl.ro_subtotal.Text != "") {
                            rec.Parse(recControl.ro_subtotal.Text, RepairOrder_CustomerContactView.ro_subtotal);
                  }
                
                        if (recControl.RODate1.Text != "") {
                            rec.Parse(recControl.RODate1.Text, RepairOrder_CustomerContactView.RODate);
                  }
                
                        if (recControl.RODeptIDNew.Text != "") {
                            rec.Parse(recControl.RODeptIDNew.Text, RepairOrder_CustomerContactView.RODeptIDNew);
                  }
                
                        if (recControl.ROFaultCodes.Text != "") {
                            rec.Parse(recControl.ROFaultCodes.Text, RepairOrder_CustomerContactView.ROFaultCodes);
                  }
                
                        if (recControl.ROMake1.Text != "") {
                            rec.Parse(recControl.ROMake1.Text, RepairOrder_CustomerContactView.ROMake);
                  }
                
                        if (recControl.ROModel1.Text != "") {
                            rec.Parse(recControl.ROModel1.Text, RepairOrder_CustomerContactView.ROModel);
                  }
                
                        if (recControl.RONo1.Text != "") {
                            rec.Parse(recControl.RONo1.Text, RepairOrder_CustomerContactView.RONo);
                  }
                
                        if (recControl.ROReference.Text != "") {
                            rec.Parse(recControl.ROReference.Text, RepairOrder_CustomerContactView.ROReference1);
                  }
                
                        if (recControl.ROReference5.Text != "") {
                            rec.Parse(recControl.ROReference5.Text, RepairOrder_CustomerContactView.ROReference4);
                  }
                
                        if (recControl.ROSerialNo1.Text != "") {
                            rec.Parse(recControl.ROSerialNo1.Text, RepairOrder_CustomerContactView.ROSerialNo);
                  }
                
                        if (recControl.ROStatus1.Text != "") {
                            rec.Parse(recControl.ROStatus1.Text, RepairOrder_CustomerContactView.ROStatus);
                  }
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new RepairOrder_CustomerContactRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(OEMConversion.Business.RepairOrder_CustomerContactRecord);
                this.DataSource = (RepairOrder_CustomerContactRecord[])(finalList.ToArray(myrec));
        ...
        public void AddToDeletedRecordIds(RepairOrder_CustomerContactTableControlRow rec)
        {
            if (rec.IsNewRecord) {
                return;
            }
        ...
        protected virtual bool InDeletedRecordIds(RepairOrder_CustomerContactTableControlRow rec)            
        {
            if (this.DeletedRecordIds == null || this.DeletedRecordIds.Length == 0) {
                return (false);
            }
        ...
        public virtual void SetROReference2Label2()
                  {
        ...
        public virtual void SetRepairOrder_CustomerContactSearchText1()
        {
                                            
            this.RepairOrder_CustomerContactSearchText1.Attributes.Add("onfocus", "if(this.value=='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "') {this.value='';this.className='Search_Input';}");
            this.RepairOrder_CustomerContactSearchText1.Attributes.Add("onblur", "if(this.value=='') {this.value='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "';this.className='Search_InputHint';}");
        ...
        public virtual void SetROMakeFilter()
        {
            ...
            this.PopulateROMakeFilter(MiscUtils.GetSelectedValue(this.ROMakeFilter,  GetFromSession(this.ROMakeFilter)), 500);					
                    ...
                    foreach (CategoriesRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.category_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.category_idFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                Boolean _isExpandableNonCompositeForeignKey = RepairOrder_CustomerContactView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RepairOrder_CustomerContactView.category_id);
                                if(_isExpandableNonCompositeForeignKey && RepairOrder_CustomerContactView.category_id.IsApplyDisplayAs)
                                     fvalue = RepairOrder_CustomerContactView.GetDFKA(itemValue, RepairOrder_CustomerContactView.category_id);
                    ...
                    foreach (FaultCodesRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.FaultCodeSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.ROFaultCodesFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                Boolean _isExpandableNonCompositeForeignKey = RepairOrder_CustomerContactView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RepairOrder_CustomerContactView.ROFaultCodes);
                                if(_isExpandableNonCompositeForeignKey && RepairOrder_CustomerContactView.ROFaultCodes.IsApplyDisplayAs)
                                     fvalue = RepairOrder_CustomerContactView.GetDFKA(itemValue, RepairOrder_CustomerContactView.ROFaultCodes);
                                if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
                    ...
                    
        {
            ...
            OrderBy orderBy = new OrderBy(false, false);
                          orderBy.Add(RepairOrder_CustomerContactView.ROSerialNo, OrderByItem.OrderDir.Asc);
            ...
            RepairOrder_CustomerContactRecord[] itemValues  = null;
            if (wc.RunQuery)
            {
                int counter = 0;
                int pageNum = 0;
                ...
                do
                {
                    ...
                    itemValues = RepairOrder_CustomerContactView.GetRecords(wc, orderBy, pageNum, maxItems);
                                    
                    foreach (RepairOrder_CustomerContactRecord itemValue in itemValues) 
                    {
                        // Create the item and add to the list.
                        string cvalue = null;
                        string fvalue = null;
            ...
            if (wc.RunQuery)
            {
                ...
                do
                {
                    ...
                    foreach (StatusesRecord itemValue in itemValues) 
                    {
                        ...
                        string cvalue = null;
                        string fvalue = null;
                        if (itemValue.status_customer_captionSpecified) 
                        {
                            cvalue = itemValue.status_customer_caption.ToString();
                            if (counter < maxItems && this.ROStatusFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                variables.Add(itemValue.TableAccess.TableDefinition.TableCodeName, itemValue);
                                fvalue = EvaluateFormula("status_customer_caption", itemValue , variables, evaluator);
                    ...
                    
        {
            ...
            OrderBy orderBy = new OrderBy(false, false);
                          orderBy.Add(RepairOrder_CustomerContactView.ROMake, OrderByItem.OrderDir.Asc);
            ...
            if (wc.RunQuery)
            {
                ...
                do
                {
                    ...
                    foreach (RepairOrder_CustomerContactRecord itemValue in itemValues) 
                    {
                        ...
                        string cvalue = null;
                        string fvalue = null;
                        if (itemValue.ROMakeSpecified) 
                        {
                            cvalue = itemValue.ROMake.ToString();
                            if (counter < maxItems && this.ROMakeFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                variables.Add(itemValue.TableAccess.TableDefinition.TableCodeName, itemValue);
                                fvalue = EvaluateFormula("ROMake", itemValue , variables, evaluator);
                    ...
                    
        {
            ...
            OrderBy orderBy = new OrderBy(false, false);
                          orderBy.Add(RepairOrder_CustomerContactView.ROModel, OrderByItem.OrderDir.Asc);
            ...
            if (wc.RunQuery)
            {
                ...
                do
                {
                    ...
                    foreach (RepairOrder_CustomerContactRecord itemValue in itemValues) 
                    {
                        ...
                        string cvalue = null;
                        string fvalue = null;
                        if (itemValue.ROModelSpecified) 
                        {
                            cvalue = itemValue.ROModel.ToString();
                            if (counter < maxItems && this.ROModelFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                variables.Add(itemValue.TableAccess.TableDefinition.TableCodeName, itemValue);
                                fvalue = EvaluateFormula("ROModel", itemValue , variables, evaluator);
        ...
        CompoundFilter filter = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
            ...
            filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.DepartmentTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"department_.department_active"), EvaluateFormula("1", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
        ...
        CompoundFilter filter = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
            ...
            if (EvaluateFormula("RepairOrder_CustomerContactTableControl.ROCategoryFilter.SelectedValue", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.RepairOrder_CustomerContactView, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"RepairOrder_CustomerContact_.ROCategory"), EvaluateFormula("RepairOrder_CustomerContactTableControl.ROCategoryFilter.SelectedValue", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("RepairOrder_CustomerContactTableControl.ROCategoryFilter.SelectedValue", false) == "--PLEASE_SELECT--" || EvaluateFormula("RepairOrder_CustomerContactTableControl.ROCategoryFilter.SelectedValue", false) == "--ANY--") whereClause.RunQuery = false;
        ...
        CompoundFilter filter = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
            ...
            if (EvaluateFormula("RepairOrder_CustomerContactTableControl.ROMakeFilter.SelectedValue", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.RepairOrder_CustomerContactView, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"RepairOrder_CustomerContact_.ROMake"), EvaluateFormula("RepairOrder_CustomerContactTableControl.ROMakeFilter.SelectedValue", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("RepairOrder_CustomerContactTableControl.ROMakeFilter.SelectedValue", false) == "--PLEASE_SELECT--" || EvaluateFormula("RepairOrder_CustomerContactTableControl.ROMakeFilter.SelectedValue", false) == "--ANY--") whereClause.RunQuery = false;
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.RepairOrder_CustomerContactSearchText1, this.RepairOrder_CustomerContactSearchText1.Text);
      ...
      this.SaveToSession("RepairOrder_CustomerContactSearchText1_Ajax", this.RepairOrder_CustomerContactSearchText1.Text);
      ...
      this.SaveToSession("ROModelFilter_Ajax", this.ROModelFilter.SelectedValue);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.RepairOrder_CustomerContactSearchText1);
    ...
    this.RemoveFromSession(this, "Page_Size");
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            string orderByStr = (string)ViewState["RepairOrder_CustomerContactTableControl_OrderBy"];
        ...
        {            
            ...
            if (this.CurrentSortOrder != null) {
                this.ViewState["RepairOrder_CustomerContactTableControl_OrderBy"] = this.CurrentSortOrder.ToXmlString();
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
         ...
         themeButtonFilters1Button.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(ROStatusFilter))
                themeButtonFilters1Button.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        ...
        public virtual void ROCategoryLabel1_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContactView.ROCategory);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContactView.ROCategory, OrderByItem.OrderDir.Asc);
        ...
        public virtual void RODateLabel2_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContactView.RODate);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContactView.RODate, OrderByItem.OrderDir.Asc);
        ...
        public virtual void ROFaultCodesLabel1_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContactView.ROFaultCodes);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContactView.ROFaultCodes, OrderByItem.OrderDir.Asc);
        ...
        public virtual void ROMakeLabel2_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContactView.ROMake);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContactView.ROMake, OrderByItem.OrderDir.Asc);
        ...
        public virtual void ROModelLabel2_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContactView.ROModel);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContactView.ROModel, OrderByItem.OrderDir.Asc);
        ...
        public virtual void RONoLabel1_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContactView.RONo);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContactView.RONo, OrderByItem.OrderDir.Asc);
        ...
        public virtual void ROReference1Label1_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContactView.ROReference1);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContactView.ROReference1, OrderByItem.OrderDir.Asc);
        ...
        public virtual void ROReference2Label2_Click(object sender, EventArgs args)
        {
            //Sorts by RODeptIDNew when clicked.
              
            // Get previous sorting state for RODeptIDNew.
        
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContactView.RODeptIDNew);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContactView.RODeptIDNew, OrderByItem.OrderDir.Asc);
        ...
        public virtual void ROReference4Label1_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContactView.ROReference4);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContactView.ROReference4, OrderByItem.OrderDir.Asc);
        ...
        public virtual void ROSerialNoLabel2_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContactView.ROSerialNo);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContactView.ROSerialNo, OrderByItem.OrderDir.Asc);
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = RepairOrder_CustomerContactView.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
              
                // Add each of the columns in order of export.
                BaseColumn[] columns = new BaseColumn[] {
                             RepairOrder_CustomerContactView.RONo,
             RepairOrder_CustomerContactView.RODate,
             RepairOrder_CustomerContactView.ro_subtotal,
             RepairOrder_CustomerContactView.ROMake,
             RepairOrder_CustomerContactView.ROModel,
             RepairOrder_CustomerContactView.ROReference1,
             RepairOrder_CustomerContactView.ROReference4,
             RepairOrder_CustomerContactView.ROSerialNo,
             RepairOrder_CustomerContactView.ROStatus,
             RepairOrder_CustomerContactView.RODeptIDNew,
             RepairOrder_CustomerContactView.ROFaultCodes,
             RepairOrder_CustomerContactView.category_id,
             null};
                ExportDataToCSV exportData = new ExportDataToCSV(RepairOrder_CustomerContactView.Instance,wc,orderBy,columns);
                exportData.StartExport(this.Page.Response, true);

                DataForExport dataForCSV = new DataForExport(RepairOrder_CustomerContactView.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(RepairOrder_CustomerContactView.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(RepairOrder_CustomerContactView.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContactView.RONo, "0"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContactView.RODate, "Short Date"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContactView.ro_subtotal, "Currency"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContactView.ROMake, "Default"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContactView.ROModel, "Default"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContactView.ROReference1, "Default"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContactView.ROReference4, "Default"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContactView.ROSerialNo, "Default"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContactView.ROStatus, "Default"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContactView.RODeptIDNew, "Default"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContactView.ROFaultCodes, "Default"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContactView.category_id, "Default"));
              ...
              {
                val = RepairOrder_CustomerContactView.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-RepairOrders-Table-CustomerContact.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RepairOrder_CustomerContact";
                // If Show-RepairOrders-Table-CustomerContact.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(RepairOrder_CustomerContactView.RONo.Name, ReportEnum.Align.Right, "${RONo}", ReportEnum.Align.Right, 15);
                 report.AddColumn(RepairOrder_CustomerContactView.RODate.Name, ReportEnum.Align.Left, "${RODate}", ReportEnum.Align.Left, 20);
                 report.AddColumn(RepairOrder_CustomerContactView.ro_subtotal.Name, ReportEnum.Align.Right, "${ro_subtotal}", ReportEnum.Align.Right, 20);
                 report.AddColumn(RepairOrder_CustomerContactView.ROMake.Name, ReportEnum.Align.Left, "${ROMake}", ReportEnum.Align.Left, 24);
                 report.AddColumn(RepairOrder_CustomerContactView.ROModel.Name, ReportEnum.Align.Left, "${ROModel}", ReportEnum.Align.Left, 28);
                 report.AddColumn(RepairOrder_CustomerContactView.ROReference1.Name, ReportEnum.Align.Left, "${ROReference1}", ReportEnum.Align.Left, 24);
                 report.AddColumn(RepairOrder_CustomerContactView.ROReference4.Name, ReportEnum.Align.Left, "${ROReference4}", ReportEnum.Align.Left, 24);
                 report.AddColumn(RepairOrder_CustomerContactView.ROSerialNo.Name, ReportEnum.Align.Left, "${ROSerialNo}", ReportEnum.Align.Left, 28);
                 report.AddColumn(RepairOrder_CustomerContactView.ROStatus.Name, ReportEnum.Align.Left, "${ROStatus}", ReportEnum.Align.Left, 29);
                 report.AddColumn(RepairOrder_CustomerContactView.RODeptIDNew.Name, ReportEnum.Align.Left, "${RODeptIDNew}", ReportEnum.Align.Left, 30);
                 report.AddColumn(RepairOrder_CustomerContactView.ROFaultCodes.Name, ReportEnum.Align.Left, "${ROFaultCodes}", ReportEnum.Align.Left, 27);
                 report.AddColumn(RepairOrder_CustomerContactView.category_id.Name, ReportEnum.Align.Left, "${category_id}", ReportEnum.Align.Left, 30);
                ...
                ColumnList columns = RepairOrder_CustomerContactView.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = RepairOrder_CustomerContactView.GetRecordCount(joinFilter,whereClause);
                RepairOrder_CustomerContactRecord[] records = null;
                
                do
                {
                    
                    records = RepairOrder_CustomerContactView.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( RepairOrder_CustomerContactRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${RONo}", record.Format(RepairOrder_CustomerContactView.RONo), ReportEnum.Align.Right, 300);
                             report.AddData("${RODate}", record.Format(RepairOrder_CustomerContactView.RODate), ReportEnum.Align.Left, 300);
                             report.AddData("${ro_subtotal}", record.Format(RepairOrder_CustomerContactView.ro_subtotal), ReportEnum.Align.Right, 300);
                             report.AddData("${ROMake}", record.Format(RepairOrder_CustomerContactView.ROMake), ReportEnum.Align.Left, 300);
                             report.AddData("${ROModel}", record.Format(RepairOrder_CustomerContactView.ROModel), ReportEnum.Align.Left, 300);
                             report.AddData("${ROReference1}", record.Format(RepairOrder_CustomerContactView.ROReference1), ReportEnum.Align.Left, 300);
                             report.AddData("${ROReference4}", record.Format(RepairOrder_CustomerContactView.ROReference4), ReportEnum.Align.Left, 300);
                             report.AddData("${ROSerialNo}", record.Format(RepairOrder_CustomerContactView.ROSerialNo), ReportEnum.Align.Left, 300);
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.ROStatus)){
                                 report.AddData("${ROStatus}", "",ReportEnum.Align.Left, 300);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = RepairOrder_CustomerContactView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RepairOrder_CustomerContactView.ROStatus);
                                 _DFKA = RepairOrder_CustomerContactView.GetDFKA(record.ROStatus.ToString(), RepairOrder_CustomerContactView.ROStatus,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  RepairOrder_CustomerContactView.ROStatus.IsApplyDisplayAs){
                                     report.AddData("${ROStatus}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${ROStatus}", record.Format(RepairOrder_CustomerContactView.ROStatus), ReportEnum.Align.Left, 300);
                                 }
                             }
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.RODeptIDNew)){
                                 ...
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = RepairOrder_CustomerContactView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RepairOrder_CustomerContactView.RODeptIDNew);
                                 _DFKA = RepairOrder_CustomerContactView.GetDFKA(record.RODeptIDNew.ToString(), RepairOrder_CustomerContactView.RODeptIDNew,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  RepairOrder_CustomerContactView.RODeptIDNew.IsApplyDisplayAs){
                                     report.AddData("${RODeptIDNew}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${RODeptIDNew}", record.Format(RepairOrder_CustomerContactView.RODeptIDNew), ReportEnum.Align.Left, 300);
                                 }
                             }
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.ROFaultCodes)){
                                 ...
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = RepairOrder_CustomerContactView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RepairOrder_CustomerContactView.ROFaultCodes);
                                 _DFKA = RepairOrder_CustomerContactView.GetDFKA(record.ROFaultCodes.ToString(), RepairOrder_CustomerContactView.ROFaultCodes,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  RepairOrder_CustomerContactView.ROFaultCodes.IsApplyDisplayAs){
                                     report.AddData("${ROFaultCodes}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${ROFaultCodes}", record.Format(RepairOrder_CustomerContactView.ROFaultCodes), ReportEnum.Align.Left, 300);
                                 }
                             }
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.category_id)){
                                 ...
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = RepairOrder_CustomerContactView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RepairOrder_CustomerContactView.category_id);
                                 _DFKA = RepairOrder_CustomerContactView.GetDFKA(record.category_id.ToString(), RepairOrder_CustomerContactView.category_id,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  RepairOrder_CustomerContactView.category_id.IsApplyDisplayAs){
                                     report.AddData("${category_id}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${category_id}", record.Format(RepairOrder_CustomerContactView.category_id), ReportEnum.Align.Left, 300);
                                 }
                             }
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-RepairOrders-Table-CustomerContact.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RepairOrder_CustomerContact";
                // If Show-RepairOrders-Table-CustomerContact.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = RepairOrder_CustomerContactView.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  RepairOrder_CustomerContactRecord[] DataSource {
            ...
            get {
                return (RepairOrder_CustomerContactRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox RepairOrder_CustomerContactSearchText1 {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RepairOrder_CustomerContactSearchText1");
            }
        }
        ...
        public System.Web.UI.WebControls.Label ROGrandTotalLabel {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROGrandTotalLabel");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton ROReference2Label2 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROReference2Label2");
            }
        }
        ...
        public System.Web.UI.WebControls.Label ROStatusLabel2 {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROStatusLabel2");
            }
        }
...
#region "Helper Functions"
        ...
        public override string EvaluateExpressions(string url, string arg, bool bEncrypt)
        {
            ...
            if (needToProcess) {
                RepairOrder_CustomerContactTableControlRow recCtl = this.GetSelectedRecordControl();
        ...
        public virtual RepairOrder_CustomerContactTableControlRow GetSelectedRecordControl()
        {
        ...
        public virtual RepairOrder_CustomerContactTableControlRow[] GetSelectedRecordControls()
        {
        
            return (RepairOrder_CustomerContactTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_RepairOrders_Table_CustomerContact.RepairOrder_CustomerContactTableControlRow")));
          
        }

        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            RepairOrder_CustomerContactTableControlRow[] recordList = this.GetSelectedRecordControls();
            if (recordList.Length == 0) {
                // Localization.
                throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "OEMConversion"));
            }
            
            foreach (RepairOrder_CustomerContactTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
        ...
        public virtual RepairOrder_CustomerContactTableControlRow[] GetRecordControls()
        {
            Control[] recCtrls = BaseClasses.Utils.MiscUtils.FindControlsRecursively(this, "RepairOrder_CustomerContactTableControlRow");
	          List<RepairOrder_CustomerContactTableControlRow> list = new List<RepairOrder_CustomerContactTableControlRow>();
	          foreach (RepairOrder_CustomerContactTableControlRow recCtrl in recCtrls) {
		          list.Add(recCtrl);
	          }
	          return list.ToArray();
        }
