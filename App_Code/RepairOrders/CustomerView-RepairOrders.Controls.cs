...
// CustomerView_RepairOrders.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.CustomerView_RepairOrders
{
...
// Base class for the Notification_logTableControlRow control on the CustomerView_RepairOrders page.
...
// Base class for the Notification_logTableControl control on the CustomerView_RepairOrders page.
...
public class BaseNotification_logTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    RepairOrdersRecordControl repairOrdersRecordControlObj = (MiscUtils.GetParentControlObject(this, "RepairOrdersRecordControl") as RepairOrdersRecordControl);
            AccessoriesRecordControl accessoriesRecordControlObj = (MiscUtils.FindControlRecursively(repairOrdersRecordControlObj , "AccessoriesRecordControl") as AccessoriesRecordControl);
              ...
              {
              wc.iAND(Notification_logTable.rono, BaseFilter.ComparisonOperator.EqualsTo, accessoriesRecordControlObj.GetRecord().RONo.ToString());
              selectedRecordKeyValue.AddElement(Notification_logTable.rono.InternalName, accessoriesRecordControlObj.GetRecord().RONo.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInAccessoriesRecordControl = HttpContext.Current.Session["Notification_logTableControlWhereClause"] as string;
...
#region "Helper Functions"
        ...
        public virtual Notification_logTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Notification_logTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.CustomerView_RepairOrders.Notification_logTableControlRow")));
...
// Base class for the RODetailsTableControlRow control on the CustomerView_RepairOrders page.
...
// Base class for the RODetailsTableControl control on the CustomerView_RepairOrders page.
...
#region "Helper Functions"
        ...
        public virtual RODetailsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RODetailsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.CustomerView_RepairOrders.RODetailsTableControlRow")));
...
// Base class for the RODetailsTableControl1Row control on the CustomerView_RepairOrders page.
...
// Base class for the RODetailsTableControl1 control on the CustomerView_RepairOrders page.
...
#region "Helper Functions"
        ...
        public virtual RODetailsTableControl1Row[] GetSelectedRecordControls()
        {
            ...
            return (RODetailsTableControl1Row[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.CustomerView_RepairOrders.RODetailsTableControl1Row")));
...
// Base class for the RODetailsTableControl2Row control on the CustomerView_RepairOrders page.
...
// Base class for the RODetailsTableControl2 control on the CustomerView_RepairOrders page.
...
#region "Helper Functions"
        ...
        public virtual RODetailsTableControl2Row[] GetSelectedRecordControls()
        {
            ...
            return (RODetailsTableControl2Row[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.CustomerView_RepairOrders.RODetailsTableControl2Row")));
...
// Base class for the AccessoriesRecordControl control on the CustomerView_RepairOrders page.
...
public class BaseAccessoriesRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public override void DataBind()
        {
          ...
          Notification_logTableControl recNotification_logTableControl = (Notification_logTableControl)(MiscUtils.FindControlRecursively(recRepairOrdersRecordControl, "Notification_logTableControl"));
           
            if (shouldResetControl || this.Page.IsPageRefresh)
                recNotification_logTableControl.ResetControl();
          
              recRepairOrdersRecordControl.SetNotification_logTableControl();
      ...
      // To customize, override this method in AccessoriesRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in CustomerView-RepairOrders"] = recId;
...
// Base class for the CustomerContactsRecordControl control on the CustomerView_RepairOrders page.
...
// Base class for the CustomersRecordControl control on the CustomerView_RepairOrders page.
    ...
    RepairOrdersRecordControl repairOrdersRecordControlObj = (MiscUtils.GetParentControlObject(this, "RepairOrdersRecordControl") as RepairOrdersRecordControl);
      ...
      wc.iAND(CustomersTable.CustNo, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(CustomersTable.CustNo).ToString());
        ...
        public virtual void Button_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Customers/Show-Customers.aspx?customers={CustomersRecordControl:FV:CustNo}";
...
// Base class for the InvoiceDetails control on the CustomerView_RepairOrders page.
...
public class BaseInvoiceDetails : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetPayTerms()
        {
            ...
            if (this.DataSource != null && this.DataSource.ROPayTermsSpecified) {
              ...
              this.PayTerms.Text = RepairOrdersTable.ROPayTerms.Format(RepairOrdersTable.ROPayTerms.DefaultValue);
      ...
      // To customize, override this method in InvoiceDetails.
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            this.Page.Authorize((Control)PayTerms, "1;2;3;4;5");
					
            this.Page.Authorize((Control)ro_labortotal_calc, "4;5");
					
            this.Page.Authorize((Control)ROLaborLabel, "4;5");
					
            this.Page.Authorize((Control)ROPayMethod, "4;5");
					
            this.Page.Authorize((Control)ROPayMethodLabel, "4;5");
					
            this.Page.Authorize((Control)ROPayTermsLabel, "4;5");
					
            this.Page.Authorize((Control)ROPreapproved1, "4;5");
					
            this.Page.Authorize((Control)ROPreapprovedLabel1, "4;5");
...
// Base class for the RepairOrdersRecordControl control on the CustomerView_RepairOrders page.
...
public class BaseRepairOrdersRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetFaultDesc()
        {
            ...
            // Set the FaultDesc Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.RepairOrders database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.RepairOrders record retrieved from the database.
            // this.FaultDesc is the ASP:Literal on the webpage.
                  
            if (this.DataSource != null && this.DataSource.FaultDescSpecified) {
                								
                // If the FaultDesc is non-NULL, then format the value.
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(RepairOrdersTable.FaultDesc);
              ...
              this.FaultDesc.Text = RepairOrdersTable.FaultDesc.Format(RepairOrdersTable.FaultDesc.DefaultValue);
        ...
        public virtual void SetRONo()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
                ...
                // The Format method will return the Display Foreign Key As (DFKA) value
                string formattedValue = EvaluateFormula("\"<a href= 'http://166.62.86.196/ReportServer/Pages/ReportViewer.aspx?%2fOEM%2fRepairOrderSummary&rs:Command=Render&rs:Format=PDF&rono=\" + RONo  + \"' target='_blank'><img src=../images/pdf-icon.png align=absmiddle border=0></a>)\"", this.DataSource);
      ...
      // To customize, override this method in RepairOrdersRecordControl.
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
			...
			if (!(((Control)(this.FindControl("RepairOrdersRecordControlTabContainer"))) == null)) {
				...
				this.Page.Authorize(((Control)(parentTC.FindControl("TabPanel"))), "2;4;5;6");
			}
					
			if (!(((Control)(this.FindControl("RepairOrdersRecordControlTabContainer"))) == null)) {
				Control parentTC = ((Control)(this.FindControl("RepairOrdersRecordControlTabContainer")));
				this.Page.Authorize(((Control)(parentTC.FindControl("TabPanel1"))), "2;4;5;6");
			}
					
			if (!(((Control)(this.FindControl("RepairOrdersRecordControlTabContainer"))) == null)) {
				Control parentTC = ((Control)(this.FindControl("RepairOrdersRecordControlTabContainer")));
				this.Page.Authorize(((Control)(parentTC.FindControl("TabPanel3"))), "2");
			}
					
			if (!(((Control)(this.FindControl("RepairOrdersRecordControlTabContainer"))) == null)) {
				Control parentTC = ((Control)(this.FindControl("RepairOrdersRecordControlTabContainer")));
				this.Page.Authorize(((Control)(parentTC.FindControl("TabPanel9"))), "2;4;5;6");
			}
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal FaultDesc {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "FaultDesc");
            }
        }
...
// Base class for the RepairOrdersRecordControl1 control on the CustomerView_RepairOrders page.
...
// Base class for the RepairOrdersRecordControl2 control on the CustomerView_RepairOrders page.
