...
// Show_RepairOrders_Table_Customer_History_Backup.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_RepairOrders_Table_Customer_History_Backup
{
...
// Base class for the Repairorder_historyTableControlRow control on the Show_RepairOrders_Table_Customer_History_Backup page.
...
// Base class for the Repairorder_historyTableControl control on the Show_RepairOrders_Table_Customer_History_Backup page.
    ...
    // Setup default pagination settings.
      ...
      public override void DataBind()
      {
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            filter.AddFilter(new BaseClasses.Data.ColumnJoinFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Repairorder_historyView, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"repairorder_history_.ROCustNo"), new BaseClasses.Data.IdentifierAliasInfo(@"repairorder_history_", null), BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.CustomerContactsTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"CustomerContacts_.CustNo"), new BaseClasses.Data.IdentifierAliasInfo(@"CustomerContacts_", null),  BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
...
#region "Helper Functions"
        ...
        public virtual Repairorder_historyTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Repairorder_historyTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_RepairOrders_Table_Customer_History_Backup.Repairorder_historyTableControlRow")));
...
// Base class for the Max_repairorderRecordControl1 control on the Show_RepairOrders_Table_Customer_History_Backup page.
