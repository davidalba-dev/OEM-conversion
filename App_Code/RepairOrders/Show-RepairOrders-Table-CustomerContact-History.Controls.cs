...
// Show_RepairOrders_Table_CustomerContact_History.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_RepairOrders_Table_CustomerContact_History
{
...
//public class RepairOrder_CustomerContact_HistoryTableControl : BaseRepairOrder_CustomerContact_HistoryTableControl
//{
//    // The BaseRepairOrder_CustomerContact_HistoryTableControl class implements the LoadData, DataBind, CreateWhereClause
//    // and other methods to load and display the data in a table control.
//
//    // This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
//    // The RepairOrder_CustomerContact_HistoryTableControlRow class offers another place where you can customize
//    // the DataBind, GetUIData, SaveData and Validate methods specific to each row displayed on the table.
//
//}
//
//public class RepairOrder_CustomerContact_HistoryTableControlRow : BaseRepairOrder_CustomerContact_HistoryTableControlRow
//{
//      
//        // The BaseRepairOrder_CustomerContact_HistoryTableControlRow implements code for a ROW within the
//        // the RepairOrder_CustomerContact_HistoryTableControl table.  The BaseRepairOrder_CustomerContact_HistoryTableControlRow implements the DataBind and SaveData methods.
//        // The loading of data is actually performed by the LoadData method in the base class of RepairOrder_CustomerContact_HistoryTableControl.
//
//        // This is the ideal place to add your code customizations. For example, you can override the DataBind, 
//        // SaveData, GetUIData, and Validate methods.
//        
//}
//
public class RepairOrder_CustomerContact_HistoryTableControl1 : BaseRepairOrder_CustomerContact_HistoryTableControl1
{
    // The BaseRepairOrder_CustomerContact_HistoryTableControl1 class implements the LoadData, DataBind, CreateWhereClause
    // and other methods to load and display the data in a table control.

    // This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
    // The RepairOrder_CustomerContact_HistoryTableControl1Row class offers another place where you can customize
    // the DataBind, GetUIData, SaveData and Validate methods specific to each row displayed on the table.

}
public class RepairOrder_CustomerContact_HistoryTableControl1Row : BaseRepairOrder_CustomerContact_HistoryTableControl1Row
{
      
        // The BaseRepairOrder_CustomerContact_HistoryTableControl1Row implements code for a ROW within the
        // the RepairOrder_CustomerContact_HistoryTableControl1 table.  The BaseRepairOrder_CustomerContact_HistoryTableControl1Row implements the DataBind and SaveData methods.
        // The loading of data is actually performed by the LoadData method in the base class of RepairOrder_CustomerContact_HistoryTableControl1.
...
// Base class for the RepairOrder_CustomerContact_HistoryTableControl1Row control on the Show_RepairOrders_Table_CustomerContact_History page.
// Do not modify this class. Instead override any method in RepairOrder_CustomerContact_HistoryTableControl1Row.
public class BaseRepairOrder_CustomerContact_HistoryTableControl1Row : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseRepairOrder_CustomerContact_HistoryTableControl1Row()
        {
        ...
        // To customize, override this method in RepairOrder_CustomerContact_HistoryTableControl1Row.
        ...
        {
            // Load the data from the database into the DataSource DatabaseAYS_OEM%dbo.RepairOrder_CustomerContact_History record.
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = RepairOrder_CustomerContact_HistoryView.GetRecord(this.RecordUniqueId, true);
              
                return;
            }
      
            // Since this is a row in the table, the data for this row is loaded by the 
            // LoadData method of the BaseRepairOrder_CustomerContact_HistoryTableControl1 when the data for the entire
            // table is loaded.
            
            this.DataSource = new RepairOrder_CustomerContact_HistoryRecord();
        ...
        public virtual void Setcategory_id()
        {
            ...
            // DatabaseAYS_OEM%dbo.RepairOrder_CustomerContact_History database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.RepairOrder_CustomerContact_History record retrieved from the database.
            ...
            if (this.DataSource != null && this.DataSource.category_idSpecified) {
               ...
               Boolean _isExpandableNonCompositeForeignKey = RepairOrder_CustomerContact_HistoryView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RepairOrder_CustomerContact_HistoryView.category_id);
               if(_isExpandableNonCompositeForeignKey &&RepairOrder_CustomerContact_HistoryView.category_id.IsApplyDisplayAs)
                                  
                     formattedValue = RepairOrder_CustomerContact_HistoryView.GetDFKA(this.DataSource.category_id.ToString(),RepairOrder_CustomerContact_HistoryView.category_id, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(RepairOrder_CustomerContact_HistoryView.category_id);
              ...
              this.category_id.Text = RepairOrder_CustomerContact_HistoryView.category_id.Format(RepairOrder_CustomerContact_HistoryView.category_id.DefaultValue);
        ...
        public virtual void Setrepair_replace()
        {
            ...
            if (this.DataSource != null && this.DataSource.repair_replaceSpecified) {
               ...
               string formattedValue = this.DataSource.Format(RepairOrder_CustomerContact_HistoryView.repair_replace);
              ...
              this.repair_replace.Text = RepairOrder_CustomerContact_HistoryView.repair_replace.Format(RepairOrder_CustomerContact_HistoryView.repair_replace.DefaultValue);
            		
            }
            
            // If the repair_replace is NULL or blank, then use the value specified  
            // on Properties.
            if (this.repair_replace.Text == null ||
                this.repair_replace.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.repair_replace.Text = "&nbsp;";
            }
        ...
        public virtual void Setro_subtotal()
        {
            ...
            if (this.DataSource != null && this.DataSource.ro_subtotalSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(RepairOrder_CustomerContact_HistoryView.ro_subtotal, @"C");
              ...
              this.ro_subtotal.Text = RepairOrder_CustomerContact_HistoryView.ro_subtotal.Format(RepairOrder_CustomerContact_HistoryView.ro_subtotal.DefaultValue, @"C");
        ...
        public virtual void SetRODate1()
        {
            ...
            if (this.DataSource != null && this.DataSource.RODateSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(RepairOrder_CustomerContact_HistoryView.RODate, @"d");
              ...
              this.RODate1.Text = RepairOrder_CustomerContact_HistoryView.RODate.Format(RepairOrder_CustomerContact_HistoryView.RODate.DefaultValue, @"d");
        ...
        public virtual void SetRODateRepairCompleted()
        {
            ...
            if (this.DataSource != null && this.DataSource.RODateRepairCompletedSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(RepairOrder_CustomerContact_HistoryView.RODateRepairCompleted, @"d");
              ...
              this.RODateRepairCompleted.Text = RepairOrder_CustomerContact_HistoryView.RODateRepairCompleted.Format(RepairOrder_CustomerContact_HistoryView.RODateRepairCompleted.DefaultValue, @"d");
        ...
        public virtual void SetRODateReturned()
        {
            ...
            if (this.DataSource != null && this.DataSource.RODateReturnedSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(RepairOrder_CustomerContact_HistoryView.RODateReturned, @"d");
              ...
              this.RODateReturned.Text = RepairOrder_CustomerContact_HistoryView.RODateReturned.Format(RepairOrder_CustomerContact_HistoryView.RODateReturned.DefaultValue, @"d");
        ...
        public virtual void SetRODeptIDNew()
        {
            ...
            if (this.DataSource != null && this.DataSource.RODeptIDNewSpecified) {
                ...
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = "";
               Boolean _isExpandableNonCompositeForeignKey = RepairOrder_CustomerContact_HistoryView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RepairOrder_CustomerContact_HistoryView.RODeptIDNew);
               if(_isExpandableNonCompositeForeignKey &&RepairOrder_CustomerContact_HistoryView.RODeptIDNew.IsApplyDisplayAs)
                                  
                     formattedValue = RepairOrder_CustomerContact_HistoryView.GetDFKA(this.DataSource.RODeptIDNew.ToString(),RepairOrder_CustomerContact_HistoryView.RODeptIDNew, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(RepairOrder_CustomerContact_HistoryView.RODeptIDNew);
              ...
              this.RODeptIDNew.Text = RepairOrder_CustomerContact_HistoryView.RODeptIDNew.Format(RepairOrder_CustomerContact_HistoryView.RODeptIDNew.DefaultValue);
        ...
        public virtual void SetROFaultCodes()
        {
            ...
            if (this.DataSource != null && this.DataSource.ROFaultCodesSpecified) {
                ...
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = "";
               Boolean _isExpandableNonCompositeForeignKey = RepairOrder_CustomerContact_HistoryView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RepairOrder_CustomerContact_HistoryView.ROFaultCodes);
               if(_isExpandableNonCompositeForeignKey &&RepairOrder_CustomerContact_HistoryView.ROFaultCodes.IsApplyDisplayAs)
                                  
                     formattedValue = RepairOrder_CustomerContact_HistoryView.GetDFKA(this.DataSource.ROFaultCodes.ToString(),RepairOrder_CustomerContact_HistoryView.ROFaultCodes, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(RepairOrder_CustomerContact_HistoryView.ROFaultCodes);
              ...
              this.ROFaultCodes.Text = RepairOrder_CustomerContact_HistoryView.ROFaultCodes.Format(RepairOrder_CustomerContact_HistoryView.ROFaultCodes.DefaultValue);
        ...
        public virtual void SetROMake1()
        {
            ...
            if (this.DataSource != null && this.DataSource.ROMakeSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(RepairOrder_CustomerContact_HistoryView.ROMake);
              ...
              this.ROMake1.Text = RepairOrder_CustomerContact_HistoryView.ROMake.Format(RepairOrder_CustomerContact_HistoryView.ROMake.DefaultValue);
        ...
        public virtual void SetROModel1()
        {
            ...
            if (this.DataSource != null && this.DataSource.ROModelSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(RepairOrder_CustomerContact_HistoryView.ROModel);
              ...
              this.ROModel1.Text = RepairOrder_CustomerContact_HistoryView.ROModel.Format(RepairOrder_CustomerContact_HistoryView.ROModel.DefaultValue);
        ...
        public virtual void SetRONo1()
        {
            ...
            if (this.DataSource != null && this.DataSource.RONoSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(RepairOrder_CustomerContact_HistoryView.RONo);
              ...
              this.RONo1.Text = RepairOrder_CustomerContact_HistoryView.RONo.Format(RepairOrder_CustomerContact_HistoryView.RONo.DefaultValue);
        ...
        public virtual void SetROReference()
        {
            ...
            if (this.DataSource != null && this.DataSource.ROReference1Specified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(RepairOrder_CustomerContact_HistoryView.ROReference1);
              ...
              this.ROReference.Text = RepairOrder_CustomerContact_HistoryView.ROReference1.Format(RepairOrder_CustomerContact_HistoryView.ROReference1.DefaultValue);
        ...
        public virtual void SetROReference5()
        {
            ...
            if (this.DataSource != null && this.DataSource.ROReference4Specified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(RepairOrder_CustomerContact_HistoryView.ROReference4);
              ...
              this.ROReference5.Text = RepairOrder_CustomerContact_HistoryView.ROReference4.Format(RepairOrder_CustomerContact_HistoryView.ROReference4.DefaultValue);
        ...
        public virtual void SetROSerialNo1()
        {
            ...
            if (this.DataSource != null && this.DataSource.ROSerialNoSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(RepairOrder_CustomerContact_HistoryView.ROSerialNo);
              ...
              this.ROSerialNo1.Text = RepairOrder_CustomerContact_HistoryView.ROSerialNo.Format(RepairOrder_CustomerContact_HistoryView.ROSerialNo.DefaultValue);
        ...
        public virtual void SetROStatus1()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
              ...
              this.ROStatus1.Text = RepairOrder_CustomerContact_HistoryView.ROStatus.Format(RepairOrder_CustomerContact_HistoryView.ROStatus.DefaultValue);
        ...
        public virtual void SaveData()
        {
            ...
            if (this.DataSource.IsAnyValueChanged) {
                ...
                ((RepairOrder_CustomerContact_HistoryTableControl1)MiscUtils.GetParentControlObject(this, "RepairOrder_CustomerContact_HistoryTableControl1")).DataChanged = true;
                ((RepairOrder_CustomerContact_HistoryTableControl1)MiscUtils.GetParentControlObject(this, "RepairOrder_CustomerContact_HistoryTableControl1")).ResetData = true;
            }
      ...
      // To customize, override this method in RepairOrder_CustomerContact_HistoryTableControl1Row.
         ...
         
        {
            ...
            bool hasFiltersRepairOrder_CustomerContact_HistoryTableControl1 = false;
            hasFiltersRepairOrder_CustomerContact_HistoryTableControl1 = hasFiltersRepairOrder_CustomerContact_HistoryTableControl1 && false; // suppress warning
        ...
        public virtual void Delete()
        {
          ...
          RepairOrder_CustomerContact_HistoryView.DeleteRecord(pkValue);
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseRepairOrder_CustomerContact_HistoryTableControl1Row_Rec"];
            }
            set {
                this.ViewState["BaseRepairOrder_CustomerContact_HistoryTableControl1Row_Rec"] = value;
            }
        }
        
        public RepairOrder_CustomerContact_HistoryRecord DataSource {
            get {
                return (RepairOrder_CustomerContact_HistoryRecord)(this._DataSource);
            }
            set {
...
#region "Helper Properties"
    ...
    RepairOrder_CustomerContact_HistoryRecord rec = null;
        ...
        public virtual RepairOrder_CustomerContact_HistoryRecord GetRecord()
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return RepairOrder_CustomerContact_HistoryView.GetRecord(this.RecordUniqueId, true);
...
// Base class for the RepairOrder_CustomerContact_HistoryTableControl1 control on the Show_RepairOrders_Table_CustomerContact_History page.
// Do not modify this class. Instead override any method in RepairOrder_CustomerContact_HistoryTableControl1.
public class BaseRepairOrder_CustomerContact_HistoryTableControl1 : OEMConversion.UI.BaseApplicationTableControl
{
         
       public BaseRepairOrder_CustomerContact_HistoryTableControl1()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.RepairOrder_CustomerContact_HistorySearchText2)) 				
                    initialVal = this.GetFromSession(this.RepairOrder_CustomerContact_HistorySearchText2);
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.RepairOrder_CustomerContact_HistorySearchText2.Text = initialVal;
            ...
            else
            {
                ...
                this.CurrentSortOrder.Add(RepairOrder_CustomerContact_HistoryView.RODate, OrderByItem.OrderDir.Desc);
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
              ...
              this.repair_replaceLabel.Click += repair_replaceLabel_Click;
              ...
              this.ROMakeLabel1.Click += ROMakeLabel1_Click;
            
              this.ROModelLabel1.Click += ROModelLabel1_Click;
              ...
              this.ROSerialNoLabel1.Click += ROSerialNoLabel1_Click;
         ...
         //' Setup events for others
            AjaxControlToolkit.ToolkitScriptManager.RegisterStartupScript(this, this.GetType(), "RepairOrder_CustomerContact_HistorySearchText2SearchBoxText", "setSearchBoxText(\"" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "\", \"" + RepairOrder_CustomerContact_HistorySearchText2.ClientID + "\");", true);
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(OEMConversion.Business.RepairOrder_CustomerContact_HistoryRecord);
                      this.DataSource = (RepairOrder_CustomerContact_HistoryRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    foreach (RepairOrder_CustomerContact_HistoryTableControl1Row rc in this.GetRecordControls()) {
                        if (!rc.IsNewRecord) {
                    ...
                    Type myrec = typeof(OEMConversion.Business.RepairOrder_CustomerContact_HistoryRecord);
                    this.DataSource = (RepairOrder_CustomerContact_HistoryRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual RepairOrder_CustomerContact_HistoryRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(RepairOrder_CustomerContact_HistoryView.Column1, true);          
            // selCols.Add(RepairOrder_CustomerContact_HistoryView.Column2, true);          
            // selCols.Add(RepairOrder_CustomerContact_HistoryView.Column3, true);          
                  ...
                  
            {
                ...
                return RepairOrder_CustomerContact_HistoryView.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                RepairOrder_CustomerContact_HistoryView databaseTable = new RepairOrder_CustomerContact_HistoryView();
                ...
                return (recList.ToArray(typeof(RepairOrder_CustomerContact_HistoryRecord)) as RepairOrder_CustomerContact_HistoryRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0)                 
                ...
                return RepairOrder_CustomerContact_HistoryView.GetRecordCount(join, where);
            else
            {
                RepairOrder_CustomerContact_HistoryView databaseTable = new RepairOrder_CustomerContact_HistoryView();
                databaseTable.SelectedColumns.Clear();
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RepairOrder_CustomerContact_HistoryTableControl1Repeater"));
        if (rep == null){return;}
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            RepairOrder_CustomerContact_HistoryTableControl1Row recControl = (RepairOrder_CustomerContact_HistoryTableControl1Row)(repItem.FindControl("RepairOrder_CustomerContact_HistoryTableControl1Row"));
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetRepairOrder_CustomerContact_HistorySearchText2();
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(RepairOrder_CustomerContact_HistoryView.category_id, this.DataSource);
            this.Page.PregetDfkaRecords(RepairOrder_CustomerContact_HistoryView.RODeptIDNew, this.DataSource);
            this.Page.PregetDfkaRecords(RepairOrder_CustomerContact_HistoryView.ROFaultCodes, this.DataSource);
            this.Page.PregetDfkaRecords(RepairOrder_CustomerContact_HistoryView.ROStatus, this.DataSource);
        }
        ...
        public virtual void ResetControl()
        {
            ...
            this.RepairOrder_CustomerContact_HistorySearchText2.Text = "";
        ...
        protected virtual void BindPaginationControls()
        {
            ...
            // Bind the buttons for RepairOrder_CustomerContact_HistoryTableControl1 pagination.
        ...
        public virtual void SaveData()
        {
            ...
            foreach (RepairOrder_CustomerContact_HistoryTableControl1Row recCtl in this.GetRecordControls())
            {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            RepairOrder_CustomerContact_HistoryView.Instance.InnerFilter = null;
            ...
            if (MiscUtils.IsValueSelected(this.category_idFilter)) {
                ...
                wc.iAND(RepairOrder_CustomerContact_HistoryView.category_id, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.category_idFilter, this.GetFromSession(this.category_idFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.repair_replaceFilter)) {
                        
                wc.iAND(RepairOrder_CustomerContact_HistoryView.repair_replace, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.repair_replaceFilter, this.GetFromSession(this.repair_replaceFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.RepairOrder_CustomerContact_HistorySearchText2)) {
                if (this.RepairOrder_CustomerContact_HistorySearchText2.Text == BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) ) {
                        this.RepairOrder_CustomerContact_HistorySearchText2.Text = "";
                } else {
                  // Strip "..." from begin and ending of the search text, otherwise the search will return 0 values as in database "..." is not stored.
                  if (this.RepairOrder_CustomerContact_HistorySearchText2.Text.StartsWith("...")) {
                      this.RepairOrder_CustomerContact_HistorySearchText2.Text = this.RepairOrder_CustomerContact_HistorySearchText2.Text.Substring(3,this.RepairOrder_CustomerContact_HistorySearchText2.Text.Length-3);
                  }
                  if (this.RepairOrder_CustomerContact_HistorySearchText2.Text.EndsWith("...")) {
                      this.RepairOrder_CustomerContact_HistorySearchText2.Text = this.RepairOrder_CustomerContact_HistorySearchText2.Text.Substring(0,this.RepairOrder_CustomerContact_HistorySearchText2.Text.Length-3);
                      // Strip the last word as well as it is likely only a partial word
                      int endindex = this.RepairOrder_CustomerContact_HistorySearchText2.Text.Length - 1;
                      while (!Char.IsWhiteSpace(RepairOrder_CustomerContact_HistorySearchText2.Text[endindex]) && endindex > 0) {
                          endindex--;
                      }
                      if (endindex > 0) {
                          this.RepairOrder_CustomerContact_HistorySearchText2.Text = this.RepairOrder_CustomerContact_HistorySearchText2.Text.Substring(0, endindex);
                      }
                  }
                }
                string formatedSearchText = MiscUtils.GetSelectedValue(this.RepairOrder_CustomerContact_HistorySearchText2, this.GetFromSession(this.RepairOrder_CustomerContact_HistorySearchText2));
      ...
      cols.Add(RepairOrder_CustomerContact_HistoryView.department_name, true);
      
      foreach(BaseColumn col in cols)
      {
      
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.RepairOrder_CustomerContact_HistorySearchText2, this.GetFromSession(this.RepairOrder_CustomerContact_HistorySearchText2)), true, false);
            ...
            if (MiscUtils.IsValueSelected(this.RODateFromFilter)) {
                ...
                wc.iAND(RepairOrder_CustomerContact_HistoryView.RODate, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, val, false, false);
            ...
            if (MiscUtils.IsValueSelected(this.RODateRepairCompletedFromFilter)) {
                ...
                val = d.ToShortDateString() + " " + "00:00:00";
                wc.iAND(RepairOrder_CustomerContact_HistoryView.RODateRepairCompleted, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, val, false, false);
            ...
            if (MiscUtils.IsValueSelected(this.RODateRepairCompletedToFilter)) {
                ...
                wc.iAND(RepairOrder_CustomerContact_HistoryView.RODateRepairCompleted, BaseFilter.ComparisonOperator.Less_Than_Or_Equal, val, false, false);
            ...
            if (MiscUtils.IsValueSelected(this.RODateToFilter)) {
                ...
                val = d.ToShortDateString() + " " + "23:59:59";
                wc.iAND(RepairOrder_CustomerContact_HistoryView.RODate, BaseFilter.ComparisonOperator.Less_Than_Or_Equal, val, false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.RODeptIDNewFromFilter)) {
                        
                wc.iAND(RepairOrder_CustomerContact_HistoryView.RODeptIDNew, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.RODeptIDNewFromFilter, this.GetFromSession(this.RODeptIDNewFromFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.ROFaultCodesFilter)) {
                        
                wc.iAND(RepairOrder_CustomerContact_HistoryView.ROFaultCodes, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.ROFaultCodesFilter, this.GetFromSession(this.ROFaultCodesFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.ROMakeFilter)) {
                        
                wc.iAND(RepairOrder_CustomerContact_HistoryView.ROMake, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.ROMakeFilter, this.GetFromSession(this.ROMakeFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.ROModelFilter)) {
                        
                wc.iAND(RepairOrder_CustomerContact_HistoryView.ROModel, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.ROModelFilter, this.GetFromSession(this.ROModelFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.ROReference1Filter)) {
                        
                wc.iAND(RepairOrder_CustomerContact_HistoryView.ROReference1, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.ROReference1Filter, this.GetFromSession(this.ROReference1Filter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.ROSerialNoFilter)) {
                        
                wc.iAND(RepairOrder_CustomerContact_HistoryView.ROSerialNo, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.ROSerialNoFilter, this.GetFromSession(this.ROSerialNoFilter)), false, false);
      ...
      String category_idFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "category_idFilter_Ajax"];
            if (MiscUtils.IsValueSelected(category_idFilterSelectedValue)) {
                ...
                wc.iAND(RepairOrder_CustomerContact_HistoryView.category_id, BaseFilter.ComparisonOperator.EqualsTo, category_idFilterSelectedValue, false, false);
      ...
      String repair_replaceFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "repair_replaceFilter_Ajax"];
            if (MiscUtils.IsValueSelected(repair_replaceFilterSelectedValue)) {
                ...
                wc.iAND(RepairOrder_CustomerContact_HistoryView.repair_replace, BaseFilter.ComparisonOperator.EqualsTo, repair_replaceFilterSelectedValue, false, false);
                      
      }
                      
            if (MiscUtils.IsValueSelected(searchText) && fromSearchControl == "RepairOrder_CustomerContact_HistorySearchText2") {
      ...
      foreach(BaseColumn col in cols)
      {
            ...
            if (MiscUtils.IsValueSelected(RODateFromFilterSelectedValue)) {
                ...
                wc.iAND(RepairOrder_CustomerContact_HistoryView.RODate, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, RODateFromFilterSelectedValue, false, false);
            ...
            if (MiscUtils.IsValueSelected(RODateRepairCompletedFromFilterSelectedValue)) {
                ...
                wc.iAND(RepairOrder_CustomerContact_HistoryView.RODateRepairCompleted, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, RODateRepairCompletedFromFilterSelectedValue, false, false);
            ...
            if (MiscUtils.IsValueSelected(RODateRepairCompletedToFilterSelectedValue)) {
                ...
                wc.iAND(RepairOrder_CustomerContact_HistoryView.RODateRepairCompleted, BaseFilter.ComparisonOperator.Less_Than_Or_Equal, RODateRepairCompletedToFilterSelectedValue, false, false);
            ...
            if (MiscUtils.IsValueSelected(RODateToFilterSelectedValue)) {
                ...
                wc.iAND(RepairOrder_CustomerContact_HistoryView.RODate, BaseFilter.ComparisonOperator.Less_Than_Or_Equal, RODateToFilterSelectedValue, false, false);
      ...
      String RODeptIDNewFromFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "RODeptIDNewFromFilter_Ajax"];
            if (MiscUtils.IsValueSelected(RODeptIDNewFromFilterSelectedValue)) {
                ...
                wc.iAND(RepairOrder_CustomerContact_HistoryView.RODeptIDNew, BaseFilter.ComparisonOperator.EqualsTo, RODeptIDNewFromFilterSelectedValue, false, false);
      ...
      String ROFaultCodesFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "ROFaultCodesFilter_Ajax"];
            if (MiscUtils.IsValueSelected(ROFaultCodesFilterSelectedValue)) {
                ...
                wc.iAND(RepairOrder_CustomerContact_HistoryView.ROFaultCodes, BaseFilter.ComparisonOperator.EqualsTo, ROFaultCodesFilterSelectedValue, false, false);
      ...
      String ROMakeFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "ROMakeFilter_Ajax"];
            if (MiscUtils.IsValueSelected(ROMakeFilterSelectedValue)) {
                ...
                wc.iAND(RepairOrder_CustomerContact_HistoryView.ROMake, BaseFilter.ComparisonOperator.EqualsTo, ROMakeFilterSelectedValue, false, false);
      ...
      String ROModelFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "ROModelFilter_Ajax"];
            if (MiscUtils.IsValueSelected(ROModelFilterSelectedValue)) {
                ...
                wc.iAND(RepairOrder_CustomerContact_HistoryView.ROModel, BaseFilter.ComparisonOperator.EqualsTo, ROModelFilterSelectedValue, false, false);
      ...
      String ROReference1FilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "ROReference1Filter_Ajax"];
            if (MiscUtils.IsValueSelected(ROReference1FilterSelectedValue)) {
                ...
                wc.iAND(RepairOrder_CustomerContact_HistoryView.ROReference1, BaseFilter.ComparisonOperator.EqualsTo, ROReference1FilterSelectedValue, false, false);
      ...
      String ROSerialNoFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "ROSerialNoFilter_Ajax"];
            if (MiscUtils.IsValueSelected(ROSerialNoFilterSelectedValue)) {
                ...
                wc.iAND(RepairOrder_CustomerContact_HistoryView.ROSerialNo, BaseFilter.ComparisonOperator.EqualsTo, ROSerialNoFilterSelectedValue, false, false);
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            filter.AddFilter(new BaseClasses.Data.ColumnJoinFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.RepairOrder_CustomerContact_HistoryView, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"RepairOrder_CustomerContact_History_.RODeptIDNew"), new BaseClasses.Data.IdentifierAliasInfo(@"RepairOrder_CustomerContact_History_", null), BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.SecurityTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"security_.deptid"), new BaseClasses.Data.IdentifierAliasInfo(@"security_", null),  BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
        ...
        public virtual string[] GetAutoCompletionList_RepairOrder_CustomerContact_HistorySearchText2(String prefixText,int count)
        {
            ArrayList resultList = new ArrayList();
            ArrayList wordList= new ArrayList();
            
            CompoundFilter filterJoin = CreateCompoundJoinFilter();    
            WhereClause wc = CreateWhereClause(prefixText,"RepairOrder_CustomerContact_HistorySearchText2", "WordsStartingWithSearchString", "[^a-zA-Z0-9]");
            if(count==0) count = 10;
            OEMConversion.Business.RepairOrder_CustomerContact_HistoryRecord[] recordList  = RepairOrder_CustomerContact_HistoryView.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (RepairOrder_CustomerContact_HistoryRecord rec in recordList ){
                ...
                resultItem = rec.Format(RepairOrder_CustomerContact_HistoryView.department_name);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(RepairOrder_CustomerContact_HistoryView.department_name.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, RepairOrder_CustomerContact_HistoryView.department_name.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
      ...
      RepairOrder_CustomerContact_HistoryRecord rec = new RepairOrder_CustomerContact_HistoryRecord();
        
                        if (recControl.category_id.Text != "") {
                            rec.Parse(recControl.category_id.Text, RepairOrder_CustomerContact_HistoryView.category_id);
                  }
                
                        if (recControl.repair_replace.Text != "") {
                            rec.Parse(recControl.repair_replace.Text, RepairOrder_CustomerContact_HistoryView.repair_replace);
                  }
                
                        if (recControl.ro_subtotal.Text != "") {
                            rec.Parse(recControl.ro_subtotal.Text, RepairOrder_CustomerContact_HistoryView.ro_subtotal);
                  }
                
                        if (recControl.RODate1.Text != "") {
                            rec.Parse(recControl.RODate1.Text, RepairOrder_CustomerContact_HistoryView.RODate);
                  }
                
                        if (recControl.RODateRepairCompleted.Text != "") {
                            rec.Parse(recControl.RODateRepairCompleted.Text, RepairOrder_CustomerContact_HistoryView.RODateRepairCompleted);
                  }
                
                        if (recControl.RODateReturned.Text != "") {
                            rec.Parse(recControl.RODateReturned.Text, RepairOrder_CustomerContact_HistoryView.RODateReturned);
                  }
                
                        if (recControl.RODeptIDNew.Text != "") {
                            rec.Parse(recControl.RODeptIDNew.Text, RepairOrder_CustomerContact_HistoryView.RODeptIDNew);
                  }
                
                        if (recControl.ROFaultCodes.Text != "") {
                            rec.Parse(recControl.ROFaultCodes.Text, RepairOrder_CustomerContact_HistoryView.ROFaultCodes);
                  }
                
                        if (recControl.ROMake1.Text != "") {
                            rec.Parse(recControl.ROMake1.Text, RepairOrder_CustomerContact_HistoryView.ROMake);
                  }
                
                        if (recControl.ROModel1.Text != "") {
                            rec.Parse(recControl.ROModel1.Text, RepairOrder_CustomerContact_HistoryView.ROModel);
                  }
                
                        if (recControl.RONo1.Text != "") {
                            rec.Parse(recControl.RONo1.Text, RepairOrder_CustomerContact_HistoryView.RONo);
                  }
                
                        if (recControl.ROReference.Text != "") {
                            rec.Parse(recControl.ROReference.Text, RepairOrder_CustomerContact_HistoryView.ROReference1);
                  }
                
                        if (recControl.ROReference5.Text != "") {
                            rec.Parse(recControl.ROReference5.Text, RepairOrder_CustomerContact_HistoryView.ROReference4);
                  }
                
                        if (recControl.ROSerialNo1.Text != "") {
                            rec.Parse(recControl.ROSerialNo1.Text, RepairOrder_CustomerContact_HistoryView.ROSerialNo);
                  }
                
                        if (recControl.ROStatus1.Text != "") {
                            rec.Parse(recControl.ROStatus1.Text, RepairOrder_CustomerContact_HistoryView.ROStatus);
                  }
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new RepairOrder_CustomerContact_HistoryRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(OEMConversion.Business.RepairOrder_CustomerContact_HistoryRecord);
                this.DataSource = (RepairOrder_CustomerContact_HistoryRecord[])(finalList.ToArray(myrec));
        ...
        public void AddToDeletedRecordIds(RepairOrder_CustomerContact_HistoryTableControl1Row rec)
        {
            if (rec.IsNewRecord) {
                return;
            }
        ...
        protected virtual bool InDeletedRecordIds(RepairOrder_CustomerContact_HistoryTableControl1Row rec)            
        {
            if (this.DeletedRecordIds == null || this.DeletedRecordIds.Length == 0) {
                return (false);
            }
        ...
        public virtual void SetROSerialNoLabel()
                  {
                        ...
                        this.ROSerialNoLabel.Text = EvaluateFormula("\"Serial No.\"");
        ...
        public virtual void SetROSerialNoLabel1()
                  {
                        ...
                        this.ROSerialNoLabel1.Text = EvaluateFormula("\"Serial No.\"");
        ...
        public virtual void SetRepairOrder_CustomerContact_HistorySearchText2()
        {
                                            
            this.RepairOrder_CustomerContact_HistorySearchText2.Attributes.Add("onfocus", "if(this.value=='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "') {this.value='';this.className='Search_Input';}");
            this.RepairOrder_CustomerContact_HistorySearchText2.Attributes.Add("onblur", "if(this.value=='') {this.value='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "';this.className='Search_InputHint';}");
                    ...
                    foreach (CategoriesRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.category_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.category_idFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                Boolean _isExpandableNonCompositeForeignKey = RepairOrder_CustomerContact_HistoryView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RepairOrder_CustomerContact_HistoryView.category_id);
                                if(_isExpandableNonCompositeForeignKey && RepairOrder_CustomerContact_HistoryView.category_id.IsApplyDisplayAs)
                                     fvalue = RepairOrder_CustomerContact_HistoryView.GetDFKA(itemValue, RepairOrder_CustomerContact_HistoryView.category_id);
                    ...
                    
        {
            ...
            OrderBy orderBy = new OrderBy(false, false);
            orderBy.Add(RepairOrder_CustomerContact_HistoryView.repair_replace, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = RepairOrder_CustomerContact_HistoryView.GetValues(RepairOrder_CustomerContact_HistoryView.repair_replace, wc, orderBy, maxItems);
            ...
            // Create the item and add to the list.
            string fvalue;
            if ( RepairOrder_CustomerContact_HistoryView.repair_replace.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = RepairOrder_CustomerContact_HistoryView.repair_replace.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
                    ...
                    foreach (DepartmentRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.department_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.RODeptIDNewFromFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                Boolean _isExpandableNonCompositeForeignKey = RepairOrder_CustomerContact_HistoryView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RepairOrder_CustomerContact_HistoryView.RODeptIDNew);
                                if(_isExpandableNonCompositeForeignKey && RepairOrder_CustomerContact_HistoryView.RODeptIDNew.IsApplyDisplayAs)
                                     fvalue = RepairOrder_CustomerContact_HistoryView.GetDFKA(itemValue, RepairOrder_CustomerContact_HistoryView.RODeptIDNew);
                                if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
                    ...
                    foreach (FaultCodesRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.FaultCodeSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.ROFaultCodesFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                Boolean _isExpandableNonCompositeForeignKey = RepairOrder_CustomerContact_HistoryView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RepairOrder_CustomerContact_HistoryView.ROFaultCodes);
                                if(_isExpandableNonCompositeForeignKey && RepairOrder_CustomerContact_HistoryView.ROFaultCodes.IsApplyDisplayAs)
                                     fvalue = RepairOrder_CustomerContact_HistoryView.GetDFKA(itemValue, RepairOrder_CustomerContact_HistoryView.ROFaultCodes);
                                if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
                    ...
                    
        {
            ...
            OrderBy orderBy = new OrderBy(false, false);
                          orderBy.Add(RepairOrder_CustomerContact_HistoryView.ROSerialNo, OrderByItem.OrderDir.Asc);
            ...
            RepairOrder_CustomerContact_HistoryRecord[] itemValues  = null;
            if (wc.RunQuery)
            {
                int counter = 0;
                int pageNum = 0;
                ...
                do
                {
                    ...
                    itemValues = RepairOrder_CustomerContact_HistoryView.GetRecords(wc, orderBy, pageNum, maxItems);
                                    
                    foreach (RepairOrder_CustomerContact_HistoryRecord itemValue in itemValues) 
                    {
                        // Create the item and add to the list.
                        string cvalue = null;
                        string fvalue = null;
        ...
        CompoundFilter filter = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
            ...
            if (EvaluateFormula("RepairOrder_CustomerContact_HistoryTableControl1.ROMakeFilter.SelectedValue", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.MakesModelsTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"MakesModels_.Make"), EvaluateFormula("RepairOrder_CustomerContact_HistoryTableControl1.ROMakeFilter.SelectedValue", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("RepairOrder_CustomerContact_HistoryTableControl1.ROMakeFilter.SelectedValue", false) == "--PLEASE_SELECT--" || EvaluateFormula("RepairOrder_CustomerContact_HistoryTableControl1.ROMakeFilter.SelectedValue", false) == "--ANY--") whereClause.RunQuery = false;
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.RepairOrder_CustomerContact_HistorySearchText2, this.RepairOrder_CustomerContact_HistorySearchText2.Text);
      ...
      this.SaveToSession("RepairOrder_CustomerContact_HistorySearchText2_Ajax", this.RepairOrder_CustomerContact_HistorySearchText2.Text);
      ...
      this.SaveToSession("ROSerialNoFilter_Ajax", this.ROSerialNoFilter.SelectedValue);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.RepairOrder_CustomerContact_HistorySearchText2);
    ...
    this.RemoveFromSession(this, "Page_Size");
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            string orderByStr = (string)ViewState["RepairOrder_CustomerContact_HistoryTableControl1_OrderBy"];
        ...
        {            
            ...
            if (this.CurrentSortOrder != null) {
                this.ViewState["RepairOrder_CustomerContact_HistoryTableControl1_OrderBy"] = this.CurrentSortOrder.ToXmlString();
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void repair_replaceLabel_Click(object sender, EventArgs args)
        {
            //Sorts by repair_replace when clicked.
              
            // Get previous sorting state for repair_replace.
        
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContact_HistoryView.repair_replace);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for repair_replace.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContact_HistoryView.repair_replace, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by repair_replace, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void ro_subtotalLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContact_HistoryView.ro_subtotal);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContact_HistoryView.ro_subtotal, OrderByItem.OrderDir.Asc);
        ...
        public virtual void ROCategoryLabel1_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContact_HistoryView.ROCategory);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContact_HistoryView.ROCategory, OrderByItem.OrderDir.Asc);
        ...
        public virtual void RODateLabel2_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContact_HistoryView.RODate);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContact_HistoryView.RODate, OrderByItem.OrderDir.Asc);
        ...
        public virtual void RODateRepairCompletedLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContact_HistoryView.RODateRepairCompleted);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContact_HistoryView.RODateRepairCompleted, OrderByItem.OrderDir.Asc);
        ...
        public virtual void RODateReturnedLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContact_HistoryView.RODateReturned);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContact_HistoryView.RODateReturned, OrderByItem.OrderDir.Asc);
        ...
        public virtual void ROFaultCodesLabel1_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContact_HistoryView.ROFaultCodes);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContact_HistoryView.ROFaultCodes, OrderByItem.OrderDir.Asc);
        ...
        public virtual void ROMakeLabel1_Click(object sender, EventArgs args)
        {
            //Sorts by ROMake when clicked.
              
            // Get previous sorting state for ROMake.
        
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContact_HistoryView.ROMake);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContact_HistoryView.ROMake, OrderByItem.OrderDir.Asc);
        ...
        public virtual void ROModelLabel1_Click(object sender, EventArgs args)
        {
            //Sorts by ROModel when clicked.
              
            // Get previous sorting state for ROModel.
        
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContact_HistoryView.ROModel);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContact_HistoryView.ROModel, OrderByItem.OrderDir.Asc);
        ...
        public virtual void RONoLabel1_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContact_HistoryView.RONo);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContact_HistoryView.RONo, OrderByItem.OrderDir.Asc);
        ...
        public virtual void ROReference1Label1_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContact_HistoryView.ROReference1);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContact_HistoryView.ROReference1, OrderByItem.OrderDir.Asc);
        ...
        public virtual void ROReference2Label1_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContact_HistoryView.RODeptIDNew);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContact_HistoryView.RODeptIDNew, OrderByItem.OrderDir.Asc);
        ...
        public virtual void ROReference4Label1_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContact_HistoryView.ROReference4);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContact_HistoryView.ROReference4, OrderByItem.OrderDir.Asc);
        ...
        public virtual void ROSerialNoLabel1_Click(object sender, EventArgs args)
        {
            //Sorts by ROSerialNo when clicked.
              
            // Get previous sorting state for ROSerialNo.
        
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContact_HistoryView.ROSerialNo);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContact_HistoryView.ROSerialNo, OrderByItem.OrderDir.Asc);
        ...
        public virtual void ROStatusLabel2_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(RepairOrder_CustomerContact_HistoryView.ROStatus);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(RepairOrder_CustomerContact_HistoryView.ROStatus, OrderByItem.OrderDir.Asc);
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = RepairOrder_CustomerContact_HistoryView.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
              
                // Add each of the columns in order of export.
                BaseColumn[] columns = new BaseColumn[] {
                             RepairOrder_CustomerContact_HistoryView.RONo,
             RepairOrder_CustomerContact_HistoryView.RODate,
             RepairOrder_CustomerContact_HistoryView.ro_subtotal,
             RepairOrder_CustomerContact_HistoryView.ROMake,
             RepairOrder_CustomerContact_HistoryView.ROModel,
             RepairOrder_CustomerContact_HistoryView.ROReference1,
             RepairOrder_CustomerContact_HistoryView.ROReference4,
             RepairOrder_CustomerContact_HistoryView.ROSerialNo,
             RepairOrder_CustomerContact_HistoryView.ROStatus,
             RepairOrder_CustomerContact_HistoryView.RODeptIDNew,
             RepairOrder_CustomerContact_HistoryView.ROFaultCodes,
             RepairOrder_CustomerContact_HistoryView.category_id,
             RepairOrder_CustomerContact_HistoryView.RODateRepairCompleted,
             RepairOrder_CustomerContact_HistoryView.repair_replace,
             RepairOrder_CustomerContact_HistoryView.RODateReturned,
             null};
                ExportDataToCSV exportData = new ExportDataToCSV(RepairOrder_CustomerContact_HistoryView.Instance,wc,orderBy,columns);
                exportData.StartExport(this.Page.Response, true);

                DataForExport dataForCSV = new DataForExport(RepairOrder_CustomerContact_HistoryView.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(RepairOrder_CustomerContact_HistoryView.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(RepairOrder_CustomerContact_HistoryView.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContact_HistoryView.RONo, "0"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContact_HistoryView.RODate, "Short Date"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContact_HistoryView.ro_subtotal, "Currency"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContact_HistoryView.ROMake, "Default"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContact_HistoryView.ROModel, "Default"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContact_HistoryView.ROReference1, "Default"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContact_HistoryView.ROReference4, "Default"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContact_HistoryView.ROSerialNo, "Default"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContact_HistoryView.ROStatus, "Default"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContact_HistoryView.RODeptIDNew, "Default"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContact_HistoryView.ROFaultCodes, "Default"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContact_HistoryView.category_id, "Default"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContact_HistoryView.RODateRepairCompleted, "Short Date"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContact_HistoryView.repair_replace, "Default"));
             data.ColumnList.Add(new ExcelColumn(RepairOrder_CustomerContact_HistoryView.RODateReturned, "Short Date"));
              ...
              {
                val = RepairOrder_CustomerContact_HistoryView.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-RepairOrders-Table-CustomerContact-History.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RepairOrder_CustomerContact_History";
                // If Show-RepairOrders-Table-CustomerContact-History.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(RepairOrder_CustomerContact_HistoryView.RONo.Name, ReportEnum.Align.Right, "${RONo}", ReportEnum.Align.Right, 15);
                 report.AddColumn(RepairOrder_CustomerContact_HistoryView.RODate.Name, ReportEnum.Align.Left, "${RODate}", ReportEnum.Align.Left, 20);
                 report.AddColumn(RepairOrder_CustomerContact_HistoryView.ro_subtotal.Name, ReportEnum.Align.Right, "${ro_subtotal}", ReportEnum.Align.Right, 20);
                 report.AddColumn(RepairOrder_CustomerContact_HistoryView.ROMake.Name, ReportEnum.Align.Left, "${ROMake}", ReportEnum.Align.Left, 24);
                 report.AddColumn(RepairOrder_CustomerContact_HistoryView.ROModel.Name, ReportEnum.Align.Left, "${ROModel}", ReportEnum.Align.Left, 28);
                 report.AddColumn(RepairOrder_CustomerContact_HistoryView.ROReference1.Name, ReportEnum.Align.Left, "${ROReference1}", ReportEnum.Align.Left, 24);
                 report.AddColumn(RepairOrder_CustomerContact_HistoryView.ROReference4.Name, ReportEnum.Align.Left, "${ROReference4}", ReportEnum.Align.Left, 24);
                 report.AddColumn(RepairOrder_CustomerContact_HistoryView.ROSerialNo.Name, ReportEnum.Align.Left, "${ROSerialNo}", ReportEnum.Align.Left, 28);
                 report.AddColumn(RepairOrder_CustomerContact_HistoryView.ROStatus.Name, ReportEnum.Align.Left, "${ROStatus}", ReportEnum.Align.Left, 29);
                 report.AddColumn(RepairOrder_CustomerContact_HistoryView.RODeptIDNew.Name, ReportEnum.Align.Left, "${RODeptIDNew}", ReportEnum.Align.Left, 30);
                 report.AddColumn(RepairOrder_CustomerContact_HistoryView.ROFaultCodes.Name, ReportEnum.Align.Left, "${ROFaultCodes}", ReportEnum.Align.Left, 27);
                 report.AddColumn(RepairOrder_CustomerContact_HistoryView.category_id.Name, ReportEnum.Align.Left, "${category_id}", ReportEnum.Align.Left, 30);
                 report.AddColumn(RepairOrder_CustomerContact_HistoryView.RODateRepairCompleted.Name, ReportEnum.Align.Left, "${RODateRepairCompleted}", ReportEnum.Align.Left, 20);
                 report.AddColumn(RepairOrder_CustomerContact_HistoryView.repair_replace.Name, ReportEnum.Align.Left, "${repair_replace}", ReportEnum.Align.Left, 15);
                 report.AddColumn(RepairOrder_CustomerContact_HistoryView.RODateReturned.Name, ReportEnum.Align.Left, "${RODateReturned}", ReportEnum.Align.Left, 20);
                ...
                ColumnList columns = RepairOrder_CustomerContact_HistoryView.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = RepairOrder_CustomerContact_HistoryView.GetRecordCount(joinFilter,whereClause);
                RepairOrder_CustomerContact_HistoryRecord[] records = null;
                
                do
                {
                    
                    records = RepairOrder_CustomerContact_HistoryView.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( RepairOrder_CustomerContact_HistoryRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${RONo}", record.Format(RepairOrder_CustomerContact_HistoryView.RONo), ReportEnum.Align.Right, 300);
                             report.AddData("${RODate}", record.Format(RepairOrder_CustomerContact_HistoryView.RODate), ReportEnum.Align.Left, 300);
                             report.AddData("${ro_subtotal}", record.Format(RepairOrder_CustomerContact_HistoryView.ro_subtotal), ReportEnum.Align.Right, 300);
                             report.AddData("${ROMake}", record.Format(RepairOrder_CustomerContact_HistoryView.ROMake), ReportEnum.Align.Left, 300);
                             report.AddData("${ROModel}", record.Format(RepairOrder_CustomerContact_HistoryView.ROModel), ReportEnum.Align.Left, 300);
                             report.AddData("${ROReference1}", record.Format(RepairOrder_CustomerContact_HistoryView.ROReference1), ReportEnum.Align.Left, 300);
                             report.AddData("${ROReference4}", record.Format(RepairOrder_CustomerContact_HistoryView.ROReference4), ReportEnum.Align.Left, 300);
                             report.AddData("${ROSerialNo}", record.Format(RepairOrder_CustomerContact_HistoryView.ROSerialNo), ReportEnum.Align.Left, 300);
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.ROStatus)){
                                 report.AddData("${ROStatus}", "",ReportEnum.Align.Left, 300);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = RepairOrder_CustomerContact_HistoryView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RepairOrder_CustomerContact_HistoryView.ROStatus);
                                 _DFKA = RepairOrder_CustomerContact_HistoryView.GetDFKA(record.ROStatus.ToString(), RepairOrder_CustomerContact_HistoryView.ROStatus,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  RepairOrder_CustomerContact_HistoryView.ROStatus.IsApplyDisplayAs){
                                     report.AddData("${ROStatus}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${ROStatus}", record.Format(RepairOrder_CustomerContact_HistoryView.ROStatus), ReportEnum.Align.Left, 300);
                                 }
                             }
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.RODeptIDNew)){
                                 ...
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = RepairOrder_CustomerContact_HistoryView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RepairOrder_CustomerContact_HistoryView.RODeptIDNew);
                                 _DFKA = RepairOrder_CustomerContact_HistoryView.GetDFKA(record.RODeptIDNew.ToString(), RepairOrder_CustomerContact_HistoryView.RODeptIDNew,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  RepairOrder_CustomerContact_HistoryView.RODeptIDNew.IsApplyDisplayAs){
                                     report.AddData("${RODeptIDNew}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${RODeptIDNew}", record.Format(RepairOrder_CustomerContact_HistoryView.RODeptIDNew), ReportEnum.Align.Left, 300);
                                 }
                             }
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.ROFaultCodes)){
                                 ...
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = RepairOrder_CustomerContact_HistoryView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RepairOrder_CustomerContact_HistoryView.ROFaultCodes);
                                 _DFKA = RepairOrder_CustomerContact_HistoryView.GetDFKA(record.ROFaultCodes.ToString(), RepairOrder_CustomerContact_HistoryView.ROFaultCodes,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  RepairOrder_CustomerContact_HistoryView.ROFaultCodes.IsApplyDisplayAs){
                                     report.AddData("${ROFaultCodes}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${ROFaultCodes}", record.Format(RepairOrder_CustomerContact_HistoryView.ROFaultCodes), ReportEnum.Align.Left, 300);
                                 }
                             }
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.category_id)){
                                 ...
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = RepairOrder_CustomerContact_HistoryView.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RepairOrder_CustomerContact_HistoryView.category_id);
                                 _DFKA = RepairOrder_CustomerContact_HistoryView.GetDFKA(record.category_id.ToString(), RepairOrder_CustomerContact_HistoryView.category_id,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  RepairOrder_CustomerContact_HistoryView.category_id.IsApplyDisplayAs){
                                     report.AddData("${category_id}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${category_id}", record.Format(RepairOrder_CustomerContact_HistoryView.category_id), ReportEnum.Align.Left, 300);
                                 }
                             }
                             report.AddData("${RODateRepairCompleted}", record.Format(RepairOrder_CustomerContact_HistoryView.RODateRepairCompleted), ReportEnum.Align.Left, 300);
                             report.AddData("${repair_replace}", record.Format(RepairOrder_CustomerContact_HistoryView.repair_replace), ReportEnum.Align.Left, 300);
                             report.AddData("${RODateReturned}", record.Format(RepairOrder_CustomerContact_HistoryView.RODateReturned), ReportEnum.Align.Left, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-RepairOrders-Table-CustomerContact-History.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RepairOrder_CustomerContact_History";
                // If Show-RepairOrders-Table-CustomerContact-History.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = RepairOrder_CustomerContact_HistoryView.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  RepairOrder_CustomerContact_HistoryRecord[] DataSource {
            ...
            get {
                return (RepairOrder_CustomerContact_HistoryRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton repair_replaceLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "repair_replaceLabel");
            }
        }
        ...
        public System.Web.UI.WebControls.TextBox RepairOrder_CustomerContact_HistorySearchText2 {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RepairOrder_CustomerContact_HistorySearchText2");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton ROMakeLabel1 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROMakeLabel1");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton ROModelLabel1 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROModelLabel1");
            }
        }
        ...
        public System.Web.UI.WebControls.Label RONoLabel {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RONoLabel");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton ROSerialNoLabel1 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROSerialNoLabel1");
            }
        }
...
#region "Helper Functions"
        ...
        public override string EvaluateExpressions(string url, string arg, bool bEncrypt)
        {
            ...
            if (needToProcess) {
                RepairOrder_CustomerContact_HistoryTableControl1Row recCtl = this.GetSelectedRecordControl();
        ...
        public virtual RepairOrder_CustomerContact_HistoryTableControl1Row GetSelectedRecordControl()
        {
        ...
        public virtual RepairOrder_CustomerContact_HistoryTableControl1Row[] GetSelectedRecordControls()
        {
        
            return (RepairOrder_CustomerContact_HistoryTableControl1Row[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_RepairOrders_Table_CustomerContact_History.RepairOrder_CustomerContact_HistoryTableControl1Row")));
          
        }

        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            RepairOrder_CustomerContact_HistoryTableControl1Row[] recordList = this.GetSelectedRecordControls();
            if (recordList.Length == 0) {
                // Localization.
                throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "OEMConversion"));
            }
            
            foreach (RepairOrder_CustomerContact_HistoryTableControl1Row recCtl in recordList)
            {
                if (deferDeletion) {
        ...
        public virtual RepairOrder_CustomerContact_HistoryTableControl1Row[] GetRecordControls()
        {
            Control[] recCtrls = BaseClasses.Utils.MiscUtils.FindControlsRecursively(this, "RepairOrder_CustomerContact_HistoryTableControl1Row");
	          List<RepairOrder_CustomerContact_HistoryTableControl1Row> list = new List<RepairOrder_CustomerContact_HistoryTableControl1Row>();
	          foreach (RepairOrder_CustomerContact_HistoryTableControl1Row recCtrl in recCtrls) {
		          list.Add(recCtrl);
	          }
	          return list.ToArray();
        }
