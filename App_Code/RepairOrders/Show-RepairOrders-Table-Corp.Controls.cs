...
// Show_RepairOrders_Table_Corp.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_RepairOrders_Table_Corp
{
...
// Base class for the RepairOrdersTableControlRow control on the Show_RepairOrders_Table_Corp page.
...
public class BaseRepairOrdersTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetROCustNo1()
        {
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.RepairOrders record retrieved from the database.
            // this.ROCustNo1 is the ASP:Literal on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.ROCustNoSpecified) {
              ...
              this.ROCustNo1.Text = RepairOrdersTable.ROCustNo.Format(RepairOrdersTable.ROCustNo.DefaultValue);
      ...
      // To customize, override this method in RepairOrdersTableControlRow.
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            this.Page.Authorize((Control)ViewRowButton, "6");
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal ROCustNo1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROCustNo1");
            }
        }
...
// Base class for the RepairOrdersTableControl control on the Show_RepairOrders_Table_Corp page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
              ...
              this.ROCustNoLabel.Click += ROCustNoLabel_Click;
        ...
        {    
            ...
            columnsToInclude.AddRange("category_id,ro_subtotal,ROCategory,ROCustName,ROCustNo,RODate,RODeptIDNew,ROGrandTotal,ROMake,ROModel,RONo,ROReference1,ROReference2,ROReference4,ROSerialNo,ROStatus,ROTechnician".Split(','));
    ...
    public virtual void AddWarningMessageOnClick() {
      ...
      cols.Add(RepairOrdersTable.ROCategory, true);
            ...
            foreach (RepairOrdersRecord rec in recordList ){
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "AtBeginningOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, RepairOrdersTable.ROCustName.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "AtBeginningOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, RepairOrdersTable.RODesc.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "AtBeginningOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, RepairOrdersTable.ROBatchID.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "AtBeginningOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, RepairOrdersTable.ROEmail.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "AtBeginningOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, RepairOrdersTable.ROPhoneBusiness.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                resultItem = rec.Format(RepairOrdersTable.ROCategory);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(RepairOrdersTable.ROCategory.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "AtBeginningOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, RepairOrdersTable.ROCategory.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
      ...
      RepairOrdersRecord rec = new RepairOrdersRecord();
                        ...
                        if (recControl.ROCustNo1.Text != "") {
                            rec.Parse(recControl.ROCustNo1.Text, RepairOrdersTable.ROCustNo);
                  }
                    ...
                    
        {
            ...
            orderBy.Add(RepairOrdersTable.ROCategory, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = RepairOrdersTable.GetValues(RepairOrdersTable.ROCategory, wc, orderBy, maxItems);
            ...
            string fvalue;
            if ( RepairOrdersTable.ROCategory.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = RepairOrdersTable.ROCategory.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
        ...
        CompoundFilter filter = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
            ...
            if (EvaluateFormula("RepairOrdersTableControl.ROCustNoFilter.SelectedValue", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.DepartmentTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"department_.custno"), EvaluateFormula("RepairOrdersTableControl.ROCustNoFilter.SelectedValue", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
        ...
        protected virtual string Getro_subtotalGrandTotal()
        {
            ...
            string ro_subtotalSum = RepairOrdersTable.GetSum(RepairOrdersTable.ro_subtotal, joinFilter, wc, orderBy, BaseTable.MIN_PAGE_NUMBER, BaseTable.MAX_BATCH_SIZE);
                
            return RepairOrdersTable.ro_subtotal.Format(ro_subtotalSum);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void ROCustNoLabel_Click(object sender, EventArgs args)
        {
        ...
        public virtual void NewButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../RepairOrders/Add-RepairOrders.aspx?RoNo={Max_repairorderRecordControl:FK:VFK_max_repairorder_OEM_1}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-RepairOrders-Table-Corp.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RepairOrders";
                // If Show-RepairOrders-Table-Corp.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-RepairOrders-Table-Corp.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RepairOrders";
                // If Show-RepairOrders-Table-Corp.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton ROCustNoLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROCustNoLabel");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_RepairOrders_Table_Corp.RepairOrdersTableControlRow")));
