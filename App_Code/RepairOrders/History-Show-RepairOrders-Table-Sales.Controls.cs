...
// History_Show_RepairOrders_Table_Sales.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.History_Show_RepairOrders_Table_Sales
{
...
// Base class for the Repairorder_historyTableControl1Row control on the History_Show_RepairOrders_Table_Sales page.
...
// Base class for the Repairorder_historyTableControl1 control on the History_Show_RepairOrders_Table_Sales page.
...
public class BaseRepairorder_historyTableControl1 : OEMConversion.UI.BaseApplicationTableControl
{
           ...
           // Setup the filter and search.
            ...
            if (!this.Page.IsPostBack)
            {
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    string[] ROReference1FilteritemListFromSession = initialVal.Split(',');
                    int index = 0;
                    foreach (string item in ROReference1FilteritemListFromSession)
                    {
                        ...
                        {
                            this.ROReference1Filter.Items.Add(item);
                            this.ROReference1Filter.Items[index].Selected = true;
                            index += 1;
                        }
                    }
                    foreach (ListItem listItem in this.ROReference1Filter.Items)
                    {
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.ROModelFilter.SelectedIndexChanged += new EventHandler(ROModelFilter_SelectedIndexChanged);
              ...
              this.ROReference1Filter.SelectedIndexChanged += ROReference1Filter_SelectedIndexChanged;                  
    ...
    public virtual void AddWarningMessageOnClick() {
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.Repairorder_historySearchText1, this.GetFromSession(this.Repairorder_historySearchText1)), true, false);
            ...
            if (MiscUtils.IsValueSelected(this.ROReference1Filter)) {
                ...
                foreach (ListItem item in this.ROReference1Filter.Items){
                    if (item.Selected) {
                        selectedItemCount += 1;
                ...
                foreach (ListItem item in this.ROReference1Filter.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(Repairorder_historyView.ROReference1, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
      ...
      String ROReference1FilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "ROReference1Filter_Ajax"];
        ...
        if (ROReference1FilterSelectedValue != null){
                        string[] ROReference1FilteritemListFromSession = ROReference1FilterSelectedValue.Split(',');
                        int index = 0;
                        WhereClause filter = new WhereClause();
                        foreach (string item in ROReference1FilteritemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(Repairorder_historyView.ROReference1, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
      ...
      Repairorder_historyRecord rec = new Repairorder_historyRecord();
        ...
        public virtual void SetRODeptIDNewLabel()
                  {
                        ...
                        this.RODeptIDNewLabel.Text = EvaluateFormula("\"Department\"");
        ...
        public virtual void SetROFaultCodesLabel11()
                  {
                  
                        this.ROFaultCodesLabel11.Text = EvaluateFormula("\"Fault Codes\"");
        ...
        public virtual void SetROMakeLabel11()
                  {
                  
                        this.ROMakeLabel11.Text = EvaluateFormula("\"Make\"");
        ...
        public virtual void SetROModelLabel11()
                  {
                  
                        this.ROModelLabel11.Text = EvaluateFormula("\"Model\"");
        ...
        public virtual void SetROSerialNoLabel11()
                  {
                  
                        this.ROSerialNoLabel11.Text = EvaluateFormula("\"Serial Number\"");
        ...
        public virtual void SetROReference1Filter()
        {
            ...
            ArrayList ROReference1FilterselectedFilterItemList = new ArrayList();
            string ROReference1FilteritemsString = null;
            if (this.InSession(this.ROReference1Filter))
                ROReference1FilteritemsString = this.GetFromSession(this.ROReference1Filter);
            
            if (ROReference1FilteritemsString != null)
            {
                string[] ROReference1FilteritemListFromSession = ROReference1FilteritemsString.Split(',');
                foreach (string item in ROReference1FilteritemListFromSession)
                {
                    ROReference1FilterselectedFilterItemList.Add(item);
                }
            }
              
            			
            this.PopulateROReference1Filter(MiscUtils.GetSelectedValueList(this.ROReference1Filter, ROReference1FilterselectedFilterItemList), 500);
                    
              string url = this.ModifyRedirectUrl("../repairorder_history/Repairorder-history-QuickSelector.aspx", "", true);
              
              url = this.Page.ModifyRedirectUrl(url, "", true);                                  
              
              url += "?Target=" + this.ROReference1Filter.ClientID + "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("ROReference1")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--ANY--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:All")) + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.ROReference1Filter.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(ROReference1Filter.AutoPostBack).ToLower() + ", event); return false;";
                    ...
                    
        {
            ...
            // Setup the static list items        
                ...
                // Add the All item.
                this.corporate_nameFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
        ...
        protected virtual void PopulateROReference1Filter(ArrayList selectedValue, int maxItems)
                    
        {
            ...
            this.ROReference1Filter.SetFieldMaxLength(50);
                                 
                  
            // Add the selected value.
            if (this.ROReference1Filter.Items.Count == 0)
                this.ROReference1Filter.Items.Add(new ListItem(Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
        ...
        CompoundFilter filter = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
            ...
            if (EvaluateFormula("Repairorder_historyTableControl1.ROCustNoFilter.SelectedValue", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.RepairOrdersTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"RepairOrders_.ROCustNo"), EvaluateFormula("Repairorder_historyTableControl1.ROCustNoFilter.SelectedValue", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
        ...
        public virtual WhereClause CreateWhereClause_ROReference1Filter()
        {
            ...
            // This function is called by the Populate method to load the items 
            // in the ROReference1FilterQuickSelector
            ...
            ROReference1FilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.ROReference1Filter, ROReference1FilterselectedFilterItemList); 
            WhereClause wc = new WhereClause();
            if (ROReference1FilterselectedFilterItemList == null || ROReference1FilterselectedFilterItemList.Count == 0)
                wc.RunQuery = false;
            else            
            {
                foreach (string item in ROReference1FilterselectedFilterItemList)
                {
            
      
   
                    wc.iOR(Repairorder_historyView.ROReference1, BaseFilter.ComparisonOperator.EqualsTo, item);
        ...
        protected override void SaveControlsToSession()
        {
            ...
            ArrayList ROReference1FilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.ROReference1Filter, null);
            string ROReference1FilterSessionString = "";
            if (ROReference1FilterselectedFilterItemList != null){
                foreach (string item in ROReference1FilterselectedFilterItemList){
                    ROReference1FilterSessionString = String.Concat(ROReference1FilterSessionString ,"," , item);
                }
            }
            this.SaveToSession(this.ROReference1Filter, ROReference1FilterSessionString);
      ...
      this.SaveToSession("RONoFromFilter_Ajax", this.RONoFromFilter.Text);
            ...
            this.SaveToSession("ROReference1Filter_Ajax", ROReference1FilterSessionString);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(corporate_nameFilter))
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("History-Show-RepairOrders-Table-Sales.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "repairorder_history";
                // If History-Show-RepairOrders-Table-Sales.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("History-Show-RepairOrders-Table-Sales.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "repairorder_history";
                // If History-Show-RepairOrders-Table-Sales.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal ROFaultCodesLabel11 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROFaultCodesLabel11");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal ROMakeLabel11 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROMakeLabel11");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal ROModelLabel11 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROModelLabel11");
            }
        }
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector ROReference1Filter {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROReference1Filter");
            }
        }              
        ...
        public System.Web.UI.WebControls.Literal ROSerialNoLabel11 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROSerialNoLabel11");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual Repairorder_historyTableControl1Row[] GetSelectedRecordControls()
        {
            ...
            return (Repairorder_historyTableControl1Row[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.History_Show_RepairOrders_Table_Sales.Repairorder_historyTableControl1Row")));
