...
// RepairOrder_POD.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.RepairOrder_POD
{
...
// Base class for the DetailsSC2Row control on the RepairOrder_POD page.
...
// Base class for the DetailsSC2 control on the RepairOrder_POD page.
...
#region "Helper Functions"
        ...
        public virtual DetailsSC2Row[] GetSelectedRecordControls()
        {
            ...
            return (DetailsSC2Row[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.RepairOrder_POD.DetailsSC2Row")));
...
// Base class for the CustomersRecordControl control on the RepairOrder_POD page.
...
// Base class for the InvoiceDetails control on the RepairOrder_POD page.
...
// Base class for the RepairOrdersRecordControl control on the RepairOrder_POD page.
...
// Base class for the RepairOrdersRecordControl1 control on the RepairOrder_POD page.
