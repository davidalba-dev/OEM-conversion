...
// Show_RepairOrders_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_RepairOrders_Table
{
...
// Base class for the RepairOrdersTableControlRow control on the Show_RepairOrders_Table page.
...
// Base class for the RepairOrdersTableControl control on the Show_RepairOrders_Table page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            else
            {
                ...
                this.CurrentSortOrder.Add(RepairOrdersTable.RONo, OrderByItem.OrderDir.Desc);
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public virtual void SaveData()
        {
          ...
          Max_makemodelRecordControl recMax_makemodelRecordControl = (Max_makemodelRecordControl)(MiscUtils.FindControlRecursively(this, "Max_makemodelRecordControl"));
        recMax_makemodelRecordControl.SaveData();
      ...
      RepairOrdersRecord rec = new RepairOrdersRecord();
        ...
        public virtual void SetMax_makemodelRecordControl()           
        
        {        
            if (Max_makemodelRecordControl.Visible)
            {
                Max_makemodelRecordControl.LoadData();
                Max_makemodelRecordControl.DataBind();
            }
        }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void NewButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../RepairOrders/Add-RepairOrders.aspx?RoNo={Max_repairorderRecordControl:FK:VFK_max_repairorder_OEM_1}&makemodelid={Max_makemodelRecordControl:FV:Expr1}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-RepairOrders-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RepairOrders";
                // If Show-RepairOrders-Table.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-RepairOrders-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RepairOrders";
                // If Show-RepairOrders-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Properties"
        ...
        public Max_makemodelRecordControl Max_makemodelRecordControl {
            get {
                return (Max_makemodelRecordControl)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Max_makemodelRecordControl");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_RepairOrders_Table.RepairOrdersTableControlRow")));
...
// Base class for the Max_makemodelRecordControl control on the Show_RepairOrders_Table page.
...
public class BaseMax_makemodelRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetExpr11()
        {
            ...
            if (this.DataSource != null && this.DataSource.Expr1Specified) {
              ...
              this.Expr11.Text = Max_makemodelView.Expr1.Format(Max_makemodelView.Expr1.DefaultValue);
...
// Base class for the Max_repairorderRecordControl control on the Show_RepairOrders_Table page.
...
public class BaseMax_repairorderRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetExpr1()
        {
            ...
            if (this.DataSource != null && this.DataSource.OEMSpecified) {
              ...
              this.Expr1.Text = Max_repairorderView.OEM.Format(Max_repairorderView.OEM.DefaultValue);
