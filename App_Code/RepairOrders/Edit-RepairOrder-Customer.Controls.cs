...
// Edit_RepairOrder_Customer.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_RepairOrder_Customer
{
...
// Base class for the RepairOrdersRecordControl control on the Edit_RepairOrder_Customer page.
...
public class BaseRepairOrdersRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in RepairOrdersRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Edit-RepairOrder-Customer"] = recId;
...
// Base class for the RepairOrdersRecordControl1 control on the Edit_RepairOrder_Customer page.
...
public class BaseRepairOrdersRecordControl1 : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetROCustNo()
        {
            ...
            this.PopulateROCustNoDropDownList(selectedValue, 2500);              
