...
// Show_RepairOrders_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_RepairOrders_Mobile
{
...
// Base class for the RepairOrdersRecordControl control on the Show_RepairOrders_Mobile page.
...
public class BaseRepairOrdersRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in RepairOrdersRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-RepairOrders-Mobile"] = recId;
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            this.Page.Authorize((Control)EditButton, "3");
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void Button1_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../RepairOrders/RepairOrder-POD-Mobile.aspx?RepairOrders={RepairOrdersRecordControl:PK}";
...
#region "Helper Properties"
        ...
        public OEMConversion.UI.IThemeButtonMobile Button1 {
            get {
                return (OEMConversion.UI.IThemeButtonMobile)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Button1");
            }
        }
