...
// Internal_Add_Procurement_request.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Internal_Add_Procurement_request
{
...
// Base class for the Procurement_requestRecordControl control on the Internal_Add_Procurement_request page.
...
public class BaseProcurement_requestRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setrequest_status_id1()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
              ...
              this.request_status_id1.Text = EvaluateFormula("1", this.DataSource);
      ...
      // To customize, override this method in Procurement_requestRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Internal-Add-Procurement-request"] = recId;
