...
// Show_Procurement_request_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Procurement_request_Table
{
...
// Base class for the Procurement_requestTableControlRow control on the Show_Procurement_request_Table page.
        ...
        public virtual void SetLiteral()
                  {
                        ...
                        this.Literal.Text = EvaluateFormula("If(new_replace=\"N\",\"<a href=../procurement_request/edit-procurement-request.aspx?procurement_request=\"+EncryptData(procurement_request_id.ToString())+\"><img src=../images/icon_edit.gif></a>\",\"<a href=../procurement_request/edit-procurement-request-replace.aspx?procurement_request=\"+EncryptData(procurement_request_id.ToString())+\"><img src=../images/icon_edit.gif></a>\")");
...
// Base class for the Procurement_requestTableControl control on the Show_Procurement_request_Table page.
...
public class BaseProcurement_requestTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    public virtual void AddWarningMessageOnClick() {
      ...
      String procurement_status_idFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "procurement_status_idFilter_Ajax"];
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            filter.AddFilter(new BaseClasses.Data.ColumnJoinFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Procurement_requestTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"procurement_request_.custno"), new BaseClasses.Data.IdentifierAliasInfo(@"procurement_request_", null), BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.CustomerContactsTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"CustomerContacts_.CustNo"), new BaseClasses.Data.IdentifierAliasInfo(@"CustomerContacts_", null),  BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
      ...
      Procurement_requestRecord rec = new Procurement_requestRecord();
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            this.Page.Authorize((Control)Button, "4;5;6");
					
            this.Page.Authorize((Control)Button1, "4;5;6");
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                    string url = "../procurement_request/Add-Procurement-request.aspx?SaveAndNewVisible=False&TabVisible=False";
              ...
              
        {
              ...
              try
              {
                    string url = "../procurement_request/Add-Procurement-request-replace.aspx?SaveAndNewVisible=False&TabVisible=False";
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Procurement-request-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "procurement_request";
                // If Show-Procurement-request-Table.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Procurement-request-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "procurement_request";
                // If Show-Procurement-request-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual Procurement_requestTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Procurement_requestTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Procurement_request_Table.Procurement_requestTableControlRow")));
