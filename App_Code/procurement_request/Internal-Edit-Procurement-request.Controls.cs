...
// Internal_Edit_Procurement_request.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Internal_Edit_Procurement_request
{
...
// Base class for the Procurement_requestRecordControl control on the Internal_Edit_Procurement_request page.
...
public class BaseProcurement_requestRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in Procurement_requestRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Internal-Edit-Procurement-request"] = recId;
