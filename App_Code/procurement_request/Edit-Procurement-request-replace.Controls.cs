...
// Edit_Procurement_request_replace.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Procurement_request_replace
{
...
// Base class for the Procurement_requestRecordControl control on the Edit_Procurement_request_replace page.
...
public class BaseProcurement_requestRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setrequest_status_id()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
              ...
              this.request_status_id.Text = EvaluateFormula("2", this.DataSource);
      ...
      // To customize, override this method in Procurement_requestRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Edit-Procurement-request-replace"] = recId;
                        ...
                        if (itemValue.department_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.department_id.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                if(_isExpandableNonCompositeForeignKey && Procurement_requestTable.department_id.IsApplyDisplayAs)
                                    fvalue = Procurement_requestTable.GetDFKA(itemValue, Procurement_requestTable.department_id);
                                if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
