...
// Edit_Procurement_request.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Procurement_request
{
...
// Base class for the Procurement_requestRecordControl control on the Edit_Procurement_request page.
...
public class BaseProcurement_requestRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setprocurement_status_id()
        {
            ...
            if (this.DataSource != null && this.DataSource.procurement_status_idSpecified)
            {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = Procurement_requestTable.procurement_status_id.DefaultValue;
        ...
        public virtual void Setprocurement_status_id1()
        {
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.procurement_request record retrieved from the database.
            // this.procurement_status_id1 is the ASP:Literal on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.procurement_status_idSpecified) {
               ...
               if(_isExpandableNonCompositeForeignKey &&Procurement_requestTable.procurement_status_id.IsApplyDisplayAs)
                     ...
                     formattedValue = Procurement_requestTable.GetDFKA(this.DataSource.procurement_status_id.ToString(),Procurement_requestTable.procurement_status_id, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(Procurement_requestTable.procurement_status_id);
                                  
                                
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                this.procurement_status_id1.Text = formattedValue;
              ...
              this.procurement_status_id1.Text = Procurement_requestTable.procurement_status_id.Format(Procurement_requestTable.procurement_status_id.DefaultValue);
        ...
        public virtual void Getprocurement_status_id1()
        {
      ...
      // To customize, override this method in Procurement_requestRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Edit-Procurement-request"] = recId;
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            this.Page.Authorize((Control)procurement_status_id, "1;3");
					
            this.Page.Authorize((Control)procurement_status_id1, "4;5;6");
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal procurement_status_id1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "procurement_status_id1");
            }
        }
            
        public System.Web.UI.WebControls.Literal procurement_status_idLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "procurement_status_idLabel");
            }
        }
