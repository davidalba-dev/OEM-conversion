...
// Add_Procurement_request_replace.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Procurement_request_replace
{
...
// Base class for the Procurement_requestRecordControl control on the Add_Procurement_request_replace page.
...
public class BaseProcurement_requestRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in Procurement_requestRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Add-Procurement-request-replace"] = recId;
