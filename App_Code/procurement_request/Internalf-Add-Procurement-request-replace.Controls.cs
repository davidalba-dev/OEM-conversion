...
// Internalf_Add_Procurement_request_replace.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Internalf_Add_Procurement_request_replace
{
...
// Base class for the Procurement_requestRecordControl control on the Internalf_Add_Procurement_request_replace page.
...
public class BaseProcurement_requestRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.request_status_id1.TextChanged += request_status_id1_TextChanged;
        ...
        public virtual void Setcustno1()
        {
            ...
            // Set AutoPostBack to true so that when the control value is changed, to refresh custcontactkey,department_id controls
            this.custno1.AutoPostBack = true;
            ...
            this.Populatecustno1DropDownList(selectedValue, 2000);              
        ...
        public virtual void Setnew_replace()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
              ...
              this.new_replace.Text = EvaluateFormula("\"R\"", this.DataSource);
        ...
        public virtual void Setprocurement_status_id()
        {
            ...
            else
            {
                ...
                selectedValue = EvaluateFormula("\"1\"");
        ...
        public virtual void Setrequest_status_id1()
        {
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.procurement_request record retrieved from the database.
            // this.request_status_id1 is the ASP:TextBox on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
               ...
               string formattedValue = this.DataSource.request_status_id.ToString();
                ...
                this.request_status_id1.Text = formattedValue;
              ...
              this.request_status_id1.Text = EvaluateFormula("2", this.DataSource);
        ...
        public virtual void Getcustno1()
        {
         // Retrieve the value entered by the user on the custno ASP:DropDownList, and
            ...
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.custno1), Procurement_requestTable.custno);			
        ...
        public virtual void Getrequest_status_id1()
        {
            ...
            // Save the value to data source
            this.DataSource.Parse(this.request_status_id1.Text, Procurement_requestTable.request_status_id);							
      ...
      // To customize, override this method in Procurement_requestRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Internalf-Add-Procurement-request-replace"] = recId;
        ...
        public virtual WhereClause CreateWhereClause_department_idDropDownList() 
        {
            ...
            if (EvaluateFormula("Procurement_requestRecordControl.custno1.SelectedValue", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.DepartmentTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"department_.custno"), EvaluateFormula("Procurement_requestRecordControl.custno1.SelectedValue", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("Procurement_requestRecordControl.custno1.SelectedValue", false) == "--PLEASE_SELECT--" || EvaluateFormula("Procurement_requestRecordControl.custno1.SelectedValue", false) == "--ANY--") whereClause.RunQuery = false;
        ...
        public virtual WhereClause CreateWhereClause_custcontactkeyDropDownList() 
        {
            ...
            if (EvaluateFormula("Procurement_requestRecordControl.custno1.SelectedValue", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.CustomerContactsTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"CustomerContacts_.CustNo"), EvaluateFormula("Procurement_requestRecordControl.custno1.SelectedValue", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
        ...
        protected virtual void Populateprocurement_status_idDropDownList(string selectedValue, int maxItems) 
        {
            ...
            // 1. Setup the static list items        
              ...
              // Add the Please Select item.
              this.procurement_status_id.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "OEMConversion"), "--PLEASE_SELECT--"));
        ...
        protected virtual void request_status_id1_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox request_status_id1 {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "request_status_id1");
            }
        }
