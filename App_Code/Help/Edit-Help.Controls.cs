...
// Edit_Help.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Help
{
...
// Base class for the HelpRecordControl control on the Edit_Help page.
...
public class BaseHelpRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in HelpRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Edit-Help"] = recId;
