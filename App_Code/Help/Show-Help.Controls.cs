...
// Show_Help.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Help
{
...
// Base class for the HelpRecordControl control on the Show_Help page.
...
public class BaseHelpRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "HelpRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            this.DataSource = HelpTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public virtual void Sethelp_file1()
        {
            // Set the help_file Image on the webpage with value from the
            ...
            // this.help_file1 is the ASP:Image on the webpage.

            if (this.DataSource != null && this.DataSource.help_fileSpecified) {
                // If the help_file is non-NULL, then format the value.
                // The Format method will use the Display Format
                  String name = HttpUtility.HtmlEncode(HelpTable.help_file.Name);
                  ...
                  this.help_file1.Attributes.Add("onclick", "gPersist=true;");
                  this.help_file1.Attributes.Add("onmouseout","detailRolloverPopupClose();");
                  this.help_file1.Attributes.Add("onmouseover","SaveMousePosition(event);delayRolloverPopup(\"PageMethods.GetImage(\\\"" + "NULL" +
                  "\\\", \\\"" + this.Page.Encrypt("Help") +
                  "\\\", \\\"" + this.Page.Encrypt(HttpUtility.UrlEncode(this.DataSource.GetID().ToString())) + 
                  "\\\", \\\"" + this.Page.Encrypt("help_file") + "\\\", \\\"" + NetUtils.EncodeStringForHtmlDisplay(name.Substring(0, name.Length))+ "\\\",\\\"" + Page.GetResourceValue("Btn:Close", "OEMConversion") + "\\\", false, 200," +
                  " 300, true, PopupDisplayWindowCallBackWith20);\", 500);");
                        
                // Shrunk image size specified by ImagePercentSize on Properties.
                this.help_file1.ImageUrl = this.DataSource.FormatImageUrl(HelpTable.help_file, this.Page.Encrypt("Help"), this.Page.Encrypt("help_file"), this.Page.Encrypt(this.DataSource.GetID().ToXmlString()), 100);
                            
                this.help_file1.Visible = true;
                                    
            } 
            else {
                // help_file is NULL in the database, so use the Default Value.  
                // Default Value could also be NULL.
                this.help_file1.Visible = false;
            }
      ...
      // To customize, override this method in HelpRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Help"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "Help"));
            }
            HttpContext.Current.Session["QueryString in Show-Help"] = recId;
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Image help_file1 {
            get {
                return (System.Web.UI.WebControls.Image)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "help_file1");
            }
        }
