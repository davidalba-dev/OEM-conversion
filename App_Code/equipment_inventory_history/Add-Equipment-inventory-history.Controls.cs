...
// Add_Equipment_inventory_history.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Equipment_inventory_history
{
...
// Base class for the Equipment_inventory_historyRecordControl control on the Add_Equipment_inventory_history page.
...
public class BaseEquipment_inventory_historyRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (Equipment_inventory_historyRecord)Equipment_inventory_historyRecord.Copy(recList[0], false);
        ...
        public virtual void Setdatetime_entered()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
              ...
              this.datetime_entered.Text = EvaluateFormula("Now()", this.DataSource, @"g");
        ...
        public virtual void Settechnician_id()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = Equipment_inventory_historyTable.technician_id.DefaultValue;
        ...
        public virtual void Setwarehouse_location_id()
        {
            ...
            this.Populatewarehouse_location_idDropDownList(selectedValue, 2500);              
        ...
        public virtual void Getinventory_id()
        {
            ...
            // Save the value to data source
            this.DataSource.Parse(this.inventory_id.Text, Equipment_inventory_historyTable.inventory_id);							
        ...
        public virtual void Gettechnician_id()
        {
         // Retrieve the value entered by the user on the technician_id ASP:DropDownList, and
            // save it into the technician_id field in DataSource DatabaseAYS_OEM%dbo.equipment_inventory_history record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.technician_id), Equipment_inventory_historyTable.technician_id);			
      ...
      // To customize, override this method in Equipment_inventory_historyRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Equipment_inventory_history"];
            ...
            HttpContext.Current.Session["QueryString in Add-Equipment-inventory-history"] = recId;
        ...
        public virtual WhereClause CreateWhereClause_warehouse_location_idDropDownList() 
        {
            ...
            if (EvaluateFormula("Equipment_inventory_historyRecordControl.warehouse_id.SelectedValue", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Warehouse_locationTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"warehouse_location_.warehouse_id"), EvaluateFormula("Equipment_inventory_historyRecordControl.warehouse_id.SelectedValue", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("1", false) == "--PLEASE_SELECT--" || EvaluateFormula("1", false) == "--ANY--") whereClause.RunQuery = false;
         if (EvaluateFormula("Equipment_inventory_historyRecordControl.warehouse_id.SelectedValue", false) == "--PLEASE_SELECT--" || EvaluateFormula("Equipment_inventory_historyRecordControl.warehouse_id.SelectedValue", false) == "--ANY--") whereClause.RunQuery = false;
...
#region "Helper Properties"
    ...
    Equipment_inventory_historyRecord rec = null;
             ...
             
        {
            ...
            return new Equipment_inventory_historyRecord();
