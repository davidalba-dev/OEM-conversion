...
// Show_Equipment_inventory_history.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Equipment_inventory_history
{
...
// Base class for the Equipment_inventory_historyRecordControl control on the Show_Equipment_inventory_history page.
...
public class BaseEquipment_inventory_historyRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setinventory_id()
        {
            ...
            if (this.DataSource != null && this.DataSource.inventory_idSpecified) {
              ...
              this.inventory_id.Text = Equipment_inventory_historyTable.inventory_id.Format(Equipment_inventory_historyTable.inventory_id.DefaultValue);
        ...
        public virtual void Setwarehouse_location_id()
        {
            ...
            if (this.DataSource != null && this.DataSource.warehouse_location_idSpecified) {
              ...
              this.warehouse_location_id.Text = Equipment_inventory_historyTable.warehouse_location_id.Format(Equipment_inventory_historyTable.warehouse_location_id.DefaultValue);
      ...
      // To customize, override this method in Equipment_inventory_historyRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-Equipment-inventory-history"] = recId;
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void inventory_id_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../equipment_inventory/Show-Equipment-inventory.aspx?Equipment_inventory={Equipment_inventory_historyRecordControl:FK:FK_equipment_inventory_history_equipment_inventory}";
