...
// Add_Project_role_rate.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Project_role_rate
{
...
// Base class for the Project_role_rateRecordControl control on the Add_Project_role_rate page.
...
public class BaseProject_role_rateRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.project_role_id.TextChanged += project_role_id_TextChanged;
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (Project_role_rateRecord)Project_role_rateRecord.Copy(recList[0], false);
        ...
        public virtual void Setproject_role_id()
        {
            ...
            // Set the project_role_id TextBox on the webpage with value from the
            ...
            // this.project_role_id is the ASP:TextBox on the webpage.
                  
            if (this.DataSource != null && this.DataSource.IsCreated) {
                								
                // If the project_role_id is non-NULL, then format the value.
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = this.DataSource.project_role_id.ToString();
                            
                this.project_role_id.Text = formattedValue;
              ...
              this.project_role_id.Text = EvaluateFormula("URL(\"project_role\")", this.DataSource);
        ...
        public virtual void Setproject_role_rate_startdate()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
              ...
              this.project_role_rate_startdate.Text = EvaluateFormula("Today()", this.DataSource, @"d");
        ...
        public virtual void Getproject_role_id()
        {
            ...
            // Retrieve the value entered by the user on the project_role_id ASP:TextBox, and
            // save it into the project_role_id field in DataSource DatabaseAYS_OEM%dbo.project_role_rate record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.project_role_id.Text, Project_role_rateTable.project_role_id);							
      ...
      // To customize, override this method in Project_role_rateRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Project_role_rate"];
            ...
            HttpContext.Current.Session["QueryString in Add-Project-role-rate"] = recId;
        ...
        protected virtual void project_role_id_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox project_role_id {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "project_role_id");
            }
        }
    ...
    Project_role_rateRecord rec = null;
             ...
             
        {
            ...
            return new Project_role_rateRecord();
