...
// Show_Conditions_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Conditions_Mobile
{
...
// Base class for the RepairOrdersTableControlRow control on the Show_Conditions_Mobile page.
...
// Base class for the RepairOrdersTableControl control on the Show_Conditions_Mobile page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Show_Conditions_Mobile.ConditionsRecordControl conditionsRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "ConditionsRecordControl") as OEMConversion.UI.Controls.Show_Conditions_Mobile.ConditionsRecordControl);
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Conditions_Mobile.RepairOrdersTableControlRow")));
...
// Base class for the ConditionsRecordControl control on the Show_Conditions_Mobile page.
...
public class BaseConditionsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in ConditionsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-Conditions-Mobile"] = recId;
