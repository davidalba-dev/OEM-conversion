...
// Show_Conditions.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Conditions
{
...
public class ConditionsRecordControl : BaseConditionsRecordControl
{
      
        // The BaseConditionsRecordControl implements the LoadData, DataBind and other
...
// Base class for the RepairOrdersTableControlRow control on the Show_Conditions page.
...
public class BaseRepairOrdersTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        ConditionsRecordControl parentCtrl;
      
            parentCtrl = (ConditionsRecordControl)this.Page.FindControlRecursively("ConditionsRecordControl");
        ...
        throw new Exception(Page.GetResourceValue("Err:NoParentRecId", "OEMConversion"));
          ...
          this.DataSource.ROCondition = parentCtrl.DataSource.Condition;
      ...
      // To customize, override this method in RepairOrdersTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersConditionsRecordControl = false;
            hasFiltersConditionsRecordControl = hasFiltersConditionsRecordControl && false; // suppress warning
...
// Base class for the RepairOrdersTableControl control on the Show_Conditions page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Show_Conditions.ConditionsRecordControl conditionsRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "ConditionsRecordControl") as OEMConversion.UI.Controls.Show_Conditions.ConditionsRecordControl);
          
              if (conditionsRecordControlObj != null && conditionsRecordControlObj.GetRecord() != null && conditionsRecordControlObj.GetRecord().IsCreated && conditionsRecordControlObj.GetRecord().Condition != null)
              {
              wc.iAND(RepairOrdersTable.ROCondition, BaseFilter.ComparisonOperator.EqualsTo, conditionsRecordControlObj.GetRecord().Condition.ToString());
              selectedRecordKeyValue.AddElement(RepairOrdersTable.ROCondition.InternalName, conditionsRecordControlObj.GetRecord().Condition.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInConditionsRecordControl = HttpContext.Current.Session["RepairOrdersTableControlWhereClause"] as string;
      
      if (selectedRecordInConditionsRecordControl != null && KeyValue.IsXmlKey(selectedRecordInConditionsRecordControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInConditionsRecordControl);
      
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(RepairOrdersTable.ROCondition))
      {
      wc.iAND(RepairOrdersTable.ROCondition, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(RepairOrdersTable.ROCondition).ToString());
      }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                    string url = "../RepairOrders/Add-RepairOrders.aspx?ROCondition={ConditionsRecordControl:FV:Condition}&TabVisible=False&SaveAndNewVisible=False";
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Conditions.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RepairOrders";
                // If Show-Conditions.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Conditions.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RepairOrders";
                // If Show-Conditions.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Conditions.RepairOrdersTableControlRow")));
...
// Base class for the ConditionsRecordControl control on the Show_Conditions page.
// Do not modify this class. Instead override any method in ConditionsRecordControl.
public class BaseConditionsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseConditionsRecordControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        // To customize, override this method in ConditionsRecordControl.
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "ConditionsRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            ConditionsRecord[] recList = ConditionsTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = ConditionsTable.GetRecord(recList[0].GetID().ToXmlString(), true);
      ...
      // To customize, override this method in ConditionsRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Conditions"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "Conditions"));
            }
            HttpContext.Current.Session["QueryString in Show-Conditions"] = recId;
          ...
          wc.iAND(ConditionsTable.Condition, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(ConditionsTable.Condition));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(ConditionsTable.Condition, BaseFilter.ComparisonOperator.EqualsTo, recId);
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseConditionsRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseConditionsRecordControl_Rec"] = value;
            }
        }
