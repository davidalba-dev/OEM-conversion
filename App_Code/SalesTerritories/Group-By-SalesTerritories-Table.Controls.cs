...
// Group_By_SalesTerritories_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Group_By_SalesTerritories_Table
{
...
// Base class for the SalesTerritoriesTableControlRow control on the Group_By_SalesTerritories_Table page.
...
public class BaseSalesTerritoriesTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ExpandRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                SalesTerritoriesTableControl panelControl = (MiscUtils.GetParentControlObject(this, "SalesTerritoriesTableControl") as SalesTerritoriesTableControl);

          SalesTerritoriesTableControlRow[] repeatedRows = panelControl.GetRecordControls();
          foreach (SalesTerritoriesTableControlRow repeatedRow in repeatedRows)
          {
              System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(repeatedRow, "SalesTerritoriesTableControlAltRow") as System.Web.UI.Control);
              if (altRow != null)
              {
...
// Base class for the SalesTerritoriesTableControl control on the Group_By_SalesTerritories_Table page.
...
public class BaseSalesTerritoriesTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
      ...
      public override void DataBind()
      {
        ...
        SalesTerritoriesTableControlRow[] recControls = this.GetRecordControls();
            for (int i = 0; i < recControls.Length; i++)
            {
                System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(recControls[i], "SalesTerritoriesTableControlAltRow") as System.Web.UI.Control);
                if (altRow != null){
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
                    ...
                    this.ImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=SalesTerritories" ;
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
             ...
             null};
                ...
                DataForExport dataForCSV = new DataForExport(SalesTerritoriesTable.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(SalesTerritoriesTable.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(SalesTerritoriesTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(SalesTerritoriesTable.territory_id, "Default"));
             data.ColumnList.Add(new ExcelColumn(SalesTerritoriesTable.technician_id, "Default"));
              ...
              {
                val = SalesTerritoriesTable.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Group-By-SalesTerritories-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "SalesTerritories";
                // If Group-By-SalesTerritories-Table.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(SalesTerritoriesTable.territory_id.Name, ReportEnum.Align.Left, "${territory_id}", ReportEnum.Align.Left, 28);
                 report.AddColumn(SalesTerritoriesTable.technician_id.Name, ReportEnum.Align.Left, "${technician_id}", ReportEnum.Align.Left, 20);
                ...
                ColumnList columns = SalesTerritoriesTable.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = SalesTerritoriesTable.GetRecordCount(joinFilter,whereClause);
                SalesTerritoriesRecord[] records = null;
                
                do
                {
                    
                    records = SalesTerritoriesTable.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( SalesTerritoriesRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                 ...
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = SalesTerritoriesTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(SalesTerritoriesTable.territory_id);
                                 _DFKA = SalesTerritoriesTable.GetDFKA(record.territory_id.ToString(), SalesTerritoriesTable.territory_id,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  SalesTerritoriesTable.territory_id.IsApplyDisplayAs){
                                     report.AddData("${territory_id}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${territory_id}", record.Format(SalesTerritoriesTable.territory_id), ReportEnum.Align.Left, 300);
                                 }
                             }
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.technician_id)){
                                 ...
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = SalesTerritoriesTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(SalesTerritoriesTable.technician_id);
                                 _DFKA = SalesTerritoriesTable.GetDFKA(record.technician_id.ToString(), SalesTerritoriesTable.technician_id,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  SalesTerritoriesTable.technician_id.IsApplyDisplayAs){
                                     report.AddData("${technician_id}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${technician_id}", record.Format(SalesTerritoriesTable.technician_id), ReportEnum.Align.Left);
                                 }
                             }
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Group-By-SalesTerritories-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "SalesTerritories";
                // If Group-By-SalesTerritories-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual SalesTerritoriesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SalesTerritoriesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Group_By_SalesTerritories_Table.SalesTerritoriesTableControlRow")));
