...
// Add_SalesTerritories.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_SalesTerritories
{
...
// Base class for the SalesTerritoriesRecordControl control on the Add_SalesTerritories page.
...
public class BaseSalesTerritoriesRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (SalesTerritoriesRecord)SalesTerritoriesRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in SalesTerritoriesRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["SalesTerritories"];
            ...
            HttpContext.Current.Session["QueryString in Add-SalesTerritories"] = recId;
...
#region "Helper Properties"
    ...
    SalesTerritoriesRecord rec = null;
             ...
             
        {
            ...
            return new SalesTerritoriesRecord();
