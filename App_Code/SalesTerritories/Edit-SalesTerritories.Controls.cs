...
// Edit_SalesTerritories.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_SalesTerritories
{
...
public class SalesTerritoriesRecordControl : BaseSalesTerritoriesRecordControl
{
      
        // The BaseSalesTerritoriesRecordControl implements the LoadData, DataBind and other
...
// Base class for the SalesTerritoriesRecordControl control on the Edit_SalesTerritories page.
// Do not modify this class. Instead override any method in SalesTerritoriesRecordControl.
public class BaseSalesTerritoriesRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseSalesTerritoriesRecordControl()
        {
        ...
        // To customize, override this method in SalesTerritoriesRecordControl.
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "SalesTerritoriesRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            SalesTerritoriesRecord[] recList = SalesTerritoriesTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = SalesTerritoriesTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public virtual void Settechnician_id()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = SalesTerritoriesTable.technician_id.DefaultValue;
        ...
        public virtual void Setterritory_id()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = SalesTerritoriesTable.territory_id.DefaultValue;
        ...
        public virtual void Gettechnician_id()
        {
         // Retrieve the value entered by the user on the technician_id ASP:DropDownList, and
            // save it into the technician_id field in DataSource DatabaseAYS_OEM%dbo.SalesTerritories record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.technician_id), SalesTerritoriesTable.technician_id);			
        ...
        public virtual void Getterritory_id()
        {
         // Retrieve the value entered by the user on the territory_id ASP:DropDownList, and
            // save it into the territory_id field in DataSource DatabaseAYS_OEM%dbo.SalesTerritories record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.territory_id), SalesTerritoriesTable.territory_id);			
      ...
      // To customize, override this method in SalesTerritoriesRecordControl.
         ...
         
        {
            ...
            bool hasFiltersSalesTerritoriesRecordControl = false;
            hasFiltersSalesTerritoriesRecordControl = hasFiltersSalesTerritoriesRecordControl && false; // suppress warning
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["SalesTerritories"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "SalesTerritories"));
            }
            HttpContext.Current.Session["QueryString in Edit-SalesTerritories"] = recId;
          ...
          wc.iAND(SalesTerritoriesTable.sales_territories_id, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(SalesTerritoriesTable.sales_territories_id));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(SalesTerritoriesTable.sales_territories_id, BaseFilter.ComparisonOperator.EqualsTo, recId);
        ...
        public virtual WhereClause CreateWhereClause_territory_idDropDownList() 
        {
            ...
            // Examples:
            // wc.iAND(TerritoryTable.territory_name, BaseFilter.ComparisonOperator.EqualsTo, "XYZ");
                        ...
                        if (itemValue.territory_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.territory_id.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                if(_isExpandableNonCompositeForeignKey && SalesTerritoriesTable.territory_id.IsApplyDisplayAs)
                                    fvalue = SalesTerritoriesTable.GetDFKA(itemValue, SalesTerritoriesTable.territory_id);
                                if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
                                    fvalue = itemValue.Format(TerritoryTable.territory_name);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseSalesTerritoriesRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseSalesTerritoriesRecordControl_Rec"] = value;
            }
        }
