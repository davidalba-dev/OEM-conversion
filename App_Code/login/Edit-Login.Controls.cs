...
// Edit_Login.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Login
{
...
// Base class for the LoginRecordControl control on the Edit_Login page.
...
public class BaseLoginRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.customer_contact_id.TextChanged += customer_contact_id_TextChanged;
        ...
        public virtual void Setcustomer_contact_id()
        {
            ...
            // Set the customer_contact_id TextBox on the webpage with value from the
            ...
            // this.customer_contact_id is the ASP:TextBox on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.customer_contact_idSpecified) {
               ...
               string formattedValue = this.DataSource.customer_contact_id.ToString();
                            
                this.customer_contact_id.Text = formattedValue;
              ...
              this.customer_contact_id.Text = LoginTable.customer_contact_id.DefaultValue;
        ...
        public virtual void Settechnician_id()
        {
            ...
            if (this.DataSource != null && this.DataSource.technician_idSpecified) {
              ...
              this.technician_id.Text = LoginTable.technician_id.DefaultValue;
        ...
        public virtual void Getcustomer_contact_id()
        {
            ...
            // Retrieve the value entered by the user on the customer_contact_id ASP:TextBox, and
            // save it into the customer_contact_id field in DataSource DatabaseAYS_OEM%dbo.login record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.customer_contact_id.Text, LoginTable.customer_contact_id);							
        ...
        public virtual void Gettechnician_id()
        {
            ...
            // Save the value to data source
            this.DataSource.Parse(this.technician_id.Text, LoginTable.technician_id);							
      ...
      // To customize, override this method in LoginRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Login"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "Login"));
            }
            HttpContext.Current.Session["QueryString in Edit-Login"] = recId;
        ...
        protected virtual void customer_contact_id_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox customer_contact_id {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "customer_contact_id");
            }
        }
