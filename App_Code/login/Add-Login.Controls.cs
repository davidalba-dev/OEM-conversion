...
// Add_Login.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Login
{
...
// Base class for the LoginRecordControl control on the Add_Login page.
...
public class BaseLoginRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Settechnician_id()
        {
            ...
            else
            {
                ...
                selectedValue = EvaluateFormula("URL(\"tid\")");
      ...
      // To customize, override this method in LoginRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Add-Login"] = recId;
        ...
        public virtual WhereClause CreateWhereClause_role_idDropDownList() 
        {
            ...
            if (EvaluateFormula("\"3\"", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.RoleTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"role_.role_id"), EvaluateFormula("\"3\"", false), BaseClasses.Data.BaseFilter.ComparisonOperator.Less_Than_Or_Equal, false));
        ...
        public virtual WhereClause CreateWhereClause_technician_idDropDownList() 
        {
            ...
            if (EvaluateFormula("URL(\"tid\")", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.TechniciansTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"Technicians_.technician_id"), EvaluateFormula("URL(\"tid\")", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("URL(\"tid\")", false) == "--PLEASE_SELECT--" || EvaluateFormula("URL(\"tid\")", false) == "--ANY--") whereClause.RunQuery = false;
