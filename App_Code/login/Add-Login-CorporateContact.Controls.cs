...
// Add_Login_CorporateContact.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Login_CorporateContact
{
...
// Base class for the LoginRecordControl control on the Add_Login_CorporateContact page.
...
public class BaseLoginRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.corporatecontact_id.TextChanged += corporatecontact_id_TextChanged;
        ...
        public virtual void Setcorporate_id()
        {
            ...
            else
            {
                ...
                selectedValue = EvaluateFormula("URL(\"corporateid\")");
                ...
                !MiscUtils.SetSelectedDisplayText(this.corporate_id, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        Boolean _isExpandableNonCompositeForeignKey = LoginTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(LoginTable.corporate_id);
                        if(_isExpandableNonCompositeForeignKey && LoginTable.corporate_id.IsApplyDisplayAs)
                            fvalue = LoginTable.GetDFKA(itemValue, LoginTable.corporate_id);
        ...
        public virtual void Setcorporatecontact_id()
        {
            ...
            // Set the corporatecontact_id TextBox on the webpage with value from the
            // DatabaseAYS_OEM%dbo.login database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.login record retrieved from the database.
            // this.corporatecontact_id is the ASP:TextBox on the webpage.
                  
            if (this.DataSource != null && this.DataSource.IsCreated) {
                								
                // If the corporatecontact_id is non-NULL, then format the value.
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = this.DataSource.corporatecontact_id.ToString();
              ...
              this.corporatecontact_id.Text = EvaluateFormula("URL(\"corporatecontact\")", this.DataSource);
        ...
        public virtual void SetLiteral()
                  {
                        ...
                        this.Literal.Text = EvaluateFormula("If(URL(\"corporatecontact_email\")=\"\",\"<font color=red><b>The User Account you created already exists</b></font>\",\"Create User Login\")");
        ...
        public virtual void Getcorporate_id()
        {
         // Retrieve the value entered by the user on the corporate_id ASP:QuickSelector, and
            // save it into the corporate_id field in DataSource DatabaseAYS_OEM%dbo.login record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.corporate_id), LoginTable.corporate_id);			
        ...
        public virtual void Getcorporatecontact_id()
        {
            ...
            // Retrieve the value entered by the user on the corporatecontact_id ASP:TextBox, and
            // save it into the corporatecontact_id field in DataSource DatabaseAYS_OEM%dbo.login record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.corporatecontact_id.Text, LoginTable.corporatecontact_id);							
      ...
      // To customize, override this method in LoginRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Add-Login-CorporateContact"] = recId;
        ...
        public virtual WhereClause CreateWhereClause_role_idDropDownList() 
        {
            ...
            if (EvaluateFormula("6", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.RoleTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"role_.role_id"), EvaluateFormula("6", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
        ...
        protected virtual void corporatecontact_id_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox corporatecontact_id {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "corporatecontact_id");
            }
        }
