...
// Add_Loaner_inventory.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Loaner_inventory
{
...
// Base class for the Loaner_inventoryRecordControl control on the Add_Loaner_inventory page.
...
public class BaseLoaner_inventoryRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (Loaner_inventoryRecord)Loaner_inventoryRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in Loaner_inventoryRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Loaner_inventory"];
            ...
            HttpContext.Current.Session["QueryString in Add-Loaner-inventory"] = recId;
...
#region "Helper Properties"
    ...
    Loaner_inventoryRecord rec = null;
             ...
             
        {
            ...
            return new Loaner_inventoryRecord();
