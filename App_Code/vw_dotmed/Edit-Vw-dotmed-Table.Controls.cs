...
// Edit_Vw_dotmed_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Vw_dotmed_Table
{
...
//}
//
public class Dotmed_processTableControl1 : BaseDotmed_processTableControl1
{
    // The BaseDotmed_processTableControl1 class implements the LoadData, DataBind, CreateWhereClause
    // and other methods to load and display the data in a table control.

    // This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
    // The Dotmed_processTableControl1Row class offers another place where you can customize
    // the DataBind, GetUIData, SaveData and Validate methods specific to each row displayed on the table.
    
}
public class Dotmed_processTableControl1Row : BaseDotmed_processTableControl1Row
{
      
        // The BaseDotmed_processTableControl1Row implements code for a ROW within the
        // the Dotmed_processTableControl1 table.  The BaseDotmed_processTableControl1Row implements the DataBind and SaveData methods.
        // The loading of data is actually performed by the LoadData method in the base class of Dotmed_processTableControl1.
...
// Base class for the Dotmed_processTableControl1Row control on the Edit_Vw_dotmed_Table page.
// Do not modify this class. Instead override any method in Dotmed_processTableControl1Row.
public class BaseDotmed_processTableControl1Row : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseDotmed_processTableControl1Row()
        {
        ...
        // To customize, override this method in Dotmed_processTableControl1Row.
        ...
        public virtual void LoadData()  
        {
            ...
            // LoadData method of the BaseDotmed_processTableControl1 when the data for the entire
            // table is loaded.
        ...
        public virtual void Setlisting_id2()
        {
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.dotmed_process record retrieved from the database.
            // this.listing_id2 is the ASP:Literal on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.listing_idSpecified) {
               ...
               string formattedValue = this.DataSource.Format(Dotmed_processTable.listing_id);
                ...
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                this.listing_id2.Text = formattedValue;
              ...
              this.listing_id2.Text = Dotmed_processTable.listing_id.Format(Dotmed_processTable.listing_id.DefaultValue);
            		
            }
            
            // If the listing_id is NULL or blank, then use the value specified  
            // on Properties.
            if (this.listing_id2.Text == null ||
                this.listing_id2.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.listing_id2.Text = "&nbsp;";
            }
                                     
        }
                
        public virtual void Setitem_idLabel()
                  {
                  
                    
        }
                
        public virtual void Setlisting_idLabel2()
                  {
        ...
        public virtual void SaveData()
        {
            ...
            if (this.DataSource.IsAnyValueChanged) {
                ...
                ((Dotmed_processTableControl1)MiscUtils.GetParentControlObject(this, "Dotmed_processTableControl1")).DataChanged = true;
                ((Dotmed_processTableControl1)MiscUtils.GetParentControlObject(this, "Dotmed_processTableControl1")).ResetData = true;
            }
        ...
        public virtual void Getlisting_id2()
        {
      ...
      // To customize, override this method in Dotmed_processTableControl1Row.
         ...
         
        {
            ...
            bool hasFiltersDotmed_processTableControl1 = false;
            hasFiltersDotmed_processTableControl1 = hasFiltersDotmed_processTableControl1 && false; // suppress warning
      
            bool hasFiltersEquipment_inventory_dotmedTableControl = false;
            hasFiltersEquipment_inventory_dotmedTableControl = hasFiltersEquipment_inventory_dotmedTableControl && false; // suppress warning
            ...
            bool hasFiltersVw_dotmedTableControl1 = false;
            hasFiltersVw_dotmedTableControl1 = hasFiltersVw_dotmedTableControl1 && false; // suppress warning
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseDotmed_processTableControl1Row_Rec"];
            }
            set {
                this.ViewState["BaseDotmed_processTableControl1Row_Rec"] = value;
            }
        }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal listing_id2 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "listing_id2");
            }
        }
            
        public System.Web.UI.WebControls.Literal listing_idLabel2 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "listing_idLabel2");
            }
        }
...
// Base class for the Dotmed_processTableControl1 control on the Edit_Vw_dotmed_Table page.
// Do not modify this class. Instead override any method in Dotmed_processTableControl1.
public class BaseDotmed_processTableControl1 : OEMConversion.UI.BaseApplicationTableControl
{
         
       public BaseDotmed_processTableControl1()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
    ...
    // Setup default pagination settings.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    foreach (Dotmed_processTableControl1Row rc in this.GetRecordControls()) {
                        if (!rc.IsNewRecord) {
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Dotmed_processTableControl1Repeater"));
        if (rep == null){return;}
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            Dotmed_processTableControl1Row recControl = (Dotmed_processTableControl1Row)(repItem.FindControl("Dotmed_processTableControl1Row"));
        ...
        protected virtual void BindPaginationControls()
        {
            ...
            // Bind the buttons for Dotmed_processTableControl1 pagination.
        ...
        public virtual void SaveData()
        {
            ...
            foreach (Dotmed_processTableControl1Row recCtl in this.GetRecordControls())
            {
      ...
      Dotmed_processRecord rec = new Dotmed_processRecord();
                        ...
                        if (recControl.listing_id2.Text != "") {
                            rec.Parse(recControl.listing_id2.Text, Dotmed_processTable.listing_id);
                  }
        ...
        public void AddToDeletedRecordIds(Dotmed_processTableControl1Row rec)
        {
            if (rec.IsNewRecord) {
                return;
            }
        ...
        protected virtual bool InDeletedRecordIds(Dotmed_processTableControl1Row rec)            
        {
            if (this.DeletedRecordIds == null || this.DeletedRecordIds.Length == 0) {
                return (false);
            }
    ...
    this.RemoveFromSession(this, "Page_Size");
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            string orderByStr = (string)ViewState["Dotmed_processTableControl1_OrderBy"];
        ...
        {            
            ...
            if (this.CurrentSortOrder != null) {
                this.ViewState["Dotmed_processTableControl1_OrderBy"] = this.CurrentSortOrder.ToXmlString();
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
                    ...
                    this.ImportButton1.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=Dotmed_process" ;
        ...
        public virtual void Button_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../vw_dotmed/Show-Vw-dotmed-Table.aspx?dotmed_equipment_inventory={Vw_dotmedTableControlRow:FV:inventory_id}";
...
#region "Helper Functions"
        ...
        public override string EvaluateExpressions(string url, string arg, bool bEncrypt)
        {
            ...
            if (needToProcess) {
                Dotmed_processTableControl1Row recCtl = this.GetSelectedRecordControl();
        ...
        public virtual Dotmed_processTableControl1Row GetSelectedRecordControl()
        {
        ...
        public virtual Dotmed_processTableControl1Row[] GetSelectedRecordControls()
        {
        
            return (Dotmed_processTableControl1Row[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_Vw_dotmed_Table.Dotmed_processTableControl1Row")));
          
        }

        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            Dotmed_processTableControl1Row[] recordList = this.GetSelectedRecordControls();
            if (recordList.Length == 0) {
                // Localization.
                throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "OEMConversion"));
            }
            
            foreach (Dotmed_processTableControl1Row recCtl in recordList)
            {
                if (deferDeletion) {
        ...
        public virtual Dotmed_processTableControl1Row[] GetRecordControls()
        {
            Control[] recCtrls = BaseClasses.Utils.MiscUtils.FindControlsRecursively(this, "Dotmed_processTableControl1Row");
	          List<Dotmed_processTableControl1Row> list = new List<Dotmed_processTableControl1Row>();
	          foreach (Dotmed_processTableControl1Row recCtrl in recCtrls) {
		          list.Add(recCtrl);
	          }
	          return list.ToArray();
        }
...
// Base class for the Equipment_inventory_dotmedTableControlRow control on the Edit_Vw_dotmed_Table page.
// Do not modify this class. Instead override any method in Equipment_inventory_dotmedTableControlRow.
public class BaseEquipment_inventory_dotmedTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseEquipment_inventory_dotmedTableControlRow()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        // To customize, override this method in Equipment_inventory_dotmedTableControlRow.
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
        ...
        public virtual void LoadData()  
        {
            ...
            // Since this is a row in the table, the data for this row is loaded by the 
            // LoadData method of the BaseEquipment_inventory_dotmedTableControl when the data for the entire
            // table is loaded.
        ...
        public virtual void SaveData()
        {
            ...
            if (this.DataSource.IsAnyValueChanged) {
                ...
                // Set the DataChanged flag to True for the for the related panels so they get refreshed as well.
                ((Equipment_inventory_dotmedTableControl)MiscUtils.GetParentControlObject(this, "Equipment_inventory_dotmedTableControl")).DataChanged = true;
                ((Equipment_inventory_dotmedTableControl)MiscUtils.GetParentControlObject(this, "Equipment_inventory_dotmedTableControl")).ResetData = true;
            }
      ...
      // To customize, override this method in Equipment_inventory_dotmedTableControlRow.
        ...
        public virtual void Button1_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../vw_dotmed/Show-Vw-dotmed-Table.aspx?equipment_inventory_dotmed={Equipment_inventory_dotmedTableControlRow:FV:inventory_id}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseEquipment_inventory_dotmedTableControlRow_Rec"];
            }
            set {
                this.ViewState["BaseEquipment_inventory_dotmedTableControlRow_Rec"] = value;
            }
        }
...
// Base class for the Equipment_inventory_dotmedTableControl control on the Edit_Vw_dotmed_Table page.
// Do not modify this class. Instead override any method in Equipment_inventory_dotmedTableControl.
public class BaseEquipment_inventory_dotmedTableControl : OEMConversion.UI.BaseApplicationTableControl
{
         
       public BaseEquipment_inventory_dotmedTableControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                        // Initialize an empty array of records
                      ArrayList alist = new ArrayList(0);
                      Type myrec = typeof(OEMConversion.Business.Equipment_inventory_dotmedRecord);
                      this.DataSource = (Equipment_inventory_dotmedRecord[])(alist.ToArray(myrec));
                      // Add records to the list if needed.
                      this.AddNewRecords();
                      this._TotalRecords = 0;
                      this._TotalPages = 0;
                ...
                if (this.AddNewRecord > 0) {
                    // Make sure to preserve the previously entered data on new rows.
                    ArrayList postdata = new ArrayList(0);
                    foreach (Equipment_inventory_dotmedTableControlRow rc in this.GetRecordControls()) {
                        if (!rc.IsNewRecord) {
                            rc.DataSource = rc.GetRecord();
                            rc.GetUIData();
                            postdata.Add(rc.DataSource);
                    ...
                    Type myrec = typeof(OEMConversion.Business.Equipment_inventory_dotmedRecord);
                    this.DataSource = (Equipment_inventory_dotmedRecord[])(postdata.ToArray(myrec));
                } 
                else {
                    // Get the records from the database
        ...
        public virtual Equipment_inventory_dotmedRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            // by default, Select * will be executed to get a list of records.  If you want to run Select Distinct with certain column only, add the column to selCols
            ColumnList selCols = new ColumnList();                 
            ...
            // However, if you don't specify PK, row button click might show an error message.
            // And make sure you write similar code in GetRecordCount as well
            // selCols.Add(Equipment_inventory_dotmedTable.Column1, true);          
            // selCols.Add(Equipment_inventory_dotmedTable.Column2, true);          
            // selCols.Add(Equipment_inventory_dotmedTable.Column3, true);          
                  ...
                  
            {
                ...
                return Equipment_inventory_dotmedTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                Equipment_inventory_dotmedTable databaseTable = new Equipment_inventory_dotmedTable();
                databaseTable.SelectedColumns.Clear();
                databaseTable.SelectedColumns.AddRange(selCols);
                ...
                orderBy.ExpandForeignKeyColums = false;
                recList = databaseTable.GetRecordList(join, where.GetFilter(), null, orderBy, pageIndex, pageSize);
                return (recList.ToArray(typeof(Equipment_inventory_dotmedRecord)) as Equipment_inventory_dotmedRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0)                 
                ...
                return Equipment_inventory_dotmedTable.GetRecordCount(join, where);
            else
            {
                Equipment_inventory_dotmedTable databaseTable = new Equipment_inventory_dotmedTable();
                databaseTable.SelectedColumns.Clear();
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Equipment_inventory_dotmedTableControlRepeater"));
        if (rep == null){return;}
        rep.DataSource = this.DataSource;
        rep.DataBind();
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Loop through all rows in the table, set its DataSource and call DataBind().
            Equipment_inventory_dotmedTableControlRow recControl = (Equipment_inventory_dotmedTableControlRow)(repItem.FindControl("Equipment_inventory_dotmedTableControlRow"));
            recControl.DataSource = this.DataSource[index];            
            if (this.UIData.Count > index)
                recControl.PreviousUIData = this.UIData[index];
            recControl.DataBind();
        ...
        protected virtual void BindPaginationControls()
        {
            ...
            // Bind the buttons for Equipment_inventory_dotmedTableControl pagination.
        ...
        public virtual void SaveData()
        {
            ...
            foreach (Equipment_inventory_dotmedTableControlRow recCtl in this.GetRecordControls())
            {
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (recControl.Visible && recControl.IsNewRecord) {
      Equipment_inventory_dotmedRecord rec = new Equipment_inventory_dotmedRecord();
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new Equipment_inventory_dotmedRecord());
                newUIDataList.Insert(0, new Hashtable());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(OEMConversion.Business.Equipment_inventory_dotmedRecord);
                this.DataSource = (Equipment_inventory_dotmedRecord[])(finalList.ToArray(myrec));
        ...
        public void AddToDeletedRecordIds(Equipment_inventory_dotmedTableControlRow rec)
        {
            if (rec.IsNewRecord) {
                return;
            }
        ...
        protected virtual bool InDeletedRecordIds(Equipment_inventory_dotmedTableControlRow rec)            
        {
            if (this.DeletedRecordIds == null || this.DeletedRecordIds.Length == 0) {
                return (false);
            }
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("Equipment_inventory_dotmedTableControlRepeater");
    ...
    this.RemoveFromSession(this, "Page_Size");
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            string orderByStr = (string)ViewState["Equipment_inventory_dotmedTableControl_OrderBy"];
        ...
        {            
            ...
            if (this.CurrentSortOrder != null) {
                this.ViewState["Equipment_inventory_dotmedTableControl_OrderBy"] = this.CurrentSortOrder.ToXmlString();
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = Equipment_inventory_dotmedTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
                return (this._TotalRecords);
            }
            set {
        ...
        public  Equipment_inventory_dotmedRecord[] DataSource {
            ...
            get {
                return (Equipment_inventory_dotmedRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Functions"
        ...
        public override string EvaluateExpressions(string url, string arg, bool bEncrypt)
        {
            bool needToProcess = AreAnyUrlParametersForMe(url, arg);
            if (needToProcess) {
                Equipment_inventory_dotmedTableControlRow recCtl = this.GetSelectedRecordControl();
                if (recCtl == null && url.IndexOf("{") >= 0) {
                    // Localization.
                    throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "OEMConversion"));
                }
        ...
        public virtual Equipment_inventory_dotmedTableControlRow GetSelectedRecordControl()
        {
        ...
        public virtual Equipment_inventory_dotmedTableControlRow[] GetSelectedRecordControls()
        {
        
            return (Equipment_inventory_dotmedTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_Vw_dotmed_Table.Equipment_inventory_dotmedTableControlRow")));
          
        }

        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            Equipment_inventory_dotmedTableControlRow[] recordList = this.GetSelectedRecordControls();
            if (recordList.Length == 0) {
                // Localization.
                throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "OEMConversion"));
            }
            
            foreach (Equipment_inventory_dotmedTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
                    if (!recCtl.IsNewRecord) {
        ...
        public virtual Equipment_inventory_dotmedTableControlRow[] GetRecordControls()
        {
            Control[] recCtrls = BaseClasses.Utils.MiscUtils.FindControlsRecursively(this, "Equipment_inventory_dotmedTableControlRow");
	          List<Equipment_inventory_dotmedTableControlRow> list = new List<Equipment_inventory_dotmedTableControlRow>();
	          foreach (Equipment_inventory_dotmedTableControlRow recCtrl in recCtrls) {
		          list.Add(recCtrl);
	          }
	          return list.ToArray();
        }
...
// Base class for the Vw_dotmedTableControlRow control on the Edit_Vw_dotmed_Table page.
...
public class BaseVw_dotmedTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setoem_ein()
        {
            ...
            if (this.DataSource != null && this.DataSource.oem_einSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(Vw_dotmedView.oem_ein);
              ...
              this.oem_ein.Text = Vw_dotmedView.oem_ein.Format(Vw_dotmedView.oem_ein.DefaultValue);
      ...
      // To customize, override this method in Vw_dotmedTableControlRow.
        ...
        public virtual void EditRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../equipment_inventory/Edit-Equipment-inventory.aspx?equipment_inventory={Vw_dotmedTableControlRow:FV:inventory_id}";
...
// Base class for the Vw_dotmedTableControl control on the Edit_Vw_dotmed_Table page.
...
public class BaseVw_dotmedTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
              ...
              this.new_category_idLabel.Click += new_category_idLabel_Click;
      ...
      public override void DataBind()
      {
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Vw_dotmedView, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"vw_dotmed_.dotmed_delete_date"), null, BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
            if (EvaluateFormula("1", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Vw_dotmedView, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"vw_dotmed_.dotmed_active"), EvaluateFormula("1", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
      ...
      Vw_dotmedRecord rec = new Vw_dotmedRecord();
                        ...
                        if (recControl.oem_ein.Text != "") {
                            rec.Parse(recControl.oem_ein.Text, Vw_dotmedView.oem_ein);
                  }
        ...
        public virtual void SetdescriptionLabel()
                  {
                        ...
                        this.descriptionLabel.Text = EvaluateFormula("\"Comments\"");
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            protected virtual void SetFocusToAddedRow()
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("Vw_dotmedTableControlRepeater");
            if (rep == null || rep.Items.Count == 0) return; 			
            foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items) {
                // Loop through all rows in the table, set its DataSource and call DataBind().
                Vw_dotmedTableControlRow recControl = (Vw_dotmedTableControlRow)repItem.FindControl("Vw_dotmedTableControlRow");
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void condition_idLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(Vw_dotmedView.condition_id);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(Vw_dotmedView.condition_id, OrderByItem.OrderDir.Asc);
        ...
        public virtual void descriptionLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(Vw_dotmedView.description);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(Vw_dotmedView.description, OrderByItem.OrderDir.Asc);
        ...
        public virtual void new_category_idLabel_Click(object sender, EventArgs args)
        {
            //Sorts by new_category_id when clicked.
              
            // Get previous sorting state for new_category_id.
        
            OrderByItem sd = this.CurrentSortOrder.Find(Vw_dotmedView.new_category_id);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for new_category_id.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(Vw_dotmedView.new_category_id, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by new_category_id, so just reverse.
                sd.Reverse();
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton new_category_idLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "new_category_idLabel");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual Vw_dotmedTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Vw_dotmedTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_Vw_dotmed_Table.Vw_dotmedTableControlRow")));
...
// Base class for the Vw_dotmedTableControl1Row control on the Edit_Vw_dotmed_Table page.
// Do not modify this class. Instead override any method in Vw_dotmedTableControl1Row.
public class BaseVw_dotmedTableControl1Row : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseVw_dotmedTableControl1Row()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        // To customize, override this method in Vw_dotmedTableControl1Row.
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
        ...
        {      
              ...
              this.dotmed_processed.TextChanged += dotmed_processed_TextChanged;
        ...
        public virtual void LoadData()  
        {
            ...
            // Since this is a row in the table, the data for this row is loaded by the 
            // LoadData method of the BaseVw_dotmedTableControl1 when the data for the entire
            // table is loaded.
        ...
        public virtual void Setcondition_id1()
        {
            ...
            if (this.DataSource != null && this.DataSource.condition_idSpecified) {
              ...
              this.condition_id1.Text = Vw_dotmedView.condition_id.Format(Vw_dotmedView.condition_id.DefaultValue);
        ...
        public virtual void Setdescription1()
        {
            ...
            if (this.DataSource != null && this.DataSource.descriptionSpecified) {
               ...
               string formattedValue = this.DataSource.Format(Vw_dotmedView.description);
                ...
                if(formattedValue != null){
                    ...
                    if (originalLength >= popupThreshold) {
                        ...
                        formattedValue = "<a onclick=\'gPersist=true;\' class=\'truncatedText\' onmouseout=\'detailRolloverPopupClose();\' " +
                            "onmouseover=\'SaveMousePosition(event); delayRolloverPopup(\"PageMethods.GetRecordFieldValue(\\\"" + "NULL" + "\\\", \\\"OEMConversion.Business.Vw_dotmedView, App_Code\\\",\\\"" +
                              (HttpUtility.UrlEncode(this.DataSource.GetID().ToString())).Replace("\\","\\\\\\\\") + "\\\", \\\"description\\\", \\\"description1\\\", \\\"" +NetUtils.EncodeStringForHtmlDisplay(name.Substring(0, name.Length)) + "\\\",\\\"" + Page.GetResourceValue("Btn:Close", "OEMConversion") + "\\\", " +
                        " false, 200," +
                            " 300, true, PopupDisplayWindowCallBackWith20);\", 500);'>" + NetUtils.EncodeStringForHtmlDisplay(formattedValue.Substring(0, Math.Min(maxLength, formattedValue.Length)));
                        if (maxLength == (int)(300))
                            {
              ...
              this.description1.Text = Vw_dotmedView.description.Format(Vw_dotmedView.description.DefaultValue);
        ...
        public virtual void Setdotmed_processed()
        {
            ...
            if (this.PreviousUIData.ContainsKey(this.dotmed_processed.ID))
            {
            
                this.dotmed_processed.Text = this.PreviousUIData[this.dotmed_processed.ID].ToString();
              
                return;
            }
            
                    
            // Set the dotmed_processed TextBox on the webpage with value from the
            // DatabaseAYS_OEM%dbo.vw_dotmed database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.vw_dotmed record retrieved from the database.
            // this.dotmed_processed is the ASP:TextBox on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.dotmed_processedSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(Vw_dotmedView.dotmed_processed);
                                
                this.dotmed_processed.Text = formattedValue;
              ...
              this.dotmed_processed.Text = Vw_dotmedView.dotmed_processed.Format(Vw_dotmedView.dotmed_processed.DefaultValue);
        ...
        public virtual void Setmake_id1()
        {
            ...
            if (this.DataSource != null && this.DataSource.make_idSpecified) {
              ...
              this.make_id1.Text = Vw_dotmedView.make_id.Format(Vw_dotmedView.make_id.DefaultValue);
        ...
        public virtual void Setmodel_id1()
        {
            ...
            if (this.DataSource != null && this.DataSource.model_idSpecified) {
              ...
              this.model_id1.Text = Vw_dotmedView.model_id.Format(Vw_dotmedView.model_id.DefaultValue);
            		
            }
                               
        }
                
        public virtual void Setnew_category_id1()
        {
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.vw_dotmed record retrieved from the database.
            // this.new_category_id1 is the ASP:Literal on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.new_category_idSpecified) {
               ...
               string formattedValue = this.DataSource.Format(Vw_dotmedView.new_category_id);
                ...
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                this.new_category_id1.Text = formattedValue;
              ...
              this.new_category_id1.Text = Vw_dotmedView.new_category_id.Format(Vw_dotmedView.new_category_id.DefaultValue);
        ...
        public virtual void Setoem_ein1()
        {
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.vw_dotmed record retrieved from the database.
            // this.oem_ein1 is the ASP:Literal on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.oem_einSpecified) {
              ...
              this.oem_ein1.Text = Vw_dotmedView.oem_ein.Format(Vw_dotmedView.oem_ein.DefaultValue);
        ...
        public virtual void SaveData()
        {
            ...
            if (this.DataSource.IsAnyValueChanged) {
                ...
                // Set the DataChanged flag to True for the for the related panels so they get refreshed as well.
                ((Vw_dotmedTableControl1)MiscUtils.GetParentControlObject(this, "Vw_dotmedTableControl1")).DataChanged = true;
                ((Vw_dotmedTableControl1)MiscUtils.GetParentControlObject(this, "Vw_dotmedTableControl1")).ResetData = true;
            }
        ...
        public virtual void Getdotmed_processed()
        {
            ...
            // Retrieve the value entered by the user on the dotmed_processed ASP:TextBox, and
            // save it into the dotmed_processed field in DataSource DatabaseAYS_OEM%dbo.vw_dotmed record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(EvaluateFormula("1"), Vw_dotmedView.dotmed_processed);							
        ...
        public virtual void Getnew_category_id1()
        {
      ...
      // To customize, override this method in Vw_dotmedTableControl1Row.
        ...
        public virtual void EditRowButton1_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../equipment_inventory/Edit-Equipment-inventory.aspx?equipment_inventory={Vw_dotmedTableControl1Row:FV:inventory_id}";
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void dotmed_processed_TextChanged(object sender, EventArgs args)
        {
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseVw_dotmedTableControl1Row_Rec"];
            }
            set {
                this.ViewState["BaseVw_dotmedTableControl1Row_Rec"] = value;
            }
        }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox dotmed_processed {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "dotmed_processed");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal new_category_id1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "new_category_id1");
            }
        }
            
        public System.Web.UI.WebControls.Literal oem_ein1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "oem_ein1");
            }
        }
...
// Base class for the Vw_dotmedTableControl1 control on the Edit_Vw_dotmed_Table page.
// Do not modify this class. Instead override any method in Vw_dotmedTableControl1.
public class BaseVw_dotmedTableControl1 : OEMConversion.UI.BaseApplicationTableControl
{
         
       public BaseVw_dotmedTableControl1()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            else
            {
                ...
                this.CurrentSortOrder.Add(Vw_dotmedView.oem_ein, OrderByItem.OrderDir.Asc);
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
              ...
              this.make_idLabel1.Click += make_idLabel1_Click;
            
              this.new_category_idLabel1.Click += new_category_idLabel1_Click;
        ...
        public virtual void LoadData()
        {
            ...
            try {
                ...
                if (this.AddNewRecord > 0) {
                    // Make sure to preserve the previously entered data on new rows.
                    ArrayList postdata = new ArrayList(0);
                    foreach (Vw_dotmedTableControl1Row rc in this.GetRecordControls()) {
                        if (!rc.IsNewRecord) {
                            rc.DataSource = rc.GetRecord();
                            rc.GetUIData();
                            postdata.Add(rc.DataSource);
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Vw_dotmedTableControl1Repeater"));
        if (rep == null){return;}
        rep.DataSource = this.DataSource;
        rep.DataBind();
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Loop through all rows in the table, set its DataSource and call DataBind().
            Vw_dotmedTableControl1Row recControl = (Vw_dotmedTableControl1Row)(repItem.FindControl("Vw_dotmedTableControl1Row"));
            recControl.DataSource = this.DataSource[index];            
            if (this.UIData.Count > index)
                recControl.PreviousUIData = this.UIData[index];
            recControl.DataBind();
        ...
        protected virtual void BindPaginationControls()
        {
            ...
            // Bind the buttons for Vw_dotmedTableControl1 pagination.
        ...
        public virtual void SaveData()
        {
            ...
            foreach (Vw_dotmedTableControl1Row recCtl in this.GetRecordControls())
            {
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Vw_dotmedView, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"vw_dotmed_.dotmed_delete_date"), null, BaseClasses.Data.BaseFilter.ComparisonOperator.Not_Equals, false));
      ...
      Vw_dotmedRecord rec = new Vw_dotmedRecord();
                        ...
                        if (recControl.condition_id1.Text != "") {
                            rec.Parse(recControl.condition_id1.Text, Vw_dotmedView.condition_id);
                  }
                
                        if (recControl.description1.Text != "") {
                            rec.Parse(recControl.description1.Text, Vw_dotmedView.description);
                  }
                
                        if (recControl.dotmed_processed.Text != "") {
                            rec.Parse(recControl.dotmed_processed.Text, Vw_dotmedView.dotmed_processed);
                  }
                
                        if (recControl.make_id1.Text != "") {
                            rec.Parse(recControl.make_id1.Text, Vw_dotmedView.make_id);
                  }
                
                        if (recControl.model_id1.Text != "") {
                            rec.Parse(recControl.model_id1.Text, Vw_dotmedView.model_id);
                  }
                
                        if (recControl.new_category_id1.Text != "") {
                            rec.Parse(recControl.new_category_id1.Text, Vw_dotmedView.new_category_id);
                  }
                
                        if (recControl.oem_ein1.Text != "") {
                            rec.Parse(recControl.oem_ein1.Text, Vw_dotmedView.oem_ein);
                  }
        ...
        public void AddToDeletedRecordIds(Vw_dotmedTableControl1Row rec)
        {
            if (rec.IsNewRecord) {
                return;
            }
        ...
        protected virtual bool InDeletedRecordIds(Vw_dotmedTableControl1Row rec)            
        {
            if (this.DeletedRecordIds == null || this.DeletedRecordIds.Length == 0) {
                return (false);
            }
        ...
        public virtual void SetdescriptionLabel1()
                  {
                        ...
                        this.descriptionLabel1.Text = EvaluateFormula("\"Comments\"");
        ...
        public virtual void Setmake_idLabel1()
                  {
                        ...
                        this.make_idLabel1.Text = EvaluateFormula("\"System Mfg\"");
                      
                    
        }
                
        public virtual void Setnew_category_idLabel1()
                  {
                  
                      //Code for the text property is generated inside the .aspx file. 
                      //To override this property you can uncomment the following property and add you own value.
                      //this.new_category_idLabel1.Text = "Some value";
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            protected virtual void SetFocusToAddedRow()
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("Vw_dotmedTableControl1Repeater");
            if (rep == null || rep.Items.Count == 0) return; 			
            foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items) {
                // Loop through all rows in the table, set its DataSource and call DataBind().
                Vw_dotmedTableControl1Row recControl = (Vw_dotmedTableControl1Row)repItem.FindControl("Vw_dotmedTableControl1Row");
    ...
    this.RemoveFromSession(this, "Page_Size");
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            string orderByStr = (string)ViewState["Vw_dotmedTableControl1_OrderBy"];
        ...
        {            
            ...
            if (this.CurrentSortOrder != null) {
                this.ViewState["Vw_dotmedTableControl1_OrderBy"] = this.CurrentSortOrder.ToXmlString();
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void make_idLabel1_Click(object sender, EventArgs args)
        {
            //Sorts by make_id when clicked.
        ...
        public virtual void new_category_idLabel1_Click(object sender, EventArgs args)
        {
            //Sorts by new_category_id when clicked.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton make_idLabel1 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "make_idLabel1");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton new_category_idLabel1 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "new_category_idLabel1");
            }
        }
...
#region "Helper Functions"
        ...
        public override string EvaluateExpressions(string url, string arg, bool bEncrypt)
        {
            bool needToProcess = AreAnyUrlParametersForMe(url, arg);
            if (needToProcess) {
                Vw_dotmedTableControl1Row recCtl = this.GetSelectedRecordControl();
                if (recCtl == null && url.IndexOf("{") >= 0) {
                    // Localization.
                    throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "OEMConversion"));
                }
        ...
        public virtual Vw_dotmedTableControl1Row GetSelectedRecordControl()
        {
        ...
        public virtual Vw_dotmedTableControl1Row[] GetSelectedRecordControls()
        {
        
            return (Vw_dotmedTableControl1Row[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_Vw_dotmed_Table.Vw_dotmedTableControl1Row")));
          
        }

        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            Vw_dotmedTableControl1Row[] recordList = this.GetSelectedRecordControls();
            if (recordList.Length == 0) {
                // Localization.
                throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "OEMConversion"));
            }
            
            foreach (Vw_dotmedTableControl1Row recCtl in recordList)
            {
                if (deferDeletion) {
                    if (!recCtl.IsNewRecord) {
        ...
        public virtual Vw_dotmedTableControl1Row[] GetRecordControls()
        {
            Control[] recCtrls = BaseClasses.Utils.MiscUtils.FindControlsRecursively(this, "Vw_dotmedTableControl1Row");
	          List<Vw_dotmedTableControl1Row> list = new List<Vw_dotmedTableControl1Row>();
	          foreach (Vw_dotmedTableControl1Row recCtrl in recCtrls) {
		          list.Add(recCtrl);
	          }
	          return list.ToArray();
        }
