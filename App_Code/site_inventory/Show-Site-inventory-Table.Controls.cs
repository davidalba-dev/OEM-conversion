...
// Show_Site_inventory_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Site_inventory_Table
{
...
// Base class for the Serial_numberTableControlRow control on the Show_Site_inventory_Table page.
...
// Base class for the Serial_numberTableControl control on the Show_Site_inventory_Table page.
...
#region "Helper Functions"
        ...
        public virtual Serial_numberTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Serial_numberTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Site_inventory_Table.Serial_numberTableControlRow")));
...
// Base class for the Site_inventoryTableControlRow control on the Show_Site_inventory_Table page.
...
public class BaseSite_inventoryTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setinventory_loc_id()
        {
            ...
            if (this.PreviousUIData.ContainsKey(this.inventory_loc_id.ID))
            {
                if (this.PreviousUIData[this.inventory_loc_id.ID] == null)
                    selectedValue = null;
                else
                    selectedValue = this.PreviousUIData[this.inventory_loc_id.ID].ToString();
            }
      ...
      // To customize, override this method in Site_inventoryTableControlRow.
        ...
        public virtual WhereClause CreateWhereClause_inventory_loc_idDropDownList() 
        {
            ...
            if (EvaluateFormula("Site_inventory.custno", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Inventory_locationTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"inventory_location_.custno"), EvaluateFormula("Site_inventory.custno", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("Site_inventory.custno", false) == "--PLEASE_SELECT--" || EvaluateFormula("Site_inventory.custno", false) == "--ANY--") whereClause.RunQuery = false;
...
// Base class for the Site_inventoryTableControl control on the Show_Site_inventory_Table page.
...
public class BaseSite_inventoryTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
              ...
              this.inventory_loc_idLabel.Click += inventory_loc_idLabel_Click;
    ...
    public virtual void AddWarningMessageOnClick() {
      ...
      Site_inventoryRecord rec = new Site_inventoryRecord();
                        ...
                        if (MiscUtils.IsValueSelected(recControl.inventory_loc_id)) {
                            rec.Parse(recControl.inventory_loc_id.SelectedItem.Value, Site_inventoryTable.inventory_loc_id);
                        }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void inventory_loc_idLabel_Click(object sender, EventArgs args)
        {
            //Sorts by inventory_loc_id when clicked.
              
            // Get previous sorting state for inventory_loc_id.
        
            OrderByItem sd = this.CurrentSortOrder.Find(Site_inventoryTable.inventory_loc_id);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for inventory_loc_id.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(Site_inventoryTable.inventory_loc_id, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by inventory_loc_id, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void CSVButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
             ...
             Site_inventoryTable.inventory_loc_id,
             null};
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
             ...
             data.ColumnList.Add(new ExcelColumn(Site_inventoryTable.inventory_loc_id, "0"));
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton inventory_loc_idLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "inventory_loc_idLabel");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual Site_inventoryTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Site_inventoryTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Site_inventory_Table.Site_inventoryTableControlRow")));
