...
// Edit_Contract.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Contract
{
...
public class BudgetTableControlRow : BaseBudgetTableControlRow
{
      
        // The BaseBudgetTableControlRow implements code for a ROW within the
        // the BudgetTableControl table.  The BaseBudgetTableControlRow implements the DataBind and SaveData methods.
        // The loading of data is actually performed by the LoadData method in the base class of BudgetTableControl.
...
public class BudgetTableControl : BaseBudgetTableControl
{
    // The BaseBudgetTableControl class implements the LoadData, DataBind, CreateWhereClause
    // and other methods to load and display the data in a table control.

    // This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
    // The BudgetTableControlRow class offers another place where you can customize
    // the DataBind, GetUIData, SaveData and Validate methods specific to each row displayed on the table.

}

  
public class ContractRecordControl : BaseContractRecordControl
{
      
        // The BaseContractRecordControl implements the LoadData, DataBind and other
...
// Base class for the BudgetTableControlRow control on the Edit_Contract page.
// Do not modify this class. Instead override any method in BudgetTableControlRow.
public class BaseBudgetTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseBudgetTableControlRow()
        {
        ...
        // To customize, override this method in BudgetTableControlRow.
        ...
        public virtual void LoadData()  
        {
            ...
            // LoadData method of the BaseBudgetTableControl when the data for the entire
            // table is loaded.
        ...
        public virtual void Setbudget_amount()
        {
            ...
            if (this.PreviousUIData.ContainsKey(this.budget_amount.ID))
            {
            
                this.budget_amount.Text = this.PreviousUIData[this.budget_amount.ID].ToString();
        ...
        public virtual void Setbudget_created_by()
        {
            ...
            if (this.PreviousUIData.ContainsKey(this.budget_created_by.ID))
            {
                if (this.PreviousUIData[this.budget_created_by.ID] == null)
                    selectedValue = null;
                else
                    selectedValue = this.PreviousUIData[this.budget_created_by.ID].ToString();
            }
            
            
            // Set the budget_created_by DropDownList on the webpage with value from the
            // DatabaseAYS_OEM%dbo.budget database record.
            
            // this.DataSource is the DatabaseAYS_OEM%dbo.budget record retrieved from the database.
            // this.budget_created_by is the ASP:DropDownList on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.budget_created_bySpecified)
            {
                            
                // If the budget_created_by is non-NULL, then format the value.
            ...
            else
            {
                ...
                // budget_created_by is NULL in the database, so use the Default Value.  
                // Default Value could also be NULL.
                if (this.DataSource != null && this.DataSource.IsCreated)
                    selectedValue = null;
                else
                    selectedValue = BudgetTable.budget_created_by.DefaultValue;
            ...
            this.Populatebudget_created_byDropDownList(selectedValue, 100);              
        ...
        public virtual void Setcustno()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = BudgetTable.custno.DefaultValue;
        ...
        ContractRecordControl parentCtrl;
      
            parentCtrl = (ContractRecordControl)this.Page.FindControlRecursively("ContractRecordControl");
        ...
        throw new Exception(Page.GetResourceValue("Err:NoParentRecId", "OEMConversion"));
          ...
          this.DataSource.contract_id = parentCtrl.DataSource.contract_id;
            ...
            if (this.DataSource.IsAnyValueChanged) {
                ...
                ((BudgetTableControl)MiscUtils.GetParentControlObject(this, "BudgetTableControl")).DataChanged = true;
                ((BudgetTableControl)MiscUtils.GetParentControlObject(this, "BudgetTableControl")).ResetData = true;
            }
        ...
        {
         // Retrieve the value entered by the user on the budget_created_by ASP:DropDownList, and
      ...
      // To customize, override this method in BudgetTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersBudgetTableControl = false;
            hasFiltersBudgetTableControl = hasFiltersBudgetTableControl && false; // suppress warning
      
            bool hasFiltersContractRecordControl = false;
            hasFiltersContractRecordControl = hasFiltersContractRecordControl && false; // suppress warning
        ...
        public virtual WhereClause CreateWhereClause_budget_created_byDropDownList() 
        {
        ...
        // Fill the budget_created_by list.
        protected virtual void Populatebudget_created_byDropDownList(string selectedValue, int maxItems) 
        {
            		  					                
            this.budget_created_by.Items.Clear();
            
            // 1. Setup the static list items        
            		  			
            // 2. Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_budget_created_byDropDownList function.
            // It is better to customize the where clause there.
            
                      
            WhereClause wc = CreateWhereClause_budget_created_byDropDownList();
            ...
            // 3. Read a total of maxItems from the database and insert them into the budget_created_byDropDownList.
                ...
                do
                {
                    ...
                    foreach (Corporate_contactsRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.CorporateContact_IdSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.budget_created_by.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                fvalue = EvaluateFormula("= Corporate_contacts.corporatecontact_title", itemValue, variables2, evaluator);
                                ...
                                ListItem dupItem = this.budget_created_by.Items.FindByText(fvalue);
                                ...
                                this.budget_created_by.Items.Add(newItem);
                ...
                !MiscUtils.SetSelectedDisplayText(this.budget_created_by, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        fvalue = EvaluateFormula("= Corporate_contacts.corporatecontact_title", itemValue, variables2, evaluator2);
        ...
        BudgetTableControl tc= ((BudgetTableControl)MiscUtils.GetParentControlObject(this, "BudgetTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((BudgetTableControlRow)this);
                    }
                    this.Visible = false;
        ...
        public virtual void EditRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../budget/Edit-Budget.aspx?Budget={PK}";
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void budget_created_by_SelectedIndexChanged(object sender, EventArgs args)
        {
            ...
            string val = (string)(this.Page.Session[budget_created_by.ClientID + "_SelectedValue"]);
            string displayText = (string)(this.Page.Session[budget_created_by.ClientID + "_SelectedDisplayText"]);
            if (!string.IsNullOrEmpty(displayText) && !string.IsNullOrEmpty(val)) {
	            this.budget_created_by.Items.Add(new ListItem(displayText, val));
	            this.budget_created_by.SelectedIndex = this.budget_created_by.Items.Count - 1;
	            this.Page.Session.Remove(budget_created_by.ClientID + "_SelectedValue");
	            this.Page.Session.Remove(budget_created_by.ClientID + "_SelectedDisplayText");
            }
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseBudgetTableControlRow_Rec"];
            }
            set {
                this.ViewState["BaseBudgetTableControlRow_Rec"] = value;
            }
        }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList budget_created_by {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "budget_created_by");
            }
        }
             ...
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return BudgetTable.GetRecord(this.RecordUniqueId, true);
...
// Base class for the BudgetTableControl control on the Edit_Contract page.
// Do not modify this class. Instead override any method in BudgetTableControl.
public class BaseBudgetTableControl : OEMConversion.UI.BaseApplicationTableControl
{
         
       public BaseBudgetTableControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(OEMConversion.Business.BudgetRecord);
                      this.DataSource = (BudgetRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    foreach (BudgetTableControlRow rc in this.GetRecordControls()) {
                        if (!rc.IsNewRecord) {
                    ...
                    Type myrec = typeof(OEMConversion.Business.BudgetRecord);
                    this.DataSource = (BudgetRecord[])(postdata.ToArray(myrec));
                } 
                else {
            ...
            this.budget_amountGrandTotal.Text = this.Getbudget_amountGrandTotal();
            if (this.budget_amountGrandTotal.Text == null || 
                this.budget_amountGrandTotal.Text.Length == 0) {
                this.budget_amountGrandTotal.Text = "&nbsp;";
            }
                }                 
        ...
        public virtual BudgetRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(BudgetTable.Column1, true);          
            // selCols.Add(BudgetTable.Column2, true);          
            // selCols.Add(BudgetTable.Column3, true);          
                  ...
                  
            {
                ...
                return BudgetTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                BudgetTable databaseTable = new BudgetTable();
                ...
                return (recList.ToArray(typeof(BudgetRecord)) as BudgetRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0)                 
                ...
                return BudgetTable.GetRecordCount(join, where);
            else
            {
                BudgetTable databaseTable = new BudgetTable();
                databaseTable.SelectedColumns.Clear();
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "BudgetTableControlRepeater"));
        if (rep == null){return;}
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            BudgetTableControlRow recControl = (BudgetTableControlRow)(repItem.FindControl("BudgetTableControlRow"));
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(BudgetTable.budget_created_by, this.DataSource);
            this.Page.PregetDfkaRecords(BudgetTable.custno, this.DataSource);
        }
        ...
        protected virtual void BindPaginationControls()
        {
            ...
            // Bind the buttons for BudgetTableControl pagination.
        ...
        public virtual void SaveData()
        {
            ...
            foreach (BudgetTableControlRow recCtl in this.GetRecordControls())
            {
    ...
    OEMConversion.UI.Controls.Edit_Contract.ContractRecordControl contractRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "ContractRecordControl") as OEMConversion.UI.Controls.Edit_Contract.ContractRecordControl);
          
              if (contractRecordControlObj != null && contractRecordControlObj.GetRecord() != null && contractRecordControlObj.GetRecord().IsCreated)
              {
              wc.iAND(BudgetTable.contract_id, BaseFilter.ComparisonOperator.EqualsTo, contractRecordControlObj.GetRecord().contract_id.ToString());
              selectedRecordKeyValue.AddElement(BudgetTable.contract_id.InternalName, contractRecordControlObj.GetRecord().contract_id.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      HttpContext.Current.Session["BudgetTableControlWhereClause"] = selectedRecordKeyValue.ToXmlString();
      ...
      string selectedRecordInContractRecordControl = HttpContext.Current.Session["BudgetTableControlWhereClause"] as string;
      
      if (selectedRecordInContractRecordControl != null && KeyValue.IsXmlKey(selectedRecordInContractRecordControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInContractRecordControl);
      
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(BudgetTable.contract_id))
      {
      wc.iAND(BudgetTable.contract_id, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(BudgetTable.contract_id).ToString());
      }
      ...
      BudgetRecord rec = new BudgetRecord();
        
                        if (recControl.budget_amount.Text != "") {
                            rec.Parse(recControl.budget_amount.Text, BudgetTable.budget_amount);
                  }
                
                        if (MiscUtils.IsValueSelected(recControl.budget_created_by)) {
                            rec.Parse(recControl.budget_created_by.SelectedItem.Value, BudgetTable.budget_created_by);
                        }
                        if (MiscUtils.IsValueSelected(recControl.custno)) {
                            rec.Parse(recControl.custno.SelectedItem.Value, BudgetTable.custno);
                        }
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new BudgetRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(OEMConversion.Business.BudgetRecord);
                this.DataSource = (BudgetRecord[])(finalList.ToArray(myrec));
        ...
        public void AddToDeletedRecordIds(BudgetTableControlRow rec)
        {
            if (rec.IsNewRecord) {
                return;
            }
        ...
        protected virtual bool InDeletedRecordIds(BudgetTableControlRow rec)            
        {
            if (this.DeletedRecordIds == null || this.DeletedRecordIds.Length == 0) {
                return (false);
            }
        ...
        protected virtual string Getbudget_amountGrandTotal()
        {
            WhereClause wc = this.CreateWhereClause();            
            CompoundFilter joinFilter = this.CreateCompoundJoinFilter();
              
            OrderBy orderBy = new OrderBy(true, false);     
            string budget_amountSum = BudgetTable.GetSum(BudgetTable.budget_amount, joinFilter, wc, orderBy, BaseTable.MIN_PAGE_NUMBER, BaseTable.MAX_BATCH_SIZE);
                
            return BudgetTable.budget_amount.Format(budget_amountSum);
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("BudgetTableControlRepeater");
    ...
    this.RemoveFromSession(this, "Page_Size");
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            string orderByStr = (string)ViewState["BudgetTableControl_OrderBy"];
        ...
        {            
            ...
            if (this.CurrentSortOrder != null) {
                this.ViewState["BudgetTableControl_OrderBy"] = this.CurrentSortOrder.ToXmlString();
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = BudgetTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  BudgetRecord[] DataSource {
            ...
            get {
                return (BudgetRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Label budget_amountGrandTotal {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "budget_amountGrandTotal");
            }
        }
...
#region "Helper Functions"
        ...
        public override string EvaluateExpressions(string url, string arg, bool bEncrypt)
        {
            ...
            if (needToProcess) {
                BudgetTableControlRow recCtl = this.GetSelectedRecordControl();
        ...
        public virtual BudgetTableControlRow GetSelectedRecordControl()
        {
        ...
        public virtual BudgetTableControlRow[] GetSelectedRecordControls()
        {
        
            return (BudgetTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_Contract.BudgetTableControlRow")));
          
        }

        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            BudgetTableControlRow[] recordList = this.GetSelectedRecordControls();
            if (recordList.Length == 0) {
                // Localization.
                throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "OEMConversion"));
            }
            
            foreach (BudgetTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
        ...
        public virtual BudgetTableControlRow[] GetRecordControls()
        {
            Control[] recCtrls = BaseClasses.Utils.MiscUtils.FindControlsRecursively(this, "BudgetTableControlRow");
	          List<BudgetTableControlRow> list = new List<BudgetTableControlRow>();
	          foreach (BudgetTableControlRow recCtrl in recCtrls) {
		          list.Add(recCtrl);
	          }
	          return list.ToArray();
        }
...
// Base class for the ContractRecordControl control on the Edit_Contract page.
// Do not modify this class. Instead override any method in ContractRecordControl.
public class BaseContractRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseContractRecordControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        // To customize, override this method in ContractRecordControl.
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
        ...
        {      
              ...
              this.contract_enddate.TextChanged += contract_enddate_TextChanged;
            
              this.contract_name.TextChanged += contract_name_TextChanged;
            
              this.contract_startdate.TextChanged += contract_startdate_TextChanged;
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "ContractRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            ContractRecord[] recList = ContractTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = ContractTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public override void DataBind()
        {
            ...
            bool shouldResetControl = false;
            if (shouldResetControl) { }; // prototype usage to void compiler warnings
            BudgetTableControl recBudgetTableControl = (BudgetTableControl)(MiscUtils.FindControlRecursively(this.Page, "BudgetTableControl"));
        
          if (shouldResetControl || this.Page.IsPageRefresh)
          {
             recBudgetTableControl.ResetControl();
          }
                  
        this.Page.SetControl("BudgetTableControl");
        ...
        public virtual void Setcontract_enddate()
        {
            ...
            // Set the contract_enddate TextBox on the webpage with value from the
            ...
            // this.contract_enddate is the ASP:TextBox on the webpage.
        ...
        public virtual void Setcontract_name()
        {
            ...
            // Set the contract_name TextBox on the webpage with value from the
            // DatabaseAYS_OEM%dbo.contract database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.contract record retrieved from the database.
            // this.contract_name is the ASP:TextBox on the webpage.
        ...
        public virtual void Setcontract_startdate()
        {
            ...
            // Set the contract_startdate TextBox on the webpage with value from the
            // DatabaseAYS_OEM%dbo.contract database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.contract record retrieved from the database.
            // this.contract_startdate is the ASP:TextBox on the webpage.
        ...
        public virtual void Setcorporate_id()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = ContractTable.corporate_id.DefaultValue;
        ...
        public virtual void SaveData()
        {
            ...
            // For Master-Detail relationships, save data on the Detail table(s)            
          BudgetTableControl recBudgetTableControl = (BudgetTableControl)(MiscUtils.FindControlRecursively(this.Page, "BudgetTableControl"));
        recBudgetTableControl.SaveData();
        ...
        public virtual void Getcontract_enddate()
        {
            ...
            // Retrieve the value entered by the user on the contract_enddate ASP:TextBox, and
            // save it into the contract_enddate field in DataSource DatabaseAYS_OEM%dbo.contract record.
            ...
            // Save the value to data source
            this.DataSource.Parse(this.contract_enddate.Text, ContractTable.contract_enddate);							
        ...
        public virtual void Getcontract_name()
        {
            ...
            // Retrieve the value entered by the user on the contract_name ASP:TextBox, and
            // save it into the contract_name field in DataSource DatabaseAYS_OEM%dbo.contract record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.contract_name.Text, ContractTable.contract_name);							
        ...
        public virtual void Getcontract_startdate()
        {
            ...
            // Retrieve the value entered by the user on the contract_startdate ASP:TextBox, and
            // save it into the contract_startdate field in DataSource DatabaseAYS_OEM%dbo.contract record.
            // Parse will also validate the date to ensure it is of the proper format
            // and a valid date.  The format is verified based on the current culture 
            // settings including the order of month, day and year and the separator character.
            // Parse throws an exception if the date is invalid.
            ...
            // Save the value to data source
            this.DataSource.Parse(this.contract_startdate.Text, ContractTable.contract_startdate);							
        ...
        public virtual void Getcontract_total_amt()
        {
            ...
            // save it into the contract_total_amt field in DataSource DatabaseAYS_OEM%dbo.contract record.
            // Parse will also validate the amount to ensure it is of the proper format
            // and valid.  The format is verified based on the current culture 
            // settings including the currency symbol and decimal separator
            // (no currency conversion is performed).
            ...
            // Save the value to data source
            this.DataSource.Parse(this.contract_total_amt.Text, ContractTable.contract_total_amt);							
        ...
        public virtual void Getcorporate_id()
        {
         // Retrieve the value entered by the user on the corporate_id ASP:DropDownList, and
            // save it into the corporate_id field in DataSource DatabaseAYS_OEM%dbo.contract record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.corporate_id), ContractTable.corporate_id);			
      ...
      // To customize, override this method in ContractRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Contract"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "Contract"));
            }
            HttpContext.Current.Session["QueryString in Edit-Contract"] = recId;
          ...
          wc.iAND(ContractTable.contract_id, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(ContractTable.contract_id));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(ContractTable.contract_id, BaseFilter.ComparisonOperator.EqualsTo, recId);
        ...
        protected virtual void contract_enddate_TextChanged(object sender, EventArgs args)
        {
                    
              }
            
        protected virtual void contract_name_TextChanged(object sender, EventArgs args)
        {
                    
              }
            
        protected virtual void contract_startdate_TextChanged(object sender, EventArgs args)
        {
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseContractRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseContractRecordControl_Rec"] = value;
            }
        }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox contract_enddate {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "contract_enddate");
            }
        }
        ...
        public System.Web.UI.WebControls.TextBox contract_name {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "contract_name");
            }
        }
        ...
        public System.Web.UI.WebControls.TextBox contract_startdate {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "contract_startdate");
            }
        }
