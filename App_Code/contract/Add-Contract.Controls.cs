...
// Add_Contract.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Contract
{
...
// Base class for the BudgetTableControlRow control on the Add_Contract page.
...
// Base class for the BudgetTableControl control on the Add_Contract page.
...
public class BaseBudgetTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Add_Contract.ContractRecordControl contractRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "ContractRecordControl") as OEMConversion.UI.Controls.Add_Contract.ContractRecordControl);
      ...
      BudgetRecord rec = new BudgetRecord();
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Budget Amount {Txt:Ascending}"), "budget_amount Asc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Budget Amount {Txt:Descending}"), "budget_amount Desc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Budget Created By {Txt:Ascending}"), "budget_created_by Asc"));
              
                this.OrderSort1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Budget Created By {Txt:Descending}"), "budget_created_by Desc"));
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (BudgetTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        BudgetTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual BudgetTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (BudgetTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Add_Contract.BudgetTableControlRow")));
...
// Base class for the ContractRecordControl control on the Add_Contract page.
...
public class BaseContractRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.custno1.TextChanged += custno1_TextChanged;
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (ContractRecord)ContractRecord.Copy(recList[0], false);
        ...
        public virtual void Setcustno1()
        {
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.contract record retrieved from the database.
            // this.custno1 is the ASP:TextBox on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
              ...
              this.custno1.Text = EvaluateFormula("URL(\"Customers\")", this.DataSource);
        ...
        public virtual void Getcustno1()
        {
            ...
            // save it into the custno field in DataSource DatabaseAYS_OEM%dbo.contract record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.custno1.Text, ContractTable.custno);							
      ...
      // To customize, override this method in ContractRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Add-Contract"] = recId;
        ...
        protected virtual void custno1_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox custno1 {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "custno1");
            }
        }
