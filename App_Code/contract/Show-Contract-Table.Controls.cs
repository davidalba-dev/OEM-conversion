...
// Show_Contract_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Contract_Table
{
...
// Base class for the ContractTableControlRow control on the Show_Contract_Table page.
...
// Base class for the ContractTableControl control on the Show_Contract_Table page.
       ...
       public BaseContractTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.contract_nameFilter)) 				
                    initialVal = this.GetFromSession(this.contract_nameFilter);
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    string[] contract_nameFilteritemListFromSession = initialVal.Split(',');
                    int index = 0;
                    foreach (string item in contract_nameFilteritemListFromSession)
                    {
                        ...
                        {
                            this.contract_nameFilter.Items.Add(item);
                            this.contract_nameFilter.Items[index].Selected = true;
                            index += 1;
                        }
                    }
                    foreach (ListItem listItem in this.contract_nameFilter.Items)
                    {
            ...
            else
            {
                ...
                this.CurrentSortOrder.Add(ContractTable.contract_startdate, OrderByItem.OrderDir.Asc);
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.OrderSort.SelectedIndexChanged += new EventHandler(OrderSort_SelectedIndexChanged);
              ...
              this.contract_nameFilter.SelectedIndexChanged += contract_nameFilter_SelectedIndexChanged;                  
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                Setcontract_nameFilter();
                Setcontract_nameLabel();
                Setcontract_nameLabel1();
        ...
        public virtual void ResetControl()
        {
            ...
            this.contract_nameFilter.ClearSelection();
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.contract_nameFilter)) {
                        
                int selectedItemCount = 0;
                foreach (ListItem item in this.contract_nameFilter.Items){
                    if (item.Selected) {
                        selectedItemCount += 1;
      ...
      String contract_nameFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "contract_nameFilter_Ajax"];
            if (MiscUtils.IsValueSelected(contract_nameFilterSelectedValue)) {

              
        if (contract_nameFilterSelectedValue != null){
                        string[] contract_nameFilteritemListFromSession = contract_nameFilterSelectedValue.Split(',');
                        int index = 0;
                        WhereClause filter = new WhereClause();
                        foreach (string item in contract_nameFilteritemListFromSession)
                        {
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            filter.AddFilter(new BaseClasses.Data.ColumnJoinFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.ContractTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"contract_.corporate_id"), new BaseClasses.Data.IdentifierAliasInfo(@"contract_", null), BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Corporate_contactsTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"corporate_contacts_.corporate_id"), new BaseClasses.Data.IdentifierAliasInfo(@"corporate_contacts_", null),  BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
      ...
      ContractRecord rec = new ContractRecord();
        ...
        public virtual void Setcontract_nameLabel1()
                  {
        ...
        public virtual void Setcontract_nameFilter()
        {
            
            ArrayList contract_nameFilterselectedFilterItemList = new ArrayList();
            string contract_nameFilteritemsString = null;
            if (this.InSession(this.contract_nameFilter))
                contract_nameFilteritemsString = this.GetFromSession(this.contract_nameFilter);
            
            if (contract_nameFilteritemsString != null)
            {
                string[] contract_nameFilteritemListFromSession = contract_nameFilteritemsString.Split(',');
                foreach (string item in contract_nameFilteritemListFromSession)
                {
                    contract_nameFilterselectedFilterItemList.Add(item);
                }
            }
              
            			
            this.Populatecontract_nameFilter(MiscUtils.GetSelectedValueList(this.contract_nameFilter, contract_nameFilterselectedFilterItemList), 500);
                    
              string url = this.ModifyRedirectUrl("../contract/Contract-QuickSelector.aspx", "", true);
              
              url = this.Page.ModifyRedirectUrl(url, "", true);                                  
              
              url += "?Target=" + this.contract_nameFilter.ClientID + "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("contract_name")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--ANY--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:All")) + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.contract_nameFilter.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(contract_nameFilter.AutoPostBack).ToLower() + ", event); return false;";
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Contract Enddate {Txt:Ascending}"), "contract_enddate Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Contract Enddate {Txt:Descending}"), "contract_enddate Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Contract Name {Txt:Ascending}"), "contract_name Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Contract Name {Txt:Descending}"), "contract_name Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Contract Startdate {Txt:Ascending}"), "contract_startdate Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Contract Startdate {Txt:Descending}"), "contract_startdate Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Contract Total Amount {Txt:Ascending}"), "contract_total_amt Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Contract Total Amount {Txt:Descending}"), "contract_total_amt Desc"));
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Contract Details {Txt:Ascending}"), "contract_details Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Contract Details {Txt:Descending}"), "contract_details Desc"));
        ...
        // Get the filters' data for contract_nameFilter.
                
        protected virtual void Populatecontract_nameFilter(ArrayList selectedValue, int maxItems)
                    
        {
            ...
            WhereClause wc = this.CreateWhereClause_contract_nameFilter();            
            this.contract_nameFilter.Items.Clear();
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_contract_nameFilter function.
            ...
            if ( ContractTable.contract_name.IsColumnValueTypeBoolean()) {
                ...
                ListItem dupItem = this.contract_nameFilter.Items.FindByText(fvalue);
                ...
                this.contract_nameFilter.Items.Add(newItem);
            ...
            this.contract_nameFilter.SetFieldMaxLength(50);
                                 
                  
            // Add the selected value.
            if (this.contract_nameFilter.Items.Count == 0)
                this.contract_nameFilter.Items.Add(new ListItem(Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
        ...
        public virtual WhereClause CreateWhereClause_contract_nameFilter()
        {
            // Create a where clause for the filter contract_nameFilter.
            // This function is called by the Populate method to load the items 
            // in the contract_nameFilterQuickSelector
            ...
            contract_nameFilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.contract_nameFilter, contract_nameFilterselectedFilterItemList); 
            WhereClause wc = new WhereClause();
            if (contract_nameFilterselectedFilterItemList == null || contract_nameFilterselectedFilterItemList.Count == 0)
                wc.RunQuery = false;
            else            
            {
                foreach (string item in contract_nameFilterselectedFilterItemList)
                {
        ...
        protected override void SaveControlsToSession()
        {
            ...
            ArrayList contract_nameFilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.contract_nameFilter, null);
            string contract_nameFilterSessionString = "";
            if (contract_nameFilterselectedFilterItemList != null){
                foreach (string item in contract_nameFilterselectedFilterItemList){
                    contract_nameFilterSessionString = String.Concat(contract_nameFilterSessionString ,"," , item);
                }
            }
            this.SaveToSession(this.contract_nameFilter, contract_nameFilterSessionString);
        ...
        protected  void SaveControlsToSession_Ajax()
        {
            ...
            this.SaveToSession("contract_nameFilter_Ajax", contract_nameFilterSessionString);
      ...
      this.SaveToSession("SearchText_Ajax", this.SearchText.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.contract_nameFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(contract_nameFilter))
        ...
        public virtual void Button_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../contract/Add-Contract.aspx";
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void contract_nameFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector contract_nameFilter {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "contract_nameFilter");
            }
        }              
        ...
        public System.Web.UI.WebControls.Literal contract_nameLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "contract_nameLabel1");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual ContractTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContractTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Contract_Table.ContractTableControlRow")));
