...
// Edit_RODetails.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_RODetails
{
...
// Base class for the RODetailsRecordControl control on the Edit_RODetails page.
...
public class BaseRODetailsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetRONo()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = RODetailsTable.RONo.DefaultValue;
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        if(_isExpandableNonCompositeForeignKey && RODetailsTable.RONo.IsApplyDisplayAs)
                            fvalue = RODetailsTable.GetDFKA(itemValue, RODetailsTable.RONo);
        ...
        public virtual void GetRONo()
        {
         // Retrieve the value entered by the user on the RONo ASP:QuickSelector, and
            ...
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.RONo), RODetailsTable.RONo);			
      ...
      // To customize, override this method in RODetailsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Edit-RODetails"] = recId;
