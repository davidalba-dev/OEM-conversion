...
// Show_RODetails_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_RODetails_Table
{
...
// Base class for the RODetailsTableControlRow control on the Show_RODetails_Table page.
...
public class BaseRODetailsTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetROItemDesc()
        {
            ...
            // on Properties.
            if (this.ROItemDesc.Text == null ||
                this.ROItemDesc.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.ROItemDesc.Text = "&nbsp;";
            }
        ...
        public virtual void SetROLineType()
        {
            ...
            // Set the ROLineType Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.RODetails database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.RODetails record retrieved from the database.
            // this.ROLineType is the ASP:Literal on the webpage.
            ...
            // If the ROLineType is NULL or blank, then use the value specified  
            // on Properties.
            if (this.ROLineType.Text == null ||
                this.ROLineType.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.ROLineType.Text = "&nbsp;";
            }
        ...
        public virtual void SetROLocation()
        {
            ...
            // Set the ROLocation Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.RODetails database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.RODetails record retrieved from the database.
            // this.ROLocation is the ASP:Literal on the webpage.
            ...
            // If the ROLocation is NULL or blank, then use the value specified  
            // on Properties.
            if (this.ROLocation.Text == null ||
                this.ROLocation.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.ROLocation.Text = "&nbsp;";
            }
        ...
        public virtual void SetRONo()
        {
            ...
            if (this.DataSource != null && this.DataSource.RONoSpecified) {
               ...
               Boolean _isExpandableNonCompositeForeignKey = RODetailsTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RODetailsTable.RONo);
               if(_isExpandableNonCompositeForeignKey &&RODetailsTable.RONo.IsApplyDisplayAs)
                                  
                     formattedValue = RODetailsTable.GetDFKA(this.DataSource.RONo.ToString(),RODetailsTable.RONo, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(RODetailsTable.RONo);
              ...
              this.RONo.Text = RODetailsTable.RONo.Format(RODetailsTable.RONo.DefaultValue);
        ...
        public virtual void SetROPartNo()
        {
            ...
            // on Properties.
            if (this.ROPartNo.Text == null ||
                this.ROPartNo.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.ROPartNo.Text = "&nbsp;";
            }
        ...
        public virtual void SetROQuantity()
        {
            ...
            // on Properties.
            if (this.ROQuantity.Text == null ||
                this.ROQuantity.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.ROQuantity.Text = "&nbsp;";
            }
        ...
        public virtual void SetROSellPrice()
        {
            ...
            // on Properties.
            if (this.ROSellPrice.Text == null ||
                this.ROSellPrice.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.ROSellPrice.Text = "&nbsp;";
            }
        ...
        public virtual void SetROStepDate()
        {
            ...
            // Set the ROStepDate Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.RODetails database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.RODetails record retrieved from the database.
            // this.ROStepDate is the ASP:Literal on the webpage.
            ...
            // If the ROStepDate is NULL or blank, then use the value specified  
            // on Properties.
            if (this.ROStepDate.Text == null ||
                this.ROStepDate.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.ROStepDate.Text = "&nbsp;";
            }
        ...
        public virtual void SetROStepDesc()
        {
            ...
            // Set the ROStepDesc Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.RODetails database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.RODetails record retrieved from the database.
            // this.ROStepDesc is the ASP:Literal on the webpage.
            ...
            // If the ROStepDesc is NULL or blank, then use the value specified  
            // on Properties.
            if (this.ROStepDesc.Text == null ||
                this.ROStepDesc.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.ROStepDesc.Text = "&nbsp;";
            }
        ...
        public virtual void SetROStepHours()
        {
            ...
            // Set the ROStepHours Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.RODetails database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.RODetails record retrieved from the database.
            // this.ROStepHours is the ASP:Literal on the webpage.
            ...
            // If the ROStepHours is NULL or blank, then use the value specified  
            // on Properties.
            if (this.ROStepHours.Text == null ||
                this.ROStepHours.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.ROStepHours.Text = "&nbsp;";
            }
        ...
        public virtual void SetROStepTechnician()
        {
            ...
            // Set the ROStepTechnician Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.RODetails database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.RODetails record retrieved from the database.
            // this.ROStepTechnician is the ASP:Literal on the webpage.
            ...
            // If the ROStepTechnician is NULL or blank, then use the value specified  
            // on Properties.
            if (this.ROStepTechnician.Text == null ||
                this.ROStepTechnician.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.ROStepTechnician.Text = "&nbsp;";
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal ROLineType {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROLineType");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal ROLocation {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROLocation");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal ROStepDate {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROStepDate");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal ROStepDesc {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROStepDesc");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal ROStepHours {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROStepHours");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal ROStepTechnician {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROStepTechnician");
            }
        }
...
// Base class for the RODetailsTableControl control on the Show_RODetails_Table page.
...
public class BaseRODetailsTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                    string url = "../RODetails/Add-RODetails.aspx?TabVisible=False&SaveAndNewVisible=False";
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "RODetailsTableControl_PostbackTracker").ClientID);                           
                                
                string javascriptCall = "";
                
                    javascriptCall = "initializePopupPage(document.getElementById('" + MiscUtils.FindControlRecursively(this, "RODetailsTableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = RODetailsTable.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
              
                // Add each of the columns in order of export.
                BaseColumn[] columns = new BaseColumn[] {
                             RODetailsTable.ROItemDesc,
             RODetailsTable.ROLineType,
             RODetailsTable.ROLocation,
             RODetailsTable.RONo,
             RODetailsTable.ROPartNo,
             RODetailsTable.ROQuantity,
             RODetailsTable.ROSellPrice,
             RODetailsTable.ROStepDate,
             RODetailsTable.ROStepDesc,
             RODetailsTable.ROStepHours,
             RODetailsTable.ROStepTechnician,
             RODetailsTable.SessionID,
             null};
                ExportDataToCSV exportData = new ExportDataToCSV(RODetailsTable.Instance,wc,orderBy,columns);
                exportData.StartExport(this.Page.Response, true);

                DataForExport dataForCSV = new DataForExport(RODetailsTable.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(RODetailsTable.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(RODetailsTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(RODetailsTable.ROItemDesc, "Default"));
             data.ColumnList.Add(new ExcelColumn(RODetailsTable.ROLineType, "0"));
             data.ColumnList.Add(new ExcelColumn(RODetailsTable.ROLocation, "0"));
             data.ColumnList.Add(new ExcelColumn(RODetailsTable.RONo, "Default"));
             data.ColumnList.Add(new ExcelColumn(RODetailsTable.ROPartNo, "Default"));
             data.ColumnList.Add(new ExcelColumn(RODetailsTable.ROQuantity, "Standard"));
             data.ColumnList.Add(new ExcelColumn(RODetailsTable.ROSellPrice, "Currency"));
             data.ColumnList.Add(new ExcelColumn(RODetailsTable.ROStepDate, "Short Date"));
             data.ColumnList.Add(new ExcelColumn(RODetailsTable.ROStepDesc, "Default"));
             data.ColumnList.Add(new ExcelColumn(RODetailsTable.ROStepHours, "Standard"));
             data.ColumnList.Add(new ExcelColumn(RODetailsTable.ROStepTechnician, "Default"));
             data.ColumnList.Add(new ExcelColumn(RODetailsTable.SessionID, "0"));
              ...
              {
                val = RODetailsTable.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-RODetails-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RODetails";
                // If Show-RODetails-Table.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(RODetailsTable.ROItemDesc.Name, ReportEnum.Align.Left, "${ROItemDesc}", ReportEnum.Align.Left, 28);
                 report.AddColumn(RODetailsTable.ROLineType.Name, ReportEnum.Align.Right, "${ROLineType}", ReportEnum.Align.Right, 15);
                 report.AddColumn(RODetailsTable.ROLocation.Name, ReportEnum.Align.Right, "${ROLocation}", ReportEnum.Align.Right, 15);
                 report.AddColumn(RODetailsTable.RONo.Name, ReportEnum.Align.Left, "${RONo}", ReportEnum.Align.Left, 17);
                 report.AddColumn(RODetailsTable.ROPartNo.Name, ReportEnum.Align.Left, "${ROPartNo}", ReportEnum.Align.Left, 20);
                 report.AddColumn(RODetailsTable.ROQuantity.Name, ReportEnum.Align.Right, "${ROQuantity}", ReportEnum.Align.Right, 20);
                 report.AddColumn(RODetailsTable.ROSellPrice.Name, ReportEnum.Align.Right, "${ROSellPrice}", ReportEnum.Align.Right, 20);
                 report.AddColumn(RODetailsTable.ROStepDate.Name, ReportEnum.Align.Left, "${ROStepDate}", ReportEnum.Align.Left, 20);
                 report.AddColumn(RODetailsTable.ROStepDesc.Name, ReportEnum.Align.Left, "${ROStepDesc}", ReportEnum.Align.Left, 20);
                 report.AddColumn(RODetailsTable.ROStepHours.Name, ReportEnum.Align.Right, "${ROStepHours}", ReportEnum.Align.Right, 20);
                 report.AddColumn(RODetailsTable.ROStepTechnician.Name, ReportEnum.Align.Left, "${ROStepTechnician}", ReportEnum.Align.Left, 15);
                 report.AddColumn(RODetailsTable.SessionID.Name, ReportEnum.Align.Right, "${SessionID}", ReportEnum.Align.Right, 15);
                ...
                ColumnList columns = RODetailsTable.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = RODetailsTable.GetRecordCount(joinFilter,whereClause);
                RODetailsRecord[] records = null;
                
                do
                {
                    
                    records = RODetailsTable.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( RODetailsRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${ROItemDesc}", record.Format(RODetailsTable.ROItemDesc), ReportEnum.Align.Left, 300);
                             report.AddData("${ROLineType}", record.Format(RODetailsTable.ROLineType), ReportEnum.Align.Right, 300);
                             report.AddData("${ROLocation}", record.Format(RODetailsTable.ROLocation), ReportEnum.Align.Right, 300);
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.RONo)){
                                 report.AddData("${RONo}", "",ReportEnum.Align.Left, 300);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = RODetailsTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RODetailsTable.RONo);
                                 _DFKA = RODetailsTable.GetDFKA(record.RONo.ToString(), RODetailsTable.RONo,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  RODetailsTable.RONo.IsApplyDisplayAs){
                                     report.AddData("${RONo}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${RONo}", record.Format(RODetailsTable.RONo), ReportEnum.Align.Left, 300);
                                 }
                             }
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.ROPartNo)){
                                 report.AddData("${ROPartNo}", "",ReportEnum.Align.Left, 300);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = RODetailsTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RODetailsTable.ROPartNo);
                                 _DFKA = RODetailsTable.GetDFKA(record.ROPartNo.ToString(), RODetailsTable.ROPartNo,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  RODetailsTable.ROPartNo.IsApplyDisplayAs){
                                     report.AddData("${ROPartNo}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${ROPartNo}", record.Format(RODetailsTable.ROPartNo), ReportEnum.Align.Left, 300);
                                 }
                             }
                             report.AddData("${ROQuantity}", record.Format(RODetailsTable.ROQuantity), ReportEnum.Align.Right, 300);
                             report.AddData("${ROSellPrice}", record.Format(RODetailsTable.ROSellPrice), ReportEnum.Align.Right, 300);
                             report.AddData("${ROStepDate}", record.Format(RODetailsTable.ROStepDate), ReportEnum.Align.Left, 300);
                             report.AddData("${ROStepDesc}", record.Format(RODetailsTable.ROStepDesc), ReportEnum.Align.Left, 300);
                             report.AddData("${ROStepHours}", record.Format(RODetailsTable.ROStepHours), ReportEnum.Align.Right, 300);
                             report.AddData("${ROStepTechnician}", record.Format(RODetailsTable.ROStepTechnician), ReportEnum.Align.Left, 300);
                             report.AddData("${SessionID}", record.Format(RODetailsTable.SessionID), ReportEnum.Align.Right, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-RODetails-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RODetails";
                // If Show-RODetails-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual RODetailsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RODetailsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_RODetails_Table.RODetailsTableControlRow")));
