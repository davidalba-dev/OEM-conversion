...
// Show_RODetails_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_RODetails_Mobile
{
...
// Base class for the RepairOrdersTableControlRow control on the Show_RODetails_Mobile page.
...
// Base class for the RepairOrdersTableControl control on the Show_RODetails_Mobile page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Show_RODetails_Mobile.RODetailsRecordControl rODetailsRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "RODetailsRecordControl") as OEMConversion.UI.Controls.Show_RODetails_Mobile.RODetailsRecordControl);
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Show_RODetails_Mobile.RepairOrdersTableControlRow")));
...
// Base class for the RODetailsRecordControl control on the Show_RODetails_Mobile page.
...
public class BaseRODetailsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in RODetailsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-RODetails-Mobile"] = recId;
