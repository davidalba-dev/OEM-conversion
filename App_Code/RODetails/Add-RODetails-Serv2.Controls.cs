...
// Add_RODetails_Serv2.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_RODetails_Serv2
{
...
// Base class for the RODetailsRecordControl control on the Add_RODetails_Serv2 page.
...
public class BaseRODetailsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetROLineType()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
              ...
              this.ROLineType.Text = EvaluateFormula("6", this.DataSource);
      ...
      // To customize, override this method in RODetailsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Add-RODetails-Serv2"] = recId;
        ...
        public virtual WhereClause CreateWhereClause_ROPartNoDropDownList() 
        {
            ...
            // This WhereClause is for the DatabaseAYS_OEM%dbo.SC2 table.
            // Examples:
            // wc.iAND(SC2Table.ServCode, BaseFilter.ComparisonOperator.EqualsTo, "XYZ");
            // wc.iAND(SC2Table.Active, BaseFilter.ComparisonOperator.EqualsTo, "1");
            CompoundFilter filter = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
            WhereClause whereClause = new WhereClause();
            
            if (EvaluateFormula("1", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.SC2Table, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"SC2_.Service_active"), EvaluateFormula("1", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
        ...
        protected virtual void PopulateROPartNoDropDownList(string selectedValue, int maxItems) 
        {
            ...
            if (wc.RunQuery)
            {
                ...
                do
                {
                    itemValues = SC2Table.GetRecords(wc, orderBy, pageNum, maxItems);
                    foreach (SC2Record itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.ServCodeSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.ROPartNo.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                fvalue = EvaluateFormula("ServCode", itemValue, variables2, evaluator);
                ...
                !MiscUtils.SetSelectedDisplayText(this.ROPartNo, selectedValue))
            {
                ...
                // construct a whereclause to query a record with DatabaseAYS_OEM%dbo.SC2.ServCode = selectedValue
                    
                CompoundFilter filter2 = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
                WhereClause whereClause2 = new WhereClause();
                filter2.AddFilter(new BaseClasses.Data.ColumnValueFilter(SC2Table.ServCode, selectedValue, BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
                whereClause2.AddFilter(filter2, CompoundFilter.CompoundingOperators.And_Operator);

                // Execute the query
                try
                {
                    SC2Record[] rc = SC2Table.GetRecords(whereClause2, new OrderBy(false, false), 0, 1);
                    System.Collections.Generic.IDictionary<string, object> vars = new System.Collections.Generic.Dictionary<string, object> ();
                    // if find a record, add it to the dropdown and set it as selected item
                    if (rc != null && rc.Length == 1)
                    {
                        SC2Record itemValue = rc[0];
                        string cvalue = null;
                        string fvalue = null;                        
                        if (itemValue.ServCodeSpecified)
                            cvalue = itemValue.ServCode.ToString(); 
                        ...
                        fvalue = EvaluateFormula("ServCode", itemValue, variables2, evaluator2);
