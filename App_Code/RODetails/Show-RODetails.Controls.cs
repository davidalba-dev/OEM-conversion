...
// Show_RODetails.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_RODetails
{
...
// Base class for the RepairOrdersTableControlRow control on the Show_RODetails page.
...
public class BaseRepairOrdersTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        RODetailsRecordControl parentCtrl;
      
            parentCtrl = (RODetailsRecordControl)this.Page.FindControlRecursively("RODetailsRecordControl");
...
// Base class for the RepairOrdersTableControl control on the Show_RODetails page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Show_RODetails.RODetailsRecordControl rODetailsRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "RODetailsRecordControl") as OEMConversion.UI.Controls.Show_RODetails.RODetailsRecordControl);
          
              if (rODetailsRecordControlObj != null && rODetailsRecordControlObj.GetRecord() != null && rODetailsRecordControlObj.GetRecord().IsCreated)
              {
              wc.iAND(RepairOrdersTable.RONo, BaseFilter.ComparisonOperator.EqualsTo, rODetailsRecordControlObj.GetRecord().RONo.ToString());
              selectedRecordKeyValue.AddElement(RepairOrdersTable.RONo.InternalName, rODetailsRecordControlObj.GetRecord().RONo.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInRODetailsRecordControl = HttpContext.Current.Session["RepairOrdersTableControlWhereClause"] as string;
      
      if (selectedRecordInRODetailsRecordControl != null && KeyValue.IsXmlKey(selectedRecordInRODetailsRecordControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInRODetailsRecordControl);
      
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(RepairOrdersTable.RONo))
      {
      wc.iAND(RepairOrdersTable.RONo, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(RepairOrdersTable.RONo).ToString());
      }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-RODetails.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RepairOrders";
                // If Show-RODetails.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-RODetails.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RepairOrders";
                // If Show-RODetails.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_RODetails.RepairOrdersTableControlRow")));
...
// Base class for the RODetailsRecordControl control on the Show_RODetails page.
...
public class BaseRODetailsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "RODetailsRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            this.DataSource = RODetailsTable.GetRecord(recList[0].GetID().ToXmlString(), true);
      ...
      // To customize, override this method in RODetailsRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["RODetails"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "RODetails"));
            }
            HttpContext.Current.Session["QueryString in Show-RODetails"] = recId;
