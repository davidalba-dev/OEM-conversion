...
// Show_RODetails_Table_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_RODetails_Table_Mobile
{
...
// Base class for the RODetailsTableControlRow control on the Show_RODetails_Table_Mobile page.
...
public class BaseRODetailsTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetROItemDesc()
        {
            ...
            // Set the ROItemDesc Label on the webpage with value from the
            ...
            // this.ROItemDesc is the ASP:Label on the webpage.
      ...
      // To customize, override this method in RODetailsTableControlRow.
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../RODetails/Show-RODetails-Mobile.aspx?RODetails={PK}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Label ROItemDesc {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ROItemDesc");
            }
        }
...
// Base class for the RODetailsTableControl control on the Show_RODetails_Table_Mobile page.
...
public class BaseRODetailsTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep1 = (System.Web.UI.WebControls.Repeater)BaseClasses.Utils.MiscUtils.FindControlRecursively(rep.Items[PageIndex], "RODetailsTableControlRepeater1");
      ...
      foreach(BaseColumn col in cols)
      {
            ...
            foreach (RODetailsRecord rec in recordList ){
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, RODetailsTable.ROPartNo.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (!this.ResetData)
            {
              System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RODetailsTableControlRepeater"));
              if (rep == null){return;}
              RODetailsTableControlRow[] recControls = this.GetRecordControls();
                foreach (RODetailsTableControlRow recControl in recControls) 
		{
...
#region "Helper Functions"
        ...
        public virtual RODetailsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RODetailsTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Show_RODetails_Table_Mobile.RODetailsTableControlRow")));
