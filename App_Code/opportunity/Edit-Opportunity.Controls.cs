...
// Edit_Opportunity.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Opportunity
{
...
// Base class for the OpportunityRecordControl control on the Edit_Opportunity page.
...
public class BaseOpportunityRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "OpportunityRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
        ...
        public virtual void Setattachment_11()
        {
              
            if (this.DataSource != null && this.DataSource.attachment_1Specified) {
              
                  this.attachment_11.Text = this.DataSource.attachment_1_filename;
                  this.attachment_11.ToolTip = "Open " + this.attachment_11.Text;
				          if(string.IsNullOrEmpty(this.attachment_11.Text)) 
				          {
				              this.attachment_11.Text = Page.GetResourceValue("Txt:OpenFile", "OEMConversion");
                      this.attachment_11.ToolTip = this.attachment_11.Text;
				          }
                    
                  this.attachment_11.OnClientClick = "window.open('../Shared/ExportFieldValue.aspx?Table=" +
            
                                this.Page.Encrypt("Opportunity") +
                                "&Field=" + this.Page.Encrypt("attachment_1") +
                                "&Record=" + this.Page.Encrypt(HttpUtility.UrlEncode(this.DataSource.GetID().ToString())) +
                                "&Filename=" + this.DataSource.attachment_1_filename +
                          
                          "','','left=100,top=50,width=400,height=300,resizable, scrollbars=1');return false;";
                            
                this.attachment_11.Visible = true;
            }
            else {
                this.attachment_11.Visible = false;	
            }
               
        }
                
        public virtual void Setattachment_21()
        {
              
            if (this.DataSource != null && this.DataSource.attachment_2Specified) {
              
                  this.attachment_21.Text = this.DataSource.attachment_2_filename;
                  this.attachment_21.ToolTip = "Open " + this.attachment_21.Text;
				          if(string.IsNullOrEmpty(this.attachment_21.Text)) 
				          {
				              this.attachment_21.Text = Page.GetResourceValue("Txt:OpenFile", "OEMConversion");
                      this.attachment_21.ToolTip = this.attachment_21.Text;
				          }
                    
                  this.attachment_21.OnClientClick = "window.open('../Shared/ExportFieldValue.aspx?Table=" +
            
                                this.Page.Encrypt("Opportunity") +
                                "&Field=" + this.Page.Encrypt("attachment_2") +
                                "&Record=" + this.Page.Encrypt(HttpUtility.UrlEncode(this.DataSource.GetID().ToString())) +
                                "&Filename=" + this.DataSource.attachment_2_filename +
                          
                          "','','left=100,top=50,width=400,height=300,resizable, scrollbars=1');return false;";
                            
                this.attachment_21.Visible = true;
            }
            else {
                this.attachment_21.Visible = false;	
            }
               
        }
                
        public virtual void Setattachment_31()
        {
              
            if (this.DataSource != null && this.DataSource.attachment_3Specified) {
              
                  this.attachment_31.Text = this.DataSource.attachment_3_filename;
                  this.attachment_31.ToolTip = "Open " + this.attachment_31.Text;
				          if(string.IsNullOrEmpty(this.attachment_31.Text)) 
				          {
				              this.attachment_31.Text = Page.GetResourceValue("Txt:OpenFile", "OEMConversion");
                      this.attachment_31.ToolTip = this.attachment_31.Text;
				          }
                    
                  this.attachment_31.OnClientClick = "window.open('../Shared/ExportFieldValue.aspx?Table=" +
            
                                this.Page.Encrypt("Opportunity") +
                                "&Field=" + this.Page.Encrypt("attachment_3") +
                                "&Record=" + this.Page.Encrypt(HttpUtility.UrlEncode(this.DataSource.GetID().ToString())) +
                                "&Filename=" + this.DataSource.attachment_3_filename +
                          
                          "','','left=100,top=50,width=400,height=300,resizable, scrollbars=1');return false;";
                            
                this.attachment_31.Visible = true;
            }
            else {
                this.attachment_31.Visible = false;	
            }
               
        }
                
        public virtual void Setattachment_41()
        {
              
            if (this.DataSource != null && this.DataSource.attachment_4Specified) {
              
                  this.attachment_41.Text = this.DataSource.attachment_4_filename;
                  this.attachment_41.ToolTip = "Open " + this.attachment_41.Text;
				          if(string.IsNullOrEmpty(this.attachment_41.Text)) 
				          {
				              this.attachment_41.Text = Page.GetResourceValue("Txt:OpenFile", "OEMConversion");
                      this.attachment_41.ToolTip = this.attachment_41.Text;
				          }
                    
                  this.attachment_41.OnClientClick = "window.open('../Shared/ExportFieldValue.aspx?Table=" +
            
                                this.Page.Encrypt("Opportunity") +
                                "&Field=" + this.Page.Encrypt("attachment_4") +
                                "&Record=" + this.Page.Encrypt(HttpUtility.UrlEncode(this.DataSource.GetID().ToString())) +
                                "&Filename=" + this.DataSource.attachment_4_filename +
                          
                          "','','left=100,top=50,width=400,height=300,resizable, scrollbars=1');return false;";
                            
                this.attachment_41.Visible = true;
            }
            else {
                this.attachment_41.Visible = false;	
            }
        ...
        public virtual void Setcustno()
        {
            ...
            this.PopulatecustnoDropDownList(selectedValue, 500);              
        ...
        public virtual void Setdept_id()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = OpportunityTable.dept_id.DefaultValue;
        ...
        public virtual void Setstage_id()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = OpportunityTable.stage_id.DefaultValue;
      ...
      // To customize, override this method in OpportunityRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Opportunity"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "Opportunity"));
            }
            HttpContext.Current.Session["QueryString in Edit-Opportunity"] = recId;
        ...
        public virtual WhereClause CreateWhereClause_custnoDropDownList() 
        {
            ...
            filter.AddFilter(new BaseClasses.Data.ColumnJoinFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.CustomersTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"Customers_.CustNo"), new BaseClasses.Data.IdentifierAliasInfo(@"Customers_", null), BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.OpportunityTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"opportunity_.custno"), new BaseClasses.Data.IdentifierAliasInfo(@"opportunity_", null),  BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
            if (EvaluateFormula("URL(\"Opportunity\")", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.OpportunityTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"opportunity_.opportunity_id"), EvaluateFormula("URL(\"Opportunity\")", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("1", false) == "--PLEASE_SELECT--" || EvaluateFormula("1", false) == "--ANY--") whereClause.RunQuery = false;
         if (EvaluateFormula("URL(\"Opportunity\")", false) == "--PLEASE_SELECT--" || EvaluateFormula("URL(\"Opportunity\")", false) == "--ANY--") whereClause.RunQuery = false;
        ...
        public virtual WhereClause CreateWhereClause_opportunity_ownerDropDownList() 
        {
            ...
            filter.AddFilter(new BaseClasses.Data.ColumnJoinFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.TechniciansTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"Technicians_.technician_id"), new BaseClasses.Data.IdentifierAliasInfo(@"Technicians_", null), BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.OpportunityTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"opportunity_.opportunity_owner"), new BaseClasses.Data.IdentifierAliasInfo(@"opportunity_", null),  BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
            if (EvaluateFormula("URL(\"Opportunity\")", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.OpportunityTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"opportunity_.opportunity_id"), EvaluateFormula("URL(\"Opportunity\")", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("1", false) == "--PLEASE_SELECT--" || EvaluateFormula("1", false) == "--ANY--") whereClause.RunQuery = false;
         if (EvaluateFormula("URL(\"Opportunity\")", false) == "--PLEASE_SELECT--" || EvaluateFormula("URL(\"Opportunity\")", false) == "--ANY--") whereClause.RunQuery = false;
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton attachment_11 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "attachment_11");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton attachment_21 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "attachment_21");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton attachment_31 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "attachment_31");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton attachment_41 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "attachment_41");
            }
        }
