...
// Show_Opportunity_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Opportunity_Table
{
...
// Base class for the OpportunityTableControlRow control on the Show_Opportunity_Table page.
...
public class BaseOpportunityTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setcustno()
        {
            ...
            if (this.DataSource != null && this.DataSource.custnoSpecified) {
               ...
               if(_isExpandableNonCompositeForeignKey &&OpportunityTable.custno.IsApplyDisplayAs)
                     ...
                     formattedValue = OpportunityTable.GetDFKA(this.DataSource.custno.ToString(),OpportunityTable.custno, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(OpportunityTable.custno);
              ...
              this.custno.Text = OpportunityTable.custno.Format(OpportunityTable.custno.DefaultValue);
        ...
        public virtual void Setlead_source_id()
        {
            ...
            // Set the lead_source_id Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.opportunity database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.opportunity record retrieved from the database.
            // this.lead_source_id is the ASP:Literal on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.lead_source_idSpecified) {
               ...
               if(_isExpandableNonCompositeForeignKey &&OpportunityTable.lead_source_id.IsApplyDisplayAs)
                     ...
                     formattedValue = OpportunityTable.GetDFKA(this.DataSource.lead_source_id.ToString(),OpportunityTable.lead_source_id, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(OpportunityTable.lead_source_id);
                                  
                                
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                this.lead_source_id.Text = formattedValue;
              ...
              this.lead_source_id.Text = OpportunityTable.lead_source_id.Format(OpportunityTable.lead_source_id.DefaultValue);
            		
            }
            
            // If the lead_source_id is NULL or blank, then use the value specified  
            // on Properties.
            if (this.lead_source_id.Text == null ||
                this.lead_source_id.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.lead_source_id.Text = "&nbsp;";
            }
        ...
        public virtual void Setopportunity_amount()
        {
            ...
            // Set the opportunity_amount Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.opportunity database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.opportunity record retrieved from the database.
            // this.opportunity_amount is the ASP:Literal on the webpage.
            ...
            // If the opportunity_amount is NULL or blank, then use the value specified  
            // on Properties.
            if (this.opportunity_amount.Text == null ||
                this.opportunity_amount.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.opportunity_amount.Text = "&nbsp;";
            }
        ...
        public virtual void Setopportunity_date()
        {
            ...
            // Set the opportunity_date Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.opportunity database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.opportunity record retrieved from the database.
            // this.opportunity_date is the ASP:Literal on the webpage.
            ...
            // If the opportunity_date is NULL or blank, then use the value specified  
            // on Properties.
            if (this.opportunity_date.Text == null ||
                this.opportunity_date.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.opportunity_date.Text = "&nbsp;";
            }
        ...
        public virtual void Setopportunity_name()
        {
            ...
            // Set the opportunity_name Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.opportunity database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.opportunity record retrieved from the database.
            // this.opportunity_name is the ASP:Literal on the webpage.
            ...
            // If the opportunity_name is NULL or blank, then use the value specified  
            // on Properties.
            if (this.opportunity_name.Text == null ||
                this.opportunity_name.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.opportunity_name.Text = "&nbsp;";
            }
        ...
        public virtual void Setopportunity_notes()
        {
            ...
            // Set the opportunity_notes Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.opportunity database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.opportunity record retrieved from the database.
            // this.opportunity_notes is the ASP:Literal on the webpage.
               ...
               string formattedValue = this.DataSource.Format(OpportunityTable.opportunity_notes);
                ...
                if(formattedValue != null){
                    ...
                    if (originalLength >= popupThreshold) {
                        String name = HttpUtility.HtmlEncode(OpportunityTable.opportunity_notes.Name);
                        ...
                        formattedValue = "<a onclick=\'gPersist=true;\' class=\'truncatedText\' onmouseout=\'detailRolloverPopupClose();\' " +
                            "onmouseover=\'SaveMousePosition(event); delayRolloverPopup(\"PageMethods.GetRecordFieldValue(\\\"" + "NULL" + "\\\", \\\"OEMConversion.Business.OpportunityTable, App_Code\\\",\\\"" +
                              (HttpUtility.UrlEncode(this.DataSource.GetID().ToString())).Replace("\\","\\\\\\\\") + "\\\", \\\"opportunity_notes\\\", \\\"opportunity_notes\\\", \\\"" +NetUtils.EncodeStringForHtmlDisplay(name.Substring(0, name.Length)) + "\\\",\\\"" + Page.GetResourceValue("Btn:Close", "OEMConversion") + "\\\", " +
                        " false, 200," +
            ...
            // If the opportunity_notes is NULL or blank, then use the value specified  
            // on Properties.
            if (this.opportunity_notes.Text == null ||
                this.opportunity_notes.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.opportunity_notes.Text = "&nbsp;";
            }
        ...
        public virtual void Setopportunity_owner()
        {
            ...
            // Set the opportunity_owner Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.opportunity database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.opportunity record retrieved from the database.
            // this.opportunity_owner is the ASP:Literal on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.opportunity_ownerSpecified) {
                ...
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = "";
               Boolean _isExpandableNonCompositeForeignKey = OpportunityTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(OpportunityTable.opportunity_owner);
               if(_isExpandableNonCompositeForeignKey &&OpportunityTable.opportunity_owner.IsApplyDisplayAs)
                                  
                     formattedValue = OpportunityTable.GetDFKA(this.DataSource.opportunity_owner.ToString(),OpportunityTable.opportunity_owner, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(OpportunityTable.opportunity_owner);
              ...
              this.opportunity_owner.Text = OpportunityTable.opportunity_owner.Format(OpportunityTable.opportunity_owner.DefaultValue);
            		
            }
            
            // If the opportunity_owner is NULL or blank, then use the value specified  
            // on Properties.
            if (this.opportunity_owner.Text == null ||
                this.opportunity_owner.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.opportunity_owner.Text = "&nbsp;";
            }
        ...
        public virtual void Setstage_id()
        {
            ...
            // Set the stage_id Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.opportunity database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.opportunity record retrieved from the database.
            // this.stage_id is the ASP:Literal on the webpage.
                  
            if (this.DataSource != null && this.DataSource.stage_idSpecified) {
                								
                // If the stage_id is non-NULL, then format the value.
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = "";
               Boolean _isExpandableNonCompositeForeignKey = OpportunityTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(OpportunityTable.stage_id);
               if(_isExpandableNonCompositeForeignKey &&OpportunityTable.stage_id.IsApplyDisplayAs)
                                  
                     formattedValue = OpportunityTable.GetDFKA(this.DataSource.stage_id.ToString(),OpportunityTable.stage_id, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(OpportunityTable.stage_id);
                                  
                                
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                this.stage_id.Text = formattedValue;
                   
            } 
            
            else {
            
                // stage_id is NULL in the database, so use the Default Value.  
                // Default Value could also be NULL.
        
              this.stage_id.Text = OpportunityTable.stage_id.Format(OpportunityTable.stage_id.DefaultValue);
            		
            }
            
            // If the stage_id is NULL or blank, then use the value specified  
            // on Properties.
            if (this.stage_id.Text == null ||
                this.stage_id.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.stage_id.Text = "&nbsp;";
            }
      ...
      // To customize, override this method in OpportunityTableControlRow.
        ...
        public virtual void EditRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../opportunity/Edit-Opportunity.aspx?Opportunity={PK}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal lead_source_id {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "lead_source_id");
            }
        }
            
        public System.Web.UI.WebControls.Literal opportunity_amount {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "opportunity_amount");
            }
        }
            
        public System.Web.UI.WebControls.Literal opportunity_date {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "opportunity_date");
            }
        }
            
        public System.Web.UI.WebControls.Literal opportunity_name {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "opportunity_name");
            }
        }
            
        public System.Web.UI.WebControls.Literal opportunity_notes {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "opportunity_notes");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal opportunity_owner {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "opportunity_owner");
            }
        }
            
        public System.Web.UI.WebControls.Literal stage_id {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "stage_id");
            }
        }
...
// Base class for the OpportunityTableControl control on the Show_Opportunity_Table page.
...
public class BaseOpportunityTableControl : OEMConversion.UI.BaseApplicationTableControl
{
       ...
       public BaseOpportunityTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.stage_idFilter)) 				
                    initialVal = this.GetFromSession(this.stage_idFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"stage_id\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.stage_idFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.stage_idFilter.SelectedValue = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.stage_idFilter.SelectedIndexChanged += new EventHandler(stage_idFilter_SelectedIndexChanged);
      ...
      public override void DataBind()
      {
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(OpportunityTable.stage_id, this.DataSource);
        }
        ...
        public virtual void ResetControl()
        {
            ...
            this.stage_idFilter.ClearSelection();
      ...
      cols.Add(OpportunityTable.custcontactkey, true);
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.SearchText, this.GetFromSession(this.SearchText)), true, false);
            ...
            if (MiscUtils.IsValueSelected(this.stage_idFilter)) {
                        
                wc.iAND(OpportunityTable.stage_id, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.stage_idFilter, this.GetFromSession(this.stage_idFilter)), false, false);
      ...
      String stage_idFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "stage_idFilter_Ajax"];
            if (MiscUtils.IsValueSelected(stage_idFilterSelectedValue)) {

              
                wc.iAND(OpportunityTable.stage_id, BaseFilter.ComparisonOperator.EqualsTo, stage_idFilterSelectedValue, false, false);
        ...
        public virtual string[] GetAutoCompletionList_SearchText(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            OEMConversion.Business.OpportunityRecord[] recordList  = OpportunityTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (OpportunityRecord rec in recordList ){
                ...
                resultItem = rec.Format(OpportunityTable.custcontactkey);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(OpportunityTable.custcontactkey.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, OpportunityTable.custcontactkey.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
      ...
      OpportunityRecord rec = new OpportunityRecord();
                        ...
                        if (recControl.custno.Text != "") {
                            rec.Parse(recControl.custno.Text, OpportunityTable.custno);
                  }
                
                        if (recControl.lead_source_id.Text != "") {
                            rec.Parse(recControl.lead_source_id.Text, OpportunityTable.lead_source_id);
                  }
                        ...
                        if (recControl.stage_id.Text != "") {
                            rec.Parse(recControl.stage_id.Text, OpportunityTable.stage_id);
                  }
        ...
        public virtual void Setstage_idLabel1()
                  {
        ...
        public virtual void Setstage_idFilter()
        {
            
            this.Populatestage_idFilter(MiscUtils.GetSelectedValue(this.stage_idFilter,  GetFromSession(this.stage_idFilter)), 500);					
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Custcontact Key {Txt:Ascending}"), "custcontactkey Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Custcontact Key {Txt:Descending}"), "custcontactkey Desc"));
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Lead Source {Txt:Ascending}"), "lead_source_id Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Lead Source {Txt:Descending}"), "lead_source_id Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Opportunity Amount {Txt:Ascending}"), "opportunity_amount Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Opportunity Amount {Txt:Descending}"), "opportunity_amount Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Opportunity Date {Txt:Ascending}"), "opportunity_date Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Opportunity Date {Txt:Descending}"), "opportunity_date Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Opportunity Name {Txt:Ascending}"), "opportunity_name Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Opportunity Name {Txt:Descending}"), "opportunity_name Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Opportunity Notes {Txt:Ascending}"), "opportunity_notes Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Opportunity Notes {Txt:Descending}"), "opportunity_notes Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Opportunity Owner {Txt:Ascending}"), "opportunity_owner Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Opportunity Owner {Txt:Descending}"), "opportunity_owner Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Stage {Txt:Ascending}"), "stage_id Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Stage {Txt:Descending}"), "stage_id Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Department {Txt:Ascending}"), "dept_id Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Department {Txt:Descending}"), "dept_id Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Attachment 3 {Txt:Ascending}"), "attachment_3 Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Attachment 3 {Txt:Descending}"), "attachment_3 Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Attachment 2 {Txt:Ascending}"), "attachment_2 Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Attachment 2 {Txt:Descending}"), "attachment_2 Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Attachment 1 {Txt:Ascending}"), "attachment_1 Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Attachment 1 {Txt:Descending}"), "attachment_1 Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Attachment 4 {Txt:Ascending}"), "attachment_4 Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Attachment 4 {Txt:Descending}"), "attachment_4 Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Attachment 2 Filename {Txt:Ascending}"), "attachment_2_filename Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Attachment 2 Filename {Txt:Descending}"), "attachment_2_filename Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Attachment 4 Filename {Txt:Ascending}"), "attachment_4_filename Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Attachment 4 Filename {Txt:Descending}"), "attachment_4_filename Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Attachment 1 Filename {Txt:Ascending}"), "attachment_1_filename Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Attachment 1 Filename {Txt:Descending}"), "attachment_1_filename Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Attachment 3 Filename {Txt:Ascending}"), "attachment_3_filename Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Attachment 3 Filename {Txt:Descending}"), "attachment_3_filename Desc"));
        ...
        // Get the filters' data for stage_idFilter.
                
        protected virtual void Populatestage_idFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.stage_idFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_stage_idFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_stage_idFilter function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.stage_idFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
                ...
                do
                {
                    ...
                    foreach (StageRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.stage_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.stage_idFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                fvalue = EvaluateFormula("= Stage.stage_name", itemValue , variables, evaluator);
                                ...
                                ListItem dupItem = this.stage_idFilter.Items.FindByText(fvalue);
                                ...
                                this.stage_idFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.stage_idFilter, selectedValue);
            ...
            if (this.stage_idFilter.SelectedValue != null && this.stage_idFilter.Items.FindByValue(this.stage_idFilter.SelectedValue) == null)
                this.stage_idFilter.SelectedValue = null;
                           
        }
            
        public virtual WhereClause CreateWhereClause_stage_idFilter()
        {
            // Create a where clause for the filter stage_idFilter.
            // This function is called by the Populate method to load the items 
            // in the stage_idFilterDropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.stage_idFilter, this.stage_idFilter.SelectedValue);
      ...
      this.SaveToSession("stage_idFilter_Ajax", this.stage_idFilter.SelectedValue);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.stage_idFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(stage_idFilter))
        ...
        public virtual void NewButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../opportunity/Add-Opportunity.aspx";
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void stage_idFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList stage_idFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "stage_idFilter");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal stage_idLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "stage_idLabel1");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual OpportunityTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (OpportunityTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Opportunity_Table.OpportunityTableControlRow")));
