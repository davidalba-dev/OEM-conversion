...
// Edit_FaultCodes_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_FaultCodes_Table
{
...
// Base class for the FaultCodesTableControlRow control on the Edit_FaultCodes_Table page.
...
public class BaseFaultCodesTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.FaultResolution.TextChanged += FaultResolution_TextChanged;
        ...
        public virtual void SetFaultCategory()
        {
            ...
            if (this.PreviousUIData.ContainsKey(this.FaultCategory.ID))
            {
            
                this.FaultCategory.Text = this.PreviousUIData[this.FaultCategory.ID].ToString();
        ...
        public virtual void SetFaultCode()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.FaultCode.ID))
            {
            
                this.FaultCode.Text = this.PreviousUIData[this.FaultCode.ID].ToString();
        ...
        public virtual void SetFaultDesc()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.FaultDesc.ID))
            {
            
                this.FaultDesc.Text = this.PreviousUIData[this.FaultDesc.ID].ToString();
        ...
        public virtual void SetFaultMake()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.FaultMake.ID))
            {
            
                this.FaultMake.Text = this.PreviousUIData[this.FaultMake.ID].ToString();
        ...
        public virtual void SetFaultResolution()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.FaultResolution.ID))
            {
            
                this.FaultResolution.Text = this.PreviousUIData[this.FaultResolution.ID].ToString();
        ...
        public virtual void SetLastExtraction()
        {
            ...
            if (this.DataSource != null && this.DataSource.LastExtractionSpecified) {
                ...
                // Default Value could also be NULL.
                if (!this.DataSource.IsCreated) 
                    this.LastExtraction.Checked = FaultCodesTable.LastExtraction.ParseValue(FaultCodesTable.LastExtraction.DefaultValue).ToBoolean();                
        ...
        public virtual void GetFaultResolution()
        {
            ...
            // Save the value to data source
            this.DataSource.Parse(this.FaultResolution.Text, FaultCodesTable.FaultResolution);							
        ...
        {	
            ...
            // save it into the LastExtraction field in DataSource DatabaseAYS_OEM%dbo.FaultCodes record.
            // Custom validation should be performed in Validate, not here.
      ...
      // To customize, override this method in FaultCodesTableControlRow.
        ...
        FaultCodesTableControl tc= ((FaultCodesTableControl)MiscUtils.GetParentControlObject(this, "FaultCodesTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((FaultCodesTableControlRow)this);
                    }
                    this.Visible = false;
        ...
        public virtual void EditRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../FaultCodes/Edit-FaultCodes.aspx?FaultCodes={PK}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../FaultCodes/Show-FaultCodes.aspx?FaultCodes={PK}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox FaultResolution {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "FaultResolution");
            }
        }
...
// Base class for the FaultCodesTableControl control on the Edit_FaultCodes_Table page.
           ...
           // Setup the filter and search.
            ...
            if (!this.Page.IsPostBack)
            {
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    string[] FaultCodeFilteritemListFromSession = initialVal.Split(',');
                    int index = 0;
                    foreach (string item in FaultCodeFilteritemListFromSession)
                    {
                        ...
                        {
                            this.FaultCodeFilter.Items.Add(item);
                            this.FaultCodeFilter.Items[index].Selected = true;
                            index += 1;
                        }
                    }
                    foreach (ListItem listItem in this.FaultCodeFilter.Items)
                    {
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.OrderSort.SelectedIndexChanged += new EventHandler(OrderSort_SelectedIndexChanged);
              ...
              this.FaultCodeFilter.SelectedIndexChanged += FaultCodeFilter_SelectedIndexChanged;                  
      ...
      public override void DataBind()
      {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.FaultCodeFilter)) {
                ...
                foreach (ListItem item in this.FaultCodeFilter.Items){
                    if (item.Selected) {
                        selectedItemCount += 1;
                ...
                foreach (ListItem item in this.FaultCodeFilter.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(FaultCodesTable.FaultCode, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
      ...
      String FaultCodeFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "FaultCodeFilter_Ajax"];
        ...
        if (FaultCodeFilterSelectedValue != null){
                        string[] FaultCodeFilteritemListFromSession = FaultCodeFilterSelectedValue.Split(',');
                        int index = 0;
                        WhereClause filter = new WhereClause();
                        foreach (string item in FaultCodeFilteritemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(FaultCodesTable.FaultCode, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
      ...
      FaultCodesRecord rec = new FaultCodesRecord();
        ...
        public virtual void SetFaultCodeFilter()
        {
            ...
            ArrayList FaultCodeFilterselectedFilterItemList = new ArrayList();
            string FaultCodeFilteritemsString = null;
            if (this.InSession(this.FaultCodeFilter))
                FaultCodeFilteritemsString = this.GetFromSession(this.FaultCodeFilter);
            
            if (FaultCodeFilteritemsString != null)
            {
                string[] FaultCodeFilteritemListFromSession = FaultCodeFilteritemsString.Split(',');
                foreach (string item in FaultCodeFilteritemListFromSession)
                {
                    FaultCodeFilterselectedFilterItemList.Add(item);
                }
            }
              
            			
            this.PopulateFaultCodeFilter(MiscUtils.GetSelectedValueList(this.FaultCodeFilter, FaultCodeFilterselectedFilterItemList), 500);
                    
              string url = this.ModifyRedirectUrl("../FaultCodes/FaultCodes-QuickSelector.aspx", "", true);
              
              url = this.Page.ModifyRedirectUrl(url, "", true);                                  
              
              url += "?Target=" + this.FaultCodeFilter.ClientID + "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("FaultCode")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--ANY--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:All")) + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.FaultCodeFilter.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(FaultCodeFilter.AutoPostBack).ToLower() + ", event); return false;";
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Fault Category {Txt:Ascending}"), "FaultCategory Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Fault Category {Txt:Descending}"), "FaultCategory Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Fault Code {Txt:Ascending}"), "FaultCode Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Fault Code {Txt:Descending}"), "FaultCode Desc"));
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Fault Make {Txt:Ascending}"), "FaultMake Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Fault Make {Txt:Descending}"), "FaultMake Desc"));
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Fault Active {Txt:Ascending}"), "fault_active Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Fault Active {Txt:Descending}"), "fault_active Desc"));
        ...
        protected virtual void PopulateFaultCodeFilter(ArrayList selectedValue, int maxItems)
                    
        {
            ...
            this.FaultCodeFilter.SetFieldMaxLength(50);
                                 
                  
            // Add the selected value.
            if (this.FaultCodeFilter.Items.Count == 0)
                this.FaultCodeFilter.Items.Add(new ListItem(Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
        ...
        public virtual WhereClause CreateWhereClause_FaultCodeFilter()
        {
            ...
            // in the FaultCodeFilterQuickSelector
            ...
            FaultCodeFilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.FaultCodeFilter, FaultCodeFilterselectedFilterItemList); 
            WhereClause wc = new WhereClause();
            if (FaultCodeFilterselectedFilterItemList == null || FaultCodeFilterselectedFilterItemList.Count == 0)
                wc.RunQuery = false;
            else            
            {
                foreach (string item in FaultCodeFilterselectedFilterItemList)
                {
            
      
   
                    wc.iOR(FaultCodesTable.FaultCode, BaseFilter.ComparisonOperator.EqualsTo, item);
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("FaultCodesTableControlRepeater");
        ...
        protected override void SaveControlsToSession()
        {
            ...
            ArrayList FaultCodeFilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.FaultCodeFilter, null);
            string FaultCodeFilterSessionString = "";
            if (FaultCodeFilterselectedFilterItemList != null){
                foreach (string item in FaultCodeFilterselectedFilterItemList){
                    FaultCodeFilterSessionString = String.Concat(FaultCodeFilterSessionString ,"," , item);
                }
            }
            this.SaveToSession(this.FaultCodeFilter, FaultCodeFilterSessionString);
        ...
        protected  void SaveControlsToSession_Ajax()
        {
            ...
            this.SaveToSession("FaultCodeFilter_Ajax", FaultCodeFilterSessionString);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(FaultCodeFilter))
        ...
        protected virtual void OrderSort_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in FaultCodesTable.GetColumns())
                  {
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(FaultCodesTable.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (FaultCodesTable.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && FaultCodesTable.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(FaultCodesTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(FaultCodesTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
...
#region "Helper Properties"
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector FaultCodeFilter {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "FaultCodeFilter");
            }
        }              
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (FaultCodesTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        FaultCodesTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual FaultCodesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (FaultCodesTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_FaultCodes_Table.FaultCodesTableControlRow")));
