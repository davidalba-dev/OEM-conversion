...
// Edit_FaultCodes.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_FaultCodes
{
...
// Base class for the FaultCodesRecordControl control on the Edit_FaultCodes page.
...
public class BaseFaultCodesRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in FaultCodesRecordControl.
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            if (EvaluateFormula("URL(\"FaultKey\")", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.FaultCodesTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"FaultCodes_.FaultKey"), EvaluateFormula("URL(\"FaultKey\")", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("URL(\"FaultKey\")", false) == "--PLEASE_SELECT--" || EvaluateFormula("URL(\"FaultKey\")", false) == "--ANY--") whereClause.RunQuery = false;
