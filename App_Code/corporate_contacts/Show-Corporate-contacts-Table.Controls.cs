...
// Show_Corporate_contacts_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Corporate_contacts_Table
{
...
// Base class for the Corporate_contactsTableControlRow control on the Show_Corporate_contacts_Table page.
...
public class BaseCorporate_contactsTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setcorporate_id()
        {
            ...
            if (this.DataSource != null && this.DataSource.corporate_idSpecified) {
               ...
               Boolean _isExpandableNonCompositeForeignKey = Corporate_contactsTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Corporate_contactsTable.corporate_id);
               if(_isExpandableNonCompositeForeignKey &&Corporate_contactsTable.corporate_id.IsApplyDisplayAs)
                                  
                     formattedValue = Corporate_contactsTable.GetDFKA(this.DataSource.corporate_id.ToString(),Corporate_contactsTable.corporate_id, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(Corporate_contactsTable.corporate_id);
              ...
              this.corporate_id.Text = Corporate_contactsTable.corporate_id.Format(Corporate_contactsTable.corporate_id.DefaultValue);
        ...
        public virtual void Setcorporatecontact_email()
        {
            ...
            // Set the corporatecontact_email Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.corporate_contacts database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.corporate_contacts record retrieved from the database.
            // this.corporatecontact_email is the ASP:Literal on the webpage.
            ...
            // If the corporatecontact_email is NULL or blank, then use the value specified  
            // on Properties.
            if (this.corporatecontact_email.Text == null ||
                this.corporatecontact_email.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.corporatecontact_email.Text = "&nbsp;";
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal corporatecontact_email {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "corporatecontact_email");
            }
        }
...
// Base class for the Corporate_contactsTableControl control on the Show_Corporate_contacts_Table page.
...
public class BaseCorporate_contactsTableControl : OEMConversion.UI.BaseApplicationTableControl
{
       ...
       public BaseCorporate_contactsTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.corporatecontact_activeFilter)) 				
                    initialVal = this.GetFromSession(this.corporatecontact_activeFilter);
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.corporatecontact_activeFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.corporatecontact_activeFilter.SelectedValue = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
              ...
              this.corporate_idLabel.Click += corporate_idLabel_Click;
            
              this.corporatecontact_activeLabel.Click += corporatecontact_activeLabel_Click;
            
              this.corporatecontact_emailLabel.Click += corporatecontact_emailLabel_Click;
            
              this.corporatecontact_firstLabel.Click += corporatecontact_firstLabel_Click;
            
              this.corporatecontact_phoneLabel.Click += corporatecontact_phoneLabel_Click;
            
              this.corporatecontact_titleLabel.Click += corporatecontact_titleLabel_Click;
            ...
            this.corporatecontact_activeFilter.SelectedIndexChanged += new EventHandler(corporatecontact_activeFilter_SelectedIndexChanged);
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                Setcorporatecontact_activeFilter();
                Setcorporatecontact_activeLabel();
                Setcorporatecontact_activeLabel1();
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(Corporate_contactsTable.corporate_id, this.DataSource);
        }
        ...
        public virtual void ResetControl()
        {
            ...
            this.corporatecontact_activeFilter.ClearSelection();
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.corporate_idFilter)) {
                ...
                wc.iAND(Corporate_contactsTable.corporate_id, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.corporate_idFilter, this.GetFromSession(this.corporate_idFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.corporatecontact_activeFilter)) {
                        
                wc.iAND(Corporate_contactsTable.corporatecontact_active, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.corporatecontact_activeFilter, this.GetFromSession(this.corporatecontact_activeFilter)), false, false);
      ...
      cols.Add(Corporate_contactsTable.corporatecontact_last, true);
      ...
      String corporate_idFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "corporate_idFilter_Ajax"];
            if (MiscUtils.IsValueSelected(corporate_idFilterSelectedValue)) {
                ...
                wc.iAND(Corporate_contactsTable.corporate_id, BaseFilter.ComparisonOperator.EqualsTo, corporate_idFilterSelectedValue, false, false);
                      
      }
                      
      String corporatecontact_activeFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "corporatecontact_activeFilter_Ajax"];
            if (MiscUtils.IsValueSelected(corporatecontact_activeFilterSelectedValue)) {

              
                wc.iAND(Corporate_contactsTable.corporatecontact_active, BaseFilter.ComparisonOperator.EqualsTo, corporatecontact_activeFilterSelectedValue, false, false);
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_SearchText(String prefixText,int count)
        {
            ...
            foreach (Corporate_contactsRecord rec in recordList ){
                ...
                resultItem = rec.Format(Corporate_contactsTable.corporatecontact_last);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(Corporate_contactsTable.corporatecontact_last.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, Corporate_contactsTable.corporatecontact_last.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
      ...
      Corporate_contactsRecord rec = new Corporate_contactsRecord();
                        ...
                        if (recControl.corporate_id.Text != "") {
                            rec.Parse(recControl.corporate_id.Text, Corporate_contactsTable.corporate_id);
                  }
                        ...
                        if (recControl.corporatecontact_email.Text != "") {
                            rec.Parse(recControl.corporatecontact_email.Text, Corporate_contactsTable.corporatecontact_email);
                  }
        ...
        public virtual void Setcorporatecontact_activeLabel1()
                  {
                  
                        this.corporatecontact_activeLabel1.Text = EvaluateFormula("\"Active\"");
        ...
        public virtual void Setcorporatecontact_emailLabel()
                  {
                        ...
                        this.corporatecontact_emailLabel.Text = EvaluateFormula("\"Email\"");
        ...
        public virtual void Setcorporatecontact_firstLabel()
                  {
                      ...
                      //this.corporatecontact_firstLabel.Text = "Some value";
        ...
        public virtual void Setcorporatecontact_activeFilter()
        {
            
            this.Populatecorporatecontact_activeFilter(MiscUtils.GetSelectedValue(this.corporatecontact_activeFilter,  GetFromSession(this.corporatecontact_activeFilter)), 500);					
                    ...
                    foreach (CorporateRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.corporate_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.corporate_idFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                fvalue = EvaluateFormula("= Corporate.corporate_name", itemValue , variables, evaluator);
        ...
        // Get the filters' data for corporatecontact_activeFilter.
                
        protected virtual void Populatecorporatecontact_activeFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.corporatecontact_activeFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_corporatecontact_activeFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_corporatecontact_activeFilter function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.corporatecontact_activeFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
            ...
            if ( Corporate_contactsTable.corporatecontact_active.IsColumnValueTypeBoolean()) {
                ...
                ListItem dupItem = this.corporatecontact_activeFilter.Items.FindByText(fvalue);
                ...
                ListItem newItem = new ListItem(fvalue, cvalue);
                this.corporatecontact_activeFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.corporatecontact_activeFilter, selectedValue);
            ...
            if (this.corporatecontact_activeFilter.SelectedValue != null && this.corporatecontact_activeFilter.Items.FindByValue(this.corporatecontact_activeFilter.SelectedValue) == null)
                this.corporatecontact_activeFilter.SelectedValue = null;
        ...
        public virtual WhereClause CreateWhereClause_corporatecontact_activeFilter()
        {
            // Create a where clause for the filter corporatecontact_activeFilter.
            // This function is called by the Populate method to load the items 
            // in the corporatecontact_activeFilterDropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.corporatecontact_activeFilter, this.corporatecontact_activeFilter.SelectedValue);
      ...
      this.SaveToSession("corporatecontact_activeFilter_Ajax", this.corporatecontact_activeFilter.SelectedValue);
      ...
      this.SaveToSession("SearchText_Ajax", this.SearchText.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.corporatecontact_activeFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                    string url = "../corporate_contacts/Add-Corporate-contacts.aspx?TabVisible=False&SaveAndNewVisible=False";
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "Corporate_contactsTableControl_PostbackTracker").ClientID);                           
                                
                string javascriptCall = "";
                
                    javascriptCall = "initializePopupPage(document.getElementById('" + MiscUtils.FindControlRecursively(this, "Corporate_contactsTableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(corporatecontact_activeFilter))
                themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        ...
        public virtual void corporate_idLabel_Click(object sender, EventArgs args)
        {
            //Sorts by corporate_id when clicked.
              
            // Get previous sorting state for corporate_id.
        
            OrderByItem sd = this.CurrentSortOrder.Find(Corporate_contactsTable.corporate_id);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(Corporate_contactsTable.corporate_id, OrderByItem.OrderDir.Asc);
        ...
        public virtual void corporatecontact_emailLabel_Click(object sender, EventArgs args)
        {
            //Sorts by corporatecontact_email when clicked.
              
            // Get previous sorting state for corporatecontact_email.
        
            OrderByItem sd = this.CurrentSortOrder.Find(Corporate_contactsTable.corporatecontact_email);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for corporatecontact_email.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(Corporate_contactsTable.corporatecontact_email, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by corporatecontact_email, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void corporatecontact_phoneLabel_Click(object sender, EventArgs args)
        {
            //Sorts by corporatecontact_phone when clicked.
              
            // Get previous sorting state for corporatecontact_phone.
        
            OrderByItem sd = this.CurrentSortOrder.Find(Corporate_contactsTable.corporatecontact_phone);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for corporatecontact_phone.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(Corporate_contactsTable.corporatecontact_phone, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by corporatecontact_phone, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void corporatecontact_titleLabel_Click(object sender, EventArgs args)
        {
            //Sorts by corporatecontact_title when clicked.
              
            // Get previous sorting state for corporatecontact_title.
        
            OrderByItem sd = this.CurrentSortOrder.Find(Corporate_contactsTable.corporatecontact_title);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for corporatecontact_title.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(Corporate_contactsTable.corporatecontact_title, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by corporatecontact_title, so just reverse.
                sd.Reverse();
            }
        ...
        // event handler for FieldFilter
        protected virtual void corporatecontact_activeFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton corporate_idLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "corporate_idLabel");
            }
        }
        ...
        public System.Web.UI.WebControls.DropDownList corporatecontact_activeFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "corporatecontact_activeFilter");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal corporatecontact_activeLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "corporatecontact_activeLabel1");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton corporatecontact_emailLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "corporatecontact_emailLabel");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton corporatecontact_phoneLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "corporatecontact_phoneLabel");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton corporatecontact_titleLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "corporatecontact_titleLabel");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual Corporate_contactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Corporate_contactsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Corporate_contacts_Table.Corporate_contactsTableControlRow")));
