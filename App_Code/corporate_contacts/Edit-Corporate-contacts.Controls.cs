...
// Edit_Corporate_contacts.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Corporate_contacts
{
...
// Base class for the LoginTableControlRow control on the Edit_Corporate_contacts page.
...
// Base class for the LoginTableControl control on the Edit_Corporate_contacts page.
...
public class BaseLoginTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Edit_Corporate_contacts.Corporate_contactsRecordControl corporate_contactsRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "Corporate_contactsRecordControl") as OEMConversion.UI.Controls.Edit_Corporate_contacts.Corporate_contactsRecordControl);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void NewButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../login/Add-Login-CorporateContact.aspx?corporatecontact={Corporate_contactsRecordControl:PK}&corporateid={Corporate_contactsRecordControl:FV:corporate_id}";
...
#region "Helper Functions"
        ...
        public virtual LoginTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (LoginTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_Corporate_contacts.LoginTableControlRow")));
...
// Base class for the Corporate_contactsRecordControl control on the Edit_Corporate_contacts page.
...
public class BaseCorporate_contactsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in Corporate_contactsRecordControl.
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            if (EvaluateFormula("URL(\"Corporate_Contacts\")", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Corporate_contactsTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"corporate_contacts_.CorporateContact_Id"), EvaluateFormula("URL(\"Corporate_Contacts\")", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("URL(\"Corporate_Contacts\")", false) == "--PLEASE_SELECT--" || EvaluateFormula("URL(\"Corporate_Contacts\")", false) == "--ANY--") whereClause.RunQuery = false;
