...
// Add_Pickup_request_comment.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Pickup_request_comment
{
...
// Base class for the Pickup_request_commentRecordControl control on the Add_Pickup_request_comment page.
...
public class BasePickup_request_commentRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.pickup_request_id.TextChanged += pickup_request_id_TextChanged;
            
              this.pickup_request_private.TextChanged += pickup_request_private_TextChanged;
        ...
        public virtual void Setpickup_request_id()
        {
            ...
            // Set the pickup_request_id TextBox on the webpage with value from the
            // DatabaseAYS_OEM%dbo.pickup_request_comment database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.pickup_request_comment record retrieved from the database.
            // this.pickup_request_id is the ASP:TextBox on the webpage.
                  
            if (this.DataSource != null && this.DataSource.IsCreated) {
                								
                // If the pickup_request_id is non-NULL, then format the value.
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = this.DataSource.pickup_request_id.ToString();
              ...
              this.pickup_request_id.Text = EvaluateFormula("URL(\"pickup_request_id\")", this.DataSource);
        ...
        public virtual void Setpickup_request_private()
        {
            ...
            // Set the pickup_request_private TextBox on the webpage with value from the
            // DatabaseAYS_OEM%dbo.pickup_request_comment database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.pickup_request_comment record retrieved from the database.
            // this.pickup_request_private is the ASP:TextBox on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
              ...
              this.pickup_request_private.Text = EvaluateFormula("URL(\"private\")", this.DataSource);
        ...
        public virtual void Getpickup_request_id()
        {
            ...
            // Retrieve the value entered by the user on the pickup_request_id ASP:TextBox, and
            // save it into the pickup_request_id field in DataSource DatabaseAYS_OEM%dbo.pickup_request_comment record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.pickup_request_id.Text, Pickup_request_commentTable.pickup_request_id);							
        ...
        public virtual void Getpickup_request_private()
        {
            ...
            // Retrieve the value entered by the user on the pickup_request_private ASP:TextBox, and
            // save it into the pickup_request_private field in DataSource DatabaseAYS_OEM%dbo.pickup_request_comment record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.pickup_request_private.Text, Pickup_request_commentTable.pickup_request_private);							
      ...
      // To customize, override this method in Pickup_request_commentRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Pickup_request_comment"];
            ...
            HttpContext.Current.Session["QueryString in Add-Pickup-request-comment"] = recId;
        ...
        protected virtual void pickup_request_id_TextChanged(object sender, EventArgs args)
        {
                    
              }
            
        protected virtual void pickup_request_private_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox pickup_request_id {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "pickup_request_id");
            }
        }
            
        public System.Web.UI.WebControls.TextBox pickup_request_private {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "pickup_request_private");
            }
        }
