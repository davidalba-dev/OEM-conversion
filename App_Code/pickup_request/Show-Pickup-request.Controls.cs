...
// Show_Pickup_request.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Pickup_request
{
...
// Base class for the Pickup_request_commentTableControlRow control on the Show_Pickup_request page.
...
public class BasePickup_request_commentTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setpickup_request_private()
        {
            ...
            // Set the pickup_request_private Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.pickup_request_comment database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.pickup_request_comment record retrieved from the database.
            // this.pickup_request_private is the ASP:Literal on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.pickup_request_privateSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(Pickup_request_commentTable.pickup_request_private);
                                
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                this.pickup_request_private.Text = formattedValue;
              ...
              this.pickup_request_private.Text = Pickup_request_commentTable.pickup_request_private.Format(Pickup_request_commentTable.pickup_request_private.DefaultValue);
            		
            }
            
            // If the pickup_request_private is NULL or blank, then use the value specified  
            // on Properties.
            if (this.pickup_request_private.Text == null ||
                this.pickup_request_private.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.pickup_request_private.Text = "&nbsp;";
            }
      ...
      this.Page.CommitTransaction(sender);
        ...
        public virtual void EditRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../pickup_request_comment/Edit-Pickup-request-comment.aspx?Pickup_request_comment={PK}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal pickup_request_private {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "pickup_request_private");
            }
        }
...
// Base class for the Pickup_request_commentTableControl control on the Show_Pickup_request page.
...
public class BasePickup_request_commentTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Show_Pickup_request.Pickup_requestRecordControl pickup_requestRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "Pickup_requestRecordControl") as OEMConversion.UI.Controls.Show_Pickup_request.Pickup_requestRecordControl);
      ...
      Pickup_request_commentRecord rec = new Pickup_request_commentRecord();
                        ...
                        if (recControl.pickup_request_private.Text != "") {
                            rec.Parse(recControl.pickup_request_private.Text, Pickup_request_commentTable.pickup_request_private);
                  }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
                    ...
                    this.ImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=Pickup_request_comment" ;
              ...
              
        {
              ...
              try
              {
                    string url = "../pickup_request_comment/Add-Pickup-request-comment.aspx?pickup_request_id={Pickup_requestRecordControl:FV:pickup_request_id}&TabVisible=False&SaveAndNewVisible=False";
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
             ...
             Pickup_request_commentTable.pickup_request_private,
             ...
             data.ColumnList.Add(new ExcelColumn(Pickup_request_commentTable.pickup_request_private, "Default"));
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Pickup-request.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "pickup_request_comment";
                // If Show-Pickup-request.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 ...
                 report.AddColumn(Pickup_request_commentTable.pickup_request_private.Name, ReportEnum.Align.Left, "${pickup_request_private}", ReportEnum.Align.Left, 15);
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             report.AddData("${pickup_request_private}", record.Format(Pickup_request_commentTable.pickup_request_private), ReportEnum.Align.Left, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Pickup-request.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "pickup_request_comment";
                // If Show-Pickup-request.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual Pickup_request_commentTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Pickup_request_commentTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Pickup_request.Pickup_request_commentTableControlRow")));
...
// Base class for the Pickup_requestRecordControl control on the Show_Pickup_request page.
...
public class BasePickup_requestRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in Pickup_requestRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-Pickup-request"] = recId;
