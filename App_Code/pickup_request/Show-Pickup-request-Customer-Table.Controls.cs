...
// Show_Pickup_request_Customer_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Pickup_request_Customer_Table
{
...
// Base class for the Pickup_requestTableControlRow control on the Show_Pickup_request_Customer_Table page.
...
public class BasePickup_requestTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in Pickup_requestTableControlRow.
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../pickup_request/Show-Pickup-request.aspx?Pickup_request={PK}";
...
// Base class for the Pickup_requestTableControl control on the Show_Pickup_request_Customer_Table page.
...
public class BasePickup_requestTableControl : OEMConversion.UI.BaseApplicationTableControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            else
            {
                ...
                this.CurrentSortOrder.Add(Pickup_requestTable.created_datetime, OrderByItem.OrderDir.Desc);
    ...
    public virtual void AddWarningMessageOnClick() {
      ...
      cols.Add(Pickup_requestTable.provname, true);
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            filter.AddFilter(new BaseClasses.Data.ColumnJoinFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Pickup_requestTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"pickup_request_.pickup_custno"), new BaseClasses.Data.IdentifierAliasInfo(@"pickup_request_", null), BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.CustomerContactsTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"CustomerContacts_.CustNo"), new BaseClasses.Data.IdentifierAliasInfo(@"CustomerContacts_", null),  BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
        ...
        public virtual string[] GetAutoCompletionList_SearchText(String prefixText,int count)
        {
            ...
            foreach (Pickup_requestRecord rec in recordList ){
                ...
                resultItem = rec.Format(Pickup_requestTable.provname);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(Pickup_requestTable.provname.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, Pickup_requestTable.provname.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Pickup-request-Customer-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "pickup_request";
                // If Show-Pickup-request-Customer-Table.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Pickup-request-Customer-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "pickup_request";
                // If Show-Pickup-request-Customer-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual Pickup_requestTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Pickup_requestTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Pickup_request_Customer_Table.Pickup_requestTableControlRow")));
