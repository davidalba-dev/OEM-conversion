...
// Edit_Vw_ticket_details_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Vw_ticket_details_Mobile
{
...
public class Vw_ticket_detailsRecordControl : BaseVw_ticket_detailsRecordControl
{
      
        // The BaseVw_ticket_detailsRecordControl implements the LoadData, DataBind and other
...
// Base class for the Vw_ticket_detailsRecordControl control on the Edit_Vw_ticket_details_Mobile page.
// Do not modify this class. Instead override any method in Vw_ticket_detailsRecordControl.
public class BaseVw_ticket_detailsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseVw_ticket_detailsRecordControl()
        {
        ...
        // To customize, override this method in Vw_ticket_detailsRecordControl.
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "Vw_ticket_detailsRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            Vw_ticket_detailsRecord[] recList = Vw_ticket_detailsView.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = Vw_ticket_detailsView.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public virtual void Setresource_sch_ticket_id()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = Vw_ticket_detailsView.resource_sch_ticket_id.DefaultValue;
        ...
        public virtual void Getresource_sch_ticket_id()
        {
         // Retrieve the value entered by the user on the resource_sch_ticket_id ASP:DropDownList, and
            // save it into the resource_sch_ticket_id field in DataSource DatabaseAYS_OEM%dbo.vw_ticket_details record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.resource_sch_ticket_id), Vw_ticket_detailsView.resource_sch_ticket_id);			
        ...
        public virtual void Getsubject()
        {
            ...
            // save it into the subject field in DataSource DatabaseAYS_OEM%dbo.vw_ticket_details record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.subject.Text, Vw_ticket_detailsView.subject);							
      ...
      // To customize, override this method in Vw_ticket_detailsRecordControl.
         ...
         
        {
            ...
            bool hasFiltersVw_ticket_detailsRecordControl = false;
            hasFiltersVw_ticket_detailsRecordControl = hasFiltersVw_ticket_detailsRecordControl && false; // suppress warning
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Vw_ticket_details"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "Vw_ticket_details"));
            }
            HttpContext.Current.Session["QueryString in Edit-Vw-ticket-details-Mobile"] = recId;
          ...
          wc.iAND(Vw_ticket_detailsView.resource_sch_ticket_id, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(Vw_ticket_detailsView.resource_sch_ticket_id));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(Vw_ticket_detailsView.resource_sch_ticket_id, BaseFilter.ComparisonOperator.EqualsTo, recId);
      ...
      this.Page.RedirectBack();
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseVw_ticket_detailsRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseVw_ticket_detailsRecordControl_Rec"] = value;
            }
        }
