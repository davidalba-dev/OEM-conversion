...
// Show_My_Vw_ticket_details_Table_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_My_Vw_ticket_details_Table_Mobile
{
...
// Base class for the Vw_ticket_detailsTableControlRow control on the Show_My_Vw_ticket_details_Table_Mobile page.
...
// Base class for the Vw_ticket_detailsTableControl control on the Show_My_Vw_ticket_details_Table_Mobile page.
...
#region "Helper Functions"
        ...
        public virtual Vw_ticket_detailsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Vw_ticket_detailsTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Show_My_Vw_ticket_details_Table_Mobile.Vw_ticket_detailsTableControlRow")));
