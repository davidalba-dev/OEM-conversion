...
// Show_Equipment_import_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Equipment_import_Table
{
...
//public class Equipment_importTableControl1 : BaseEquipment_importTableControl1
//{
//    // The BaseEquipment_importTableControl1 class implements the LoadData, DataBind, CreateWhereClause
//    // and other methods to load and display the data in a table control.
//
//    // This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
//    // The Equipment_importTableControl1Row class offers another place where you can customize
//    // the DataBind, GetUIData, SaveData and Validate methods specific to each row displayed on the table.
//    
//}
//
//public class Equipment_importTableControl1Row : BaseEquipment_importTableControl1Row
//{
//      
//        // The BaseEquipment_importTableControl1Row implements code for a ROW within the
//        // the Equipment_importTableControl1 table.  The BaseEquipment_importTableControl1Row implements the DataBind and SaveData methods.
//        // The loading of data is actually performed by the LoadData method in the base class of Equipment_importTableControl1.
//
//        // This is the ideal place to add your code customizations. For example, you can override the DataBind, 
//        // SaveData, GetUIData, and Validate methods.
//        
...
// Base class for the Equipment_importTableControlRow control on the Show_Equipment_import_Table page.
...
public class BaseEquipment_importTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setaddress_state()
        {
            ...
            // Set the address_state Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.equipment_import database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.equipment_import record retrieved from the database.
            // this.address_state is the ASP:Literal on the webpage.
            ...
            // If the address_state is NULL or blank, then use the value specified  
            // on Properties.
            if (this.address_state.Text == null ||
                this.address_state.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.address_state.Text = "&nbsp;";
            }
        ...
        public virtual void Setcontact_first()
        {
            ...
            // Set the contact_first Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.equipment_import database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.equipment_import record retrieved from the database.
            // this.contact_first is the ASP:Literal on the webpage.
            ...
            // If the contact_first is NULL or blank, then use the value specified  
            // on Properties.
            if (this.contact_first.Text == null ||
                this.contact_first.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.contact_first.Text = "&nbsp;";
            }
        ...
        public virtual void Setcontact_last()
        {
            ...
            // Set the contact_last Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.equipment_import database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.equipment_import record retrieved from the database.
            // this.contact_last is the ASP:Literal on the webpage.
            ...
            // If the contact_last is NULL or blank, then use the value specified  
            // on Properties.
            if (this.contact_last.Text == null ||
                this.contact_last.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.contact_last.Text = "&nbsp;";
            }
        ...
        public virtual void Setpm_purchase_order()
        {
            ...
            // Set the pm_purchase_order Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.equipment_import database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.equipment_import record retrieved from the database.
            // this.pm_purchase_order is the ASP:Literal on the webpage.
            ...
            // If the pm_purchase_order is NULL or blank, then use the value specified  
            // on Properties.
            if (this.pm_purchase_order.Text == null ||
                this.pm_purchase_order.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.pm_purchase_order.Text = "&nbsp;";
            }
        ...
        public virtual void Setpo_date()
        {
            ...
            // Set the po_date Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.equipment_import database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.equipment_import record retrieved from the database.
            // this.po_date is the ASP:Literal on the webpage.
            ...
            // If the po_date is NULL or blank, then use the value specified  
            // on Properties.
            if (this.po_date.Text == null ||
                this.po_date.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.po_date.Text = "&nbsp;";
            }
        ...
        public virtual void Setzipcode()
        {
            ...
            // Set the zipcode Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.equipment_import database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.equipment_import record retrieved from the database.
            // this.zipcode is the ASP:Literal on the webpage.
            ...
            // If the zipcode is NULL or blank, then use the value specified  
            // on Properties.
            if (this.zipcode.Text == null ||
                this.zipcode.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.zipcode.Text = "&nbsp;";
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal address_state {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "address_state");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal contact_first {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "contact_first");
            }
        }
            
        public System.Web.UI.WebControls.Literal contact_last {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "contact_last");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal pm_purchase_order {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "pm_purchase_order");
            }
        }
            
        public System.Web.UI.WebControls.Literal po_date {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "po_date");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal zipcode {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "zipcode");
            }
        }
...
// Base class for the Equipment_importTableControl control on the Show_Equipment_import_Table page.
...
public class BaseEquipment_importTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    public virtual void AddWarningMessageOnClick() {
      ...
      String asset_tagFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "asset_tagFilter_Ajax"];
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Equipment_importTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"equipment_import_.equip_import_batch_id"), EvaluateFormula("URL(\"equip_import_batch_id\")", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
        ...
        public virtual void Setcontact_firstLabel()
                  {
                      ...
                      //this.contact_firstLabel.Text = "Some value";
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
                    ...
                    this.ImportButton1.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=Equipment_import" ;
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
             ...
             Equipment_importTable.pm_purchase_order,
             Equipment_importTable.po_date,
             Equipment_importTable.address,
             Equipment_importTable.city,
             Equipment_importTable.address_state,
             Equipment_importTable.zipcode,
             Equipment_importTable.contact_first,
             Equipment_importTable.contact_last,
             null};
             ...
             data.ColumnList.Add(new ExcelColumn(Equipment_importTable.pm_purchase_order, "Default"));
             data.ColumnList.Add(new ExcelColumn(Equipment_importTable.po_date, "Short Date"));
             data.ColumnList.Add(new ExcelColumn(Equipment_importTable.address, "Default"));
             data.ColumnList.Add(new ExcelColumn(Equipment_importTable.city, "Default"));
             data.ColumnList.Add(new ExcelColumn(Equipment_importTable.address_state, "Default"));
             data.ColumnList.Add(new ExcelColumn(Equipment_importTable.zipcode, "Default"));
             data.ColumnList.Add(new ExcelColumn(Equipment_importTable.contact_first, "Default"));
             data.ColumnList.Add(new ExcelColumn(Equipment_importTable.contact_last, "Default"));
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Equipment-import-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "equipment_import";
                // If Show-Equipment-import-Table.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 ...
                 report.AddColumn(Equipment_importTable.pm_purchase_order.Name, ReportEnum.Align.Left, "${pm_purchase_order}", ReportEnum.Align.Left, 15);
                 report.AddColumn(Equipment_importTable.po_date.Name, ReportEnum.Align.Left, "${po_date}", ReportEnum.Align.Left, 20);
                 report.AddColumn(Equipment_importTable.address.Name, ReportEnum.Align.Left, "${address}", ReportEnum.Align.Left, 28);
                 report.AddColumn(Equipment_importTable.city.Name, ReportEnum.Align.Left, "${city}", ReportEnum.Align.Left, 28);
                 report.AddColumn(Equipment_importTable.address_state.Name, ReportEnum.Align.Left, "${address_state}", ReportEnum.Align.Left, 28);
                 report.AddColumn(Equipment_importTable.zipcode.Name, ReportEnum.Align.Left, "${zipcode}", ReportEnum.Align.Left, 15);
                 report.AddColumn(Equipment_importTable.contact_first.Name, ReportEnum.Align.Left, "${contact_first}", ReportEnum.Align.Left, 20);
                 report.AddColumn(Equipment_importTable.contact_last.Name, ReportEnum.Align.Left, "${contact_last}", ReportEnum.Align.Left, 28);
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             report.AddData("${pm_purchase_order}", record.Format(Equipment_importTable.pm_purchase_order), ReportEnum.Align.Left, 300);
                             report.AddData("${po_date}", record.Format(Equipment_importTable.po_date), ReportEnum.Align.Left, 300);
                             report.AddData("${address}", record.Format(Equipment_importTable.address), ReportEnum.Align.Left, 300);
                             report.AddData("${city}", record.Format(Equipment_importTable.city), ReportEnum.Align.Left, 300);
                             report.AddData("${address_state}", record.Format(Equipment_importTable.address_state), ReportEnum.Align.Left, 300);
                             report.AddData("${zipcode}", record.Format(Equipment_importTable.zipcode), ReportEnum.Align.Left, 300);
                             report.AddData("${contact_first}", record.Format(Equipment_importTable.contact_first), ReportEnum.Align.Left, 300);
                             report.AddData("${contact_last}", record.Format(Equipment_importTable.contact_last), ReportEnum.Align.Left, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Equipment-import-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "equipment_import";
                // If Show-Equipment-import-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual Equipment_importTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Equipment_importTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Equipment_import_Table.Equipment_importTableControlRow")));
