...
// Action_Equipment_import_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Action_Equipment_import_Table
{
...
// Base class for the Equipment_importTableControlRow control on the Action_Equipment_import_Table page.
...
// Base class for the Equipment_importTableControl control on the Action_Equipment_import_Table page.
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Action-Equipment-import-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "equipment_import";
                // If Action-Equipment-import-Table.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Action-Equipment-import-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "equipment_import";
                // If Action-Equipment-import-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual Equipment_importTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Equipment_importTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Action_Equipment_import_Table.Equipment_importTableControlRow")));
...
// Base class for the Equipment_import_batchRecordControl control on the Action_Equipment_import_Table page.
...
public class BaseEquipment_import_batchRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.technician.SelectedIndexChanged += technician_SelectedIndexChanged;
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (Equipment_import_batchRecord)Equipment_import_batchRecord.Copy(recList[0], false);
        ...
        public virtual void Setbatch_date_created()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
              ...
              this.batch_date_created.Text = EvaluateFormula("Today()", this.DataSource, @"d");
        ...
        public virtual void Setcustno1()
        {
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.equipment_import_batch record retrieved from the database.
            // this.custno1 is the ASP:QuickSelector on the webpage.
            ...
            if (selectedValue == null || selectedValue == "")
                  MiscUtils.ResetSelectedItem(this.custno1, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "OEMConversion"), "--PLEASE_SELECT--"));
                        
                  
            // Populate the item(s) to the control
            
            this.custno1.SetFieldMaxLength(50);
        ...
        public virtual void Settechnician()
        {
            ...
            // Set the technician DropDownList on the webpage with value from the
            // DatabaseAYS_OEM%dbo.equipment_import_batch database record.
            
            // this.DataSource is the DatabaseAYS_OEM%dbo.equipment_import_batch record retrieved from the database.
            // this.technician is the ASP:DropDownList on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.IsCreated)
            {
                ...
                selectedValue = this.DataSource.technician.ToString();
            ...
            else
            {
                ...
                selectedValue = EvaluateFormula("URL(\"technician\")");
            ...
            this.PopulatetechnicianDropDownList(selectedValue, 100);              
        ...
        public virtual void Getcustno1()
        {
         // Retrieve the value entered by the user on the custno ASP:QuickSelector, and
            ...
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.custno1), Equipment_import_batchTable.custno);			
                			 
        }
                
        public virtual void Gettechnician()
        {
         // Retrieve the value entered by the user on the technician ASP:DropDownList, and
            // save it into the technician field in DataSource DatabaseAYS_OEM%dbo.equipment_import_batch record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.technician), Equipment_import_batchTable.technician);			
      ...
      // To customize, override this method in Equipment_import_batchRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Equipment_import_batch"];
            ...
            HttpContext.Current.Session["QueryString in Action-Equipment-import-Table"] = recId;
          ...
          wc.iAND(Equipment_import_batchTable.equip_import_batch_id, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(Equipment_import_batchTable.equip_import_batch_id));
             
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(Equipment_import_batchTable.equip_import_batch_id, BaseFilter.ComparisonOperator.EqualsTo, recId);
        ...
        public virtual WhereClause CreateWhereClause_technicianDropDownList() 
        {
        ...
        // Fill the technician list.
        protected virtual void PopulatetechnicianDropDownList(string selectedValue, int maxItems) 
        {
            		  					                
            this.technician.Items.Clear();
            
            // 1. Setup the static list items        
            		  			
            // 2. Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_technicianDropDownList function.
            // It is better to customize the where clause there.
            
                      
            WhereClause wc = CreateWhereClause_technicianDropDownList();
                        
                
            // Create the ORDER BY clause to sort based on the displayed value.							
                
            OrderBy orderBy = new OrderBy(false, false);
                          orderBy.Add(TechniciansTable.technician_id, OrderByItem.OrderDir.Asc);

            System.Collections.Generic.IDictionary<string, object> variables = new System.Collections.Generic.Dictionary<string, object> ();
            FormulaEvaluator evaluator = new FormulaEvaluator();

            // 3. Read a total of maxItems from the database and insert them into the technicianDropDownList.
                ...
                do
                {
                    ...
                    foreach (TechniciansRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.technician_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.technician.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                fvalue = EvaluateFormula("= Technicians.=Technicians.LastExtraction", itemValue, variables2, evaluator);
                                ...
                                ListItem dupItem = this.technician.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.technician.Items.Add(newItem);
            ...
            if (selectedValue != null &&
                selectedValue.Trim() != "" &&
                !MiscUtils.SetSelectedValue(this.technician, selectedValue) &&
                !MiscUtils.SetSelectedDisplayText(this.technician, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        fvalue = EvaluateFormula("= Technicians.=Technicians.LastExtraction", itemValue, variables2, evaluator2);
                            					
                        if (fvalue == null || fvalue.Trim() == "") fvalue = cvalue;
                        MiscUtils.ResetSelectedItem(this.technician, new ListItem(fvalue, cvalue));                      
                    }
                }
                catch
                {
        ...
        protected virtual void technician_SelectedIndexChanged(object sender, EventArgs args)
        {
            // for the value inserted by quick add button or large list selector, 
            // the value is necessary to be inserted by this event during postback 
            string val = (string)(this.Page.Session[technician.ClientID + "_SelectedValue"]);
            string displayText = (string)(this.Page.Session[technician.ClientID + "_SelectedDisplayText"]);
            if (!string.IsNullOrEmpty(displayText) && !string.IsNullOrEmpty(val)) {
	            this.technician.Items.Add(new ListItem(displayText, val));
	            this.technician.SelectedIndex = this.technician.Items.Count - 1;
	            this.Page.Session.Remove(technician.ClientID + "_SelectedValue");
	            this.Page.Session.Remove(technician.ClientID + "_SelectedDisplayText");
            }
...
#region "Helper Properties"
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector custno1 {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "custno1");
            }
        }              
            
        public System.Web.UI.WebControls.DropDownList technician {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "technician");
            }
        }
    ...
    Equipment_import_batchRecord rec = null;
             ...
             
        {
            ...
            return new Equipment_import_batchRecord();
