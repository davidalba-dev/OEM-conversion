...
// Edit_Equipment_import_batch.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Equipment_import_batch
{
...
// Base class for the Equipment_import_batchRecordControl control on the Edit_Equipment_import_batch page.
...
public class BaseEquipment_import_batchRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setcustno()
        {
            ...
            if (this.DataSource != null && this.DataSource.custnoSpecified) {
              ...
              this.custno.Text = Equipment_import_batchTable.custno.DefaultValue;
        ...
        public virtual void Getcustno()
        {
            ...
            // Save the value to data source
            this.DataSource.Parse(this.custno.Text, Equipment_import_batchTable.custno);							
      ...
      // To customize, override this method in Equipment_import_batchRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Equipment_import_batch"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OEMConversion").Replace("{URL}", "Equipment_import_batch"));
            }
            HttpContext.Current.Session["QueryString in Edit-Equipment-import-batch"] = recId;
