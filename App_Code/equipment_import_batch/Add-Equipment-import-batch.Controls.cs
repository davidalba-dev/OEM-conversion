...
// Add_Equipment_import_batch.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Equipment_import_batch
{
...
// Base class for the Equipment_import_batchRecordControl control on the Add_Equipment_import_batch page.
...
public class BaseEquipment_import_batchRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in Equipment_import_batchRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Add-Equipment-import-batch"] = recId;
