...
// Sales_Show_Customers_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Sales_Show_Customers_Table
{
...
// Base class for the CustomersTableControlRow control on the Sales_Show_Customers_Table page.
...
// Base class for the CustomersTableControl control on the Sales_Show_Customers_Table page.
...
public class BaseCustomersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
           ...
           // Setup the filter and search.
            ...
            if (!this.Page.IsPostBack)
            {
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.ProvCodeFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.ProvCodeFilter.SelectedValue = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.ProvCodeFilter.SelectedIndexChanged += new EventHandler(ProvCodeFilter_SelectedIndexChanged);
    ...
    public virtual void AddWarningMessageOnClick() {
      ...
      CustomersRecord rec = new CustomersRecord();
        ...
        public virtual void SetProvCodeLabel()
                  {
                      ...
                      //this.ProvCodeLabel.Text = "Some value";
        ...
        public virtual void SetProvCodeFilter()
        {
            ...
            this.PopulateProvCodeFilter(MiscUtils.GetSelectedValue(this.ProvCodeFilter,  GetFromSession(this.ProvCodeFilter)), 500);					
                    ...
                    foreach (Customer_typeRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.customer_type_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.customer_type_idFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                fvalue = EvaluateFormula("= Customer_type.customer_type", itemValue , variables, evaluator);
        ...
        protected virtual void PopulateProvCodeFilter(string selectedValue, int maxItems)
                    
        {
            ...
            // Setup the static list items        
                ...
                // Add the All item.
                this.ProvCodeFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
                ...
                do
                {
                    ...
                    foreach (ProvincesRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.ProvCodeSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.ProvCodeFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                variables.Add(itemValue.TableAccess.TableDefinition.TableCodeName, itemValue);
                                fvalue = EvaluateFormula("ProvCode", itemValue , variables, evaluator);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.ProvCodeFilter, selectedValue);
            ...
            if (this.ProvCodeFilter.SelectedValue != null && this.ProvCodeFilter.Items.FindByValue(this.ProvCodeFilter.SelectedValue) == null)
                this.ProvCodeFilter.SelectedValue = null;
        ...
        public virtual WhereClause CreateWhereClause_ProvCodeFilter()
        {
            ...
            // This function is called by the Populate method to load the items 
            // in the ProvCodeFilterDropDownList
        CompoundFilter filter = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
            WhereClause whereClause = new WhereClause();
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.ProvCodeFilter, this.ProvCodeFilter.SelectedValue);
      ...
      this.SaveToSession("ProvCodeFilter_Ajax", this.ProvCodeFilter.SelectedValue);
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Sales-Show-Customers-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Customers";
                // If Sales-Show-Customers-Table.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Sales-Show-Customers-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Customers";
                // If Sales-Show-Customers-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList ProvCodeFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ProvCodeFilter");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual CustomersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (CustomersTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Sales_Show_Customers_Table.CustomersTableControlRow")));
...
// Base class for the Max_customerRecordControl control on the Sales_Show_Customers_Table page.
