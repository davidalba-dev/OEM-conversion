...
// Add_Customers_Basic.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Customers_Basic
{
...
// Base class for the CustomersRecordControl control on the Add_Customers_Basic page.
...
public class BaseCustomersRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.CustNoF.TextChanged += CustNoF_TextChanged;
        ...
        public virtual void SetCustNoF()
        {
            ...
            // this.DataSource is the DatabaseAYS_OEM%dbo.Customers record retrieved from the database.
            // this.CustNoF is the ASP:TextBox on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
               ...
               string formattedValue = this.DataSource.Format(CustomersTable.CustNo);
                ...
                this.CustNoF.Text = formattedValue;
              ...
              this.CustNoF.Text = EvaluateFormula("URL(\"CustomerNO\")", this.DataSource);
        ...
        public virtual void Setcustomer_active()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {					
                ...
                if (StringUtils.InvariantLCase(EvaluateFormula("True", this.DataSource)).Equals("true"))
                    this.customer_active.Checked = true;
                else
                    this.customer_active.Checked = false;
        ...
        public virtual void Setcustomer_inventory()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {					
                ...
                if (StringUtils.InvariantLCase(EvaluateFormula("True", this.DataSource)).Equals("true"))
                    this.customer_inventory.Checked = true;
                else
                    this.customer_inventory.Checked = false;
        ...
        public virtual void GetCustNoF()
        {
            ...
            // Save the value to data source
            this.DataSource.Parse(this.CustNoF.Text, CustomersTable.CustNo);							
      ...
      // To customize, override this method in CustomersRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Add-Customers-Basic"] = recId;
        ...
        protected virtual void CustNoF_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox CustNoF {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CustNoF");
            }
        }
