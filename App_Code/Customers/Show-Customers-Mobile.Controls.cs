...
// Show_Customers_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Customers_Mobile
{
...
// Base class for the CustomersRecordControl control on the Show_Customers_Mobile page.
...
public class BaseCustomersRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetCustAddress11()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
                ...
                // If the CustAddress1 is non-NULL, then format the value.
                // The Format method will use the Display Format
                string formattedValue = EvaluateFormula("\"<a href='https://www.google.com/maps/place/\"+CustAddress1+\"%2C%20\"+CustCity+\"%2C%20\"+CustProvince+\"%2C%20\"+CustPostalCode+\"' target=_blank><img src=../images/mapicon.png width=100 height=100></a>\"", this.DataSource);
              ...
              this.CustAddress11.Text = CustomersTable.CustAddress1.Format(CustomersTable.CustAddress1.DefaultValue);
      ...
      // To customize, override this method in CustomersRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-Customers-Mobile"] = recId;
