...
// Show_Leads_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Leads_Table
{
...
// Base class for the CustomersTableControlRow control on the Show_Leads_Table page.
...
// Base class for the CustomersTableControl control on the Show_Leads_Table page.
...
public class BaseCustomersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
       ...
       public BaseCustomersTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.customer_mgr_idFilter)) 				
                    initialVal = this.GetFromSession(this.customer_mgr_idFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"customer_mgr_id\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.customer_mgr_idFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.customer_mgr_idFilter.SelectedValue = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.customer_mgr_idFilter.SelectedIndexChanged += new EventHandler(customer_mgr_idFilter_SelectedIndexChanged);
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetCustNameLabel();
                Setcustomer_mgr_idFilter();
                Setcustomer_mgr_idLabel();
                Setcustomer_mgr_idLabel1();
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public virtual void ResetControl()
        {
            ...
            this.customer_mgr_idFilter.ClearSelection();
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.customer_mgr_idFilter)) {
                        
                wc.iAND(CustomersTable.customer_mgr_id, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.customer_mgr_idFilter, this.GetFromSession(this.customer_mgr_idFilter)), false, false);
      ...
      String customer_mgr_idFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "customer_mgr_idFilter_Ajax"];
            if (MiscUtils.IsValueSelected(customer_mgr_idFilterSelectedValue)) {

              
                wc.iAND(CustomersTable.customer_mgr_id, BaseFilter.ComparisonOperator.EqualsTo, customer_mgr_idFilterSelectedValue, false, false);
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            if (EvaluateFormula("2", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.CustomersTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"Customers_.customer_type_id"), EvaluateFormula("2", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
      ...
      CustomersRecord rec = new CustomersRecord();
        ...
        public virtual void Setcustomer_mgr_idLabel1()
                  {
                  
                        this.customer_mgr_idLabel1.Text = EvaluateFormula("\"Rep.\"");
        ...
        public virtual void Setcustomer_mgr_idFilter()
        {
            
            this.Populatecustomer_mgr_idFilter(MiscUtils.GetSelectedValue(this.customer_mgr_idFilter,  GetFromSession(this.customer_mgr_idFilter)), 500);					
        ...
        // Get the filters' data for customer_mgr_idFilter.
                
        protected virtual void Populatecustomer_mgr_idFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.customer_mgr_idFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_customer_mgr_idFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_customer_mgr_idFilter function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.customer_mgr_idFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
                ...
                do
                {
                    ...
                    foreach (TechniciansRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.technician_idSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.customer_mgr_idFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                ListItem dupItem = this.customer_mgr_idFilter.Items.FindByText(fvalue);
                                ...
                                this.customer_mgr_idFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                MiscUtils.SetSelectedValue(this.customer_mgr_idFilter, selectedValue);
            ...
            if (this.customer_mgr_idFilter.SelectedValue != null && this.customer_mgr_idFilter.Items.FindByValue(this.customer_mgr_idFilter.SelectedValue) == null)
                this.customer_mgr_idFilter.SelectedValue = null;
        ...
        public virtual WhereClause CreateWhereClause_customer_mgr_idFilter()
        {
            // Create a where clause for the filter customer_mgr_idFilter.
            // This function is called by the Populate method to load the items 
            // in the customer_mgr_idFilterDropDownList
        CompoundFilter filter = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
            WhereClause whereClause = new WhereClause();
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.customer_mgr_idFilter, this.customer_mgr_idFilter.SelectedValue);
      ...
      this.SaveToSession("customer_mgr_idFilter_Ajax", this.customer_mgr_idFilter.SelectedValue);
      ...
      this.SaveToSession("SearchText_Ajax", this.SearchText.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.customer_mgr_idFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(customer_mgr_idFilter))
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
             ...
             CustomersTable.CustContactName,
             ...
             data.ColumnList.Add(new ExcelColumn(CustomersTable.CustContactName, "Default"));
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Leads-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Customers";
                // If Show-Leads-Table.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 ...
                 report.AddColumn(CustomersTable.CustContactName.Name, ReportEnum.Align.Left, "${CustContactName}", ReportEnum.Align.Left, 22);
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             report.AddData("${CustContactName}", record.Format(CustomersTable.CustContactName), ReportEnum.Align.Left, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Leads-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Customers";
                // If Show-Leads-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        protected virtual void customer_mgr_idFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList customer_mgr_idFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "customer_mgr_idFilter");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal customer_mgr_idLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "customer_mgr_idLabel1");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual CustomersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (CustomersTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Leads_Table.CustomersTableControlRow")));
...
// Base class for the Max_customerRecordControl control on the Show_Leads_Table page.
