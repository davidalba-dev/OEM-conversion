...
// Show_Prospect_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Prospect_Table
{
...
// Base class for the CustomersTableControlRow control on the Show_Prospect_Table page.
...
public class BaseCustomersTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setcustomer_type_id()
        {
            ...
            // Set the customer_type_id Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.Customers database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.Customers record retrieved from the database.
            // this.customer_type_id is the ASP:Literal on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.customer_type_idSpecified) {
               ...
               if(_isExpandableNonCompositeForeignKey &&CustomersTable.customer_type_id.IsApplyDisplayAs)
                     ...
                     formattedValue = CustomersTable.GetDFKA(this.DataSource.customer_type_id.ToString(),CustomersTable.customer_type_id, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(CustomersTable.customer_type_id);
                                  
                                
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                this.customer_type_id.Text = formattedValue;
              ...
              this.customer_type_id.Text = CustomersTable.customer_type_id.Format(CustomersTable.customer_type_id.DefaultValue);
            		
            }
            
            // If the customer_type_id is NULL or blank, then use the value specified  
            // on Properties.
            if (this.customer_type_id.Text == null ||
                this.customer_type_id.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.customer_type_id.Text = "&nbsp;";
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal customer_type_id {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "customer_type_id");
            }
        }
...
// Base class for the CustomersTableControl control on the Show_Prospect_Table page.
    ...
    public virtual void AddWarningMessageOnClick() {
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            if (EvaluateFormula("3", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.CustomersTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"Customers_.customer_type_id"), EvaluateFormula("3", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
      ...
      CustomersRecord rec = new CustomersRecord();
                        ...
                        if (recControl.customer_type_id.Text != "") {
                            rec.Parse(recControl.customer_type_id.Text, CustomersTable.customer_type_id);
                  }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
             ...
             CustomersTable.customer_type_id,
             ...
             data.ColumnList.Add(new ExcelColumn(CustomersTable.customer_type_id, "Default"));
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Prospect-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Customers";
                // If Show-Prospect-Table.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 ...
                 report.AddColumn(CustomersTable.customer_type_id.Name, ReportEnum.Align.Left, "${customer_type_id}", ReportEnum.Align.Left, 30);
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.customer_type_id)){
                                 report.AddData("${customer_type_id}", "",ReportEnum.Align.Left, 300);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = CustomersTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(CustomersTable.customer_type_id);
                                 _DFKA = CustomersTable.GetDFKA(record.customer_type_id.ToString(), CustomersTable.customer_type_id,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  CustomersTable.customer_type_id.IsApplyDisplayAs){
                                     report.AddData("${customer_type_id}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${customer_type_id}", record.Format(CustomersTable.customer_type_id), ReportEnum.Align.Left, 300);
                                 }
                             }
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Prospect-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Customers";
                // If Show-Prospect-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual CustomersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (CustomersTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Prospect_Table.CustomersTableControlRow")));
...
// Base class for the Max_customerRecordControl control on the Show_Prospect_Table page.
