...
// Edit_Customers_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Customers_Table
{
...
// Base class for the CustomersTableControlRow control on the Edit_Customers_Table page.
...
public class BaseCustomersTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setrepairorder_notification()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.repairorder_notification.ID))
            {
            
                this.repairorder_notification.Text = this.PreviousUIData[this.repairorder_notification.ID].ToString();
...
// Base class for the CustomersTableControl control on the Edit_Customers_Table page.
...
public class BaseCustomersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
              ...
              this.repairorder_notificationLabel.Click += repairorder_notificationLabel_Click;
      ...
      CustomersRecord rec = new CustomersRecord();
                        ...
                        if (recControl.repairorder_notification.Text != "") {
                            rec.Parse(recControl.repairorder_notification.Text, CustomersTable.repairorder_notification);
                  }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void repairorder_notificationLabel_Click(object sender, EventArgs args)
        {
            //Sorts by repairorder_notification when clicked.
              
            // Get previous sorting state for repairorder_notification.
        
            OrderByItem sd = this.CurrentSortOrder.Find(CustomersTable.repairorder_notification);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for repairorder_notification.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(CustomersTable.repairorder_notification, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by repairorder_notification, so just reverse.
                sd.Reverse();
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton repairorder_notificationLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "repairorder_notificationLabel");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual CustomersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (CustomersTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_Customers_Table.CustomersTableControlRow")));
