...
// Corp_Add_Customers.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Corp_Add_Customers
{
...
// Base class for the CustomersRecordControl control on the Corp_Add_Customers page.
...
public class BaseCustomersRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetCustNo()
        {
            ...
            else
            {
                ...
                selectedValue = EvaluateFormula("CustNoDefaultValue + \"-\" + cust_shipping_address1DefaultValue + \"-\" + CustCityDefaultValue + \"-\" + CustProvinceDefaultValue");
        ...
        public virtual void GetCustNo()
        {
         // Retrieve the value entered by the user on the CustNo ASP:DropDownList, and
            ...
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.CustNo), CustomersTable.CustNo);			
      ...
      // To customize, override this method in CustomersRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Corp-Add-Customers"] = recId;
                    ...
                    foreach (CustomersRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.CustNoSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.CustNo.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                fvalue = EvaluateFormula("=CustNoDefaultValue + \"-\" + cust_shipping_address1DefaultValue + \"-\" + CustCityDefaultValue + \"-\" + CustProvinceDefaultValue", itemValue, variables2, evaluator);
                ...
                !MiscUtils.SetSelectedDisplayText(this.CustNo, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        fvalue = EvaluateFormula("=CustNoDefaultValue + \"-\" + cust_shipping_address1DefaultValue + \"-\" + CustCityDefaultValue + \"-\" + CustProvinceDefaultValue", itemValue, variables2, evaluator2);
