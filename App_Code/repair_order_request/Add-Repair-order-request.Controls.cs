...
// Add_Repair_order_request.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Repair_order_request
{
...
// Base class for the LoginRecordControl control on the Add_Repair_order_request page.
...
// Base class for the Repair_order_requestRecordControl control on the Add_Repair_order_request page.
...
public class BaseRepair_order_requestRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setrequestor()
        {
            ...
            else
            {
                ...
                selectedValue = EvaluateFormula("URL(\"requestor\")");
      ...
      // To customize, override this method in Repair_order_requestRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Add-Repair-order-request"] = recId;
