...
// Corp_Add_Repair_order_request.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Corp_Add_Repair_order_request
{
...
// Base class for the LoginRecordControl control on the Corp_Add_Repair_order_request page.
...
// Base class for the Repair_order_requestRecordControl control on the Corp_Add_Repair_order_request page.
...
public class BaseRepair_order_requestRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setcorp_name()
        {
            
                    
            // Set the corp_name Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.repair_order_request database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.repair_order_request record retrieved from the database.
            // this.corp_name is the ASP:Literal on the webpage.
                  
            if (this.DataSource != null && this.DataSource.corp_nameSpecified) {
                								
                // If the corp_name is non-NULL, then format the value.
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(Repair_order_requestTable.corp_name);
                                
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                this.corp_name.Text = formattedValue;
                   
            } 
            
            else {
            
                // corp_name is NULL in the database, so use the Default Value.  
                // Default Value could also be NULL.
        
              this.corp_name.Text = Repair_order_requestTable.corp_name.Format(Repair_order_requestTable.corp_name.DefaultValue);
        ...
        public virtual void Setcustno()
        {
            ...
            // Set AutoPostBack to true so that when the control value is changed, to refresh cust_dept_id,serialno controls
        ...
        public virtual void Setcorporatecontact_idLabel()
                  {
                      ...
                      //Code for the text property is generated inside the .aspx file. 
                      //To override this property you can uncomment the following property and add you own value.
                      //this.corporatecontact_idLabel.Text = "Some value";
        ...
        public virtual void Getcorp_name()
        {
      ...
      // To customize, override this method in Repair_order_requestRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Corp-Add-Repair-order-request"] = recId;
        ...
        public virtual WhereClause CreateWhereClause_serialnoDropDownList() 
        {
            ...
            filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.RepairOrdersTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"RepairOrders_.ROCustNo"), EvaluateFormula("Repair_order_requestRecordControl.custno.SelectedValue", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
                    ...
                    foreach (Corporate_contactsRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.CorporateContact_IdSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.corporatecontact_id.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                fvalue = EvaluateFormula("=Corporate_contacts.corporatecontact_first", itemValue, variables2, evaluator);
                ...
                !MiscUtils.SetSelectedDisplayText(this.corporatecontact_id, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        fvalue = EvaluateFormula("=Corporate_contacts.corporatecontact_first", itemValue, variables2, evaluator2);
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal corp_name {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "corp_name");
            }
        }
