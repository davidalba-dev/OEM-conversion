...
// Show_Repair_order_request_Table_Customer.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Repair_order_request_Table_Customer
{
...
// Base class for the Repair_order_requestTableControlRow control on the Show_Repair_order_request_Table_Customer page.
...
public class BaseRepair_order_requestTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setprocessed()
        {
            ...
            if (this.DataSource != null && this.DataSource.processedSpecified) {
               ...
               string formattedValue = this.DataSource.Format(Repair_order_requestTable.processed);
              ...
              this.processed.Text = Repair_order_requestTable.processed.Format(Repair_order_requestTable.processed.DefaultValue);
        ...
        public virtual void Setprocessed_datetime()
        {
            ...
            if (this.DataSource != null && this.DataSource.processed_datetimeSpecified) {
                								
                // If the processed_datetime is non-NULL, then format the value.
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(Repair_order_requestTable.processed_datetime, @"g");
            ...
            if (this.processed_datetime.Text == null ||
                ...
                // Set the value specified on the Properties.
                this.processed_datetime.Text = "N/A";
            }
...
// Base class for the Repair_order_requestTableControl control on the Show_Repair_order_request_Table_Customer page.
...
public class BaseRepair_order_requestTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
              ...
              this.processed_datetimeLabel.Click += processed_datetimeLabel_Click;
            
              this.processedLabel.Click += processedLabel_Click;
      ...
      cols.Add(Repair_order_requestTable.requestor, true);
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            filter.AddFilter(new BaseClasses.Data.ColumnJoinFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Repair_order_requestTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"repair_order_request_.custno"), new BaseClasses.Data.IdentifierAliasInfo(@"repair_order_request_", null), BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.CustomersTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"Customers_.CustNo"), new BaseClasses.Data.IdentifierAliasInfo(@"Customers_", null),  BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
            filter.AddFilter(new BaseClasses.Data.ColumnJoinFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Repair_order_requestTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"repair_order_request_.requestor"), new BaseClasses.Data.IdentifierAliasInfo(@"repair_order_request_", null), BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.CustomerContactsTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"CustomerContacts_.CustContactKey"), new BaseClasses.Data.IdentifierAliasInfo(@"CustomerContacts_", null),  BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
        ...
        public virtual string[] GetAutoCompletionList_SearchText(String prefixText,int count)
        {
            ...
            foreach (Repair_order_requestRecord rec in recordList ){
                ...
                resultItem = rec.Format(Repair_order_requestTable.requestor);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(Repair_order_requestTable.requestor.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, Repair_order_requestTable.requestor.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
      ...
      Repair_order_requestRecord rec = new Repair_order_requestRecord();
                        ...
                        if (recControl.processed.Text != "") {
                            rec.Parse(recControl.processed.Text, Repair_order_requestTable.processed);
                  }
                
                        if (recControl.processed_datetime.Text != "") {
                            rec.Parse(recControl.processed_datetime.Text, Repair_order_requestTable.processed_datetime);
                  }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void processed_datetimeLabel_Click(object sender, EventArgs args)
        {
            //Sorts by processed_datetime when clicked.
              
            // Get previous sorting state for processed_datetime.
        
            OrderByItem sd = this.CurrentSortOrder.Find(Repair_order_requestTable.processed_datetime);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for processed_datetime.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(Repair_order_requestTable.processed_datetime, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by processed_datetime, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void processedLabel_Click(object sender, EventArgs args)
        {
            //Sorts by processed when clicked.
              
            // Get previous sorting state for processed.
        
            OrderByItem sd = this.CurrentSortOrder.Find(Repair_order_requestTable.processed);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for processed.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(Repair_order_requestTable.processed, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by processed, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void NewButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../repair_order_request/Add-Repair-order-request.aspx";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton processed_datetimeLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "processed_datetimeLabel");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton processedLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "processedLabel");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual Repair_order_requestTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Repair_order_requestTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Repair_order_request_Table_Customer.Repair_order_requestTableControlRow")));
