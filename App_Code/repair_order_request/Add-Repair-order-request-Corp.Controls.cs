...
// Add_Repair_order_request_Corp.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Repair_order_request_Corp
{
...
// Base class for the LoginRecordControl control on the Add_Repair_order_request_Corp page.
...
// Base class for the Repair_order_requestRecordControl control on the Add_Repair_order_request_Corp page.
...
public class BaseRepair_order_requestRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.clean_status.SelectedIndexChanged += clean_status_SelectedIndexChanged;
              ...
              this.serialno.SelectedIndexChanged += serialno_SelectedIndexChanged;
              ...
              this.request_date.TextChanged += request_date_TextChanged;
        ...
        public virtual void LoadData()  
        {
            ...
            // Set DataSource based on record retrieved from the database.
            this.DataSource = (Repair_order_requestRecord)Repair_order_requestRecord.Copy(recList[0], false);
        ...
        public virtual void Setclean_status()
        {
            ...
            // Set the clean_status DropDownList on the webpage with value from the
            ...
            // this.clean_status is the ASP:DropDownList on the webpage.
            
            // You can modify this method directly, or replace it with a call to
            //     base.Setclean_status();
            ...
            if (this.DataSource != null && this.DataSource.clean_statusSpecified)
            {
                ...
                // The Format method will use the Display Format
                selectedValue = this.DataSource.clean_status;
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = Repair_order_requestTable.clean_status.DefaultValue;
            ...
            this.Populateclean_statusDropDownList(selectedValue, 100);              
        ...
        public virtual void Setmake()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = Repair_order_requestTable.make.DefaultValue;
        ...
        public virtual void Setmodel()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = Repair_order_requestTable.model.DefaultValue;
        ...
        public virtual void Setrequest_date()
        {
            ...
            // Set the request_date TextBox on the webpage with value from the
            // DatabaseAYS_OEM%dbo.repair_order_request database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.repair_order_request record retrieved from the database.
            // this.request_date is the ASP:TextBox on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
              ...
              this.request_date.Text = EvaluateFormula("Now()", this.DataSource, @"g");
        ...
        public virtual void Setserialno()
        {
            ...
            // Set the serialno DropDownList on the webpage with value from the
            // DatabaseAYS_OEM%dbo.repair_order_request database record.
            
            // this.DataSource is the DatabaseAYS_OEM%dbo.repair_order_request record retrieved from the database.
            // this.serialno is the ASP:DropDownList on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.serialnoSpecified)
            {
                ...
                // The Format method will use the Display Format
                selectedValue = this.DataSource.serialno;
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = Repair_order_requestTable.serialno.DefaultValue;
            ...
            this.PopulateserialnoDropDownList(selectedValue, 1000);              
        ...
        public virtual void Setclean_statusLabel()
                  {
                      ...
                      //this.clean_statusLabel.Text = "Some value";
        ...
        public virtual void SetLoginRecordControl()           
        
        {        
            if (LoginRecordControl.Visible)
            {
                LoginRecordControl.LoadData();
                LoginRecordControl.DataBind();
            }
        }
        ...
        public virtual void SaveData()
        {
            ...
            this.CheckSum = "";
            // For Master-Detail relationships, save data on the Detail table(s)            
          LoginRecordControl recLoginRecordControl = (LoginRecordControl)(MiscUtils.FindControlRecursively(this, "LoginRecordControl"));
        ...
        {
         // Retrieve the value entered by the user on the clean_status ASP:DropDownList, and
            // save it into the clean_status field in DataSource DatabaseAYS_OEM%dbo.repair_order_request record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.clean_status), Repair_order_requestTable.clean_status);			
        ...
        public virtual void Getcorporatecontact_id()
        {
         // Retrieve the value entered by the user on the corporatecontact_id ASP:DropDownList, and
            // save it into the corporatecontact_id field in DataSource DatabaseAYS_OEM%dbo.repair_order_request record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.corporatecontact_id), Repair_order_requestTable.corporatecontact_id);			
        ...
        public virtual void Getmake()
        {
         // Retrieve the value entered by the user on the make ASP:DropDownList, and
            ...
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.make), Repair_order_requestTable.make);			
        ...
        public virtual void Getmodel()
        {
         // Retrieve the value entered by the user on the model ASP:DropDownList, and
            ...
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.model), Repair_order_requestTable.model);			
        ...
        public virtual void Getrequest_date()
        {
            ...
            // Retrieve the value entered by the user on the request_date ASP:TextBox, and
            // save it into the request_date field in DataSource DatabaseAYS_OEM%dbo.repair_order_request record.
            ...
            // Save the value to data source
            this.DataSource.Parse(this.request_date.Text, Repair_order_requestTable.request_date);							
        ...
        {
         // Retrieve the value entered by the user on the serialno ASP:DropDownList, and
            // save it into the serialno field in DataSource DatabaseAYS_OEM%dbo.repair_order_request record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.serialno), Repair_order_requestTable.serialno);			
      ...
      // To customize, override this method in Repair_order_requestRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Repair_order_request"];
            ...
            HttpContext.Current.Session["QueryString in Add-Repair-order-request-Corp"] = recId;
        ...
        public virtual WhereClause CreateWhereClause_clean_statusDropDownList() 
        {
        ...
        public virtual WhereClause CreateWhereClause_corporatecontact_idDropDownList() 
        {
            ...
            // Examples:
            // wc.iAND(Corporate_contactsTable.CorporateContact_Id, BaseFilter.ComparisonOperator.EqualsTo, "XYZ");
            // wc.iAND(Corporate_contactsTable.Active, BaseFilter.ComparisonOperator.EqualsTo, "1");
            CompoundFilter filter = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
            WhereClause whereClause = new WhereClause();
            
            filter.AddFilter(new BaseClasses.Data.ColumnJoinFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.Corporate_contactsTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"corporate_contacts_.corporate_id"), new BaseClasses.Data.IdentifierAliasInfo(@"corporate_contacts_", null), BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.LoginTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"login_.corporatecontact_id"), new BaseClasses.Data.IdentifierAliasInfo(@"login_", null),  BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
            if (EvaluateFormula("UserId()", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.LoginTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"login_.login_id"), EvaluateFormula("UserId()", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("UserId()", false) == "--PLEASE_SELECT--" || EvaluateFormula("UserId()", false) == "--ANY--") whereClause.RunQuery = false;
        ...
        public virtual WhereClause CreateWhereClause_custnoDropDownList() 
        {
            ...
            filter.AddFilter(new BaseClasses.Data.ColumnJoinFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.CustomersTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"Customers_.corporate_id"), new BaseClasses.Data.IdentifierAliasInfo(@"Customers_", null), BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.LoginTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"login_.corporate_id"), new BaseClasses.Data.IdentifierAliasInfo(@"login_", null),  BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
            if (EvaluateFormula("UserId()", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.LoginTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"login_.login_id"), EvaluateFormula("UserId()", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("UserId()", false) == "--PLEASE_SELECT--" || EvaluateFormula("UserId()", false) == "--ANY--") whereClause.RunQuery = false;
        ...
        public virtual WhereClause CreateWhereClause_modelDropDownList() 
        {
            ...
            if (EvaluateFormula("Repair_order_requestRecordControl.make.SelectedValue", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.MakesModelsTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"MakesModels_.Make"), EvaluateFormula("Repair_order_requestRecordControl.make.SelectedValue", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("Repair_order_requestRecordControl.make.SelectedValue", false) == "--PLEASE_SELECT--" || EvaluateFormula("Repair_order_requestRecordControl.make.SelectedValue", false) == "--ANY--") whereClause.RunQuery = false;
        ...
        public virtual WhereClause CreateWhereClause_serialnoDropDownList() 
        {
            // By default, we simply return a new WhereClause.
            // Add additional where clauses to restrict the items shown in the dropdown list.
            CompoundFilter filter = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
            ...
            filter.AddFilter(new BaseClasses.Data.ColumnJoinFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.RepairOrdersTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"RepairOrders_.ROCustNo"), new BaseClasses.Data.IdentifierAliasInfo(@"RepairOrders_", null), BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.DepartmentTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"department_.custno"), new BaseClasses.Data.IdentifierAliasInfo(@"department_", null),  BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
        ...
        // Fill the clean_status list.
        protected virtual void Populateclean_statusDropDownList(string selectedValue, int maxItems) 
        {
            		  					                
            this.clean_status.Items.Clear();
            
            // 1. Setup the static list items        
            
                this.clean_status.Items.Add(new ListItem(this.Page.ExpandResourceValue("{Txt:PleaseSelect}"), "--PLEASE_SELECT--"));
              
                this.clean_status.Items.Add(new ListItem(this.Page.ExpandResourceValue("Clean"), "Clean"));
              
                this.clean_status.Items.Add(new ListItem(this.Page.ExpandResourceValue("Dirty"), "Dirty"));
            ...
            if (selectedValue != null &&
                selectedValue.Trim() != "" &&
                !MiscUtils.SetSelectedValue(this.clean_status, selectedValue) &&
                !MiscUtils.SetSelectedDisplayText(this.clean_status, selectedValue) &&
                !MiscUtils.SetSelectedDisplayText(this.clean_status, Repair_order_requestTable.clean_status.Format(selectedValue)))
            {
                string fvalue = Repair_order_requestTable.clean_status.Format(selectedValue);
                if (fvalue == null || fvalue.Trim() == "") fvalue = selectedValue;
                MiscUtils.ResetSelectedItem(this.clean_status, new ListItem(fvalue, selectedValue));
            }
        ...
        protected virtual void Populatecorporatecontact_idDropDownList(string selectedValue, int maxItems) 
        {
            ...
            OrderBy orderBy = new OrderBy(false, false);
              ...
              orderBy.Add(Corporate_contactsTable.corporatecontact_last, OrderByItem.OrderDir.Asc);
                        ...
                        if (itemValue.CorporateContact_IdSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.corporatecontact_id.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                if(_isExpandableNonCompositeForeignKey && Repair_order_requestTable.corporatecontact_id.IsApplyDisplayAs)
                                    fvalue = Repair_order_requestTable.GetDFKA(itemValue, Repair_order_requestTable.corporatecontact_id);
                                if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(fvalue)))
                                    fvalue = itemValue.Format(Corporate_contactsTable.CorporateContact_Id);
        ...
        protected virtual void Populaterequest_methodDropDownList(string selectedValue, int maxItems) 
        {
            ...
            // 1. Setup the static list items        
                ...
                this.request_method.Items.Add(new ListItem(this.Page.ExpandResourceValue("{Txt:PleaseSelect}"), "--PLEASE_SELECT--"));
              
                this.request_method.Items.Add(new ListItem(this.Page.ExpandResourceValue("Pick-Up"), "Pick-Up"));
              
                this.request_method.Items.Add(new ListItem(this.Page.ExpandResourceValue("Shipping Label"), "Shipping Label"));
        ...
        // Fill the serialno list.
        protected virtual void PopulateserialnoDropDownList(string selectedValue, int maxItems) 
        {
            		  					                
            this.serialno.Items.Clear();
            
            // 1. Setup the static list items        
            
              // Add the Please Select item.
              this.serialno.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "OEMConversion"), "--PLEASE_SELECT--"));
            		  			
            // 2. Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_serialnoDropDownList function.
            // It is better to customize the where clause there.
            
                      
            WhereClause wc = CreateWhereClause_serialnoDropDownList();
                        
                
            // Create the ORDER BY clause to sort based on the displayed value.							
                
            OrderBy orderBy = new OrderBy(false, false);
                          orderBy.Add(RepairOrdersTable.ROSerialNo, OrderByItem.OrderDir.Asc);

            System.Collections.Generic.IDictionary<string, object> variables = new System.Collections.Generic.Dictionary<string, object> ();
            FormulaEvaluator evaluator = new FormulaEvaluator();

            // 3. Read a total of maxItems from the database and insert them into the serialnoDropDownList.
                ...
                do
                {
                    ...
                    foreach (RepairOrdersRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.ROSerialNoSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.serialno.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                fvalue = EvaluateFormula("=RepairOrders.ROSerialNo", itemValue, variables2, evaluator);
                                ...
                                ListItem dupItem = this.serialno.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.serialno.Items.Add(newItem);
            ...
            if (selectedValue != null &&
                selectedValue.Trim() != "" &&
                !MiscUtils.SetSelectedValue(this.serialno, selectedValue) &&
                !MiscUtils.SetSelectedDisplayText(this.serialno, selectedValue))
            {

                // construct a whereclause to query a record with DatabaseAYS_OEM%dbo.RepairOrders.ROSerialNo = selectedValue
                    
                CompoundFilter filter2 = new CompoundFilter(CompoundFilter.CompoundingOperators.And_Operator, null);
                WhereClause whereClause2 = new WhereClause();
                filter2.AddFilter(new BaseClasses.Data.ColumnValueFilter(RepairOrdersTable.ROSerialNo, selectedValue, BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
                whereClause2.AddFilter(filter2, CompoundFilter.CompoundingOperators.And_Operator);
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        fvalue = EvaluateFormula("=RepairOrders.ROSerialNo", itemValue, variables2, evaluator2);
                            					
                        if (fvalue == null || fvalue.Trim() == "") fvalue = cvalue;
                        MiscUtils.ResetSelectedItem(this.serialno, new ListItem(fvalue, cvalue));                      
                    }
                }
                catch
                {
        ...
        protected virtual void clean_status_SelectedIndexChanged(object sender, EventArgs args)
        {
            // for the value inserted by quick add button or large list selector, 
            // the value is necessary to be inserted by this event during postback 
            string val = (string)(this.Page.Session[clean_status.ClientID + "_SelectedValue"]);
            string displayText = (string)(this.Page.Session[clean_status.ClientID + "_SelectedDisplayText"]);
            if (!string.IsNullOrEmpty(displayText) && !string.IsNullOrEmpty(val)) {
	            this.clean_status.Items.Add(new ListItem(displayText, val));
	            this.clean_status.SelectedIndex = this.clean_status.Items.Count - 1;
	            this.Page.Session.Remove(clean_status.ClientID + "_SelectedValue");
	            this.Page.Session.Remove(clean_status.ClientID + "_SelectedDisplayText");
            }
        ...
        protected virtual void serialno_SelectedIndexChanged(object sender, EventArgs args)
        {
            // for the value inserted by quick add button or large list selector, 
            // the value is necessary to be inserted by this event during postback 
            string val = (string)(this.Page.Session[serialno.ClientID + "_SelectedValue"]);
            string displayText = (string)(this.Page.Session[serialno.ClientID + "_SelectedDisplayText"]);
            if (!string.IsNullOrEmpty(displayText) && !string.IsNullOrEmpty(val)) {
	            this.serialno.Items.Add(new ListItem(displayText, val));
	            this.serialno.SelectedIndex = this.serialno.Items.Count - 1;
	            this.Page.Session.Remove(serialno.ClientID + "_SelectedValue");
	            this.Page.Session.Remove(serialno.ClientID + "_SelectedDisplayText");
            }
        ...
        protected virtual void request_date_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList clean_status {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "clean_status");
            }
        }
        ...
        public System.Web.UI.WebControls.Label cust_dept_idLabel {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "cust_dept_idLabel");
            }
        }
        ...
        public LoginRecordControl LoginRecordControl {
            get {
                return (LoginRecordControl)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "LoginRecordControl");
            }
        }
        ...
        public System.Web.UI.WebControls.TextBox request_date {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "request_date");
            }
        }
        ...
        public System.Web.UI.WebControls.DropDownList serialno {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "serialno");
            }
        }
    ...
    Repair_order_requestRecord rec = null;
             ...
             
        {
            ...
            return new Repair_order_requestRecord();
