...
// Show_Repair_order_request_Table_Sales.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Repair_order_request_Table_Sales
{
...
// Base class for the Repair_order_requestTableControlRow control on the Show_Repair_order_request_Table_Sales page.
...
// Base class for the Repair_order_requestTableControl control on the Show_Repair_order_request_Table_Sales page.
...
#region "Helper Functions"
        ...
        public virtual Repair_order_requestTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Repair_order_requestTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Repair_order_request_Table_Sales.Repair_order_requestTableControlRow")));
