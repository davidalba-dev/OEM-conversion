...
// Show_Repair_order_request_Table_Corp.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Repair_order_request_Table_Corp
{
...
// Base class for the Repair_order_requestTableControlRow control on the Show_Repair_order_request_Table_Corp page.
...
// Base class for the Repair_order_requestTableControl control on the Show_Repair_order_request_Table_Corp page.
    ...
    // Setup default pagination settings.
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            filter.AddFilter(new BaseClasses.Data.ColumnJoinFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.CustomersTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"Customers_.corporate_id"), new BaseClasses.Data.IdentifierAliasInfo(@"Customers_", null), BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.CorporateTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"corporate_.corporate_id"), new BaseClasses.Data.IdentifierAliasInfo(@"corporate_", null),  BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
...
#region "Helper Functions"
        ...
        public virtual Repair_order_requestTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Repair_order_requestTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Repair_order_request_Table_Corp.Repair_order_requestTableControlRow")));
