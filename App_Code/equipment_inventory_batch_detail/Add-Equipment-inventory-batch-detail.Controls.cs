...
// Add_Equipment_inventory_batch_detail.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Equipment_inventory_batch_detail
{
...
// Base class for the Equipment_inventory_batch_detailRecordControl control on the Add_Equipment_inventory_batch_detail page.
...
public class BaseEquipment_inventory_batch_detailRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.equipment_inventory_batch_id.TextChanged += equipment_inventory_batch_id_TextChanged;
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (Equipment_inventory_batch_detailRecord)Equipment_inventory_batch_detailRecord.Copy(recList[0], false);
        ...
        public virtual void Setequipment_inventory_batch_id()
        {
            ...
            // Set the equipment_inventory_batch_id TextBox on the webpage with value from the
            // DatabaseAYS_OEM%dbo.equipment_inventory_batch_detail database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.equipment_inventory_batch_detail record retrieved from the database.
            // this.equipment_inventory_batch_id is the ASP:TextBox on the webpage.
                  
            if (this.DataSource != null && this.DataSource.IsCreated) {
                								
                // If the equipment_inventory_batch_id is non-NULL, then format the value.
                // The Format method will return the Display Foreign Key As (DFKA) value
               string formattedValue = this.DataSource.equipment_inventory_batch_id.ToString();
              ...
              this.equipment_inventory_batch_id.Text = EvaluateFormula("URL(\"batch_id\")", this.DataSource);
        ...
        public virtual void Setmake()
        {
            ...
            this.PopulatemakeDropDownList(selectedValue, 5000);              
        ...
        public virtual void Setmodel()
        {
            ...
            this.PopulatemodelDropDownList(selectedValue, 5000);              
        ...
        public virtual void Getequipment_inventory_batch_id()
        {
            ...
            // Retrieve the value entered by the user on the equipment_inventory_batch_id ASP:TextBox, and
            ...
            // Save the value to data source
            this.DataSource.Parse(this.equipment_inventory_batch_id.Text, Equipment_inventory_batch_detailTable.equipment_inventory_batch_id);							
      ...
      // To customize, override this method in Equipment_inventory_batch_detailRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Equipment_inventory_batch_detail"];
            ...
            HttpContext.Current.Session["QueryString in Add-Equipment-inventory-batch-detail"] = recId;
        ...
        public virtual WhereClause CreateWhereClause_modelDropDownList() 
        {
            ...
            if (EvaluateFormula("Equipment_inventory_batch_detailRecordControl.make.SelectedValue", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.MakesModelsTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"MakesModels_.Make"), EvaluateFormula("Equipment_inventory_batch_detailRecordControl.make.SelectedValue", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("Equipment_inventory_batch_detailRecordControl.make.SelectedValue", false) == "--PLEASE_SELECT--" || EvaluateFormula("Equipment_inventory_batch_detailRecordControl.make.SelectedValue", false) == "--ANY--") whereClause.RunQuery = false;
        ...
        protected virtual void equipment_inventory_batch_id_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox equipment_inventory_batch_id {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "equipment_inventory_batch_id");
            }
        }
    ...
    Equipment_inventory_batch_detailRecord rec = null;
             ...
             
        {
            ...
            return new Equipment_inventory_batch_detailRecord();
