...
// Add_Equipment_batch_status.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Equipment_batch_status
{
...
// Base class for the Equipment_batch_statusRecordControl control on the Add_Equipment_batch_status page.
...
public class BaseEquipment_batch_statusRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (Equipment_batch_statusRecord)Equipment_batch_statusRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in Equipment_batch_statusRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Equipment_batch_status"];
            ...
            HttpContext.Current.Session["QueryString in Add-Equipment-batch-status"] = recId;
...
#region "Helper Properties"
    ...
    Equipment_batch_statusRecord rec = null;
             ...
             
        {
            ...
            return new Equipment_batch_statusRecord();
