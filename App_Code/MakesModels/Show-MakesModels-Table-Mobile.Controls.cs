...
// Show_MakesModels_Table_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_MakesModels_Table_Mobile
{
...
// Base class for the MakesModelsTableControlRow control on the Show_MakesModels_Table_Mobile page.
...
public class BaseMakesModelsTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetModelDesc()
        {
            ...
            // Set the ModelDesc Label on the webpage with value from the
            // DatabaseAYS_OEM%dbo.MakesModels database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.MakesModels record retrieved from the database.
            // this.ModelDesc is the ASP:Label on the webpage.
      ...
      // To customize, override this method in MakesModelsTableControlRow.
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../MakesModels/Show-MakesModels-Mobile.aspx?MakesModels={PK}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Label ModelDesc {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ModelDesc");
            }
        }
...
// Base class for the MakesModelsTableControl control on the Show_MakesModels_Table_Mobile page.
...
public class BaseMakesModelsTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep1 = (System.Web.UI.WebControls.Repeater)BaseClasses.Utils.MiscUtils.FindControlRecursively(rep.Items[PageIndex], "MakesModelsTableControlRepeater1");
      ...
      foreach(BaseColumn col in cols)
      {
            ...
            foreach (MakesModelsRecord rec in recordList ){
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MakesModelsTable.Category.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MakesModelsTable.Make.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MakesModelsTable.Model.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MakesModelsTable.ModelReference1.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, MakesModelsTable.ModelReference2.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (!this.ResetData)
            {
              System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MakesModelsTableControlRepeater"));
              if (rep == null){return;}
              MakesModelsTableControlRow[] recControls = this.GetRecordControls();
                foreach (MakesModelsTableControlRow recControl in recControls) 
		{
      ...
      MakesModelsRecord rec = new MakesModelsRecord();
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Model Description {Txt:Ascending}"), "ModelDesc Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Model Description {Txt:Descending}"), "ModelDesc Desc"));
...
#region "Helper Functions"
        ...
        public virtual MakesModelsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MakesModelsTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Show_MakesModels_Table_Mobile.MakesModelsTableControlRow")));
