...
// Show_Category_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Category_Table
{
...
// Base class for the MakesModelsTableControlRow control on the Show_Category_Table page.
...
// Base class for the MakesModelsTableControl control on the Show_Category_Table page.
...
public class BaseMakesModelsTableControl : OEMConversion.UI.BaseApplicationTableControl
{
           ...
           // Setup the filter and search.
            ...
            if (!this.Page.IsPostBack)
            {
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.CategoryFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.CategoryFilter.SelectedValue = initialVal;
            ...
            else
            {
                ...
                this.CurrentSortOrder.Add(MakesModelsTable.Category, OrderByItem.OrderDir.Asc);
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.CategoryFilter.SelectedIndexChanged += new EventHandler(CategoryFilter_SelectedIndexChanged);
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.CategoryFilter)) {
                ...
                wc.iAND(MakesModelsTable.Category, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.CategoryFilter, this.GetFromSession(this.CategoryFilter)), false, false);
      ...
      String CategoryFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "CategoryFilter_Ajax"];
            if (MiscUtils.IsValueSelected(CategoryFilterSelectedValue)) {
                ...
                wc.iAND(MakesModelsTable.Category, BaseFilter.ComparisonOperator.EqualsTo, CategoryFilterSelectedValue, false, false);
      ...
      MakesModelsRecord rec = new MakesModelsRecord();
        ...
        public virtual void SetCategoryFilter()
        {
            ...
            this.PopulateCategoryFilter(MiscUtils.GetSelectedValue(this.CategoryFilter,  GetFromSession(this.CategoryFilter)), 500);					
        ...
        protected virtual void PopulateCategoryFilter(string selectedValue, int maxItems)
                    
        {
            ...
            // Setup the static list items        
                ...
                // Add the All item.
                this.CategoryFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
            ...
            try
            {
                ...
                MiscUtils.SetSelectedValue(this.CategoryFilter, selectedValue);
            ...
            if (this.CategoryFilter.SelectedValue != null && this.CategoryFilter.Items.FindByValue(this.CategoryFilter.SelectedValue) == null)
        ...
        public virtual WhereClause CreateWhereClause_CategoryFilter()
        {
            ...
            // in the CategoryFilterDropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.CategoryFilter, this.CategoryFilter.SelectedValue);
      ...
      this.SaveToSession("CategoryFilter_Ajax", this.CategoryFilter.SelectedValue);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void CategoryLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(MakesModelsTable.Category);
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = MakesModelsTable.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
              
                // Add each of the columns in order of export.
                BaseColumn[] columns = new BaseColumn[] {
                             MakesModelsTable.Category,
             null};
                ExportDataToCSV exportData = new ExportDataToCSV(MakesModelsTable.Instance,wc,orderBy,columns);
                exportData.StartExport(this.Page.Response, true);

                DataForExport dataForCSV = new DataForExport(MakesModelsTable.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(MakesModelsTable.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(MakesModelsTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(MakesModelsTable.Category, "Default"));
              ...
              {
                val = MakesModelsTable.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        public virtual void NewButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../MakesModels/Add-Category.aspx?makemodelid={Max_makemodelRecordControl:FV:Expr1}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Category-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "MakesModels";
                // If Show-Category-Table.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(MakesModelsTable.Category.Name, ReportEnum.Align.Left, "${Category}", ReportEnum.Align.Left, 15);
                ...
                ColumnList columns = MakesModelsTable.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = MakesModelsTable.GetRecordCount(joinFilter,whereClause);
                MakesModelsRecord[] records = null;
                
                do
                {
                    
                    records = MakesModelsTable.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( MakesModelsRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 if (BaseClasses.Utils.MiscUtils.IsNull(record.Category)){
                                 report.AddData("${Category}", "",ReportEnum.Align.Left, 300);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = MakesModelsTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(MakesModelsTable.Category);
                                 _DFKA = MakesModelsTable.GetDFKA(record.Category.ToString(), MakesModelsTable.Category,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  MakesModelsTable.Category.IsApplyDisplayAs){
                                     report.AddData("${Category}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${Category}", record.Format(MakesModelsTable.Category), ReportEnum.Align.Left, 300);
                                 }
                             }
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Category-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "MakesModels";
                // If Show-Category-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList CategoryFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CategoryFilter");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual MakesModelsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MakesModelsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Category_Table.MakesModelsTableControlRow")));
...
// Base class for the Max_makemodelRecordControl control on the Show_Category_Table page.
