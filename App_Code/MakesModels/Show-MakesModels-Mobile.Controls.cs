...
// Show_MakesModels_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_MakesModels_Mobile
{
...
// Base class for the RepairOrdersTableControlRow control on the Show_MakesModels_Mobile page.
...
// Base class for the RepairOrdersTableControl control on the Show_MakesModels_Mobile page.
...
public class BaseRepairOrdersTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Show_MakesModels_Mobile.MakesModelsRecordControl makesModelsRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "MakesModelsRecordControl") as OEMConversion.UI.Controls.Show_MakesModels_Mobile.MakesModelsRecordControl);
...
#region "Helper Functions"
        ...
        public virtual RepairOrdersTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RepairOrdersTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Show_MakesModels_Mobile.RepairOrdersTableControlRow")));
...
// Base class for the MakesModelsRecordControl control on the Show_MakesModels_Mobile page.
...
public class BaseMakesModelsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in MakesModelsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-MakesModels-Mobile"] = recId;
