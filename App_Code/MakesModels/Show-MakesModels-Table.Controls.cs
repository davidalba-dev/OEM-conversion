...
// Show_MakesModels_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_MakesModels_Table
{
...
// Base class for the MakesModelsTableControlRow control on the Show_MakesModels_Table page.
...
public class BaseMakesModelsTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void Setmakesmodels_active()
        {
            ...
            // Set the makesmodels_active Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.MakesModels database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.MakesModels record retrieved from the database.
            // this.makesmodels_active is the ASP:Literal on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.makesmodels_activeSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(MakesModelsTable.makesmodels_active);
                                
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                this.makesmodels_active.Text = formattedValue;
              ...
              this.makesmodels_active.Text = MakesModelsTable.makesmodels_active.Format(MakesModelsTable.makesmodels_active.DefaultValue);
            		
            }
            
            // If the makesmodels_active is NULL or blank, then use the value specified  
            // on Properties.
            if (this.makesmodels_active.Text == null ||
                this.makesmodels_active.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.makesmodels_active.Text = "&nbsp;";
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal makesmodels_active {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "makesmodels_active");
            }
        }
...
// Base class for the MakesModelsTableControl control on the Show_MakesModels_Table page.
...
public class BaseMakesModelsTableControl : OEMConversion.UI.BaseApplicationTableControl
{
       ...
       public BaseMakesModelsTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.makesmodels_activeFilter)) 				
                    initialVal = this.GetFromSession(this.makesmodels_activeFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"makesmodels_active\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.makesmodels_activeFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.makesmodels_activeFilter.SelectedValue = initialVal;
            ...
            else
            {
                ...
                this.CurrentSortOrder.Add(MakesModelsTable.Make, OrderByItem.OrderDir.Asc);
              
                this.CurrentSortOrder.Add(MakesModelsTable.Model, OrderByItem.OrderDir.Asc);
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
              ...
              this.makesmodels_activeLabel.Click += makesmodels_activeLabel_Click;
            
              this.ModelDescLabel.Click += ModelDescLabel_Click;
            
              this.ModelLabel.Click += ModelLabel_Click;
            
              this.ModelPackCodeLabel.Click += ModelPackCodeLabel_Click;
            ...
            this.makesmodels_activeFilter.SelectedIndexChanged += new EventHandler(makesmodels_activeFilter_SelectedIndexChanged);
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetMakeLabel();
                SetMakeLabel1();
                Setmakesmodels_activeFilter();
                Setmakesmodels_activeLabel();
                Setmakesmodels_activeLabel1();
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public virtual void ResetControl()
        {
            ...
            this.makesmodels_activeFilter.ClearSelection();
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.MakeFilter)) {
                ...
                wc.iAND(MakesModelsTable.Make, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.MakeFilter, this.GetFromSession(this.MakeFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.makesmodels_activeFilter)) {
                        
                wc.iAND(MakesModelsTable.makesmodels_active, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.makesmodels_activeFilter, this.GetFromSession(this.makesmodels_activeFilter)), false, false);
      ...
      String MakeFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "MakeFilter_Ajax"];
            if (MiscUtils.IsValueSelected(MakeFilterSelectedValue)) {
                ...
                wc.iAND(MakesModelsTable.Make, BaseFilter.ComparisonOperator.EqualsTo, MakeFilterSelectedValue, false, false);
                      
      }
                      
      String makesmodels_activeFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "makesmodels_activeFilter_Ajax"];
            if (MiscUtils.IsValueSelected(makesmodels_activeFilterSelectedValue)) {

              
                wc.iAND(MakesModelsTable.makesmodels_active, BaseFilter.ComparisonOperator.EqualsTo, makesmodels_activeFilterSelectedValue, false, false);
      ...
      MakesModelsRecord rec = new MakesModelsRecord();
                        ...
                        if (recControl.makesmodels_active.Text != "") {
                            rec.Parse(recControl.makesmodels_active.Text, MakesModelsTable.makesmodels_active);
                  }
        ...
        public virtual void Setmakesmodels_activeLabel1()
                  {
                  
                        this.makesmodels_activeLabel1.Text = EvaluateFormula("\"Active\"");
        ...
        public virtual void Setmakesmodels_activeFilter()
        {
            
            this.Populatemakesmodels_activeFilter(MiscUtils.GetSelectedValue(this.makesmodels_activeFilter,  GetFromSession(this.makesmodels_activeFilter)), 500);					
        ...
        // Get the filters' data for makesmodels_activeFilter.
                
        protected virtual void Populatemakesmodels_activeFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.makesmodels_activeFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_makesmodels_activeFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_makesmodels_activeFilter function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.makesmodels_activeFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
              
            
            
            OrderBy orderBy = new OrderBy(false, false);
            orderBy.Add(MakesModelsTable.makesmodels_active, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = MakesModelsTable.GetValues(MakesModelsTable.makesmodels_active, wc, orderBy, maxItems);
            ...
            // Create the item and add to the list.
            string fvalue;
            if ( MakesModelsTable.makesmodels_active.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = MakesModelsTable.makesmodels_active.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
                ...
                ListItem dupItem = this.makesmodels_activeFilter.Items.FindByText(fvalue);
                ...
                ListItem newItem = new ListItem(fvalue, cvalue);
                this.makesmodels_activeFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.makesmodels_activeFilter, selectedValue);
            ...
            if (this.makesmodels_activeFilter.SelectedValue != null && this.makesmodels_activeFilter.Items.FindByValue(this.makesmodels_activeFilter.SelectedValue) == null)
                this.makesmodels_activeFilter.SelectedValue = null;
        ...
        public virtual WhereClause CreateWhereClause_makesmodels_activeFilter()
        {
            // Create a where clause for the filter makesmodels_activeFilter.
            // This function is called by the Populate method to load the items 
            // in the makesmodels_activeFilterDropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.makesmodels_activeFilter, this.makesmodels_activeFilter.SelectedValue);
      ...
      this.SaveToSession("makesmodels_activeFilter_Ajax", this.makesmodels_activeFilter.SelectedValue);
      ...
      this.SaveToSession("SearchText_Ajax", this.SearchText.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.makesmodels_activeFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(makesmodels_activeFilter))
                themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        ...
        public virtual void MakeLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(MakesModelsTable.Make);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
        ...
        public virtual void makesmodels_activeLabel_Click(object sender, EventArgs args)
        {
            //Sorts by makesmodels_active when clicked.
              
            // Get previous sorting state for makesmodels_active.
        
            OrderByItem sd = this.CurrentSortOrder.Find(MakesModelsTable.makesmodels_active);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for makesmodels_active.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(MakesModelsTable.makesmodels_active, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by makesmodels_active, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void ModelDescLabel_Click(object sender, EventArgs args)
        {
            //Sorts by ModelDesc when clicked.
              
            // Get previous sorting state for ModelDesc.
        
            OrderByItem sd = this.CurrentSortOrder.Find(MakesModelsTable.ModelDesc);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for ModelDesc.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(MakesModelsTable.ModelDesc, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by ModelDesc, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void ModelLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(MakesModelsTable.Model);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
        ...
        public virtual void ModelPackCodeLabel_Click(object sender, EventArgs args)
        {
            //Sorts by ModelPackCode when clicked.
              
            // Get previous sorting state for ModelPackCode.
        
            OrderByItem sd = this.CurrentSortOrder.Find(MakesModelsTable.ModelPackCode);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for ModelPackCode.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(MakesModelsTable.ModelPackCode, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by ModelPackCode, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
             ...
             MakesModelsTable.Make,
             MakesModelsTable.Model,
             MakesModelsTable.ModelDesc,
             MakesModelsTable.ModelNotes,
             MakesModelsTable.ModelPackCode,
             MakesModelsTable.makesmodels_active,
             null};
             ...
             data.ColumnList.Add(new ExcelColumn(MakesModelsTable.Make, "Default"));
             data.ColumnList.Add(new ExcelColumn(MakesModelsTable.Model, "Default"));
             data.ColumnList.Add(new ExcelColumn(MakesModelsTable.ModelDesc, "Default"));
             data.ColumnList.Add(new ExcelColumn(MakesModelsTable.ModelNotes, "Default"));
             data.ColumnList.Add(new ExcelColumn(MakesModelsTable.ModelPackCode, "Default"));
             data.ColumnList.Add(new ExcelColumn(MakesModelsTable.makesmodels_active, "Default"));
        ...
        public virtual void NewButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../MakesModels/Add-MakesModels.aspx?makemodelid={Max_makemodelRecordControl:FV:Expr1}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-MakesModels-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "MakesModels";
                // If Show-MakesModels-Table.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 ...
                 report.AddColumn(MakesModelsTable.Make.Name, ReportEnum.Align.Left, "${Make}", ReportEnum.Align.Left, 24);
                 report.AddColumn(MakesModelsTable.Model.Name, ReportEnum.Align.Left, "${Model}", ReportEnum.Align.Left, 28);
                 report.AddColumn(MakesModelsTable.ModelDesc.Name, ReportEnum.Align.Left, "${ModelDesc}", ReportEnum.Align.Left, 28);
                 report.AddColumn(MakesModelsTable.ModelNotes.Name, ReportEnum.Align.Left, "${ModelNotes}", ReportEnum.Align.Left, 28);
                 report.AddColumn(MakesModelsTable.ModelPackCode.Name, ReportEnum.Align.Left, "${ModelPackCode}", ReportEnum.Align.Left, 15);
                 report.AddColumn(MakesModelsTable.makesmodels_active.Name, ReportEnum.Align.Left, "${makesmodels_active}", ReportEnum.Align.Left, 15);
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             report.AddData("${Make}", record.Format(MakesModelsTable.Make), ReportEnum.Align.Left, 300);
                             report.AddData("${Model}", record.Format(MakesModelsTable.Model), ReportEnum.Align.Left, 300);
                             report.AddData("${ModelDesc}", record.Format(MakesModelsTable.ModelDesc), ReportEnum.Align.Left, 300);
                             report.AddData("${ModelNotes}", record.Format(MakesModelsTable.ModelNotes), ReportEnum.Align.Left, 300);
                             report.AddData("${ModelPackCode}", record.Format(MakesModelsTable.ModelPackCode), ReportEnum.Align.Left, 300);
                             report.AddData("${makesmodels_active}", record.Format(MakesModelsTable.makesmodels_active), ReportEnum.Align.Left, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-MakesModels-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "MakesModels";
                // If Show-MakesModels-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        // event handler for FieldFilter
        protected virtual void makesmodels_activeFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList makesmodels_activeFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "makesmodels_activeFilter");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton makesmodels_activeLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "makesmodels_activeLabel");
            }
        }
        
        public System.Web.UI.WebControls.Literal makesmodels_activeLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "makesmodels_activeLabel1");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton ModelDescLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ModelDescLabel");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton ModelPackCodeLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ModelPackCodeLabel");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual MakesModelsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MakesModelsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_MakesModels_Table.MakesModelsTableControlRow")));
...
// Base class for the Max_makemodelRecordControl control on the Show_MakesModels_Table page.
