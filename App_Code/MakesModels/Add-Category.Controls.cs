...
// Add_Category.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Category
{
...
// Base class for the MakesModelsRecordControl control on the Add_Category page.
...
public class BaseMakesModelsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in MakesModelsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Add-Category"] = recId;
