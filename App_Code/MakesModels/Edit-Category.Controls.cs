...
// Edit_Category.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_Category
{
...
// Base class for the MakesModelsRecordControl control on the Edit_Category page.
...
public class BaseMakesModelsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in MakesModelsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Edit-Category"] = recId;
