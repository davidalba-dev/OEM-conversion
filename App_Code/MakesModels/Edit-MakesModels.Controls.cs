...
// Edit_MakesModels.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_MakesModels
{
...
// Base class for the MakesModelsRecordControl control on the Edit_MakesModels page.
...
public class BaseMakesModelsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetCategory()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = MakesModelsTable.Category.DefaultValue;
      ...
      // To customize, override this method in MakesModelsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Edit-MakesModels"] = recId;
