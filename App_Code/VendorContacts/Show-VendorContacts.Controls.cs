...
// Show_VendorContacts.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_VendorContacts
{
...
// Base class for the VendorContactsRecordControl control on the Show_VendorContacts page.
...
public class BaseVendorContactsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in VendorContactsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-VendorContacts"] = recId;
