...
// Edit_VendorContacts_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_VendorContacts_Table
{
...
// Base class for the VendorContactsTableControlRow control on the Edit_VendorContacts_Table page.
...
public class BaseVendorContactsTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetVendContactEmail()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.VendContactEmail.ID))
            {
            
                this.VendContactEmail.Text = this.PreviousUIData[this.VendContactEmail.ID].ToString();
        ...
        public virtual void SetVendContactFax()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.VendContactFax.ID))
            {
            
                this.VendContactFax.Text = this.PreviousUIData[this.VendContactFax.ID].ToString();
        ...
        public virtual void SetVendContactName()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.VendContactName.ID))
            {
            
                this.VendContactName.Text = this.PreviousUIData[this.VendContactName.ID].ToString();
        ...
        public virtual void SetVendContactPhoneBusiness()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.VendContactPhoneBusiness.ID))
            {
            
                this.VendContactPhoneBusiness.Text = this.PreviousUIData[this.VendContactPhoneBusiness.ID].ToString();
        ...
        public virtual void SetVendContactPhoneMobile()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.VendContactPhoneMobile.ID))
            {
            
                this.VendContactPhoneMobile.Text = this.PreviousUIData[this.VendContactPhoneMobile.ID].ToString();
        ...
        public virtual void SetVendContactTitle()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.VendContactTitle.ID))
            {
            
                this.VendContactTitle.Text = this.PreviousUIData[this.VendContactTitle.ID].ToString();
        ...
        public virtual void SetVendContactType()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.VendContactType.ID))
            {
            
                this.VendContactType.Text = this.PreviousUIData[this.VendContactType.ID].ToString();
        ...
        public virtual void SetVendNo()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.VendNo.ID))
            {
            
                this.VendNo.Text = this.PreviousUIData[this.VendNo.ID].ToString();
      ...
      // To customize, override this method in VendorContactsTableControlRow.
        ...
        VendorContactsTableControl tc= ((VendorContactsTableControl)MiscUtils.GetParentControlObject(this, "VendorContactsTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((VendorContactsTableControlRow)this);
                    }
                    this.Visible = false;
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../VendorContacts/Show-VendorContacts.aspx?VendorContacts={PK}";
...
// Base class for the VendorContactsTableControl control on the Edit_VendorContacts_Table page.
    ...
    // Setup default pagination settings.
      ...
      VendorContactsRecord rec = new VendorContactsRecord();
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("VendorContactsTableControlRepeater");
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (VendorContactsTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        VendorContactsTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual VendorContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (VendorContactsTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_VendorContacts_Table.VendorContactsTableControlRow")));
