...
// Add_VendorContacts.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_VendorContacts
{
...
// Base class for the VendorContactsRecordControl control on the Add_VendorContacts page.
...
public class BaseVendorContactsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (VendorContactsRecord)VendorContactsRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in VendorContactsRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["VendorContacts"];
            ...
            HttpContext.Current.Session["QueryString in Add-VendorContacts"] = recId;
...
#region "Helper Properties"
    ...
    VendorContactsRecord rec = null;
             ...
             
        {
            ...
            return new VendorContactsRecord();
