...
// Add_Contractor_contact_rate.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Contractor_contact_rate
{
...
// Base class for the Contractor_contact_rateRecordControl control on the Add_Contractor_contact_rate page.
...
public class BaseContractor_contact_rateRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = Contractor_contact_rateTable.GetRecord(this.RecordUniqueId, true);
        ...
        public virtual void Setcontractor_contact_id()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
              ...
              this.contractor_contact_id.Text = EvaluateFormula("URL(\"contractor_contact\")", this.DataSource);
        ...
        public virtual void Setstart_date()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
              ...
              this.start_date.Text = EvaluateFormula("Today()", this.DataSource, @"d");
        ...
        public virtual void Getcontractor_contact_id()
        {
            ...
            // save it into the contractor_contact_id field in DataSource DatabaseAYS_OEM%dbo.contractor_contact_rate record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.contractor_contact_id.Text, Contractor_contact_rateTable.contractor_contact_id);							
        ...
        public virtual void Getstart_date()
        {
            ...
            // Retrieve the value entered by the user on the start_date ASP:Literal, and
            ...
            // Save the value to data source
            this.DataSource.Parse(EvaluateFormula("Contractor_contact_rateRecordControl.start_date.Text"), Contractor_contact_rateTable.start_date);							
      ...
      // To customize, override this method in Contractor_contact_rateRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Contractor_contact_rate"];
            ...
            HttpContext.Current.Session["QueryString in Add-Contractor-contact-rate"] = recId;
          ...
          wc.iAND(Contractor_contact_rateTable.contractor_contact_rate_id, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(Contractor_contact_rateTable.contractor_contact_rate_id));
             
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(Contractor_contact_rateTable.contractor_contact_rate_id, BaseFilter.ComparisonOperator.EqualsTo, recId);
