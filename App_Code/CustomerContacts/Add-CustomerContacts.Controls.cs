...
// Add_CustomerContacts.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_CustomerContacts
{
...
{
    string whereStr = CustomerContactsTable.CustContactEmail.UniqueName + " = '" + this.CustContactEmail.Text + "'";

    // Check if record already exists before saving.
    CustomerContactsRecord  rec = CustomerContactsTable.GetRecord(whereStr);
    if (rec != null)
    {   
...
//public class Max_customercontactRecordControl : BaseMax_customercontactRecordControl
//{
//      
//        // The BaseMax_customercontactRecordControl implements the LoadData, DataBind and other
//        // methods to load and display the data in a table control.
//
//        // This is the ideal place to add your code customizations. For example, you can override the LoadData, 
//        // CreateWhereClause, DataBind, SaveData, GetUIData, and Validate methods.
...
// Base class for the CustomerContactsRecordControl control on the Add_CustomerContacts page.
...
public class BaseCustomerContactsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in CustomerContactsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Add-CustomerContacts"] = recId;
