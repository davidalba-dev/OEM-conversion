...
// Show_CustomerContacts_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_CustomerContacts_Table
{
...
// Base class for the CustomerContactsTableControlRow control on the Show_CustomerContacts_Table page.
...
// Base class for the CustomerContactsTableControl control on the Show_CustomerContacts_Table page.
...
public class BaseCustomerContactsTableControl : OEMConversion.UI.BaseApplicationTableControl
{
       ...
       public BaseCustomerContactsTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.CustContactTypeFromFilter)) 				
                    initialVal = this.GetFromSession(this.CustContactTypeFromFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"CustContactTypeFrom\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.CustContactTypeFromFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.CustContactTypeFromFilter.SelectedValue = initialVal;
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.CustNoFromFilter)) 				
                    initialVal = this.GetFromSession(this.CustNoFromFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"CustNoFrom\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.CustNoFromFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.CustNoFromFilter.SelectedValue = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.CustContactTypeFromFilter.SelectedIndexChanged += new EventHandler(CustContactTypeFromFilter_SelectedIndexChanged);
            
            this.CustNoFromFilter.SelectedIndexChanged += new EventHandler(CustNoFromFilter_SelectedIndexChanged);
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(CustomerContactsTable.CustNo, this.DataSource);
        }
        ...
        public virtual void ResetControl()
        {
            ...
            this.CustContactTypeFromFilter.ClearSelection();
            
            this.CustNoFromFilter.ClearSelection();
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.CustContact_activeFilter)) {
                ...
                wc.iAND(CustomerContactsTable.CustContact_active, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.CustContact_activeFilter, this.GetFromSession(this.CustContact_activeFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.CustContactTypeFromFilter)) {
                        
                wc.iAND(CustomerContactsTable.CustContactType, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, MiscUtils.GetSelectedValue(this.CustContactTypeFromFilter, this.GetFromSession(this.CustContactTypeFromFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.CustNoFromFilter)) {
                        
                wc.iAND(CustomerContactsTable.CustNo, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, MiscUtils.GetSelectedValue(this.CustNoFromFilter, this.GetFromSession(this.CustNoFromFilter)), false, false);
      ...
      cols.Add(CustomerContactsTable.CustContactPhoneBusiness, true);
      ...
      String CustContact_activeFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "CustContact_activeFilter_Ajax"];
            if (MiscUtils.IsValueSelected(CustContact_activeFilterSelectedValue)) {
                ...
                wc.iAND(CustomerContactsTable.CustContact_active, BaseFilter.ComparisonOperator.EqualsTo, CustContact_activeFilterSelectedValue, false, false);
                      
      }
                      
      String CustContactTypeFromFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "CustContactTypeFromFilter_Ajax"];
            if (MiscUtils.IsValueSelected(CustContactTypeFromFilterSelectedValue)) {

              
                wc.iAND(CustomerContactsTable.CustContactType, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, CustContactTypeFromFilterSelectedValue, false, false);
                      
      }
                      
      String CustNoFromFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "CustNoFromFilter_Ajax"];
            if (MiscUtils.IsValueSelected(CustNoFromFilterSelectedValue)) {

              
                wc.iAND(CustomerContactsTable.CustNo, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, CustNoFromFilterSelectedValue, false, false);
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_SearchText(String prefixText,int count)
        {
            ...
            foreach (CustomerContactsRecord rec in recordList ){
                ...
                resultItem = rec.Format(CustomerContactsTable.CustContactPhoneBusiness);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(CustomerContactsTable.CustContactPhoneBusiness.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, CustomerContactsTable.CustContactPhoneBusiness.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
      ...
      CustomerContactsRecord rec = new CustomerContactsRecord();
                        ...
                        if (recControl.CustContactName.Text != "") {
                            rec.Parse(recControl.CustContactName.Text, CustomerContactsTable.CustContactName);
                  }
                        ...
                        if (recControl.CustNo.Text != "") {
                            rec.Parse(recControl.CustNo.Text, CustomerContactsTable.CustNo);
                  }
        ...
        public virtual void SetCustContact_activeLabel1()
                  {
                        ...
                        this.CustContact_activeLabel1.Text = EvaluateFormula("\"Active\"");
        ...
        public virtual void SetCustContactTypeFromFilter()
        {
            
            this.PopulateCustContactTypeFromFilter(MiscUtils.GetSelectedValue(this.CustContactTypeFromFilter,  GetFromSession(this.CustContactTypeFromFilter)), 500);					
                                     
        }
            
        public virtual void SetCustNoFromFilter()
        {
            
            this.PopulateCustNoFromFilter(MiscUtils.GetSelectedValue(this.CustNoFromFilter,  GetFromSession(this.CustNoFromFilter)), 2000);					
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer Contact Fax {Txt:Ascending}"), "CustContactFax Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer Contact Fax {Txt:Descending}"), "CustContactFax Desc"));
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer Contact Phone Business {Txt:Ascending}"), "CustContactPhoneBusiness Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer Contact Phone Business {Txt:Descending}"), "CustContactPhoneBusiness Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer Contact Phone Mobile {Txt:Ascending}"), "CustContactPhoneMobile Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer Contact Phone Mobile {Txt:Descending}"), "CustContactPhoneMobile Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer Contact Title {Txt:Ascending}"), "CustContactTitle Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer Contact Title {Txt:Descending}"), "CustContactTitle Desc"));
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer Created By {Txt:Ascending}"), "CustCreatedBy Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer Created By {Txt:Descending}"), "CustCreatedBy Desc"));
                ...
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer Contact AP {Txt:Ascending}"), "CustContact_AP Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer Contact AP {Txt:Descending}"), "CustContact_AP Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer Contact QS {Txt:Ascending}"), "CustContact_QS Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Customer Contact QS {Txt:Descending}"), "CustContact_QS Desc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Is Active {Txt:Ascending}"), "isActive Asc"));
              
                this.OrderSort.Items.Add(new ListItem(this.Page.ExpandResourceValue("Is Active {Txt:Descending}"), "isActive Desc"));
        ...
        // Get the filters' data for CustContactTypeFromFilter.
                
        protected virtual void PopulateCustContactTypeFromFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.CustContactTypeFromFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_CustContactTypeFromFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_CustContactTypeFromFilter function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.CustContactTypeFromFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
              
            OrderBy orderBy = new OrderBy(false, false);
                          orderBy.Add(CustomerContactsTable.CustContactType, OrderByItem.OrderDir.Asc);
            ...
            if (wc.RunQuery)
            {
                ...
                do
                {
                    ...
                    foreach (CustomerContactsRecord itemValue in itemValues) 
                    {
                        ...
                        string cvalue = null;
                        string fvalue = null;
                        if (itemValue.CustContactTypeSpecified) 
                        {
                            cvalue = itemValue.CustContactType.ToString();
                            if (counter < maxItems && this.CustContactTypeFromFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                fvalue = EvaluateFormula("CustContactType", itemValue , variables, evaluator);
                                ...
                                ListItem dupItem = this.CustContactTypeFromFilter.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.CustContactTypeFromFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.CustContactTypeFromFilter, selectedValue);
            ...
            if (this.CustContactTypeFromFilter.SelectedValue != null && this.CustContactTypeFromFilter.Items.FindByValue(this.CustContactTypeFromFilter.SelectedValue) == null)
                this.CustContactTypeFromFilter.SelectedValue = null;
                           
        }
            
        // Get the filters' data for CustNoFromFilter.
                
        protected virtual void PopulateCustNoFromFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.CustNoFromFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_CustNoFromFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_CustNoFromFilter function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.CustNoFromFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
                ...
                do
                {
                    ...
                    foreach (CustomersRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.CustNoSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.CustNoFromFilter.Items.FindByValue(cvalue) == null)
                            {
                                    
                                Boolean _isExpandableNonCompositeForeignKey = CustomerContactsTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(CustomerContactsTable.CustNo);
                                if(_isExpandableNonCompositeForeignKey && CustomerContactsTable.CustNo.IsApplyDisplayAs)
                                     fvalue = CustomerContactsTable.GetDFKA(itemValue, CustomerContactsTable.CustNo);
                                ...
                                ListItem dupItem = this.CustNoFromFilter.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.CustNoFromFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.CustNoFromFilter, selectedValue);
            ...
            if (this.CustNoFromFilter.SelectedValue != null && this.CustNoFromFilter.Items.FindByValue(this.CustNoFromFilter.SelectedValue) == null)
                this.CustNoFromFilter.SelectedValue = null;
        ...
        public virtual WhereClause CreateWhereClause_CustContactTypeFromFilter()
        {
            // Create a where clause for the filter CustContactTypeFromFilter.
            // This function is called by the Populate method to load the items 
            // in the CustContactTypeFromFilterDropDownList
        ...
        public virtual WhereClause CreateWhereClause_CustNoFromFilter()
        {
            // Create a where clause for the filter CustNoFromFilter.
            // This function is called by the Populate method to load the items 
            // in the CustNoFromFilterDropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.CustContactTypeFromFilter, this.CustContactTypeFromFilter.SelectedValue);
                  
            this.SaveToSession(this.CustNoFromFilter, this.CustNoFromFilter.SelectedValue);
      ...
      this.SaveToSession("CustContactTypeFromFilter_Ajax", this.CustContactTypeFromFilter.SelectedValue);
              
      this.SaveToSession("CustNoFromFilter_Ajax", this.CustNoFromFilter.SelectedValue);
      ...
      this.SaveToSession("SearchText_Ajax", this.SearchText.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.CustContactTypeFromFilter);
            this.RemoveFromSession(this.CustNoFromFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                    string url = "../CustomerContacts/Add-CustomerContacts.aspx?TabVisible=False&SaveAndNewVisible=False";
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "CustomerContactsTableControl_PostbackTracker").ClientID);                           
                                
                string javascriptCall = "";
                
                    javascriptCall = "initializePopupPage(document.getElementById('" + MiscUtils.FindControlRecursively(this, "CustomerContactsTableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(CustContactTypeFromFilter))
                themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        
            if (MiscUtils.IsValueSelected(CustNoFromFilter))
                themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        ...
        public virtual void CustContactNameLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(CustomerContactsTable.CustContactName);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
        ...
        public virtual void CustNoLabel_Click(object sender, EventArgs args)
        {
            ...
            OrderByItem sd = this.CurrentSortOrder.Find(CustomerContactsTable.CustNo);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
              ...
              this.CurrentSortOrder.Add(CustomerContactsTable.CustNo, OrderByItem.OrderDir.Asc);
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
             ...
             null};
                ...
                DataForExport dataForCSV = new DataForExport(CustomerContactsTable.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(CustomerContactsTable.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(CustomerContactsTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(CustomerContactsTable.CustContactEmail, "Default"));
             data.ColumnList.Add(new ExcelColumn(CustomerContactsTable.CustContactName, "Default"));
             data.ColumnList.Add(new ExcelColumn(CustomerContactsTable.CustContactPhoneBusiness, "Default"));
             data.ColumnList.Add(new ExcelColumn(CustomerContactsTable.CustContactTitle, "Default"));
             data.ColumnList.Add(new ExcelColumn(CustomerContactsTable.CustNo, "Default"));
             data.ColumnList.Add(new ExcelColumn(CustomerContactsTable.CustContact_active, "Default"));
              ...
              {
                val = CustomerContactsTable.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-CustomerContacts-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "CustomerContacts";
                // If Show-CustomerContacts-Table.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(CustomerContactsTable.CustContactEmail.Name, ReportEnum.Align.Left, "${CustContactEmail}", ReportEnum.Align.Left, 28);
                 report.AddColumn(CustomerContactsTable.CustContactName.Name, ReportEnum.Align.Left, "${CustContactName}", ReportEnum.Align.Left, 22);
                 report.AddColumn(CustomerContactsTable.CustContactPhoneBusiness.Name, ReportEnum.Align.Left, "${CustContactPhoneBusiness}", ReportEnum.Align.Left, 22);
                 report.AddColumn(CustomerContactsTable.CustContactTitle.Name, ReportEnum.Align.Left, "${CustContactTitle}", ReportEnum.Align.Left, 28);
                 report.AddColumn(CustomerContactsTable.CustNo.Name, ReportEnum.Align.Left, "${CustNo}", ReportEnum.Align.Left, 18);
                 report.AddColumn(CustomerContactsTable.CustContact_active.Name, ReportEnum.Align.Left, "${CustContact_active}", ReportEnum.Align.Left, 15);
                ...
                ColumnList columns = CustomerContactsTable.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = CustomerContactsTable.GetRecordCount(joinFilter,whereClause);
                CustomerContactsRecord[] records = null;
                
                do
                {
                    
                    records = CustomerContactsTable.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( CustomerContactsRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${CustContactEmail}", record.Format(CustomerContactsTable.CustContactEmail), ReportEnum.Align.Left, 300);
                             report.AddData("${CustContactName}", record.Format(CustomerContactsTable.CustContactName), ReportEnum.Align.Left, 300);
                             report.AddData("${CustContactPhoneBusiness}", record.Format(CustomerContactsTable.CustContactPhoneBusiness), ReportEnum.Align.Left, 300);
                             report.AddData("${CustContactTitle}", record.Format(CustomerContactsTable.CustContactTitle), ReportEnum.Align.Left, 300);
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.CustNo)){
                                 report.AddData("${CustNo}", "",ReportEnum.Align.Left, 300);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = CustomerContactsTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(CustomerContactsTable.CustNo);
                                 _DFKA = CustomerContactsTable.GetDFKA(record.CustNo.ToString(), CustomerContactsTable.CustNo,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  CustomerContactsTable.CustNo.IsApplyDisplayAs){
                                     report.AddData("${CustNo}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${CustNo}", record.Format(CustomerContactsTable.CustNo), ReportEnum.Align.Left, 300);
                                 }
                             }
                             report.AddData("${CustContact_active}", record.Format(CustomerContactsTable.CustContact_active), ReportEnum.Align.Left, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-CustomerContacts-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "CustomerContacts";
                // If Show-CustomerContacts-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        // event handler for FieldFilter
        protected virtual void CustContactTypeFromFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
        ...
        // event handler for FieldFilter
        protected virtual void CustNoFromFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList CustContactTypeFromFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CustContactTypeFromFilter");
            }
        }
        ...
        public System.Web.UI.WebControls.DropDownList CustNoFromFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CustNoFromFilter");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual CustomerContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (CustomerContactsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_CustomerContacts_Table.CustomerContactsTableControlRow")));
