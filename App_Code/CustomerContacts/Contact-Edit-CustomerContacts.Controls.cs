...
// Contact_Edit_CustomerContacts.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Contact_Edit_CustomerContacts
{
...
// Base class for the SecurityTableControlRow control on the Contact_Edit_CustomerContacts page.
...
public class BaseSecurityTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        CustomerContactsRecordControl parentCtrl;
      
            parentCtrl = (CustomerContactsRecordControl)this.Page.FindControlRecursively("CustomerContactsRecordControl");
        ...
        throw new Exception(Page.GetResourceValue("Err:NoParentRecId", "OEMConversion"));
          ...
          this.DataSource.contact_id = parentCtrl.DataSource.CustContactKey;
...
// Base class for the SecurityTableControl control on the Contact_Edit_CustomerContacts page.
...
public class BaseSecurityTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    OEMConversion.UI.Controls.Contact_Edit_CustomerContacts.CustomerContactsRecordControl customerContactsRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "CustomerContactsRecordControl") as OEMConversion.UI.Controls.Contact_Edit_CustomerContacts.CustomerContactsRecordControl);
          
              if (customerContactsRecordControlObj != null && customerContactsRecordControlObj.GetRecord() != null && customerContactsRecordControlObj.GetRecord().IsCreated)
              {
              wc.iAND(SecurityTable.contact_id, BaseFilter.ComparisonOperator.EqualsTo, customerContactsRecordControlObj.GetRecord().CustContactKey.ToString());
              selectedRecordKeyValue.AddElement(SecurityTable.contact_id.InternalName, customerContactsRecordControlObj.GetRecord().CustContactKey.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInCustomerContactsRecordControl = HttpContext.Current.Session["SecurityTableControlWhereClause"] as string;
      
      if (selectedRecordInCustomerContactsRecordControl != null && KeyValue.IsXmlKey(selectedRecordInCustomerContactsRecordControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInCustomerContactsRecordControl);
      
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(SecurityTable.contact_id))
      {
      wc.iAND(SecurityTable.contact_id, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(SecurityTable.contact_id).ToString());
      }
...
#region "Helper Functions"
        ...
        public virtual SecurityTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SecurityTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Contact_Edit_CustomerContacts.SecurityTableControlRow")));
...
// Base class for the CustomerContactsRecordControl control on the Contact_Edit_CustomerContacts page.
...
public class BaseCustomerContactsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in CustomerContactsRecordControl.
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            this.Page.Authorize((Control)Button, "5");
        ...
        public virtual void Button_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../login/Add-Login-Customer.aspx?Custno={CustomerContactsRecordControl:FV:CustNo}&custcontact={CustomerContactsRecordControl:PK}";
...
// Base class for the LoginRecordControl control on the Contact_Edit_CustomerContacts page.
...
public class BaseLoginRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        throw new Exception(Page.GetResourceValue("Err:NoParentRecId", "OEMConversion"));
          ...
          this.DataSource.customer_contact_id = parentCtrl.DataSource.CustContactKey;
    ...
    OEMConversion.UI.Controls.Contact_Edit_CustomerContacts.CustomerContactsRecordControl customerContactsRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "CustomerContactsRecordControl") as OEMConversion.UI.Controls.Contact_Edit_CustomerContacts.CustomerContactsRecordControl);
              ...
              if (customerContactsRecordControlObj != null && customerContactsRecordControlObj.GetRecord() != null && customerContactsRecordControlObj.GetRecord().IsCreated)
              {
              wc.iAND(LoginTable.customer_contact_id, BaseFilter.ComparisonOperator.EqualsTo, customerContactsRecordControlObj.GetRecord().CustContactKey.ToString());
              selectedRecordKeyValue.AddElement(LoginTable.customer_contact_id.InternalName, customerContactsRecordControlObj.GetRecord().CustContactKey.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInCustomerContactsRecordControl = HttpContext.Current.Session["LoginRecordControlWhereClause"] as string;
      
      if (selectedRecordInCustomerContactsRecordControl != null && KeyValue.IsXmlKey(selectedRecordInCustomerContactsRecordControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInCustomerContactsRecordControl);
      
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(LoginTable.customer_contact_id))
      {
      wc.iAND(LoginTable.customer_contact_id, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(LoginTable.customer_contact_id).ToString());
      }
