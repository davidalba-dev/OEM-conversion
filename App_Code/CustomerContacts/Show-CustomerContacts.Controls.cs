...
// Show_CustomerContacts.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_CustomerContacts
{
...
// Base class for the CustomerContactsRecordControl control on the Show_CustomerContacts page.
...
public class BaseCustomerContactsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in CustomerContactsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-CustomerContacts"] = recId;
