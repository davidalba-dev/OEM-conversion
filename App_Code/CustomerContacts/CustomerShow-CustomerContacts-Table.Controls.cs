...
// CustomerShow_CustomerContacts_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.CustomerShow_CustomerContacts_Table
{
...
// Base class for the CustomerContactsTableControlRow control on the CustomerShow_CustomerContacts_Table page.
...
// Base class for the CustomerContactsTableControl control on the CustomerShow_CustomerContacts_Table page.
...
public class BaseCustomerContactsTableControl : OEMConversion.UI.BaseApplicationTableControl
{
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetButton();
                  ...
                  CustomerContactsTableControlRow recControl = (CustomerContactsTableControlRow)(rep.Items[0].FindControl("CustomerContactsTableControlRow"));
                  ...
                  CustomerContactsTableControlRow row = (CustomerContactsTableControlRow)(repItem.FindControl("CustomerContactsTableControlRow"));
                  
                        if (row.GetRecord().CustNoSpecified){
                        keyValue.AddElement(CustomerContactsTable.CustNo.InternalName, row.GetRecord().CustNo.ToString());
                        }
                  ...
                  KeyValue keyValue = new KeyValue();
                        ...
                        if (recControl.GetRecord().CustNoSpecified){
                        keyValue.AddElement(CustomerContactsTable.CustNo.InternalName, recControl.GetRecord().CustNo.ToString());
                        }
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            filter.AddFilter(new BaseClasses.Data.ColumnJoinFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.CustomerContactsTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"CustomerContacts_.CustNo"), new BaseClasses.Data.IdentifierAliasInfo(@"CustomerContacts_", null), BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.LoginTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"login_.custno"), new BaseClasses.Data.IdentifierAliasInfo(@"login_", null),  BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
             ...
             data.ColumnList.Add(new ExcelColumn(CustomerContactsTable.CustContactFax, "Default"));
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("CustomerShow-CustomerContacts-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "CustomerContacts";
                // If CustomerShow-CustomerContacts-Table.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 ...
                 report.AddColumn(CustomerContactsTable.CustContactFax.Name, ReportEnum.Align.Left, "${CustContactFax}", ReportEnum.Align.Left, 22);
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             report.AddData("${CustContactFax}", record.Format(CustomerContactsTable.CustContactFax), ReportEnum.Align.Left, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("CustomerShow-CustomerContacts-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "CustomerContacts";
                // If CustomerShow-CustomerContacts-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        public virtual void Button_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Customers/Edit-Customers.aspx?Customers={CustomersRecordControl:FV:CustNo}";
...
#region "Helper Functions"
        ...
        public virtual CustomerContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (CustomerContactsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.CustomerShow_CustomerContacts_Table.CustomerContactsTableControlRow")));
...
// Base class for the CustomersRecordControl control on the CustomerShow_CustomerContacts_Table page.
...
public class BaseCustomersRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SaveData()
        {
          ...
          CustomerContactsTableControlRow parentCtrl;
      
            parentCtrl = (CustomerContactsTableControlRow)MiscUtils.GetParentControlObject(this, "CustomerContactsTableControlRow");
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue customerContactsRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = customerContactsRecordObj;
          customerContactsRecordObj = tmp;
        CustomerContactsTableControl customerContactsTableControlObj = (MiscUtils.GetParentControlObject(this, "CustomerContactsTableControl") as CustomerContactsTableControl);
          
              if (this.GetFromSession(customerContactsTableControlObj, "selectedRowID", null) != null)
              {
              customerContactsRecordObj = KeyValue.XmlToKey(this.GetFromSession(customerContactsTableControlObj, "selectedRowID", null));
              if (customerContactsRecordObj != null && customerContactsRecordObj.ContainsColumn(CustomerContactsTable.CustNo))
              {
              wc.iAND(CustomersTable.CustNo, BaseFilter.ComparisonOperator.EqualsTo, customerContactsRecordObj.GetColumnValue(CustomerContactsTable.CustNo).ToString());
              selectedRecordKeyValue.AddElement(CustomersTable.CustNo.InternalName, customerContactsRecordObj.GetColumnValue(CustomerContactsTable.CustNo).ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInCustomerContactsTableControl = HttpContext.Current.Session["CustomersRecordControlWhereClause"] as string;
      
      if (selectedRecordInCustomerContactsTableControl != null && KeyValue.IsXmlKey(selectedRecordInCustomerContactsTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInCustomerContactsTableControl);
