...
// Edit_CustomerContacts.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_CustomerContacts
{
...
public class Customercontact_vendorTableControl : BaseCustomercontact_vendorTableControl
{
    // The BaseCustomercontact_vendorTableControl class implements the LoadData, DataBind, CreateWhereClause
    // and other methods to load and display the data in a table control.

    // This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
    // The Customercontact_vendorTableControlRow class offers another place where you can customize
    // the DataBind, GetUIData, SaveData and Validate methods specific to each row displayed on the table.
    
}
public class Customercontact_vendorTableControlRow : BaseCustomercontact_vendorTableControlRow
{
      
        // The BaseCustomercontact_vendorTableControlRow implements code for a ROW within the
        // the Customercontact_vendorTableControl table.  The BaseCustomercontact_vendorTableControlRow implements the DataBind and SaveData methods.
        // The loading of data is actually performed by the LoadData method in the base class of Customercontact_vendorTableControl.
...
// Base class for the Customercontact_vendorTableControlRow control on the Edit_CustomerContacts page.
// Do not modify this class. Instead override any method in Customercontact_vendorTableControlRow.
public class BaseCustomercontact_vendorTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        public BaseCustomercontact_vendorTableControlRow()
        {
        ...
        // To customize, override this method in Customercontact_vendorTableControlRow.
        ...
        {
            // Load the data from the database into the DataSource DatabaseAYS_OEM%dbo.customercontact_vendor record.
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = Customercontact_vendorTable.GetRecord(this.RecordUniqueId, true);
              
                return;
            }
      
            // Since this is a row in the table, the data for this row is loaded by the 
            // LoadData method of the BaseCustomercontact_vendorTableControl when the data for the entire
            // table is loaded.
            
            this.DataSource = new Customercontact_vendorRecord();
        ...
        public virtual void Setcustcontactkey()
        {
            ...
            // DatabaseAYS_OEM%dbo.customercontact_vendor database record.
            
            // this.DataSource is the DatabaseAYS_OEM%dbo.customercontact_vendor record retrieved from the database.
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = Customercontact_vendorTable.custcontactkey.DefaultValue;
        ...
        public virtual void Setvendno()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = Customercontact_vendorTable.vendno.DefaultValue;
            ...
            this.PopulatevendnoDropDownList(selectedValue, 2000);              
        ...
        throw new Exception(Page.GetResourceValue("Err:NoParentRecId", "OEMConversion"));
          ...
          this.DataSource.custcontactkey = parentCtrl.DataSource.CustContactKey;
            ...
            if (this.DataSource.IsAnyValueChanged) {
                ...
                ((Customercontact_vendorTableControl)MiscUtils.GetParentControlObject(this, "Customercontact_vendorTableControl")).DataChanged = true;
                ((Customercontact_vendorTableControl)MiscUtils.GetParentControlObject(this, "Customercontact_vendorTableControl")).ResetData = true;
            }
        ...
        public virtual void Getcustcontactkey()
        {
         // Retrieve the value entered by the user on the custcontactkey ASP:DropDownList, and
            // save it into the custcontactkey field in DataSource DatabaseAYS_OEM%dbo.customercontact_vendor record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.custcontactkey), Customercontact_vendorTable.custcontactkey);			
        ...
        public virtual void Getvendno()
        {
         // Retrieve the value entered by the user on the vendno ASP:DropDownList, and
            // save it into the vendno field in DataSource DatabaseAYS_OEM%dbo.customercontact_vendor record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.vendno), Customercontact_vendorTable.vendno);			
      ...
      // To customize, override this method in Customercontact_vendorTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersCustomercontact_vendorTableControl = false;
            hasFiltersCustomercontact_vendorTableControl = hasFiltersCustomercontact_vendorTableControl && false; // suppress warning
        ...
        public virtual void Delete()
        {
          ...
          Customercontact_vendorTable.DeleteRecord(pkValue);
        ...
        Customercontact_vendorTableControl tc= ((Customercontact_vendorTableControl)MiscUtils.GetParentControlObject(this, "Customercontact_vendorTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((Customercontact_vendorTableControlRow)this);
                    }
                    this.Visible = false;
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseCustomercontact_vendorTableControlRow_Rec"];
            }
            set {
                this.ViewState["BaseCustomercontact_vendorTableControlRow_Rec"] = value;
            }
        }
        
        public Customercontact_vendorRecord DataSource {
            get {
                return (Customercontact_vendorRecord)(this._DataSource);
            }
            set {
...
#region "Helper Properties"
    ...
    Customercontact_vendorRecord rec = null;
        ...
        public virtual Customercontact_vendorRecord GetRecord()
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return Customercontact_vendorTable.GetRecord(this.RecordUniqueId, true);
...
// Base class for the Customercontact_vendorTableControl control on the Edit_CustomerContacts page.
// Do not modify this class. Instead override any method in Customercontact_vendorTableControl.
public class BaseCustomercontact_vendorTableControl : OEMConversion.UI.BaseApplicationTableControl
{
         
       public BaseCustomercontact_vendorTableControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.custcontactkeyFilter1)) 				
                    initialVal = this.GetFromSession(this.custcontactkeyFilter1);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"custcontactkey\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    string[] custcontactkeyFilter1itemListFromSession = initialVal.Split(',');
                    int index = 0;
                    foreach (string item in custcontactkeyFilter1itemListFromSession)
                    {
                        ...
                        {
                            this.custcontactkeyFilter1.Items.Add(item);
                            this.custcontactkeyFilter1.Items[index].Selected = true;
                            index += 1;
                        }
                    }
                    foreach (ListItem listItem in this.custcontactkeyFilter1.Items)
                    {
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.Customercontact_vendorSearchText)) 				
                    initialVal = this.GetFromSession(this.Customercontact_vendorSearchText);
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.Customercontact_vendorSearchText.Text = initialVal;
            ...
            else
            {
                ...
                this.CurrentSortOrder.Add(Customercontact_vendorTable.vendno, OrderByItem.OrderDir.Asc);
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.SortControl.SelectedIndexChanged += new EventHandler(SortControl_SelectedIndexChanged);
              ...
              this.custcontactkeyFilter1.SelectedIndexChanged += custcontactkeyFilter1_SelectedIndexChanged;                  
                        
        
         //' Setup events for others
            AjaxControlToolkit.ToolkitScriptManager.RegisterStartupScript(this, this.GetType(), "Customercontact_vendorSearchTextSearchBoxText", "setSearchBoxText(\"" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "\", \"" + Customercontact_vendorSearchText.ClientID + "\");", true);
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(OEMConversion.Business.Customercontact_vendorRecord);
                      this.DataSource = (Customercontact_vendorRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    foreach (Customercontact_vendorTableControlRow rc in this.GetRecordControls()) {
                        if (!rc.IsNewRecord) {
                    ...
                    Type myrec = typeof(OEMConversion.Business.Customercontact_vendorRecord);
                    this.DataSource = (Customercontact_vendorRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual Customercontact_vendorRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(Customercontact_vendorTable.Column1, true);          
            // selCols.Add(Customercontact_vendorTable.Column2, true);          
            // selCols.Add(Customercontact_vendorTable.Column3, true);          
                  ...
                  
            {
                ...
                return Customercontact_vendorTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                Customercontact_vendorTable databaseTable = new Customercontact_vendorTable();
                ...
                return (recList.ToArray(typeof(Customercontact_vendorRecord)) as Customercontact_vendorRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0)                 
                ...
                return Customercontact_vendorTable.GetRecordCount(join, where);
            else
            {
                Customercontact_vendorTable databaseTable = new Customercontact_vendorTable();
                databaseTable.SelectedColumns.Clear();
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Customercontact_vendorTableControlRepeater"));
        if (rep == null){return;}
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            Customercontact_vendorTableControlRow recControl = (Customercontact_vendorTableControlRow)(repItem.FindControl("Customercontact_vendorTableControlRow"));
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetcustcontactkeyFilter1();
                SetcustcontactkeyLabel2();
                SetCustomercontact_vendorSearchText();
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(Customercontact_vendorTable.custcontactkey, this.DataSource);
            this.Page.PregetDfkaRecords(Customercontact_vendorTable.vendno, this.DataSource);
        }
        ...
        public virtual void ResetControl()
        {
            ...
            this.custcontactkeyFilter1.ClearSelection();
            
            this.SortControl.ClearSelection();
            
            this.Customercontact_vendorSearchText.Text = "";
        ...
        protected virtual void BindPaginationControls()
        {
            ...
            // Bind the buttons for Customercontact_vendorTableControl pagination.
        ...
        public virtual void SaveData()
        {
            ...
            foreach (Customercontact_vendorTableControlRow recCtl in this.GetRecordControls())
            {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            Customercontact_vendorTable.Instance.InnerFilter = null;
    ...
    OEMConversion.UI.Controls.Edit_CustomerContacts.CustomerContactsRecordControl customerContactsRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "CustomerContactsRecordControl") as OEMConversion.UI.Controls.Edit_CustomerContacts.CustomerContactsRecordControl);
              ...
              {
              wc.iAND(Customercontact_vendorTable.custcontactkey, BaseFilter.ComparisonOperator.EqualsTo, customerContactsRecordControlObj.GetRecord().CustContactKey.ToString());
              selectedRecordKeyValue.AddElement(Customercontact_vendorTable.custcontactkey.InternalName, customerContactsRecordControlObj.GetRecord().CustContactKey.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      HttpContext.Current.Session["Customercontact_vendorTableControlWhereClause"] = selectedRecordKeyValue.ToXmlString();
    
            if (MiscUtils.IsValueSelected(this.custcontactkeyFilter1)) {
                        
                int selectedItemCount = 0;
                foreach (ListItem item in this.custcontactkeyFilter1.Items){
                    if (item.Selected) {
                        selectedItemCount += 1;
                ...
                foreach (ListItem item in this.custcontactkeyFilter1.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(Customercontact_vendorTable.custcontactkey, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
            ...
            if (MiscUtils.IsValueSelected(this.Customercontact_vendorSearchText)) {
                if (this.Customercontact_vendorSearchText.Text == BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) ) {
                        this.Customercontact_vendorSearchText.Text = "";
                } else {
                  // Strip "..." from begin and ending of the search text, otherwise the search will return 0 values as in database "..." is not stored.
                  if (this.Customercontact_vendorSearchText.Text.StartsWith("...")) {
                      this.Customercontact_vendorSearchText.Text = this.Customercontact_vendorSearchText.Text.Substring(3,this.Customercontact_vendorSearchText.Text.Length-3);
                  }
                  if (this.Customercontact_vendorSearchText.Text.EndsWith("...")) {
                      this.Customercontact_vendorSearchText.Text = this.Customercontact_vendorSearchText.Text.Substring(0,this.Customercontact_vendorSearchText.Text.Length-3);
                      // Strip the last word as well as it is likely only a partial word
                      int endindex = this.Customercontact_vendorSearchText.Text.Length - 1;
                      while (!Char.IsWhiteSpace(Customercontact_vendorSearchText.Text[endindex]) && endindex > 0) {
                          endindex--;
                      }
                      if (endindex > 0) {
                          this.Customercontact_vendorSearchText.Text = this.Customercontact_vendorSearchText.Text.Substring(0, endindex);
                      }
                  }
                }
                string formatedSearchText = MiscUtils.GetSelectedValue(this.Customercontact_vendorSearchText, this.GetFromSession(this.Customercontact_vendorSearchText));
      ...
      cols.Add(Customercontact_vendorTable.custcontactkey, true);
      
      foreach(BaseColumn col in cols)
      {
      
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.Customercontact_vendorSearchText, this.GetFromSession(this.Customercontact_vendorSearchText)), true, false);
      ...
      string selectedRecordInCustomerContactsRecordControl = HttpContext.Current.Session["Customercontact_vendorTableControlWhereClause"] as string;
      ...
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(Customercontact_vendorTable.custcontactkey))
      {
      wc.iAND(Customercontact_vendorTable.custcontactkey, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(Customercontact_vendorTable.custcontactkey).ToString());
      }
      ...
      String custcontactkeyFilter1SelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "custcontactkeyFilter1_Ajax"];
            if (MiscUtils.IsValueSelected(custcontactkeyFilter1SelectedValue)) {

              
        if (custcontactkeyFilter1SelectedValue != null){
                        string[] custcontactkeyFilter1itemListFromSession = custcontactkeyFilter1SelectedValue.Split(',');
                        int index = 0;
                        WhereClause filter = new WhereClause();
                        foreach (string item in custcontactkeyFilter1itemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(Customercontact_vendorTable.custcontactkey, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
            ...
            if (MiscUtils.IsValueSelected(searchText) && fromSearchControl == "Customercontact_vendorSearchText") {
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_Customercontact_vendorSearchText(String prefixText,int count)
        {
            ArrayList resultList = new ArrayList();
            ArrayList wordList= new ArrayList();
            
            CompoundFilter filterJoin = CreateCompoundJoinFilter();    
            WhereClause wc = CreateWhereClause(prefixText,"Customercontact_vendorSearchText", "WordsStartingWithSearchString", "[^a-zA-Z0-9]");
            if(count==0) count = 10;
            OEMConversion.Business.Customercontact_vendorRecord[] recordList  = Customercontact_vendorTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (Customercontact_vendorRecord rec in recordList ){
                ...
                resultItem = rec.Format(Customercontact_vendorTable.custcontactkey);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(Customercontact_vendorTable.custcontactkey.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, Customercontact_vendorTable.custcontactkey.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
      ...
      Customercontact_vendorRecord rec = new Customercontact_vendorRecord();
        
                        if (MiscUtils.IsValueSelected(recControl.custcontactkey)) {
                            rec.Parse(recControl.custcontactkey.SelectedItem.Value, Customercontact_vendorTable.custcontactkey);
                        }
                        if (MiscUtils.IsValueSelected(recControl.vendno)) {
                            rec.Parse(recControl.vendno.SelectedItem.Value, Customercontact_vendorTable.vendno);
                        }
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new Customercontact_vendorRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(OEMConversion.Business.Customercontact_vendorRecord);
                this.DataSource = (Customercontact_vendorRecord[])(finalList.ToArray(myrec));
        ...
        public void AddToDeletedRecordIds(Customercontact_vendorTableControlRow rec)
        {
            if (rec.IsNewRecord) {
                return;
            }
        ...
        protected virtual bool InDeletedRecordIds(Customercontact_vendorTableControlRow rec)            
        {
            if (this.DeletedRecordIds == null || this.DeletedRecordIds.Length == 0) {
                return (false);
            }
        ...
        public virtual void SetcustcontactkeyLabel2()
                  {
        ...
        public virtual void SetvendnoLabel()
                  {
                      ...
                      //Code for the text property is generated inside the .aspx file. 
                      //To override this property you can uncomment the following property and add you own value.
                      //this.vendnoLabel.Text = "Some value";
        ...
        public virtual void SetcustcontactkeyFilter1()
        {
            
            ArrayList custcontactkeyFilter1selectedFilterItemList = new ArrayList();
            string custcontactkeyFilter1itemsString = null;
            if (this.InSession(this.custcontactkeyFilter1))
                custcontactkeyFilter1itemsString = this.GetFromSession(this.custcontactkeyFilter1);
            
            if (custcontactkeyFilter1itemsString != null)
            {
                string[] custcontactkeyFilter1itemListFromSession = custcontactkeyFilter1itemsString.Split(',');
                foreach (string item in custcontactkeyFilter1itemListFromSession)
                {
                    custcontactkeyFilter1selectedFilterItemList.Add(item);
                }
            }
              
            			
            this.PopulatecustcontactkeyFilter1(MiscUtils.GetSelectedValueList(this.custcontactkeyFilter1, custcontactkeyFilter1selectedFilterItemList), 500);
                    
              string url = this.ModifyRedirectUrl("../CustomerContacts/CustomerContacts-QuickSelector.aspx", "", true);
              
              url = this.Page.ModifyRedirectUrl(url, "", true);                                  
              
              url += "?Target=" + this.custcontactkeyFilter1.ClientID + "&DFKA=" + (this.Page as BaseApplicationPage).Encrypt("CustContactName")+ "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("CustContactKey")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--ANY--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:All")) + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.custcontactkeyFilter1.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(custcontactkeyFilter1.AutoPostBack).ToLower() + ", event); return false;";
                  
                             
        }
            
        public virtual void SetCustomercontact_vendorSearchText()
        {
                                            
            this.Customercontact_vendorSearchText.Attributes.Add("onfocus", "if(this.value=='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "') {this.value='';this.className='Search_Input';}");
            this.Customercontact_vendorSearchText.Attributes.Add("onblur", "if(this.value=='') {this.value='" + BaseClasses.Resources.AppResources.GetResourceValue("Txt:SearchForEllipsis", null) + "';this.className='Search_InputHint';}");
        ...
        // Get the filters' data for custcontactkeyFilter1.
                
        protected virtual void PopulatecustcontactkeyFilter1(ArrayList selectedValue, int maxItems)
                    
        {
            ...
            WhereClause wc = this.CreateWhereClause_custcontactkeyFilter1();            
            this.custcontactkeyFilter1.Items.Clear();
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_custcontactkeyFilter1 function.
            // It is better to customize the where clause there.
            ...
            if (wc.RunQuery)
            {
                ...
                do
                {
                    ...
                    foreach (CustomerContactsRecord itemValue in itemValues) 
                    {
                        ...
                        {
                            cvalue = itemValue.CustContactKey.ToString();
                            if (counter < maxItems && this.custcontactkeyFilter1.Items.FindByValue(cvalue) == null)
                            {
                                    
                                Boolean _isExpandableNonCompositeForeignKey = Customercontact_vendorTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(Customercontact_vendorTable.custcontactkey);
                                if(_isExpandableNonCompositeForeignKey && Customercontact_vendorTable.custcontactkey.IsApplyDisplayAs)
                                     fvalue = Customercontact_vendorTable.GetDFKA(itemValue, Customercontact_vendorTable.custcontactkey);
                                ...
                                ListItem dupItem = this.custcontactkeyFilter1.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.custcontactkeyFilter1.Items.Add(newItem);
            ...
            this.custcontactkeyFilter1.SetFieldMaxLength(50);
                                 
                  
            // Add the selected value.
            if (this.custcontactkeyFilter1.Items.Count == 0)
                this.custcontactkeyFilter1.Items.Add(new ListItem(Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
        ...
        public virtual WhereClause CreateWhereClause_custcontactkeyFilter1()
        {
            // Create a where clause for the filter custcontactkeyFilter1.
            // This function is called by the Populate method to load the items 
            // in the custcontactkeyFilter1QuickSelector
            ...
            custcontactkeyFilter1selectedFilterItemList = MiscUtils.GetSelectedValueList(this.custcontactkeyFilter1, custcontactkeyFilter1selectedFilterItemList); 
            WhereClause wc = new WhereClause();
            if (custcontactkeyFilter1selectedFilterItemList == null || custcontactkeyFilter1selectedFilterItemList.Count == 0)
                wc.RunQuery = false;
            else            
            {
                foreach (string item in custcontactkeyFilter1selectedFilterItemList)
                {
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("Customercontact_vendorTableControlRepeater");
        ...
        protected override void SaveControlsToSession()
        {
            ...
            ArrayList custcontactkeyFilter1selectedFilterItemList = MiscUtils.GetSelectedValueList(this.custcontactkeyFilter1, null);
            string custcontactkeyFilter1SessionString = "";
            if (custcontactkeyFilter1selectedFilterItemList != null){
                foreach (string item in custcontactkeyFilter1selectedFilterItemList){
                    custcontactkeyFilter1SessionString = String.Concat(custcontactkeyFilter1SessionString ,"," , item);
                }
            }
            this.SaveToSession(this.custcontactkeyFilter1, custcontactkeyFilter1SessionString);
                  
            this.SaveToSession(this.Customercontact_vendorSearchText, this.Customercontact_vendorSearchText.Text);
        ...
        protected  void SaveControlsToSession_Ajax()
        {
            ...
            this.SaveToSession("custcontactkeyFilter1_Ajax", custcontactkeyFilter1SessionString);
          
      this.SaveToSession("Customercontact_vendorSearchText_Ajax", this.Customercontact_vendorSearchText.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.custcontactkeyFilter1);
            this.RemoveFromSession(this.Customercontact_vendorSearchText);
    ...
    this.RemoveFromSession(this, "Page_Size");
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            string orderByStr = (string)ViewState["Customercontact_vendorTableControl_OrderBy"];
        ...
        {            
            ...
            if (this.CurrentSortOrder != null) {
                this.ViewState["Customercontact_vendorTableControl_OrderBy"] = this.CurrentSortOrder.ToXmlString();
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(custcontactkeyFilter1))
        ...
        protected virtual void SortControl_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in Customercontact_vendorTable.GetColumns())
                  {
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(Customercontact_vendorTable.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (Customercontact_vendorTable.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && Customercontact_vendorTable.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(Customercontact_vendorTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(Customercontact_vendorTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
        ...
        protected virtual void custcontactkeyFilter1_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = Customercontact_vendorTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  Customercontact_vendorRecord[] DataSource {
            ...
            get {
                return (Customercontact_vendorRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Properties"
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector custcontactkeyFilter1 {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "custcontactkeyFilter1");
            }
        }              
        
        public System.Web.UI.WebControls.Literal custcontactkeyLabel2 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "custcontactkeyLabel2");
            }
        }
        
        public System.Web.UI.WebControls.TextBox Customercontact_vendorSearchText {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Customercontact_vendorSearchText");
            }
        }
...
#region "Helper Functions"
        ...
        public override string EvaluateExpressions(string url, string arg, bool bEncrypt)
        {
            ...
            if (needToProcess) {
                Customercontact_vendorTableControlRow recCtl = this.GetSelectedRecordControl();
        ...
        public virtual Customercontact_vendorTableControlRow GetSelectedRecordControl()
        {
        ...
        public virtual Customercontact_vendorTableControlRow[] GetSelectedRecordControls()
        {
        
            return (Customercontact_vendorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_CustomerContacts.Customercontact_vendorTableControlRow")));
          
        }

        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            Customercontact_vendorTableControlRow[] recordList = this.GetSelectedRecordControls();
            if (recordList.Length == 0) {
                // Localization.
                throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "OEMConversion"));
            }
            
            foreach (Customercontact_vendorTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
        ...
        public virtual Customercontact_vendorTableControlRow[] GetRecordControls()
        {
            Control[] recCtrls = BaseClasses.Utils.MiscUtils.FindControlsRecursively(this, "Customercontact_vendorTableControlRow");
	          List<Customercontact_vendorTableControlRow> list = new List<Customercontact_vendorTableControlRow>();
	          foreach (Customercontact_vendorTableControlRow recCtrl in recCtrls) {
		          list.Add(recCtrl);
	          }
	          return list.ToArray();
        }
...
// Base class for the SecurityTableControlRow control on the Edit_CustomerContacts page.
...
public class BaseSecurityTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in SecurityTableControlRow.
        ...
        public virtual void EditRowButton1_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../department/Edit-Department.aspx?Department={SecurityTableControlRow:FV:deptid}";
...
// Base class for the SecurityTableControl control on the Edit_CustomerContacts page.
...
public class BaseSecurityTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
      ...
      public override void DataBind()
      {
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            if (EvaluateFormula("URL(\"CustomerContacts\")", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.SecurityTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"security_.contact_id"), EvaluateFormula("URL(\"CustomerContacts\")", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("URL(\"CustomerContacts\")", false) == "--PLEASE_SELECT--" || EvaluateFormula("URL(\"CustomerContacts\")", false) == "--ANY--") whereClause.RunQuery = false;
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void NewButton1_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../Security/Add-Dept-Security.aspx?custno={CustomerContactsRecordControl:FV:CustNo}&customercontact={CustomerContactsRecordControl:PK}";
...
#region "Helper Functions"
        ...
        public virtual SecurityTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SecurityTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_CustomerContacts.SecurityTableControlRow")));
...
// Base class for the CustomerContactsRecordControl control on the Edit_CustomerContacts page.
...
public class BaseCustomerContactsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public override void DataBind()
        {
            ...
            bool shouldResetControl = false;
            if (shouldResetControl) { }; // prototype usage to void compiler warnings
            Customercontact_vendorTableControl recCustomercontact_vendorTableControl = (Customercontact_vendorTableControl)(MiscUtils.FindControlRecursively(this.Page, "Customercontact_vendorTableControl"));
        
          if (shouldResetControl || this.Page.IsPageRefresh)
          {
             recCustomercontact_vendorTableControl.ResetControl();
          }
                  
        this.Page.SetControl("Customercontact_vendorTableControl");
        ...
        public virtual void SaveData()
        {
            ...
            // For Master-Detail relationships, save data on the Detail table(s)            
          Customercontact_vendorTableControl recCustomercontact_vendorTableControl = (Customercontact_vendorTableControl)(MiscUtils.FindControlRecursively(this.Page, "Customercontact_vendorTableControl"));
        recCustomercontact_vendorTableControl.SaveData();
      ...
      // To customize, override this method in CustomerContactsRecordControl.
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            this.Page.Authorize((Control)Button, "NO_ACCESS");
...
// Base class for the LoginRecordControl control on the Edit_CustomerContacts page.
...
public class BaseLoginRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in LoginRecordControl.
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            if (EvaluateFormula("URL(\"CustomerContacts\")", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.LoginTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"login_.customer_contact_id"), EvaluateFormula("URL(\"CustomerContacts\")", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("URL(\"CustomerContacts\")", false) == "--PLEASE_SELECT--" || EvaluateFormula("URL(\"CustomerContacts\")", false) == "--ANY--") whereClause.RunQuery = false;
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            this.Page.Authorize((Control)login_active, "2;3;5");
					
            this.Page.Authorize((Control)login_activeLabel, "2;3;5");
					
            this.Page.Authorize((Control)role_id, "2;3;5");
					
            this.Page.Authorize((Control)role_idLabel, "2;3;5");
        ...
        public virtual WhereClause CreateWhereClause_role_idDropDownList() 
        {
            ...
            if (EvaluateFormula("\"3\"", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OEMConversion.Business.RoleTable, App_Code").TableDefinition.ColumnList.GetByUniqueName(@"role_.role_id"), EvaluateFormula("\"3\"", false), BaseClasses.Data.BaseFilter.ComparisonOperator.Greater_Than, false));
