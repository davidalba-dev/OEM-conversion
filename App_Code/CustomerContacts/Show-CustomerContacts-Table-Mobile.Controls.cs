...
// Show_CustomerContacts_Table_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_CustomerContacts_Table_Mobile
{
...
// Base class for the CustomerContactsTableControlRow control on the Show_CustomerContacts_Table_Mobile page.
...
public class BaseCustomerContactsTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetCustContactName()
        {
            ...
            // Set the CustContactName Label on the webpage with value from the
            // DatabaseAYS_OEM%dbo.CustomerContacts database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.CustomerContacts record retrieved from the database.
            // this.CustContactName is the ASP:Label on the webpage.
      ...
      // To customize, override this method in CustomerContactsTableControlRow.
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../CustomerContacts/Show-CustomerContacts-Mobile.aspx?CustomerContacts={PK}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Label CustContactName {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CustContactName");
            }
        }
...
// Base class for the CustomerContactsTableControl control on the Show_CustomerContacts_Table_Mobile page.
...
public class BaseCustomerContactsTableControl : OEMConversion.UI.BaseApplicationTableControl
{
           ...
           // Setup the filter and search.
            ...
            if (!this.Page.IsPostBack)
            {
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.CustContactNameFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.CustContactNameFilter.SelectedValue = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.CustContactNameFilter.SelectedIndexChanged += new EventHandler(CustContactNameFilter_SelectedIndexChanged);
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep1 = (System.Web.UI.WebControls.Repeater)BaseClasses.Utils.MiscUtils.FindControlRecursively(rep.Items[PageIndex], "CustomerContactsTableControlRepeater1");
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.CustContactNameFilter)) {
                ...
                wc.iAND(CustomerContactsTable.CustContactName, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.CustContactNameFilter, this.GetFromSession(this.CustContactNameFilter)), false, false);
      ...
      String CustContactNameFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "CustContactNameFilter_Ajax"];
            if (MiscUtils.IsValueSelected(CustContactNameFilterSelectedValue)) {
                ...
                wc.iAND(CustomerContactsTable.CustContactName, BaseFilter.ComparisonOperator.EqualsTo, CustContactNameFilterSelectedValue, false, false);
      ...
      foreach(BaseColumn col in cols)
      {
            ...
            foreach (CustomerContactsRecord rec in recordList ){
                ...
                if (resultItem != null) {
                    ...
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 20, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, CustomerContactsTable.CustContactName.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (!this.ResetData)
            {
              System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CustomerContactsTableControlRepeater"));
              if (rep == null){return;}
              CustomerContactsTableControlRow[] recControls = this.GetRecordControls();
                foreach (CustomerContactsTableControlRow recControl in recControls) 
		{
      ...
      CustomerContactsRecord rec = new CustomerContactsRecord();
        ...
        public virtual void SetCustContactNameFilter()
        {
            ...
            this.PopulateCustContactNameFilter(MiscUtils.GetSelectedValue(this.CustContactNameFilter,  GetFromSession(this.CustContactNameFilter)), 500);					
        ...
        protected virtual void PopulateCustContactNameFilter(string selectedValue, int maxItems)
                    
        {
            ...
            // Setup the static list items        
                ...
                // Add the All item.
                this.CustContactNameFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.CustContactNameFilter, selectedValue);
            ...
            if (this.CustContactNameFilter.SelectedValue != null && this.CustContactNameFilter.Items.FindByValue(this.CustContactNameFilter.SelectedValue) == null)
                this.CustContactNameFilter.SelectedValue = null;
        ...
        public virtual WhereClause CreateWhereClause_CustContactNameFilter()
        {
            ...
            // in the CustContactNameFilterDropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.CustContactNameFilter, this.CustContactNameFilter.SelectedValue);
      ...
      this.SaveToSession("CustContactNameFilter_Ajax", this.CustContactNameFilter.SelectedValue);
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList CustContactNameFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CustContactNameFilter");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual CustomerContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (CustomerContactsTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Show_CustomerContacts_Table_Mobile.CustomerContactsTableControlRow")));
