...
// Add_CustomerContacts_Popup.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_CustomerContacts_Popup
{
...
// Base class for the CustomerContactsRecordControl control on the Add_CustomerContacts_Popup page.
...
public class BaseCustomerContactsRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in CustomerContactsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Add-CustomerContacts-Popup"] = recId;
