...
// Edit_CustomerContacts_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_CustomerContacts_Table
{
...
// Base class for the CustomerContactsTableControlRow control on the Edit_CustomerContacts_Table page.
...
public class BaseCustomerContactsTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.CustContactType.TextChanged += CustContactType_TextChanged;
        ...
        public virtual void SetCustContactFax()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.CustContactFax.ID))
            {
            
                this.CustContactFax.Text = this.PreviousUIData[this.CustContactFax.ID].ToString();
        ...
        public virtual void SetCustContactPhoneBusiness()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.CustContactPhoneBusiness.ID))
            {
            
                this.CustContactPhoneBusiness.Text = this.PreviousUIData[this.CustContactPhoneBusiness.ID].ToString();
        ...
        public virtual void SetCustContactPhoneMobile()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.CustContactPhoneMobile.ID))
            {
            
                this.CustContactPhoneMobile.Text = this.PreviousUIData[this.CustContactPhoneMobile.ID].ToString();
        ...
        public virtual void SetCustContactTitle()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.CustContactTitle.ID))
            {
            
                this.CustContactTitle.Text = this.PreviousUIData[this.CustContactTitle.ID].ToString();
        ...
        public virtual void SetCustContactType()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.CustContactType.ID))
            {
            
                this.CustContactType.Text = this.PreviousUIData[this.CustContactType.ID].ToString();
              
                return;
            }
            
                    
            // Set the CustContactType TextBox on the webpage with value from the
            // DatabaseAYS_OEM%dbo.CustomerContacts database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.CustomerContacts record retrieved from the database.
            // this.CustContactType is the ASP:TextBox on the webpage.
        ...
        public virtual void SetCustNo()
        {
            ...
            if (this.DataSource != null && this.DataSource.CustNoSpecified) {
              ...
              this.CustNo.Text = CustomerContactsTable.CustNo.DefaultValue;
        ...
        public virtual void GetCustContactType()
        {
            ...
            // Retrieve the value entered by the user on the CustContactType ASP:TextBox, and
            // save it into the CustContactType field in DataSource DatabaseAYS_OEM%dbo.CustomerContacts record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.CustContactType.Text, CustomerContactsTable.CustContactType);							
        ...
        public virtual void GetSessionID()
        {
            ...
            // save it into the SessionID field in DataSource DatabaseAYS_OEM%dbo.CustomerContacts record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.SessionID.Text, CustomerContactsTable.SessionID);							
      ...
      // To customize, override this method in CustomerContactsTableControlRow.
        ...
        CustomerContactsTableControl tc= ((CustomerContactsTableControl)MiscUtils.GetParentControlObject(this, "CustomerContactsTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((CustomerContactsTableControlRow)this);
                    }
                    this.Visible = false;
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ViewRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../CustomerContacts/Show-CustomerContacts.aspx?CustomerContacts={PK}";
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void CustContactType_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox CustContactType {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CustContactType");
            }
        }
...
// Base class for the CustomerContactsTableControl control on the Edit_CustomerContacts_Table page.
       ...
       public BaseCustomerContactsTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.CustContactNameFilter)) 				
                    initialVal = this.GetFromSession(this.CustContactNameFilter);
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    string[] CustContactNameFilteritemListFromSession = initialVal.Split(',');
                    int index = 0;
                    foreach (string item in CustContactNameFilteritemListFromSession)
                    {
                        ...
                        {
                            this.CustContactNameFilter.Items.Add(item);
                            this.CustContactNameFilter.Items[index].Selected = true;
                            index += 1;
                        }
                    }
                    foreach (ListItem listItem in this.CustContactNameFilter.Items)
                    {
            ...
            if (!this.Page.IsPostBack)
            {
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.CustNoFromFilter.Text = initialVal;
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.CustNoToFilter)) 				
                    initialVal = this.GetFromSession(this.CustNoToFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"CustNoTo\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.CustNoToFilter.Text = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.OrderSort.SelectedIndexChanged += new EventHandler(OrderSort_SelectedIndexChanged);
              ...
              this.CustContactNameFilter.SelectedIndexChanged += CustContactNameFilter_SelectedIndexChanged;                  
      ...
      public override void DataBind()
      {
        ...
        public virtual void ResetControl()
        {
            ...
            this.CustContactNameFilter.ClearSelection();
            
            this.OrderSort.ClearSelection();
            
            this.CustNoFromFilter.Text = "";
            
            this.CustNoToFilter.Text = "";
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.CustContactNameFilter)) {
                        
                int selectedItemCount = 0;
                foreach (ListItem item in this.CustContactNameFilter.Items){
                    if (item.Selected) {
                        selectedItemCount += 1;
                ...
                foreach (ListItem item in this.CustContactNameFilter.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(CustomerContactsTable.CustContactName, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
            ...
            if (MiscUtils.IsValueSelected(this.CustNoToFilter)) {
                        
                wc.iAND(CustomerContactsTable.CustNo, BaseFilter.ComparisonOperator.Less_Than_Or_Equal, MiscUtils.GetSelectedValue(this.CustNoToFilter, this.GetFromSession(this.CustNoToFilter)), false, false);
      ...
      String CustContactNameFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "CustContactNameFilter_Ajax"];
            if (MiscUtils.IsValueSelected(CustContactNameFilterSelectedValue)) {

              
        if (CustContactNameFilterSelectedValue != null){
                        string[] CustContactNameFilteritemListFromSession = CustContactNameFilterSelectedValue.Split(',');
                        int index = 0;
                        WhereClause filter = new WhereClause();
                        foreach (string item in CustContactNameFilteritemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(CustomerContactsTable.CustContactName, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
      ...
      String CustNoToFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "CustNoToFilter_Ajax"];
            if (MiscUtils.IsValueSelected(CustNoToFilterSelectedValue)) {

              
                wc.iAND(CustomerContactsTable.CustNo, BaseFilter.ComparisonOperator.Less_Than_Or_Equal, CustNoToFilterSelectedValue, false, false);
      ...
      CustomerContactsRecord rec = new CustomerContactsRecord();
                        ...
                        if (recControl.CustContactPhoneMobile.Text != "") {
                            rec.Parse(recControl.CustContactPhoneMobile.Text, CustomerContactsTable.CustContactPhoneMobile);
                  }
                        ...
                        if (recControl.CustContactType.Text != "") {
                            rec.Parse(recControl.CustContactType.Text, CustomerContactsTable.CustContactType);
                  }
                        ...
                        if (recControl.SessionID.Text != "") {
                            rec.Parse(recControl.SessionID.Text, CustomerContactsTable.SessionID);
                  }
        ...
        public virtual void SetCustContactNameFilter()
        {
            
            ArrayList CustContactNameFilterselectedFilterItemList = new ArrayList();
            string CustContactNameFilteritemsString = null;
            if (this.InSession(this.CustContactNameFilter))
                CustContactNameFilteritemsString = this.GetFromSession(this.CustContactNameFilter);
            
            if (CustContactNameFilteritemsString != null)
            {
                string[] CustContactNameFilteritemListFromSession = CustContactNameFilteritemsString.Split(',');
                foreach (string item in CustContactNameFilteritemListFromSession)
                {
                    CustContactNameFilterselectedFilterItemList.Add(item);
                }
            }
              
            			
            this.PopulateCustContactNameFilter(MiscUtils.GetSelectedValueList(this.CustContactNameFilter, CustContactNameFilterselectedFilterItemList), 500);
                    
              string url = this.ModifyRedirectUrl("../CustomerContacts/CustomerContacts-QuickSelector.aspx", "", true);
              
              url = this.Page.ModifyRedirectUrl(url, "", true);                                  
              
              url += "?Target=" + this.CustContactNameFilter.ClientID + "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("CustContactName")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--ANY--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:All")) + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.CustContactNameFilter.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(CustContactNameFilter.AutoPostBack).ToLower() + ", event); return false;";
        ...
        // Get the filters' data for CustContactNameFilter.
                
        protected virtual void PopulateCustContactNameFilter(ArrayList selectedValue, int maxItems)
                    
        {
            ...
            WhereClause wc = this.CreateWhereClause_CustContactNameFilter();            
            this.CustContactNameFilter.Items.Clear();
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_CustContactNameFilter function.
            ...
            if (wc.RunQuery)
            {
                ...
                values = CustomerContactsTable.GetValues(CustomerContactsTable.CustContactName, wc, orderBy, maxItems);
            ...
            string fvalue;
            if ( CustomerContactsTable.CustContactName.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = CustomerContactsTable.CustContactName.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
                ...
                ListItem dupItem = this.CustContactNameFilter.Items.FindByText(fvalue);
                ...
                this.CustContactNameFilter.Items.Add(newItem);
            ...
            this.CustContactNameFilter.SetFieldMaxLength(50);
                                 
                  
            // Add the selected value.
            if (this.CustContactNameFilter.Items.Count == 0)
                this.CustContactNameFilter.Items.Add(new ListItem(Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
        ...
        public virtual WhereClause CreateWhereClause_CustContactNameFilter()
        {
            // Create a where clause for the filter CustContactNameFilter.
            // This function is called by the Populate method to load the items 
            // in the CustContactNameFilterQuickSelector
            ...
            CustContactNameFilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.CustContactNameFilter, CustContactNameFilterselectedFilterItemList); 
            WhereClause wc = new WhereClause();
            if (CustContactNameFilterselectedFilterItemList == null || CustContactNameFilterselectedFilterItemList.Count == 0)
                wc.RunQuery = false;
            else            
            {
                foreach (string item in CustContactNameFilterselectedFilterItemList)
                {
        ...
        protected override void SaveControlsToSession()
        {
            ...
            ArrayList CustContactNameFilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.CustContactNameFilter, null);
            string CustContactNameFilterSessionString = "";
            if (CustContactNameFilterselectedFilterItemList != null){
                foreach (string item in CustContactNameFilterselectedFilterItemList){
                    CustContactNameFilterSessionString = String.Concat(CustContactNameFilterSessionString ,"," , item);
                }
            }
            this.SaveToSession(this.CustContactNameFilter, CustContactNameFilterSessionString);
                  
            this.SaveToSession(this.CustNoFromFilter, this.CustNoFromFilter.Text);
                  
            this.SaveToSession(this.CustNoToFilter, this.CustNoToFilter.Text);
        ...
        protected  void SaveControlsToSession_Ajax()
        {
            ...
            this.SaveToSession("CustContactNameFilter_Ajax", CustContactNameFilterSessionString);
          
      this.SaveToSession("CustNoFromFilter_Ajax", this.CustNoFromFilter.Text);
              
      this.SaveToSession("CustNoToFilter_Ajax", this.CustNoToFilter.Text);
      ...
      this.SaveToSession("SearchText_Ajax", this.SearchText.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.CustContactNameFilter);
            this.RemoveFromSession(this.CustNoFromFilter);
            this.RemoveFromSession(this.CustNoToFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(CustContactNameFilter))
                themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        
            if (MiscUtils.IsValueSelected(CustNoFromFilter))
                themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        
            if (MiscUtils.IsValueSelected(CustNoToFilter))
                themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        ...
        protected virtual void CustContactNameFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector CustContactNameFilter {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CustContactNameFilter");
            }
        }              
        ...
        public System.Web.UI.WebControls.TextBox CustNoFromFilter {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CustNoFromFilter");
            }
        }
        ...
        public System.Web.UI.WebControls.TextBox CustNoToFilter {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "CustNoToFilter");
            }
        }
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (CustomerContactsTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        CustomerContactsTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual CustomerContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (CustomerContactsTableControlRow[])(selectedList.ToArray(Type.GetType("OEMConversion.UI.Controls.Edit_CustomerContacts_Table.CustomerContactsTableControlRow")));
