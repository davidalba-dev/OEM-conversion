...
// Show_LedgerComm_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_LedgerComm_Mobile
{
...
// Base class for the LedgerCommRecordControl control on the Show_LedgerComm_Mobile page.
...
public class BaseLedgerCommRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in LedgerCommRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-LedgerComm-Mobile"] = recId;
