...
// Edit_LedgerComm.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Edit_LedgerComm
{
...
// Base class for the LedgerCommRecordControl control on the Edit_LedgerComm page.
...
public class BaseLedgerCommRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in LedgerCommRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Edit-LedgerComm"] = recId;
