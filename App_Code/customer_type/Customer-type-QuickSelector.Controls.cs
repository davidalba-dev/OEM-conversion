...
// Customer_type_QuickSelector.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Customer_type_QuickSelector
{
...
// Base class for the SelectorTableControlRow control on the Customer_type_QuickSelector page.
...
public class BaseSelectorTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        {
            // Load the data from the database into the DataSource DatabaseAYS_OEM%dbo.customer_type record.
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = Customer_typeTable.GetRecord(this.RecordUniqueId, true);
            ...
            this.DataSource = new Customer_typeRecord();
      ...
      // To customize, override this method in SelectorTableControlRow.
        ...
        public virtual void Delete()
        {
          ...
          Customer_typeTable.DeleteRecord(pkValue);
        ...
        public Customer_typeRecord DataSource {
            get {
                return (Customer_typeRecord)(this._DataSource);
            }
            set {
...
#region "Helper Properties"
    ...
    Customer_typeRecord rec = null;
        ...
        public virtual Customer_typeRecord GetRecord()
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return Customer_typeTable.GetRecord(this.RecordUniqueId, true);
...
// Base class for the SelectorTableControl control on the Customer_type_QuickSelector page.
...
public class BaseSelectorTableControl : OEMConversion.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(OEMConversion.Business.Customer_typeRecord);
                      this.DataSource = (Customer_typeRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    Type myrec = typeof(OEMConversion.Business.Customer_typeRecord);
                    this.DataSource = (Customer_typeRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual Customer_typeRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(Customer_typeTable.Column1, true);          
            // selCols.Add(Customer_typeTable.Column2, true);          
            // selCols.Add(Customer_typeTable.Column3, true);          
                  ...
                  
            {
                ...
                return Customer_typeTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                Customer_typeTable databaseTable = new Customer_typeTable();
                ...
                return (recList.ToArray(typeof(Customer_typeRecord)) as Customer_typeRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0 || selCols.HasPrimaryKey())
                ...
                return Customer_typeTable.GetRecordCount(join, where);
            else
            {
                Customer_typeTable databaseTable = new Customer_typeTable();
                databaseTable.SelectedColumns.Clear();
        ...
        {    
            ...
            {
                BaseColumn col = Customer_typeTable.GetColumnByName(field);
            ...
            if (includeFormulaAndDFKAParameter) 
            {
                if (formula != "")
                {
                    foreach (BaseColumn col in MiscUtils.GetFormulaFieldList(formula, Customer_typeTable.Instance.TableDefinition))
                    {
                        if (col != null && !columnList.Contains(col))
                            columnList.Add(col);             
                    }
                ...
                {
                    BaseColumn col = Customer_typeTable.GetColumnByName(displayFieldName);
                    if (col != null && !columnList.Contains(col))
                        columnList.Add(col);             
                }
            }
      ...
      public override void DataBind()
      {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            Customer_typeTable.Instance.InnerFilter = null;
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.Search, this.GetFromSession(this.Search)), true, false);
		        ...
		        if (!string.IsNullOrEmpty(this.Page.Request["dependOnField"]) && this.Page.Request["dependOnVal"] != null) {
			          BaseColumn dependOnCol = Customer_typeTable.GetColumnByName(this.Page.GetDecryptedURLParameter("dependOnField"));
                if (dependOnCol != null){                
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_Search(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            OEMConversion.Business.Customer_typeRecord[] recordList  = Customer_typeTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (Customer_typeRecord rec in recordList ){
      ...
      Customer_typeRecord rec = new Customer_typeRecord();
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new Customer_typeRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(OEMConversion.Business.Customer_typeRecord);
                this.DataSource = (Customer_typeRecord[])(finalList.ToArray(myrec));
      ...
      this.Page.Response.Redirect(url);
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = Customer_typeTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  Customer_typeRecord[] DataSource {
            ...
            get {
                return (Customer_typeRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Customer_type_QuickSelector.SelectorTableControlRow")));
