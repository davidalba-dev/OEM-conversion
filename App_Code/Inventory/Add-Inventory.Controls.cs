...
// Add_Inventory.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Add_Inventory
{
...
// Base class for the InventoryRecordControl control on the Add_Inventory page.
...
public class BaseInventoryRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (InventoryRecord)InventoryRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in InventoryRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["Inventory"];
            ...
            HttpContext.Current.Session["QueryString in Add-Inventory"] = recId;
