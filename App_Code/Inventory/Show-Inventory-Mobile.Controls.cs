...
// Show_Inventory_Mobile.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Inventory_Mobile
{
...
// Base class for the InventoryRecordControl control on the Show_Inventory_Mobile page.
...
public class BaseInventoryRecordControl : OEMConversion.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in InventoryRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-Inventory-Mobile"] = recId;
