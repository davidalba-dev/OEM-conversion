...
// Show_Inventory_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OEMConversion.UI.Controls.Show_Inventory_Table
{
...
// Base class for the InventoryTableControlRow control on the Show_Inventory_Table page.
...
public class BaseInventoryTableControlRow : OEMConversion.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetInventory_active()
        {
            ...
            // Set the Inventory_active Literal on the webpage with value from the
            // DatabaseAYS_OEM%dbo.Inventory database record.

            // this.DataSource is the DatabaseAYS_OEM%dbo.Inventory record retrieved from the database.
            // this.Inventory_active is the ASP:Literal on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.Inventory_activeSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(InventoryTable.Inventory_active);
                                
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                this.Inventory_active.Text = formattedValue;
              ...
              this.Inventory_active.Text = InventoryTable.Inventory_active.Format(InventoryTable.Inventory_active.DefaultValue);
            		
            }
            
            // If the Inventory_active is NULL or blank, then use the value specified  
            // on Properties.
            if (this.Inventory_active.Text == null ||
                this.Inventory_active.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.Inventory_active.Text = "&nbsp;";
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal Inventory_active {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Inventory_active");
            }
        }
...
// Base class for the InventoryTableControl control on the Show_Inventory_Table page.
...
public class BaseInventoryTableControl : OEMConversion.UI.BaseApplicationTableControl
{
           ...
           // Setup the filter and search.
            ...
            if (!this.Page.IsPostBack)
            {
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.InvCategoryFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.InvCategoryFilter.SelectedValue = initialVal;
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.Inventory_activeFilter)) 				
                    initialVal = this.GetFromSession(this.Inventory_activeFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"Inventory_active\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.Inventory_activeFilter.Items.Add(new ListItem(initialVal, initialVal));
                        
                    this.Inventory_activeFilter.SelectedValue = initialVal;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
              ...
              this.InvAvgBuyPriceLabel.Click += InvAvgBuyPriceLabel_Click;
            
              this.InvCategoryLabel.Click += InvCategoryLabel_Click;
            
              this.Inventory_activeLabel.Click += Inventory_activeLabel_Click;
            
              this.InvItemDescLabel.Click += InvItemDescLabel_Click;
            
              this.InvPartNoLabel.Click += InvPartNoLabel_Click;
            
              this.InvSellPrice0Label.Click += InvSellPrice0Label_Click;
            ...
            this.InvCategoryFilter.SelectedIndexChanged += new EventHandler(InvCategoryFilter_SelectedIndexChanged);
            
            this.Inventory_activeFilter.SelectedIndexChanged += new EventHandler(Inventory_activeFilter_SelectedIndexChanged);
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetInventory_activeFilter();
                SetInventory_activeLabel();
                SetInventory_activeLabel1();
                SetInvItemDescLabel();
                SetInvPartNoLabel();
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public virtual void ResetControl()
        {
            ...
            this.Inventory_activeFilter.ClearSelection();
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.InvCategoryFilter)) {
                ...
                wc.iAND(InventoryTable.InvCategory, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.InvCategoryFilter, this.GetFromSession(this.InvCategoryFilter)), false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.Inventory_activeFilter)) {
                        
                wc.iAND(InventoryTable.Inventory_active, BaseFilter.ComparisonOperator.EqualsTo, MiscUtils.GetSelectedValue(this.Inventory_activeFilter, this.GetFromSession(this.Inventory_activeFilter)), false, false);
      ...
      String InvCategoryFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "InvCategoryFilter_Ajax"];
            if (MiscUtils.IsValueSelected(InvCategoryFilterSelectedValue)) {
                ...
                wc.iAND(InventoryTable.InvCategory, BaseFilter.ComparisonOperator.EqualsTo, InvCategoryFilterSelectedValue, false, false);
                      
      }
                      
      String Inventory_activeFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "Inventory_activeFilter_Ajax"];
            if (MiscUtils.IsValueSelected(Inventory_activeFilterSelectedValue)) {

              
                wc.iAND(InventoryTable.Inventory_active, BaseFilter.ComparisonOperator.EqualsTo, Inventory_activeFilterSelectedValue, false, false);
      ...
      InventoryRecord rec = new InventoryRecord();
                        ...
                        if (recControl.Inventory_active.Text != "") {
                            rec.Parse(recControl.Inventory_active.Text, InventoryTable.Inventory_active);
                  }
        ...
        public virtual void SetInventory_activeLabel1()
                  {
        ...
        public virtual void SetInvCategoryFilter()
        {
            ...
            this.PopulateInvCategoryFilter(MiscUtils.GetSelectedValue(this.InvCategoryFilter,  GetFromSession(this.InvCategoryFilter)), 500);					
                                     
        }
            
        public virtual void SetInventory_activeFilter()
        {
            
            this.PopulateInventory_activeFilter(MiscUtils.GetSelectedValue(this.Inventory_activeFilter,  GetFromSession(this.Inventory_activeFilter)), 500);					
        ...
        protected virtual void PopulateInvCategoryFilter(string selectedValue, int maxItems)
                    
        {
            ...
            // Setup the static list items        
                ...
                // Add the All item.
                this.InvCategoryFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
            ...
            try
            {
                ...
                MiscUtils.SetSelectedValue(this.InvCategoryFilter, selectedValue);
            ...
            if (this.InvCategoryFilter.SelectedValue != null && this.InvCategoryFilter.Items.FindByValue(this.InvCategoryFilter.SelectedValue) == null)
                this.InvCategoryFilter.SelectedValue = null;
                           
        }
            
        // Get the filters' data for Inventory_activeFilter.
                
        protected virtual void PopulateInventory_activeFilter(string selectedValue, int maxItems)
                    
        {
            ...
            this.Inventory_activeFilter.Items.Clear();
            WhereClause wc = this.CreateWhereClause_Inventory_activeFilter();            
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_Inventory_activeFilter function.
            // It is better to customize the where clause there.
             
            // Setup the static list items        
            
                // Add the All item.
                this.Inventory_activeFilter.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:All", "OEMConversion"), "--ANY--"));
              
            
            
            OrderBy orderBy = new OrderBy(false, false);
            orderBy.Add(InventoryTable.Inventory_active, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = InventoryTable.GetValues(InventoryTable.Inventory_active, wc, orderBy, maxItems);
            ...
            // Create the item and add to the list.
            string fvalue;
            if ( InventoryTable.Inventory_active.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = InventoryTable.Inventory_active.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
                ...
                ListItem dupItem = this.Inventory_activeFilter.Items.FindByText(fvalue);
                ...
                ListItem newItem = new ListItem(fvalue, cvalue);
                this.Inventory_activeFilter.Items.Add(newItem);
            ...
            try
            {
                ...
                // Set the selected value.
                MiscUtils.SetSelectedValue(this.Inventory_activeFilter, selectedValue);
            ...
            if (this.Inventory_activeFilter.SelectedValue != null && this.Inventory_activeFilter.Items.FindByValue(this.Inventory_activeFilter.SelectedValue) == null)
                this.Inventory_activeFilter.SelectedValue = null;
        ...
        public virtual WhereClause CreateWhereClause_InvCategoryFilter()
        {
            ...
            // in the InvCategoryFilterDropDownList
        ...
        public virtual WhereClause CreateWhereClause_Inventory_activeFilter()
        {
            // Create a where clause for the filter Inventory_activeFilter.
            // This function is called by the Populate method to load the items 
            // in the Inventory_activeFilterDropDownList
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.InvCategoryFilter, this.InvCategoryFilter.SelectedValue);
                  
            this.SaveToSession(this.Inventory_activeFilter, this.Inventory_activeFilter.SelectedValue);
      ...
      this.SaveToSession("InvCategoryFilter_Ajax", this.InvCategoryFilter.SelectedValue);
              
      this.SaveToSession("Inventory_activeFilter_Ajax", this.Inventory_activeFilter.SelectedValue);
      ...
      this.SaveToSession("SearchText_Ajax", this.SearchText.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.Inventory_activeFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
              ...
              try
              {
                    string url = "../Inventory/Add-Inventory.aspx?TabVisible=False&SaveAndNewVisible=False";
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "InventoryTableControl_PostbackTracker").ClientID);                           
                                
                string javascriptCall = "";
                
                    javascriptCall = "initializePopupPage(document.getElementById('" + MiscUtils.FindControlRecursively(this, "InventoryTableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(Inventory_activeFilter))
                themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonCheckmark.png";
        ...
        public virtual void InvAvgBuyPriceLabel_Click(object sender, EventArgs args)
        {
            //Sorts by InvAvgBuyPrice when clicked.
              
            // Get previous sorting state for InvAvgBuyPrice.
        
            OrderByItem sd = this.CurrentSortOrder.Find(InventoryTable.InvAvgBuyPrice);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for InvAvgBuyPrice.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(InventoryTable.InvAvgBuyPrice, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by InvAvgBuyPrice, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void InvCategoryLabel_Click(object sender, EventArgs args)
        {
            //Sorts by InvCategory when clicked.
              
            // Get previous sorting state for InvCategory.
        
            OrderByItem sd = this.CurrentSortOrder.Find(InventoryTable.InvCategory);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for InvCategory.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(InventoryTable.InvCategory, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by InvCategory, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void Inventory_activeLabel_Click(object sender, EventArgs args)
        {
            //Sorts by Inventory_active when clicked.
              
            // Get previous sorting state for Inventory_active.
        
            OrderByItem sd = this.CurrentSortOrder.Find(InventoryTable.Inventory_active);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for Inventory_active.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(InventoryTable.Inventory_active, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by Inventory_active, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void InvItemDescLabel_Click(object sender, EventArgs args)
        {
            //Sorts by InvItemDesc when clicked.
              
            // Get previous sorting state for InvItemDesc.
        
            OrderByItem sd = this.CurrentSortOrder.Find(InventoryTable.InvItemDesc);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for InvItemDesc.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(InventoryTable.InvItemDesc, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by InvItemDesc, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void InvPartNoLabel_Click(object sender, EventArgs args)
        {
            //Sorts by InvPartNo when clicked.
              
            // Get previous sorting state for InvPartNo.
        
            OrderByItem sd = this.CurrentSortOrder.Find(InventoryTable.InvPartNo);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for InvPartNo.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(InventoryTable.InvPartNo, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by InvPartNo, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void InvSellPrice0Label_Click(object sender, EventArgs args)
        {
            //Sorts by InvSellPrice0 when clicked.
              
            // Get previous sorting state for InvSellPrice0.
        
            OrderByItem sd = this.CurrentSortOrder.Find(InventoryTable.InvSellPrice0);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for InvSellPrice0.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(InventoryTable.InvSellPrice0, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by InvSellPrice0, so just reverse.
                sd.Reverse();
            }
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = InventoryTable.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
              
                // Add each of the columns in order of export.
                BaseColumn[] columns = new BaseColumn[] {
                             InventoryTable.InvAvgBuyPrice,
             InventoryTable.InvCategory,
             InventoryTable.InvItemDesc,
             InventoryTable.InvPartNo,
             InventoryTable.InvSellPrice0,
             InventoryTable.InvVendNo1,
             InventoryTable.Inventory_active,
             null};
                ExportDataToCSV exportData = new ExportDataToCSV(InventoryTable.Instance,wc,orderBy,columns);
                exportData.StartExport(this.Page.Response, true);

                DataForExport dataForCSV = new DataForExport(InventoryTable.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(InventoryTable.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(InventoryTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(InventoryTable.InvAvgBuyPrice, "Currency"));
             data.ColumnList.Add(new ExcelColumn(InventoryTable.InvCategory, "Default"));
             data.ColumnList.Add(new ExcelColumn(InventoryTable.InvItemDesc, "Default"));
             data.ColumnList.Add(new ExcelColumn(InventoryTable.InvPartNo, "Default"));
             data.ColumnList.Add(new ExcelColumn(InventoryTable.InvSellPrice0, "Currency"));
             data.ColumnList.Add(new ExcelColumn(InventoryTable.InvVendNo1, "Default"));
             data.ColumnList.Add(new ExcelColumn(InventoryTable.Inventory_active, "Default"));
              ...
              {
                val = InventoryTable.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Inventory-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Inventory";
                // If Show-Inventory-Table.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(InventoryTable.InvAvgBuyPrice.Name, ReportEnum.Align.Right, "${InvAvgBuyPrice}", ReportEnum.Align.Right, 20);
                 report.AddColumn(InventoryTable.InvCategory.Name, ReportEnum.Align.Left, "${InvCategory}", ReportEnum.Align.Left, 20);
                 report.AddColumn(InventoryTable.InvItemDesc.Name, ReportEnum.Align.Left, "${InvItemDesc}", ReportEnum.Align.Left, 28);
                 report.AddColumn(InventoryTable.InvPartNo.Name, ReportEnum.Align.Left, "${InvPartNo}", ReportEnum.Align.Left, 24);
                 report.AddColumn(InventoryTable.InvSellPrice0.Name, ReportEnum.Align.Right, "${InvSellPrice0}", ReportEnum.Align.Right, 20);
                 report.AddColumn(InventoryTable.InvVendNo1.Name, ReportEnum.Align.Left, "${InvVendNo1}", ReportEnum.Align.Left, 16);
                 report.AddColumn(InventoryTable.Inventory_active.Name, ReportEnum.Align.Left, "${Inventory_active}", ReportEnum.Align.Left, 15);
                ...
                ColumnList columns = InventoryTable.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = InventoryTable.GetRecordCount(joinFilter,whereClause);
                InventoryRecord[] records = null;
                
                do
                {
                    
                    records = InventoryTable.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${InvAvgBuyPrice}", record.Format(InventoryTable.InvAvgBuyPrice), ReportEnum.Align.Right, 300);
                             report.AddData("${InvCategory}", record.Format(InventoryTable.InvCategory), ReportEnum.Align.Left, 300);
                             report.AddData("${InvItemDesc}", record.Format(InventoryTable.InvItemDesc), ReportEnum.Align.Left, 300);
                             report.AddData("${InvPartNo}", record.Format(InventoryTable.InvPartNo), ReportEnum.Align.Left, 300);
                             report.AddData("${InvSellPrice0}", record.Format(InventoryTable.InvSellPrice0), ReportEnum.Align.Right, 300);
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.InvVendNo1)){
                                 report.AddData("${InvVendNo1}", "",ReportEnum.Align.Left, 300);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = InventoryTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(InventoryTable.InvVendNo1);
                                 _DFKA = InventoryTable.GetDFKA(record.InvVendNo1.ToString(), InventoryTable.InvVendNo1,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  InventoryTable.InvVendNo1.IsApplyDisplayAs){
                                     report.AddData("${InvVendNo1}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${InvVendNo1}", record.Format(InventoryTable.InvVendNo1), ReportEnum.Align.Left, 300);
                                 }
                             }
                             report.AddData("${Inventory_active}", record.Format(InventoryTable.Inventory_active), ReportEnum.Align.Left, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Inventory-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Inventory";
                // If Show-Inventory-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        // event handler for FieldFilter
        protected virtual void Inventory_activeFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton InvAvgBuyPriceLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "InvAvgBuyPriceLabel");
            }
        }
        
        public System.Web.UI.WebControls.DropDownList InvCategoryFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "InvCategoryFilter");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton InvCategoryLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "InvCategoryLabel");
            }
        }
        ...
        public System.Web.UI.WebControls.DropDownList Inventory_activeFilter {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Inventory_activeFilter");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton Inventory_activeLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Inventory_activeLabel");
            }
        }
        
        public System.Web.UI.WebControls.Literal Inventory_activeLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Inventory_activeLabel1");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton InvItemDescLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "InvItemDescLabel");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton InvPartNoLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "InvPartNoLabel");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton InvSellPrice0Label {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "InvSellPrice0Label");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual InventoryTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (InventoryTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OEMConversion.UI.Controls.Show_Inventory_Table.InventoryTableControlRow")));
