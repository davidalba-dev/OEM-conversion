<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Resource-sch-status-QuickSelector.aspx.cs" Culture="en-US" MasterPageFile="../Master Pages/Popup.master" Inherits="OEMConversion.UI.Resource_sch_status_QuickSelector" %>
...
<%@ Register Tagprefix="OEMConversion" Namespace="OEMConversion.UI.Controls.Resource_sch_status_QuickSelector" %>
